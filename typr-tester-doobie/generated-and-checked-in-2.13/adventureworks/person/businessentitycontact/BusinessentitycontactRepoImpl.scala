...
class BusinessentitycontactRepoImpl extends BusinessentitycontactRepo {
  ...
  override def deleteByIds(compositeIds: Array[BusinessentitycontactId]): ConnectionIO[Int] = {
    ...
    in (select unnest(${fromWrite(businessentityid)(new Write.Single(BusinessentityId.arrayPut))}), unnest(${fromWrite(personid)(new Write.Single(BusinessentityId.arrayPut))}), unnest(${fromWrite(contacttypeid)(new Write.Single(ContacttypeId.arrayPut))}))
    """.update.run
  }
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  ): ConnectionIO[Long] = new FragmentOps(sql"""COPY "person"."businessentitycontact"("businessentityid", "personid", "contacttypeid", "rowguid", "modifieddate") FROM STDIN""").copyIn(unsaved, batchSize)(BusinessentitycontactRow.pgText)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: Stream[ConnectionIO, BusinessentitycontactRowUnsaved],
    batchSize: Int = 10000
  ): ConnectionIO[Long] = new FragmentOps(sql"""COPY "person"."businessentitycontact"("businessentityid", "personid", "contacttypeid", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""").copyIn(unsaved, batchSize)(BusinessentitycontactRowUnsaved.pgText)
  ...
  override def selectAll: Stream[ConnectionIO, BusinessentitycontactRow] = sql"""select "businessentityid", "personid", "contacttypeid", "rowguid", "modifieddate"::text from "person"."businessentitycontact"""".query(BusinessentitycontactRow.read).stream

  override def selectById(compositeId: BusinessentitycontactId): ConnectionIO[Option[BusinessentitycontactRow]] = sql"""select "businessentityid", "personid", "contacttypeid", "rowguid", "modifieddate"::text from "person"."businessentitycontact" where "businessentityid" = ${fromWrite(compositeId.businessentityid)(new Write.Single(BusinessentityId.put))} AND "personid" = ${fromWrite(compositeId.personid)(new Write.Single(BusinessentityId.put))} AND "contacttypeid" = ${fromWrite(compositeId.contacttypeid)(new Write.Single(ContacttypeId.put))}""".query(BusinessentitycontactRow.read).option
  ...
  override def selectByIds(compositeIds: Array[BusinessentitycontactId]): Stream[ConnectionIO, BusinessentitycontactRow] = {
    ...
    where ("businessentityid", "personid", "contacttypeid")
    in (select unnest(${fromWrite(businessentityid)(new Write.Single(BusinessentityId.arrayPut))}), unnest(${fromWrite(personid)(new Write.Single(BusinessentityId.arrayPut))}), unnest(${fromWrite(contacttypeid)(new Write.Single(ContacttypeId.arrayPut))}))
    """.query(BusinessentitycontactRow.read).stream
  }
  ...
  override def update(row: BusinessentitycontactRow): ConnectionIO[Option[BusinessentitycontactRow]] = {
    ...
    returning "businessentityid", "personid", "contacttypeid", "rowguid", "modifieddate"::text""".query(BusinessentitycontactRow.read).option
  }
  ...
  override def upsertBatch(unsaved: List[BusinessentitycontactRow]): Stream[ConnectionIO, BusinessentitycontactRow] = {
    Update[BusinessentitycontactRow](
      ...
      "modifieddate" = EXCLUDED."modifieddate"
      returning "businessentityid", "personid", "contacttypeid", "rowguid", "modifieddate"::text"""
    )(BusinessentitycontactRow.write)
    .updateManyWithGeneratedKeys[BusinessentitycontactRow]("businessentityid", "personid", "contacttypeid", "rowguid", "modifieddate")(unsaved)(catsStdInstancesForList, BusinessentitycontactRow.read)
  }
  ...
  override def upsertStreaming(
    ...
    for {
      ...
      _ <- new FragmentOps(sql"""copy businessentitycontact_TEMP("businessentityid", "personid", "contacttypeid", "rowguid", "modifieddate") from stdin""").copyIn(unsaved, batchSize)(BusinessentitycontactRow.pgText)
