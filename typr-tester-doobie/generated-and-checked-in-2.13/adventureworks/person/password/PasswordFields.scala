...
object PasswordFields {
  lazy val structure: RelationStructure[PasswordFields, PasswordRow] =
    new Impl(List())

  private final class Impl(val _path: List[Path])
    extends RelationStructure[PasswordFields, PasswordRow] {
    ...
    override lazy val fields: PasswordFields = new PasswordFields {
      ...
      override def passwordhash = Field[String, PasswordRow](_path, "passwordhash", None, None, x => x.passwordhash, (row, value) => row.copy(passwordhash = value))
      override def passwordsalt = Field[String, PasswordRow](_path, "passwordsalt", None, None, x => x.passwordsalt, (row, value) => row.copy(passwordsalt = value))
