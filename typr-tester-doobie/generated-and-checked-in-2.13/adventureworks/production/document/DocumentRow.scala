...
object DocumentRow {
  ...
  implicit lazy val pgText: Text[DocumentRow] = {
    Text.instance[DocumentRow]{ (row, sb) =>
      ...
      sb.append(Text.DELIMETER)
      Flag.pgText.unsafeEncode(row.folderflag, sb)
      sb.append(Text.DELIMETER)
  ...
  implicit lazy val write: Write[DocumentRow] = {
    new Write.Composite[DocumentRow](
