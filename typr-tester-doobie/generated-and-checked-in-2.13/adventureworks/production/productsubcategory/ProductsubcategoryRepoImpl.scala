...
class ProductsubcategoryRepoImpl extends ProductsubcategoryRepo {
  ...
  override def deleteById(productsubcategoryid: ProductsubcategoryId): ConnectionIO[Boolean] = sql"""delete from "production"."productsubcategory" where "productsubcategoryid" = ${fromWrite(productsubcategoryid)(new Write.Single(ProductsubcategoryId.put))}""".update.run.map(_ > 0)

  override def deleteByIds(productsubcategoryids: Array[ProductsubcategoryId]): ConnectionIO[Int] = sql"""delete from "production"."productsubcategory" where "productsubcategoryid" = ANY(${fromWrite(productsubcategoryids)(new Write.Single(ProductsubcategoryId.arrayPut))})""".update.run
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  ): ConnectionIO[Long] = new FragmentOps(sql"""COPY "production"."productsubcategory"("productsubcategoryid", "productcategoryid", "name", "rowguid", "modifieddate") FROM STDIN""").copyIn(unsaved, batchSize)(ProductsubcategoryRow.pgText)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: Stream[ConnectionIO, ProductsubcategoryRowUnsaved],
    batchSize: Int = 10000
  ): ConnectionIO[Long] = new FragmentOps(sql"""COPY "production"."productsubcategory"("productcategoryid", "name", "productsubcategoryid", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""").copyIn(unsaved, batchSize)(ProductsubcategoryRowUnsaved.pgText)
  ...
  override def selectAll: Stream[ConnectionIO, ProductsubcategoryRow] = sql"""select "productsubcategoryid", "productcategoryid", "name", "rowguid", "modifieddate"::text from "production"."productsubcategory"""".query(ProductsubcategoryRow.read).stream

  override def selectById(productsubcategoryid: ProductsubcategoryId): ConnectionIO[Option[ProductsubcategoryRow]] = sql"""select "productsubcategoryid", "productcategoryid", "name", "rowguid", "modifieddate"::text from "production"."productsubcategory" where "productsubcategoryid" = ${fromWrite(productsubcategoryid)(new Write.Single(ProductsubcategoryId.put))}""".query(ProductsubcategoryRow.read).option

  override def selectByIds(productsubcategoryids: Array[ProductsubcategoryId]): Stream[ConnectionIO, ProductsubcategoryRow] = sql"""select "productsubcategoryid", "productcategoryid", "name", "rowguid", "modifieddate"::text from "production"."productsubcategory" where "productsubcategoryid" = ANY(${fromWrite(productsubcategoryids)(new Write.Single(ProductsubcategoryId.arrayPut))})""".query(ProductsubcategoryRow.read).stream
  ...
  override def update(row: ProductsubcategoryRow): ConnectionIO[Option[ProductsubcategoryRow]] = {
    ...
    returning "productsubcategoryid", "productcategoryid", "name", "rowguid", "modifieddate"::text""".query(ProductsubcategoryRow.read).option
  }
  ...
  override def upsertBatch(unsaved: List[ProductsubcategoryRow]): Stream[ConnectionIO, ProductsubcategoryRow] = {
    Update[ProductsubcategoryRow](
      ...
      "modifieddate" = EXCLUDED."modifieddate"
      returning "productsubcategoryid", "productcategoryid", "name", "rowguid", "modifieddate"::text"""
    )(ProductsubcategoryRow.write)
    .updateManyWithGeneratedKeys[ProductsubcategoryRow]("productsubcategoryid", "productcategoryid", "name", "rowguid", "modifieddate")(unsaved)(catsStdInstancesForList, ProductsubcategoryRow.read)
  }
  ...
  override def upsertStreaming(
    ...
    for {
      ...
      _ <- new FragmentOps(sql"""copy productsubcategory_TEMP("productsubcategoryid", "productcategoryid", "name", "rowguid", "modifieddate") from stdin""").copyIn(unsaved, batchSize)(ProductsubcategoryRow.pgText)
