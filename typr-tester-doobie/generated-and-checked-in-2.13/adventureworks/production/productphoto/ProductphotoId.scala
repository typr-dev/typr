...
object ProductphotoId {
  ...
  implicit lazy val bijection: Bijection[ProductphotoId, Int] = Bijection.apply[ProductphotoId, Int](_.value)(ProductphotoId.apply)
  ...
  implicit lazy val pgText: Text[ProductphotoId] = {
