...
trait SohViewFields {
  ...
  def shipdate: Field[TypoLocalDateTime, SohViewRow]
...
object SohViewFields {
  lazy val structure: RelationStructure[SohViewFields, SohViewRow] =
    new Impl(List())

  private final class Impl(val _path: List[Path])
    extends RelationStructure[SohViewFields, SohViewRow] {
    ...
    override lazy val fields: SohViewFields = new SohViewFields {
      ...
      override def shipdate = Field[TypoLocalDateTime, SohViewRow](_path, "shipdate", Some("text"), None, x => x.shipdate, (row, value) => row.copy(shipdate = value))
      ...
      override def purchaseordernumber = Field[OrderNumber, SohViewRow](_path, "purchaseordernumber", None, None, x => x.purchaseordernumber, (row, value) => row.copy(purchaseordernumber = value))
      override def accountnumber = Field[AccountNumber, SohViewRow](_path, "accountnumber", None, None, x => x.accountnumber, (row, value) => row.copy(accountnumber = value))
      ...
      override def salespersonid = Field[BusinessentityId, SohViewRow](_path, "salespersonid", None, None, x => x.salespersonid, (row, value) => row.copy(salespersonid = value))
      override def territoryid = Field[SalesterritoryId, SohViewRow](_path, "territoryid", None, None, x => x.territoryid, (row, value) => row.copy(territoryid = value))
      ...
      override def creditcardid = Field[/* user-picked */ CustomCreditcardId, SohViewRow](_path, "creditcardid", None, None, x => x.creditcardid, (row, value) => row.copy(creditcardid = value))
      override def creditcardapprovalcode = Field[String, SohViewRow](_path, "creditcardapprovalcode", None, None, x => x.creditcardapprovalcode, (row, value) => row.copy(creditcardapprovalcode = value))
      override def currencyrateid = Field[CurrencyrateId, SohViewRow](_path, "currencyrateid", None, None, x => x.currencyrateid, (row, value) => row.copy(currencyrateid = value))
      ...
      override def totaldue = Field[BigDecimal, SohViewRow](_path, "totaldue", None, None, x => x.totaldue, (row, value) => row.copy(totaldue = value))
      override def comment = Field[String, SohViewRow](_path, "comment", None, None, x => x.comment, (row, value) => row.copy(comment = value))
