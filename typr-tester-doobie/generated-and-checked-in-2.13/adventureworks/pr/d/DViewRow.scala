...
object DViewRow {
  implicit lazy val decoder: Decoder[DViewRow] = Decoder.forProduct13[DViewRow, String, BusinessentityId, Flag, String, String, String, Int, TypoShort, String, TypoBytea, TypoUUID, TypoLocalDateTime, DocumentId]("title", "owner", "folderflag", "filename", "fileextension", "revision", "changenumber", "status", "documentsummary", "document", "rowguid", "modifieddate", "documentnode")(DViewRow.apply)(Decoder.decodeString, BusinessentityId.decoder, Flag.decoder, Decoder.decodeString, Decoder.decodeString, Decoder.decodeString, Decoder.decodeInt, TypoShort.decoder, Decoder.decodeString, TypoBytea.decoder, TypoUUID.decoder, TypoLocalDateTime.decoder, DocumentId.decoder)

  implicit lazy val encoder: Encoder[DViewRow] = Encoder.forProduct13[DViewRow, String, BusinessentityId, Flag, String, String, String, Int, TypoShort, String, TypoBytea, TypoUUID, TypoLocalDateTime, DocumentId]("title", "owner", "folderflag", "filename", "fileextension", "revision", "changenumber", "status", "documentsummary", "document", "rowguid", "modifieddate", "documentnode")(x => (x.title, x.owner, x.folderflag, x.filename, x.fileextension, x.revision, x.changenumber, x.status, x.documentsummary, x.document, x.rowguid, x.modifieddate, x.documentnode))(Encoder.encodeString, BusinessentityId.encoder, Flag.encoder, Encoder.encodeString, Encoder.encodeString, Encoder.encodeString, Encoder.encodeInt, TypoShort.encoder, Encoder.encodeString, TypoBytea.encoder, TypoUUID.encoder, TypoLocalDateTime.encoder, DocumentId.encoder)
