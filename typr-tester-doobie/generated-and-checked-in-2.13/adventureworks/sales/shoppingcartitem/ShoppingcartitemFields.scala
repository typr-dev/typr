...
object ShoppingcartitemFields {
  lazy val structure: RelationStructure[ShoppingcartitemFields, ShoppingcartitemRow] =
    new Impl(List())

  private final class Impl(val _path: List[Path])
    extends RelationStructure[ShoppingcartitemFields, ShoppingcartitemRow] {
    ...
    override lazy val fields: ShoppingcartitemFields = new ShoppingcartitemFields {
      ...
      override def shoppingcartid = Field[String, ShoppingcartitemRow](_path, "shoppingcartid", None, None, x => x.shoppingcartid, (row, value) => row.copy(shoppingcartid = value))
