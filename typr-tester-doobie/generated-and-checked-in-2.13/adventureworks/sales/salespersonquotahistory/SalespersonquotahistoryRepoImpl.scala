...
class SalespersonquotahistoryRepoImpl extends SalespersonquotahistoryRepo {
  ...
  override def deleteById(compositeId: SalespersonquotahistoryId): ConnectionIO[Boolean] = sql"""delete from "sales"."salespersonquotahistory" where "businessentityid" = ${fromWrite(compositeId.businessentityid)(new Write.Single(BusinessentityId.put))} AND "quotadate" = ${fromWrite(compositeId.quotadate)(new Write.Single(TypoLocalDateTime.put))}""".update.run.map(_ > 0)
  ...
  override def deleteByIds(compositeIds: Array[SalespersonquotahistoryId]): ConnectionIO[Int] = {
    ...
    in (select unnest(${fromWrite(businessentityid)(new Write.Single(BusinessentityId.arrayPut))}), unnest(${fromWrite(quotadate)(new Write.Single(TypoLocalDateTime.arrayPut))}))
    """.update.run
  }
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  ): ConnectionIO[Long] = new FragmentOps(sql"""COPY "sales"."salespersonquotahistory"("businessentityid", "quotadate", "salesquota", "rowguid", "modifieddate") FROM STDIN""").copyIn(unsaved, batchSize)(SalespersonquotahistoryRow.pgText)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: Stream[ConnectionIO, SalespersonquotahistoryRowUnsaved],
    batchSize: Int = 10000
  ): ConnectionIO[Long] = new FragmentOps(sql"""COPY "sales"."salespersonquotahistory"("businessentityid", "quotadate", "salesquota", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""").copyIn(unsaved, batchSize)(SalespersonquotahistoryRowUnsaved.pgText)
  ...
  override def selectAll: Stream[ConnectionIO, SalespersonquotahistoryRow] = sql"""select "businessentityid", "quotadate"::text, "salesquota", "rowguid", "modifieddate"::text from "sales"."salespersonquotahistory"""".query(SalespersonquotahistoryRow.read).stream

  override def selectById(compositeId: SalespersonquotahistoryId): ConnectionIO[Option[SalespersonquotahistoryRow]] = sql"""select "businessentityid", "quotadate"::text, "salesquota", "rowguid", "modifieddate"::text from "sales"."salespersonquotahistory" where "businessentityid" = ${fromWrite(compositeId.businessentityid)(new Write.Single(BusinessentityId.put))} AND "quotadate" = ${fromWrite(compositeId.quotadate)(new Write.Single(TypoLocalDateTime.put))}""".query(SalespersonquotahistoryRow.read).option
  ...
  override def selectByIds(compositeIds: Array[SalespersonquotahistoryId]): Stream[ConnectionIO, SalespersonquotahistoryRow] = {
    ...
    where ("businessentityid", "quotadate")
    in (select unnest(${fromWrite(businessentityid)(new Write.Single(BusinessentityId.arrayPut))}), unnest(${fromWrite(quotadate)(new Write.Single(TypoLocalDateTime.arrayPut))}))
    """.query(SalespersonquotahistoryRow.read).stream
  }
  ...
  override def update(row: SalespersonquotahistoryRow): ConnectionIO[Option[SalespersonquotahistoryRow]] = {
    ...
    returning "businessentityid", "quotadate"::text, "salesquota", "rowguid", "modifieddate"::text""".query(SalespersonquotahistoryRow.read).option
  }
  ...
  override def upsertBatch(unsaved: List[SalespersonquotahistoryRow]): Stream[ConnectionIO, SalespersonquotahistoryRow] = {
    Update[SalespersonquotahistoryRow](
      ...
      "modifieddate" = EXCLUDED."modifieddate"
      returning "businessentityid", "quotadate"::text, "salesquota", "rowguid", "modifieddate"::text"""
    )(SalespersonquotahistoryRow.write)
    .updateManyWithGeneratedKeys[SalespersonquotahistoryRow]("businessentityid", "quotadate", "salesquota", "rowguid", "modifieddate")(unsaved)(catsStdInstancesForList, SalespersonquotahistoryRow.read)
  }
  ...
  override def upsertStreaming(
    ...
    for {
      ...
      _ <- new FragmentOps(sql"""copy salespersonquotahistory_TEMP("businessentityid", "quotadate", "salesquota", "rowguid", "modifieddate") from stdin""").copyIn(unsaved, batchSize)(SalespersonquotahistoryRow.pgText)
