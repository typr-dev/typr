...
class SalesorderheadersalesreasonRepoImpl extends SalesorderheadersalesreasonRepo {
  ...
  override def deleteById(compositeId: SalesorderheadersalesreasonId): ConnectionIO[Boolean] = sql"""delete from "sales"."salesorderheadersalesreason" where "salesorderid" = ${fromWrite(compositeId.salesorderid)(new Write.Single(SalesorderheaderId.put))} AND "salesreasonid" = ${fromWrite(compositeId.salesreasonid)(new Write.Single(SalesreasonId.put))}""".update.run.map(_ > 0)
  ...
  override def deleteByIds(compositeIds: Array[SalesorderheadersalesreasonId]): ConnectionIO[Int] = {
    ...
    in (select unnest(${fromWrite(salesorderid)(new Write.Single(SalesorderheaderId.arrayPut))}), unnest(${fromWrite(salesreasonid)(new Write.Single(SalesreasonId.arrayPut))}))
    """.update.run
  }
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  ): ConnectionIO[Long] = new FragmentOps(sql"""COPY "sales"."salesorderheadersalesreason"("salesorderid", "salesreasonid", "modifieddate") FROM STDIN""").copyIn(unsaved, batchSize)(SalesorderheadersalesreasonRow.pgText)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: Stream[ConnectionIO, SalesorderheadersalesreasonRowUnsaved],
    batchSize: Int = 10000
  ): ConnectionIO[Long] = new FragmentOps(sql"""COPY "sales"."salesorderheadersalesreason"("salesorderid", "salesreasonid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""").copyIn(unsaved, batchSize)(SalesorderheadersalesreasonRowUnsaved.pgText)
  ...
  override def selectByIds(compositeIds: Array[SalesorderheadersalesreasonId]): Stream[ConnectionIO, SalesorderheadersalesreasonRow] = {
    ...
    where ("salesorderid", "salesreasonid")
    in (select unnest(${fromWrite(salesorderid)(new Write.Single(SalesorderheaderId.arrayPut))}), unnest(${fromWrite(salesreasonid)(new Write.Single(SalesreasonId.arrayPut))}))
    """.query(SalesorderheadersalesreasonRow.read).stream
  }
  ...
  override def update(row: SalesorderheadersalesreasonRow): ConnectionIO[Option[SalesorderheadersalesreasonRow]] = {
    ...
    returning "salesorderid", "salesreasonid", "modifieddate"::text""".query(SalesorderheadersalesreasonRow.read).option
  }
  ...
  override def upsertBatch(unsaved: List[SalesorderheadersalesreasonRow]): Stream[ConnectionIO, SalesorderheadersalesreasonRow] = {
    Update[SalesorderheadersalesreasonRow](
      ...
      do update set
        "modifieddate" = EXCLUDED."modifieddate"
      returning "salesorderid", "salesreasonid", "modifieddate"::text"""
    )(SalesorderheadersalesreasonRow.write)
    .updateManyWithGeneratedKeys[SalesorderheadersalesreasonRow]("salesorderid", "salesreasonid", "modifieddate")(unsaved)(catsStdInstancesForList, SalesorderheadersalesreasonRow.read)
  }
  ...
  override def upsertStreaming(
    ...
    for {
      ...
      _ <- new FragmentOps(sql"""copy salesorderheadersalesreason_TEMP("salesorderid", "salesreasonid", "modifieddate") from stdin""").copyIn(unsaved, batchSize)(SalesorderheadersalesreasonRow.pgText)
