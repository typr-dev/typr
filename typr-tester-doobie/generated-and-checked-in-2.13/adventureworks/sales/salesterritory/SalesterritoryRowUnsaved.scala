...
object SalesterritoryRowUnsaved {
  implicit lazy val decoder: Decoder[SalesterritoryRowUnsaved] = Decoder.forProduct10[SalesterritoryRowUnsaved, Name, CountryregionId, String, Defaulted[SalesterritoryId], Defaulted[BigDecimal], Defaulted[BigDecimal], Defaulted[BigDecimal], Defaulted[BigDecimal], Defaulted[TypoUUID], Defaulted[TypoLocalDateTime]]("name", "countryregioncode", "group", "territoryid", "salesytd", "saleslastyear", "costytd", "costlastyear", "rowguid", "modifieddate")(SalesterritoryRowUnsaved.apply)(Name.decoder, CountryregionId.decoder, Decoder.decodeString, Defaulted.decoder(SalesterritoryId.decoder), Defaulted.decoder(Decoder.decodeBigDecimal), Defaulted.decoder(Decoder.decodeBigDecimal), Defaulted.decoder(Decoder.decodeBigDecimal), Defaulted.decoder(Decoder.decodeBigDecimal), Defaulted.decoder(TypoUUID.decoder), Defaulted.decoder(TypoLocalDateTime.decoder))

  implicit lazy val encoder: Encoder[SalesterritoryRowUnsaved] = Encoder.forProduct10[SalesterritoryRowUnsaved, Name, CountryregionId, String, Defaulted[SalesterritoryId], Defaulted[BigDecimal], Defaulted[BigDecimal], Defaulted[BigDecimal], Defaulted[BigDecimal], Defaulted[TypoUUID], Defaulted[TypoLocalDateTime]]("name", "countryregioncode", "group", "territoryid", "salesytd", "saleslastyear", "costytd", "costlastyear", "rowguid", "modifieddate")(x => (x.name, x.countryregioncode, x.group, x.territoryid, x.salesytd, x.saleslastyear, x.costytd, x.costlastyear, x.rowguid, x.modifieddate))(Name.encoder, CountryregionId.encoder, Encoder.encodeString, Defaulted.encoder(SalesterritoryId.encoder), Defaulted.encoder(Encoder.encodeBigDecimal), Defaulted.encoder(Encoder.encodeBigDecimal), Defaulted.encoder(Encoder.encodeBigDecimal), Defaulted.encoder(Encoder.encodeBigDecimal), Defaulted.encoder(TypoUUID.encoder), Defaulted.encoder(TypoLocalDateTime.encoder))

  implicit lazy val pgText: Text[SalesterritoryRowUnsaved] = {
    Text.instance[SalesterritoryRowUnsaved]{ (row, sb) =>
      ...
      sb.append(Text.DELIMETER)
      Defaulted.pgText(SalesterritoryId.pgText).unsafeEncode(row.territoryid, sb)
      sb.append(Text.DELIMETER)
      ...
      sb.append(Text.DELIMETER)
      Defaulted.pgText(Text.bigDecimalInstance).unsafeEncode(row.costytd, sb)
      sb.append(Text.DELIMETER)
      Defaulted.pgText(Text.bigDecimalInstance).unsafeEncode(row.costlastyear, sb)
      sb.append(Text.DELIMETER)
