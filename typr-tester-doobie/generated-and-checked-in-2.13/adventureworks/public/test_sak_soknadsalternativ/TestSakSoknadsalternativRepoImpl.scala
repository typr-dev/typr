...
class TestSakSoknadsalternativRepoImpl extends TestSakSoknadsalternativRepo {
  ...
  override def upsertStreaming(
    ...
    for {
      ...
      _ <- new FragmentOps(sql"""copy test_sak_soknadsalternativ_TEMP("organisasjonskode_saksbehandler", "utdanningsmulighet_kode", "organisasjonskode_tilbyder") from stdin""").copyIn(unsaved, batchSize)(TestSakSoknadsalternativRow.pgText)
