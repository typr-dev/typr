...
trait OnlyPkColumnsFields {
  ...
  def compositeIdIn(compositeIds: Array[OnlyPkColumnsId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[OnlyPkColumnsId](keyColumn1)(_.keyColumn1)(using as[Array[String]](adventureworks.StringArrayMeta.put), implicitly), TuplePart[OnlyPkColumnsId](keyColumn2)(_.keyColumn2)(using as[Array[Int]](adventureworks.IntegerArrayMeta.put), implicitly))
