    ...
    Decoder.instanceTry[PViewRow]((c: HCursor) =>
      Try {
        ...
        PViewRow(
          ...
          size = orThrow(c.get("size")(using Decoder.decodeString)),
          sizeunitmeasurecode = orThrow(c.get("sizeunitmeasurecode")(using UnitmeasureId.decoder)),
          weightunitmeasurecode = orThrow(c.get("weightunitmeasurecode")(using UnitmeasureId.decoder)),
          weight = orThrow(c.get("weight")(using Decoder.decodeBigDecimal)),
          ...
          `class` = orThrow(c.get("class")(using Decoder.decodeString)),
          style = orThrow(c.get("style")(using Decoder.decodeString)),
          productsubcategoryid = orThrow(c.get("productsubcategoryid")(using ProductsubcategoryId.decoder)),
          ...
          sellenddate = orThrow(c.get("sellenddate")(using TypoLocalDateTime.decoder)),
          discontinueddate = orThrow(c.get("discontinueddate")(using TypoLocalDateTime.decoder)),
