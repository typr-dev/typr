...
class SalesorderheadersalesreasonRepoImpl extends SalesorderheadersalesreasonRepo {
  ...
  override def deleteByIds(compositeIds: Array[SalesorderheadersalesreasonId]): ConnectionIO[Int] = {
    ...
    in (select unnest(${fromWrite(salesorderid)(using new Write.Single(SalesorderheaderId.arrayPut))}), unnest(${fromWrite(salesreasonid)(using new Write.Single(SalesreasonId.arrayPut))}))
    """.update.run
  }
  ...
  override def update(row: SalesorderheadersalesreasonRow): ConnectionIO[Option[SalesorderheadersalesreasonRow]] = {
    ...
    where "salesorderid" = ${fromWrite(compositeId.salesorderid)(using new Write.Single(SalesorderheaderId.put))} AND "salesreasonid" = ${fromWrite(compositeId.salesreasonid)(using new Write.Single(SalesreasonId.put))}
  ...
  override def upsertStreaming(
    ...
    for {
      ...
      _ <- new FragmentOps(sql"""copy salesorderheadersalesreason_TEMP("salesorderid", "salesreasonid", "modifieddate") from stdin""").copyIn(unsaved, batchSize)(using SalesorderheadersalesreasonRow.pgText)
