...
object VstorewithaddressesViewFields {
  lazy val structure: RelationStructure[VstorewithaddressesViewFields, VstorewithaddressesViewRow] =
    new Impl(List())

  private final class Impl(val _path: List[Path])
    extends RelationStructure[VstorewithaddressesViewFields, VstorewithaddressesViewRow] {
    ...
    override lazy val fields: VstorewithaddressesViewFields = new VstorewithaddressesViewFields {
      ...
      override def addressline1 = Field[String, VstorewithaddressesViewRow](_path, "addressline1", None, None, x => x.addressline1, (row, value) => row.copy(addressline1 = value))
      override def addressline2 = Field[String, VstorewithaddressesViewRow](_path, "addressline2", None, None, x => x.addressline2, (row, value) => row.copy(addressline2 = value))
      override def city = Field[String, VstorewithaddressesViewRow](_path, "city", None, None, x => x.city, (row, value) => row.copy(city = value))
      ...
      override def postalcode = Field[String, VstorewithaddressesViewRow](_path, "postalcode", None, None, x => x.postalcode, (row, value) => row.copy(postalcode = value))
