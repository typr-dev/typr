...
trait CountryregioncurrencyFields {
  ...
  def compositeIdIn(compositeIds: Array[CountryregioncurrencyId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[CountryregioncurrencyId](countryregioncode)(_.countryregioncode)(using as[Array[CountryregionId]](using CountryregionId.arrayPut), implicitly), TuplePart[CountryregioncurrencyId](currencycode)(_.currencycode)(using as[Array[CurrencyId]](using CurrencyId.arrayPut), implicitly))
