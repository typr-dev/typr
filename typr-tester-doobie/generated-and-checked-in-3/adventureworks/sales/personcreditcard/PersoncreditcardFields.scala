...
trait PersoncreditcardFields {
  ...
  def compositeIdIn(compositeIds: Array[PersoncreditcardId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[PersoncreditcardId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId]](using BusinessentityId.arrayPut), implicitly), TuplePart[PersoncreditcardId](creditcardid)(_.creditcardid)(using as[Array[/* user-picked */ CustomCreditcardId]](using CustomCreditcardId.arrayPut), implicitly))
