...
object SalesorderheaderRow {
  given decoder: Decoder[SalesorderheaderRow] = {
  ...
  given encoder: Encoder[SalesorderheaderRow] = {
    Encoder.instance[SalesorderheaderRow](row =>
      Json.obj(
  ...
  given read: Read[SalesorderheaderRow] = {
  ...
  given write: Write[SalesorderheaderRow] = {
    new Write.Composite[SalesorderheaderRow](
