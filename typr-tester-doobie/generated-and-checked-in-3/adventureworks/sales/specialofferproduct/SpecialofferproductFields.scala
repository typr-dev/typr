...
trait SpecialofferproductFields {
  ...
  def compositeIdIn(compositeIds: Array[SpecialofferproductId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[SpecialofferproductId](specialofferid)(_.specialofferid)(using as[Array[SpecialofferId]](using SpecialofferId.arrayPut), implicitly), TuplePart[SpecialofferproductId](productid)(_.productid)(using as[Array[ProductId]](using ProductId.arrayPut), implicitly))
