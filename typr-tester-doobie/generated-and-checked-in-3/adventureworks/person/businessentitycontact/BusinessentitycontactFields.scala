...
trait BusinessentitycontactFields {
  ...
  def compositeIdIn(compositeIds: Array[BusinessentitycontactId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[BusinessentitycontactId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId]](using BusinessentityId.arrayPut), implicitly), TuplePart[BusinessentitycontactId](personid)(_.personid)(using as[Array[BusinessentityId]](using BusinessentityId.arrayPut), implicitly), TuplePart[BusinessentitycontactId](contacttypeid)(_.contacttypeid)(using as[Array[ContacttypeId]](using ContacttypeId.arrayPut), implicitly))
