...
object TestSakSoknadsalternativRow {
  ...
  given decoder: Decoder[TestSakSoknadsalternativRow] = Decoder.forProduct3[TestSakSoknadsalternativRow, String, String, TestOrganisasjonId]("organisasjonskode_saksbehandler", "utdanningsmulighet_kode", "organisasjonskode_tilbyder")(TestSakSoknadsalternativRow.apply)(using Decoder.decodeString, Decoder.decodeString, TestOrganisasjonId.decoder)

  given encoder: Encoder[TestSakSoknadsalternativRow] = Encoder.forProduct3[TestSakSoknadsalternativRow, String, String, TestOrganisasjonId]("organisasjonskode_saksbehandler", "utdanningsmulighet_kode", "organisasjonskode_tilbyder")(x => (x.organisasjonskodeSaksbehandler, x.utdanningsmulighetKode, x.organisasjonskodeTilbyder))(using Encoder.encodeString, Encoder.encodeString, TestOrganisasjonId.encoder)
  ...
  given read: Read[TestSakSoknadsalternativRow] = {
  ...
  given write: Write[TestSakSoknadsalternativRow] = {
    new Write.Composite[TestSakSoknadsalternativRow](
