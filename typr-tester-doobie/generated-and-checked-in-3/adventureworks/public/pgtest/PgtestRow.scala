...
object PgtestRow {
  given decoder: Decoder[PgtestRow] = {
    Decoder.instanceTry[PgtestRow]((c: HCursor) =>
      Try {
        ...
        PgtestRow(
          bool = orThrow(c.get("bool")(using Decoder.decodeBoolean)),
          box = orThrow(c.get("box")(using TypoBox.decoder)),
          bpchar = orThrow(c.get("bpchar")(using Decoder.decodeString)),
          bytea = orThrow(c.get("bytea")(using TypoBytea.decoder)),
          char = orThrow(c.get("char")(using Decoder.decodeString)),
          circle = orThrow(c.get("circle")(using TypoCircle.decoder)),
          date = orThrow(c.get("date")(using TypoLocalDate.decoder)),
          float4 = orThrow(c.get("float4")(using Decoder.decodeFloat)),
          float8 = orThrow(c.get("float8")(using Decoder.decodeDouble)),
          hstore = orThrow(c.get("hstore")(using TypoHStore.decoder)),
          inet = orThrow(c.get("inet")(using TypoInet.decoder)),
          int2 = orThrow(c.get("int2")(using TypoShort.decoder)),
          int2vector = orThrow(c.get("int2vector")(using TypoInt2Vector.decoder)),
          int4 = orThrow(c.get("int4")(using Decoder.decodeInt)),
          int8 = orThrow(c.get("int8")(using Decoder.decodeLong)),
          interval = orThrow(c.get("interval")(using TypoInterval.decoder)),
          json = orThrow(c.get("json")(using TypoJson.decoder)),
          jsonb = orThrow(c.get("jsonb")(using TypoJsonb.decoder)),
          line = orThrow(c.get("line")(using TypoLine.decoder)),
          lseg = orThrow(c.get("lseg")(using TypoLineSegment.decoder)),
          money = orThrow(c.get("money")(using TypoMoney.decoder)),
          mydomain = orThrow(c.get("mydomain")(using Mydomain.decoder)),
          myenum = orThrow(c.get("myenum")(using Myenum.decoder)),
          name = orThrow(c.get("name")(using Decoder.decodeString)),
          numeric = orThrow(c.get("numeric")(using Decoder.decodeBigDecimal)),
          path = orThrow(c.get("path")(using TypoPath.decoder)),
          point = orThrow(c.get("point")(using TypoPoint.decoder)),
          polygon = orThrow(c.get("polygon")(using TypoPolygon.decoder)),
          text = orThrow(c.get("text")(using Decoder.decodeString)),
          time = orThrow(c.get("time")(using TypoLocalTime.decoder)),
          timestamp = orThrow(c.get("timestamp")(using TypoLocalDateTime.decoder)),
          timestampz = orThrow(c.get("timestampz")(using TypoInstant.decoder)),
          timez = orThrow(c.get("timez")(using TypoOffsetTime.decoder)),
          uuid = orThrow(c.get("uuid")(using TypoUUID.decoder)),
          varchar = orThrow(c.get("varchar")(using Decoder.decodeString)),
          vector = orThrow(c.get("vector")(using TypoVector.decoder)),
          xml = orThrow(c.get("xml")(using TypoXml.decoder)),
          boxes = orThrow(c.get("boxes")(using Decoder.decodeArray[TypoBox](using TypoBox.decoder, implicitly))),
          bpchares = orThrow(c.get("bpchares")(using Decoder.decodeArray[String](using Decoder.decodeString, implicitly))),
          chares = orThrow(c.get("chares")(using Decoder.decodeArray[String](using Decoder.decodeString, implicitly))),
          circlees = orThrow(c.get("circlees")(using Decoder.decodeArray[TypoCircle](using TypoCircle.decoder, implicitly))),
          datees = orThrow(c.get("datees")(using Decoder.decodeArray[TypoLocalDate](using TypoLocalDate.decoder, implicitly))),
          float4es = orThrow(c.get("float4es")(using Decoder.decodeArray[Float](using Decoder.decodeFloat, implicitly))),
          float8es = orThrow(c.get("float8es")(using Decoder.decodeArray[Double](using Decoder.decodeDouble, implicitly))),
          inetes = orThrow(c.get("inetes")(using Decoder.decodeArray[TypoInet](using TypoInet.decoder, implicitly))),
          int2es = orThrow(c.get("int2es")(using Decoder.decodeArray[TypoShort](using TypoShort.decoder, implicitly))),
          int2vectores = orThrow(c.get("int2vectores")(using Decoder.decodeArray[TypoInt2Vector](using TypoInt2Vector.decoder, implicitly))),
          int4es = orThrow(c.get("int4es")(using Decoder.decodeArray[Int](using Decoder.decodeInt, implicitly))),
          int8es = orThrow(c.get("int8es")(using Decoder.decodeArray[Long](using Decoder.decodeLong, implicitly))),
          intervales = orThrow(c.get("intervales")(using Decoder.decodeArray[TypoInterval](using TypoInterval.decoder, implicitly))),
          jsones = orThrow(c.get("jsones")(using Decoder.decodeArray[TypoJson](using TypoJson.decoder, implicitly))),
          jsonbes = orThrow(c.get("jsonbes")(using Decoder.decodeArray[TypoJsonb](using TypoJsonb.decoder, implicitly))),
          linees = orThrow(c.get("linees")(using Decoder.decodeArray[TypoLine](using TypoLine.decoder, implicitly))),
          lseges = orThrow(c.get("lseges")(using Decoder.decodeArray[TypoLineSegment](using TypoLineSegment.decoder, implicitly))),
          moneyes = orThrow(c.get("moneyes")(using Decoder.decodeArray[TypoMoney](using TypoMoney.decoder, implicitly))),
          mydomaines = orThrow(c.get("mydomaines")(using Decoder.decodeArray[Mydomain](using Mydomain.decoder, implicitly))),
          myenumes = orThrow(c.get("myenumes")(using Decoder.decodeArray[Myenum](using Myenum.decoder, implicitly))),
          namees = orThrow(c.get("namees")(using Decoder.decodeArray[String](using Decoder.decodeString, implicitly))),
          numerices = orThrow(c.get("numerices")(using Decoder.decodeArray[BigDecimal](using Decoder.decodeBigDecimal, implicitly))),
          pathes = orThrow(c.get("pathes")(using Decoder.decodeArray[TypoPath](using TypoPath.decoder, implicitly))),
          pointes = orThrow(c.get("pointes")(using Decoder.decodeArray[TypoPoint](using TypoPoint.decoder, implicitly))),
          polygones = orThrow(c.get("polygones")(using Decoder.decodeArray[TypoPolygon](using TypoPolygon.decoder, implicitly))),
          textes = orThrow(c.get("textes")(using Decoder.decodeArray[String](using Decoder.decodeString, implicitly))),
          timees = orThrow(c.get("timees")(using Decoder.decodeArray[TypoLocalTime](using TypoLocalTime.decoder, implicitly))),
          timestampes = orThrow(c.get("timestampes")(using Decoder.decodeArray[TypoLocalDateTime](using TypoLocalDateTime.decoder, implicitly))),
          timestampzes = orThrow(c.get("timestampzes")(using Decoder.decodeArray[TypoInstant](using TypoInstant.decoder, implicitly))),
          timezes = orThrow(c.get("timezes")(using Decoder.decodeArray[TypoOffsetTime](using TypoOffsetTime.decoder, implicitly))),
          uuides = orThrow(c.get("uuides")(using Decoder.decodeArray[TypoUUID](using TypoUUID.decoder, implicitly))),
          varchares = orThrow(c.get("varchares")(using Decoder.decodeArray[String](using Decoder.decodeString, implicitly))),
          xmles = orThrow(c.get("xmles")(using Decoder.decodeArray[TypoXml](using TypoXml.decoder, implicitly)))
        )
      }
    )
  }

  given encoder: Encoder[PgtestRow] = {
    Encoder.instance[PgtestRow](row =>
      Json.obj(
        ...
        "boxes" -> Encoder.encodeIterable[TypoBox, Array](using TypoBox.encoder, implicitly).apply(row.boxes),
        "bpchares" -> Encoder.encodeIterable[String, Array](using Encoder.encodeString, implicitly).apply(row.bpchares),
        "chares" -> Encoder.encodeIterable[String, Array](using Encoder.encodeString, implicitly).apply(row.chares),
        "circlees" -> Encoder.encodeIterable[TypoCircle, Array](using TypoCircle.encoder, implicitly).apply(row.circlees),
        "datees" -> Encoder.encodeIterable[TypoLocalDate, Array](using TypoLocalDate.encoder, implicitly).apply(row.datees),
        "float4es" -> Encoder.encodeIterable[Float, Array](using Encoder.encodeFloat, implicitly).apply(row.float4es),
        "float8es" -> Encoder.encodeIterable[Double, Array](using Encoder.encodeDouble, implicitly).apply(row.float8es),
        "inetes" -> Encoder.encodeIterable[TypoInet, Array](using TypoInet.encoder, implicitly).apply(row.inetes),
        "int2es" -> Encoder.encodeIterable[TypoShort, Array](using TypoShort.encoder, implicitly).apply(row.int2es),
        "int2vectores" -> Encoder.encodeIterable[TypoInt2Vector, Array](using TypoInt2Vector.encoder, implicitly).apply(row.int2vectores),
        "int4es" -> Encoder.encodeIterable[Int, Array](using Encoder.encodeInt, implicitly).apply(row.int4es),
        "int8es" -> Encoder.encodeIterable[Long, Array](using Encoder.encodeLong, implicitly).apply(row.int8es),
        "intervales" -> Encoder.encodeIterable[TypoInterval, Array](using TypoInterval.encoder, implicitly).apply(row.intervales),
        "jsones" -> Encoder.encodeIterable[TypoJson, Array](using TypoJson.encoder, implicitly).apply(row.jsones),
        "jsonbes" -> Encoder.encodeIterable[TypoJsonb, Array](using TypoJsonb.encoder, implicitly).apply(row.jsonbes),
        "linees" -> Encoder.encodeIterable[TypoLine, Array](using TypoLine.encoder, implicitly).apply(row.linees),
        "lseges" -> Encoder.encodeIterable[TypoLineSegment, Array](using TypoLineSegment.encoder, implicitly).apply(row.lseges),
        "moneyes" -> Encoder.encodeIterable[TypoMoney, Array](using TypoMoney.encoder, implicitly).apply(row.moneyes),
        "mydomaines" -> Encoder.encodeIterable[Mydomain, Array](using Mydomain.encoder, implicitly).apply(row.mydomaines),
        "myenumes" -> Encoder.encodeIterable[Myenum, Array](using Myenum.encoder, implicitly).apply(row.myenumes),
        "namees" -> Encoder.encodeIterable[String, Array](using Encoder.encodeString, implicitly).apply(row.namees),
        "numerices" -> Encoder.encodeIterable[BigDecimal, Array](using Encoder.encodeBigDecimal, implicitly).apply(row.numerices),
        "pathes" -> Encoder.encodeIterable[TypoPath, Array](using TypoPath.encoder, implicitly).apply(row.pathes),
        "pointes" -> Encoder.encodeIterable[TypoPoint, Array](using TypoPoint.encoder, implicitly).apply(row.pointes),
        "polygones" -> Encoder.encodeIterable[TypoPolygon, Array](using TypoPolygon.encoder, implicitly).apply(row.polygones),
        "textes" -> Encoder.encodeIterable[String, Array](using Encoder.encodeString, implicitly).apply(row.textes),
        "timees" -> Encoder.encodeIterable[TypoLocalTime, Array](using TypoLocalTime.encoder, implicitly).apply(row.timees),
        "timestampes" -> Encoder.encodeIterable[TypoLocalDateTime, Array](using TypoLocalDateTime.encoder, implicitly).apply(row.timestampes),
        "timestampzes" -> Encoder.encodeIterable[TypoInstant, Array](using TypoInstant.encoder, implicitly).apply(row.timestampzes),
        "timezes" -> Encoder.encodeIterable[TypoOffsetTime, Array](using TypoOffsetTime.encoder, implicitly).apply(row.timezes),
        "uuides" -> Encoder.encodeIterable[TypoUUID, Array](using TypoUUID.encoder, implicitly).apply(row.uuides),
        "varchares" -> Encoder.encodeIterable[String, Array](using Encoder.encodeString, implicitly).apply(row.varchares),
        "xmles" -> Encoder.encodeIterable[TypoXml, Array](using TypoXml.encoder, implicitly).apply(row.xmles)
      )
    )
  }
