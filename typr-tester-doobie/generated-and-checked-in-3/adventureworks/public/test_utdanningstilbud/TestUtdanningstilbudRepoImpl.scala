...
class TestUtdanningstilbudRepoImpl extends TestUtdanningstilbudRepo {
  ...
  override def upsertStreaming(
    ...
    for {
      ...
      _ <- new FragmentOps(sql"""copy test_utdanningstilbud_TEMP("organisasjonskode", "utdanningsmulighet_kode") from stdin""").copyIn(unsaved, batchSize)(using TestUtdanningstilbudRow.pgText)
