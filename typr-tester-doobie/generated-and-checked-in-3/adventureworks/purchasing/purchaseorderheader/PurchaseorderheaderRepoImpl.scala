...
class PurchaseorderheaderRepoImpl extends PurchaseorderheaderRepo {
  override def delete: DeleteBuilder[PurchaseorderheaderFields, PurchaseorderheaderRow] = DeleteBuilder.of(""""purchasing"."purchaseorderheader"""", PurchaseorderheaderFields.structure, PurchaseorderheaderRow.read)

  override def deleteById(purchaseorderid: PurchaseorderheaderId): ConnectionIO[Boolean] = sql"""delete from "purchasing"."purchaseorderheader" where "purchaseorderid" = ${fromWrite(purchaseorderid)(using new Write.Single(PurchaseorderheaderId.put))}""".update.run.map(_ > 0)

  override def deleteByIds(purchaseorderids: Array[PurchaseorderheaderId]): ConnectionIO[Int] = sql"""delete from "purchasing"."purchaseorderheader" where "purchaseorderid" = ANY(${fromWrite(purchaseorderids)(using new Write.Single(PurchaseorderheaderId.arrayPut))})""".update.run
  ...
  override def insert(unsaved: PurchaseorderheaderRow): ConnectionIO[PurchaseorderheaderRow] = {
    ...
    values (${fromWrite(unsaved.purchaseorderid)(using new Write.Single(PurchaseorderheaderId.put))}::int4, ${fromWrite(unsaved.revisionnumber)(using new Write.Single(TypoShort.put))}::int2, ${fromWrite(unsaved.status)(using new Write.Single(TypoShort.put))}::int2, ${fromWrite(unsaved.employeeid)(using new Write.Single(BusinessentityId.put))}::int4, ${fromWrite(unsaved.vendorid)(using new Write.Single(BusinessentityId.put))}::int4, ${fromWrite(unsaved.shipmethodid)(using new Write.Single(ShipmethodId.put))}::int4, ${fromWrite(unsaved.orderdate)(using new Write.Single(TypoLocalDateTime.put))}::timestamp, ${fromWrite(unsaved.shipdate)(using new Write.SingleOpt(TypoLocalDateTime.put))}::timestamp, ${fromWrite(unsaved.subtotal)(using new Write.Single(Meta.ScalaBigDecimalMeta.put))}::numeric, ${fromWrite(unsaved.taxamt)(using new Write.Single(Meta.ScalaBigDecimalMeta.put))}::numeric, ${fromWrite(unsaved.freight)(using new Write.Single(Meta.ScalaBigDecimalMeta.put))}::numeric, ${fromWrite(unsaved.modifieddate)(using new Write.Single(TypoLocalDateTime.put))}::timestamp)
  ...
  override def insert(unsaved: PurchaseorderheaderRowUnsaved): ConnectionIO[PurchaseorderheaderRow] = {
    val fs = List(
      Some((Fragment.const0(s""""employeeid""""), fr"${fromWrite(unsaved.employeeid)(using new Write.Single(BusinessentityId.put))}::int4")),
      Some((Fragment.const0(s""""vendorid""""), fr"${fromWrite(unsaved.vendorid)(using new Write.Single(BusinessentityId.put))}::int4")),
      ...
      unsaved.purchaseorderid match {
        ...
        case Defaulted.Provided(value) => Some((Fragment.const0(s""""purchaseorderid""""), fr"${fromWrite(value: PurchaseorderheaderId)(using new Write.Single(PurchaseorderheaderId.put))}::int4"))
      },
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  ): ConnectionIO[Long] = new FragmentOps(sql"""COPY "purchasing"."purchaseorderheader"("purchaseorderid", "revisionnumber", "status", "employeeid", "vendorid", "shipmethodid", "orderdate", "shipdate", "subtotal", "taxamt", "freight", "modifieddate") FROM STDIN""").copyIn(unsaved, batchSize)(using PurchaseorderheaderRow.pgText)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: Stream[ConnectionIO, PurchaseorderheaderRowUnsaved],
    batchSize: Int = 10000
  ): ConnectionIO[Long] = new FragmentOps(sql"""COPY "purchasing"."purchaseorderheader"("employeeid", "vendorid", "shipmethodid", "shipdate", "purchaseorderid", "revisionnumber", "status", "orderdate", "subtotal", "taxamt", "freight", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""").copyIn(unsaved, batchSize)(using PurchaseorderheaderRowUnsaved.pgText)

  override def select: SelectBuilder[PurchaseorderheaderFields, PurchaseorderheaderRow] = SelectBuilder.of(""""purchasing"."purchaseorderheader"""", PurchaseorderheaderFields.structure, PurchaseorderheaderRow.read)

  override def selectAll: Stream[ConnectionIO, PurchaseorderheaderRow] = sql"""select "purchaseorderid", "revisionnumber", "status", "employeeid", "vendorid", "shipmethodid", "orderdate"::text, "shipdate"::text, "subtotal", "taxamt", "freight", "modifieddate"::text from "purchasing"."purchaseorderheader"""".query(using PurchaseorderheaderRow.read).stream

  override def selectById(purchaseorderid: PurchaseorderheaderId): ConnectionIO[Option[PurchaseorderheaderRow]] = sql"""select "purchaseorderid", "revisionnumber", "status", "employeeid", "vendorid", "shipmethodid", "orderdate"::text, "shipdate"::text, "subtotal", "taxamt", "freight", "modifieddate"::text from "purchasing"."purchaseorderheader" where "purchaseorderid" = ${fromWrite(purchaseorderid)(using new Write.Single(PurchaseorderheaderId.put))}""".query(using PurchaseorderheaderRow.read).option

  override def selectByIds(purchaseorderids: Array[PurchaseorderheaderId]): Stream[ConnectionIO, PurchaseorderheaderRow] = sql"""select "purchaseorderid", "revisionnumber", "status", "employeeid", "vendorid", "shipmethodid", "orderdate"::text, "shipdate"::text, "subtotal", "taxamt", "freight", "modifieddate"::text from "purchasing"."purchaseorderheader" where "purchaseorderid" = ANY(${fromWrite(purchaseorderids)(using new Write.Single(PurchaseorderheaderId.arrayPut))})""".query(using PurchaseorderheaderRow.read).stream
  ...
  override def update: UpdateBuilder[PurchaseorderheaderFields, PurchaseorderheaderRow] = UpdateBuilder.of(""""purchasing"."purchaseorderheader"""", PurchaseorderheaderFields.structure, PurchaseorderheaderRow.read)
  ...
  override def update(row: PurchaseorderheaderRow): ConnectionIO[Option[PurchaseorderheaderRow]] = {
    ...
    "employeeid" = ${fromWrite(row.employeeid)(using new Write.Single(BusinessentityId.put))}::int4,
    "vendorid" = ${fromWrite(row.vendorid)(using new Write.Single(BusinessentityId.put))}::int4,
    ...
    where "purchaseorderid" = ${fromWrite(purchaseorderid)(using new Write.Single(PurchaseorderheaderId.put))}
  ...
  override def upsert(unsaved: PurchaseorderheaderRow): ConnectionIO[PurchaseorderheaderRow] = {
    sql"""insert into "purchasing"."purchaseorderheader"("purchaseorderid", "revisionnumber", "status", "employeeid", "vendorid", "shipmethodid", "orderdate", "shipdate", "subtotal", "taxamt", "freight", "modifieddate")
    values (
      ${fromWrite(unsaved.purchaseorderid)(using new Write.Single(PurchaseorderheaderId.put))}::int4,
    ...
    ${fromWrite(unsaved.employeeid)(using new Write.Single(BusinessentityId.put))}::int4,
    ${fromWrite(unsaved.vendorid)(using new Write.Single(BusinessentityId.put))}::int4,
  ...
  override def upsertStreaming(
    ...
    for {
      ...
      _ <- new FragmentOps(sql"""copy purchaseorderheader_TEMP("purchaseorderid", "revisionnumber", "status", "employeeid", "vendorid", "shipmethodid", "orderdate", "shipdate", "subtotal", "taxamt", "freight", "modifieddate") from stdin""").copyIn(unsaved, batchSize)(using PurchaseorderheaderRow.pgText)
