...
trait ProductinventoryFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductinventoryId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[ProductinventoryId](productid)(_.productid)(using as[Array[ProductId]](using ProductId.arrayPut), implicitly), TuplePart[ProductinventoryId](locationid)(_.locationid)(using as[Array[LocationId]](using LocationId.arrayPut), implicitly))
