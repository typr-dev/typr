...
trait ProductmodelproductdescriptioncultureFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductmodelproductdescriptioncultureId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[ProductmodelproductdescriptioncultureId](productmodelid)(_.productmodelid)(using as[Array[ProductmodelId]](using ProductmodelId.arrayPut), implicitly), TuplePart[ProductmodelproductdescriptioncultureId](productdescriptionid)(_.productdescriptionid)(using as[Array[ProductdescriptionId]](using ProductdescriptionId.arrayPut), implicitly), TuplePart[ProductmodelproductdescriptioncultureId](cultureid)(_.cultureid)(using as[Array[CultureId]](using CultureId.arrayPut), implicitly))
