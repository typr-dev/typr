...
object ProductmodelproductdescriptioncultureRow {
  ...
  given pgText: Text[ProductmodelproductdescriptioncultureRow] = {
  ...
  given read: Read[ProductmodelproductdescriptioncultureRow] = {
  ...
  given write: Write[ProductmodelproductdescriptioncultureRow] = {
    new Write.Composite[ProductmodelproductdescriptioncultureRow](
