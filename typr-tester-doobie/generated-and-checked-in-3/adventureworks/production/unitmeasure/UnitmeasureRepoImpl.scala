...
class UnitmeasureRepoImpl extends UnitmeasureRepo {
  ...
  override def deleteById(unitmeasurecode: UnitmeasureId): ConnectionIO[Boolean] = sql"""delete from "production"."unitmeasure" where "unitmeasurecode" = ${fromWrite(unitmeasurecode)(using new Write.Single(UnitmeasureId.put))}""".update.run.map(_ > 0)

  override def deleteByIds(unitmeasurecodes: Array[UnitmeasureId]): ConnectionIO[Int] = sql"""delete from "production"."unitmeasure" where "unitmeasurecode" = ANY(${fromWrite(unitmeasurecodes)(using new Write.Single(UnitmeasureId.arrayPut))})""".update.run
  ...
  override def insert(unsaved: UnitmeasureRow): ConnectionIO[UnitmeasureRow] = {
    ...
    values (${fromWrite(unsaved.unitmeasurecode)(using new Write.Single(UnitmeasureId.put))}::bpchar, ${fromWrite(unsaved.name)(using new Write.Single(Name.put))}::varchar, ${fromWrite(unsaved.modifieddate)(using new Write.Single(TypoLocalDateTime.put))}::timestamp)
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  ): ConnectionIO[Long] = new FragmentOps(sql"""COPY "production"."unitmeasure"("unitmeasurecode", "name", "modifieddate") FROM STDIN""").copyIn(unsaved, batchSize)(using UnitmeasureRow.pgText)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: Stream[ConnectionIO, UnitmeasureRowUnsaved],
    batchSize: Int = 10000
  ): ConnectionIO[Long] = new FragmentOps(sql"""COPY "production"."unitmeasure"("unitmeasurecode", "name", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""").copyIn(unsaved, batchSize)(using UnitmeasureRowUnsaved.pgText)
  ...
  override def selectAll: Stream[ConnectionIO, UnitmeasureRow] = sql"""select "unitmeasurecode", "name", "modifieddate"::text from "production"."unitmeasure"""".query(using UnitmeasureRow.read).stream

  override def selectById(unitmeasurecode: UnitmeasureId): ConnectionIO[Option[UnitmeasureRow]] = sql"""select "unitmeasurecode", "name", "modifieddate"::text from "production"."unitmeasure" where "unitmeasurecode" = ${fromWrite(unitmeasurecode)(using new Write.Single(UnitmeasureId.put))}""".query(using UnitmeasureRow.read).option

  override def selectByIds(unitmeasurecodes: Array[UnitmeasureId]): Stream[ConnectionIO, UnitmeasureRow] = sql"""select "unitmeasurecode", "name", "modifieddate"::text from "production"."unitmeasure" where "unitmeasurecode" = ANY(${fromWrite(unitmeasurecodes)(using new Write.Single(UnitmeasureId.arrayPut))})""".query(using UnitmeasureRow.read).stream
  ...
  override def update(row: UnitmeasureRow): ConnectionIO[Option[UnitmeasureRow]] = {
    ...
    where "unitmeasurecode" = ${fromWrite(unitmeasurecode)(using new Write.Single(UnitmeasureId.put))}
  ...
  override def upsertStreaming(
    ...
    for {
      ...
      _ <- new FragmentOps(sql"""copy unitmeasure_TEMP("unitmeasurecode", "name", "modifieddate") from stdin""").copyIn(unsaved, batchSize)(using UnitmeasureRow.pgText)
