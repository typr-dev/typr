...
object EmployeeFields {
  lazy val structure: RelationStructure[EmployeeFields, EmployeeRow] =
    new Impl(List())

  private final class Impl(val _path: List[Path])
    extends RelationStructure[EmployeeFields, EmployeeRow] {
    ...
    override lazy val fields: EmployeeFields = new EmployeeFields {
      ...
      override def nationalidnumber = Field[String, EmployeeRow](_path, "nationalidnumber", None, None, x => x.nationalidnumber, (row, value) => row.copy(nationalidnumber = value))
      override def loginid = Field[String, EmployeeRow](_path, "loginid", None, None, x => x.loginid, (row, value) => row.copy(loginid = value))
      override def jobtitle = Field[String, EmployeeRow](_path, "jobtitle", None, None, x => x.jobtitle, (row, value) => row.copy(jobtitle = value))
