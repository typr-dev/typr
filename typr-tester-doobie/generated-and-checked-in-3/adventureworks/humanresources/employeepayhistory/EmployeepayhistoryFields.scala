...
trait EmployeepayhistoryFields {
  ...
  def compositeIdIn(compositeIds: Array[EmployeepayhistoryId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[EmployeepayhistoryId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId]](using BusinessentityId.arrayPut), implicitly), TuplePart[EmployeepayhistoryId](ratechangedate)(_.ratechangedate)(using as[Array[TypoLocalDateTime]](using TypoLocalDateTime.arrayPut), implicitly))
