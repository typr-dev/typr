    ...
    Decoder.instanceTry[SohViewRow]((c: HCursor) =>
      Try {
        ...
        SohViewRow(
          ...
          shipdate = orThrow(c.get("shipdate")(using TypoLocalDateTime.decoder)),
          status = orThrow(c.get("status")(using TypoShort.decoder)),
          onlineorderflag = orThrow(c.get("onlineorderflag")(using Flag.decoder)),
          purchaseordernumber = orThrow(c.get("purchaseordernumber")(using OrderNumber.decoder)),
          accountnumber = orThrow(c.get("accountnumber")(using AccountNumber.decoder)),
          customerid = orThrow(c.get("customerid")(using CustomerId.decoder)),
          salespersonid = orThrow(c.get("salespersonid")(using BusinessentityId.decoder)),
          territoryid = orThrow(c.get("territoryid")(using SalesterritoryId.decoder)),
          ...
          creditcardid = orThrow(c.get("creditcardid")(using CustomCreditcardId.decoder)),
          creditcardapprovalcode = orThrow(c.get("creditcardapprovalcode")(using Decoder.decodeString)),
          currencyrateid = orThrow(c.get("currencyrateid")(using CurrencyrateId.decoder)),
          ...
          totaldue = orThrow(c.get("totaldue")(using Decoder.decodeBigDecimal)),
          comment = orThrow(c.get("comment")(using Decoder.decodeString)),
