...
object SoViewFields {
  lazy val structure: RelationStructure[SoViewFields, SoViewRow] =
    new Impl(List())

  private final class Impl(val _path: List[Path])
    extends RelationStructure[SoViewFields, SoViewRow] {
    ...
    override lazy val fields: SoViewFields = new SoViewFields {
      ...
      override def description = Field[String, SoViewRow](_path, "description", None, None, x => x.description, (row, value) => row.copy(description = value))
      ...
      override def `type` = Field[String, SoViewRow](_path, "type", None, None, x => x.`type`, (row, value) => row.copy(`type` = value))
      override def category = Field[String, SoViewRow](_path, "category", None, None, x => x.category, (row, value) => row.copy(category = value))
      ...
      override def maxqty = Field[Int, SoViewRow](_path, "maxqty", None, None, x => x.maxqty, (row, value) => row.copy(maxqty = value))
