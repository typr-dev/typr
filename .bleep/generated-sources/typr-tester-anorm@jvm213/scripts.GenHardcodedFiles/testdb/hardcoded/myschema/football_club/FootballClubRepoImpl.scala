...
class FootballClubRepoImpl extends FootballClubRepo {
  ...
  override def deleteById(id: FootballClubId)(implicit c: Connection): Boolean = SQL"""delete from "myschema"."football_club" where "id" = ${ParameterValue(id, null, FootballClubId.toStatement)}""".executeUpdate() > 0
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  )(implicit c: Connection): Long = streamingInsert(s"""COPY "myschema"."football_club"("id", "name") FROM STDIN""", batchSize, unsaved)(FootballClubRow.pgText, c)
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy football_club_TEMP("id", "name") from stdin""", batchSize, unsaved)(FootballClubRow.pgText, c): @nowarn
    SQL"""insert into "myschema"."football_club"("id", "name")
