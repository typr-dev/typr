...
class MaritalStatusRepoImpl extends MaritalStatusRepo {
  ...
  override def deleteById(id: MaritalStatusId)(implicit c: Connection): Boolean = SQL"""delete from "myschema"."marital_status" where "id" = ${ParameterValue(id, null, MaritalStatusId.toStatement)}""".executeUpdate() > 0
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  )(implicit c: Connection): Long = streamingInsert(s"""COPY "myschema"."marital_status"("id") FROM STDIN""", batchSize, unsaved)(MaritalStatusRow.pgText, c)
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy marital_status_TEMP("id") from stdin""", batchSize, unsaved)(MaritalStatusRow.pgText, c): @nowarn
    SQL"""insert into "myschema"."marital_status"("id")
