...
trait PersonFields {
  ...
  def email: Field[String, PersonRow]
  def phone: Field[String, PersonRow]
...
object PersonFields {
  ...
  private final class Impl(val _path: List[Path])
    ...
    override lazy val fields: PersonFields = new PersonFields {
      ...
      override def email = Field[String, PersonRow](_path, "email", None, None, x => x.email, (row, value) => row.copy(email = value))
      override def phone = Field[String, PersonRow](_path, "phone", None, None, x => x.phone, (row, value) => row.copy(phone = value))
