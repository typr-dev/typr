...
class PersonRepoImpl extends PersonRepo {
  ...
  override def deleteById(id: PersonId): ConnectionIO[Boolean] = sql"""delete from "myschema"."person" where "id" = ${fromWrite(id)(new Write.Single(PersonId.put))}""".update.run.map(_ > 0)

  override def deleteByIds(ids: Array[PersonId]): ConnectionIO[Int] = sql"""delete from "myschema"."person" where "id" = ANY(${fromWrite(ids)(new Write.Single(PersonId.arrayPut))})""".update.run
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  ): ConnectionIO[Long] = new FragmentOps(sql"""COPY "myschema"."person"("id", "favourite_football_club_id", "name", "nick_name", "blog_url", "email", "phone", "likes_pizza", "marital_status_id", "work_email", "favorite_number") FROM STDIN""").copyIn(unsaved, batchSize)(PersonRow.pgText)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: Stream[ConnectionIO, PersonRowUnsaved],
    batchSize: Int = 10000
  ): ConnectionIO[Long] = new FragmentOps(sql"""COPY "myschema"."person"("favourite_football_club_id", "name", "nick_name", "blog_url", "email", "phone", "likes_pizza", "work_email", "id", "marital_status_id", "favorite_number") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""").copyIn(unsaved, batchSize)(PersonRowUnsaved.pgText)
  ...
  override def selectAll: Stream[ConnectionIO, PersonRow] = sql"""select "id", "favourite_football_club_id", "name", "nick_name", "blog_url", "email", "phone", "likes_pizza", "marital_status_id", "work_email", "sector", "favorite_number" from "myschema"."person"""".query(PersonRow.read).stream
  ...
  override def selectById(id: PersonId): ConnectionIO[Option[PersonRow]] = sql"""select "id", "favourite_football_club_id", "name", "nick_name", "blog_url", "email", "phone", "likes_pizza", "marital_status_id", "work_email", "sector", "favorite_number" from "myschema"."person" where "id" = ${fromWrite(id)(new Write.Single(PersonId.put))}""".query(PersonRow.read).option

  override def selectByIds(ids: Array[PersonId]): Stream[ConnectionIO, PersonRow] = sql"""select "id", "favourite_football_club_id", "name", "nick_name", "blog_url", "email", "phone", "likes_pizza", "marital_status_id", "work_email", "sector", "favorite_number" from "myschema"."person" where "id" = ANY(${fromWrite(ids)(new Write.Single(PersonId.arrayPut))})""".query(PersonRow.read).stream
    ...
    NonEmptyList.fromList(fieldValues) match {
      ...
      case Some(nonEmpty) =>
        val updates = fragments.set(
          nonEmpty.map {
            case PersonFieldValue.id(value) => fr""""id" = ${fromWrite(value)(new Write.Single(PersonId.put))}::int8"""
            case PersonFieldValue.favouriteFootballClubId(value) => fr""""favourite_football_club_id" = ${fromWrite(value)(new Write.Single(FootballClubId.put))}"""
            case PersonFieldValue.name(value) => fr""""name" = ${fromWrite(value)(new Write.Single(Meta.StringMeta.put))}"""
            case PersonFieldValue.nickName(value) => fr""""nick_name" = ${fromWrite(value)(new Write.SingleOpt(Meta.StringMeta.put))}"""
            case PersonFieldValue.blogUrl(value) => fr""""blog_url" = ${fromWrite(value)(new Write.SingleOpt(Meta.StringMeta.put))}"""
  ...
  override def upsertStreaming(
    ...
    for {
      ...
      _ <- new FragmentOps(sql"""copy person_TEMP("id", "favourite_football_club_id", "name", "nick_name", "blog_url", "email", "phone", "likes_pizza", "marital_status_id", "work_email", "favorite_number") from stdin""").copyIn(unsaved, batchSize)(PersonRow.pgText)
