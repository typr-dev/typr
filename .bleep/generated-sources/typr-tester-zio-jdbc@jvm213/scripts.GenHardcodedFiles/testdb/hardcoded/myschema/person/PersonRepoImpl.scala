...
class PersonRepoImpl extends PersonRepo {
  ...
  override def deleteById(id: PersonId): ZIO[ZConnection, Throwable, Boolean] = sql"""delete from "myschema"."person" where "id" = ${Segment.paramSegment(id)(PersonId.setter)}""".delete.map(_ > 0)

  override def deleteByIds(ids: Array[PersonId]): ZIO[ZConnection, Throwable, Long] = sql"""delete from "myschema"."person" where "id" = ANY(${Segment.paramSegment(ids)(PersonId.arraySetter)})""".delete
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  ): ZIO[ZConnection, Throwable, Long] = streamingInsert(s"""COPY "myschema"."person"("id", "favourite_football_club_id", "name", "nick_name", "blog_url", "email", "phone", "likes_pizza", "marital_status_id", "work_email", "favorite_number") FROM STDIN""", batchSize, unsaved)(PersonRow.pgText)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: ZStream[ZConnection, Throwable, PersonRowUnsaved],
    batchSize: Int = 10000
  ): ZIO[ZConnection, Throwable, Long] = streamingInsert(s"""COPY "myschema"."person"("favourite_football_club_id", "name", "nick_name", "blog_url", "email", "phone", "likes_pizza", "work_email", "id", "marital_status_id", "favorite_number") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(PersonRowUnsaved.pgText)
  ...
  override def selectAll: ZStream[ZConnection, Throwable, PersonRow] = sql"""select "id", "favourite_football_club_id", "name", "nick_name", "blog_url", "email", "phone", "likes_pizza", "marital_status_id", "work_email", "sector", "favorite_number" from "myschema"."person"""".query(PersonRow.jdbcDecoder).selectStream()
  ...
  override def selectById(id: PersonId): ZIO[ZConnection, Throwable, Option[PersonRow]] = sql"""select "id", "favourite_football_club_id", "name", "nick_name", "blog_url", "email", "phone", "likes_pizza", "marital_status_id", "work_email", "sector", "favorite_number" from "myschema"."person" where "id" = ${Segment.paramSegment(id)(PersonId.setter)}""".query(PersonRow.jdbcDecoder).selectOne

  override def selectByIds(ids: Array[PersonId]): ZStream[ZConnection, Throwable, PersonRow] = sql"""select "id", "favourite_football_club_id", "name", "nick_name", "blog_url", "email", "phone", "likes_pizza", "marital_status_id", "work_email", "sector", "favorite_number" from "myschema"."person" where "id" = ANY(${Segment.paramSegment(ids)(PersonId.arraySetter)})""".query(PersonRow.jdbcDecoder).selectStream()
  ...
  override def upsertStreaming(
    ...
    val copied = streamingInsert(s"""copy person_TEMP("id", "favourite_football_club_id", "name", "nick_name", "blog_url", "email", "phone", "likes_pizza", "marital_status_id", "work_email", "favorite_number") from stdin""", batchSize, unsaved)(PersonRow.pgText)
