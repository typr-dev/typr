...
case class EnumsSqlRow(
   ...
   */
  enumName: String,
  /** Points to [[typr.generated.pg_catalog.pg_enum.PgEnumRow.enumsortorder]]
   ...
   */
  enumSortOrder: Float,
  /** Points to [[typr.generated.pg_catalog.pg_enum.PgEnumRow.enumlabel]]
...
object EnumsSqlRow {
  ...
  def rowParser(idx: Int): RowParser[EnumsSqlRow] = {
