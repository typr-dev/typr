...
trait Lang {
  ...
  /** Array equality check. Java/Scala: Arrays.equals(left, right), Kotlin: left.contentEquals(right) */
  def arrayEquals(left: jvm.Code, right: jvm.Code): jvm.Code

  /** Array hash code. Java/Scala: Arrays.hashCode(arr), Kotlin: arr.contentHashCode() */
  def arrayHashCode(arr: jvm.Code): jvm.Code

  /** Strip leading and trailing whitespace. Java/Scala: expr.strip(), Kotlin: expr.trim() */
  def strip(expr: jvm.Code): jvm.Code

  /** Strip trailing whitespace. Java/Scala: expr.stripTrailing(), Kotlin: expr.trimEnd() */
  def stripTrailing(expr: jvm.Code): jvm.Code

  /** BigDecimal zero constant. Scala (native): BigDecimal(0), Java/Kotlin: BigDecimal.ZERO */
  def bigDecimalZero: jvm.Code

  /** BigInteger zero constant. Scala (native): BigInt(0), Java/Kotlin: BigInteger.ZERO */
  def bigIntegerZero: jvm.Code

  /** Create BigDecimal from Long. Scala (native): BigDecimal(v), Java/Kotlin: BigDecimal.valueOf(v) */
  def bigDecimalFromLong(v: jvm.Code): jvm.Code

  /** Create BigInteger from Long. Scala (native): BigInt(v), Java/Kotlin: BigInteger.valueOf(v) */
  def bigIntegerFromLong(v: jvm.Code): jvm.Code

  /** Get runtime class name. Java/Scala: expr.getClass().getName(), Kotlin: expr.javaClass.name */
  def getClassName(expr: jvm.Code): jvm.Code
