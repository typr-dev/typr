...
object ModelClass {
  ...
  case class EnumType(
      ...
      /** Parent sum types this enum belongs to (for discriminated unions) */
      sumTypeParents: List[String] = Nil
  ) extends ModelClass
  ...
  case class WrapperType(
      ...
      description: Option[String],
      underlying: TypeInfo,
      /** Parent sum types this wrapper belongs to (for discriminated unions) */
      sumTypeParents: List[String] = Nil
  ) extends ModelClass
