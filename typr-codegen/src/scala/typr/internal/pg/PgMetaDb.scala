...
import typr.generated.custom.table_comments.*
import typr.generated.custom.view_find_all.*
import typr.generated.information_schema.columns.{ColumnsViewRepoImpl, ColumnsViewRow}
import typr.generated.information_schema.key_column_usage.{KeyColumnUsageViewRepoImpl, KeyColumnUsageViewRow}
import typr.generated.information_schema.referential_constraints.{ReferentialConstraintsViewRepoImpl, ReferentialConstraintsViewRow}
import typr.generated.information_schema.table_constraints.{TableConstraintsViewRepoImpl, TableConstraintsViewRow}
import typr.generated.information_schema.tables.{TablesViewRepoImpl, TablesViewRow}
...
object PgMetaDb {
  ...
  object Input {
    ...
    private def analyzeViewsWithSqlglot(
      ...
      val sqlglotResults: Map[String, SqlglotFileResult] = SqlglotAnalyzer.analyze(config, input, Some(logger)) match {
