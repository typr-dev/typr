...
object TypesScala {
  ...
  val BigInt = jvm.Type.Qualified("scala.math.BigInt")
  ...
  val ListBuffer = jvm.Type.Qualified("scala.collection.mutable.ListBuffer")
  ...
  val Nothing = jvm.Type.Qualified("scala.Nothing")
