...
object FoundationsTypes {
  ...
  object runtime {
    ...
    val Bit: Qualified = Qualified(s"$dataPackage.Bit")
    val Varbit: Qualified = Qualified(s"$dataPackage.Varbit")
  ...
  object scala {
    private val scalaPackage = "dev.typr.foundationssc"
  ...
  object kotlin {
    private val kotlinPackage = "dev.typr.foundationskt"
  ...
  /** typr-side Inserter that takes `dev.typr.foundations.Connection` (not java.sql.Connection). */
  val Inserter: Qualified = Qualified("dev.typr.dsl.Inserter")
  val DbText: Qualified = Qualified("dev.typr.foundations.DbText")

  def RowCodecsFunctionN(n: Int): Qualified = Qualified(s"dev.typr.dsl.RowCodecs.Function$n")
