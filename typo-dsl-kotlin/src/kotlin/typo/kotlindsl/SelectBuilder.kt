...
class SelectBuilder<Fields, Row> internal constructor(
     ...
     */
    fun <G> groupBy(groupKey: (Fields) -> SqlExpr<G>): typo.dsl.GroupedBuilder<Fields, Row> {
     ...
     */
    fun groupByExpr(groupKeys: (Fields) -> List<SqlExpr<*>>): typo.dsl.GroupedBuilder<Fields, Row> {
