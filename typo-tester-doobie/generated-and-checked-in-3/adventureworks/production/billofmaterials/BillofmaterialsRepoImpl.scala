...
class BillofmaterialsRepoImpl extends BillofmaterialsRepo {
  ...
  override def deleteById(billofmaterialsid: Int): ConnectionIO[Boolean] = {
    sql"""delete from "production"."billofmaterials" where "billofmaterialsid" = ${fromWrite(billofmaterialsid)(using new Write.Single(Meta.IntMeta.put))}""".update.run.map(_ > 0)
  }
