...
object TransactionhistoryarchiveRow {
  ...
  given read: Read[TransactionhistoryarchiveRow] = new Read.CompositeOfInstances(Array(
  ...
  given write: Write[TransactionhistoryarchiveRow] = new Write.Composite[TransactionhistoryarchiveRow](
