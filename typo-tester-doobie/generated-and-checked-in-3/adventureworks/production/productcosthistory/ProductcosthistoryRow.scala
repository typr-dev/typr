...
object ProductcosthistoryRow {
  ...
  given read: Read[ProductcosthistoryRow] = new Read.CompositeOfInstances(Array(
  ...
  given text: Text[ProductcosthistoryRow] = Text.instance[ProductcosthistoryRow]{ (row, sb) =>
  ...
  given write: Write[ProductcosthistoryRow] = new Write.Composite[ProductcosthistoryRow](
