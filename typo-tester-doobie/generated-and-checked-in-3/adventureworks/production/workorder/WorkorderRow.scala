...
object WorkorderRow {
  ...
  given read: Read[WorkorderRow] = new Read.CompositeOfInstances(Array(
  ...
  given text: Text[WorkorderRow] = Text.instance[WorkorderRow]{ (row, sb) =>
  ...
  given write: Write[WorkorderRow] = new Write.Composite[WorkorderRow](
