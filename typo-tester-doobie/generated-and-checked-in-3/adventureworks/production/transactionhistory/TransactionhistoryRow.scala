...
object TransactionhistoryRow {
  ...
  given read: Read[TransactionhistoryRow] = new Read.CompositeOfInstances(Array(
  ...
  given text: Text[TransactionhistoryRow] = Text.instance[TransactionhistoryRow]{ (row, sb) =>
  ...
  given write: Write[TransactionhistoryRow] = new Write.Composite[TransactionhistoryRow](
