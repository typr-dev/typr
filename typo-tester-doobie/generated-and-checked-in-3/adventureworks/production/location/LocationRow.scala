...
object LocationRow {
  ...
  given read: Read[LocationRow] = new Read.CompositeOfInstances(Array(
  ...
  given text: Text[LocationRow] = Text.instance[LocationRow]{ (row, sb) =>
  ...
  given write: Write[LocationRow] = new Write.Composite[LocationRow](
