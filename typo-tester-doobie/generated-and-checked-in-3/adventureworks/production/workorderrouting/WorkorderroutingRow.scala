...
object WorkorderroutingRow {
  ...
  given read: Read[WorkorderroutingRow] = new Read.CompositeOfInstances(Array(
  ...
  given text: Text[WorkorderroutingRow] = Text.instance[WorkorderroutingRow]{ (row, sb) =>
  ...
  given write: Write[WorkorderroutingRow] = new Write.Composite[WorkorderroutingRow](
