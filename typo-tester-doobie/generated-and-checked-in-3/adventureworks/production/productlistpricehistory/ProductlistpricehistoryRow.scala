...
object ProductlistpricehistoryRow {
  ...
  given read: Read[ProductlistpricehistoryRow] = new Read.CompositeOfInstances(Array(
  ...
  given write: Write[ProductlistpricehistoryRow] = new Write.Composite[ProductlistpricehistoryRow](
