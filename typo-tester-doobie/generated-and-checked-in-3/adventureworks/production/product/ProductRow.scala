...
object ProductRow {
  given decoder: Decoder[ProductRow] = {
  ...
  given encoder: Encoder[ProductRow] = {
    Encoder.instance[ProductRow](row =>
      Json.obj(
  ...
  given write: Write[ProductRow] = {
    new Write.Composite[ProductRow](
