...
object ProductRow {
  given decoder: Decoder[ProductRow] = Decoder.instanceTry[ProductRow]((c: HCursor) =>
    Try {
      ...
      ProductRow(
        productid = orThrow(c.get("productid")(using ProductId.decoder)),
        name = orThrow(c.get("name")(using Name.decoder)),
        productnumber = orThrow(c.get("productnumber")(using Decoder.decodeString)),
        makeflag = orThrow(c.get("makeflag")(using Flag.decoder)),
        finishedgoodsflag = orThrow(c.get("finishedgoodsflag")(using Flag.decoder)),
  ...
  given encoder: Encoder[ProductRow] = Encoder.instance[ProductRow](row =>
    Json.obj(
  ...
  given read: Read[ProductRow] = new Read.CompositeOfInstances(Array(
  ...
  given write: Write[ProductRow] = new Write.Composite[ProductRow](
