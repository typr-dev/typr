...
object SohViewRow {
  given decoder: Decoder[SohViewRow] = Decoder.instanceTry[SohViewRow]((c: HCursor) =>
    Try {
  ...
  given encoder: Encoder[SohViewRow] = Encoder.instance[SohViewRow](row =>
    Json.obj(
  ...
  given read: Read[SohViewRow] = new Read.CompositeOfInstances(Array(
