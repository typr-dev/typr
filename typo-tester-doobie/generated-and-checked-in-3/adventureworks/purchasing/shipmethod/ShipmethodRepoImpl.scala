...
class ShipmethodRepoImpl extends ShipmethodRepo {
  ...
  override def deleteById(shipmethodid: ShipmethodId): ConnectionIO[Boolean] = {
    sql"""delete from "purchasing"."shipmethod" where "shipmethodid" = ${fromWrite(shipmethodid)(using new Write.Single(ShipmethodId.put))}""".update.run.map(_ > 0)
  }
  ...
  override def selectById(shipmethodid: ShipmethodId): ConnectionIO[Option[ShipmethodRow]] = {
    sql"""select "shipmethodid", "name", "shipbase", "shiprate", "rowguid", "modifieddate"::text from "purchasing"."shipmethod" where "shipmethodid" = ${fromWrite(shipmethodid)(using new Write.Single(ShipmethodId.put))}""".query(using ShipmethodRow.read).option
  }
