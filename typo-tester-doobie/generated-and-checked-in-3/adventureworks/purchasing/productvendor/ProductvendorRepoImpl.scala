...
class ProductvendorRepoImpl extends ProductvendorRepo {
  ...
  override def insert(unsaved: ProductvendorRowUnsaved): ConnectionIO[ProductvendorRow] = {
    val fs = List(
      ...
      Some((Fragment.const0(s""""averageleadtime""""), fr"${fromWrite(unsaved.averageleadtime)(using new Write.Single(Meta.IntMeta.put))}::int4")),
      Some((Fragment.const0(s""""standardprice""""), fr"${fromWrite(unsaved.standardprice)(using new Write.Single(Meta.ScalaBigDecimalMeta.put))}::numeric")),
      Some((Fragment.const0(s""""lastreceiptcost""""), fr"${fromWrite(unsaved.lastreceiptcost)(using new Write.SingleOpt(Meta.ScalaBigDecimalMeta.put))}::numeric")),
      Some((Fragment.const0(s""""lastreceiptdate""""), fr"${fromWrite(unsaved.lastreceiptdate)(using new Write.SingleOpt(TypoLocalDateTime.put))}::timestamp")),
      Some((Fragment.const0(s""""minorderqty""""), fr"${fromWrite(unsaved.minorderqty)(using new Write.Single(Meta.IntMeta.put))}::int4")),
      Some((Fragment.const0(s""""maxorderqty""""), fr"${fromWrite(unsaved.maxorderqty)(using new Write.Single(Meta.IntMeta.put))}::int4")),
