...
object ProductvendorRow {
  ...
  given read: Read[ProductvendorRow] = new Read.CompositeOfInstances(Array(
  ...
  given text: Text[ProductvendorRow] = Text.instance[ProductvendorRow]{ (row, sb) =>
    ...
    sb.append(Text.DELIMETER)
    Text.option(using TypoLocalDateTime.text).unsafeEncode(row.lastreceiptdate, sb)
    sb.append(Text.DELIMETER)
  ...
  given write: Write[ProductvendorRow] = new Write.Composite[ProductvendorRow](
