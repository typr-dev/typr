...
object SalesterritoryRow {
  ...
  given read: Read[SalesterritoryRow] = new Read.CompositeOfInstances(Array(
  ...
  given text: Text[SalesterritoryRow] = Text.instance[SalesterritoryRow]{ (row, sb) =>
  ...
  given write: Write[SalesterritoryRow] = new Write.Composite[SalesterritoryRow](
