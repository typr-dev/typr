...
object CountryregioncurrencyRow {
  ...
  given read: Read[CountryregioncurrencyRow] = new Read.CompositeOfInstances(Array(
  ...
  given text: Text[CountryregioncurrencyRow] = Text.instance[CountryregioncurrencyRow]{ (row, sb) =>
  ...
  given write: Write[CountryregioncurrencyRow] = new Write.Composite[CountryregioncurrencyRow](
