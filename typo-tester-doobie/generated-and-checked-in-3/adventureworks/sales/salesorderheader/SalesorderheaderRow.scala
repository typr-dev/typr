...
object SalesorderheaderRow {
  given decoder: Decoder[SalesorderheaderRow] = Decoder.instanceTry[SalesorderheaderRow]((c: HCursor) =>
    Try {
  ...
  given encoder: Encoder[SalesorderheaderRow] = Encoder.instance[SalesorderheaderRow](row =>
    Json.obj(
  ...
  given read: Read[SalesorderheaderRow] = new Read.CompositeOfInstances(Array(
  ...
  given write: Write[SalesorderheaderRow] = new Write.Composite[SalesorderheaderRow](
