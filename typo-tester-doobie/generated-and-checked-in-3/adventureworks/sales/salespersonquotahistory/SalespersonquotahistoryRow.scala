...
object SalespersonquotahistoryRow {
  ...
  given read: Read[SalespersonquotahistoryRow] = new Read.CompositeOfInstances(Array(
  ...
  given write: Write[SalespersonquotahistoryRow] = new Write.Composite[SalespersonquotahistoryRow](
