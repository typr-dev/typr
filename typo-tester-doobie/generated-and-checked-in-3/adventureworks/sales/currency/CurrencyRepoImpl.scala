...
class CurrencyRepoImpl extends CurrencyRepo {
  ...
  override def deleteById(currencycode: CurrencyId): ConnectionIO[Boolean] = {
    sql"""delete from "sales"."currency" where "currencycode" = ${fromWrite(currencycode)(using new Write.Single(CurrencyId.put))}""".update.run.map(_ > 0)
  }
  ...
  override def selectById(currencycode: CurrencyId): ConnectionIO[Option[CurrencyRow]] = {
    sql"""select "currencycode", "name", "modifieddate"::text from "sales"."currency" where "currencycode" = ${fromWrite(currencycode)(using new Write.Single(CurrencyId.put))}""".query(using CurrencyRow.read).option
  }
  ...
  override def update(row: CurrencyRow): ConnectionIO[Option[CurrencyRow]] = {
    ...
    sql"""update "sales"."currency"
          ...
          where "currencycode" = ${fromWrite(currencycode)(using new Write.Single(CurrencyId.put))}
