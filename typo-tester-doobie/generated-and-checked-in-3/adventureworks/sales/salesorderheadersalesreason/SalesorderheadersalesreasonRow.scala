...
object SalesorderheadersalesreasonRow {
  ...
  given read: Read[SalesorderheadersalesreasonRow] = new Read.CompositeOfInstances(Array(
  ...
  given write: Write[SalesorderheadersalesreasonRow] = new Write.Composite[SalesorderheadersalesreasonRow](
