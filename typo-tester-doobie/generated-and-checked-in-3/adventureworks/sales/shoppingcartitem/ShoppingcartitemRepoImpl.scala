...
class ShoppingcartitemRepoImpl extends ShoppingcartitemRepo {
  ...
  override def deleteById(shoppingcartitemid: ShoppingcartitemId): ConnectionIO[Boolean] = {
    sql"""delete from "sales"."shoppingcartitem" where "shoppingcartitemid" = ${fromWrite(shoppingcartitemid)(using new Write.Single(ShoppingcartitemId.put))}""".update.run.map(_ > 0)
  }
  ...
  override def selectById(shoppingcartitemid: ShoppingcartitemId): ConnectionIO[Option[ShoppingcartitemRow]] = {
    sql"""select "shoppingcartitemid", "shoppingcartid", "quantity", "productid", "datecreated"::text, "modifieddate"::text from "sales"."shoppingcartitem" where "shoppingcartitemid" = ${fromWrite(shoppingcartitemid)(using new Write.Single(ShoppingcartitemId.put))}""".query(using ShoppingcartitemRow.read).option
  }
