...
object ShoppingcartitemRow {
  ...
  given read: Read[ShoppingcartitemRow] = new Read.CompositeOfInstances(Array(
  ...
  given text: Text[ShoppingcartitemRow] = Text.instance[ShoppingcartitemRow]{ (row, sb) =>
  ...
  given write: Write[ShoppingcartitemRow] = new Write.Composite[ShoppingcartitemRow](
