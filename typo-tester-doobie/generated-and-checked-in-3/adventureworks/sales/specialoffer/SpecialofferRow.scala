...
object SpecialofferRow {
  ...
  given read: Read[SpecialofferRow] = new Read.CompositeOfInstances(Array(
  ...
  given text: Text[SpecialofferRow] = Text.instance[SpecialofferRow]{ (row, sb) =>
  ...
  given write: Write[SpecialofferRow] = new Write.Composite[SpecialofferRow](
