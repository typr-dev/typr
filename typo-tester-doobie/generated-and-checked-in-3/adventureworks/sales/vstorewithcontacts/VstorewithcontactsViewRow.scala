...
object VstorewithcontactsViewRow {
  given decoder: Decoder[VstorewithcontactsViewRow] = Decoder.forProduct12[VstorewithcontactsViewRow, BusinessentityId, Name, Name, Option[/* max 8 chars */ String], /* user-picked */ FirstName, Option[Name], Name, Option[/* max 10 chars */ String], Option[Phone], Option[Name], Option[/* max 50 chars */ String], Int]("businessentityid", "name", "contacttype", "title", "firstname", "middlename", "lastname", "suffix", "phonenumber", "phonenumbertype", "emailaddress", "emailpromotion")(VstorewithcontactsViewRow.apply)(using BusinessentityId.decoder, Name.decoder, Name.decoder, Decoder.decodeOption(using Decoder.decodeString), FirstName.decoder, Decoder.decodeOption(using Name.decoder), Name.decoder, Decoder.decodeOption(using Decoder.decodeString), Decoder.decodeOption(using Phone.decoder), Decoder.decodeOption(using Name.decoder), Decoder.decodeOption(using Decoder.decodeString), Decoder.decodeInt)
  ...
  given read: Read[VstorewithcontactsViewRow] = new Read.CompositeOfInstances(Array(
