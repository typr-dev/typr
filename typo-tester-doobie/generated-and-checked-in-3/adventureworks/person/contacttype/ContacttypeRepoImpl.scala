...
class ContacttypeRepoImpl extends ContacttypeRepo {
  ...
  override def deleteById(contacttypeid: ContacttypeId): ConnectionIO[Boolean] = {
    sql"""delete from "person"."contacttype" where "contacttypeid" = ${fromWrite(contacttypeid)(using new Write.Single(ContacttypeId.put))}""".update.run.map(_ > 0)
  }
  ...
  override def insert(unsaved: ContacttypeRowUnsaved): ConnectionIO[ContacttypeRow] = {
    val fs = List(
      ...
      unsaved.contacttypeid match {
        ...
        case Defaulted.Provided(value) => Some((Fragment.const0(s""""contacttypeid""""), fr"${fromWrite(value: ContacttypeId)(using new Write.Single(ContacttypeId.put))}::int4"))
      },
  ...
  override def selectById(contacttypeid: ContacttypeId): ConnectionIO[Option[ContacttypeRow]] = {
    sql"""select "contacttypeid", "name", "modifieddate"::text from "person"."contacttype" where "contacttypeid" = ${fromWrite(contacttypeid)(using new Write.Single(ContacttypeId.put))}""".query(using ContacttypeRow.read).option
  }
  ...
  override def update(row: ContacttypeRow): ConnectionIO[Option[ContacttypeRow]] = {
    ...
    sql"""update "person"."contacttype"
          ...
          where "contacttypeid" = ${fromWrite(contacttypeid)(using new Write.Single(ContacttypeId.put))}
