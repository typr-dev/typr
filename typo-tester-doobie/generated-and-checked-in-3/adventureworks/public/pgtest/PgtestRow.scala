...
object PgtestRow {
  given decoder: Decoder[PgtestRow] = Decoder.instanceTry[PgtestRow]((c: HCursor) =>
    Try {
  ...
  given encoder: Encoder[PgtestRow] = Encoder.instance[PgtestRow](row =>
    Json.obj(
  ...
  given read: Read[PgtestRow] = new Read.CompositeOfInstances(Array(
  ...
  given text: Text[PgtestRow] = Text.instance[PgtestRow]{ (row, sb) =>
    ...
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoBox](using TypoBox.text, summon).unsafeEncode(row.boxes, sb)
    sb.append(Text.DELIMETER)
    Text[Array[String]].unsafeEncode(row.bpchares, sb)
    sb.append(Text.DELIMETER)
    Text[Array[String]].unsafeEncode(row.chares, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoCircle](using TypoCircle.text, summon).unsafeEncode(row.circlees, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoLocalDate](using TypoLocalDate.text, summon).unsafeEncode(row.datees, sb)
    sb.append(Text.DELIMETER)
    Text[Array[Float]].unsafeEncode(row.float4es, sb)
    sb.append(Text.DELIMETER)
    Text[Array[Double]].unsafeEncode(row.float8es, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoInet](using TypoInet.text, summon).unsafeEncode(row.inetes, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoShort](using TypoShort.text, summon).unsafeEncode(row.int2es, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoInt2Vector](using TypoInt2Vector.text, summon).unsafeEncode(row.int2vectores, sb)
    sb.append(Text.DELIMETER)
    Text[Array[Int]].unsafeEncode(row.int4es, sb)
    sb.append(Text.DELIMETER)
    Text[Array[Long]].unsafeEncode(row.int8es, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoInterval](using TypoInterval.text, summon).unsafeEncode(row.intervales, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoJson](using TypoJson.text, summon).unsafeEncode(row.jsones, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoJsonb](using TypoJsonb.text, summon).unsafeEncode(row.jsonbes, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoLine](using TypoLine.text, summon).unsafeEncode(row.linees, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoLineSegment](using TypoLineSegment.text, summon).unsafeEncode(row.lseges, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoMoney](using TypoMoney.text, summon).unsafeEncode(row.moneyes, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, Mydomain](using Mydomain.text, summon).unsafeEncode(row.mydomaines, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, Myenum](using Myenum.text, summon).unsafeEncode(row.myenumes, sb)
    sb.append(Text.DELIMETER)
    Text[Array[String]].unsafeEncode(row.namees, sb)
    sb.append(Text.DELIMETER)
    Text[Array[BigDecimal]].unsafeEncode(row.numerices, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoPath](using TypoPath.text, summon).unsafeEncode(row.pathes, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoPoint](using TypoPoint.text, summon).unsafeEncode(row.pointes, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoPolygon](using TypoPolygon.text, summon).unsafeEncode(row.polygones, sb)
    sb.append(Text.DELIMETER)
    Text[Array[String]].unsafeEncode(row.textes, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoLocalTime](using TypoLocalTime.text, summon).unsafeEncode(row.timees, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoLocalDateTime](using TypoLocalDateTime.text, summon).unsafeEncode(row.timestampes, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoInstant](using TypoInstant.text, summon).unsafeEncode(row.timestampzes, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoOffsetTime](using TypoOffsetTime.text, summon).unsafeEncode(row.timezes, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoUUID](using TypoUUID.text, summon).unsafeEncode(row.uuides, sb)
    sb.append(Text.DELIMETER)
    Text[Array[String]].unsafeEncode(row.varchares, sb)
    sb.append(Text.DELIMETER)
    Text.iterableInstance[Array, TypoXml](using TypoXml.text, summon).unsafeEncode(row.xmles, sb)
  }
  given write: Write[PgtestRow] = new Write.Composite[PgtestRow](
