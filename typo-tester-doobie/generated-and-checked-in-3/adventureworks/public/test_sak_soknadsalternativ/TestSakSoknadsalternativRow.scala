...
object TestSakSoknadsalternativRow {
  ...
  given read: Read[TestSakSoknadsalternativRow] = new Read.CompositeOfInstances(Array(
  ...
  given write: Write[TestSakSoknadsalternativRow] = new Write.Composite[TestSakSoknadsalternativRow](
