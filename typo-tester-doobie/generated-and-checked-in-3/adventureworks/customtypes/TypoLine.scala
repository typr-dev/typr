...
object TypoLine {
  given arrayGet: Get[Array[TypoLine]] = Get.Advanced.array[AnyRef](NonEmptyList.one("line[]"))
    .map(_.map(v => TypoLine(v.asInstanceOf[PGline].a, v.asInstanceOf[PGline].b, v.asInstanceOf[PGline].c)))
  given arrayPut: Put[Array[TypoLine]] = Put.Advanced.array[AnyRef](NonEmptyList.one("line[]"), "line")
  ...
  given get: Get[TypoLine] = Get.Advanced.other[PGline](NonEmptyList.one("line"))
