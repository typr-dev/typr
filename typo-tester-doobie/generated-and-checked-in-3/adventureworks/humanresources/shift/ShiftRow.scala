...
object ShiftRow {
  ...
  given read: Read[ShiftRow] = new Read.CompositeOfInstances(Array(
  ...
  given text: Text[ShiftRow] = Text.instance[ShiftRow]{ (row, sb) =>
  ...
  given write: Write[ShiftRow] = new Write.Composite[ShiftRow](
