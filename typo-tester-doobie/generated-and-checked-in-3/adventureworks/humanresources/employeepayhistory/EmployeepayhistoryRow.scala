...
object EmployeepayhistoryRow {
  ...
  given read: Read[EmployeepayhistoryRow] = new Read.CompositeOfInstances(Array(
  ...
  given text: Text[EmployeepayhistoryRow] = Text.instance[EmployeepayhistoryRow]{ (row, sb) =>
  ...
  given write: Write[EmployeepayhistoryRow] = new Write.Composite[EmployeepayhistoryRow](
