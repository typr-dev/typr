...
object EmployeepayhistoryRowUnsaved {
  given decoder: Decoder[EmployeepayhistoryRowUnsaved] = Decoder.forProduct5[EmployeepayhistoryRowUnsaved, BusinessentityId, TypoLocalDateTime, BigDecimal, TypoShort, Defaulted[TypoLocalDateTime]]("businessentityid", "ratechangedate", "rate", "payfrequency", "modifieddate")(EmployeepayhistoryRowUnsaved.apply)(using BusinessentityId.decoder, TypoLocalDateTime.decoder, Decoder.decodeBigDecimal, TypoShort.decoder, Defaulted.decoder(using TypoLocalDateTime.decoder))

  given encoder: Encoder[EmployeepayhistoryRowUnsaved] = Encoder.forProduct5[EmployeepayhistoryRowUnsaved, BusinessentityId, TypoLocalDateTime, BigDecimal, TypoShort, Defaulted[TypoLocalDateTime]]("businessentityid", "ratechangedate", "rate", "payfrequency", "modifieddate")(x => (x.businessentityid, x.ratechangedate, x.rate, x.payfrequency, x.modifieddate))(using BusinessentityId.encoder, TypoLocalDateTime.encoder, Encoder.encodeBigDecimal, TypoShort.encoder, Defaulted.encoder(using TypoLocalDateTime.encoder))
