...
object EmployeedepartmenthistoryRow {
  ...
  given read: Read[EmployeedepartmenthistoryRow] = new Read.CompositeOfInstances(Array(
  ...
  given text: Text[EmployeedepartmenthistoryRow] = Text.instance[EmployeedepartmenthistoryRow]{ (row, sb) =>
  ...
  given write: Write[EmployeedepartmenthistoryRow] = new Write.Composite[EmployeedepartmenthistoryRow](
