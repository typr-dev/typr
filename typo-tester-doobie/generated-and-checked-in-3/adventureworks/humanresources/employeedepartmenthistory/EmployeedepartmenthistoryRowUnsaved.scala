...
object EmployeedepartmenthistoryRowUnsaved {
  ...
  given text: Text[EmployeedepartmenthistoryRowUnsaved] = Text.instance[EmployeedepartmenthistoryRowUnsaved]{ (row, sb) =>
    ...
    sb.append(Text.DELIMETER)
    Text.option(using TypoLocalDate.text).unsafeEncode(row.enddate, sb)
    sb.append(Text.DELIMETER)
