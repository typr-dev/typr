...
class IllustrationRepoImpl extends IllustrationRepo {
  ...
  override def selectById(illustrationid: IllustrationId): ConnectionIO[Option[IllustrationRow]] = {
    sql"""select "illustrationid", "diagram", "modifieddate"::text from "production"."illustration" where "illustrationid" = ${fromWrite(illustrationid)(new Write.Single(IllustrationId.put))}""".query(IllustrationRow.read).option
  }
    ...
    Update[IllustrationRow](
      s"""insert into "production"."illustration"("illustrationid", "diagram", "modifieddate")
          ...
          do update set
            ...
            "modifieddate" = EXCLUDED."modifieddate"
          returning "illustrationid", "diagram", "modifieddate"::text"""
    )(IllustrationRow.write)
    .updateManyWithGeneratedKeys[IllustrationRow]("illustrationid", "diagram", "modifieddate")(unsaved)(catsStdInstancesForList, IllustrationRow.read)
  }
  ...
  override def upsertStreaming(unsaved: Stream[ConnectionIO, IllustrationRow], batchSize: Int = 10000): ConnectionIO[Int] = {
    for {
      ...
      _ <- new FragmentOps(sql"""copy illustration_TEMP("illustrationid", "diagram", "modifieddate") from stdin""").copyIn(unsaved, batchSize)(IllustrationRow.text)
