...
class TableWithGeneratedColumnsRepoImpl extends TableWithGeneratedColumnsRepo {
  ...
  override def insertStreaming(unsaved: Stream[ConnectionIO, TableWithGeneratedColumnsRow], batchSize: Int = 10000): ConnectionIO[Long] = {
    new FragmentOps(sql"""COPY "public"."table-with-generated-columns"("name") FROM STDIN""").copyIn(unsaved, batchSize)(TableWithGeneratedColumnsRow.text)
  }
  ...
  override def insertUnsavedStreaming(unsaved: Stream[ConnectionIO, TableWithGeneratedColumnsRowUnsaved], batchSize: Int = 10000): ConnectionIO[Long] = {
    new FragmentOps(sql"""COPY "public"."table-with-generated-columns"("name") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""").copyIn(unsaved, batchSize)(TableWithGeneratedColumnsRowUnsaved.text)
  }
  ...
  override def selectAll: Stream[ConnectionIO, TableWithGeneratedColumnsRow] = {
    sql"""select "name", "name-type-always" from "public"."table-with-generated-columns"""".query(TableWithGeneratedColumnsRow.read).stream
  }
  override def selectById(name: TableWithGeneratedColumnsId): ConnectionIO[Option[TableWithGeneratedColumnsRow]] = {
    sql"""select "name", "name-type-always" from "public"."table-with-generated-columns" where "name" = ${fromWrite(name)(new Write.Single(TableWithGeneratedColumnsId.put))}""".query(TableWithGeneratedColumnsRow.read).option
  }
  override def selectByIds(names: Array[TableWithGeneratedColumnsId]): Stream[ConnectionIO, TableWithGeneratedColumnsRow] = {
    sql"""select "name", "name-type-always" from "public"."table-with-generated-columns" where "name" = ANY(${names})""".query(TableWithGeneratedColumnsRow.read).stream
  }
  ...
  override def upsertStreaming(unsaved: Stream[ConnectionIO, TableWithGeneratedColumnsRow], batchSize: Int = 10000): ConnectionIO[Int] = {
    for {
      ...
      _ <- new FragmentOps(sql"""copy table-with-generated-columns_TEMP("name") from stdin""").copyIn(unsaved, batchSize)(TableWithGeneratedColumnsRow.text)
