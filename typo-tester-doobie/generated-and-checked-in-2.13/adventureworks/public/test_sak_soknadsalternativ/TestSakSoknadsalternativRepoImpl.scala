...
class TestSakSoknadsalternativRepoImpl extends TestSakSoknadsalternativRepo {
  ...
  override def insertStreaming(unsaved: Stream[ConnectionIO, TestSakSoknadsalternativRow], batchSize: Int = 10000): ConnectionIO[Long] = {
    new FragmentOps(sql"""COPY "public"."test_sak_soknadsalternativ"("organisasjonskode_saksbehandler", "utdanningsmulighet_kode", "organisasjonskode_tilbyder") FROM STDIN""").copyIn(unsaved, batchSize)(TestSakSoknadsalternativRow.text)
  }
  ...
  override def selectAll: Stream[ConnectionIO, TestSakSoknadsalternativRow] = {
    sql"""select "organisasjonskode_saksbehandler", "utdanningsmulighet_kode", "organisasjonskode_tilbyder" from "public"."test_sak_soknadsalternativ"""".query(TestSakSoknadsalternativRow.read).stream
  }
    ...
    Update[TestSakSoknadsalternativRow](
      s"""insert into "public"."test_sak_soknadsalternativ"("organisasjonskode_saksbehandler", "utdanningsmulighet_kode", "organisasjonskode_tilbyder")
          ...
          do update set
            "organisasjonskode_tilbyder" = EXCLUDED."organisasjonskode_tilbyder"
          returning "organisasjonskode_saksbehandler", "utdanningsmulighet_kode", "organisasjonskode_tilbyder""""
    )(TestSakSoknadsalternativRow.write)
    .updateManyWithGeneratedKeys[TestSakSoknadsalternativRow]("organisasjonskode_saksbehandler", "utdanningsmulighet_kode", "organisasjonskode_tilbyder")(unsaved)(catsStdInstancesForList, TestSakSoknadsalternativRow.read)
  }
  ...
  override def upsertStreaming(unsaved: Stream[ConnectionIO, TestSakSoknadsalternativRow], batchSize: Int = 10000): ConnectionIO[Int] = {
    for {
      ...
      _ <- new FragmentOps(sql"""copy test_sak_soknadsalternativ_TEMP("organisasjonskode_saksbehandler", "utdanningsmulighet_kode", "organisasjonskode_tilbyder") from stdin""").copyIn(unsaved, batchSize)(TestSakSoknadsalternativRow.text)
