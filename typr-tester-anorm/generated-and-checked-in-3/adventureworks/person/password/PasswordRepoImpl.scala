...
class PasswordRepoImpl extends PasswordRepo {
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy password_TEMP("businessentityid", "passwordhash", "passwordsalt", "rowguid", "modifieddate") from stdin""", batchSize, unsaved)(using PasswordRow.pgText, c): @nowarn
    SQL"""insert into "person"."password"("businessentityid", "passwordhash", "passwordsalt", "rowguid", "modifieddate")
