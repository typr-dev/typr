    ...
    Reads[PersonRowUnsaved](json => JsResult.fromTry(
        Try(
          PersonRowUnsaved(
            ...
            namestyle = json.\("namestyle").as(using Defaulted.reads(using NameStyle.reads)),
            emailpromotion = json.\("emailpromotion").as(using Defaulted.reads(using Reads.IntReads)),
