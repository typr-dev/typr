    ...
    RowParser[PersonRow] { row =>
      Success(
        PersonRow(
          ...
          persontype = row(idx + 1)(using Column.columnToString),
          ...
          demographics = row(idx + 10)(using Column.columnToOption(using TypoXml.column)),
          rowguid = row(idx + 11)(using TypoUUID.column),
