...
trait PersonphoneFields {
  ...
  def compositeIdIn(compositeIds: Array[PersonphoneId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[PersonphoneId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId]](using ToParameterValue(using null, BusinessentityId.arrayToStatement), adventureworks.arrayParameterMetaData(using BusinessentityId.parameterMetadata)), implicitly), TuplePart[PersonphoneId](phonenumber)(_.phonenumber)(using as[Array[Phone]](using ToParameterValue(using null, Phone.arrayToStatement), adventureworks.arrayParameterMetaData(using Phone.parameterMetadata)), implicitly), TuplePart[PersonphoneId](phonenumbertypeid)(_.phonenumbertypeid)(using as[Array[PhonenumbertypeId]](using ToParameterValue(using null, PhonenumbertypeId.arrayToStatement), adventureworks.arrayParameterMetaData(using PhonenumbertypeId.parameterMetadata)), implicitly))

}

object PersonphoneFields {
  lazy val structure: RelationStructure[PersonphoneFields, PersonphoneRow] =
    new Impl(List())

  private final class Impl(val _path: List[Path])
    extends RelationStructure[PersonphoneFields, PersonphoneRow] {
