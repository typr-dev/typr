...
object PersonphoneRow {
  ...
  given reads: Reads[PersonphoneRow] = {
    ...
    RowParser[PersonphoneRow] { row =>
      Success(
        PersonphoneRow(
          ...
          phonenumber = row(idx + 1)(using Phone.column),
          phonenumbertypeid = row(idx + 2)(using PhonenumbertypeId.column),
  ...
  given writes: OWrites[PersonphoneRow] = {
