    ...
    Reads[EmailaddressRowUnsaved](json => JsResult.fromTry(
        Try(
          EmailaddressRowUnsaved(
            ...
            emailaddress = json.\("emailaddress").toOption.map(_.as(using Reads.StringReads)),
            emailaddressid = json.\("emailaddressid").as(using Defaulted.reads(using Reads.IntReads)),
