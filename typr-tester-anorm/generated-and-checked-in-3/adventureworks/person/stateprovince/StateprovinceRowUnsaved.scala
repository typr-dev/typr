    ...
    Reads[StateprovinceRowUnsaved](json => JsResult.fromTry(
        Try(
          StateprovinceRowUnsaved(
            ...
            stateprovinceid = json.\("stateprovinceid").as(using Defaulted.reads(using StateprovinceId.reads)),
            isonlystateprovinceflag = json.\("isonlystateprovinceflag").as(using Defaulted.reads(using Flag.reads)),
