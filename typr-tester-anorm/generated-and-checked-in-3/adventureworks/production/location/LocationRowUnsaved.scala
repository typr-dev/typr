    ...
    Reads[LocationRowUnsaved](json => JsResult.fromTry(
        Try(
          LocationRowUnsaved(
            ...
            locationid = json.\("locationid").as(using Defaulted.reads(using LocationId.reads)),
            costrate = json.\("costrate").as(using Defaulted.reads(using Reads.bigDecReads)),
            availability = json.\("availability").as(using Defaulted.reads(using Reads.bigDecReads)),
