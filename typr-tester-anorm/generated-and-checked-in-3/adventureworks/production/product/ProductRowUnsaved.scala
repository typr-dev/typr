    ...
    Reads[ProductRowUnsaved](json => JsResult.fromTry(
        Try(
          ProductRowUnsaved(
            ...
            productid = json.\("productid").as(using Defaulted.reads(using ProductId.reads)),
            makeflag = json.\("makeflag").as(using Defaulted.reads(using Flag.reads)),
            finishedgoodsflag = json.\("finishedgoodsflag").as(using Defaulted.reads(using Flag.reads)),
  ...
  given writes: OWrites[ProductRowUnsaved] = {
    OWrites[ProductRowUnsaved](o =>
      new JsObject(ListMap[String, JsValue](
        ...
        "productid" -> Defaulted.writes(using ProductId.writes).writes(o.productid),
        "makeflag" -> Defaulted.writes(using Flag.writes).writes(o.makeflag),
        "finishedgoodsflag" -> Defaulted.writes(using Flag.writes).writes(o.finishedgoodsflag),
