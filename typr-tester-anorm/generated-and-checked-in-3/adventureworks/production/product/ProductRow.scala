    ...
    Reads[ProductRow](json => JsResult.fromTry(
        Try(
          ProductRow(
            ...
            color = json.\("color").toOption.map(_.as(using Reads.StringReads)),
            ...
            size = json.\("size").toOption.map(_.as(using Reads.StringReads)),
            sizeunitmeasurecode = json.\("sizeunitmeasurecode").toOption.map(_.as(using UnitmeasureId.reads)),
            weightunitmeasurecode = json.\("weightunitmeasurecode").toOption.map(_.as(using UnitmeasureId.reads)),
            weight = json.\("weight").toOption.map(_.as(using Reads.bigDecReads)),
            daystomanufacture = json.\("daystomanufacture").as(using Reads.IntReads),
            productline = json.\("productline").toOption.map(_.as(using Reads.StringReads)),
            `class` = json.\("class").toOption.map(_.as(using Reads.StringReads)),
            style = json.\("style").toOption.map(_.as(using Reads.StringReads)),
            productsubcategoryid = json.\("productsubcategoryid").toOption.map(_.as(using ProductsubcategoryId.reads)),
            productmodelid = json.\("productmodelid").toOption.map(_.as(using ProductmodelId.reads)),
            sellstartdate = json.\("sellstartdate").as(using TypoLocalDateTime.reads),
            sellenddate = json.\("sellenddate").toOption.map(_.as(using TypoLocalDateTime.reads)),
            discontinueddate = json.\("discontinueddate").toOption.map(_.as(using TypoLocalDateTime.reads)),
    ...
    RowParser[ProductRow] { row =>
      Success(
        ProductRow(
          ...
          productnumber = row(idx + 2)(using Column.columnToString),
          makeflag = row(idx + 3)(using Flag.column),
          finishedgoodsflag = row(idx + 4)(using Flag.column),
          color = row(idx + 5)(using Column.columnToOption(using Column.columnToString)),
          safetystocklevel = row(idx + 6)(using TypoShort.column),
          reorderpoint = row(idx + 7)(using TypoShort.column),
          standardcost = row(idx + 8)(using Column.columnToScalaBigDecimal),
          listprice = row(idx + 9)(using Column.columnToScalaBigDecimal),
          size = row(idx + 10)(using Column.columnToOption(using Column.columnToString)),
          sizeunitmeasurecode = row(idx + 11)(using Column.columnToOption(using UnitmeasureId.column)),
          weightunitmeasurecode = row(idx + 12)(using Column.columnToOption(using UnitmeasureId.column)),
          weight = row(idx + 13)(using Column.columnToOption(using Column.columnToScalaBigDecimal)),
          daystomanufacture = row(idx + 14)(using Column.columnToInt),
          productline = row(idx + 15)(using Column.columnToOption(using Column.columnToString)),
          `class` = row(idx + 16)(using Column.columnToOption(using Column.columnToString)),
          style = row(idx + 17)(using Column.columnToOption(using Column.columnToString)),
          productsubcategoryid = row(idx + 18)(using Column.columnToOption(using ProductsubcategoryId.column)),
          productmodelid = row(idx + 19)(using Column.columnToOption(using ProductmodelId.column)),
          sellstartdate = row(idx + 20)(using TypoLocalDateTime.column),
          sellenddate = row(idx + 21)(using Column.columnToOption(using TypoLocalDateTime.column)),
          discontinueddate = row(idx + 22)(using Column.columnToOption(using TypoLocalDateTime.column)),
