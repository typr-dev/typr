...
object ProductmodelRowUnsaved {
  ...
  given reads: Reads[ProductmodelRowUnsaved] = {
    Reads[ProductmodelRowUnsaved](json => JsResult.fromTry(
        Try(
          ProductmodelRowUnsaved(
            ...
            productmodelid = json.\("productmodelid").as(using Defaulted.reads(using ProductmodelId.reads)),
  ...
  given writes: OWrites[ProductmodelRowUnsaved] = {
