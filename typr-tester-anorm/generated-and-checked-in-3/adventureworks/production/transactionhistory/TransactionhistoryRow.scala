...
object TransactionhistoryRow {
  ...
  given reads: Reads[TransactionhistoryRow] = {
    Reads[TransactionhistoryRow](json => JsResult.fromTry(
        Try(
          TransactionhistoryRow(
            transactionid = json.\("transactionid").as(using TransactionhistoryId.reads),
  ...
  def rowParser(idx: Int): RowParser[TransactionhistoryRow] = {
    RowParser[TransactionhistoryRow] { row =>
      Success(
        TransactionhistoryRow(
          transactionid = row(idx + 0)(using TransactionhistoryId.column),
  ...
  given writes: OWrites[TransactionhistoryRow] = {
