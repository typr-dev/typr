...
case class IllustrationRepoMock(
  ...
  override def deleteByIds(illustrationids: Array[IllustrationId])(using c: Connection): Int = illustrationids.map(id => map.remove(id)).count(_.isDefined)
  ...
  override def insert(unsaved: IllustrationRowUnsaved)(using c: Connection): IllustrationRow = insert(toRow(unsaved))
  ...
  override def selectByIds(illustrationids: Array[IllustrationId])(using c: Connection): List[IllustrationRow] = illustrationids.flatMap(map.get).toList
