...
trait ProductcosthistoryFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductcosthistoryId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[ProductcosthistoryId](productid)(_.productid)(using as[Array[ProductId]](using ToParameterValue(using null, ProductId.arrayToStatement), adventureworks.arrayParameterMetaData(using ProductId.parameterMetadata)), implicitly), TuplePart[ProductcosthistoryId](startdate)(_.startdate)(using as[Array[TypoLocalDateTime]](using ToParameterValue(using null, TypoLocalDateTime.arrayToStatement), adventureworks.arrayParameterMetaData(using TypoLocalDateTime.parameterMetadata)), implicitly))
