...
object ProductinventoryRow {
  ...
  given reads: Reads[ProductinventoryRow] = {
    ...
    RowParser[ProductinventoryRow] { row =>
      Success(
        ProductinventoryRow(
          ...
          shelf = row(idx + 2)(using Column.columnToString),
          bin = row(idx + 3)(using TypoShort.column),
          quantity = row(idx + 4)(using TypoShort.column),
  ...
  given writes: OWrites[ProductinventoryRow] = {
