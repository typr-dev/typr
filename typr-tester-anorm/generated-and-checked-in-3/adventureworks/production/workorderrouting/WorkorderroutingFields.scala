...
trait WorkorderroutingFields {
  ...
  def compositeIdIn(compositeIds: Array[WorkorderroutingId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[WorkorderroutingId](workorderid)(_.workorderid)(using as[Array[WorkorderId]](using ToParameterValue(using null, WorkorderId.arrayToStatement), adventureworks.arrayParameterMetaData(using WorkorderId.parameterMetadata)), implicitly), TuplePart[WorkorderroutingId](productid)(_.productid)(using as[Array[Int]](using ToParameterValue(using null, adventureworks.IntArrayToStatement), adventureworks.arrayParameterMetaData(using ParameterMetaData.IntParameterMetaData)), implicitly), TuplePart[WorkorderroutingId](operationsequence)(_.operationsequence)(using as[Array[TypoShort]](using ToParameterValue(using null, TypoShort.arrayToStatement), adventureworks.arrayParameterMetaData(using TypoShort.parameterMetadata)), implicitly))
