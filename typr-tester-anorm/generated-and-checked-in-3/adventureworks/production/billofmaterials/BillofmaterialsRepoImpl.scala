...
class BillofmaterialsRepoImpl extends BillofmaterialsRepo {
  override def delete: DeleteBuilder[BillofmaterialsFields, BillofmaterialsRow] = DeleteBuilder.of(""""production"."billofmaterials"""", BillofmaterialsFields.structure, BillofmaterialsRow.rowParser(1).*)

  override def deleteById(billofmaterialsid: Int)(using c: Connection): Boolean = SQL"""delete from "production"."billofmaterials" where "billofmaterialsid" = ${ParameterValue(billofmaterialsid, null, ToStatement.intToStatement)}""".executeUpdate() > 0
  ...
  override def insert(unsaved: BillofmaterialsRowUnsaved)(using c: Connection): BillofmaterialsRow = {
    val namedParameters = List(
      Some((NamedParameter("productassemblyid", ParameterValue(unsaved.productassemblyid, null, ToStatement.optionToStatement(using ProductId.toStatement, ProductId.parameterMetadata))), "::int4")),
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  )(using c: Connection): Long = streamingInsert(s"""COPY "production"."billofmaterials"("billofmaterialsid", "productassemblyid", "componentid", "startdate", "enddate", "unitmeasurecode", "bomlevel", "perassemblyqty", "modifieddate") FROM STDIN""", batchSize, unsaved)(using BillofmaterialsRow.pgText, c)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: Iterator[BillofmaterialsRowUnsaved],
    batchSize: Int = 10000
  )(using c: Connection): Long = streamingInsert(s"""COPY "production"."billofmaterials"("productassemblyid", "componentid", "enddate", "unitmeasurecode", "bomlevel", "billofmaterialsid", "startdate", "perassemblyqty", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using BillofmaterialsRowUnsaved.pgText, c)

  override def select: SelectBuilder[BillofmaterialsFields, BillofmaterialsRow] = SelectBuilder.of(""""production"."billofmaterials"""", BillofmaterialsFields.structure, BillofmaterialsRow.rowParser)
  ...
  override def update: UpdateBuilder[BillofmaterialsFields, BillofmaterialsRow] = UpdateBuilder.of(""""production"."billofmaterials"""", BillofmaterialsFields.structure, BillofmaterialsRow.rowParser(1).*)
  ...
  override def update(row: BillofmaterialsRow)(using c: Connection): Option[BillofmaterialsRow] = {
    ...
    set "productassemblyid" = ${ParameterValue(row.productassemblyid, null, ToStatement.optionToStatement(using ProductId.toStatement, ProductId.parameterMetadata))}::int4,
    ...
    "enddate" = ${ParameterValue(row.enddate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))}::timestamp,
  ...
  SQL"""insert into "production"."billofmaterials"("billofmaterialsid", "productassemblyid", "componentid", "startdate", "enddate", "unitmeasurecode", "bomlevel", "perassemblyqty", "modifieddate")
    ...
    ${ParameterValue(unsaved.productassemblyid, null, ToStatement.optionToStatement(using ProductId.toStatement, ProductId.parameterMetadata))}::int4,
  ...
  override def upsertBatch(unsaved: Iterable[BillofmaterialsRow])(using c: Connection): List[BillofmaterialsRow] = {
    def toNamedParameter(row: BillofmaterialsRow): List[NamedParameter] = List(
      ...
      NamedParameter("productassemblyid", ParameterValue(row.productassemblyid, null, ToStatement.optionToStatement(using ProductId.toStatement, ProductId.parameterMetadata))),
      ...
      NamedParameter("enddate", ParameterValue(row.enddate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))),
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy billofmaterials_TEMP("billofmaterialsid", "productassemblyid", "componentid", "startdate", "enddate", "unitmeasurecode", "bomlevel", "perassemblyqty", "modifieddate") from stdin""", batchSize, unsaved)(using BillofmaterialsRow.pgText, c): @nowarn
    SQL"""insert into "production"."billofmaterials"("billofmaterialsid", "productassemblyid", "componentid", "startdate", "enddate", "unitmeasurecode", "bomlevel", "perassemblyqty", "modifieddate")
