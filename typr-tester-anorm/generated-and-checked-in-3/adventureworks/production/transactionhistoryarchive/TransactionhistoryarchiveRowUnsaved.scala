...
object TransactionhistoryarchiveRowUnsaved {
  ...
  given reads: Reads[TransactionhistoryarchiveRowUnsaved] = {
    Reads[TransactionhistoryarchiveRowUnsaved](json => JsResult.fromTry(
        Try(
          TransactionhistoryarchiveRowUnsaved(
            ...
            referenceorderlineid = json.\("referenceorderlineid").as(using Defaulted.reads(using Reads.IntReads)),
            transactiondate = json.\("transactiondate").as(using Defaulted.reads(using TypoLocalDateTime.reads)),
  ...
  given writes: OWrites[TransactionhistoryarchiveRowUnsaved] = {
