...
class TransactionhistoryarchiveRepoImpl extends TransactionhistoryarchiveRepo {
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy transactionhistoryarchive_TEMP("transactionid", "productid", "referenceorderid", "referenceorderlineid", "transactiondate", "transactiontype", "quantity", "actualcost", "modifieddate") from stdin""", batchSize, unsaved)(using TransactionhistoryarchiveRow.pgText, c): @nowarn
    SQL"""insert into "production"."transactionhistoryarchive"("transactionid", "productid", "referenceorderid", "referenceorderlineid", "transactiondate", "transactiontype", "quantity", "actualcost", "modifieddate")
