...
class DocumentRepoImpl extends DocumentRepo {
  override def delete: DeleteBuilder[DocumentFields, DocumentRow] = DeleteBuilder.of(""""production"."document"""", DocumentFields.structure, DocumentRow.rowParser(1).*)

  override def deleteById(documentnode: DocumentId)(using c: Connection): Boolean = SQL"""delete from "production"."document" where "documentnode" = ${ParameterValue(documentnode, null, DocumentId.toStatement)}""".executeUpdate() > 0
  ...
  override def insert(unsaved: DocumentRowUnsaved)(using c: Connection): DocumentRow = {
    val namedParameters = List(
      ...
      Some((NamedParameter("fileextension", ParameterValue(unsaved.fileextension, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))), "")),
      ...
      Some((NamedParameter("documentsummary", ParameterValue(unsaved.documentsummary, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))), "")),
      Some((NamedParameter("document", ParameterValue(unsaved.document, null, ToStatement.optionToStatement(using TypoBytea.toStatement, TypoBytea.parameterMetadata))), "::bytea")),
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  )(using c: Connection): Long = streamingInsert(s"""COPY "production"."document"("title", "owner", "folderflag", "filename", "fileextension", "revision", "changenumber", "status", "documentsummary", "document", "rowguid", "modifieddate", "documentnode") FROM STDIN""", batchSize, unsaved)(using DocumentRow.pgText, c)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: Iterator[DocumentRowUnsaved],
    batchSize: Int = 10000
  )(using c: Connection): Long = streamingInsert(s"""COPY "production"."document"("title", "owner", "filename", "fileextension", "revision", "status", "documentsummary", "document", "folderflag", "changenumber", "rowguid", "modifieddate", "documentnode") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using DocumentRowUnsaved.pgText, c)

  override def select: SelectBuilder[DocumentFields, DocumentRow] = SelectBuilder.of(""""production"."document"""", DocumentFields.structure, DocumentRow.rowParser)
  ...
  override def selectByUniqueRowguid(rowguid: TypoUUID)(using c: Connection): Option[DocumentRow] = {
    SQL"""select "title", "owner", "folderflag", "filename", "fileextension", "revision", "changenumber", "status", "documentsummary", "document", "rowguid", "modifieddate"::text, "documentnode"
    from "production"."document"
  ...
  override def update: UpdateBuilder[DocumentFields, DocumentRow] = UpdateBuilder.of(""""production"."document"""", DocumentFields.structure, DocumentRow.rowParser(1).*)
  ...
  override def update(row: DocumentRow)(using c: Connection): Option[DocumentRow] = {
    ...
    "fileextension" = ${ParameterValue(row.fileextension, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
    ...
    "documentsummary" = ${ParameterValue(row.documentsummary, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
    "document" = ${ParameterValue(row.document, null, ToStatement.optionToStatement(using TypoBytea.toStatement, TypoBytea.parameterMetadata))}::bytea,
  ...
  SQL"""insert into "production"."document"("title", "owner", "folderflag", "filename", "fileextension", "revision", "changenumber", "status", "documentsummary", "document", "rowguid", "modifieddate", "documentnode")
    ...
    ${ParameterValue(unsaved.fileextension, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
    ...
    ${ParameterValue(unsaved.documentsummary, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
    ${ParameterValue(unsaved.document, null, ToStatement.optionToStatement(using TypoBytea.toStatement, TypoBytea.parameterMetadata))}::bytea,
  ...
  override def upsertBatch(unsaved: Iterable[DocumentRow])(using c: Connection): List[DocumentRow] = {
    def toNamedParameter(row: DocumentRow): List[NamedParameter] = List(
      ...
      NamedParameter("fileextension", ParameterValue(row.fileextension, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))),
      ...
      NamedParameter("documentsummary", ParameterValue(row.documentsummary, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))),
      NamedParameter("document", ParameterValue(row.document, null, ToStatement.optionToStatement(using TypoBytea.toStatement, TypoBytea.parameterMetadata))),
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy document_TEMP("title", "owner", "folderflag", "filename", "fileextension", "revision", "changenumber", "status", "documentsummary", "document", "rowguid", "modifieddate", "documentnode") from stdin""", batchSize, unsaved)(using DocumentRow.pgText, c): @nowarn
    SQL"""insert into "production"."document"("title", "owner", "folderflag", "filename", "fileextension", "revision", "changenumber", "status", "documentsummary", "document", "rowguid", "modifieddate", "documentnode")
