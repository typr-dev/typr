...
class WorkorderRepoImpl extends WorkorderRepo {
  ...
  override def deleteById(workorderid: WorkorderId)(using c: Connection): Boolean = SQL"""delete from "production"."workorder" where "workorderid" = ${ParameterValue(workorderid, null, WorkorderId.toStatement)}""".executeUpdate() > 0
  ...
  override def insert(unsaved: WorkorderRowUnsaved)(using c: Connection): WorkorderRow = {
    val namedParameters = List(
      ...
      Some((NamedParameter("scrapreasonid", ParameterValue(unsaved.scrapreasonid, null, ToStatement.optionToStatement(using ScrapreasonId.toStatement, ScrapreasonId.parameterMetadata))), "::int2")),
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  )(using c: Connection): Long = streamingInsert(s"""COPY "production"."workorder"("workorderid", "productid", "orderqty", "scrappedqty", "startdate", "enddate", "duedate", "scrapreasonid", "modifieddate") FROM STDIN""", batchSize, unsaved)(using WorkorderRow.pgText, c)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: Iterator[WorkorderRowUnsaved],
    batchSize: Int = 10000
  )(using c: Connection): Long = streamingInsert(s"""COPY "production"."workorder"("productid", "orderqty", "scrappedqty", "startdate", "enddate", "duedate", "scrapreasonid", "workorderid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using WorkorderRowUnsaved.pgText, c)
  ...
  override def update(row: WorkorderRow)(using c: Connection): Option[WorkorderRow] = {
    ...
    "scrapreasonid" = ${ParameterValue(row.scrapreasonid, null, ToStatement.optionToStatement(using ScrapreasonId.toStatement, ScrapreasonId.parameterMetadata))}::int2,
  ...
  SQL"""insert into "production"."workorder"("workorderid", "productid", "orderqty", "scrappedqty", "startdate", "enddate", "duedate", "scrapreasonid", "modifieddate")
    ...
    ${ParameterValue(unsaved.scrapreasonid, null, ToStatement.optionToStatement(using ScrapreasonId.toStatement, ScrapreasonId.parameterMetadata))}::int2,
  ...
  override def upsertBatch(unsaved: Iterable[WorkorderRow])(using c: Connection): List[WorkorderRow] = {
    def toNamedParameter(row: WorkorderRow): List[NamedParameter] = List(
      ...
      NamedParameter("scrapreasonid", ParameterValue(row.scrapreasonid, null, ToStatement.optionToStatement(using ScrapreasonId.toStatement, ScrapreasonId.parameterMetadata))),
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy workorder_TEMP("workorderid", "productid", "orderqty", "scrappedqty", "startdate", "enddate", "duedate", "scrapreasonid", "modifieddate") from stdin""", batchSize, unsaved)(using WorkorderRow.pgText, c): @nowarn
    SQL"""insert into "production"."workorder"("workorderid", "productid", "orderqty", "scrappedqty", "startdate", "enddate", "duedate", "scrapreasonid", "modifieddate")
