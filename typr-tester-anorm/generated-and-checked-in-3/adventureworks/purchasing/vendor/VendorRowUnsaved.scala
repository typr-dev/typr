    ...
    Reads[VendorRowUnsaved](json => JsResult.fromTry(
        Try(
          VendorRowUnsaved(
            ...
            preferredvendorstatus = json.\("preferredvendorstatus").as(using Defaulted.reads(using Flag.reads)),
            activeflag = json.\("activeflag").as(using Defaulted.reads(using Flag.reads)),
