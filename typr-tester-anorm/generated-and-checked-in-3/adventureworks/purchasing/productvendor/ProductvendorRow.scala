...
object ProductvendorRow {
  ...
  given reads: Reads[ProductvendorRow] = {
    Reads[ProductvendorRow](json => JsResult.fromTry(
        Try(
          ProductvendorRow(
            ...
            averageleadtime = json.\("averageleadtime").as(using Reads.IntReads),
            standardprice = json.\("standardprice").as(using Reads.bigDecReads),
            lastreceiptcost = json.\("lastreceiptcost").toOption.map(_.as(using Reads.bigDecReads)),
            lastreceiptdate = json.\("lastreceiptdate").toOption.map(_.as(using TypoLocalDateTime.reads)),
            minorderqty = json.\("minorderqty").as(using Reads.IntReads),
            maxorderqty = json.\("maxorderqty").as(using Reads.IntReads),
            onorderqty = json.\("onorderqty").toOption.map(_.as(using Reads.IntReads)),
    ...
    RowParser[ProductvendorRow] { row =>
      Success(
        ProductvendorRow(
          ...
          averageleadtime = row(idx + 2)(using Column.columnToInt),
          standardprice = row(idx + 3)(using Column.columnToScalaBigDecimal),
          lastreceiptcost = row(idx + 4)(using Column.columnToOption(using Column.columnToScalaBigDecimal)),
          lastreceiptdate = row(idx + 5)(using Column.columnToOption(using TypoLocalDateTime.column)),
          minorderqty = row(idx + 6)(using Column.columnToInt),
          maxorderqty = row(idx + 7)(using Column.columnToInt),
          onorderqty = row(idx + 8)(using Column.columnToOption(using Column.columnToInt)),
          unitmeasurecode = row(idx + 9)(using UnitmeasureId.column),
  ...
  given writes: OWrites[ProductvendorRow] = {
    OWrites[ProductvendorRow](o =>
      new JsObject(ListMap[String, JsValue](
        ...
        "lastreceiptcost" -> Writes.OptionWrites(using Writes.BigDecimalWrites).writes(o.lastreceiptcost),
        "lastreceiptdate" -> Writes.OptionWrites(using TypoLocalDateTime.writes).writes(o.lastreceiptdate),
        "minorderqty" -> Writes.IntWrites.writes(o.minorderqty),
        "maxorderqty" -> Writes.IntWrites.writes(o.maxorderqty),
        "onorderqty" -> Writes.OptionWrites(using Writes.IntWrites).writes(o.onorderqty),
