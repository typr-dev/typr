...
trait ProductvendorFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductvendorId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[ProductvendorId](productid)(_.productid)(using as[Array[ProductId]](using ToParameterValue(using null, ProductId.arrayToStatement), adventureworks.arrayParameterMetaData(using ProductId.parameterMetadata)), implicitly), TuplePart[ProductvendorId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId]](using ToParameterValue(using null, BusinessentityId.arrayToStatement), adventureworks.arrayParameterMetaData(using BusinessentityId.parameterMetadata)), implicitly))

}

object ProductvendorFields {
  lazy val structure: RelationStructure[ProductvendorFields, ProductvendorRow] =
    new Impl(List())

  private final class Impl(val _path: List[Path])
    extends RelationStructure[ProductvendorFields, ProductvendorRow] {
