...
class ProductvendorRepoImpl extends ProductvendorRepo {
  override def delete: DeleteBuilder[ProductvendorFields, ProductvendorRow] = DeleteBuilder.of(""""purchasing"."productvendor"""", ProductvendorFields.structure, ProductvendorRow.rowParser(1).*)

  override def deleteById(compositeId: ProductvendorId)(using c: Connection): Boolean = SQL"""delete from "purchasing"."productvendor" where "productid" = ${ParameterValue(compositeId.productid, null, ProductId.toStatement)} AND "businessentityid" = ${ParameterValue(compositeId.businessentityid, null, BusinessentityId.toStatement)}""".executeUpdate() > 0
  ...
  override def insert(unsaved: ProductvendorRowUnsaved)(using c: Connection): ProductvendorRow = {
    val namedParameters = List(
      ...
      Some((NamedParameter("lastreceiptcost", ParameterValue(unsaved.lastreceiptcost, null, ToStatement.optionToStatement(using ToStatement.scalaBigDecimalToStatement, ParameterMetaData.BigDecimalParameterMetaData))), "::numeric")),
      Some((NamedParameter("lastreceiptdate", ParameterValue(unsaved.lastreceiptdate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))), "::timestamp")),
      ...
      Some((NamedParameter("onorderqty", ParameterValue(unsaved.onorderqty, null, ToStatement.optionToStatement(using ToStatement.intToStatement, ParameterMetaData.IntParameterMetaData))), "::int4")),
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  )(using c: Connection): Long = streamingInsert(s"""COPY "purchasing"."productvendor"("productid", "businessentityid", "averageleadtime", "standardprice", "lastreceiptcost", "lastreceiptdate", "minorderqty", "maxorderqty", "onorderqty", "unitmeasurecode", "modifieddate") FROM STDIN""", batchSize, unsaved)(using ProductvendorRow.pgText, c)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: Iterator[ProductvendorRowUnsaved],
    batchSize: Int = 10000
  )(using c: Connection): Long = streamingInsert(s"""COPY "purchasing"."productvendor"("productid", "businessentityid", "averageleadtime", "standardprice", "lastreceiptcost", "lastreceiptdate", "minorderqty", "maxorderqty", "onorderqty", "unitmeasurecode", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using ProductvendorRowUnsaved.pgText, c)

  override def select: SelectBuilder[ProductvendorFields, ProductvendorRow] = SelectBuilder.of(""""purchasing"."productvendor"""", ProductvendorFields.structure, ProductvendorRow.rowParser)
  ...
  override def update: UpdateBuilder[ProductvendorFields, ProductvendorRow] = UpdateBuilder.of(""""purchasing"."productvendor"""", ProductvendorFields.structure, ProductvendorRow.rowParser(1).*)

  override def update(row: ProductvendorRow)(using c: Connection): Option[ProductvendorRow] = {
    ...
    "lastreceiptcost" = ${ParameterValue(row.lastreceiptcost, null, ToStatement.optionToStatement(using ToStatement.scalaBigDecimalToStatement, ParameterMetaData.BigDecimalParameterMetaData))}::numeric,
    "lastreceiptdate" = ${ParameterValue(row.lastreceiptdate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))}::timestamp,
    ...
    "onorderqty" = ${ParameterValue(row.onorderqty, null, ToStatement.optionToStatement(using ToStatement.intToStatement, ParameterMetaData.IntParameterMetaData))}::int4,
  ...
  SQL"""insert into "purchasing"."productvendor"("productid", "businessentityid", "averageleadtime", "standardprice", "lastreceiptcost", "lastreceiptdate", "minorderqty", "maxorderqty", "onorderqty", "unitmeasurecode", "modifieddate")
    ...
    ${ParameterValue(unsaved.lastreceiptcost, null, ToStatement.optionToStatement(using ToStatement.scalaBigDecimalToStatement, ParameterMetaData.BigDecimalParameterMetaData))}::numeric,
    ${ParameterValue(unsaved.lastreceiptdate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))}::timestamp,
    ...
    ${ParameterValue(unsaved.onorderqty, null, ToStatement.optionToStatement(using ToStatement.intToStatement, ParameterMetaData.IntParameterMetaData))}::int4,
  ...
  override def upsertBatch(unsaved: Iterable[ProductvendorRow])(using c: Connection): List[ProductvendorRow] = {
    def toNamedParameter(row: ProductvendorRow): List[NamedParameter] = List(
      ...
      NamedParameter("lastreceiptcost", ParameterValue(row.lastreceiptcost, null, ToStatement.optionToStatement(using ToStatement.scalaBigDecimalToStatement, ParameterMetaData.BigDecimalParameterMetaData))),
      NamedParameter("lastreceiptdate", ParameterValue(row.lastreceiptdate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))),
      ...
      NamedParameter("onorderqty", ParameterValue(row.onorderqty, null, ToStatement.optionToStatement(using ToStatement.intToStatement, ParameterMetaData.IntParameterMetaData))),
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy productvendor_TEMP("productid", "businessentityid", "averageleadtime", "standardprice", "lastreceiptcost", "lastreceiptdate", "minorderqty", "maxorderqty", "onorderqty", "unitmeasurecode", "modifieddate") from stdin""", batchSize, unsaved)(using ProductvendorRow.pgText, c): @nowarn
    SQL"""insert into "purchasing"."productvendor"("productid", "businessentityid", "averageleadtime", "standardprice", "lastreceiptcost", "lastreceiptdate", "minorderqty", "maxorderqty", "onorderqty", "unitmeasurecode", "modifieddate")
