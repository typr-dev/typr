...
object PurchaseorderheaderRow {
  given pgText: Text[PurchaseorderheaderRow] = {
  ...
  given reads: Reads[PurchaseorderheaderRow] = {
  ...
  def rowParser(idx: Int): RowParser[PurchaseorderheaderRow] = {
    RowParser[PurchaseorderheaderRow] { row =>
      Success(
        PurchaseorderheaderRow(
          purchaseorderid = row(idx + 0)(using PurchaseorderheaderId.column),
          revisionnumber = row(idx + 1)(using TypoShort.column),
          status = row(idx + 2)(using TypoShort.column),
          employeeid = row(idx + 3)(using BusinessentityId.column),
          vendorid = row(idx + 4)(using BusinessentityId.column),
          shipmethodid = row(idx + 5)(using ShipmethodId.column),
          orderdate = row(idx + 6)(using TypoLocalDateTime.column),
          shipdate = row(idx + 7)(using Column.columnToOption(using TypoLocalDateTime.column)),
          subtotal = row(idx + 8)(using Column.columnToScalaBigDecimal),
          taxamt = row(idx + 9)(using Column.columnToScalaBigDecimal),
          freight = row(idx + 10)(using Column.columnToScalaBigDecimal),
  ...
  given writes: OWrites[PurchaseorderheaderRow] = {
