...
object ShipmethodRow {
  ...
  given reads: Reads[ShipmethodRow] = {
  ...
  def rowParser(idx: Int): RowParser[ShipmethodRow] = {
    RowParser[ShipmethodRow] { row =>
      Success(
        ShipmethodRow(
          shipmethodid = row(idx + 0)(using ShipmethodId.column),
          name = row(idx + 1)(using Name.column),
          shipbase = row(idx + 2)(using Column.columnToScalaBigDecimal),
          shiprate = row(idx + 3)(using Column.columnToScalaBigDecimal),
  ...
  given writes: OWrites[ShipmethodRow] = {
