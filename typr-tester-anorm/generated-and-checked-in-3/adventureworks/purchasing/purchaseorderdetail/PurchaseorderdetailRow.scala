...
object PurchaseorderdetailRow {
  ...
  given pgText: Text[PurchaseorderdetailRow] = {
  ...
  given reads: Reads[PurchaseorderdetailRow] = {
    Reads[PurchaseorderdetailRow](json => JsResult.fromTry(
        Try(
          PurchaseorderdetailRow(
            ...
            purchaseorderdetailid = json.\("purchaseorderdetailid").as(using Reads.IntReads),
    ...
    RowParser[PurchaseorderdetailRow] { row =>
      Success(
        PurchaseorderdetailRow(
          ...
          purchaseorderdetailid = row(idx + 1)(using Column.columnToInt),
          duedate = row(idx + 2)(using TypoLocalDateTime.column),
          orderqty = row(idx + 3)(using TypoShort.column),
          productid = row(idx + 4)(using ProductId.column),
          unitprice = row(idx + 5)(using Column.columnToScalaBigDecimal),
          receivedqty = row(idx + 6)(using Column.columnToScalaBigDecimal),
          rejectedqty = row(idx + 7)(using Column.columnToScalaBigDecimal),
  ...
  given writes: OWrites[PurchaseorderdetailRow] = {
