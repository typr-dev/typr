...
case class TestInsert(
  ...
  )(using c: Connection): DepartmentRow = (new DepartmentRepoImpl).insert(new DepartmentRowUnsaved(name = name, groupname = groupname, departmentid = departmentid, modifieddate = modifieddate))
  ...
  )(using c: Connection): EmployeeRow = (new EmployeeRepoImpl).insert(new EmployeeRowUnsaved(businessentityid = businessentityid, nationalidnumber = nationalidnumber, loginid = loginid, jobtitle = jobtitle, birthdate = birthdate, maritalstatus = maritalstatus, gender = gender, hiredate = hiredate, salariedflag = salariedflag, vacationhours = vacationhours, sickleavehours = sickleavehours, currentflag = currentflag, rowguid = rowguid, modifieddate = modifieddate, organizationnode = organizationnode))
  ...
  def humanresourcesEmployeedepartmenthistory(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): EmployeedepartmenthistoryRow = (new EmployeedepartmenthistoryRepoImpl).insert(new EmployeedepartmenthistoryRowUnsaved(businessentityid = businessentityid, departmentid = departmentid, shiftid = shiftid, startdate = startdate, enddate = enddate, modifieddate = modifieddate))
  ...
  def humanresourcesEmployeepayhistory(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): EmployeepayhistoryRow = (new EmployeepayhistoryRepoImpl).insert(new EmployeepayhistoryRowUnsaved(businessentityid = businessentityid, ratechangedate = ratechangedate, rate = rate, payfrequency = payfrequency, modifieddate = modifieddate))
  ...
  def humanresourcesJobcandidate(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): JobcandidateRow = (new JobcandidateRepoImpl).insert(new JobcandidateRowUnsaved(businessentityid = businessentityid, resume = resume, jobcandidateid = jobcandidateid, modifieddate = modifieddate))
  ...
  def humanresourcesShift(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): ShiftRow = (new ShiftRepoImpl).insert(new ShiftRowUnsaved(name = name, starttime = starttime, endtime = endtime, shiftid = shiftid, modifieddate = modifieddate))
  ...
  def personAddress(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): AddressRow = (new AddressRepoImpl).insert(new AddressRowUnsaved(addressline1 = addressline1, addressline2 = addressline2, city = city, stateprovinceid = stateprovinceid, postalcode = postalcode, spatiallocation = spatiallocation, addressid = addressid, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def personAddresstype(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): AddresstypeRow = (new AddresstypeRepoImpl).insert(new AddresstypeRowUnsaved(name = name, addresstypeid = addresstypeid, rowguid = rowguid, modifieddate = modifieddate))

  def personBusinessentity(
    businessentityid: Defaulted[BusinessentityId] = Defaulted.UseDefault(),
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): BusinessentityRow = (new BusinessentityRepoImpl).insert(new BusinessentityRowUnsaved(businessentityid = businessentityid, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def personBusinessentityaddress(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): BusinessentityaddressRow = (new BusinessentityaddressRepoImpl).insert(new BusinessentityaddressRowUnsaved(businessentityid = businessentityid, addressid = addressid, addresstypeid = addresstypeid, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def personBusinessentitycontact(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): BusinessentitycontactRow = (new BusinessentitycontactRepoImpl).insert(new BusinessentitycontactRowUnsaved(businessentityid = businessentityid, personid = personid, contacttypeid = contacttypeid, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def personEmailaddress(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): EmailaddressRow = (new EmailaddressRepoImpl).insert(new EmailaddressRowUnsaved(businessentityid = businessentityid, emailaddress = emailaddress, emailaddressid = emailaddressid, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def personPerson(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): PersonRow = (new PersonRepoImpl).insert(new PersonRowUnsaved(businessentityid = businessentityid, persontype = persontype, title = title, firstname = firstname, middlename = middlename, lastname = lastname, suffix = suffix, additionalcontactinfo = additionalcontactinfo, demographics = demographics, namestyle = namestyle, emailpromotion = emailpromotion, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def personPersonphone(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): PersonphoneRow = (new PersonphoneRepoImpl).insert(new PersonphoneRowUnsaved(businessentityid = businessentityid, phonenumber = phonenumber, phonenumbertypeid = phonenumbertypeid, modifieddate = modifieddate))

  def personPhonenumbertype(
    name: Name = domainInsert.publicName(random),
    phonenumbertypeid: Defaulted[PhonenumbertypeId] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): PhonenumbertypeRow = (new PhonenumbertypeRepoImpl).insert(new PhonenumbertypeRowUnsaved(name = name, phonenumbertypeid = phonenumbertypeid, modifieddate = modifieddate))
  ...
  def productionLocation(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): LocationRow = (new LocationRepoImpl).insert(new LocationRowUnsaved(name = name, locationid = locationid, costrate = costrate, availability = availability, modifieddate = modifieddate))
  ...
  def productionProductcategory(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): ProductcategoryRow = (new ProductcategoryRepoImpl).insert(new ProductcategoryRowUnsaved(name = name, productcategoryid = productcategoryid, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def productionProductdescription(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): ProductdescriptionRow = (new ProductdescriptionRepoImpl).insert(new ProductdescriptionRowUnsaved(description = description, productdescriptionid = productdescriptionid, rowguid = rowguid, modifieddate = modifieddate))

  def productionProductdocument(
    productid: ProductId,
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault(),
    documentnode: Defaulted[DocumentId] = Defaulted.UseDefault()
  )(using c: Connection): ProductdocumentRow = (new ProductdocumentRepoImpl).insert(new ProductdocumentRowUnsaved(productid = productid, modifieddate = modifieddate, documentnode = documentnode))
  ...
  def productionProductinventory(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): ProductinventoryRow = (new ProductinventoryRepoImpl).insert(new ProductinventoryRowUnsaved(productid = productid, locationid = locationid, shelf = shelf, bin = bin, quantity = quantity, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def productionProductlistpricehistory(
    ...
    enddate: Option[TypoLocalDateTime] = None,
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): ProductlistpricehistoryRow = (new ProductlistpricehistoryRepoImpl).insert(new ProductlistpricehistoryRowUnsaved(productid = productid, startdate = startdate, enddate = enddate, listprice = listprice, modifieddate = modifieddate))
  ...
  def productionProductmodel(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): ProductmodelRow = (new ProductmodelRepoImpl).insert(new ProductmodelRowUnsaved(name = name, catalogdescription = catalogdescription, instructions = instructions, productmodelid = productmodelid, rowguid = rowguid, modifieddate = modifieddate))

  def productionProductmodelillustration(
    productmodelid: ProductmodelId,
    illustrationid: IllustrationId,
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): ProductmodelillustrationRow = (new ProductmodelillustrationRepoImpl).insert(new ProductmodelillustrationRowUnsaved(productmodelid = productmodelid, illustrationid = illustrationid, modifieddate = modifieddate))
  ...
  def productionProductmodelproductdescriptionculture(
    ...
    cultureid: CultureId,
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): ProductmodelproductdescriptioncultureRow = (new ProductmodelproductdescriptioncultureRepoImpl).insert(new ProductmodelproductdescriptioncultureRowUnsaved(productmodelid = productmodelid, productdescriptionid = productdescriptionid, cultureid = cultureid, modifieddate = modifieddate))
  ...
  def productionProductphoto(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): ProductphotoRow = (new ProductphotoRepoImpl).insert(new ProductphotoRowUnsaved(thumbnailphoto = thumbnailphoto, thumbnailphotofilename = thumbnailphotofilename, largephoto = largephoto, largephotofilename = largephotofilename, productphotoid = productphotoid, modifieddate = modifieddate))
  ...
  def productionProductproductphoto(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): ProductproductphotoRow = (new ProductproductphotoRepoImpl).insert(new ProductproductphotoRowUnsaved(productid = productid, productphotoid = productphotoid, primary = primary, modifieddate = modifieddate))
  ...
  def productionProductreview(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): ProductreviewRow = (new ProductreviewRepoImpl).insert(new ProductreviewRowUnsaved(productid = productid, reviewername = reviewername, emailaddress = emailaddress, rating = rating, comments = comments, productreviewid = productreviewid, reviewdate = reviewdate, modifieddate = modifieddate))
  ...
  def productionProductsubcategory(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): ProductsubcategoryRow = (new ProductsubcategoryRepoImpl).insert(new ProductsubcategoryRowUnsaved(productcategoryid = productcategoryid, name = name, productsubcategoryid = productsubcategoryid, rowguid = rowguid, modifieddate = modifieddate))

  def productionScrapreason(
    name: Name = domainInsert.publicName(random),
    scrapreasonid: Defaulted[ScrapreasonId] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): ScrapreasonRow = (new ScrapreasonRepoImpl).insert(new ScrapreasonRowUnsaved(name = name, scrapreasonid = scrapreasonid, modifieddate = modifieddate))
  ...
  def productionWorkorder(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): WorkorderRow = (new WorkorderRepoImpl).insert(new WorkorderRowUnsaved(productid = productid, orderqty = orderqty, scrappedqty = scrappedqty, startdate = startdate, enddate = enddate, duedate = duedate, scrapreasonid = scrapreasonid, workorderid = workorderid, modifieddate = modifieddate))
  ...
  def productionWorkorderrouting(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): WorkorderroutingRow = (new WorkorderroutingRepoImpl).insert(new WorkorderroutingRowUnsaved(workorderid = workorderid, productid = productid, operationsequence = operationsequence, locationid = locationid, scheduledstartdate = scheduledstartdate, scheduledenddate = scheduledenddate, actualstartdate = actualstartdate, actualenddate = actualenddate, actualresourcehrs = actualresourcehrs, plannedcost = plannedcost, actualcost = actualcost, modifieddate = modifieddate))
  ...
  def publicIssue142(tabellkode: Issue142Id = Issue142Id(random.alphanumeric.take(20).mkString))(using c: Connection): Issue142Row = (new Issue142RepoImpl).insert(new Issue142Row(tabellkode = tabellkode))

  def publicIssue1422(tabellkode: Issue142Id = Issue142Id.All(random.nextInt(2)))(using c: Connection): Issue1422Row = (new Issue1422RepoImpl).insert(new Issue1422Row(tabellkode = tabellkode))

  def publicOnlyPkColumns(
    keyColumn1: String = random.alphanumeric.take(20).mkString,
    keyColumn2: Int = random.nextInt()
  )(using c: Connection): OnlyPkColumnsRow = (new OnlyPkColumnsRepoImpl).insert(new OnlyPkColumnsRow(keyColumn1 = keyColumn1, keyColumn2 = keyColumn2))
  ...
  )(using c: Connection): PgtestnullRow = (new PgtestnullRepoImpl).insert(new PgtestnullRow(bool = bool, box = box, bpchar = bpchar, bytea = bytea, char = char, circle = circle, date = date, float4 = float4, float8 = float8, hstore = hstore, inet = inet, int2 = int2, int2vector = int2vector, int4 = int4, int8 = int8, interval = interval, json = json, jsonb = jsonb, line = line, lseg = lseg, money = money, mydomain = mydomain, myenum = myenum, name = name, numeric = numeric, path = path, point = point, polygon = polygon, text = text, time = time, timestamp = timestamp, timestampz = timestampz, timez = timez, uuid = uuid, varchar = varchar, vector = vector, xml = xml, boxes = boxes, bpchares = bpchares, chares = chares, circlees = circlees, datees = datees, float4es = float4es, float8es = float8es, inetes = inetes, int2es = int2es, int2vectores = int2vectores, int4es = int4es, int8es = int8es, intervales = intervales, jsones = jsones, jsonbes = jsonbes, linees = linees, lseges = lseges, moneyes = moneyes, mydomaines = mydomaines, myenumes = myenumes, namees = namees, numerices = numerices, pathes = pathes, pointes = pointes, polygones = polygones, textes = textes, timees = timees, timestampes = timestampes, timestampzes = timestampzes, timezes = timezes, uuides = uuides, varchares = varchares, xmles = xmles))

  def publicTableWithGeneratedColumns(name: TableWithGeneratedColumnsId = TableWithGeneratedColumnsId(random.alphanumeric.take(20).mkString))(using c: Connection): TableWithGeneratedColumnsRow = (new TableWithGeneratedColumnsRepoImpl).insert(new TableWithGeneratedColumnsRowUnsaved(name = name))

  def publicTestOrganisasjon(organisasjonskode: TestOrganisasjonId = TestOrganisasjonId(random.alphanumeric.take(20).mkString))(using c: Connection): TestOrganisasjonRow = (new TestOrganisasjonRepoImpl).insert(new TestOrganisasjonRow(organisasjonskode = organisasjonskode))
  ...
  )(using c: Connection): TestUtdanningstilbudRow = (new TestUtdanningstilbudRepoImpl).insert(new TestUtdanningstilbudRow(organisasjonskode = organisasjonskode, utdanningsmulighetKode = utdanningsmulighetKode))

  def publicTitle(code: TitleId = TitleId(random.alphanumeric.take(20).mkString))(using c: Connection): TitleRow = (new TitleRepoImpl).insert(new TitleRow(code = code))

  def publicTitleDomain(code: TitleDomainId = TitleDomainId(domainInsert.publicShortText(random)))(using c: Connection): TitleDomainRow = (new TitleDomainRepoImpl).insert(new TitleDomainRow(code = code))
  ...
  def publicTitledperson(
    ...
    name: String = random.alphanumeric.take(20).mkString
  )(using c: Connection): TitledpersonRow = (new TitledpersonRepoImpl).insert(new TitledpersonRow(titleShort = titleShort, title = title, name = name))
  ...
  )(using c: Connection): UsersRow = (new UsersRepoImpl).insert(new UsersRowUnsaved(userId = userId, name = name, lastName = lastName, email = email, password = password, verifiedOn = verifiedOn, createdAt = createdAt))
  ...
  def purchasingProductvendor(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): ProductvendorRow = (new ProductvendorRepoImpl).insert(new ProductvendorRowUnsaved(productid = productid, businessentityid = businessentityid, averageleadtime = averageleadtime, standardprice = standardprice, lastreceiptcost = lastreceiptcost, lastreceiptdate = lastreceiptdate, minorderqty = minorderqty, maxorderqty = maxorderqty, onorderqty = onorderqty, unitmeasurecode = unitmeasurecode, modifieddate = modifieddate))
  ...
  def purchasingShipmethod(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): ShipmethodRow = (new ShipmethodRepoImpl).insert(new ShipmethodRowUnsaved(name = name, shipmethodid = shipmethodid, shipbase = shipbase, shiprate = shiprate, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def purchasingVendor(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): VendorRow = (new VendorRepoImpl).insert(new VendorRowUnsaved(businessentityid = businessentityid, accountnumber = accountnumber, name = name, creditrating = creditrating, purchasingwebserviceurl = purchasingwebserviceurl, preferredvendorstatus = preferredvendorstatus, activeflag = activeflag, modifieddate = modifieddate))
  ...
  def salesCurrencyrate(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): CurrencyrateRow = (new CurrencyrateRepoImpl).insert(new CurrencyrateRowUnsaved(currencyratedate = currencyratedate, fromcurrencycode = fromcurrencycode, tocurrencycode = tocurrencycode, averagerate = averagerate, endofdayrate = endofdayrate, currencyrateid = currencyrateid, modifieddate = modifieddate))
  ...
  def salesCustomer(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): CustomerRow = (new CustomerRepoImpl).insert(new CustomerRowUnsaved(personid = personid, storeid = storeid, territoryid = territoryid, customerid = customerid, rowguid = rowguid, modifieddate = modifieddate))

  def salesPersoncreditcard(
    businessentityid: BusinessentityId,
    creditcardid: /* user-picked */ CustomCreditcardId,
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): PersoncreditcardRow = (new PersoncreditcardRepoImpl).insert(new PersoncreditcardRowUnsaved(businessentityid = businessentityid, creditcardid = creditcardid, modifieddate = modifieddate))
  ...
  def salesSalesperson(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): SalespersonRow = (new SalespersonRepoImpl).insert(new SalespersonRowUnsaved(businessentityid = businessentityid, territoryid = territoryid, salesquota = salesquota, bonus = bonus, commissionpct = commissionpct, salesytd = salesytd, saleslastyear = saleslastyear, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def salesSalespersonquotahistory(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): SalespersonquotahistoryRow = (new SalespersonquotahistoryRepoImpl).insert(new SalespersonquotahistoryRowUnsaved(businessentityid = businessentityid, quotadate = quotadate, salesquota = salesquota, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def salesSalesreason(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): SalesreasonRow = (new SalesreasonRepoImpl).insert(new SalesreasonRowUnsaved(name = name, reasontype = reasontype, salesreasonid = salesreasonid, modifieddate = modifieddate))
  ...
  def salesSalestaxrate(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): SalestaxrateRow = (new SalestaxrateRepoImpl).insert(new SalestaxrateRowUnsaved(stateprovinceid = stateprovinceid, taxtype = taxtype, name = name, salestaxrateid = salestaxrateid, taxrate = taxrate, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def salesSalesterritoryhistory(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): SalesterritoryhistoryRow = (new SalesterritoryhistoryRepoImpl).insert(new SalesterritoryhistoryRowUnsaved(businessentityid = businessentityid, territoryid = territoryid, startdate = startdate, enddate = enddate, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def salesShoppingcartitem(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): ShoppingcartitemRow = (new ShoppingcartitemRepoImpl).insert(new ShoppingcartitemRowUnsaved(shoppingcartid = shoppingcartid, productid = productid, shoppingcartitemid = shoppingcartitemid, quantity = quantity, datecreated = datecreated, modifieddate = modifieddate))
  ...
  def salesSpecialoffer(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): SpecialofferRow = (new SpecialofferRepoImpl).insert(new SpecialofferRowUnsaved(description = description, `type` = `type`, category = category, startdate = startdate, enddate = enddate, maxqty = maxqty, specialofferid = specialofferid, discountpct = discountpct, minqty = minqty, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def salesSpecialofferproduct(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): SpecialofferproductRow = (new SpecialofferproductRepoImpl).insert(new SpecialofferproductRowUnsaved(specialofferid = specialofferid, productid = productid, rowguid = rowguid, modifieddate = modifieddate))
  ...
  def salesStore(
    ...
    rowguid: Defaulted[TypoUUID] = Defaulted.UseDefault(),
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(using c: Connection): StoreRow = (new StoreRepoImpl).insert(new StoreRowUnsaved(businessentityid = businessentityid, name = name, salespersonid = salespersonid, demographics = demographics, rowguid = rowguid, modifieddate = modifieddate))
}