...
object VindividualcustomerViewRow {
  given reads: Reads[VindividualcustomerViewRow] = {
    ...
    RowParser[VindividualcustomerViewRow] { row =>
      Success(
        VindividualcustomerViewRow(
          ...
          emailaddress = row(idx + 8)(using Column.columnToString),
          ...
          demographics = row(idx + 17)(using TypoXml.column)
        )
      )
    }
  }

  given writes: OWrites[VindividualcustomerViewRow] = {
