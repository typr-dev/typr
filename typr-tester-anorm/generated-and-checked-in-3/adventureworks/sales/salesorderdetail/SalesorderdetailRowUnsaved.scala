    ...
    Reads[SalesorderdetailRowUnsaved](json => JsResult.fromTry(
        Try(
          SalesorderdetailRowUnsaved(
            ...
            carriertrackingnumber = json.\("carriertrackingnumber").toOption.map(_.as(using Reads.StringReads)),
            ...
            salesorderdetailid = json.\("salesorderdetailid").as(using Defaulted.reads(using Reads.IntReads)),
            unitpricediscount = json.\("unitpricediscount").as(using Defaulted.reads(using Reads.bigDecReads)),
