...
object SalesorderdetailRow {
  ...
  given reads: Reads[SalesorderdetailRow] = {
    Reads[SalesorderdetailRow](json => JsResult.fromTry(
        Try(
          SalesorderdetailRow(
            ...
            unitpricediscount = json.\("unitpricediscount").as(using Reads.bigDecReads),
    ...
    RowParser[SalesorderdetailRow] { row =>
      Success(
        SalesorderdetailRow(
          ...
          carriertrackingnumber = row(idx + 2)(using Column.columnToOption(using Column.columnToString)),
          orderqty = row(idx + 3)(using TypoShort.column),
          productid = row(idx + 4)(using ProductId.column),
          specialofferid = row(idx + 5)(using SpecialofferId.column),
          unitprice = row(idx + 6)(using Column.columnToScalaBigDecimal),
          unitpricediscount = row(idx + 7)(using Column.columnToScalaBigDecimal),
  ...
  given writes: OWrites[SalesorderdetailRow] = {
