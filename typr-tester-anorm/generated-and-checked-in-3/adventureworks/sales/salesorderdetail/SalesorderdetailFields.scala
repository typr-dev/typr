...
trait SalesorderdetailFields {
  ...
  def compositeIdIn(compositeIds: Array[SalesorderdetailId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[SalesorderdetailId](salesorderid)(_.salesorderid)(using as[Array[SalesorderheaderId]](using ToParameterValue(using null, SalesorderheaderId.arrayToStatement), adventureworks.arrayParameterMetaData(using SalesorderheaderId.parameterMetadata)), implicitly), TuplePart[SalesorderdetailId](salesorderdetailid)(_.salesorderdetailid)(using as[Array[Int]](using ToParameterValue(using null, adventureworks.IntArrayToStatement), adventureworks.arrayParameterMetaData(using ParameterMetaData.IntParameterMetaData)), implicitly))
  ...
  def extractSpecialofferproductIdIn(ids: Array[SpecialofferproductId]): SqlExpr[Boolean] =
    new CompositeIn(ids)(TuplePart[SpecialofferproductId](specialofferid)(_.specialofferid)(using as[Array[SpecialofferId]](using ToParameterValue(using null, SpecialofferId.arrayToStatement), adventureworks.arrayParameterMetaData(using SpecialofferId.parameterMetadata)), implicitly), TuplePart[SpecialofferproductId](productid)(_.productid)(using as[Array[ProductId]](using ToParameterValue(using null, ProductId.arrayToStatement), adventureworks.arrayParameterMetaData(using ProductId.parameterMetadata)), implicitly))

}

object SalesorderdetailFields {
  lazy val structure: RelationStructure[SalesorderdetailFields, SalesorderdetailRow] =
    new Impl(List())

  private final class Impl(val _path: List[Path])
    extends RelationStructure[SalesorderdetailFields, SalesorderdetailRow] {
