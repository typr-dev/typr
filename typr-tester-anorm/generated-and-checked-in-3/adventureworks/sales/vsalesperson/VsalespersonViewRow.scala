    ...
    Reads[VsalespersonViewRow](json => JsResult.fromTry(
        Try(
          VsalespersonViewRow(
            ...
            territoryname = json.\("territoryname").as(using Name.reads),
            territorygroup = json.\("territorygroup").as(using Reads.StringReads),
    ...
    RowParser[VsalespersonViewRow] { row =>
      Success(
        VsalespersonViewRow(
          ...
          territoryname = row(idx + 17)(using Name.column),
          territorygroup = row(idx + 18)(using Column.columnToString),
          salesquota = row(idx + 19)(using Column.columnToScalaBigDecimal),
  ...
  given writes: OWrites[VsalespersonViewRow] = {
    OWrites[VsalespersonViewRow](o =>
      new JsObject(ListMap[String, JsValue](
        ...
        "territoryname" -> Name.writes.writes(o.territoryname),
        "territorygroup" -> Writes.StringWrites.writes(o.territorygroup),
