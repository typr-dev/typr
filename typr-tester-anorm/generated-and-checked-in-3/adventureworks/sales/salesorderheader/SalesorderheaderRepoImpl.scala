...
class SalesorderheaderRepoImpl extends SalesorderheaderRepo {
  override def delete: DeleteBuilder[SalesorderheaderFields, SalesorderheaderRow] = DeleteBuilder.of(""""sales"."salesorderheader"""", SalesorderheaderFields.structure, SalesorderheaderRow.rowParser(1).*)

  override def deleteById(salesorderid: SalesorderheaderId)(using c: Connection): Boolean = SQL"""delete from "sales"."salesorderheader" where "salesorderid" = ${ParameterValue(salesorderid, null, SalesorderheaderId.toStatement)}""".executeUpdate() > 0
  ...
  override def insert(unsaved: SalesorderheaderRowUnsaved)(using c: Connection): SalesorderheaderRow = {
    val namedParameters = List(
      ...
      Some((NamedParameter("shipdate", ParameterValue(unsaved.shipdate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))), "::timestamp")),
      Some((NamedParameter("purchaseordernumber", ParameterValue(unsaved.purchaseordernumber, null, ToStatement.optionToStatement(using OrderNumber.toStatement, OrderNumber.parameterMetadata))), "::varchar")),
      Some((NamedParameter("accountnumber", ParameterValue(unsaved.accountnumber, null, ToStatement.optionToStatement(using AccountNumber.toStatement, AccountNumber.parameterMetadata))), "::varchar")),
      ...
      Some((NamedParameter("territoryid", ParameterValue(unsaved.territoryid, null, ToStatement.optionToStatement(using SalesterritoryId.toStatement, SalesterritoryId.parameterMetadata))), "::int4")),
      ...
      Some((NamedParameter("creditcardid", ParameterValue(unsaved.creditcardid, null, ToStatement.optionToStatement(using CustomCreditcardId.toStatement, CustomCreditcardId.parameterMetadata))), "::int4")),
      Some((NamedParameter("creditcardapprovalcode", ParameterValue(unsaved.creditcardapprovalcode, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))), "")),
      Some((NamedParameter("currencyrateid", ParameterValue(unsaved.currencyrateid, null, ToStatement.optionToStatement(using CurrencyrateId.toStatement, CurrencyrateId.parameterMetadata))), "::int4")),
      Some((NamedParameter("totaldue", ParameterValue(unsaved.totaldue, null, ToStatement.optionToStatement(using ToStatement.scalaBigDecimalToStatement, ParameterMetaData.BigDecimalParameterMetaData))), "::numeric")),
      Some((NamedParameter("comment", ParameterValue(unsaved.comment, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))), "")),
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  )(using c: Connection): Long = streamingInsert(s"""COPY "sales"."salesorderheader"("salesorderid", "revisionnumber", "orderdate", "duedate", "shipdate", "status", "onlineorderflag", "purchaseordernumber", "accountnumber", "customerid", "salespersonid", "territoryid", "billtoaddressid", "shiptoaddressid", "shipmethodid", "creditcardid", "creditcardapprovalcode", "currencyrateid", "subtotal", "taxamt", "freight", "totaldue", "comment", "rowguid", "modifieddate") FROM STDIN""", batchSize, unsaved)(using SalesorderheaderRow.pgText, c)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: Iterator[SalesorderheaderRowUnsaved],
    batchSize: Int = 10000
  )(using c: Connection): Long = streamingInsert(s"""COPY "sales"."salesorderheader"("duedate", "shipdate", "purchaseordernumber", "accountnumber", "customerid", "salespersonid", "territoryid", "billtoaddressid", "shiptoaddressid", "shipmethodid", "creditcardid", "creditcardapprovalcode", "currencyrateid", "totaldue", "comment", "salesorderid", "revisionnumber", "orderdate", "status", "onlineorderflag", "subtotal", "taxamt", "freight", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using SalesorderheaderRowUnsaved.pgText, c)

  override def select: SelectBuilder[SalesorderheaderFields, SalesorderheaderRow] = SelectBuilder.of(""""sales"."salesorderheader"""", SalesorderheaderFields.structure, SalesorderheaderRow.rowParser)
  ...
  override def update: UpdateBuilder[SalesorderheaderFields, SalesorderheaderRow] = UpdateBuilder.of(""""sales"."salesorderheader"""", SalesorderheaderFields.structure, SalesorderheaderRow.rowParser(1).*)

  override def update(row: SalesorderheaderRow)(using c: Connection): Option[SalesorderheaderRow] = {
    ...
    "shipdate" = ${ParameterValue(row.shipdate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))}::timestamp,
    ...
    "purchaseordernumber" = ${ParameterValue(row.purchaseordernumber, null, ToStatement.optionToStatement(using OrderNumber.toStatement, OrderNumber.parameterMetadata))}::varchar,
    "accountnumber" = ${ParameterValue(row.accountnumber, null, ToStatement.optionToStatement(using AccountNumber.toStatement, AccountNumber.parameterMetadata))}::varchar,
    ...
    "territoryid" = ${ParameterValue(row.territoryid, null, ToStatement.optionToStatement(using SalesterritoryId.toStatement, SalesterritoryId.parameterMetadata))}::int4,
    ...
    "creditcardid" = ${ParameterValue(row.creditcardid, null, ToStatement.optionToStatement(using CustomCreditcardId.toStatement, CustomCreditcardId.parameterMetadata))}::int4,
    "creditcardapprovalcode" = ${ParameterValue(row.creditcardapprovalcode, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
    "currencyrateid" = ${ParameterValue(row.currencyrateid, null, ToStatement.optionToStatement(using CurrencyrateId.toStatement, CurrencyrateId.parameterMetadata))}::int4,
    ...
    "totaldue" = ${ParameterValue(row.totaldue, null, ToStatement.optionToStatement(using ToStatement.scalaBigDecimalToStatement, ParameterMetaData.BigDecimalParameterMetaData))}::numeric,
    "comment" = ${ParameterValue(row.comment, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
  ...
  SQL"""insert into "sales"."salesorderheader"("salesorderid", "revisionnumber", "orderdate", "duedate", "shipdate", "status", "onlineorderflag", "purchaseordernumber", "accountnumber", "customerid", "salespersonid", "territoryid", "billtoaddressid", "shiptoaddressid", "shipmethodid", "creditcardid", "creditcardapprovalcode", "currencyrateid", "subtotal", "taxamt", "freight", "totaldue", "comment", "rowguid", "modifieddate")
    ...
    ${ParameterValue(unsaved.shipdate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))}::timestamp,
    ...
    ${ParameterValue(unsaved.purchaseordernumber, null, ToStatement.optionToStatement(using OrderNumber.toStatement, OrderNumber.parameterMetadata))}::varchar,
    ${ParameterValue(unsaved.accountnumber, null, ToStatement.optionToStatement(using AccountNumber.toStatement, AccountNumber.parameterMetadata))}::varchar,
    ...
    ${ParameterValue(unsaved.territoryid, null, ToStatement.optionToStatement(using SalesterritoryId.toStatement, SalesterritoryId.parameterMetadata))}::int4,
    ...
    ${ParameterValue(unsaved.creditcardid, null, ToStatement.optionToStatement(using CustomCreditcardId.toStatement, CustomCreditcardId.parameterMetadata))}::int4,
    ${ParameterValue(unsaved.creditcardapprovalcode, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
    ${ParameterValue(unsaved.currencyrateid, null, ToStatement.optionToStatement(using CurrencyrateId.toStatement, CurrencyrateId.parameterMetadata))}::int4,
    ...
    ${ParameterValue(unsaved.totaldue, null, ToStatement.optionToStatement(using ToStatement.scalaBigDecimalToStatement, ParameterMetaData.BigDecimalParameterMetaData))}::numeric,
    ${ParameterValue(unsaved.comment, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
  ...
  override def upsertBatch(unsaved: Iterable[SalesorderheaderRow])(using c: Connection): List[SalesorderheaderRow] = {
    def toNamedParameter(row: SalesorderheaderRow): List[NamedParameter] = List(
      ...
      NamedParameter("shipdate", ParameterValue(row.shipdate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))),
      ...
      NamedParameter("purchaseordernumber", ParameterValue(row.purchaseordernumber, null, ToStatement.optionToStatement(using OrderNumber.toStatement, OrderNumber.parameterMetadata))),
      NamedParameter("accountnumber", ParameterValue(row.accountnumber, null, ToStatement.optionToStatement(using AccountNumber.toStatement, AccountNumber.parameterMetadata))),
      ...
      NamedParameter("territoryid", ParameterValue(row.territoryid, null, ToStatement.optionToStatement(using SalesterritoryId.toStatement, SalesterritoryId.parameterMetadata))),
      ...
      NamedParameter("creditcardid", ParameterValue(row.creditcardid, null, ToStatement.optionToStatement(using CustomCreditcardId.toStatement, CustomCreditcardId.parameterMetadata))),
      NamedParameter("creditcardapprovalcode", ParameterValue(row.creditcardapprovalcode, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))),
      NamedParameter("currencyrateid", ParameterValue(row.currencyrateid, null, ToStatement.optionToStatement(using CurrencyrateId.toStatement, CurrencyrateId.parameterMetadata))),
      ...
      NamedParameter("totaldue", ParameterValue(row.totaldue, null, ToStatement.optionToStatement(using ToStatement.scalaBigDecimalToStatement, ParameterMetaData.BigDecimalParameterMetaData))),
      NamedParameter("comment", ParameterValue(row.comment, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))),
