...
object SalesterritoryRowUnsaved {
  ...
  given reads: Reads[SalesterritoryRowUnsaved] = {
    Reads[SalesterritoryRowUnsaved](json => JsResult.fromTry(
        Try(
          SalesterritoryRowUnsaved(
            ...
            territoryid = json.\("territoryid").as(using Defaulted.reads(using SalesterritoryId.reads)),
            salesytd = json.\("salesytd").as(using Defaulted.reads(using Reads.bigDecReads)),
            saleslastyear = json.\("saleslastyear").as(using Defaulted.reads(using Reads.bigDecReads)),
            costytd = json.\("costytd").as(using Defaulted.reads(using Reads.bigDecReads)),
            costlastyear = json.\("costlastyear").as(using Defaulted.reads(using Reads.bigDecReads)),
  ...
  given writes: OWrites[SalesterritoryRowUnsaved] = {
    OWrites[SalesterritoryRowUnsaved](o =>
      new JsObject(ListMap[String, JsValue](
        ...
        "territoryid" -> Defaulted.writes(using SalesterritoryId.writes).writes(o.territoryid),
        ...
        "costytd" -> Defaulted.writes(using Writes.BigDecimalWrites).writes(o.costytd),
        "costlastyear" -> Defaulted.writes(using Writes.BigDecimalWrites).writes(o.costlastyear),
