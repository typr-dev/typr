...
class CurrencyrateRepoImpl extends CurrencyrateRepo {
  override def delete: DeleteBuilder[CurrencyrateFields, CurrencyrateRow] = DeleteBuilder.of(""""sales"."currencyrate"""", CurrencyrateFields.structure, CurrencyrateRow.rowParser(1).*)

  override def deleteById(currencyrateid: CurrencyrateId)(using c: Connection): Boolean = SQL"""delete from "sales"."currencyrate" where "currencyrateid" = ${ParameterValue(currencyrateid, null, CurrencyrateId.toStatement)}""".executeUpdate() > 0
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  )(using c: Connection): Long = streamingInsert(s"""COPY "sales"."currencyrate"("currencyrateid", "currencyratedate", "fromcurrencycode", "tocurrencycode", "averagerate", "endofdayrate", "modifieddate") FROM STDIN""", batchSize, unsaved)(using CurrencyrateRow.pgText, c)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: Iterator[CurrencyrateRowUnsaved],
    batchSize: Int = 10000
  )(using c: Connection): Long = streamingInsert(s"""COPY "sales"."currencyrate"("currencyratedate", "fromcurrencycode", "tocurrencycode", "averagerate", "endofdayrate", "currencyrateid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using CurrencyrateRowUnsaved.pgText, c)

  override def select: SelectBuilder[CurrencyrateFields, CurrencyrateRow] = SelectBuilder.of(""""sales"."currencyrate"""", CurrencyrateFields.structure, CurrencyrateRow.rowParser)
  ...
  override def update: UpdateBuilder[CurrencyrateFields, CurrencyrateRow] = UpdateBuilder.of(""""sales"."currencyrate"""", CurrencyrateFields.structure, CurrencyrateRow.rowParser(1).*)

  override def update(row: CurrencyrateRow)(using c: Connection): Option[CurrencyrateRow] = {
  ...
  override def upsertBatch(unsaved: Iterable[CurrencyrateRow])(using c: Connection): List[CurrencyrateRow] = {
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy currencyrate_TEMP("currencyrateid", "currencyratedate", "fromcurrencycode", "tocurrencycode", "averagerate", "endofdayrate", "modifieddate") from stdin""", batchSize, unsaved)(using CurrencyrateRow.pgText, c): @nowarn
    SQL"""insert into "sales"."currencyrate"("currencyrateid", "currencyratedate", "fromcurrencycode", "tocurrencycode", "averagerate", "endofdayrate", "modifieddate")
