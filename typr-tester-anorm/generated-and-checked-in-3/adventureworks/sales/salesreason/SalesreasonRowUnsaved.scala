...
object SalesreasonRowUnsaved {
  ...
  given reads: Reads[SalesreasonRowUnsaved] = {
    Reads[SalesreasonRowUnsaved](json => JsResult.fromTry(
        Try(
          SalesreasonRowUnsaved(
            ...
            salesreasonid = json.\("salesreasonid").as(using Defaulted.reads(using SalesreasonId.reads)),
  ...
  given writes: OWrites[SalesreasonRowUnsaved] = {
    OWrites[SalesreasonRowUnsaved](o =>
      new JsObject(ListMap[String, JsValue](
        "name" -> Name.writes.writes(o.name),
        "reasontype" -> Name.writes.writes(o.reasontype),
        "salesreasonid" -> Defaulted.writes(using SalesreasonId.writes).writes(o.salesreasonid),
