...
trait SalespersonquotahistoryFields {
  ...
  def compositeIdIn(compositeIds: Array[SalespersonquotahistoryId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[SalespersonquotahistoryId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId]](using ToParameterValue(using null, BusinessentityId.arrayToStatement), adventureworks.arrayParameterMetaData(using BusinessentityId.parameterMetadata)), implicitly), TuplePart[SalespersonquotahistoryId](quotadate)(_.quotadate)(using as[Array[TypoLocalDateTime]](using ToParameterValue(using null, TypoLocalDateTime.arrayToStatement), adventureworks.arrayParameterMetaData(using TypoLocalDateTime.parameterMetadata)), implicitly))
