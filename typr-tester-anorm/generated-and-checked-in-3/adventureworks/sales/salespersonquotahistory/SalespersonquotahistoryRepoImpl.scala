...
class SalespersonquotahistoryRepoImpl extends SalespersonquotahistoryRepo {
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy salespersonquotahistory_TEMP("businessentityid", "quotadate", "salesquota", "rowguid", "modifieddate") from stdin""", batchSize, unsaved)(using SalespersonquotahistoryRow.pgText, c): @nowarn
    SQL"""insert into "sales"."salespersonquotahistory"("businessentityid", "quotadate", "salesquota", "rowguid", "modifieddate")
