...
class JobcandidateRepoImpl extends JobcandidateRepo {
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy jobcandidate_TEMP("jobcandidateid", "businessentityid", "resume", "modifieddate") from stdin""", batchSize, unsaved)(using JobcandidateRow.pgText, c): @nowarn
    SQL"""insert into "humanresources"."jobcandidate"("jobcandidateid", "businessentityid", "resume", "modifieddate")
