...
object EmployeedepartmenthistoryRow {
  ...
  given pgText: Text[EmployeedepartmenthistoryRow] = {
  ...
  given reads: Reads[EmployeedepartmenthistoryRow] = {
    ...
    RowParser[EmployeedepartmenthistoryRow] { row =>
      Success(
        EmployeedepartmenthistoryRow(
          ...
          departmentid = row(idx + 1)(using DepartmentId.column),
          shiftid = row(idx + 2)(using ShiftId.column),
          startdate = row(idx + 3)(using TypoLocalDate.column),
          enddate = row(idx + 4)(using Column.columnToOption(using TypoLocalDate.column)),
  ...
  given writes: OWrites[EmployeedepartmenthistoryRow] = {
