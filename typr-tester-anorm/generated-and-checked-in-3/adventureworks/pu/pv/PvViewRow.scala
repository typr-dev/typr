...
object PvViewRow {
    ...
    Reads[PvViewRow](json => JsResult.fromTry(
        Try(
          PvViewRow(
            ...
            lastreceiptcost = json.\("lastreceiptcost").as(using Reads.bigDecReads),
            lastreceiptdate = json.\("lastreceiptdate").as(using TypoLocalDateTime.reads),
            minorderqty = json.\("minorderqty").as(using Reads.IntReads),
            maxorderqty = json.\("maxorderqty").as(using Reads.IntReads),
            onorderqty = json.\("onorderqty").as(using Reads.IntReads),
    ...
    RowParser[PvViewRow] { row =>
      Success(
        PvViewRow(
          ...
          averageleadtime = row(idx + 3)(using Column.columnToInt),
          standardprice = row(idx + 4)(using Column.columnToScalaBigDecimal),
          lastreceiptcost = row(idx + 5)(using Column.columnToScalaBigDecimal),
          lastreceiptdate = row(idx + 6)(using TypoLocalDateTime.column),
          minorderqty = row(idx + 7)(using Column.columnToInt),
          maxorderqty = row(idx + 8)(using Column.columnToInt),
          onorderqty = row(idx + 9)(using Column.columnToInt),
          unitmeasurecode = row(idx + 10)(using UnitmeasureId.column),
  ...
  given writes: OWrites[PvViewRow] = {
    OWrites[PvViewRow](o =>
