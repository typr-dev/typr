...
object PodViewRow {
    ...
    RowParser[PodViewRow] { row =>
      Success(
        PodViewRow(
          ...
          purchaseorderdetailid = row(idx + 2)(using Column.columnToInt),
          ...
          receivedqty = row(idx + 7)(using Column.columnToScalaBigDecimal),
          rejectedqty = row(idx + 8)(using Column.columnToScalaBigDecimal),
  ...
  given writes: OWrites[PodViewRow] = {
