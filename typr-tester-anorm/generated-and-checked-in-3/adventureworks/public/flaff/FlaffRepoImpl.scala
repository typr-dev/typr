...
class FlaffRepoImpl extends FlaffRepo {
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy flaff_TEMP("code", "another_code", "some_number", "specifier", "parentspecifier") from stdin""", batchSize, unsaved)(using FlaffRow.pgText, c): @nowarn
    SQL"""insert into "public"."flaff"("code", "another_code", "some_number", "specifier", "parentspecifier")
