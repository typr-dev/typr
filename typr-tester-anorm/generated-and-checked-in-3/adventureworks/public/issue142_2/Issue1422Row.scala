...
object Issue1422Row {
  ...
  given reads: Reads[Issue1422Row] = {
    Reads[Issue1422Row](json => JsResult.fromTry(
        Try(
          Issue1422Row(
  ...
  def rowParser(idx: Int): RowParser[Issue1422Row] = {
    RowParser[Issue1422Row] { row =>
      Success(
        Issue1422Row(
  ...
  given writes: OWrites[Issue1422Row] = {
    OWrites[Issue1422Row](o =>
