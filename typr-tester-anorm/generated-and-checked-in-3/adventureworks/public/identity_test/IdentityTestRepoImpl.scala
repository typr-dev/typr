...
class IdentityTestRepoImpl extends IdentityTestRepo {
  ...
  override def deleteById(name: IdentityTestId)(using c: Connection): Boolean = SQL"""delete from "public"."identity-test" where "name" = ${ParameterValue(name, null, IdentityTestId.toStatement)}""".executeUpdate() > 0
