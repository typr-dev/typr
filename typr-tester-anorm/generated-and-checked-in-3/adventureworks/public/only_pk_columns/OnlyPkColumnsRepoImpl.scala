...
class OnlyPkColumnsRepoImpl extends OnlyPkColumnsRepo {
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  )(using c: Connection): Long = streamingInsert(s"""COPY "public"."only_pk_columns"("key_column_1", "key_column_2") FROM STDIN""", batchSize, unsaved)(using OnlyPkColumnsRow.pgText, c)
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy only_pk_columns_TEMP("key_column_1", "key_column_2") from stdin""", batchSize, unsaved)(using OnlyPkColumnsRow.pgText, c): @nowarn
    SQL"""insert into "public"."only_pk_columns"("key_column_1", "key_column_2")
