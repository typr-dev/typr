...
class Issue142RepoImpl extends Issue142Repo {
  ...
  override def deleteById(tabellkode: Issue142Id)(using c: Connection): Boolean = SQL"""delete from "public"."issue142" where "tabellkode" = ${ParameterValue(tabellkode, null, Issue142Id.toStatement)}""".executeUpdate() > 0
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  )(using c: Connection): Long = streamingInsert(s"""COPY "public"."issue142"("tabellkode") FROM STDIN""", batchSize, unsaved)(using Issue142Row.pgText, c)
  ...
  override def upsertBatch(unsaved: Iterable[Issue142Row])(using c: Connection): List[Issue142Row] = {
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy issue142_TEMP("tabellkode") from stdin""", batchSize, unsaved)(using Issue142Row.pgText, c): @nowarn
    SQL"""insert into "public"."issue142"("tabellkode")
