...
object TypoRecord {
  given arrayColumn: Column[Array[TypoRecord]] = {
    Column.nonNull[Array[TypoRecord]]((v1: Any, _) =>
      v1 match {
          case v: PgArray =>
           v.getArray match {
             case v: Array[?] =>
               Right(v.map(v => new TypoRecord(v.asInstanceOf[PGobject].getValue)))
  ...
  given arrayToStatement: ToStatement[Array[TypoRecord]] = {
  ...
  given toStatement: ToStatement[TypoRecord] = {
