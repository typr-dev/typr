...
object TypoInet {
  given arrayColumn: Column[Array[TypoInet]] = {
    Column.nonNull[Array[TypoInet]]((v1: Any, _) =>
      v1 match {
          case v: PgArray =>
           v.getArray match {
             case v: Array[?] =>
               Right(v.map(v => new TypoInet(v.asInstanceOf[PGobject].getValue)))
  ...
  given arrayToStatement: ToStatement[Array[TypoInet]] = {
  ...
  given toStatement: ToStatement[TypoInet] = {
