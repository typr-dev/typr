...
object TypoJson {
  given arrayColumn: Column[Array[TypoJson]] = {
    Column.nonNull[Array[TypoJson]]((v1: Any, _) =>
      v1 match {
          case v: PgArray =>
           v.getArray match {
             case v: Array[?] =>
               Right(v.map(v => new TypoJson(v.asInstanceOf[String])))
  ...
  given arrayToStatement: ToStatement[Array[TypoJson]] = {
  ...
  given toStatement: ToStatement[TypoJson] = {
