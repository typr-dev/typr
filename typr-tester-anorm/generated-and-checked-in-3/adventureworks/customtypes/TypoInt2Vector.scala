...
object TypoInt2Vector {
  given arrayColumn: Column[Array[TypoInt2Vector]] = {
    Column.nonNull[Array[TypoInt2Vector]]((v1: Any, _) =>
      v1 match {
          case v: PgArray =>
           v.getArray match {
             case v: Array[?] =>
               Right(v.map(v => new TypoInt2Vector(v.asInstanceOf[PGobject].getValue)))
  ...
  given arrayToStatement: ToStatement[Array[TypoInt2Vector]] = {
  ...
  given toStatement: ToStatement[TypoInt2Vector] = {
