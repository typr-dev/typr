...
object SalesorderheaderId {
  ...
  implicit lazy val bijection: Bijection[SalesorderheaderId, Int] = Bijection.apply[SalesorderheaderId, Int](_.value)(SalesorderheaderId.apply)
  ...
  implicit lazy val pgText: Text[SalesorderheaderId] = {
