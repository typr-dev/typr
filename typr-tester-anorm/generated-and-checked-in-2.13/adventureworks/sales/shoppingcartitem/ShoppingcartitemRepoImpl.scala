...
class ShoppingcartitemRepoImpl extends ShoppingcartitemRepo {
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy shoppingcartitem_TEMP("shoppingcartitemid", "shoppingcartid", "quantity", "productid", "datecreated", "modifieddate") from stdin""", batchSize, unsaved)(ShoppingcartitemRow.pgText, c): @nowarn
    SQL"""insert into "sales"."shoppingcartitem"("shoppingcartitemid", "shoppingcartid", "quantity", "productid", "datecreated", "modifieddate")
