...
object CurrencyrateId {
  ...
  implicit lazy val bijection: Bijection[CurrencyrateId, Int] = Bijection.apply[CurrencyrateId, Int](_.value)(CurrencyrateId.apply)
  ...
  implicit lazy val pgText: Text[CurrencyrateId] = {
