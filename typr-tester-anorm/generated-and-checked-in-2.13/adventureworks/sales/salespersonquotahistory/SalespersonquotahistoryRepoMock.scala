...
case class SalespersonquotahistoryRepoMock(
  ...
  override def deleteById(compositeId: SalespersonquotahistoryId)(implicit c: Connection): Boolean = map.remove(compositeId).isDefined

  override def deleteByIds(compositeIds: Array[SalespersonquotahistoryId])(implicit c: Connection): Int = compositeIds.map(id => map.remove(id)).count(_.isDefined)
  ...
  override def insert(unsaved: SalespersonquotahistoryRowUnsaved)(implicit c: Connection): SalespersonquotahistoryRow = insert(toRow(unsaved))
  ...
  override def selectAll(implicit c: Connection): List[SalespersonquotahistoryRow] = map.values.toList

  override def selectById(compositeId: SalespersonquotahistoryId)(implicit c: Connection): Option[SalespersonquotahistoryRow] = map.get(compositeId)

  override def selectByIds(compositeIds: Array[SalespersonquotahistoryId])(implicit c: Connection): List[SalespersonquotahistoryRow] = compositeIds.flatMap(map.get).toList
