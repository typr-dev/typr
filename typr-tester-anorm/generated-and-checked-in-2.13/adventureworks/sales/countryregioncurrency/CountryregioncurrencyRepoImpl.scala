...
class CountryregioncurrencyRepoImpl extends CountryregioncurrencyRepo {
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy countryregioncurrency_TEMP("countryregioncode", "currencycode", "modifieddate") from stdin""", batchSize, unsaved)(CountryregioncurrencyRow.pgText, c): @nowarn
    SQL"""insert into "sales"."countryregioncurrency"("countryregioncode", "currencycode", "modifieddate")
