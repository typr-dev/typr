...
case class CountryregioncurrencyRepoMock(
  ...
  override def deleteById(compositeId: CountryregioncurrencyId)(implicit c: Connection): Boolean = map.remove(compositeId).isDefined

  override def deleteByIds(compositeIds: Array[CountryregioncurrencyId])(implicit c: Connection): Int = compositeIds.map(id => map.remove(id)).count(_.isDefined)
  ...
  override def insert(unsaved: CountryregioncurrencyRowUnsaved)(implicit c: Connection): CountryregioncurrencyRow = insert(toRow(unsaved))
  ...
  override def selectAll(implicit c: Connection): List[CountryregioncurrencyRow] = map.values.toList

  override def selectById(compositeId: CountryregioncurrencyId)(implicit c: Connection): Option[CountryregioncurrencyRow] = map.get(compositeId)

  override def selectByIds(compositeIds: Array[CountryregioncurrencyId])(implicit c: Connection): List[CountryregioncurrencyRow] = compositeIds.flatMap(map.get).toList
