...
class PersoncreditcardRepoImpl extends PersoncreditcardRepo {
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  )(implicit c: Connection): Long = streamingInsert(s"""COPY "sales"."personcreditcard"("businessentityid", "creditcardid", "modifieddate") FROM STDIN""", batchSize, unsaved)(PersoncreditcardRow.pgText, c)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: Iterator[PersoncreditcardRowUnsaved],
    batchSize: Int = 10000
  )(implicit c: Connection): Long = streamingInsert(s"""COPY "sales"."personcreditcard"("businessentityid", "creditcardid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(PersoncreditcardRowUnsaved.pgText, c)
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy personcreditcard_TEMP("businessentityid", "creditcardid", "modifieddate") from stdin""", batchSize, unsaved)(PersoncreditcardRow.pgText, c): @nowarn
    SQL"""insert into "sales"."personcreditcard"("businessentityid", "creditcardid", "modifieddate")
