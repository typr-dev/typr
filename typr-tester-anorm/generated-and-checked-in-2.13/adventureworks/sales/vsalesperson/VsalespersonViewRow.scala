    ...
    Reads[VsalespersonViewRow](json => JsResult.fromTry(
        Try(
          VsalespersonViewRow(
            ...
            territoryname = json.\("territoryname").as(Name.reads),
            territorygroup = json.\("territorygroup").as(Reads.StringReads),
    ...
    RowParser[VsalespersonViewRow] { row =>
      Success(
        VsalespersonViewRow(
          ...
          territoryname = row(idx + 17)(Name.column),
          territorygroup = row(idx + 18)(Column.columnToString),
