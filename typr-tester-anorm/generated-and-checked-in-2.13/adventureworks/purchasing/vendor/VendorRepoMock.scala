...
case class VendorRepoMock(
  ...
  override def insert(unsaved: VendorRowUnsaved)(implicit c: Connection): VendorRow = insert(toRow(unsaved))
  ...
  override def selectAll(implicit c: Connection): List[VendorRow] = map.values.toList

  override def selectById(businessentityid: BusinessentityId)(implicit c: Connection): Option[VendorRow] = map.get(businessentityid)

  override def selectByIds(businessentityids: Array[BusinessentityId])(implicit c: Connection): List[VendorRow] = businessentityids.flatMap(map.get).toList
