    ...
    Reads[PgtestnullRow](json => JsResult.fromTry(
        Try(
          PgtestnullRow(
            ...
            mydomaines = json.\("mydomaines").toOption.map(_.as(Reads.ArrayReads[Mydomain](Mydomain.reads, implicitly))),
  ...
  implicit lazy val writes: OWrites[PgtestnullRow] = {
    OWrites[PgtestnullRow](o =>
      new JsObject(ListMap[String, JsValue](
        ...
        "mydomaines" -> Writes.OptionWrites(Writes.arrayWrites[Mydomain](implicitly, Mydomain.writes)).writes(o.mydomaines),
