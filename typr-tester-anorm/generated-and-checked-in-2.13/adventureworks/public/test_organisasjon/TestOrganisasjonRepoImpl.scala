...
class TestOrganisasjonRepoImpl extends TestOrganisasjonRepo {
  ...
  override def deleteById(organisasjonskode: TestOrganisasjonId)(implicit c: Connection): Boolean = SQL"""delete from "public"."test_organisasjon" where "organisasjonskode" = ${ParameterValue(organisasjonskode, null, TestOrganisasjonId.toStatement)}""".executeUpdate() > 0
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  )(implicit c: Connection): Long = streamingInsert(s"""COPY "public"."test_organisasjon"("organisasjonskode") FROM STDIN""", batchSize, unsaved)(TestOrganisasjonRow.pgText, c)
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy test_organisasjon_TEMP("organisasjonskode") from stdin""", batchSize, unsaved)(TestOrganisasjonRow.pgText, c): @nowarn
    SQL"""insert into "public"."test_organisasjon"("organisasjonskode")
