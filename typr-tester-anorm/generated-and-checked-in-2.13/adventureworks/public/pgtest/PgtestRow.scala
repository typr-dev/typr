    ...
    Reads[PgtestRow](json => JsResult.fromTry(
        Try(
          PgtestRow(
            ...
            mydomaines = json.\("mydomaines").as(Reads.ArrayReads[Mydomain](Mydomain.reads, implicitly)),
  ...
  implicit lazy val writes: OWrites[PgtestRow] = {
    OWrites[PgtestRow](o =>
      new JsObject(ListMap[String, JsValue](
        ...
        "mydomaines" -> Writes.arrayWrites[Mydomain](implicitly, Mydomain.writes).writes(o.mydomaines),
