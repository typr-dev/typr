...
case class TestInsert(
  ...
  def personPersonphone(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(implicit c: Connection): PersonphoneRow = (new PersonphoneRepoImpl).insert(new PersonphoneRowUnsaved(businessentityid = businessentityid, phonenumber = phonenumber, phonenumbertypeid = phonenumbertypeid, modifieddate = modifieddate))
  ...
  )(implicit c: Connection): OnlyPkColumnsRow = (new OnlyPkColumnsRepoImpl).insert(new OnlyPkColumnsRow(keyColumn1 = keyColumn1, keyColumn2 = keyColumn2))
  ...
  )(implicit c: Connection): TestSakSoknadsalternativRow = (new TestSakSoknadsalternativRepoImpl).insert(new TestSakSoknadsalternativRow(organisasjonskodeSaksbehandler = organisasjonskodeSaksbehandler, utdanningsmulighetKode = TestUtdanningstilbudId.utdanningsmulighetKode, organisasjonskodeTilbyder = TestUtdanningstilbudId.organisasjonskode))
  ...
  )(implicit c: Connection): TestUtdanningstilbudRow = (new TestUtdanningstilbudRepoImpl).insert(new TestUtdanningstilbudRow(organisasjonskode = organisasjonskode, utdanningsmulighetKode = utdanningsmulighetKode))
  ...
  def purchasingProductvendor(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(implicit c: Connection): ProductvendorRow = (new ProductvendorRepoImpl).insert(new ProductvendorRowUnsaved(productid = productid, businessentityid = businessentityid, averageleadtime = averageleadtime, standardprice = standardprice, lastreceiptcost = lastreceiptcost, lastreceiptdate = lastreceiptdate, minorderqty = minorderqty, maxorderqty = maxorderqty, onorderqty = onorderqty, unitmeasurecode = unitmeasurecode, modifieddate = modifieddate))
  ...
  def salesCurrencyrate(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(implicit c: Connection): CurrencyrateRow = (new CurrencyrateRepoImpl).insert(new CurrencyrateRowUnsaved(currencyratedate = currencyratedate, fromcurrencycode = fromcurrencycode, tocurrencycode = tocurrencycode, averagerate = averagerate, endofdayrate = endofdayrate, currencyrateid = currencyrateid, modifieddate = modifieddate))
  ...
  def salesShoppingcartitem(
    ...
    modifieddate: Defaulted[TypoLocalDateTime] = Defaulted.UseDefault()
  )(implicit c: Connection): ShoppingcartitemRow = (new ShoppingcartitemRepoImpl).insert(new ShoppingcartitemRowUnsaved(shoppingcartid = shoppingcartid, productid = productid, shoppingcartitemid = shoppingcartitemid, quantity = quantity, datecreated = datecreated, modifieddate = modifieddate))
