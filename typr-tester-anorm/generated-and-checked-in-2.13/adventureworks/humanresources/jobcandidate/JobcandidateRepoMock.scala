...
case class JobcandidateRepoMock(
  ...
  override def deleteById(jobcandidateid: JobcandidateId)(implicit c: Connection): Boolean = map.remove(jobcandidateid).isDefined

  override def deleteByIds(jobcandidateids: Array[JobcandidateId])(implicit c: Connection): Int = jobcandidateids.map(id => map.remove(id)).count(_.isDefined)
  ...
  override def insert(unsaved: JobcandidateRowUnsaved)(implicit c: Connection): JobcandidateRow = insert(toRow(unsaved))
  ...
  override def selectAll(implicit c: Connection): List[JobcandidateRow] = map.values.toList

  override def selectById(jobcandidateid: JobcandidateId)(implicit c: Connection): Option[JobcandidateRow] = map.get(jobcandidateid)

  override def selectByIds(jobcandidateids: Array[JobcandidateId])(implicit c: Connection): List[JobcandidateRow] = jobcandidateids.flatMap(map.get).toList
