...
object AddressFields {
  lazy val structure: RelationStructure[AddressFields, AddressRow] =
    new Impl(List())

  private final class Impl(val _path: List[Path])
    extends RelationStructure[AddressFields, AddressRow] {
    ...
    override lazy val fields: AddressFields = new AddressFields {
      ...
      override def addressline1 = Field[String, AddressRow](_path, "addressline1", None, None, x => x.addressline1, (row, value) => row.copy(addressline1 = value))
      ...
      override def postalcode = Field[String, AddressRow](_path, "postalcode", None, None, x => x.postalcode, (row, value) => row.copy(postalcode = value))
