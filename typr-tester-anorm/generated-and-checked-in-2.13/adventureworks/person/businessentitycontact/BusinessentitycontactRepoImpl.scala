...
class BusinessentitycontactRepoImpl extends BusinessentitycontactRepo {
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy businessentitycontact_TEMP("businessentityid", "personid", "contacttypeid", "rowguid", "modifieddate") from stdin""", batchSize, unsaved)(BusinessentitycontactRow.pgText, c): @nowarn
    SQL"""insert into "person"."businessentitycontact"("businessentityid", "personid", "contacttypeid", "rowguid", "modifieddate")
