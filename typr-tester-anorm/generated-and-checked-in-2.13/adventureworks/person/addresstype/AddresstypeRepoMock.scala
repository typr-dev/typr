...
case class AddresstypeRepoMock(
  ...
  override def deleteById(addresstypeid: AddresstypeId)(implicit c: Connection): Boolean = map.remove(addresstypeid).isDefined

  override def deleteByIds(addresstypeids: Array[AddresstypeId])(implicit c: Connection): Int = addresstypeids.map(id => map.remove(id)).count(_.isDefined)
  ...
  override def insert(unsaved: AddresstypeRowUnsaved)(implicit c: Connection): AddresstypeRow = insert(toRow(unsaved))
  ...
  override def selectAll(implicit c: Connection): List[AddresstypeRow] = map.values.toList

  override def selectById(addresstypeid: AddresstypeId)(implicit c: Connection): Option[AddresstypeRow] = map.get(addresstypeid)

  override def selectByIds(addresstypeids: Array[AddresstypeId])(implicit c: Connection): List[AddresstypeRow] = addresstypeids.flatMap(map.get).toList
