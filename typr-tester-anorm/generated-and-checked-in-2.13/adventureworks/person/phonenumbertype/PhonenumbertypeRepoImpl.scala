...
class PhonenumbertypeRepoImpl extends PhonenumbertypeRepo {
  ...
  override def deleteById(phonenumbertypeid: PhonenumbertypeId)(implicit c: Connection): Boolean = SQL"""delete from "person"."phonenumbertype" where "phonenumbertypeid" = ${ParameterValue(phonenumbertypeid, null, PhonenumbertypeId.toStatement)}""".executeUpdate() > 0
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  )(implicit c: Connection): Long = streamingInsert(s"""COPY "person"."phonenumbertype"("phonenumbertypeid", "name", "modifieddate") FROM STDIN""", batchSize, unsaved)(PhonenumbertypeRow.pgText, c)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: Iterator[PhonenumbertypeRowUnsaved],
    batchSize: Int = 10000
  )(implicit c: Connection): Long = streamingInsert(s"""COPY "person"."phonenumbertype"("name", "phonenumbertypeid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(PhonenumbertypeRowUnsaved.pgText, c)
  ...
  override def upsertStreaming(
    ...
    streamingInsert(s"""copy phonenumbertype_TEMP("phonenumbertypeid", "name", "modifieddate") from stdin""", batchSize, unsaved)(PhonenumbertypeRow.pgText, c): @nowarn
    SQL"""insert into "person"."phonenumbertype"("phonenumbertypeid", "name", "modifieddate")
