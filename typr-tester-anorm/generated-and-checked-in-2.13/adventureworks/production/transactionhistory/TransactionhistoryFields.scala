...
object TransactionhistoryFields {
  lazy val structure: RelationStructure[TransactionhistoryFields, TransactionhistoryRow] =
    new Impl(List())

  private final class Impl(val _path: List[Path])
    extends RelationStructure[TransactionhistoryFields, TransactionhistoryRow] {
    ...
    override lazy val fields: TransactionhistoryFields = new TransactionhistoryFields {
      ...
      override def transactiontype = Field[String, TransactionhistoryRow](_path, "transactiontype", None, Some("bpchar"), x => x.transactiontype, (row, value) => row.copy(transactiontype = value))
