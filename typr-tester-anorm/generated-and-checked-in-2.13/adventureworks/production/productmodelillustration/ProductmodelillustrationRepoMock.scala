...
case class ProductmodelillustrationRepoMock(
  ...
  override def deleteById(compositeId: ProductmodelillustrationId)(implicit c: Connection): Boolean = map.remove(compositeId).isDefined

  override def deleteByIds(compositeIds: Array[ProductmodelillustrationId])(implicit c: Connection): Int = compositeIds.map(id => map.remove(id)).count(_.isDefined)
  ...
  override def insert(unsaved: ProductmodelillustrationRowUnsaved)(implicit c: Connection): ProductmodelillustrationRow = insert(toRow(unsaved))
  ...
  override def selectAll(implicit c: Connection): List[ProductmodelillustrationRow] = map.values.toList

  override def selectById(compositeId: ProductmodelillustrationId)(implicit c: Connection): Option[ProductmodelillustrationRow] = map.get(compositeId)

  override def selectByIds(compositeIds: Array[ProductmodelillustrationId])(implicit c: Connection): List[ProductmodelillustrationRow] = compositeIds.flatMap(map.get).toList
