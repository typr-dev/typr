...
object ScrapreasonId {
  ...
  implicit lazy val bijection: Bijection[ScrapreasonId, Int] = Bijection.apply[ScrapreasonId, Int](_.value)(ScrapreasonId.apply)
  ...
  implicit lazy val pgText: Text[ScrapreasonId] = {
