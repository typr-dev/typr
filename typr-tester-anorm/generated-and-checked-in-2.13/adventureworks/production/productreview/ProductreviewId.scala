...
object ProductreviewId {
  ...
  implicit lazy val bijection: Bijection[ProductreviewId, Int] = Bijection.apply[ProductreviewId, Int](_.value)(ProductreviewId.apply)
  ...
  implicit lazy val pgText: Text[ProductreviewId] = {
