...
object WorkorderId {
  ...
  implicit lazy val bijection: Bijection[WorkorderId, Int] = Bijection.apply[WorkorderId, Int](_.value)(WorkorderId.apply)
  ...
  implicit lazy val pgText: Text[WorkorderId] = {
