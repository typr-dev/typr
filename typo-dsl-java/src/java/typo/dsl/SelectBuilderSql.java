...
public abstract class SelectBuilderSql<Fields, Row> implements SelectBuilder<Fields, Row> {
  ...
  @Override
  public <Fields2, Row2>
      SelectBuilder<typo.dsl.Tuple2<Fields, Fields2>, typo.dsl.Tuple2<Row, Row2>> joinOn(
          SelectBuilder<Fields2, Row2> other,
          Function<typo.dsl.Tuple2<Fields, Fields2>, SqlExpr<Boolean>> pred) {
  ...
  @Override
  public <Fields2, Row2>
      SelectBuilder<typo.dsl.Tuple2<Fields, Fields2>, typo.dsl.Tuple2<Row, Optional<Row2>>>
          leftJoinOn(
              SelectBuilder<Fields2, Row2> other,
              Function<typo.dsl.Tuple2<Fields, Fields2>, SqlExpr<Boolean>> pred) {
  ...
  @SuppressWarnings("unchecked")
  public <Fields2, Row2>
      SelectBuilder<typo.dsl.Tuple2<Fields, Fields2>, typo.dsl.Tuple2<Row, List<Row2>>> multisetOn(
          SelectBuilder<Fields2, Row2> other,
          Function<typo.dsl.Tuple2<Fields, Fields2>, SqlExpr<Boolean>> pred) {
    if (!(other instanceof SelectBuilderSql<Fields2, Row2> otherSql)) {
  ...
  static class TableJoin<Fields1, Row1, Fields2, Row2>
      extends SelectBuilderSql<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Row2>> {

    private final SelectBuilderSql<Fields1, Row1> leftBuilder;
    private final SelectBuilderSql<Fields2, Row2> rightBuilder;
    private final Function<typo.dsl.Tuple2<Fields1, Fields2>, SqlExpr<Boolean>> pred;
    private final SelectParams<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Row2>>
        params;
    ...
    public TableJoin(
        ...
        Function<typo.dsl.Tuple2<Fields1, Fields2>, SqlExpr<Boolean>> pred,
        SelectParams<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Row2>> params,
        boolean isLeftJoin) {
    ...
    @Override
    public Structure<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Row2>> structure() {
      return leftBuilder.structure().join(rightBuilder.structure());
    }

    @Override
    public SelectParams<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Row2>> params() {
      return params;
    }

    @Override
    public SelectBuilder<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Row2>> withParams(
        SelectParams<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Row2>> newParams) {
      return new TableJoin<>(leftBuilder, rightBuilder, pred, newParams, isLeftJoin);
    }

    @Override
    public SelectBuilderSql<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Row2>>
        withPath(Path path) {
      return new TableJoin<>(
    ...
    @Override
    public Query<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Row2>> collectQuery(
      ...
      Structure<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Row2>> newStructure =
      ...
      Function<Integer, RowParser<typo.dsl.Tuple2<Row1, Row2>>> combinedParser =
          i -> {
            ...
            Function<Object[], typo.dsl.Tuple2<Row1, Row2>> decode =
                values -> {
                  And<Row1, Row2> and = andParser.decode().apply(values);
                  return typo.dsl.Tuple2.of(and.left(), and.right());
                };
            Function<typo.dsl.Tuple2<Row1, Row2>, Object[]> encode =
                tuple2 -> {
  ...
  static class TableLeftJoin<Fields1, Row1, Fields2, Row2>
      extends SelectBuilderSql<
          typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Optional<Row2>>> {
    ...
    public TableLeftJoin(
        ...
        SelectBuilderSql<Fields2, Row2> right,
        Function<typo.dsl.Tuple2<Fields1, Fields2>, SqlExpr<Boolean>> pred,
        SelectParams<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Optional<Row2>>>
            params) {
      this.leftBuilder = left;
      this.rightBuilder = right;
      this.pred = pred;
    ...
    @Override
    public Structure<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Optional<Row2>>>
        structure() {
      return leftBuilder.structure().leftJoin(rightBuilder.structure());
    }

    @Override
    public SelectParams<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Optional<Row2>>>
        params() {
      return params;
    }

    @Override
    public SelectBuilder<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Optional<Row2>>>
        withParams(
            SelectParams<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Optional<Row2>>>
                newParams) {
    ...
    @Override
    public Query<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Optional<Row2>>>
        collectQuery(RenderCtx ctx, AtomicInteger counter) {

      Query<Fields1, Row1> leftQuery = leftBuilder.collectQuery(ctx, counter);
      Query<Fields2, Row2> rightQuery = rightBuilder.collectQuery(ctx, counter);

      Structure<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Row2>> joinedStructure =
          leftBuilder.structure().join(rightBuilder.structure());
      Structure<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Optional<Row2>>>
      ...
      Function<Integer, RowParser<typo.dsl.Tuple2<Row1, Optional<Row2>>>> combinedParser =
          i -> {
            RowParser<Row1> r1Parser = leftParser.apply(i);
            RowParser<Row2> r2Parser = rightParser.apply(i + leftColCount);
            ...
            var allColumns = new ArrayList<>(andParser.columns());
            Function<Object[], typo.dsl.Tuple2<Row1, Optional<Row2>>> decode =
                values -> {
                  And<Row1, Optional<Row2>> and = andParser.decode().apply(values);
                  return typo.dsl.Tuple2.of(and.left(), and.right());
                };
            Function<typo.dsl.Tuple2<Row1, Optional<Row2>>, Object[]> encode =
                tuple2 -> {
  ...
  static class MultisetSelectBuilder<Fields1, Row1, Fields2, Row2>
      extends SelectBuilderSql<
          typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, List<Row2>>> {

    private final SelectBuilderSql<Fields1, Row1> parentBuilder;
    private final SelectBuilderSql<Fields2, Row2> childBuilder;
    private final Function<typo.dsl.Tuple2<Fields1, Fields2>, SqlExpr<Boolean>> correlationPred;
    private final SelectParams<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, List<Row2>>>
        params;

    MultisetSelectBuilder(
        SelectBuilderSql<Fields1, Row1> parentBuilder,
        SelectBuilderSql<Fields2, Row2> childBuilder,
        Function<typo.dsl.Tuple2<Fields1, Fields2>, SqlExpr<Boolean>> correlationPred,
        SelectParams<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, List<Row2>>> params) {
    ...
    @Override
    public Structure<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, List<Row2>>>
        structure() {
      return new MultisetStructure<>(parentBuilder.structure(), childBuilder.structure());
    }

    @Override
    public SelectParams<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, List<Row2>>>
        params() {
      return params;
    }

    @Override
    public SelectBuilder<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, List<Row2>>>
        withParams(
            SelectParams<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, List<Row2>>>
                newParams) {
      return new MultisetSelectBuilder<>(parentBuilder, childBuilder, correlationPred, newParams);
    }

    @Override
    public SelectBuilderSql<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, List<Row2>>>
        withPath(Path path) {
    ...
    @Override
    public Query<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, List<Row2>>> collectQuery(
        RenderCtx ctx, AtomicInteger counter) {
      ...
      Function<Integer, RowParser<typo.dsl.Tuple2<Row1, List<Row2>>>> combinedParser =
          startCol -> {
            ...
            Function<Object[], typo.dsl.Tuple2<Row1, List<Row2>>> decode =
                values -> {
                  ...
                  return typo.dsl.Tuple2.of(parentRow, childRows);
                };

            Function<typo.dsl.Tuple2<Row1, List<Row2>>, Object[]> encode =
                tuple -> {
    ...
    @Override
    protected Tuple2<Fragment, RowParser<typo.dsl.Tuple2<Row1, List<Row2>>>> getSqlAndRowParser() {
      ...
      // Build row parser
      Query<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, List<Row2>>> fullQuery =
          collectQuery(parentCtx, new AtomicInteger(0));
      RowParser<typo.dsl.Tuple2<Row1, List<Row2>>> rowParser = fullQuery.rowParser().apply(1);
    ...
    private Fragment buildMultisetSubquery(
      ...
      Structure<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, Row2>>
  ...
  record MultisetStructure<Fields1, Row1, Fields2, Row2>(
      ...
      implements Structure<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, List<Row2>>> {
    ...
    @Override
    public typo.dsl.Tuple2<Fields1, Fields2> fields() {
      return typo.dsl.Tuple2.of(parentStructure.fields(), childStructure.fields());
    }
    ...
    @Override
    public Structure<typo.dsl.Tuple2<Fields1, Fields2>, typo.dsl.Tuple2<Row1, List<Row2>>> withPath(
        Path _path) {
    ...
    public <T> Optional<T> untypedGetFieldValue(
        SqlExpr.FieldLike<T, ?> field, typo.dsl.Tuple2<Row1, List<Row2>> row) {
  ...
  static class Rewritten<Fields, OuterRow, Row> extends SelectBuilderSql<Fields, Row> {
    ...
    public <Fields2, Row2>
        SelectBuilder<typo.dsl.Tuple2<Fields, Fields2>, typo.dsl.Tuple2<Row, Row2>> joinOn(
            SelectBuilder<Fields2, Row2> other,
            Function<typo.dsl.Tuple2<Fields, Fields2>, SqlExpr<Boolean>> pred) {
      SelectBuilder<typo.dsl.Tuple2<Fields, Fields2>, typo.dsl.Tuple2<OuterRow, Row2>> outerResult =
          outer.joinOn(other, pred);
      Bijection<typo.dsl.Tuple2<OuterRow, Row2>, typo.dsl.Tuple2<Row, Row2>> tupleBijection =
          Bijection.of(
              tuple -> new typo.dsl.Tuple2<>(bijection.underlying(tuple._1()), tuple._2()),
              tuple -> new typo.dsl.Tuple2<>(bijection.from(tuple._1()), tuple._2()));
      @SuppressWarnings("unchecked")
      SelectBuilderSql<typo.dsl.Tuple2<Fields, Fields2>, typo.dsl.Tuple2<OuterRow, Row2>> outerSql =
          (SelectBuilderSql<typo.dsl.Tuple2<Fields, Fields2>, typo.dsl.Tuple2<OuterRow, Row2>>)
              outerResult;
    ...
    public <Fields2, Row2>
        SelectBuilder<typo.dsl.Tuple2<Fields, Fields2>, typo.dsl.Tuple2<Row, Optional<Row2>>>
            leftJoinOn(
                SelectBuilder<Fields2, Row2> other,
                Function<typo.dsl.Tuple2<Fields, Fields2>, SqlExpr<Boolean>> pred) {
      SelectBuilder<typo.dsl.Tuple2<Fields, Fields2>, typo.dsl.Tuple2<OuterRow, Optional<Row2>>>
          outerResult = outer.leftJoinOn(other, pred);
      Bijection<typo.dsl.Tuple2<OuterRow, Optional<Row2>>, typo.dsl.Tuple2<Row, Optional<Row2>>>
          tupleBijection =
              Bijection.of(
                  tuple -> new typo.dsl.Tuple2<>(bijection.underlying(tuple._1()), tuple._2()),
                  tuple -> new typo.dsl.Tuple2<>(bijection.from(tuple._1()), tuple._2()));
      @SuppressWarnings("unchecked")
      SelectBuilderSql<typo.dsl.Tuple2<Fields, Fields2>, typo.dsl.Tuple2<OuterRow, Optional<Row2>>>
          outerSql =
              (SelectBuilderSql<
                      typo.dsl.Tuple2<Fields, Fields2>, typo.dsl.Tuple2<OuterRow, Optional<Row2>>>)
                  outerResult;
      return new Rewritten<>(outerSql, tupleBijection);
    }
    ...
    @Override
    public <Fields2, Row2>
        SelectBuilder<typo.dsl.Tuple2<Fields, Fields2>, typo.dsl.Tuple2<Row, List<Row2>>>
            multisetOn(
                SelectBuilder<Fields2, Row2> other,
                Function<typo.dsl.Tuple2<Fields, Fields2>, SqlExpr<Boolean>> pred) {
      SelectBuilder<typo.dsl.Tuple2<Fields, Fields2>, typo.dsl.Tuple2<OuterRow, List<Row2>>>
          outerResult = outer.multisetOn(other, pred);
      Bijection<typo.dsl.Tuple2<OuterRow, List<Row2>>, typo.dsl.Tuple2<Row, List<Row2>>>
          tupleBijection =
              Bijection.of(
                  tuple -> new typo.dsl.Tuple2<>(bijection.underlying(tuple._1()), tuple._2()),
                  tuple -> new typo.dsl.Tuple2<>(bijection.from(tuple._1()), tuple._2()));
      @SuppressWarnings("unchecked")
      SelectBuilderSql<typo.dsl.Tuple2<Fields, Fields2>, typo.dsl.Tuple2<OuterRow, List<Row2>>>
          outerSql =
              (SelectBuilderSql<
                      typo.dsl.Tuple2<Fields, Fields2>, typo.dsl.Tuple2<OuterRow, List<Row2>>>)
                  outerResult;
      return new Rewritten<>(outerSql, tupleBijection);
    }
