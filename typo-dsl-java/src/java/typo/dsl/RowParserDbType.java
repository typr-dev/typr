...
import typo.runtime.DbTypename;
import typo.runtime.DbWrite;
...
/**
 * A DbType that wraps a RowParser, allowing multi-column row types to be used as SqlExpr.
 * This enables FieldsExpr to participate in the type system while delegating actual
 * parsing to the existing RowParser infrastructure.
 *
