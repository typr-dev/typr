...
/**
 * Represents a bidirectional conversion between two types.
 * This is used for type-safe conversions in the DSL.
 */
public interface Bijection<T, TT> {
     ...
     *
     * <p>This is used for type-safe boolean operations on {@link SqlExpr}.
     * The method only compiles when called in a context where T = Boolean,
    ...
    /**
     * Curried factory method for Scala interop.
     * Scala: Bijection.apply[W, U](_.value)(SomeType.apply)
     */
