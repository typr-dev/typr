...
class CustomersTest extends AnyFunSuite {
  ...
  test("insert customer with address and money") {
    withConnection { c =>
      ...
      val coords = new CoordinatesT(new java.math.BigDecimal("40.7128"), new java.math.BigDecimal("-74.0061"))
      val address = new AddressT("123 Main St", "New York", coords)
      val creditLimit = new MoneyT(new java.math.BigDecimal("10000.01"), "USD")

      val unsaved = new CustomersRowUnsaved(
        "John Doe",
        address,
        java.util.Optional.of(creditLimit),
      ...
      val _ = assert(inserted.creditLimit.isPresent())
  ...
  test("nested object type roundtrip") {
    withConnection { c =>
      given java.sql.Connection = c
      val coords = new CoordinatesT(new java.math.BigDecimal("37.7749"), new java.math.BigDecimal("-122.4194"))
      ...
      val _ = assert(inserted.billingAddress.location.latitude == new java.math.BigDecimal("37.7749"))
      val _ = assert(inserted.billingAddress.location.longitude == new java.math.BigDecimal("-122.4194"))
  ...
  test("update address") {
    withConnection { c =>
      given java.sql.Connection = c
      val originalCoords = new CoordinatesT(new java.math.BigDecimal("40.7128"), new java.math.BigDecimal("-74.0061"))
      ...
      val newCoords = new CoordinatesT(new java.math.BigDecimal("34.0522"), new java.math.BigDecimal("-118.2437"))
      ...
      val _ = assert(fetched.billingAddress.location.latitude == new java.math.BigDecimal("34.0522"))
    }
  }
  ...
  test("update credit limit") {
    withConnection { c =>
      ...
      val address = new AddressT(
        "123 Test St",
        "Test City",
        new CoordinatesT(new java.math.BigDecimal(0), new java.math.BigDecimal(0))
      )
      val originalLimit = new MoneyT(new java.math.BigDecimal("5000.00"), "USD")

      val unsaved = new CustomersRowUnsaved(
        "Credit Limit Test",
        address,
        java.util.Optional.of(originalLimit),
        Defaulted.UseDefault[CustomersId](),
        Defaulted.UseDefault[java.time.LocalDateTime]()
      )
      ...
      val newLimit = new MoneyT(new java.math.BigDecimal("15000.01"), "EUR")
      val updatedRow = inserted.copy(creditLimit = java.util.Optional.of(newLimit))
      val wasUpdated = repo.update(updatedRow)

      val _ = assert(wasUpdated)
      val fetched = repo.selectById(insertedId).orElseThrow()
      val _ = assert(fetched.creditLimit.isPresent())
      val _ = assert(fetched.creditLimit.get().amount == new java.math.BigDecimal("15000.01"))
  ...
  test("delete customer") {
    withConnection { c =>
      ...
      val address = new AddressT(
        "Delete St",
        "Delete City",
        new CoordinatesT(new java.math.BigDecimal(1), new java.math.BigDecimal(1))
      )
  ...
  test("select all") {
    withConnection { c =>
      ...
      val address1 = new AddressT(
        "Address 1",
        "City 1",
        new CoordinatesT(new java.math.BigDecimal("10.0"), new java.math.BigDecimal("20.0"))
      )
      val address2 = new AddressT(
        "Address 2",
        "City 2",
        new CoordinatesT(new java.math.BigDecimal("30.0"), new java.math.BigDecimal("40.0"))
      )
      ...
      val unsaved2 = new CustomersRowUnsaved(
        "Customer 2",
        address2,
        java.util.Optional.of(new MoneyT(new java.math.BigDecimal("1000"), "USD")),
        Defaulted.UseDefault[CustomersId](),
        Defaulted.UseDefault[java.time.LocalDateTime]()
      )
  ...
  test("object type equality") {
    val coords1 = new CoordinatesT(new java.math.BigDecimal("40.7128"), new java.math.BigDecimal("-74.0061"))
    val coords2 = new CoordinatesT(new java.math.BigDecimal("40.7128"), new java.math.BigDecimal("-74.0061"))
    ...
    val money1 = new MoneyT(new java.math.BigDecimal("100.00"), "USD")
    val money2 = new MoneyT(new java.math.BigDecimal("100.00"), "USD")
  ...
  //   val coords = new CoordinatesT(new java.math.BigDecimal("40.7128"), new java.math.BigDecimal("-74.0061"))
  //   val modified = coords.withLatitude(new java.math.BigDecimal("50.0"))
  //   val _ = assert(modified.latitude == new java.math.BigDecimal("50.0"))
  //   val _ = assert(modified.longitude == new java.math.BigDecimal("-74.0061"))
  //
  //   val address = new AddressT("123 Main St", "New York", coords)
  ...
  //
  //   val money = new MoneyT(new java.math.BigDecimal("100.00"), "USD")
  //   val modifiedMoney = money.withCurrency("EUR")
  //   val _ = assert(modifiedMoney.amount == new java.math.BigDecimal("100.00"))
