 ...
 * <p>
 * Similar to PgText but adapted for MariaDB's text format.
 * MariaDB uses different escape sequences and doesn't have the PostgreSQL array syntax.
 */
public abstract class MariaText<A> implements DbText<A> {
    ...
    /**
     * Escape a string for MariaDB LOAD DATA INFILE format.
    ...
    public static final MariaText<Boolean> textBoolean = instance((b, sb) -> sb.append(b ? "1" : "0"));
    ...
    public static final MariaText<byte[]> textByteArray = instance((bs, sb) -> {
    ...
    /**
     * Text encoder for SET type values.
     * SET values are comma-separated strings in MariaDB.
     */
    public static final MariaText<Set<String>> textSet = instance((set, sb) -> {
        boolean first = true;
    ...
    public static final MariaText<Object> NotWorking = new MariaText<>() {
        @Override
        public void unsafeEncode(Object t, StringBuilder sb) {
            throw new UnsupportedOperationException("LOAD DATA INFILE is not supported for this type");
        }
    };
