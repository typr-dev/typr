...
public interface mariaTester {
    ...
    List<MariaTypeAndExample<?>> All = List.of(
            ...
            new MariaTypeAndExample<>(MariaTypes.tinyintUnsigned, (short) 0), // Edge case: min unsigned
            ...
            new MariaTypeAndExample<>(MariaTypes.bigintUnsigned, BigInteger.ZERO), // Edge case: min unsigned
            ...
            new MariaTypeAndExample<>(MariaTypes.decimal, new BigDecimal("-9999999999")), // Edge case: negative
            ...
            new MariaTypeAndExample<>(MariaTypes.decimal(10, 2), new BigDecimal("0.00")), // Edge case: zero with decimals
            new MariaTypeAndExample<>(MariaTypes.decimal(10, 2), new BigDecimal("-99999999.99")), // Edge case: large negative
            new MariaTypeAndExample<>(MariaTypes.decimal(10, 5), new BigDecimal("12345.67890")),
            new MariaTypeAndExample<>(MariaTypes.decimal(10, 5), new BigDecimal("0.00001")), // Edge case: small value
            ...
            new MariaTypeAndExample<>(MariaTypes.float_, 1.0E-38f).noIdentity(), // Edge case: small positive
            ...
            new MariaTypeAndExample<>(MariaTypes.varchar(255), "Line1\nLine2\tTabbed"), // Edge case: whitespace
            new MariaTypeAndExample<>(MariaTypes.varchar(255), "Quote\"Test'Single\\Back"), // Edge case: special chars
            new MariaTypeAndExample<>(MariaTypes.varchar(255), "Emoji: \uD83D\uDE00\uD83C\uDF89\uD83D\uDE80"), // Edge case: emoji
            ...
            new MariaTypeAndExample<>(MariaTypes.date, LocalDate.of(2099, 12, 31)), // Edge case: far future
            new MariaTypeAndExample<>(MariaTypes.date, LocalDate.of(1000, 1, 1)), // Edge case: old date
            ...
            new MariaTypeAndExample<>(MariaTypes.time, LocalTime.of(23, 59, 59)), // Edge case: end of day
            new MariaTypeAndExample<>(MariaTypes.time(3), LocalTime.of(14, 30, 45, 123000000)),
            new MariaTypeAndExample<>(MariaTypes.time(6), LocalTime.of(14, 30, 45, 123456000)), // Edge case: microseconds
            new MariaTypeAndExample<>(MariaTypes.datetime, LocalDateTime.of(2024, 6, 15, 14, 30, 45)),
            new MariaTypeAndExample<>(MariaTypes.datetime, LocalDateTime.of(1970, 1, 1, 0, 0, 0)), // Edge case: epoch
            new MariaTypeAndExample<>(MariaTypes.datetime(6), LocalDateTime.of(2024, 6, 15, 14, 30, 45, 123456000)),
            new MariaTypeAndExample<>(MariaTypes.timestamp, LocalDateTime.of(2024, 6, 15, 14, 30, 45)),
            new MariaTypeAndExample<>(MariaTypes.timestamp, LocalDateTime.of(1971, 1, 1, 0, 0, 1)), // Edge case: near epoch (timestamp starts at 1970-01-01 00:00:01)
            ...
            // ==================== ENUM Type ====================
            new MariaTypeAndExample<>(MariaTypes.ofEnum("ENUM('RED','GREEN','BLUE')", Color::valueOf), Color.GREEN),
            new MariaTypeAndExample<>(MariaTypes.ofEnum("ENUM('RED','GREEN','BLUE')", Color::valueOf), Color.RED), // Edge case: first value
            new MariaTypeAndExample<>(MariaTypes.ofEnum("ENUM('RED','GREEN','BLUE')", Color::valueOf), Color.BLUE), // Edge case: last value

            // ==================== SET Type ====================
            new MariaTypeAndExample<>(MariaTypes.set.withTypename("SET('email','sms','push')"), MariaSet.of("email", "push")),
            new MariaTypeAndExample<>(MariaTypes.set.withTypename("SET('a','b','c')"), MariaSet.empty()), // Edge case: empty set
            new MariaTypeAndExample<>(MariaTypes.set.withTypename("SET('x','y','z')"), MariaSet.of("x", "y", "z")), // Edge case: all values
            new MariaTypeAndExample<>(MariaTypes.set.withTypename("SET('only')"), MariaSet.of("only")), // Edge case: single value
            ...
            new MariaTypeAndExample<>(MariaTypes.json, new Json("{}")).noIdentity(), // Edge case: empty object
            new MariaTypeAndExample<>(MariaTypes.json, new Json("[]")).noIdentity(), // Edge case: empty array
            new MariaTypeAndExample<>(MariaTypes.json, new Json("null")).noIdentity(), // Edge case: null
            new MariaTypeAndExample<>(MariaTypes.json, new Json("\"string\"")).noIdentity(), // Edge case: string value
            new MariaTypeAndExample<>(MariaTypes.json, new Json("42")).noIdentity(), // Edge case: number value
            new MariaTypeAndExample<>(MariaTypes.json, new Json("true")).noIdentity(), // Edge case: boolean value
            ...
            new MariaTypeAndExample<>(MariaTypes.inet4, Inet4.parse("0.0.0.0")), // Edge case: any address
            new MariaTypeAndExample<>(MariaTypes.inet4, Inet4.parse("255.255.255.255")), // Edge case: broadcast
            new MariaTypeAndExample<>(MariaTypes.inet4, Inet4.parse("127.0.0.1")), // Edge case: localhost
            ...
            new MariaTypeAndExample<>(MariaTypes.inet6, Inet6.parse("fe80::1")) // Edge case: link-local
    );
    ...
    static <A> void testJsonRoundtrip(MariaTypeAndExample<A> t) {
        try {
            ...
            System.out.println("JSON roundtrip " + t.type.typename().sqlType() +
                    ": " + format(original) + " -> " + encoded + " -> " + format(decoded));
