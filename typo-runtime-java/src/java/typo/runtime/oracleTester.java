...
/**
 * Tester for Oracle type codecs. Similar to tester.java and mariaTester.java but for Oracle types.
 * Tests all types defined in OracleTypes.
 */
public interface oracleTester {
  ...
  static <T> T withConnection(SqlFunction<Connection, T> f) {
    ...
    try (var conn =
        java.sql.DriverManager.getConnection(
            "jdbc:oracle:thin:@//localhost:1521/FREEPDB1", "typo", "typo_password")) {
