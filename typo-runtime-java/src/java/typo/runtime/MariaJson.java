...
/**
 * MariaDB-specific JSON codec implementations.
 * Handles conversion to/from JSON in MariaDB's expected format.
 */
public interface MariaJson<A> extends DbJson<A> {
    ...
    MariaJson<Short> int2 = new MariaJson<>() {
        @Override
        ...
        public Short fromJson(JsonValue json) {
            if (json instanceof JsonValue.JNumber n) return n.value().shortValueExact();
            throw new IllegalArgumentException("Expected number, got: " + json.getClass().getSimpleName());
        }
    };

    MariaJson<Integer> int4 = new MariaJson<>() {
        @Override
        ...
        public Integer fromJson(JsonValue json) {
            if (json instanceof JsonValue.JNumber n) return n.value().intValueExact();
            throw new IllegalArgumentException("Expected number, got: " + json.getClass().getSimpleName());
        }
    };

    MariaJson<Long> int8 = new MariaJson<>() {
        @Override
        ...
        public Long fromJson(JsonValue json) {
            if (json instanceof JsonValue.JNumber n) return n.value().longValueExact();
            throw new IllegalArgumentException("Expected number, got: " + json.getClass().getSimpleName());
        }
    };

    MariaJson<Float> float4 = new MariaJson<>() {
        @Override
        ...
        public Float fromJson(JsonValue json) {
            if (json instanceof JsonValue.JNumber n) return n.value().floatValue();
            throw new IllegalArgumentException("Expected number, got: " + json.getClass().getSimpleName());
        }
    };

    MariaJson<Double> float8 = new MariaJson<>() {
        @Override
        ...
        public Double fromJson(JsonValue json) {
            if (json instanceof JsonValue.JNumber n) return n.value().doubleValue();
            throw new IllegalArgumentException("Expected number, got: " + json.getClass().getSimpleName());
        }
    };

    MariaJson<BigDecimal> numeric = new MariaJson<>() {
        @Override
        ...
        public BigDecimal fromJson(JsonValue json) {
            if (json instanceof JsonValue.JNumber n) return n.value();
            throw new IllegalArgumentException("Expected number, got: " + json.getClass().getSimpleName());
        }
    };

    MariaJson<String> text = new MariaJson<>() {
        @Override
    ...
    // Date/Time types
    MariaJson<LocalDate> date = new MariaJson<>() {
        @Override
    ...
    MariaJson<LocalTime> time = new MariaJson<>() {
        @Override
    ...
    MariaJson<LocalDateTime> timestamp = new MariaJson<>() {
        @Override
    ...
    MariaJson<Instant> timestamptz = new MariaJson<>() {
        @Override
    ...
    MariaJson<UUID> uuid = new MariaJson<>() {
        @Override
    ...
    MariaJson<Json> json = new MariaJson<>() {
        @Override
