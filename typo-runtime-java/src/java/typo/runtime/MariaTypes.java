...
public interface MariaTypes {
    ...
    MariaType<Byte> tinyint = MariaType.of("TINYINT",
            MariaRead.readByte, MariaWrite.writeByte, MariaText.textByte, MariaJson.int4.bimap(Integer::byteValue, Byte::intValue));

    MariaType<Short> smallint = MariaType.of("SMALLINT",
            MariaRead.readShort, MariaWrite.writeShort, MariaText.textShort, MariaJson.int2);

    MariaType<Integer> mediumint = MariaType.of("MEDIUMINT",
            MariaRead.readInteger, MariaWrite.writeInteger, MariaText.textInteger, MariaJson.int4);

    MariaType<Integer> int_ = MariaType.of("INT",
            MariaRead.readInteger, MariaWrite.writeInteger, MariaText.textInteger, MariaJson.int4);

    MariaType<Long> bigint = MariaType.of("BIGINT",
            MariaRead.readLong, MariaWrite.writeLong, MariaText.textLong, MariaJson.int8);
    ...
    MariaType<BigInteger> bigintUnsigned = MariaType.of("BIGINT UNSIGNED",
            MariaRead.readBigInteger, MariaWrite.writeBigInteger, MariaText.textBigInteger, MariaJson.numeric.bimap(BigDecimal::toBigInteger, BigDecimal::new));

    // ==================== Fixed-Point Types ====================

    MariaType<BigDecimal> decimal = MariaType.of("DECIMAL",
            MariaRead.readBigDecimal, MariaWrite.writeBigDecimal, MariaText.textBigDecimal, MariaJson.numeric);
    ...
    MariaType<Float> float_ = MariaType.of("FLOAT",
            MariaRead.readFloat, MariaWrite.writeFloat, MariaText.textFloat, MariaJson.float4);

    MariaType<Double> double_ = MariaType.of("DOUBLE",
            MariaRead.readDouble, MariaWrite.writeDouble, MariaText.textDouble, MariaJson.float8);

    // ==================== Boolean Type ====================

    MariaType<Boolean> bool = MariaType.of("BOOLEAN",
            MariaRead.readBoolean, MariaWrite.writeBoolean, MariaText.textBoolean, MariaJson.bool);

    // ==================== Bit Types ====================

    // BIT(1) as Boolean
    MariaType<Boolean> bit1 = MariaType.of("BIT",
            MariaRead.readBitAsBoolean, MariaWrite.writeBoolean, MariaText.textBoolean, MariaJson.bool);

    // BIT(n) as byte[]
    MariaType<byte[]> bit = MariaType.of("BIT",
            MariaRead.readBit, MariaWrite.writeByteArray, MariaText.textByteArray, MariaJson.bytea);

    // ==================== String Types ====================

    MariaType<String> char_ = MariaType.of("CHAR",
            MariaRead.readString, MariaWrite.writeString, MariaText.textString, MariaJson.text);
    ...
    MariaType<byte[]> binary = MariaType.of("BINARY",
            MariaRead.readByteArray, MariaWrite.writeByteArray, MariaText.textByteArray, MariaJson.bytea);

    MariaType<byte[]> varbinary = MariaType.of("VARBINARY",
            MariaRead.readByteArray, MariaWrite.writeByteArray, MariaText.textByteArray, MariaJson.bytea);

    MariaType<byte[]> tinyblob = MariaType.of("TINYBLOB",
            MariaRead.readBlob, MariaWrite.writeByteArray, MariaText.textByteArray, MariaJson.bytea);
    ...
    MariaType<LocalDate> date = MariaType.of("DATE",
            MariaRead.readLocalDate, MariaWrite.passObjectToJdbc(), MariaText.instanceToString(), MariaJson.date);

    MariaType<LocalTime> time = MariaType.of("TIME",
            MariaRead.readLocalTime, MariaWrite.passObjectToJdbc(), MariaText.instanceToString(), MariaJson.time);

    MariaType<LocalDateTime> datetime = MariaType.of("DATETIME",
            MariaRead.readLocalDateTime, MariaWrite.passObjectToJdbc(), MariaText.instanceToString(), MariaJson.timestamp);

    MariaType<LocalDateTime> timestamp = MariaType.of("TIMESTAMP",
            MariaRead.readLocalDateTime, MariaWrite.passObjectToJdbc(), MariaText.instanceToString(), MariaJson.timestamp);

    MariaType<Year> year = MariaType.of("YEAR",
            MariaRead.readYear, MariaWrite.writeShort.contramap(y -> (short) y.getValue()), MariaText.textInteger.contramap(Year::getValue), MariaJson.int4.bimap(Year::of, Year::getValue));
    ...
    // Note: Spatial types use text representation for JSON (WKT format would be better but is complex)
    ...
    MariaType<Geometry> geometry = MariaType.of("GEOMETRY",
            ...
            MariaJson.text.bimap(s -> { throw new UnsupportedOperationException("Geometry JSON not supported"); }, Object::toString));

    MariaType<Point> point = MariaType.of("POINT",
            MariaRead.getObjectAs(Point.class),
            MariaWrite.passObjectToJdbc(),
            MariaText.NotWorking(),
            MariaJson.text.bimap(s -> { throw new UnsupportedOperationException("Point JSON not supported"); }, Object::toString));

    MariaType<LineString> linestring = MariaType.of("LINESTRING",
            MariaRead.getObjectAs(LineString.class),
            MariaWrite.passObjectToJdbc(),
            MariaText.NotWorking(),
            MariaJson.text.bimap(s -> { throw new UnsupportedOperationException("LineString JSON not supported"); }, Object::toString));

    MariaType<Polygon> polygon = MariaType.of("POLYGON",
            MariaRead.getObjectAs(Polygon.class),
            MariaWrite.passObjectToJdbc(),
            MariaText.NotWorking(),
            MariaJson.text.bimap(s -> { throw new UnsupportedOperationException("Polygon JSON not supported"); }, Object::toString));

    MariaType<MultiPoint> multipoint = MariaType.of("MULTIPOINT",
            MariaRead.getObjectAs(MultiPoint.class),
            MariaWrite.passObjectToJdbc(),
            MariaText.NotWorking(),
            MariaJson.text.bimap(s -> { throw new UnsupportedOperationException("MultiPoint JSON not supported"); }, Object::toString));

    MariaType<MultiLineString> multilinestring = MariaType.of("MULTILINESTRING",
            MariaRead.getObjectAs(MultiLineString.class),
            MariaWrite.passObjectToJdbc(),
            MariaText.NotWorking(),
            MariaJson.text.bimap(s -> { throw new UnsupportedOperationException("MultiLineString JSON not supported"); }, Object::toString));

    MariaType<MultiPolygon> multipolygon = MariaType.of("MULTIPOLYGON",
            MariaRead.getObjectAs(MultiPolygon.class),
            MariaWrite.passObjectToJdbc(),
            MariaText.NotWorking(),
            MariaJson.text.bimap(s -> { throw new UnsupportedOperationException("MultiPolygon JSON not supported"); }, Object::toString));
    ...
    MariaType<GeometryCollection> geometrycollection = MariaType.of("GEOMETRYCOLLECTION",
            ...
            MariaWrite.passObjectToJdbc(),
            MariaText.NotWorking(),
            MariaJson.text.bimap(s -> { throw new UnsupportedOperationException("GeometryCollection JSON not supported"); }, Object::toString));
}
