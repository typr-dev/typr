...
public abstract class PgText<A> implements DbText<A> {
    ...
    public static <A> PgText<A> instance(BiConsumer<A, StringBuilder> f, BiConsumer<A, StringBuilder> arrayF) {
        return new PgText<>() {
            @Override
    ...
    public static final PgText<String> textString = instance(StringImpl::unsafeEncode, StringImpl::unsafeArrayEncode);
    ...
    public static <T extends PGobject> PgText<T> textPGobject(){
        return PgText.textString.contramap(x -> {
    ...
    public static final PgText<Object> NotWorking = new PgText<>() {
        @Override
