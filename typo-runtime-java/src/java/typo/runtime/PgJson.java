...
/**
 * PostgreSQL-specific JSON codec implementations.
 * Handles conversion to/from JSON in PostgreSQL's expected format.
 */
public interface PgJson<A> extends DbJson<A> {
    ...
    PgJson<Boolean> bool = new PgJson<>() {
        @Override
    ...
    PgJson<Short> int2 = new PgJson<>() {
        ...
        public Short fromJson(JsonValue json) {
            if (json instanceof JsonValue.JNumber(BigDecimal value)) return value.shortValueExact();
            throw new IllegalArgumentException("Expected number, got: " + json.getClass().getSimpleName());
        }
    };

    PgJson<Integer> int4 = new PgJson<>() {
        @Override
        ...
        public Integer fromJson(JsonValue json) {
            if (json instanceof JsonValue.JNumber(BigDecimal value)) return value.intValueExact();
            throw new IllegalArgumentException("Expected number, got: " + json.getClass().getSimpleName());
        }
    };

    PgJson<Long> int8 = new PgJson<>() {
        @Override
        ...
        public Long fromJson(JsonValue json) {
            if (json instanceof JsonValue.JNumber(BigDecimal value)) return value.longValueExact();
            throw new IllegalArgumentException("Expected number, got: " + json.getClass().getSimpleName());
        }
    };

    PgJson<Float> float4 = new PgJson<>() {
        @Override
        ...
        public Float fromJson(JsonValue json) {
            if (json instanceof JsonValue.JNumber(BigDecimal value)) return value.floatValue();
            throw new IllegalArgumentException("Expected number, got: " + json.getClass().getSimpleName());
        }
    };

    PgJson<Double> float8 = new PgJson<>() {
        @Override
        ...
        public Double fromJson(JsonValue json) {
            if (json instanceof JsonValue.JNumber(BigDecimal value)) return value.doubleValue();
            throw new IllegalArgumentException("Expected number, got: " + json.getClass().getSimpleName());
        }
    };

    PgJson<BigDecimal> numeric = new PgJson<>() {
        @Override
        ...
        public BigDecimal fromJson(JsonValue json) {
            if (json instanceof JsonValue.JNumber(BigDecimal value)) return value;
            throw new IllegalArgumentException("Expected number, got: " + json.getClass().getSimpleName());
        }
    };

    PgJson<String> text = new PgJson<>() {
        @Override
        ...
        public String fromJson(JsonValue json) {
            ...
            throw new IllegalArgumentException("Expected string, got: " + json.getClass().getSimpleName());
        }
    };

    PgJson<byte[]> bytea = new PgJson<>() {
        @Override
    ...
    // Date/Time types
    PgJson<LocalDate> date = new PgJson<>() {
        @Override
        ...
        public LocalDate fromJson(JsonValue json) {
            ...
            throw new IllegalArgumentException("Expected string for date, got: " + json.getClass().getSimpleName());
        }
    };

    PgJson<LocalTime> time = new PgJson<>() {
        @Override
        ...
        public LocalTime fromJson(JsonValue json) {
            ...
            throw new IllegalArgumentException("Expected string for time, got: " + json.getClass().getSimpleName());
        }
    };

    PgJson<LocalDateTime> timestamp = new PgJson<>() {
        // PostgreSQL JSON uses ISO format with 'T', but some custom types use space delimiter
        private static final DateTimeFormatter FORMATTER_SPACE = new DateTimeFormatterBuilder()
    ...
    PgJson<Instant> timestamptz = new PgJson<>() {
        @Override
        ...
        public Instant fromJson(JsonValue json) {
            ...
            throw new IllegalArgumentException("Expected string for timestamptz, got: " + json.getClass().getSimpleName());
        }
    };
    ...
    PgJson<UUID> uuid = new PgJson<>() {
        ...
        public UUID fromJson(JsonValue json) {
            ...
            throw new IllegalArgumentException("Expected string for uuid, got: " + json.getClass().getSimpleName());
        }
    };

    // JSON types (pass-through)
    PgJson<Json> json = new PgJson<>() {
        @Override
    ...
    PgJson<PGpoint> point = new PgJson<>() {
        @Override
        ...
        public PGpoint fromJson(JsonValue json) {
            ...
            throw new IllegalArgumentException("Expected string for point, got: " + json.getClass().getSimpleName());
        }
    };

    PgJson<PGbox> box = new PgJson<>() {
        @Override
        ...
        public PGbox fromJson(JsonValue json) {
            ...
            throw new IllegalArgumentException("Expected string for box, got: " + json.getClass().getSimpleName());
        }
    };

    PgJson<PGcircle> circle = new PgJson<>() {
        @Override
        ...
        public PGcircle fromJson(JsonValue json) {
            ...
            throw new IllegalArgumentException("Expected string for circle, got: " + json.getClass().getSimpleName());
        }
    };

    PgJson<PGline> line = new PgJson<>() {
        @Override
        ...
        public PGline fromJson(JsonValue json) {
            ...
            throw new IllegalArgumentException("Expected string for line, got: " + json.getClass().getSimpleName());
        }
    };

    PgJson<PGlseg> lseg = new PgJson<>() {
        @Override
        ...
        public PGlseg fromJson(JsonValue json) {
            ...
            throw new IllegalArgumentException("Expected string for lseg, got: " + json.getClass().getSimpleName());
        }
    };

    PgJson<PGpath> path = new PgJson<>() {
        @Override
        ...
        public PGpath fromJson(JsonValue json) {
            ...
            throw new IllegalArgumentException("Expected string for path, got: " + json.getClass().getSimpleName());
        }
    };

    PgJson<PGpolygon> polygon = new PgJson<>() {
        @Override
        ...
        public PGpolygon fromJson(JsonValue json) {
            ...
            throw new IllegalArgumentException("Expected string for polygon, got: " + json.getClass().getSimpleName());
        }
    };
    ...
    PgJson<Map<String, String>> hstore = new PgJson<>() {
        @Override
        public JsonValue toJson(Map<String, String> value) {
            Map<String, JsonValue> fields = new LinkedHashMap<>();
            for (Map.Entry<String, String> e : value.entrySet()) {
                fields.put(e.getKey(), e.getValue() == null ? JsonValue.JNull.INSTANCE : new JsonValue.JString(e.getValue()));
            }
        ...
        public Map<String, String> fromJson(JsonValue json) {
            if (!(json instanceof JsonValue.JObject(Map<String, JsonValue> fields))) {
                throw new IllegalArgumentException("Expected object for hstore, got: " + json.getClass().getSimpleName());
            }
            ...
            for (Map.Entry<String, JsonValue> e : fields.entrySet()) {
                if (e.getValue() instanceof JsonValue.JNull) {
                    ...
                    throw new IllegalArgumentException("Expected string or null in hstore, got: " + e.getValue().getClass().getSimpleName());
                }
            }
            return result;
        }
