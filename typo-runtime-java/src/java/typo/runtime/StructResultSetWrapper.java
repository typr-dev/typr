...
/**
 * Minimal ResultSet wrapper that allows reading a STRUCT as if it were from a ResultSet. This is
 * used internally to convert STRUCT elements in arrays to Java objects.
 */
class StructResultSetWrapper implements ResultSet, AutoCloseable {
  private final STRUCT struct;

  StructResultSetWrapper(STRUCT struct) {
    this.struct = struct;
  }
