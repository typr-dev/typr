...
/**
 * Interface for JSON serialization/deserialization of database values.
 * Each DbType provides an implementation that converts values to/from JSON
 * in the format that the database produces/consumes.
 *
