...
public interface tester {
    ...
    List<PgTypeAndExample<?>> All = List.<PgTypeAndExample<?>>of(
            // ==================== ACL Item Types ====================
            ...
            new PgTypeAndExample<>(PgTypes.box, new PGbox(-100, -50, 100, 50)).noIdentity(), // Edge case: negative coords
            ...
            new PgTypeAndExample<>(PgTypes.circle, new PGcircle(new PGpoint(0, 0), 0)).noIdentity(), // Edge case: zero radius
            ...
            new PgTypeAndExample<>(PgTypes.point, new PGpoint(0, 0)).noIdentity(), // Edge case: origin
            ...
            new PgTypeAndExample<>(PgTypes.textArray, new String[]{"a", "b", "c"}), // Edge case: multiple elements
            ...
            new PgTypeAndExample<>(PgTypes.bytea, new byte[]{(byte) 0xFF, (byte) 0xFE, (byte) 0xFD}), // Edge case: high bytes
            ...
            new PgTypeAndExample<>(PgTypes.time, LocalTime.of(23, 59, 59, 999999000)), // Edge case: end of day
            ...
            new PgTypeAndExample<>(PgTypes.timestamp, LocalDateTime.of(1970, 1, 1, 0, 0, 0)), // Edge case: epoch
            ...
            new PgTypeAndExample<>(PgTypes.interval, new PGInterval(0, 0, 0, 0, 0, 0)).noIdentity(), // Edge case: zero interval
            ...
            new PgTypeAndExample<>(PgTypes.numeric, new BigDecimal("-99999999999999.999999999999")), // Edge case: large negative
            new PgTypeAndExample<>(PgTypes.numeric, new BigDecimal("99999999999999.999999999999")), // Edge case: large positive
            ...
            new PgTypeAndExample<>(PgTypes.vector, new Vector(new short[]{32767, -32768})), // Edge case: min/max short values
            new PgTypeAndExample<>(PgTypes.vector, new Vector(new short[]{0, 0, 0})), // Edge case: zero vector
            ...
            new PgTypeAndExample<>(PgTypes.inet, new Inet("192.168.1.1")), // Edge case: common private IP
            ...
            new PgTypeAndExample<>(PgTypes.hstore, Map.of("key1", "value1", "key2", "value2")), // Edge case: multiple entries

            // ==================== JSON Types ====================
            new PgTypeAndExample<>(PgTypes.json, new Json("{\"A\": 42}")).noIdentity(),
            new PgTypeAndExample<>(PgTypes.json, new Json("{}")).noIdentity(), // Edge case: empty object
            new PgTypeAndExample<>(PgTypes.json, new Json("[]")).noIdentity(), // Edge case: empty array
            ...
            new PgTypeAndExample<>(PgTypes.regconfig, new Regconfig("english")), // Edge case: common config
            ...
            new PgTypeAndExample<>(PgTypes.regnamespace, new Regnamespace("pg_catalog")), // Edge case: system namespace
            ...
            new PgTypeAndExample<>(PgTypes.xml, new Xml("<root><child attr=\"value\">text</child></root>")).noIdentity(), // Edge case: nested
