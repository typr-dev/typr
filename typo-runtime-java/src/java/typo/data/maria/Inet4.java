...
/**
 * Wrapper for MariaDB INET4 type.
 * Represents an IPv4 address.
 * <p>
 * MariaDB stores INET4 internally as a 4-byte binary value but returns it as a string
...
public record Inet4(String value) {
    ...
    public static Inet4 fromBytes(byte[] bytes) {
        ...
        return new Inet4(String.format("%d.%d.%d.%d",
