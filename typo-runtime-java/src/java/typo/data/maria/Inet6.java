package typo.data.maria;

import java.util.Objects;

/**
 * Wrapper for MariaDB INET6 type.
 * Represents an IPv6 address (can also store IPv4 addresses in IPv6 format).
 * <p>
 * MariaDB stores INET6 internally as a 16-byte binary value but returns it as a string
 * in standard IPv6 notation (e.g., "::ffff:192.168.1.1" or "2001:db8::1").
 */
public record Inet6(String value) {
    ...
    /**
     * If this is an IPv4-mapped address, extract the IPv4 part.
