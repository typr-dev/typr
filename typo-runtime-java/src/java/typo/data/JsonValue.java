 ...
 * This is used for type-safe JSON serialization/deserialization without external dependencies.
 */
public sealed interface JsonValue permits JsonValue.JNull, JsonValue.JBool, JsonValue.JNumber, JsonValue.JString, JsonValue.JArray, JsonValue.JObject {
    ...
    /** JSON number value (stored as BigDecimal for precision) */
    record JNumber(BigDecimal value) implements JsonValue {
        public static JNumber of(long value) {
            return new JNumber(BigDecimal.valueOf(value));
        }
        ...
        public static JNumber of(BigDecimal value) {
