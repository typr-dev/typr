...
public class DepartmentRepoImpl implements DepartmentRepo {
  ...
  public DepartmentRow insert(DepartmentRowUnsaved unsaved, Connection c) {
    ...
    Fragment q =
        interpolate(
            Fragment.lit("insert into \"humanresources\".\"department\"("),
  ...
  public Long insertStreaming(Iterator<DepartmentRow> unsaved, Integer batchSize, Connection c) {
    return streamingInsert.insertUnchecked(
        "COPY \"humanresources\".\"department\"(\"departmentid\", \"name\", \"groupname\","
  ...
  public Long insertUnsavedStreaming(
    ...
    return streamingInsert.insertUnchecked(
        "COPY \"humanresources\".\"department\"(\"name\", \"groupname\", \"departmentid\","
  ...
  public Integer upsertStreaming(Iterator<DepartmentRow> unsaved, Integer batchSize, Connection c) {
    interpolate(
            Fragment.lit(
                "create temporary table department_TEMP (like \"humanresources\".\"department\") on"
                    + " commit drop"))
        .update()
        .runUnchecked(c);
    streamingInsert.insertUnchecked(
        "copy department_TEMP(\"departmentid\", \"name\", \"groupname\", \"modifieddate\") from"
            + " stdin",
        batchSize,
        unsaved,
        c,
