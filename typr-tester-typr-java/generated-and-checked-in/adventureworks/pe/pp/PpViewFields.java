...
public interface PpViewFields extends FieldsExpr<PpViewRow> {
  record Impl(List<Path> _path)
    ...
    public Field<BusinessentityId, PpViewRow> id() {
      return new Field<BusinessentityId, PpViewRow>(
          _path,
          "id",
          PpViewRow::id,
          Optional.empty(),
    ...
    public Field<Phone, PpViewRow> phonenumber() {
      return new Field<Phone, PpViewRow>(
          _path,
          "phonenumber",
          PpViewRow::phonenumber,
          Optional.empty(),
          Optional.empty(),
    ...
    public Field<PhonenumbertypeId, PpViewRow> phonenumbertypeid() {
      return new Field<PhonenumbertypeId, PpViewRow>(
          _path,
          "phonenumbertypeid",
          PpViewRow::phonenumbertypeid,
          Optional.empty(),
          Optional.empty(),
