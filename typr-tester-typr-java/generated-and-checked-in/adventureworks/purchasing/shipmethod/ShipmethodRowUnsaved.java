...
public record ShipmethodRowUnsaved(
    ...
    Name name,
    /**
     * Default: nextval('purchasing.shipmethod_shipmethodid_seq'::regclass) Primary key for
     * ShipMethod records.
     */
    Defaulted<ShipmethodId> shipmethodid,
    /**
     * Default: 0.00 Minimum shipping charge. Constraint CK_ShipMethod_ShipBase affecting columns
     * shipbase: ((shipbase > 0.00))
     */
    Defaulted<BigDecimal> shipbase,
    /**
     * Default: 0.00 Shipping charge per pound. Constraint CK_ShipMethod_ShipRate affecting columns
  ...
  /**
   * Default: nextval('purchasing.shipmethod_shipmethodid_seq'::regclass) Primary key for ShipMethod
   * records.
   */
  ...
  public static PgText<ShipmethodRowUnsaved> pgText =
      PgText.instance(
          (row, sb) -> {
  ...
  public ShipmethodRow toRow(
    ...
    return new ShipmethodRow(
        shipmethodid.getOrElse(shipmethodidDefault),
        name,
        shipbase.getOrElse(shipbaseDefault),
        shiprate.getOrElse(shiprateDefault),
