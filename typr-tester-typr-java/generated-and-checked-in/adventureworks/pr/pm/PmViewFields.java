...
public interface PmViewFields extends FieldsExpr<PmViewRow> {
  record Impl(List<Path> _path)
      implements PmViewFields, RelationStructure<PmViewFields, PmViewRow> {
    @Override
    public Field<ProductmodelId, PmViewRow> id() {
      return new Field<ProductmodelId, PmViewRow>(
          _path,
          "id",
          PmViewRow::id,
          Optional.empty(),
    ...
    public Field<Name, PmViewRow> name() {
      return new Field<Name, PmViewRow>(
          _path,
          "name",
          PmViewRow::name,
          Optional.empty(),
    ...
    public Field<Xml, PmViewRow> catalogdescription() {
      return new Field<Xml, PmViewRow>(
          _path,
          "catalogdescription",
          PmViewRow::catalogdescription,
          Optional.empty(),
          Optional.empty(),
    ...
    public Field<UUID, PmViewRow> rowguid() {
      return new Field<UUID, PmViewRow>(
          _path,
          "rowguid",
          PmViewRow::rowguid,
          Optional.empty(),
    ...
    public Field<LocalDateTime, PmViewRow> modifieddate() {
      return new Field<LocalDateTime, PmViewRow>(
          _path,
          "modifieddate",
          PmViewRow::modifieddate,
          Optional.empty(),
          Optional.empty(),
