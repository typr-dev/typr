...
/**
 * This class corresponds to a row in table `production.productlistpricehistory` which has not been
 * persisted yet
 */
public record ProductlistpricehistoryRowUnsaved(
  ...
  public static PgText<ProductlistpricehistoryRowUnsaved> pgText =
      PgText.instance(
          (row, sb) -> {
  ...
  public ProductlistpricehistoryRow toRow(
      java.util.function.Supplier<LocalDateTime> modifieddateDefault) {
    return new ProductlistpricehistoryRow(
        productid, startdate, enddate, listprice, modifieddate.getOrElse(modifieddateDefault));
  }
  ;
}
