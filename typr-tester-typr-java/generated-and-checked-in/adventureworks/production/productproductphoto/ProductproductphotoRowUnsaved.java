...
/**
 * This class corresponds to a row in table `production.productproductphoto` which has not been
 * persisted yet
 */
public record ProductproductphotoRowUnsaved(
    ...
    /** Default: false 0 = Photo is not the principal image. 1 = Photo is the principal image. */
  ...
  public static PgText<ProductproductphotoRowUnsaved> pgText =
      PgText.instance(
          (row, sb) -> {
  ...
  public ProductproductphotoRow toRow(
    ...
    return new ProductproductphotoRow(
        productid,
        productphotoid,
        primary.getOrElse(primaryDefault),
