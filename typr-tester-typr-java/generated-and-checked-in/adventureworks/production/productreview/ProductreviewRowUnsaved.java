...
/**
 * This class corresponds to a row in table `production.productreview` which has not been persisted
 * yet
 */
public record ProductreviewRowUnsaved(
    ...
    /**
     * Default: nextval('production.productreview_productreviewid_seq'::regclass) Primary key for
     * ProductReview records.
     */
    Defaulted<ProductreviewId> productreviewid,
    /** Default: now() Date review was submitted. */
  ...
  public static PgText<ProductreviewRowUnsaved> pgText =
      PgText.instance(
          (row, sb) -> {
  ...
  public ProductreviewRow toRow(
    ...
    return new ProductreviewRow(
        productreviewid.getOrElse(productreviewidDefault),
        productid,
        reviewername,
        reviewdate.getOrElse(reviewdateDefault),
        emailaddress,
        rating,
        comments,
