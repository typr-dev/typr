...
/**
 * This class corresponds to a row in table `sales.salesorderdetail` which has not been persisted
 * yet
 */
public record SalesorderdetailRowUnsaved(
    ...
    /**
     * Default: nextval('sales.salesorderdetail_salesorderdetailid_seq'::regclass) Primary key. One
     * incremental unique number per product sold.
     */
    Defaulted<Integer> salesorderdetailid,
    /**
     * Default: 0.0 Discount amount. Constraint CK_SalesOrderDetail_UnitPriceDiscount affecting
  ...
  public SalesorderdetailRowUnsaved(
      ...
      SpecialofferId specialofferid,
      /**
       * Selling price of a single product. Constraint CK_SalesOrderDetail_UnitPrice affecting
       * columns unitprice: ((unitprice >= 0.00))
       */
      BigDecimal unitprice) {
    this(
        salesorderid,
  ...
  /** Shipment tracking number supplied by the shipper. */
  public SalesorderdetailRowUnsaved withCarriertrackingnumber(
      Optional</* max 25 chars */ String> carriertrackingnumber) {
    return new SalesorderdetailRowUnsaved(
        salesorderid,
        carriertrackingnumber,
  ...
  public static PgText<SalesorderdetailRowUnsaved> pgText =
      PgText.instance(
          (row, sb) -> {
  ...
  public SalesorderdetailRow toRow(
    ...
    return new SalesorderdetailRow(
        salesorderid,
        salesorderdetailid.getOrElse(salesorderdetailidDefault),
        carriertrackingnumber,
        orderqty,
        productid,
        specialofferid,
        unitprice,
        unitpricediscount.getOrElse(unitpricediscountDefault),
