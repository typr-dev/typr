...
public interface SthViewFields extends FieldsExpr<SthViewRow> {
  record Impl(List<Path> _path)
      implements SthViewFields, RelationStructure<SthViewFields, SthViewRow> {
    @Override
    public Field<SalesterritoryId, SthViewRow> id() {
      return new Field<SalesterritoryId, SthViewRow>(
          _path,
          "id",
          SthViewRow::id,
          Optional.empty(),
    ...
    public Field<BusinessentityId, SthViewRow> businessentityid() {
      return new Field<BusinessentityId, SthViewRow>(
          _path,
          "businessentityid",
          SthViewRow::businessentityid,
          Optional.empty(),
          Optional.empty(),
    ...
    public Field<LocalDateTime, SthViewRow> startdate() {
      return new Field<LocalDateTime, SthViewRow>(
          _path,
          "startdate",
          SthViewRow::startdate,
          Optional.empty(),
          Optional.empty(),
    ...
    public Field<UUID, SthViewRow> rowguid() {
      return new Field<UUID, SthViewRow>(
          _path,
          "rowguid",
          SthViewRow::rowguid,
          Optional.empty(),
