...
object OracleAdapter extends DbAdapter {
  ...
  val Types: jvm.Type.Qualified = jvm.Type.Qualified("typo.runtime.OracleTypes")
  val TypeClass: jvm.Type.Qualified = jvm.Type.Qualified("typo.runtime.OracleType")
  ...
  val ScalaDbTypeOps: jvm.Type.Qualified = jvm.Type.Qualified("typo.scaladsl.OracleTypeOps")
