...
object TestSakSoknadsalternativRow {
  ...
  implicit lazy val pgText: Text[TestSakSoknadsalternativRow] = {
  ...
  implicit lazy val reads: Reads[TestSakSoknadsalternativRow] = {
  ...
  implicit lazy val writes: OWrites[TestSakSoknadsalternativRow] = {
