...
class ShiftRepoImpl extends ShiftRepo {
  ...
  override def insertStreaming(unsaved: Iterator[ShiftRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "humanresources"."shift"("shiftid", "name", "starttime", "endtime", "modifieddate") FROM STDIN""", batchSize, unsaved)(using ShiftRow.text, c)
  }
  ...
  override def insertUnsavedStreaming(unsaved: Iterator[ShiftRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "humanresources"."shift"("name", "starttime", "endtime", "shiftid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using ShiftRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[ShiftRow], batchSize: Int = 10000)(using c: Connection): Int = {
    ...
    streamingInsert(s"""copy shift_TEMP("shiftid", "name", "starttime", "endtime", "modifieddate") from stdin""", batchSize, unsaved)(using ShiftRow.text, c): @nowarn
    SQL"""insert into "humanresources"."shift"("shiftid", "name", "starttime", "endtime", "modifieddate")
