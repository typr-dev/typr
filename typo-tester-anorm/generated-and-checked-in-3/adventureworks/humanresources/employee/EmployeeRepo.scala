...
trait EmployeeRepo {
  ...
  def insertStreaming(unsaved: Iterator[EmployeeRow], batchSize: Int = 10000)(using c: Connection): Long
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[EmployeeRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long
  ...
  def upsertStreaming(unsaved: Iterator[EmployeeRow], batchSize: Int = 10000)(using c: Connection): Int
}
