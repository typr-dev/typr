...
object EmployeepayhistoryRow {
  ...
  given reads: Reads[EmployeepayhistoryRow] = Reads[EmployeepayhistoryRow](json => JsResult.fromTry(
      Try(
  ...
  given writes: OWrites[EmployeepayhistoryRow] = OWrites[EmployeepayhistoryRow](o =>
