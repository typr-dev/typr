...
class DepartmentRepoImpl extends DepartmentRepo {
  ...
  override def insertStreaming(unsaved: Iterator[DepartmentRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "humanresources"."department"("departmentid", "name", "groupname", "modifieddate") FROM STDIN""", batchSize, unsaved)(using DepartmentRow.text, c)
  }
  ...
  override def insertUnsavedStreaming(unsaved: Iterator[DepartmentRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "humanresources"."department"("name", "groupname", "departmentid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using DepartmentRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[DepartmentRow], batchSize: Int = 10000)(using c: Connection): Int = {
    ...
    streamingInsert(s"""copy department_TEMP("departmentid", "name", "groupname", "modifieddate") from stdin""", batchSize, unsaved)(using DepartmentRow.text, c): @nowarn
    SQL"""insert into "humanresources"."department"("departmentid", "name", "groupname", "modifieddate")
