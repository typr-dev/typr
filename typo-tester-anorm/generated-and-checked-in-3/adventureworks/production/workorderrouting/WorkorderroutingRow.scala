...
object WorkorderroutingRow {
  ...
  given reads: Reads[WorkorderroutingRow] = Reads[WorkorderroutingRow](json => JsResult.fromTry(
      Try(
        WorkorderroutingRow(
  ...
  given writes: OWrites[WorkorderroutingRow] = OWrites[WorkorderroutingRow](o =>
