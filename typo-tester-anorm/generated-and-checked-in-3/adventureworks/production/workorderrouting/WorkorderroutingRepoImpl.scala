...
class WorkorderroutingRepoImpl extends WorkorderroutingRepo {
  ...
  override def deleteById(compositeId: WorkorderroutingId)(using c: Connection): Boolean = {
  ...
  override def insert(unsaved: WorkorderroutingRowUnsaved)(using c: Connection): WorkorderroutingRow = {
    val namedParameters = List(
      ...
      Some((NamedParameter("actualstartdate", ParameterValue(unsaved.actualstartdate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))), "::timestamp")),
      Some((NamedParameter("actualenddate", ParameterValue(unsaved.actualenddate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))), "::timestamp")),
      Some((NamedParameter("actualresourcehrs", ParameterValue(unsaved.actualresourcehrs, null, ToStatement.optionToStatement(using ToStatement.scalaBigDecimalToStatement, ParameterMetaData.BigDecimalParameterMetaData))), "::numeric")),
      Some((NamedParameter("plannedcost", ParameterValue(unsaved.plannedcost, null, ToStatement.scalaBigDecimalToStatement)), "::numeric")),
      Some((NamedParameter("actualcost", ParameterValue(unsaved.actualcost, null, ToStatement.optionToStatement(using ToStatement.scalaBigDecimalToStatement, ParameterMetaData.BigDecimalParameterMetaData))), "::numeric")),
  ...
  override def insertStreaming(unsaved: Iterator[WorkorderroutingRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."workorderrouting"("workorderid", "productid", "operationsequence", "locationid", "scheduledstartdate", "scheduledenddate", "actualstartdate", "actualenddate", "actualresourcehrs", "plannedcost", "actualcost", "modifieddate") FROM STDIN""", batchSize, unsaved)(using WorkorderroutingRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[WorkorderroutingRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."workorderrouting"("workorderid", "productid", "operationsequence", "locationid", "scheduledstartdate", "scheduledenddate", "actualstartdate", "actualenddate", "actualresourcehrs", "plannedcost", "actualcost", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using WorkorderroutingRowUnsaved.text, c)
  }
  ...
  override def update(row: WorkorderroutingRow)(using c: Connection): Option[WorkorderroutingRow] = {
    ...
    SQL"""update "production"."workorderrouting"
          set "locationid" = ${ParameterValue(row.locationid, null, LocationId.toStatement)}::int2,
              ...
              "actualstartdate" = ${ParameterValue(row.actualstartdate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))}::timestamp,
              "actualenddate" = ${ParameterValue(row.actualenddate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))}::timestamp,
              "actualresourcehrs" = ${ParameterValue(row.actualresourcehrs, null, ToStatement.optionToStatement(using ToStatement.scalaBigDecimalToStatement, ParameterMetaData.BigDecimalParameterMetaData))}::numeric,
              "plannedcost" = ${ParameterValue(row.plannedcost, null, ToStatement.scalaBigDecimalToStatement)}::numeric,
              "actualcost" = ${ParameterValue(row.actualcost, null, ToStatement.optionToStatement(using ToStatement.scalaBigDecimalToStatement, ParameterMetaData.BigDecimalParameterMetaData))}::numeric,
  ...
  override def upsert(unsaved: WorkorderroutingRow)(using c: Connection): WorkorderroutingRow = {
    SQL"""insert into "production"."workorderrouting"("workorderid", "productid", "operationsequence", "locationid", "scheduledstartdate", "scheduledenddate", "actualstartdate", "actualenddate", "actualresourcehrs", "plannedcost", "actualcost", "modifieddate")
          values (
            ...
            ${ParameterValue(unsaved.actualstartdate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))}::timestamp,
            ${ParameterValue(unsaved.actualenddate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))}::timestamp,
            ${ParameterValue(unsaved.actualresourcehrs, null, ToStatement.optionToStatement(using ToStatement.scalaBigDecimalToStatement, ParameterMetaData.BigDecimalParameterMetaData))}::numeric,
            ${ParameterValue(unsaved.plannedcost, null, ToStatement.scalaBigDecimalToStatement)}::numeric,
            ${ParameterValue(unsaved.actualcost, null, ToStatement.optionToStatement(using ToStatement.scalaBigDecimalToStatement, ParameterMetaData.BigDecimalParameterMetaData))}::numeric,
  ...
  override def upsertBatch(unsaved: Iterable[WorkorderroutingRow])(using c: Connection): List[WorkorderroutingRow] = {
    def toNamedParameter(row: WorkorderroutingRow): List[NamedParameter] = List(
      ...
      NamedParameter("actualstartdate", ParameterValue(row.actualstartdate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))),
      NamedParameter("actualenddate", ParameterValue(row.actualenddate, null, ToStatement.optionToStatement(using TypoLocalDateTime.toStatement, TypoLocalDateTime.parameterMetadata))),
      NamedParameter("actualresourcehrs", ParameterValue(row.actualresourcehrs, null, ToStatement.optionToStatement(using ToStatement.scalaBigDecimalToStatement, ParameterMetaData.BigDecimalParameterMetaData))),
  ...
  override def upsertStreaming(unsaved: Iterator[WorkorderroutingRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table workorderrouting_TEMP (like "production"."workorderrouting") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy workorderrouting_TEMP("workorderid", "productid", "operationsequence", "locationid", "scheduledstartdate", "scheduledenddate", "actualstartdate", "actualenddate", "actualresourcehrs", "plannedcost", "actualcost", "modifieddate") from stdin""", batchSize, unsaved)(using WorkorderroutingRow.text, c): @nowarn
    SQL"""insert into "production"."workorderrouting"("workorderid", "productid", "operationsequence", "locationid", "scheduledstartdate", "scheduledenddate", "actualstartdate", "actualenddate", "actualresourcehrs", "plannedcost", "actualcost", "modifieddate")
