...
trait WorkorderroutingRepo {
  ...
  def insertStreaming(unsaved: Iterator[WorkorderroutingRow], batchSize: Int = 10000)(using c: Connection): Long
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[WorkorderroutingRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long
  ...
  def upsertStreaming(unsaved: Iterator[WorkorderroutingRow], batchSize: Int = 10000)(using c: Connection): Int
}
