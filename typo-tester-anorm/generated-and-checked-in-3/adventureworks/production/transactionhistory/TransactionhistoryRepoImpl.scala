...
class TransactionhistoryRepoImpl extends TransactionhistoryRepo {
  ...
  override def deleteById(transactionid: TransactionhistoryId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[TransactionhistoryRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."transactionhistory"("transactionid", "productid", "referenceorderid", "referenceorderlineid", "transactiondate", "transactiontype", "quantity", "actualcost", "modifieddate") FROM STDIN""", batchSize, unsaved)(using TransactionhistoryRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[TransactionhistoryRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."transactionhistory"("productid", "referenceorderid", "transactiontype", "quantity", "actualcost", "transactionid", "referenceorderlineid", "transactiondate", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using TransactionhistoryRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[TransactionhistoryRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table transactionhistory_TEMP (like "production"."transactionhistory") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy transactionhistory_TEMP("transactionid", "productid", "referenceorderid", "referenceorderlineid", "transactiondate", "transactiontype", "quantity", "actualcost", "modifieddate") from stdin""", batchSize, unsaved)(using TransactionhistoryRow.text, c): @nowarn
    SQL"""insert into "production"."transactionhistory"("transactionid", "productid", "referenceorderid", "referenceorderlineid", "transactiondate", "transactiontype", "quantity", "actualcost", "modifieddate")
