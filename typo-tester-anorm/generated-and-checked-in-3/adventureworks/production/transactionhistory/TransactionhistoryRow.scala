...
object TransactionhistoryRow {
  given reads: Reads[TransactionhistoryRow] = Reads[TransactionhistoryRow](json => JsResult.fromTry(
      Try(
  ...
  given writes: OWrites[TransactionhistoryRow] = OWrites[TransactionhistoryRow](o =>
