...
class ProductdocumentRepoImpl extends ProductdocumentRepo {
  ...
  override def deleteById(compositeId: ProductdocumentId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[ProductdocumentRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."productdocument"("productid", "modifieddate", "documentnode") FROM STDIN""", batchSize, unsaved)(using ProductdocumentRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[ProductdocumentRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."productdocument"("productid", "modifieddate", "documentnode") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using ProductdocumentRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[ProductdocumentRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table productdocument_TEMP (like "production"."productdocument") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy productdocument_TEMP("productid", "modifieddate", "documentnode") from stdin""", batchSize, unsaved)(using ProductdocumentRow.text, c): @nowarn
    SQL"""insert into "production"."productdocument"("productid", "modifieddate", "documentnode")
