...
object ProductdocumentRow {
  ...
  given reads: Reads[ProductdocumentRow] = Reads[ProductdocumentRow](json => JsResult.fromTry(
      Try(
        ProductdocumentRow(
  ...
  def rowParser(idx: Int): RowParser[ProductdocumentRow] = RowParser[ProductdocumentRow] { row =>
    Success(
      ProductdocumentRow(
        ...
        documentnode = row(idx + 2)(using DocumentId.column)
      )
    )
  }
  ...
  given writes: OWrites[ProductdocumentRow] = OWrites[ProductdocumentRow](o =>
