...
class ProductmodelillustrationRepoImpl extends ProductmodelillustrationRepo {
  ...
  override def deleteById(compositeId: ProductmodelillustrationId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[ProductmodelillustrationRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."productmodelillustration"("productmodelid", "illustrationid", "modifieddate") FROM STDIN""", batchSize, unsaved)(using ProductmodelillustrationRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[ProductmodelillustrationRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."productmodelillustration"("productmodelid", "illustrationid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using ProductmodelillustrationRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[ProductmodelillustrationRow], batchSize: Int = 10000)(using c: Connection): Int = {
    ...
    streamingInsert(s"""copy productmodelillustration_TEMP("productmodelid", "illustrationid", "modifieddate") from stdin""", batchSize, unsaved)(using ProductmodelillustrationRow.text, c): @nowarn
    SQL"""insert into "production"."productmodelillustration"("productmodelid", "illustrationid", "modifieddate")
