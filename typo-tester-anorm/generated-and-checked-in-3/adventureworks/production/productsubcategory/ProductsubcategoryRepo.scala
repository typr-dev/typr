...
trait ProductsubcategoryRepo {
  ...
  def insertStreaming(unsaved: Iterator[ProductsubcategoryRow], batchSize: Int = 10000)(using c: Connection): Long
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[ProductsubcategoryRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long
  ...
  def upsertStreaming(unsaved: Iterator[ProductsubcategoryRow], batchSize: Int = 10000)(using c: Connection): Int
}
