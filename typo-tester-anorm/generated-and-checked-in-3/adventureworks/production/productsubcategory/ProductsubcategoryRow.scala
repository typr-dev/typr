...
object ProductsubcategoryRow {
  given reads: Reads[ProductsubcategoryRow] = Reads[ProductsubcategoryRow](json => JsResult.fromTry(
      Try(
  ...
  given writes: OWrites[ProductsubcategoryRow] = OWrites[ProductsubcategoryRow](o =>
