...
object ProductreviewRowUnsaved {
  given reads: Reads[ProductreviewRowUnsaved] = Reads[ProductreviewRowUnsaved](json => JsResult.fromTry(
      Try(
        ProductreviewRowUnsaved(
          ...
          productreviewid = json.\("productreviewid").as(Defaulted.reads(using ProductreviewId.reads)),
          reviewdate = json.\("reviewdate").as(Defaulted.reads(using TypoLocalDateTime.reads)),
  ...
  given writes: OWrites[ProductreviewRowUnsaved] = OWrites[ProductreviewRowUnsaved](o =>
