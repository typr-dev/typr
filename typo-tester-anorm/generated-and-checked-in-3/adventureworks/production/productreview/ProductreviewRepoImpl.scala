...
class ProductreviewRepoImpl extends ProductreviewRepo {
  ...
  override def deleteById(productreviewid: ProductreviewId)(using c: Connection): Boolean = {
  ...
  override def insert(unsaved: ProductreviewRowUnsaved)(using c: Connection): ProductreviewRow = {
    val namedParameters = List(
      ...
      Some((NamedParameter("comments", ParameterValue(unsaved.comments, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))), "")),
  ...
  override def insertStreaming(unsaved: Iterator[ProductreviewRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."productreview"("productreviewid", "productid", "reviewername", "reviewdate", "emailaddress", "rating", "comments", "modifieddate") FROM STDIN""", batchSize, unsaved)(using ProductreviewRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[ProductreviewRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."productreview"("productid", "reviewername", "emailaddress", "rating", "comments", "productreviewid", "reviewdate", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using ProductreviewRowUnsaved.text, c)
  }
  ...
  override def update(row: ProductreviewRow)(using c: Connection): Option[ProductreviewRow] = {
    ...
    SQL"""update "production"."productreview"
          set "productid" = ${ParameterValue(row.productid, null, ProductId.toStatement)}::int4,
              ...
              "comments" = ${ParameterValue(row.comments, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
  ...
  override def upsert(unsaved: ProductreviewRow)(using c: Connection): ProductreviewRow = {
    SQL"""insert into "production"."productreview"("productreviewid", "productid", "reviewername", "reviewdate", "emailaddress", "rating", "comments", "modifieddate")
          values (
            ...
            ${ParameterValue(unsaved.comments, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
  ...
  override def upsertBatch(unsaved: Iterable[ProductreviewRow])(using c: Connection): List[ProductreviewRow] = {
    def toNamedParameter(row: ProductreviewRow): List[NamedParameter] = List(
      ...
      NamedParameter("comments", ParameterValue(row.comments, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))),
  ...
  override def upsertStreaming(unsaved: Iterator[ProductreviewRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table productreview_TEMP (like "production"."productreview") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy productreview_TEMP("productreviewid", "productid", "reviewername", "reviewdate", "emailaddress", "rating", "comments", "modifieddate") from stdin""", batchSize, unsaved)(using ProductreviewRow.text, c): @nowarn
    SQL"""insert into "production"."productreview"("productreviewid", "productid", "reviewername", "reviewdate", "emailaddress", "rating", "comments", "modifieddate")
