...
object ProductRowUnsaved {
  given reads: Reads[ProductRowUnsaved] = Reads[ProductRowUnsaved](json => JsResult.fromTry(
      Try(
        ProductRowUnsaved(
          ...
          productid = json.\("productid").as(Defaulted.reads(using ProductId.reads)),
          makeflag = json.\("makeflag").as(Defaulted.reads(using Flag.reads)),
          finishedgoodsflag = json.\("finishedgoodsflag").as(Defaulted.reads(using Flag.reads)),
  ...
  given writes: OWrites[ProductRowUnsaved] = OWrites[ProductRowUnsaved](o =>
