...
class ProductinventoryRepoImpl extends ProductinventoryRepo {
  ...
  override def deleteById(compositeId: ProductinventoryId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[ProductinventoryRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."productinventory"("productid", "locationid", "shelf", "bin", "quantity", "rowguid", "modifieddate") FROM STDIN""", batchSize, unsaved)(using ProductinventoryRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[ProductinventoryRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."productinventory"("productid", "locationid", "shelf", "bin", "quantity", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using ProductinventoryRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[ProductinventoryRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table productinventory_TEMP (like "production"."productinventory") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy productinventory_TEMP("productid", "locationid", "shelf", "bin", "quantity", "rowguid", "modifieddate") from stdin""", batchSize, unsaved)(using ProductinventoryRow.text, c): @nowarn
    SQL"""insert into "production"."productinventory"("productid", "locationid", "shelf", "bin", "quantity", "rowguid", "modifieddate")
