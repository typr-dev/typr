...
class ProductproductphotoRepoImpl extends ProductproductphotoRepo {
  ...
  override def deleteById(compositeId: ProductproductphotoId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[ProductproductphotoRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."productproductphoto"("productid", "productphotoid", "primary", "modifieddate") FROM STDIN""", batchSize, unsaved)(using ProductproductphotoRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[ProductproductphotoRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."productproductphoto"("productid", "productphotoid", "primary", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using ProductproductphotoRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[ProductproductphotoRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table productproductphoto_TEMP (like "production"."productproductphoto") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy productproductphoto_TEMP("productid", "productphotoid", "primary", "modifieddate") from stdin""", batchSize, unsaved)(using ProductproductphotoRow.text, c): @nowarn
    SQL"""insert into "production"."productproductphoto"("productid", "productphotoid", "primary", "modifieddate")
