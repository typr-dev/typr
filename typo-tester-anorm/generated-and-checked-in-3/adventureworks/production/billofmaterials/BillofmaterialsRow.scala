...
object BillofmaterialsRow {
  given reads: Reads[BillofmaterialsRow] = Reads[BillofmaterialsRow](json => JsResult.fromTry(
      Try(
        BillofmaterialsRow(
  ...
  given writes: OWrites[BillofmaterialsRow] = OWrites[BillofmaterialsRow](o =>
