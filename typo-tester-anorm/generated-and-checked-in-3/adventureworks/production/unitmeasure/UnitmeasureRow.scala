...
object UnitmeasureRow {
  given reads: Reads[UnitmeasureRow] = Reads[UnitmeasureRow](json => JsResult.fromTry(
      Try(
        UnitmeasureRow(
  ...
  def rowParser(idx: Int): RowParser[UnitmeasureRow] = RowParser[UnitmeasureRow] { row =>
    Success(
      UnitmeasureRow(
        unitmeasurecode = row(idx + 0)(using UnitmeasureId.column),
  ...
  given writes: OWrites[UnitmeasureRow] = OWrites[UnitmeasureRow](o =>
