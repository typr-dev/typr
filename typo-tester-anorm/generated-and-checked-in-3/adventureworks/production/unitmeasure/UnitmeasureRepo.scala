...
trait UnitmeasureRepo {
  ...
  def insertStreaming(unsaved: Iterator[UnitmeasureRow], batchSize: Int = 10000)(using c: Connection): Long
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[UnitmeasureRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long
  ...
  def upsertStreaming(unsaved: Iterator[UnitmeasureRow], batchSize: Int = 10000)(using c: Connection): Int
}
