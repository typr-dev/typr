...
class DocumentRepoImpl extends DocumentRepo {
  ...
  override def deleteById(documentnode: DocumentId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[DocumentRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."document"("title", "owner", "folderflag", "filename", "fileextension", "revision", "changenumber", "status", "documentsummary", "document", "rowguid", "modifieddate", "documentnode") FROM STDIN""", batchSize, unsaved)(using DocumentRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[DocumentRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."document"("title", "owner", "filename", "fileextension", "revision", "status", "documentsummary", "document", "folderflag", "changenumber", "rowguid", "modifieddate", "documentnode") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using DocumentRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[DocumentRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table document_TEMP (like "production"."document") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy document_TEMP("title", "owner", "folderflag", "filename", "fileextension", "revision", "changenumber", "status", "documentsummary", "document", "rowguid", "modifieddate", "documentnode") from stdin""", batchSize, unsaved)(using DocumentRow.text, c): @nowarn
    SQL"""insert into "production"."document"("title", "owner", "folderflag", "filename", "fileextension", "revision", "changenumber", "status", "documentsummary", "document", "rowguid", "modifieddate", "documentnode")
