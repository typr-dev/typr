...
class ProductlistpricehistoryRepoImpl extends ProductlistpricehistoryRepo {
  ...
  override def deleteById(compositeId: ProductlistpricehistoryId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[ProductlistpricehistoryRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."productlistpricehistory"("productid", "startdate", "enddate", "listprice", "modifieddate") FROM STDIN""", batchSize, unsaved)(using ProductlistpricehistoryRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[ProductlistpricehistoryRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."productlistpricehistory"("productid", "startdate", "enddate", "listprice", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using ProductlistpricehistoryRowUnsaved.text, c)
  }
  ...
  override def update(row: ProductlistpricehistoryRow)(using c: Connection): Option[ProductlistpricehistoryRow] = {
  ...
  override def upsertBatch(unsaved: Iterable[ProductlistpricehistoryRow])(using c: Connection): List[ProductlistpricehistoryRow] = {
  ...
  override def upsertStreaming(unsaved: Iterator[ProductlistpricehistoryRow], batchSize: Int = 10000)(using c: Connection): Int = {
    ...
    streamingInsert(s"""copy productlistpricehistory_TEMP("productid", "startdate", "enddate", "listprice", "modifieddate") from stdin""", batchSize, unsaved)(using ProductlistpricehistoryRow.text, c): @nowarn
    SQL"""insert into "production"."productlistpricehistory"("productid", "startdate", "enddate", "listprice", "modifieddate")
