...
object WorkorderRowUnsaved {
  given reads: Reads[WorkorderRowUnsaved] = Reads[WorkorderRowUnsaved](json => JsResult.fromTry(
      Try(
        WorkorderRowUnsaved(
  ...
  given writes: OWrites[WorkorderRowUnsaved] = OWrites[WorkorderRowUnsaved](o =>
