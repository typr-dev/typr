...
trait ProductphotoRepo {
  ...
  def insertStreaming(unsaved: Iterator[ProductphotoRow], batchSize: Int = 10000)(using c: Connection): Long
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[ProductphotoRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long
  ...
  def upsertStreaming(unsaved: Iterator[ProductphotoRow], batchSize: Int = 10000)(using c: Connection): Int
}
