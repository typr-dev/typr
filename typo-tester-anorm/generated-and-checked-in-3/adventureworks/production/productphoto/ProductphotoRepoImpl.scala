...
class ProductphotoRepoImpl extends ProductphotoRepo {
  ...
  override def deleteById(productphotoid: ProductphotoId)(using c: Connection): Boolean = {
  ...
  override def insert(unsaved: ProductphotoRowUnsaved)(using c: Connection): ProductphotoRow = {
    val namedParameters = List(
      ...
      Some((NamedParameter("largephoto", ParameterValue(unsaved.largephoto, null, ToStatement.optionToStatement(using TypoBytea.toStatement, TypoBytea.parameterMetadata))), "::bytea")),
      Some((NamedParameter("largephotofilename", ParameterValue(unsaved.largephotofilename, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))), "")),
  ...
  override def insertStreaming(unsaved: Iterator[ProductphotoRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."productphoto"("productphotoid", "thumbnailphoto", "thumbnailphotofilename", "largephoto", "largephotofilename", "modifieddate") FROM STDIN""", batchSize, unsaved)(using ProductphotoRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[ProductphotoRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "production"."productphoto"("thumbnailphoto", "thumbnailphotofilename", "largephoto", "largephotofilename", "productphotoid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using ProductphotoRowUnsaved.text, c)
  }
  ...
  override def update(row: ProductphotoRow)(using c: Connection): Option[ProductphotoRow] = {
    ...
    SQL"""update "production"."productphoto"
          set "thumbnailphoto" = ${ParameterValue(row.thumbnailphoto, null, ToStatement.optionToStatement(using TypoBytea.toStatement, TypoBytea.parameterMetadata))}::bytea,
              "thumbnailphotofilename" = ${ParameterValue(row.thumbnailphotofilename, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
              "largephoto" = ${ParameterValue(row.largephoto, null, ToStatement.optionToStatement(using TypoBytea.toStatement, TypoBytea.parameterMetadata))}::bytea,
              "largephotofilename" = ${ParameterValue(row.largephotofilename, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
  ...
  override def upsert(unsaved: ProductphotoRow)(using c: Connection): ProductphotoRow = {
    SQL"""insert into "production"."productphoto"("productphotoid", "thumbnailphoto", "thumbnailphotofilename", "largephoto", "largephotofilename", "modifieddate")
          values (
            ...
            ${ParameterValue(unsaved.thumbnailphoto, null, ToStatement.optionToStatement(using TypoBytea.toStatement, TypoBytea.parameterMetadata))}::bytea,
            ${ParameterValue(unsaved.thumbnailphotofilename, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
            ${ParameterValue(unsaved.largephoto, null, ToStatement.optionToStatement(using TypoBytea.toStatement, TypoBytea.parameterMetadata))}::bytea,
            ${ParameterValue(unsaved.largephotofilename, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
  ...
  override def upsertBatch(unsaved: Iterable[ProductphotoRow])(using c: Connection): List[ProductphotoRow] = {
    def toNamedParameter(row: ProductphotoRow): List[NamedParameter] = List(
      ...
      NamedParameter("thumbnailphotofilename", ParameterValue(row.thumbnailphotofilename, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))),
      NamedParameter("largephoto", ParameterValue(row.largephoto, null, ToStatement.optionToStatement(using TypoBytea.toStatement, TypoBytea.parameterMetadata))),
  ...
  override def upsertStreaming(unsaved: Iterator[ProductphotoRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table productphoto_TEMP (like "production"."productphoto") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy productphoto_TEMP("productphotoid", "thumbnailphoto", "thumbnailphotofilename", "largephoto", "largephotofilename", "modifieddate") from stdin""", batchSize, unsaved)(using ProductphotoRow.text, c): @nowarn
    SQL"""insert into "production"."productphoto"("productphotoid", "thumbnailphoto", "thumbnailphotofilename", "largephoto", "largephotofilename", "modifieddate")
