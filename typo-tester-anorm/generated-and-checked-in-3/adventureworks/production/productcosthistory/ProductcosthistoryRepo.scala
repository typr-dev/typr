...
trait ProductcosthistoryRepo {
  ...
  def insertStreaming(unsaved: Iterator[ProductcosthistoryRow], batchSize: Int = 10000)(using c: Connection): Long
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[ProductcosthistoryRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long
  ...
  def upsertStreaming(unsaved: Iterator[ProductcosthistoryRow], batchSize: Int = 10000)(using c: Connection): Int
}
