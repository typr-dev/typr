...
object ProductcosthistoryRow {
  ...
  given reads: Reads[ProductcosthistoryRow] = Reads[ProductcosthistoryRow](json => JsResult.fromTry(
      Try(
  ...
  given writes: OWrites[ProductcosthistoryRow] = OWrites[ProductcosthistoryRow](o =>
