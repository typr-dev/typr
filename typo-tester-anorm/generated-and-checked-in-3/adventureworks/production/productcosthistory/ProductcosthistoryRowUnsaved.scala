...
object ProductcosthistoryRowUnsaved {
  given reads: Reads[ProductcosthistoryRowUnsaved] = Reads[ProductcosthistoryRowUnsaved](json => JsResult.fromTry(
      Try(
  ...
  given writes: OWrites[ProductcosthistoryRowUnsaved] = OWrites[ProductcosthistoryRowUnsaved](o =>
