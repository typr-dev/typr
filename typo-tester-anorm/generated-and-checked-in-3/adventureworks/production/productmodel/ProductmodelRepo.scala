...
trait ProductmodelRepo {
  ...
  def insertStreaming(unsaved: Iterator[ProductmodelRow], batchSize: Int = 10000)(using c: Connection): Long
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[ProductmodelRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long
  ...
  def update(row: ProductmodelRow)(using c: Connection): Option[ProductmodelRow]
  def upsert(unsaved: ProductmodelRow)(using c: Connection): ProductmodelRow
  def upsertBatch(unsaved: Iterable[ProductmodelRow])(using c: Connection): List[ProductmodelRow]
  /* NOTE: this functionality is not safe if you use auto-commit mode! it runs 3 SQL statements */
  def upsertStreaming(unsaved: Iterator[ProductmodelRow], batchSize: Int = 10000)(using c: Connection): Int
}
