...
object ProductdescriptionRow {
  given reads: Reads[ProductdescriptionRow] = Reads[ProductdescriptionRow](json => JsResult.fromTry(
      Try(
  ...
  def rowParser(idx: Int): RowParser[ProductdescriptionRow] = RowParser[ProductdescriptionRow] { row =>
    Success(
      ProductdescriptionRow(
        productdescriptionid = row(idx + 0)(using ProductdescriptionId.column),
  ...
  given writes: OWrites[ProductdescriptionRow] = OWrites[ProductdescriptionRow](o =>
