...
object ScrapreasonRowUnsaved {
  given reads: Reads[ScrapreasonRowUnsaved] = Reads[ScrapreasonRowUnsaved](json => JsResult.fromTry(
      Try(
        ScrapreasonRowUnsaved(
          name = json.\("name").as(Name.reads),
          scrapreasonid = json.\("scrapreasonid").as(Defaulted.reads(using ScrapreasonId.reads)),
  ...
  given writes: OWrites[ScrapreasonRowUnsaved] = OWrites[ScrapreasonRowUnsaved](o =>
