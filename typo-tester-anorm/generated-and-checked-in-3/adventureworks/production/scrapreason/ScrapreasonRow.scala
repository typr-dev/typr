...
object ScrapreasonRow {
  given reads: Reads[ScrapreasonRow] = Reads[ScrapreasonRow](json => JsResult.fromTry(
      Try(
        ScrapreasonRow(
  ...
  def rowParser(idx: Int): RowParser[ScrapreasonRow] = RowParser[ScrapreasonRow] { row =>
    Success(
      ScrapreasonRow(
        scrapreasonid = row(idx + 0)(using ScrapreasonId.column),
  ...
  given writes: OWrites[ScrapreasonRow] = OWrites[ScrapreasonRow](o =>
