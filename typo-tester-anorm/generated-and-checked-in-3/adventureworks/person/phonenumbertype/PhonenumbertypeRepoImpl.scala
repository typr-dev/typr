...
class PhonenumbertypeRepoImpl extends PhonenumbertypeRepo {
  ...
  override def deleteById(phonenumbertypeid: PhonenumbertypeId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[PhonenumbertypeRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "person"."phonenumbertype"("phonenumbertypeid", "name", "modifieddate") FROM STDIN""", batchSize, unsaved)(using PhonenumbertypeRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[PhonenumbertypeRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "person"."phonenumbertype"("name", "phonenumbertypeid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using PhonenumbertypeRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[PhonenumbertypeRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table phonenumbertype_TEMP (like "person"."phonenumbertype") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy phonenumbertype_TEMP("phonenumbertypeid", "name", "modifieddate") from stdin""", batchSize, unsaved)(using PhonenumbertypeRow.text, c): @nowarn
    SQL"""insert into "person"."phonenumbertype"("phonenumbertypeid", "name", "modifieddate")
