...
trait PhonenumbertypeRepo {
  ...
  def insertStreaming(unsaved: Iterator[PhonenumbertypeRow], batchSize: Int = 10000)(using c: Connection): Long
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[PhonenumbertypeRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long
  ...
  def upsertStreaming(unsaved: Iterator[PhonenumbertypeRow], batchSize: Int = 10000)(using c: Connection): Int
}
