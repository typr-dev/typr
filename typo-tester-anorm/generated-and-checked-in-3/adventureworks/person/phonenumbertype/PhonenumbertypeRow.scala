...
object PhonenumbertypeRow {
  given reads: Reads[PhonenumbertypeRow] = Reads[PhonenumbertypeRow](json => JsResult.fromTry(
      Try(
        PhonenumbertypeRow(
  ...
  given writes: OWrites[PhonenumbertypeRow] = OWrites[PhonenumbertypeRow](o =>
