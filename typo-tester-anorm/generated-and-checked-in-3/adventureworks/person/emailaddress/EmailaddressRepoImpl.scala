...
class EmailaddressRepoImpl extends EmailaddressRepo {
  ...
  override def deleteById(compositeId: EmailaddressId)(using c: Connection): Boolean = {
  ...
  override def insert(unsaved: EmailaddressRowUnsaved)(using c: Connection): EmailaddressRow = {
    val namedParameters = List(
      ...
      Some((NamedParameter("emailaddress", ParameterValue(unsaved.emailaddress, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))), "")),
  ...
  override def insertStreaming(unsaved: Iterator[EmailaddressRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "person"."emailaddress"("businessentityid", "emailaddressid", "emailaddress", "rowguid", "modifieddate") FROM STDIN""", batchSize, unsaved)(using EmailaddressRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[EmailaddressRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "person"."emailaddress"("businessentityid", "emailaddress", "emailaddressid", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using EmailaddressRowUnsaved.text, c)
  }
  ...
  override def update(row: EmailaddressRow)(using c: Connection): Option[EmailaddressRow] = {
    ...
    SQL"""update "person"."emailaddress"
          set "emailaddress" = ${ParameterValue(row.emailaddress, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
  ...
  override def upsert(unsaved: EmailaddressRow)(using c: Connection): EmailaddressRow = {
    SQL"""insert into "person"."emailaddress"("businessentityid", "emailaddressid", "emailaddress", "rowguid", "modifieddate")
          values (
            ...
            ${ParameterValue(unsaved.emailaddress, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
  ...
  override def upsertBatch(unsaved: Iterable[EmailaddressRow])(using c: Connection): List[EmailaddressRow] = {
    def toNamedParameter(row: EmailaddressRow): List[NamedParameter] = List(
      ...
      NamedParameter("emailaddress", ParameterValue(row.emailaddress, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))),
  ...
  override def upsertStreaming(unsaved: Iterator[EmailaddressRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table emailaddress_TEMP (like "person"."emailaddress") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy emailaddress_TEMP("businessentityid", "emailaddressid", "emailaddress", "rowguid", "modifieddate") from stdin""", batchSize, unsaved)(using EmailaddressRow.text, c): @nowarn
    SQL"""insert into "person"."emailaddress"("businessentityid", "emailaddressid", "emailaddress", "rowguid", "modifieddate")
