...
trait EmailaddressRepo {
  ...
  def insertStreaming(unsaved: Iterator[EmailaddressRow], batchSize: Int = 10000)(using c: Connection): Long
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[EmailaddressRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long
  ...
  def upsertStreaming(unsaved: Iterator[EmailaddressRow], batchSize: Int = 10000)(using c: Connection): Int
}
