...
trait BusinessentityaddressRepo {
  ...
  def insertStreaming(unsaved: Iterator[BusinessentityaddressRow], batchSize: Int = 10000)(using c: Connection): Long
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[BusinessentityaddressRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long
  ...
  def update(row: BusinessentityaddressRow)(using c: Connection): Option[BusinessentityaddressRow]
  def upsert(unsaved: BusinessentityaddressRow)(using c: Connection): BusinessentityaddressRow
  def upsertBatch(unsaved: Iterable[BusinessentityaddressRow])(using c: Connection): List[BusinessentityaddressRow]
  /* NOTE: this functionality is not safe if you use auto-commit mode! it runs 3 SQL statements */
  def upsertStreaming(unsaved: Iterator[BusinessentityaddressRow], batchSize: Int = 10000)(using c: Connection): Int
}
