...
object BusinessentityaddressRow {
  ...
  given reads: Reads[BusinessentityaddressRow] = Reads[BusinessentityaddressRow](json => JsResult.fromTry(
      Try(
  ...
  given writes: OWrites[BusinessentityaddressRow] = OWrites[BusinessentityaddressRow](o =>
