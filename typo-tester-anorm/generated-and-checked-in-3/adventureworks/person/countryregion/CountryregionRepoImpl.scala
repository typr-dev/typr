...
class CountryregionRepoImpl extends CountryregionRepo {
  ...
  override def deleteById(countryregioncode: CountryregionId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[CountryregionRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "person"."countryregion"("countryregioncode", "name", "modifieddate") FROM STDIN""", batchSize, unsaved)(using CountryregionRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[CountryregionRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "person"."countryregion"("countryregioncode", "name", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using CountryregionRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[CountryregionRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table countryregion_TEMP (like "person"."countryregion") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy countryregion_TEMP("countryregioncode", "name", "modifieddate") from stdin""", batchSize, unsaved)(using CountryregionRow.text, c): @nowarn
    SQL"""insert into "person"."countryregion"("countryregioncode", "name", "modifieddate")
