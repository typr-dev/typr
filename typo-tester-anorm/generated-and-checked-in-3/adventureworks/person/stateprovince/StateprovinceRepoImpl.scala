...
class StateprovinceRepoImpl extends StateprovinceRepo {
  ...
  override def deleteById(stateprovinceid: StateprovinceId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[StateprovinceRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "person"."stateprovince"("stateprovinceid", "stateprovincecode", "countryregioncode", "isonlystateprovinceflag", "name", "territoryid", "rowguid", "modifieddate") FROM STDIN""", batchSize, unsaved)(using StateprovinceRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[StateprovinceRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "person"."stateprovince"("stateprovincecode", "countryregioncode", "name", "territoryid", "stateprovinceid", "isonlystateprovinceflag", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using StateprovinceRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[StateprovinceRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table stateprovince_TEMP (like "person"."stateprovince") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy stateprovince_TEMP("stateprovinceid", "stateprovincecode", "countryregioncode", "isonlystateprovinceflag", "name", "territoryid", "rowguid", "modifieddate") from stdin""", batchSize, unsaved)(using StateprovinceRow.text, c): @nowarn
    SQL"""insert into "person"."stateprovince"("stateprovinceid", "stateprovincecode", "countryregioncode", "isonlystateprovinceflag", "name", "territoryid", "rowguid", "modifieddate")
