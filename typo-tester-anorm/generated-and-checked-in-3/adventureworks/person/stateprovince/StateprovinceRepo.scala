...
trait StateprovinceRepo {
  ...
  def insertStreaming(unsaved: Iterator[StateprovinceRow], batchSize: Int = 10000)(using c: Connection): Long
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[StateprovinceRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long
  ...
  def upsertStreaming(unsaved: Iterator[StateprovinceRow], batchSize: Int = 10000)(using c: Connection): Int
}
