...
object AddresstypeRow {
  given reads: Reads[AddresstypeRow] = Reads[AddresstypeRow](json => JsResult.fromTry(
      Try(
        AddresstypeRow(
  ...
  def rowParser(idx: Int): RowParser[AddresstypeRow] = RowParser[AddresstypeRow] { row =>
    Success(
      AddresstypeRow(
        addresstypeid = row(idx + 0)(using AddresstypeId.column),
  ...
  given writes: OWrites[AddresstypeRow] = OWrites[AddresstypeRow](o =>
