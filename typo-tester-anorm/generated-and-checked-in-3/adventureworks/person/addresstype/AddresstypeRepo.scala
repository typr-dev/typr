...
trait AddresstypeRepo {
  ...
  def insertStreaming(unsaved: Iterator[AddresstypeRow], batchSize: Int = 10000)(using c: Connection): Long
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[AddresstypeRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long
  ...
  def upsertStreaming(unsaved: Iterator[AddresstypeRow], batchSize: Int = 10000)(using c: Connection): Int
}
