...
class BusinessentitycontactRepoImpl extends BusinessentitycontactRepo {
  ...
  override def deleteById(compositeId: BusinessentitycontactId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[BusinessentitycontactRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "person"."businessentitycontact"("businessentityid", "personid", "contacttypeid", "rowguid", "modifieddate") FROM STDIN""", batchSize, unsaved)(using BusinessentitycontactRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[BusinessentitycontactRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "person"."businessentitycontact"("businessentityid", "personid", "contacttypeid", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using BusinessentitycontactRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[BusinessentitycontactRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table businessentitycontact_TEMP (like "person"."businessentitycontact") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy businessentitycontact_TEMP("businessentityid", "personid", "contacttypeid", "rowguid", "modifieddate") from stdin""", batchSize, unsaved)(using BusinessentitycontactRow.text, c): @nowarn
    SQL"""insert into "person"."businessentitycontact"("businessentityid", "personid", "contacttypeid", "rowguid", "modifieddate")
