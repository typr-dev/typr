...
object BusinessentitycontactRow {
  ...
  given reads: Reads[BusinessentitycontactRow] = Reads[BusinessentitycontactRow](json => JsResult.fromTry(
      Try(
  ...
  given writes: OWrites[BusinessentitycontactRow] = OWrites[BusinessentitycontactRow](o =>
