...
object AddressRow {
  given reads: Reads[AddressRow] = Reads[AddressRow](json => JsResult.fromTry(
      Try(
        AddressRow(
  ...
  given text: Text[AddressRow] = Text.instance[AddressRow]{ (row, sb) =>
  ...
  given writes: OWrites[AddressRow] = OWrites[AddressRow](o =>
