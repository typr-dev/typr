...
class AddressRepoImpl extends AddressRepo {
  ...
  override def deleteById(addressid: AddressId)(using c: Connection): Boolean = {
  ...
  override def insert(unsaved: AddressRowUnsaved)(using c: Connection): AddressRow = {
    val namedParameters = List(
      ...
      Some((NamedParameter("addressline2", ParameterValue(unsaved.addressline2, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))), "")),
      ...
      Some((NamedParameter("spatiallocation", ParameterValue(unsaved.spatiallocation, null, ToStatement.optionToStatement(using TypoBytea.toStatement, TypoBytea.parameterMetadata))), "::bytea")),
  ...
  override def insertStreaming(unsaved: Iterator[AddressRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "person"."address"("addressid", "addressline1", "addressline2", "city", "stateprovinceid", "postalcode", "spatiallocation", "rowguid", "modifieddate") FROM STDIN""", batchSize, unsaved)(using AddressRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[AddressRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "person"."address"("addressline1", "addressline2", "city", "stateprovinceid", "postalcode", "spatiallocation", "addressid", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using AddressRowUnsaved.text, c)
  }
  ...
  override def update(row: AddressRow)(using c: Connection): Option[AddressRow] = {
    ...
    SQL"""update "person"."address"
          set "addressline1" = ${ParameterValue(row.addressline1, null, ToStatement.stringToStatement)},
              "addressline2" = ${ParameterValue(row.addressline2, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
              ...
              "spatiallocation" = ${ParameterValue(row.spatiallocation, null, ToStatement.optionToStatement(using TypoBytea.toStatement, TypoBytea.parameterMetadata))}::bytea,
  ...
  override def upsert(unsaved: AddressRow)(using c: Connection): AddressRow = {
    SQL"""insert into "person"."address"("addressid", "addressline1", "addressline2", "city", "stateprovinceid", "postalcode", "spatiallocation", "rowguid", "modifieddate")
          values (
            ...
            ${ParameterValue(unsaved.addressline2, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
            ...
            ${ParameterValue(unsaved.spatiallocation, null, ToStatement.optionToStatement(using TypoBytea.toStatement, TypoBytea.parameterMetadata))}::bytea,
  ...
  override def upsertBatch(unsaved: Iterable[AddressRow])(using c: Connection): List[AddressRow] = {
    def toNamedParameter(row: AddressRow): List[NamedParameter] = List(
      ...
      NamedParameter("addressline2", ParameterValue(row.addressline2, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))),
      ...
      NamedParameter("spatiallocation", ParameterValue(row.spatiallocation, null, ToStatement.optionToStatement(using TypoBytea.toStatement, TypoBytea.parameterMetadata))),
  ...
  override def upsertStreaming(unsaved: Iterator[AddressRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table address_TEMP (like "person"."address") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy address_TEMP("addressid", "addressline1", "addressline2", "city", "stateprovinceid", "postalcode", "spatiallocation", "rowguid", "modifieddate") from stdin""", batchSize, unsaved)(using AddressRow.text, c): @nowarn
    SQL"""insert into "person"."address"("addressid", "addressline1", "addressline2", "city", "stateprovinceid", "postalcode", "spatiallocation", "rowguid", "modifieddate")
