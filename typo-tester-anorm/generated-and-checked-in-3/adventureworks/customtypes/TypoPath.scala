...
object TypoPath {
  given arrayColumn: Column[Array[TypoPath]] = Column.nonNull[Array[TypoPath]]((v1: Any, _) =>
    v1 match {
        case v: PgArray =>
         v.getArray match {
           case v: Array[?] =>
  ...
  given column: Column[TypoPath] = Column.nonNull[TypoPath]((v1: Any, _) =>
    v1 match {
  ...
  given reads: Reads[TypoPath] = Reads[TypoPath](json => JsResult.fromTry(
      Try(
        TypoPath(
          open = json.\("open").as(Reads.BooleanReads),
          points = json.\("points").as(summon[Reads[List[TypoPoint]]])
        )
      )
    ),
  )
  ...
  given writes: OWrites[TypoPath] = OWrites[TypoPath](o =>
    new JsObject(ListMap[String, JsValue](
      "open" -> Writes.BooleanWrites.writes(o.open),
      "points" -> summon[Writes[List[TypoPoint]]].writes(o.points)
    ))
  )
}
