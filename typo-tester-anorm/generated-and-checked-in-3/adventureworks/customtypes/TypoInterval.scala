...
object TypoInterval {
  given arrayColumn: Column[Array[TypoInterval]] = Column.nonNull[Array[TypoInterval]]((v1: Any, _) =>
    v1 match {
        case v: PgArray =>
         v.getArray match {
           case v: Array[?] =>
  ...
  given arrayToStatement: ToStatement[Array[TypoInterval]] = ToStatement[Array[TypoInterval]]((s, index, v) => s.setArray(index, s.getConnection.createArrayOf("interval", v.map(v => new PGInterval(v.years, v.months, v.days, v.hours, v.minutes, v.seconds)))))
  given column: Column[TypoInterval] = Column.nonNull[TypoInterval]((v1: Any, _) =>
    v1 match {
  ...
  given reads: Reads[TypoInterval] = Reads[TypoInterval](json => JsResult.fromTry(
      Try(
        TypoInterval(
  ...
  given toStatement: ToStatement[TypoInterval] = ToStatement[TypoInterval]((s, index, v) => s.setObject(index, new PGInterval(v.years, v.months, v.days, v.hours, v.minutes, v.seconds)))
  given writes: OWrites[TypoInterval] = OWrites[TypoInterval](o =>
