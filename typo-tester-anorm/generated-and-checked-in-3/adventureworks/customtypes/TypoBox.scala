...
object TypoBox {
  given arrayColumn: Column[Array[TypoBox]] = Column.nonNull[Array[TypoBox]]((v1: Any, _) =>
    v1 match {
        case v: PgArray =>
         v.getArray match {
           case v: Array[?] =>
  ...
  given arrayToStatement: ToStatement[Array[TypoBox]] = ToStatement[Array[TypoBox]]((s, index, v) => s.setArray(index, s.getConnection.createArrayOf("box", v.map(v => new PGbox(v.x1, v.y1, v.x2, v.y2)))))
  given column: Column[TypoBox] = Column.nonNull[TypoBox]((v1: Any, _) =>
    v1 match {
  ...
  given reads: Reads[TypoBox] = Reads[TypoBox](json => JsResult.fromTry(
      Try(
        TypoBox(
  ...
  given toStatement: ToStatement[TypoBox] = ToStatement[TypoBox]((s, index, v) => s.setObject(index, new PGbox(v.x1, v.y1, v.x2, v.y2)))
  given writes: OWrites[TypoBox] = OWrites[TypoBox](o =>
