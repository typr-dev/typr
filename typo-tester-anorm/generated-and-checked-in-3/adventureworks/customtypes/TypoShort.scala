...
object TypoShort {
  ...
  given arrayColumn: Column[Array[TypoShort]] = Column.nonNull[Array[TypoShort]]((v1: Any, _) =>
    v1 match {
        case v: PgArray =>
         v.getArray match {
           case v: Array[?] =>
  ...
  given column: Column[TypoShort] = Column.nonNull[TypoShort]((v1: Any, _) =>
    v1 match {
  ...
  given parameterMetadata: ParameterMetaData[TypoShort] = new ParameterMetaData[TypoShort] {
    override def sqlType: String = "int2"
    override def jdbcType: Int = Types.OTHER
  }
  given reads: Reads[TypoShort] = summon[Reads[Short]].map(TypoShort.apply)
  ...
  given writes: Writes[TypoShort] = summon[Writes[Short]].contramap(_.value)
}
