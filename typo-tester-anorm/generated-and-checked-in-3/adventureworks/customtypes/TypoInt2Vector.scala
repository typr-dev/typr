...
object TypoInt2Vector {
  given arrayColumn: Column[Array[TypoInt2Vector]] = Column.nonNull[Array[TypoInt2Vector]]((v1: Any, _) =>
    v1 match {
        case v: PgArray =>
         v.getArray match {
           case v: Array[?] =>
  ...
  given arrayToStatement: ToStatement[Array[TypoInt2Vector]] = ToStatement[Array[TypoInt2Vector]]((s, index, v) => s.setArray(index, s.getConnection.createArrayOf("int2vector", v.map(v => {
  ...
  given column: Column[TypoInt2Vector] = Column.nonNull[TypoInt2Vector]((v1: Any, _) =>
    v1 match {
  ...
  given parameterMetadata: ParameterMetaData[TypoInt2Vector] = new ParameterMetaData[TypoInt2Vector] {
    override def sqlType: String = "int2vector"
    override def jdbcType: Int = Types.OTHER
  }
  given reads: Reads[TypoInt2Vector] = Reads.StringReads.map(TypoInt2Vector.apply)
  ...
  given toStatement: ToStatement[TypoInt2Vector] = ToStatement[TypoInt2Vector]((s, index, v) => s.setObject(index, {
                                                                    val obj = new PGobject
                                                                    obj.setType("int2vector")
                                                                    obj.setValue(v.value)
                                                                    obj
                                                                  }))
  given writes: Writes[TypoInt2Vector] = Writes.StringWrites.contramap(_.value)
}
