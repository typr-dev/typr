...
object TypoPoint {
  given arrayColumn: Column[Array[TypoPoint]] = Column.nonNull[Array[TypoPoint]]((v1: Any, _) =>
    v1 match {
        case v: PgArray =>
         v.getArray match {
           case v: Array[?] =>
  ...
  given column: Column[TypoPoint] = Column.nonNull[TypoPoint]((v1: Any, _) =>
    v1 match {
  ...
  given parameterMetadata: ParameterMetaData[TypoPoint] = new ParameterMetaData[TypoPoint] {
    override def sqlType: String = "point"
    override def jdbcType: Int = Types.OTHER
  }
  given reads: Reads[TypoPoint] = Reads[TypoPoint](json => JsResult.fromTry(
      Try(
        TypoPoint(
  ...
  given writes: OWrites[TypoPoint] = OWrites[TypoPoint](o =>
