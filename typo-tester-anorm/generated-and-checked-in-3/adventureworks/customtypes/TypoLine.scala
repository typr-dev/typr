...
object TypoLine {
  given arrayColumn: Column[Array[TypoLine]] = Column.nonNull[Array[TypoLine]]((v1: Any, _) =>
    v1 match {
        case v: PgArray =>
         v.getArray match {
           case v: Array[?] =>
  ...
  given column: Column[TypoLine] = Column.nonNull[TypoLine]((v1: Any, _) =>
    v1 match {
  ...
  given reads: Reads[TypoLine] = Reads[TypoLine](json => JsResult.fromTry(
      Try(
        TypoLine(
  ...
  given writes: OWrites[TypoLine] = OWrites[TypoLine](o =>
