...
object PersonDetailSqlRow {
  given reads: Reads[PersonDetailSqlRow] = Reads[PersonDetailSqlRow](json => JsResult.fromTry(
      Try(
        PersonDetailSqlRow(
  ...
  given writes: OWrites[PersonDetailSqlRow] = OWrites[PersonDetailSqlRow](o =>
