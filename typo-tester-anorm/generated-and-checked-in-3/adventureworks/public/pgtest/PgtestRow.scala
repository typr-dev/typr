...
object PgtestRow {
  given reads: Reads[PgtestRow] = Reads[PgtestRow](json => JsResult.fromTry(
      Try(
        PgtestRow(
  ...
  def rowParser(idx: Int): RowParser[PgtestRow] = RowParser[PgtestRow] { row =>
    Success(
      PgtestRow(
        ...
        bpchares = row(idx + 38)(using Column.columnToArray[String](using Column.columnToString, implicitly)),
        chares = row(idx + 39)(using Column.columnToArray[String](using Column.columnToString, implicitly)),
        circlees = row(idx + 40)(using TypoCircle.arrayColumn),
        datees = row(idx + 41)(using TypoLocalDate.arrayColumn),
        float4es = row(idx + 42)(using Column.columnToArray[Float](using Column.columnToFloat, implicitly)),
        float8es = row(idx + 43)(using Column.columnToArray[Double](using Column.columnToDouble, implicitly)),
        ...
        int4es = row(idx + 47)(using Column.columnToArray[Int](using Column.columnToInt, implicitly)),
        int8es = row(idx + 48)(using Column.columnToArray[Long](using Column.columnToLong, implicitly)),
        ...
        namees = row(idx + 57)(using Column.columnToArray[String](using Column.columnToString, implicitly)),
        numerices = row(idx + 58)(using Column.columnToArray[BigDecimal](using Column.columnToScalaBigDecimal, implicitly)),
        ...
        textes = row(idx + 62)(using Column.columnToArray[String](using Column.columnToString, implicitly)),
        ...
        varchares = row(idx + 68)(using Column.columnToArray[String](using Column.columnToString, implicitly)),
  ...
  given writes: OWrites[PgtestRow] = OWrites[PgtestRow](o =>
