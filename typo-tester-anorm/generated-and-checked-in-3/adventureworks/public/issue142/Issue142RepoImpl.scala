...
class Issue142RepoImpl extends Issue142Repo {
  ...
  override def insertStreaming(unsaved: Iterator[Issue142Row], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "public"."issue142"("tabellkode") FROM STDIN""", batchSize, unsaved)(using Issue142Row.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[Issue142Row], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table issue142_TEMP (like "public"."issue142") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy issue142_TEMP("tabellkode") from stdin""", batchSize, unsaved)(using Issue142Row.text, c): @nowarn
    SQL"""insert into "public"."issue142"("tabellkode")
