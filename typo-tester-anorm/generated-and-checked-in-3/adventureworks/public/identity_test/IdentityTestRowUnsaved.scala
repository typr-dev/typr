...
object IdentityTestRowUnsaved {
  given reads: Reads[IdentityTestRowUnsaved] = Reads[IdentityTestRowUnsaved](json => JsResult.fromTry(
      Try(
  ...
  given writes: OWrites[IdentityTestRowUnsaved] = OWrites[IdentityTestRowUnsaved](o =>
