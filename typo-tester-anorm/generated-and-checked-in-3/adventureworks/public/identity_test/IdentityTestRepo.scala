...
trait IdentityTestRepo {
  ...
  def insertStreaming(unsaved: Iterator[IdentityTestRow], batchSize: Int = 10000)(using c: Connection): Long
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[IdentityTestRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long
  ...
  def upsertStreaming(unsaved: Iterator[IdentityTestRow], batchSize: Int = 10000)(using c: Connection): Int
}
