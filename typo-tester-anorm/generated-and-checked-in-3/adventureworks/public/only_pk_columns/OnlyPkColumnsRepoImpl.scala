...
class OnlyPkColumnsRepoImpl extends OnlyPkColumnsRepo {
  ...
  override def deleteById(compositeId: OnlyPkColumnsId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[OnlyPkColumnsRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "public"."only_pk_columns"("key_column_1", "key_column_2") FROM STDIN""", batchSize, unsaved)(using OnlyPkColumnsRow.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[OnlyPkColumnsRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table only_pk_columns_TEMP (like "public"."only_pk_columns") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy only_pk_columns_TEMP("key_column_1", "key_column_2") from stdin""", batchSize, unsaved)(using OnlyPkColumnsRow.text, c): @nowarn
    SQL"""insert into "public"."only_pk_columns"("key_column_1", "key_column_2")
