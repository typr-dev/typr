...
class TableWithGeneratedColumnsRepoImpl extends TableWithGeneratedColumnsRepo {
  ...
  override def deleteById(name: TableWithGeneratedColumnsId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[TableWithGeneratedColumnsRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "public"."table-with-generated-columns"("name") FROM STDIN""", batchSize, unsaved)(using TableWithGeneratedColumnsRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[TableWithGeneratedColumnsRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "public"."table-with-generated-columns"("name") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using TableWithGeneratedColumnsRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[TableWithGeneratedColumnsRow], batchSize: Int = 10000)(using c: Connection): Int = {
    ...
    streamingInsert(s"""copy table-with-generated-columns_TEMP("name") from stdin""", batchSize, unsaved)(using TableWithGeneratedColumnsRow.text, c): @nowarn
    SQL"""insert into "public"."table-with-generated-columns"("name")
