...
class Issue1422RepoImpl extends Issue1422Repo {
  ...
  override def deleteById(tabellkode: Issue142Id)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[Issue1422Row], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "public"."issue142_2"("tabellkode") FROM STDIN""", batchSize, unsaved)(using Issue1422Row.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[Issue1422Row], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table issue142_2_TEMP (like "public"."issue142_2") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy issue142_2_TEMP("tabellkode") from stdin""", batchSize, unsaved)(using Issue1422Row.text, c): @nowarn
    SQL"""insert into "public"."issue142_2"("tabellkode")
