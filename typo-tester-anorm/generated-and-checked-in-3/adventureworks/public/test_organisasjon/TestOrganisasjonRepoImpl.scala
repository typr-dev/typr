...
class TestOrganisasjonRepoImpl extends TestOrganisasjonRepo {
  ...
  override def deleteById(organisasjonskode: TestOrganisasjonId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[TestOrganisasjonRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "public"."test_organisasjon"("organisasjonskode") FROM STDIN""", batchSize, unsaved)(using TestOrganisasjonRow.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[TestOrganisasjonRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table test_organisasjon_TEMP (like "public"."test_organisasjon") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy test_organisasjon_TEMP("organisasjonskode") from stdin""", batchSize, unsaved)(using TestOrganisasjonRow.text, c): @nowarn
    SQL"""insert into "public"."test_organisasjon"("organisasjonskode")
