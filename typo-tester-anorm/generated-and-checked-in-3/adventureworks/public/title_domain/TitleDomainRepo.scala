...
trait TitleDomainRepo {
  ...
  def insertStreaming(unsaved: Iterator[TitleDomainRow], batchSize: Int = 10000)(using c: Connection): Long
  ...
  def upsertStreaming(unsaved: Iterator[TitleDomainRow], batchSize: Int = 10000)(using c: Connection): Int
}
