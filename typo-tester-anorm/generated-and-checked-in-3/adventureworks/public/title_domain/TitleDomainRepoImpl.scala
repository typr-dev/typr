...
class TitleDomainRepoImpl extends TitleDomainRepo {
  ...
  override def insertStreaming(unsaved: Iterator[TitleDomainRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "public"."title_domain"("code") FROM STDIN""", batchSize, unsaved)(using TitleDomainRow.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[TitleDomainRow], batchSize: Int = 10000)(using c: Connection): Int = {
    ...
    streamingInsert(s"""copy title_domain_TEMP("code") from stdin""", batchSize, unsaved)(using TitleDomainRow.text, c): @nowarn
    SQL"""insert into "public"."title_domain"("code")
