...
class TestSakSoknadsalternativRepoImpl extends TestSakSoknadsalternativRepo {
  ...
  override def deleteById(compositeId: TestSakSoknadsalternativId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[TestSakSoknadsalternativRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "public"."test_sak_soknadsalternativ"("organisasjonskode_saksbehandler", "utdanningsmulighet_kode", "organisasjonskode_tilbyder") FROM STDIN""", batchSize, unsaved)(using TestSakSoknadsalternativRow.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[TestSakSoknadsalternativRow], batchSize: Int = 10000)(using c: Connection): Int = {
    ...
    streamingInsert(s"""copy test_sak_soknadsalternativ_TEMP("organisasjonskode_saksbehandler", "utdanningsmulighet_kode", "organisasjonskode_tilbyder") from stdin""", batchSize, unsaved)(using TestSakSoknadsalternativRow.text, c): @nowarn
    SQL"""insert into "public"."test_sak_soknadsalternativ"("organisasjonskode_saksbehandler", "utdanningsmulighet_kode", "organisasjonskode_tilbyder")
