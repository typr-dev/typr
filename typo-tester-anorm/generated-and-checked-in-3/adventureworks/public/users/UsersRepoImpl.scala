...
class UsersRepoImpl extends UsersRepo {
  ...
  override def deleteById(userId: UsersId)(using c: Connection): Boolean = {
  ...
  override def insert(unsaved: UsersRowUnsaved)(using c: Connection): UsersRow = {
    val namedParameters = List(
      ...
      Some((NamedParameter("last_name", ParameterValue(unsaved.lastName, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))), "")),
      ...
      Some((NamedParameter("verified_on", ParameterValue(unsaved.verifiedOn, null, ToStatement.optionToStatement(using TypoInstant.toStatement, TypoInstant.parameterMetadata))), "::timestamptz")),
  ...
  override def insertStreaming(unsaved: Iterator[UsersRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "public"."users"("user_id", "name", "last_name", "email", "password", "created_at", "verified_on") FROM STDIN""", batchSize, unsaved)(using UsersRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[UsersRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "public"."users"("user_id", "name", "last_name", "email", "password", "verified_on", "created_at") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using UsersRowUnsaved.text, c)
  }
  ...
  override def update(row: UsersRow)(using c: Connection): Option[UsersRow] = {
    ...
    SQL"""update "public"."users"
          set "name" = ${ParameterValue(row.name, null, ToStatement.stringToStatement)},
              "last_name" = ${ParameterValue(row.lastName, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
              ...
              "verified_on" = ${ParameterValue(row.verifiedOn, null, ToStatement.optionToStatement(using TypoInstant.toStatement, TypoInstant.parameterMetadata))}::timestamptz
          where "user_id" = ${ParameterValue(userId, null, UsersId.toStatement)}
          returning "user_id", "name", "last_name", "email"::text, "password", "created_at"::text, "verified_on"::text
  ...
  override def upsert(unsaved: UsersRow)(using c: Connection): UsersRow = {
    SQL"""insert into "public"."users"("user_id", "name", "last_name", "email", "password", "created_at", "verified_on")
          values (
            ...
            ${ParameterValue(unsaved.lastName, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
            ...
            ${ParameterValue(unsaved.verifiedOn, null, ToStatement.optionToStatement(using TypoInstant.toStatement, TypoInstant.parameterMetadata))}::timestamptz
          )
          on conflict ("user_id")
          do update set
            "name" = EXCLUDED."name",
  ...
  override def upsertBatch(unsaved: Iterable[UsersRow])(using c: Connection): List[UsersRow] = {
    def toNamedParameter(row: UsersRow): List[NamedParameter] = List(
      ...
      NamedParameter("last_name", ParameterValue(row.lastName, null, ToStatement.optionToStatement(using ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))),
  ...
  override def upsertStreaming(unsaved: Iterator[UsersRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table users_TEMP (like "public"."users") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy users_TEMP("user_id", "name", "last_name", "email", "password", "created_at", "verified_on") from stdin""", batchSize, unsaved)(using UsersRow.text, c): @nowarn
    SQL"""insert into "public"."users"("user_id", "name", "last_name", "email", "password", "created_at", "verified_on")
