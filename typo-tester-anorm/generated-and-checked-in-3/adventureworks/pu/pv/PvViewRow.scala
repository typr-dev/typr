...
object PvViewRow {
  given reads: Reads[PvViewRow] = Reads[PvViewRow](json => JsResult.fromTry(
      Try(
        PvViewRow(
  ...
  def rowParser(idx: Int): RowParser[PvViewRow] = RowParser[PvViewRow] { row =>
    Success(
      PvViewRow(
        ...
        lastreceiptcost = row(idx + 5)(using Column.columnToOption(using Column.columnToScalaBigDecimal)),
        lastreceiptdate = row(idx + 6)(using Column.columnToOption(using TypoLocalDateTime.column)),
        minorderqty = row(idx + 7)(using Column.columnToInt),
        maxorderqty = row(idx + 8)(using Column.columnToInt),
        onorderqty = row(idx + 9)(using Column.columnToOption(using Column.columnToInt)),
        unitmeasurecode = row(idx + 10)(using UnitmeasureId.column),
        modifieddate = row(idx + 11)(using TypoLocalDateTime.column)
      )
    )
  }
  given writes: OWrites[PvViewRow] = OWrites[PvViewRow](o =>
