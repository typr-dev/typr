...
class PersoncreditcardRepoImpl extends PersoncreditcardRepo {
  ...
  override def deleteById(compositeId: PersoncreditcardId)(using c: Connection): Boolean = {
  ...
  override def deleteByIds(compositeIds: Array[PersoncreditcardId])(using c: Connection, toStatement0: ToStatement[Array[/* user-picked */ CustomCreditcardId]]): Int = {
  ...
  override def insertStreaming(unsaved: Iterator[PersoncreditcardRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "sales"."personcreditcard"("businessentityid", "creditcardid", "modifieddate") FROM STDIN""", batchSize, unsaved)(using PersoncreditcardRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[PersoncreditcardRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "sales"."personcreditcard"("businessentityid", "creditcardid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using PersoncreditcardRowUnsaved.text, c)
  }
  ...
  override def selectByIds(compositeIds: Array[PersoncreditcardId])(using c: Connection, toStatement0: ToStatement[Array[/* user-picked */ CustomCreditcardId]]): List[PersoncreditcardRow] = {
    val businessentityid = compositeIds.map(_.businessentityid)
    val creditcardid = compositeIds.map(_.creditcardid)
    SQL"""select "businessentityid", "creditcardid", "modifieddate"::text
          from "sales"."personcreditcard"
  ...
  override def selectByIdsTracked(compositeIds: Array[PersoncreditcardId])(using c: Connection, toStatement0: ToStatement[Array[/* user-picked */ CustomCreditcardId]]): Map[PersoncreditcardId, PersoncreditcardRow] = {
  ...
  override def upsertStreaming(unsaved: Iterator[PersoncreditcardRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table personcreditcard_TEMP (like "sales"."personcreditcard") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy personcreditcard_TEMP("businessentityid", "creditcardid", "modifieddate") from stdin""", batchSize, unsaved)(using PersoncreditcardRow.text, c): @nowarn
    SQL"""insert into "sales"."personcreditcard"("businessentityid", "creditcardid", "modifieddate")
