...
class SalespersonquotahistoryRepoImpl extends SalespersonquotahistoryRepo {
  ...
  override def deleteById(compositeId: SalespersonquotahistoryId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[SalespersonquotahistoryRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "sales"."salespersonquotahistory"("businessentityid", "quotadate", "salesquota", "rowguid", "modifieddate") FROM STDIN""", batchSize, unsaved)(using SalespersonquotahistoryRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[SalespersonquotahistoryRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "sales"."salespersonquotahistory"("businessentityid", "quotadate", "salesquota", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using SalespersonquotahistoryRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[SalespersonquotahistoryRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table salespersonquotahistory_TEMP (like "sales"."salespersonquotahistory") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy salespersonquotahistory_TEMP("businessentityid", "quotadate", "salesquota", "rowguid", "modifieddate") from stdin""", batchSize, unsaved)(using SalespersonquotahistoryRow.text, c): @nowarn
    SQL"""insert into "sales"."salespersonquotahistory"("businessentityid", "quotadate", "salesquota", "rowguid", "modifieddate")
