...
object CountryregioncurrencyRowUnsaved {
  given reads: Reads[CountryregioncurrencyRowUnsaved] = Reads[CountryregioncurrencyRowUnsaved](json => JsResult.fromTry(
      Try(
  ...
  given writes: OWrites[CountryregioncurrencyRowUnsaved] = OWrites[CountryregioncurrencyRowUnsaved](o =>
