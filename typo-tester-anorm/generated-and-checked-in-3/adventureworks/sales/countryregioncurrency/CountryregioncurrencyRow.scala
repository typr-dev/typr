...
object CountryregioncurrencyRow {
  ...
  given reads: Reads[CountryregioncurrencyRow] = Reads[CountryregioncurrencyRow](json => JsResult.fromTry(
      Try(
  ...
  given writes: OWrites[CountryregioncurrencyRow] = OWrites[CountryregioncurrencyRow](o =>
