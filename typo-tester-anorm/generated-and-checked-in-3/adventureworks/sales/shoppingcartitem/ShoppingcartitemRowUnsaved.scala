...
object ShoppingcartitemRowUnsaved {
  given reads: Reads[ShoppingcartitemRowUnsaved] = Reads[ShoppingcartitemRowUnsaved](json => JsResult.fromTry(
      Try(
        ShoppingcartitemRowUnsaved(
          shoppingcartid = json.\("shoppingcartid").as(Reads.StringReads),
          productid = json.\("productid").as(ProductId.reads),
          shoppingcartitemid = json.\("shoppingcartitemid").as(Defaulted.reads(using ShoppingcartitemId.reads)),
          quantity = json.\("quantity").as(Defaulted.reads(using Reads.IntReads)),
          datecreated = json.\("datecreated").as(Defaulted.reads(using TypoLocalDateTime.reads)),
  ...
  given writes: OWrites[ShoppingcartitemRowUnsaved] = OWrites[ShoppingcartitemRowUnsaved](o =>
