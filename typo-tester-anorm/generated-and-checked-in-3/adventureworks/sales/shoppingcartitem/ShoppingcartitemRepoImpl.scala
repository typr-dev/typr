...
class ShoppingcartitemRepoImpl extends ShoppingcartitemRepo {
  ...
  override def deleteById(shoppingcartitemid: ShoppingcartitemId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[ShoppingcartitemRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "sales"."shoppingcartitem"("shoppingcartitemid", "shoppingcartid", "quantity", "productid", "datecreated", "modifieddate") FROM STDIN""", batchSize, unsaved)(using ShoppingcartitemRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[ShoppingcartitemRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "sales"."shoppingcartitem"("shoppingcartid", "productid", "shoppingcartitemid", "quantity", "datecreated", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using ShoppingcartitemRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[ShoppingcartitemRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table shoppingcartitem_TEMP (like "sales"."shoppingcartitem") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy shoppingcartitem_TEMP("shoppingcartitemid", "shoppingcartid", "quantity", "productid", "datecreated", "modifieddate") from stdin""", batchSize, unsaved)(using ShoppingcartitemRow.text, c): @nowarn
    SQL"""insert into "sales"."shoppingcartitem"("shoppingcartitemid", "shoppingcartid", "quantity", "productid", "datecreated", "modifieddate")
