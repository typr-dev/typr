...
object ShoppingcartitemRow {
  given reads: Reads[ShoppingcartitemRow] = Reads[ShoppingcartitemRow](json => JsResult.fromTry(
      Try(
        ShoppingcartitemRow(
  ...
  given writes: OWrites[ShoppingcartitemRow] = OWrites[ShoppingcartitemRow](o =>
