...
object VindividualcustomerViewRow {
  given reads: Reads[VindividualcustomerViewRow] = Reads[VindividualcustomerViewRow](json => JsResult.fromTry(
      Try(
  ...
  def rowParser(idx: Int): RowParser[VindividualcustomerViewRow] = RowParser[VindividualcustomerViewRow] { row =>
    Success(
      VindividualcustomerViewRow(
        ...
        demographics = row(idx + 17)(using Column.columnToOption(using TypoXml.column))
      )
    )
  }
  given writes: OWrites[VindividualcustomerViewRow] = OWrites[VindividualcustomerViewRow](o =>
