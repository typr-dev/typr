...
object SalesorderdetailRow {
  ...
  given reads: Reads[SalesorderdetailRow] = Reads[SalesorderdetailRow](json => JsResult.fromTry(
      Try(
        SalesorderdetailRow(
  ...
  given writes: OWrites[SalesorderdetailRow] = OWrites[SalesorderdetailRow](o =>
