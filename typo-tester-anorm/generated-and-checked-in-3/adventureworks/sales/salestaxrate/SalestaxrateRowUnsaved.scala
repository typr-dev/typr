...
object SalestaxrateRowUnsaved {
  given reads: Reads[SalestaxrateRowUnsaved] = Reads[SalestaxrateRowUnsaved](json => JsResult.fromTry(
      Try(
        SalestaxrateRowUnsaved(
          ...
          salestaxrateid = json.\("salestaxrateid").as(Defaulted.reads(using SalestaxrateId.reads)),
          taxrate = json.\("taxrate").as(Defaulted.reads(using Reads.bigDecReads)),
  ...
  given writes: OWrites[SalestaxrateRowUnsaved] = OWrites[SalestaxrateRowUnsaved](o =>
