...
class StoreRepoImpl extends StoreRepo {
  ...
  override def insertStreaming(unsaved: Iterator[StoreRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "sales"."store"("businessentityid", "name", "salespersonid", "demographics", "rowguid", "modifieddate") FROM STDIN""", batchSize, unsaved)(using StoreRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[StoreRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "sales"."store"("businessentityid", "name", "salespersonid", "demographics", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using StoreRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[StoreRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table store_TEMP (like "sales"."store") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy store_TEMP("businessentityid", "name", "salespersonid", "demographics", "rowguid", "modifieddate") from stdin""", batchSize, unsaved)(using StoreRow.text, c): @nowarn
    SQL"""insert into "sales"."store"("businessentityid", "name", "salespersonid", "demographics", "rowguid", "modifieddate")
