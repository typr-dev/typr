...
object SalesterritoryRowUnsaved {
  given reads: Reads[SalesterritoryRowUnsaved] = Reads[SalesterritoryRowUnsaved](json => JsResult.fromTry(
      Try(
        SalesterritoryRowUnsaved(
          ...
          territoryid = json.\("territoryid").as(Defaulted.reads(using SalesterritoryId.reads)),
          ...
          costytd = json.\("costytd").as(Defaulted.reads(using Reads.bigDecReads)),
          costlastyear = json.\("costlastyear").as(Defaulted.reads(using Reads.bigDecReads)),
  ...
  given writes: OWrites[SalesterritoryRowUnsaved] = OWrites[SalesterritoryRowUnsaved](o =>
