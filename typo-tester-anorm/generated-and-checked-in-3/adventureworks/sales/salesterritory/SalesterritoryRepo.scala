...
trait SalesterritoryRepo {
  ...
  def insertStreaming(unsaved: Iterator[SalesterritoryRow], batchSize: Int = 10000)(using c: Connection): Long
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  def insertUnsavedStreaming(unsaved: Iterator[SalesterritoryRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long
  ...
  def upsertStreaming(unsaved: Iterator[SalesterritoryRow], batchSize: Int = 10000)(using c: Connection): Int
}
