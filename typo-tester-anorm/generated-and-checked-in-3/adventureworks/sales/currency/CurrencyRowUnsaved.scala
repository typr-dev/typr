...
object CurrencyRowUnsaved {
  given reads: Reads[CurrencyRowUnsaved] = Reads[CurrencyRowUnsaved](json => JsResult.fromTry(
      Try(
        CurrencyRowUnsaved(
  ...
  given writes: OWrites[CurrencyRowUnsaved] = OWrites[CurrencyRowUnsaved](o =>
