...
class CurrencyRepoImpl extends CurrencyRepo {
  ...
  override def insertStreaming(unsaved: Iterator[CurrencyRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "sales"."currency"("currencycode", "name", "modifieddate") FROM STDIN""", batchSize, unsaved)(using CurrencyRow.text, c)
  }
  ...
  override def insertUnsavedStreaming(unsaved: Iterator[CurrencyRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "sales"."currency"("currencycode", "name", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using CurrencyRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[CurrencyRow], batchSize: Int = 10000)(using c: Connection): Int = {
    ...
    streamingInsert(s"""copy currency_TEMP("currencycode", "name", "modifieddate") from stdin""", batchSize, unsaved)(using CurrencyRow.text, c): @nowarn
    SQL"""insert into "sales"."currency"("currencycode", "name", "modifieddate")
