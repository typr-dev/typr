...
class SpecialofferproductRepoImpl extends SpecialofferproductRepo {
  ...
  override def deleteById(compositeId: SpecialofferproductId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[SpecialofferproductRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "sales"."specialofferproduct"("specialofferid", "productid", "rowguid", "modifieddate") FROM STDIN""", batchSize, unsaved)(using SpecialofferproductRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[SpecialofferproductRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "sales"."specialofferproduct"("specialofferid", "productid", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using SpecialofferproductRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[SpecialofferproductRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table specialofferproduct_TEMP (like "sales"."specialofferproduct") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy specialofferproduct_TEMP("specialofferid", "productid", "rowguid", "modifieddate") from stdin""", batchSize, unsaved)(using SpecialofferproductRow.text, c): @nowarn
    SQL"""insert into "sales"."specialofferproduct"("specialofferid", "productid", "rowguid", "modifieddate")
