...
object SalesorderheaderRowUnsaved {
  given reads: Reads[SalesorderheaderRowUnsaved] = Reads[SalesorderheaderRowUnsaved](json => JsResult.fromTry(
      Try(
        SalesorderheaderRowUnsaved(
          ...
          salesorderid = json.\("salesorderid").as(Defaulted.reads(using SalesorderheaderId.reads)),
          revisionnumber = json.\("revisionnumber").as(Defaulted.reads(using TypoShort.reads)),
          orderdate = json.\("orderdate").as(Defaulted.reads(using TypoLocalDateTime.reads)),
          status = json.\("status").as(Defaulted.reads(using TypoShort.reads)),
          onlineorderflag = json.\("onlineorderflag").as(Defaulted.reads(using Flag.reads)),
          subtotal = json.\("subtotal").as(Defaulted.reads(using Reads.bigDecReads)),
          taxamt = json.\("taxamt").as(Defaulted.reads(using Reads.bigDecReads)),
          freight = json.\("freight").as(Defaulted.reads(using Reads.bigDecReads)),
  ...
  given writes: OWrites[SalesorderheaderRowUnsaved] = OWrites[SalesorderheaderRowUnsaved](o =>
