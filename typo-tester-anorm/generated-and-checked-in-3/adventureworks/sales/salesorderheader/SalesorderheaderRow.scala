...
object SalesorderheaderRow {
  given reads: Reads[SalesorderheaderRow] = Reads[SalesorderheaderRow](json => JsResult.fromTry(
      Try(
        SalesorderheaderRow(
  ...
  given writes: OWrites[SalesorderheaderRow] = OWrites[SalesorderheaderRow](o =>
