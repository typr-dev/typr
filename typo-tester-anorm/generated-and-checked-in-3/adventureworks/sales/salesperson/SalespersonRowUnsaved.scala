...
object SalespersonRowUnsaved {
  given reads: Reads[SalespersonRowUnsaved] = Reads[SalespersonRowUnsaved](json => JsResult.fromTry(
      Try(
  ...
  given writes: OWrites[SalespersonRowUnsaved] = OWrites[SalespersonRowUnsaved](o =>
