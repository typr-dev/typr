...
object SalesreasonRowUnsaved {
  given reads: Reads[SalesreasonRowUnsaved] = Reads[SalesreasonRowUnsaved](json => JsResult.fromTry(
      Try(
        SalesreasonRowUnsaved(
          name = json.\("name").as(Name.reads),
          reasontype = json.\("reasontype").as(Name.reads),
          salesreasonid = json.\("salesreasonid").as(Defaulted.reads(using SalesreasonId.reads)),
  ...
  given writes: OWrites[SalesreasonRowUnsaved] = OWrites[SalesreasonRowUnsaved](o =>
