...
class SalesreasonRepoImpl extends SalesreasonRepo {
  ...
  override def deleteById(salesreasonid: SalesreasonId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[SalesreasonRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "sales"."salesreason"("salesreasonid", "name", "reasontype", "modifieddate") FROM STDIN""", batchSize, unsaved)(using SalesreasonRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[SalesreasonRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "sales"."salesreason"("name", "reasontype", "salesreasonid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using SalesreasonRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[SalesreasonRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table salesreason_TEMP (like "sales"."salesreason") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy salesreason_TEMP("salesreasonid", "name", "reasontype", "modifieddate") from stdin""", batchSize, unsaved)(using SalesreasonRow.text, c): @nowarn
    SQL"""insert into "sales"."salesreason"("salesreasonid", "name", "reasontype", "modifieddate")
