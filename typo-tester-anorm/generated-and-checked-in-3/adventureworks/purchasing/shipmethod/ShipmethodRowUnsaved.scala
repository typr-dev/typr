...
object ShipmethodRowUnsaved {
  given reads: Reads[ShipmethodRowUnsaved] = Reads[ShipmethodRowUnsaved](json => JsResult.fromTry(
      Try(
        ShipmethodRowUnsaved(
          name = json.\("name").as(Name.reads),
          shipmethodid = json.\("shipmethodid").as(Defaulted.reads(using ShipmethodId.reads)),
          shipbase = json.\("shipbase").as(Defaulted.reads(using Reads.bigDecReads)),
          shiprate = json.\("shiprate").as(Defaulted.reads(using Reads.bigDecReads)),
  ...
  given writes: OWrites[ShipmethodRowUnsaved] = OWrites[ShipmethodRowUnsaved](o =>
