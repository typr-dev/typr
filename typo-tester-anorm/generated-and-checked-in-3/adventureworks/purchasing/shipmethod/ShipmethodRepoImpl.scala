...
class ShipmethodRepoImpl extends ShipmethodRepo {
  ...
  override def deleteById(shipmethodid: ShipmethodId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[ShipmethodRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "purchasing"."shipmethod"("shipmethodid", "name", "shipbase", "shiprate", "rowguid", "modifieddate") FROM STDIN""", batchSize, unsaved)(using ShipmethodRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[ShipmethodRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "purchasing"."shipmethod"("name", "shipmethodid", "shipbase", "shiprate", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using ShipmethodRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[ShipmethodRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table shipmethod_TEMP (like "purchasing"."shipmethod") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy shipmethod_TEMP("shipmethodid", "name", "shipbase", "shiprate", "rowguid", "modifieddate") from stdin""", batchSize, unsaved)(using ShipmethodRow.text, c): @nowarn
    SQL"""insert into "purchasing"."shipmethod"("shipmethodid", "name", "shipbase", "shiprate", "rowguid", "modifieddate")
