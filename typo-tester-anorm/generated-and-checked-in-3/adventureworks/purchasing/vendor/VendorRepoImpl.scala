...
class VendorRepoImpl extends VendorRepo {
  ...
  override def insertStreaming(unsaved: Iterator[VendorRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "purchasing"."vendor"("businessentityid", "accountnumber", "name", "creditrating", "preferredvendorstatus", "activeflag", "purchasingwebserviceurl", "modifieddate") FROM STDIN""", batchSize, unsaved)(using VendorRow.text, c)
  }
  ...
  override def insertUnsavedStreaming(unsaved: Iterator[VendorRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "purchasing"."vendor"("businessentityid", "accountnumber", "name", "creditrating", "purchasingwebserviceurl", "preferredvendorstatus", "activeflag", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using VendorRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[VendorRow], batchSize: Int = 10000)(using c: Connection): Int = {
    ...
    streamingInsert(s"""copy vendor_TEMP("businessentityid", "accountnumber", "name", "creditrating", "preferredvendorstatus", "activeflag", "purchasingwebserviceurl", "modifieddate") from stdin""", batchSize, unsaved)(using VendorRow.text, c): @nowarn
    SQL"""insert into "purchasing"."vendor"("businessentityid", "accountnumber", "name", "creditrating", "preferredvendorstatus", "activeflag", "purchasingwebserviceurl", "modifieddate")
