...
object VvendorwithcontactsViewRow {
  given reads: Reads[VvendorwithcontactsViewRow] = Reads[VvendorwithcontactsViewRow](json => JsResult.fromTry(
      Try(
  ...
  given writes: OWrites[VvendorwithcontactsViewRow] = OWrites[VvendorwithcontactsViewRow](o =>
