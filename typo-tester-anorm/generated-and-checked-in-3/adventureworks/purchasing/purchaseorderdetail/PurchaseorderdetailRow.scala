...
object PurchaseorderdetailRow {
  ...
  given reads: Reads[PurchaseorderdetailRow] = Reads[PurchaseorderdetailRow](json => JsResult.fromTry(
      Try(
  ...
  given writes: OWrites[PurchaseorderdetailRow] = OWrites[PurchaseorderdetailRow](o =>
