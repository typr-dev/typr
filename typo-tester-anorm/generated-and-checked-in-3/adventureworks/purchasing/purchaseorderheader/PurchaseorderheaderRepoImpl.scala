...
class PurchaseorderheaderRepoImpl extends PurchaseorderheaderRepo {
  ...
  override def deleteById(purchaseorderid: PurchaseorderheaderId)(using c: Connection): Boolean = {
  ...
  override def insertStreaming(unsaved: Iterator[PurchaseorderheaderRow], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "purchasing"."purchaseorderheader"("purchaseorderid", "revisionnumber", "status", "employeeid", "vendorid", "shipmethodid", "orderdate", "shipdate", "subtotal", "taxamt", "freight", "modifieddate") FROM STDIN""", batchSize, unsaved)(using PurchaseorderheaderRow.text, c)
  }
  /* NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(unsaved: Iterator[PurchaseorderheaderRowUnsaved], batchSize: Int = 10000)(using c: Connection): Long = {
    streamingInsert(s"""COPY "purchasing"."purchaseorderheader"("employeeid", "vendorid", "shipmethodid", "shipdate", "purchaseorderid", "revisionnumber", "status", "orderdate", "subtotal", "taxamt", "freight", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using PurchaseorderheaderRowUnsaved.text, c)
  }
  ...
  override def upsertStreaming(unsaved: Iterator[PurchaseorderheaderRow], batchSize: Int = 10000)(using c: Connection): Int = {
    SQL"""create temporary table purchaseorderheader_TEMP (like "purchasing"."purchaseorderheader") on commit drop""".execute(): @nowarn
    streamingInsert(s"""copy purchaseorderheader_TEMP("purchaseorderid", "revisionnumber", "status", "employeeid", "vendorid", "shipmethodid", "orderdate", "shipdate", "subtotal", "taxamt", "freight", "modifieddate") from stdin""", batchSize, unsaved)(using PurchaseorderheaderRow.text, c): @nowarn
    SQL"""insert into "purchasing"."purchaseorderheader"("purchaseorderid", "revisionnumber", "status", "employeeid", "vendorid", "shipmethodid", "orderdate", "shipdate", "subtotal", "taxamt", "freight", "modifieddate")
