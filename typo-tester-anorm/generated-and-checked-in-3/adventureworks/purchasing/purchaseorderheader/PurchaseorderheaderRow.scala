...
object PurchaseorderheaderRow {
  given reads: Reads[PurchaseorderheaderRow] = Reads[PurchaseorderheaderRow](json => JsResult.fromTry(
      Try(
  ...
  given writes: OWrites[PurchaseorderheaderRow] = OWrites[PurchaseorderheaderRow](o =>
