...
import dev.typr.dsl.UpdateBuilder as JavaUpdateBuilder
...
class UpdateBuilder<Fields, Row> internal constructor(
     ...
     */
    fun <T> setExpr(field: (Fields) -> SqlExpr.FieldLike<T, Row>, expr: dev.typr.dsl.SqlExpr<T>): UpdateBuilder<Fields, Row> {
    ...
    fun <T> setComputedValue(
        ...
        compute: (dev.typr.dsl.SqlExpr.FieldLike<T, Row>) -> dev.typr.dsl.SqlExpr<T>
    ...
    fun executeReturning(connection: Connection): List<Row> {
        return javaBuilder.executeReturning(connection.javaConnection)
    }
    ...
    companion object {
        ...
        fun <Fields, Row : Any> of(
            ...
            return UpdateBuilder(JavaUpdateBuilder.of(tableName, structure, rowCodec.underlying, dialect))
        }
    }
}
