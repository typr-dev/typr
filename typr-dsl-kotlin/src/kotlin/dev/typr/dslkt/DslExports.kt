...
// Core DSL types
typealias Bijection<Wrapper, Underlying> = dev.typr.foundations.Bijection<Wrapper, Underlying>
// Note: SqlExpr and Structure are defined as objects below for nested type access
typealias SortOrder<T> = dev.typr.dsl.SortOrder<T>
typealias Dialect = dev.typr.dsl.Dialect
typealias FieldsBase<Row> = dev.typr.dsl.FieldsBase<Row>
typealias FieldsExpr<Row> = dev.typr.dsl.FieldsExpr<Row>

// Functional interfaces (for SQL expressions with multiple parameters)
typealias SqlFunction2<T1, T2, R> = dev.typr.dsl.SqlFunction2<T1, T2, R>
typealias SqlFunction3<T1, T2, T3, R> = dev.typr.dsl.SqlFunction3<T1, T2, T3, R>
typealias TriFunction<T1, T2, T3, R> = dev.typr.dsl.TriFunction<T1, T2, T3, R>

// Builder parameter types (used by generated code)
typealias DeleteParams<Fields> = dev.typr.dsl.DeleteParams<Fields>
typealias SelectParams<Fields, Row> = dev.typr.dsl.SelectParams<Fields, Row>
typealias UpdateParams<Fields, Row> = dev.typr.dsl.UpdateParams<Fields, Row>
...
// Path type
typealias Path = dev.typr.dsl.Path
 ...
 * Usage: field.asc()
 */
fun <T> dev.typr.dsl.SqlExpr<T>.asc(): SortOrder<T> = dev.typr.dsl.SortOrder.asc(this)

/**
 * Create descending sort order from SqlExpr.
 * Usage: field.desc()
 */
fun <T> dev.typr.dsl.SqlExpr<T>.desc(): SortOrder<T> = dev.typr.dsl.SortOrder.desc(this)
