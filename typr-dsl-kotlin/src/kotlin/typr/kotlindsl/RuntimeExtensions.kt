...
fun <A : Any> PgType<A>.nullable(): PgType<A?> {
    ...
    val pgRead: PgRead<A?> = typr.runtime.KotlinNullablePgRead(underlying.read())
...
fun <A : Any> DuckDbType<A>.nullable(): DuckDbType<A?> {
    ...
    // This tells RowParser.opt() that this column is already nullable
    val duckDbRead: DuckDbRead<A?> = typr.runtime.KotlinNullableDuckDbRead(underlying.read())
...
fun <A : Any> MariaType<A>.nullable(): MariaType<A?> {
    ...
    // This tells RowParser.opt() that this column is already nullable
    val mariaRead: MariaRead<A?> = typr.runtime.KotlinNullableMariaRead(underlying.read())
...
fun <A : Any> OracleType<A>.nullable(): OracleType<A?> {
    ...
    // This tells RowParser.opt() that this column is already nullable
    val oracleRead: OracleRead<A?> = typr.runtime.KotlinNullableOracleRead(underlying.read())
...
fun <A : Any> SqlServerType<A>.nullable(): SqlServerType<A?> {
    ...
    // This tells RowParser.opt() that this column is already nullable
    val sqlServerRead: SqlServerRead<A?> = typr.runtime.KotlinNullableSqlServerRead(underlying.read())
...
fun <L, R> Either<L, R>.leftOrNull(): L? {
    return when (this) {
        is typr.runtime.Either.Left -> this.value()
        else -> null
    }
}
 ...
 * Uses .orNull() from OptionalExtensions.
 */
fun <A> typr.data.Arr<A>.getOrNull(vararg indices: Int): A? {
 ...
 */
inline fun buildFragment(block: typr.runtime.Fragment.Builder.() -> Unit): Fragment {
    val builder = typr.runtime.Fragment.Builder()
    builder.block()
 ...
 */
fun <T> typr.runtime.Fragment.Builder.paramNullable(type: PgType<T>, value: T?): typr.runtime.Fragment.Builder {
 ...
 */
fun <Out> typr.runtime.Fragment.query(parser: ResultSetParser<Out>): typr.runtime.Operation<Out> {
 ...
 */
fun <T> typr.runtime.Operation<java.util.Optional<T>>.runUncheckedOrNull(c: java.sql.Connection): T? {
