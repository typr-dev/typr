...
trait EmployeepayhistoryRepo {
  ...
  def update(row: EmployeepayhistoryRow)(using c: Connection): Boolean

  def upsert(unsaved: EmployeepayhistoryRow)(using c: Connection): EmployeepayhistoryRow

  def upsertBatch(unsaved: Iterator[EmployeepayhistoryRow])(using c: Connection): List[EmployeepayhistoryRow]
