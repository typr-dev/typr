...
trait SalesterritoryhistoryRepo {
  ...
  def update(row: SalesterritoryhistoryRow)(using c: Connection): Boolean

  def upsert(unsaved: SalesterritoryhistoryRow)(using c: Connection): SalesterritoryhistoryRow

  def upsertBatch(unsaved: Iterator[SalesterritoryhistoryRow])(using c: Connection): List[SalesterritoryhistoryRow]
