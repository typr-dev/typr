...
trait SalespersonquotahistoryRepo {
  ...
  def update(row: SalespersonquotahistoryRow)(using c: Connection): Boolean

  def upsert(unsaved: SalespersonquotahistoryRow)(using c: Connection): SalespersonquotahistoryRow

  def upsertBatch(unsaved: Iterator[SalespersonquotahistoryRow])(using c: Connection): List[SalespersonquotahistoryRow]
