...
trait CountryregioncurrencyRepo {
  ...
  def update(row: CountryregioncurrencyRow)(using c: Connection): Boolean

  def upsert(unsaved: CountryregioncurrencyRow)(using c: Connection): CountryregioncurrencyRow

  def upsertBatch(unsaved: Iterator[CountryregioncurrencyRow])(using c: Connection): List[CountryregioncurrencyRow]
