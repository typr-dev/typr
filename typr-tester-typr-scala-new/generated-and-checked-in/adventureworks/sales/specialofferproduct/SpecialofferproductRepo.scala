...
trait SpecialofferproductRepo {
  ...
  def update(row: SpecialofferproductRow)(using c: Connection): Boolean

  def upsert(unsaved: SpecialofferproductRow)(using c: Connection): SpecialofferproductRow

  def upsertBatch(unsaved: Iterator[SpecialofferproductRow])(using c: Connection): List[SpecialofferproductRow]
