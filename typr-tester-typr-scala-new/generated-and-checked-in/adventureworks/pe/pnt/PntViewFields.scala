...
trait PntViewFields extends FieldsExpr0[PntViewRow] {
  ...
  override def rowParser: RowParser[PntViewRow] = PntViewRow._rowParser.underlying
}
...
object PntViewFields {
  case class Impl(val `_path`: java.util.List[Path]) extends PntViewFields with RelationStructure[PntViewFields, PntViewRow] {
    ...
    override def columns: java.util.List[FieldLike[?, PntViewRow]] = java.util.List.of(this.id.underlying, this.phonenumbertypeid.underlying, this.name.underlying, this.modifieddate.underlying)
