...
trait ProductmodelproductdescriptioncultureRepo {
  ...
  def update(row: ProductmodelproductdescriptioncultureRow)(using c: Connection): Boolean

  def upsert(unsaved: ProductmodelproductdescriptioncultureRow)(using c: Connection): ProductmodelproductdescriptioncultureRow

  def upsertBatch(unsaved: Iterator[ProductmodelproductdescriptioncultureRow])(using c: Connection): List[ProductmodelproductdescriptioncultureRow]
