...
trait ProductproductphotoRepo {
  ...
  def update(row: ProductproductphotoRow)(using c: Connection): Boolean

  def upsert(unsaved: ProductproductphotoRow)(using c: Connection): ProductproductphotoRow

  def upsertBatch(unsaved: Iterator[ProductproductphotoRow])(using c: Connection): List[ProductproductphotoRow]
