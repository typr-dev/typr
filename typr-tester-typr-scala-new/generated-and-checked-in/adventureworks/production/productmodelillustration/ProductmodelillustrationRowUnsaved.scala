...
case class ProductmodelillustrationRowUnsaved(
  ...
  def toRow(modifieddateDefault: => LocalDateTime): ProductmodelillustrationRow = new ProductmodelillustrationRow(productmodelid = productmodelid, illustrationid = illustrationid, modifieddate = modifieddate.getOrElse(modifieddateDefault))
}
