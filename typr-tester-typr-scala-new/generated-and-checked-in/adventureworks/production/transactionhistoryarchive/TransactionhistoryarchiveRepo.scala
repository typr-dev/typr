...
trait TransactionhistoryarchiveRepo {
  ...
  def update(row: TransactionhistoryarchiveRow)(using c: Connection): Boolean

  def upsert(unsaved: TransactionhistoryarchiveRow)(using c: Connection): TransactionhistoryarchiveRow

  def upsertBatch(unsaved: Iterator[TransactionhistoryarchiveRow])(using c: Connection): List[TransactionhistoryarchiveRow]
