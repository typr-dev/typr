...
trait BillofmaterialsRepo {
  ...
  def update(row: BillofmaterialsRow)(using c: Connection): Boolean

  def upsert(unsaved: BillofmaterialsRow)(using c: Connection): BillofmaterialsRow

  def upsertBatch(unsaved: Iterator[BillofmaterialsRow])(using c: Connection): List[BillofmaterialsRow]
