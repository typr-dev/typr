...
trait TransactionhistoryRepo {
  ...
  def update(row: TransactionhistoryRow)(using c: Connection): Boolean

  def upsert(unsaved: TransactionhistoryRow)(using c: Connection): TransactionhistoryRow

  def upsertBatch(unsaved: Iterator[TransactionhistoryRow])(using c: Connection): List[TransactionhistoryRow]
