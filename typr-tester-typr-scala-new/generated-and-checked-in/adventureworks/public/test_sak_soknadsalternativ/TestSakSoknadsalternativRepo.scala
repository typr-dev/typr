...
trait TestSakSoknadsalternativRepo {
  ...
  def update(row: TestSakSoknadsalternativRow)(using c: Connection): Boolean

  def upsert(unsaved: TestSakSoknadsalternativRow)(using c: Connection): TestSakSoknadsalternativRow

  def upsertBatch(unsaved: Iterator[TestSakSoknadsalternativRow])(using c: Connection): List[TestSakSoknadsalternativRow]
