...
object OnlyPkColumnsRow {
  val `_rowParser`: RowParser[OnlyPkColumnsRow] = RowParsers.of(PgTypes.text, PgTypes.int4, (t0, t1) => new OnlyPkColumnsRow(t0, t1), row => Array[Any](row.keyColumn1, row.keyColumn2))
