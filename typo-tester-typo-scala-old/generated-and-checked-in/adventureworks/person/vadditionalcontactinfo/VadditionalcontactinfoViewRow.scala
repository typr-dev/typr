...
object VadditionalcontactinfoViewRow {
  val `_rowParser`: RowParser[VadditionalcontactinfoViewRow] = {
    RowParsers.of(BusinessentityId.pgType, FirstName.pgType, Name.pgType, Name.pgType, PgTypes.xml.opt(), PgTypes.text.opt(), PgTypes.xml.opt(), PgTypes.xml.opt(), PgTypes.xml.opt(), PgTypes.xml.opt(), PgTypes.xml.opt(), PgTypes.xml.opt(), PgTypes.xml.opt(), PgTypes.text.opt(), PgTypes.xml.opt(), PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16) => new VadditionalcontactinfoViewRow(
      t0,
      t1,
      t2,
      t3,
