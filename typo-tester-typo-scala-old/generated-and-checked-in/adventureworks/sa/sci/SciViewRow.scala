...
object SciViewRow {
  val `_rowParser`: RowParser[SciViewRow] = {
    RowParsers.of(ShoppingcartitemId.pgType, ShoppingcartitemId.pgType, PgTypes.text, PgTypes.int4, ProductId.pgType, PgTypes.timestamp, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6) => new SciViewRow(
      t0,
      t1,
      t2,
      t3,
