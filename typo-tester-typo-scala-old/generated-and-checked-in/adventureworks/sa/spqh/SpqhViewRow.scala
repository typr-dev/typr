...
object SpqhViewRow {
  val `_rowParser`: RowParser[SpqhViewRow] = {
    RowParsers.of(BusinessentityId.pgType, BusinessentityId.pgType, PgTypes.timestamp, PgTypes.numeric, PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5) => new SpqhViewRow(
      t0,
      t1,
      t2,
      t3,
