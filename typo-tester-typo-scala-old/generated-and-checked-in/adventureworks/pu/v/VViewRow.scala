...
object VViewRow {
  val `_rowParser`: RowParser[VViewRow] = {
    RowParsers.of(BusinessentityId.pgType, BusinessentityId.pgType, AccountNumber.pgType, Name.pgType, PgTypes.int2, Flag.pgType, Flag.pgType, PgTypes.text, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6, t7, t8) => new VViewRow(
      t0,
      t1,
      t2,
      t3,
