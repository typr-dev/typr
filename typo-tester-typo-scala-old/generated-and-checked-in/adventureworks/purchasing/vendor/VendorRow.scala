...
object VendorRow {
  val `_rowParser`: RowParser[VendorRow] = {
    RowParsers.of(BusinessentityId.pgType, AccountNumber.pgType, Name.pgType, PgTypes.int2, Flag.pgType, Flag.pgType, PgTypes.text.opt(), PgTypes.timestamp, (t0, t1, t2, t3, t4, t5, t6, t7) => new VendorRow(
      t0,
      t1,
      t2,
      t3,
