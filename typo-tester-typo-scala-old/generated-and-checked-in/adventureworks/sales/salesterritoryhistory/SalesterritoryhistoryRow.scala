...
object SalesterritoryhistoryRow {
  val `_rowParser`: RowParser[SalesterritoryhistoryRow] = {
    RowParsers.of(BusinessentityId.pgType, SalesterritoryId.pgType, PgTypes.timestamp, PgTypes.timestamp.opt(), PgTypes.uuid, PgTypes.timestamp, (t0, t1, t2, t3, t4, t5) => new SalesterritoryhistoryRow(
      t0,
      t1,
      t2,
      t3,
