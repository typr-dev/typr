...
class VWarehouseCoverageViewRepoImpl extends VWarehouseCoverageViewRepo {
  ...
  override def selectAll(using c: Connection): java.util.List[VWarehouseCoverageViewRow] = {
    interpolate"""select `warehouse_id`, `code`, `name`, `address`, `location_wkt`, `service_area_wkt`, `timezone`, `is_active`, `products_stocked`, `total_inventory`
