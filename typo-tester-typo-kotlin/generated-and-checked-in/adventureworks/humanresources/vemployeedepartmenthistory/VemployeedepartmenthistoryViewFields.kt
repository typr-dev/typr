  ...
  companion object {
    private class Impl(path: List<Path>) : Relation<VemployeedepartmenthistoryViewFields, VemployeedepartmenthistoryViewRow>(path) {
      override fun fields(): VemployeedepartmenthistoryViewFields = object : VemployeedepartmenthistoryViewFields {
        ...
        override fun firstname(): Field</* user-picked */ FirstName, VemployeedepartmenthistoryViewRow> = Field</* user-picked */ FirstName, VemployeedepartmenthistoryViewRow>(_path, "firstname", VemployeedepartmenthistoryViewRow::firstname, Optional.empty(), Optional.empty(), { row, value -> row.copy(firstname = value) }, /* user-picked */ FirstName.pgType)
