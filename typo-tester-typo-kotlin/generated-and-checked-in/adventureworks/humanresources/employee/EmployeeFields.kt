  ...
  companion object {
    private class Impl(path: List<Path>) : Relation<EmployeeFields, EmployeeRow>(path) {
      override fun fields(): EmployeeFields = object : EmployeeFields {
        ...
        override fun maritalstatus(): Field</* bpchar, max 1 chars */ String, EmployeeRow> = Field</* bpchar, max 1 chars */ String, EmployeeRow>(_path, "maritalstatus", EmployeeRow::maritalstatus, Optional.empty(), Optional.of("bpchar"), { row, value -> row.copy(maritalstatus = value) }, PgTypes.text)
        override fun gender(): Field</* bpchar, max 1 chars */ String, EmployeeRow> = Field</* bpchar, max 1 chars */ String, EmployeeRow>(_path, "gender", EmployeeRow::gender, Optional.empty(), Optional.of("bpchar"), { row, value -> row.copy(gender = value) }, PgTypes.text)
