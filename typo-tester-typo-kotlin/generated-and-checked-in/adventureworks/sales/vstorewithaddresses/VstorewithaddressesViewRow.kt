...
data class VstorewithaddressesViewRow(
  ...
  companion object {
    val _rowParser: RowParser<VstorewithaddressesViewRow> = RowParsers.of(BusinessentityId.pgType, Name.pgType, Name.pgType, PgTypes.text, PgTypes.text.opt(), PgTypes.text, Name.pgType, PgTypes.text, Name.pgType, { t0, t1, t2, t3, t4, t5, t6, t7, t8 -> VstorewithaddressesViewRow(t0!!, t1!!, t2!!, t3!!, t4!!, t5!!, t6!!, t7!!, t8!!) }, { row -> arrayOf<Any?>(row.businessentityid, row.name, row.addresstype, row.addressline1, row.addressline2, row.city, row.stateprovincename, row.postalcode, row.countryregionname) })
  }
}