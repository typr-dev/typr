  ...
  companion object {
    private class Impl(path: List<Path>) : Relation<VsalespersonViewFields, VsalespersonViewRow>(path) {
      override fun fields(): VsalespersonViewFields = object : VsalespersonViewFields {
        ...
        override fun firstname(): Field</* user-picked */ FirstName, VsalespersonViewRow> = Field</* user-picked */ FirstName, VsalespersonViewRow>(_path, "firstname", VsalespersonViewRow::firstname, Optional.empty(), Optional.empty(), { row, value -> row.copy(firstname = value) }, /* user-picked */ FirstName.pgType)
