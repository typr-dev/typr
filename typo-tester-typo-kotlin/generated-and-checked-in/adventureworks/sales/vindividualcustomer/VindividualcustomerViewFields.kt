  ...
  companion object {
    private class Impl(path: List<Path>) : Relation<VindividualcustomerViewFields, VindividualcustomerViewRow>(path) {
      override fun fields(): VindividualcustomerViewFields = object : VindividualcustomerViewFields {
        ...
        override fun firstname(): Field</* user-picked */ FirstName, VindividualcustomerViewRow> = Field</* user-picked */ FirstName, VindividualcustomerViewRow>(_path, "firstname", VindividualcustomerViewRow::firstname, Optional.empty(), Optional.empty(), { row, value -> row.copy(firstname = value) }, /* user-picked */ FirstName.pgType)
