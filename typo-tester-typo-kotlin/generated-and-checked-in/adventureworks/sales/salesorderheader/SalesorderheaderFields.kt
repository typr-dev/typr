  ...
  companion object {
    private class Impl(path: List<Path>) : Relation<SalesorderheaderFields, SalesorderheaderRow>(path) {
      override fun fields(): SalesorderheaderFields = object : SalesorderheaderFields {
        ...
        override fun creditcardid(): OptField</* user-picked */ CustomCreditcardId, SalesorderheaderRow> = OptField</* user-picked */ CustomCreditcardId, SalesorderheaderRow>(_path, "creditcardid", SalesorderheaderRow::creditcardid, Optional.empty(), Optional.of("int4"), { row, value -> row.copy(creditcardid = value) }, /* user-picked */ CustomCreditcardId.pgType)
