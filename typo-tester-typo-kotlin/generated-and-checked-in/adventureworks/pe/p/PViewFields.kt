  ...
  companion object {
    private class Impl(path: List<Path>) : Relation<PViewFields, PViewRow>(path) {
      override fun fields(): PViewFields = object : PViewFields {
        ...
        override fun persontype(): Field</* bpchar, max 2 chars */ String, PViewRow> = Field</* bpchar, max 2 chars */ String, PViewRow>(_path, "persontype", PViewRow::persontype, Optional.empty(), Optional.empty(), { row, value -> row.copy(persontype = value) }, PgTypes.text)
        ...
        override fun firstname(): Field</* user-picked */ FirstName, PViewRow> = Field</* user-picked */ FirstName, PViewRow>(_path, "firstname", PViewRow::firstname, Optional.empty(), Optional.empty(), { row, value -> row.copy(firstname = value) }, /* user-picked */ FirstName.pgType)
