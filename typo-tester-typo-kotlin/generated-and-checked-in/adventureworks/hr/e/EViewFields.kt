  ...
  companion object {
    private class Impl(path: List<Path>) : Relation<EViewFields, EViewRow>(path) {
      override fun fields(): EViewFields = object : EViewFields {
        ...
        override fun maritalstatus(): Field</* bpchar, max 1 chars */ String, EViewRow> = Field</* bpchar, max 1 chars */ String, EViewRow>(_path, "maritalstatus", EViewRow::maritalstatus, Optional.empty(), Optional.empty(), { row, value -> row.copy(maritalstatus = value) }, PgTypes.text)
        override fun gender(): Field</* bpchar, max 1 chars */ String, EViewRow> = Field</* bpchar, max 1 chars */ String, EViewRow>(_path, "gender", EViewRow::gender, Optional.empty(), Optional.empty(), { row, value -> row.copy(gender = value) }, PgTypes.text)
