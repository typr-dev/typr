  ...
  companion object {
    private class Impl(path: List<Path>) : Relation<PgtestnullFields, PgtestnullRow>(path) {
      override fun fields(): PgtestnullFields = object : PgtestnullFields {
        ...
        override fun bpchar(): OptField</* bpchar, max 3 chars */ String, PgtestnullRow> = OptField</* bpchar, max 3 chars */ String, PgtestnullRow>(_path, "bpchar", PgtestnullRow::bpchar, Optional.empty(), Optional.of("bpchar"), { row, value -> row.copy(bpchar = value) }, PgTypes.text)
        ...
        override fun char(): OptField</* bpchar, max 1 chars */ String, PgtestnullRow> = OptField</* bpchar, max 1 chars */ String, PgtestnullRow>(_path, "char", PgtestnullRow::char, Optional.empty(), Optional.of("bpchar"), { row, value -> row.copy(char = value) }, PgTypes.text)
        ...
        override fun name(): OptField<String, PgtestnullRow> = OptField<String, PgtestnullRow>(_path, "name", PgtestnullRow::name, Optional.empty(), Optional.of("name"), { row, value -> row.copy(name = value) }, PgTypes.text)
        ...
        override fun bpchares(): OptField<Array</* bpchar */ String>, PgtestnullRow> = OptField<Array</* bpchar */ String>, PgtestnullRow>(_path, "bpchares", PgtestnullRow::bpchares, Optional.empty(), Optional.of("bpchar[]"), { row, value -> row.copy(bpchares = value) }, PgTypes.textArray)
        override fun chares(): OptField<Array</* bpchar */ String>, PgtestnullRow> = OptField<Array</* bpchar */ String>, PgtestnullRow>(_path, "chares", PgtestnullRow::chares, Optional.empty(), Optional.of("bpchar[]"), { row, value -> row.copy(chares = value) }, PgTypes.textArray)
        ...
        override fun namees(): OptField<Array<String>, PgtestnullRow> = OptField<Array<String>, PgtestnullRow>(_path, "namees", PgtestnullRow::namees, Optional.empty(), Optional.of("name[]"), { row, value -> row.copy(namees = value) }, PgTypes.textArray)
