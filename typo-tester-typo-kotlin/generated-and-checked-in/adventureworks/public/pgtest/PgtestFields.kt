  ...
  companion object {
    private class Impl(path: List<Path>) : Relation<PgtestFields, PgtestRow>(path) {
      override fun fields(): PgtestFields = object : PgtestFields {
        ...
        override fun bpchar(): Field</* bpchar, max 3 chars */ String, PgtestRow> = Field</* bpchar, max 3 chars */ String, PgtestRow>(_path, "bpchar", PgtestRow::bpchar, Optional.empty(), Optional.of("bpchar"), { row, value -> row.copy(bpchar = value) }, PgTypes.text)
        ...
        override fun char(): Field</* bpchar, max 1 chars */ String, PgtestRow> = Field</* bpchar, max 1 chars */ String, PgtestRow>(_path, "char", PgtestRow::char, Optional.empty(), Optional.of("bpchar"), { row, value -> row.copy(char = value) }, PgTypes.text)
        ...
        override fun name(): Field<String, PgtestRow> = Field<String, PgtestRow>(_path, "name", PgtestRow::name, Optional.empty(), Optional.of("name"), { row, value -> row.copy(name = value) }, PgTypes.text)
        ...
        override fun bpchares(): Field<Array</* bpchar */ String>, PgtestRow> = Field<Array</* bpchar */ String>, PgtestRow>(_path, "bpchares", PgtestRow::bpchares, Optional.empty(), Optional.of("bpchar[]"), { row, value -> row.copy(bpchares = value) }, PgTypes.textArray)
        override fun chares(): Field<Array</* bpchar */ String>, PgtestRow> = Field<Array</* bpchar */ String>, PgtestRow>(_path, "chares", PgtestRow::chares, Optional.empty(), Optional.of("bpchar[]"), { row, value -> row.copy(chares = value) }, PgTypes.textArray)
        ...
        override fun namees(): Field<Array<String>, PgtestRow> = Field<Array<String>, PgtestRow>(_path, "namees", PgtestRow::namees, Optional.empty(), Optional.of("name[]"), { row, value -> row.copy(namees = value) }, PgTypes.textArray)
