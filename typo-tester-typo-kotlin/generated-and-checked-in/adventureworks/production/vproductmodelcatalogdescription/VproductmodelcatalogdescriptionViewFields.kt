...
interface VproductmodelcatalogdescriptionViewFields {
  ...
  companion object {
    private class Impl(path: List<Path>) : Relation<VproductmodelcatalogdescriptionViewFields, VproductmodelcatalogdescriptionViewRow>(path) {
      override fun fields(): VproductmodelcatalogdescriptionViewFields = object : VproductmodelcatalogdescriptionViewFields {
