  ...
  companion object {
    private class Impl(path: List<Path>) : Relation<ProductFields, ProductRow>(path) {
      override fun fields(): ProductFields = object : ProductFields {
        ...
        override fun productline(): OptField</* bpchar, max 2 chars */ String, ProductRow> = OptField</* bpchar, max 2 chars */ String, ProductRow>(_path, "productline", ProductRow::productline, Optional.empty(), Optional.of("bpchar"), { row, value -> row.copy(productline = value) }, PgTypes.text)
        override fun `class`(): OptField</* bpchar, max 2 chars */ String, ProductRow> = OptField</* bpchar, max 2 chars */ String, ProductRow>(_path, "class", ProductRow::`class`, Optional.empty(), Optional.of("bpchar"), { row, value -> row.copy(`class` = value) }, PgTypes.text)
        override fun style(): OptField</* bpchar, max 2 chars */ String, ProductRow> = OptField</* bpchar, max 2 chars */ String, ProductRow>(_path, "style", ProductRow::style, Optional.empty(), Optional.of("bpchar"), { row, value -> row.copy(style = value) }, PgTypes.text)
