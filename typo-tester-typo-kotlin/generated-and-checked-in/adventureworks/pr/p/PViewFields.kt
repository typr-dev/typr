  ...
  companion object {
    private class Impl(path: List<Path>) : Relation<PViewFields, PViewRow>(path) {
      override fun fields(): PViewFields = object : PViewFields {
        ...
        override fun productline(): OptField</* bpchar, max 2 chars */ String, PViewRow> = OptField</* bpchar, max 2 chars */ String, PViewRow>(_path, "productline", PViewRow::productline, Optional.empty(), Optional.empty(), { row, value -> row.copy(productline = value) }, PgTypes.text)
        override fun `class`(): OptField</* bpchar, max 2 chars */ String, PViewRow> = OptField</* bpchar, max 2 chars */ String, PViewRow>(_path, "class", PViewRow::`class`, Optional.empty(), Optional.empty(), { row, value -> row.copy(`class` = value) }, PgTypes.text)
        override fun style(): OptField</* bpchar, max 2 chars */ String, PViewRow> = OptField</* bpchar, max 2 chars */ String, PViewRow>(_path, "style", PViewRow::style, Optional.empty(), Optional.empty(), { row, value -> row.copy(style = value) }, PgTypes.text)
