  ...
  companion object {
    private class Impl(path: List<Path>) : Relation<ThaViewFields, ThaViewRow>(path) {
      override fun fields(): ThaViewFields = object : ThaViewFields {
        ...
        override fun transactiontype(): Field</* bpchar, max 1 chars */ String, ThaViewRow> = Field</* bpchar, max 1 chars */ String, ThaViewRow>(_path, "transactiontype", ThaViewRow::transactiontype, Optional.empty(), Optional.empty(), { row, value -> row.copy(transactiontype = value) }, PgTypes.text)
