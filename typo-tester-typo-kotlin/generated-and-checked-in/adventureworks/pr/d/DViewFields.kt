  ...
  companion object {
    private class Impl(path: List<Path>) : Relation<DViewFields, DViewRow>(path) {
      override fun fields(): DViewFields = object : DViewFields {
        ...
        override fun revision(): Field</* bpchar, max 5 chars */ String, DViewRow> = Field</* bpchar, max 5 chars */ String, DViewRow>(_path, "revision", DViewRow::revision, Optional.empty(), Optional.empty(), { row, value -> row.copy(revision = value) }, PgTypes.text)
