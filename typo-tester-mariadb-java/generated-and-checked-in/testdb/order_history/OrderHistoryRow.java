...
public record OrderHistoryRow(
  ...
  static RowParser<OrderHistoryRow> _rowParser = RowParsers.of(OrderHistoryId.pgType, OrdersId.pgType, MariaTypes.text.opt(), MariaTypes.text, MariaTypes.varchar.opt(), MariaTypes.varchar.opt(), MariaTypes.longtext.opt(), MariaTypes.datetime, OrderHistoryRow::new, row -> new Object[]{row.historyId(), row.orderId(), row.previousStatus(), row.newStatus(), row.changedBy(), row.changeReason(), row.metadata(), row.createdAt()});;

  static public MariaText<OrderHistoryRow> mariaText =
