...
public record ReviewsRow(
  ...
  static RowParser<ReviewsRow> _rowParser = RowParsers.of(ReviewsId.pgType, ProductsId.pgType, CustomersId.pgType, OrderItemsId.pgType.opt(), MariaTypes.tinyintUnsigned, MariaTypes.varchar.opt(), MariaTypes.text.opt(), MariaTypes.longtext.opt(), MariaTypes.longtext.opt(), MariaTypes.longtext.opt(), MariaTypes.bool, MariaTypes.bool, MariaTypes.intUnsigned, MariaTypes.intUnsigned, MariaTypes.text.opt(), MariaTypes.datetime.opt(), MariaTypes.datetime, MariaTypes.datetime, ReviewsRow::new, row -> new Object[]{row.reviewId(), row.productId(), row.customerId(), row.orderItemId(), row.rating(), row.title(), row.content(), row.pros(), row.cons(), row.images(), row.isVerifiedPurchase(), row.isApproved(), row.helpfulVotes(), row.unhelpfulVotes(), row.adminResponse(), row.respondedAt(), row.createdAt(), row.updatedAt()});;

  static public MariaText<ReviewsRow> mariaText =
