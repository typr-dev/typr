...
public record ProductImagesRow(
  ...
  static RowParser<ProductImagesRow> _rowParser = RowParsers.of(ProductImagesId.pgType, ProductsId.pgType, MariaTypes.varchar, MariaTypes.varchar.opt(), MariaTypes.varchar.opt(), MariaTypes.tinyintUnsigned, MariaTypes.bool, MariaTypes.longblob.opt(), ProductImagesRow::new, row -> new Object[]{row.imageId(), row.productId(), row.imageUrl(), row.thumbnailUrl(), row.altText(), row.sortOrder(), row.isPrimary(), row.imageData()});;

  static public MariaText<ProductImagesRow> mariaText =
