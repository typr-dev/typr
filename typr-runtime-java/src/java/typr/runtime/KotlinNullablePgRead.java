...
/**
 * A PgRead implementation that reads nullable values as Kotlin nulls instead of Optional. This
 ...
 */
public final class KotlinNullablePgRead<A> implements PgRead<A>, DbRead.Nullable {
  private final PgRead<Optional<A>> underlyingReader;

  public KotlinNullablePgRead(PgRead<Optional<A>> underlyingReader) {
  ...
  @Override
  public <B> PgRead<B> map(SqlFunction<A, B> f) {
    // Map the nullable value to a new type
    // The result is also nullable
    return new KotlinNullablePgRead<>(
