...
public record SalesterritoryRepoMock(
  ...
  public SalesterritoryRepoMock(
      java.util.function.Function<SalesterritoryRowUnsaved, SalesterritoryRow> toRow) {
    this(toRow, new HashMap<SalesterritoryId, SalesterritoryRow>());
  }
  ;

  public SalesterritoryRepoMock withToRow(
      java.util.function.Function<SalesterritoryRowUnsaved, SalesterritoryRow> toRow) {
  ...
  public Map<SalesterritoryId, SalesterritoryRow> selectByIdsTracked(
    ...
    return selectByIds(territoryids, c).stream()
        .collect(
            Collectors.toMap((SalesterritoryRow row) -> row.territoryid(), Function.identity()));
  }
  ;
  ...
  public Boolean update(SalesterritoryRow row, Connection c) {
    var shouldUpdate =
        Optional.ofNullable(map.get(row.territoryid()))
