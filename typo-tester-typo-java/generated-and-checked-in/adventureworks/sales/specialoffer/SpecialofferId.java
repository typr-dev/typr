...
public record SpecialofferId(@JsonValue Integer value) {
  ...
  static public PgType<SpecialofferId> pgType =
    PgTypes.int4.bimap(SpecialofferId::new, SpecialofferId::value);

  static public PgType<SpecialofferId[]> pgTypeArray =
    PgTypes.int4Array.bimap(xs -> arrayMap.map(xs, SpecialofferId::new, SpecialofferId.class), xs -> arrayMap.map(xs, SpecialofferId::value, Integer.class));
}