...
public record SpecialofferRepoMock(
  ...
  public SpecialofferRepoMock(java.util.function.Function<SpecialofferRowUnsaved, SpecialofferRow> toRow) {
    this(toRow, new HashMap<SpecialofferId, SpecialofferRow>());
  };

  public SpecialofferRepoMock withToRow(java.util.function.Function<SpecialofferRowUnsaved, SpecialofferRow> toRow) {
