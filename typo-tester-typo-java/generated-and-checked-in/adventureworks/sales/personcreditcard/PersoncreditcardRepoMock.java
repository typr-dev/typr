...
public record PersoncreditcardRepoMock(
  ...
  public PersoncreditcardRepoMock(java.util.function.Function<PersoncreditcardRowUnsaved, PersoncreditcardRow> toRow) {
    this(toRow, new HashMap<PersoncreditcardId, PersoncreditcardRow>());
  };

  public PersoncreditcardRepoMock withToRow(java.util.function.Function<PersoncreditcardRowUnsaved, PersoncreditcardRow> toRow) {
  ...
  public DeleteBuilder<PersoncreditcardFields, PersoncreditcardRow> delete() {
    return new DeleteBuilderMock<>(PersoncreditcardFields.structure(), () -> new ArrayList<>(map.values()), DeleteParams.empty(), row -> row.compositeId(), id -> map.remove(id));
  };
  ...
  public SelectBuilder<PersoncreditcardFields, PersoncreditcardRow> select() {
    return new SelectBuilderMock<>(PersoncreditcardFields.structure(), () -> new ArrayList<>(map.values()), SelectParams.empty());
  };
  ...
  public Map<PersoncreditcardId, PersoncreditcardRow> selectByIdsTracked(
    ...
    return selectByIds(compositeIds, c).stream().collect(Collectors.toMap((PersoncreditcardRow row) -> row.compositeId(), Function.identity()));
  };

  @Override
  public UpdateBuilder<PersoncreditcardFields, PersoncreditcardRow> update() {
    return new UpdateBuilderMock<>(PersoncreditcardFields.structure(), () -> new ArrayList<>(map.values()), UpdateParams.empty(), row -> row);
  };
