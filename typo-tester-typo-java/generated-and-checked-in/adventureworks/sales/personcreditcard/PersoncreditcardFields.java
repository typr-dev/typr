...
public interface PersoncreditcardFields extends FieldsExpr<PersoncreditcardRow> {
  record Impl(List<Path> _path) implements PersoncreditcardFields, RelationStructure<PersoncreditcardFields, PersoncreditcardRow> {
    @Override
    ...
    public Field<LocalDateTime, PersoncreditcardRow> modifieddate() {
      return new Field<LocalDateTime, PersoncreditcardRow>(_path, "modifieddate", PersoncreditcardRow::modifieddate, Optional.empty(), Optional.of("timestamp"), (row, value) -> row.withModifieddate(value), PgTypes.timestamp);
    };
    ...
    @Override
    public RelationStructure<PersoncreditcardFields, PersoncreditcardRow> withPaths(List<Path> _path) {
  ...
  default ForeignKey<CreditcardFields, CreditcardRow> fkCreditcard() {
    return ForeignKey.<CreditcardFields, CreditcardRow>of("sales.FK_PersonCreditCard_CreditCard_CreditCardID").</* user-picked */ CustomCreditcardId>withColumnPair(creditcardid(), CreditcardFields::creditcardid);
  };

  default ForeignKey<PersonFields, PersonRow> fkPersonPerson() {
    return ForeignKey.<PersonFields, PersonRow>of("sales.FK_PersonCreditCard_Person_BusinessEntityID").<BusinessentityId>withColumnPair(businessentityid(), PersonFields::businessentityid);
  };
