...
public record SalesorderheadersalesreasonRepoMock(
  ...
  public SalesorderheadersalesreasonRepoMock withToRow(
      java.util.function.Function<
              SalesorderheadersalesreasonRowUnsaved, SalesorderheadersalesreasonRow>
          toRow) {
  ...
  public SalesorderheadersalesreasonRepoMock withMap(
      HashMap<SalesorderheadersalesreasonId, SalesorderheadersalesreasonRow> map) {
    return new SalesorderheadersalesreasonRepoMock(toRow, map);
  }
  ;
  ...
  public Map<SalesorderheadersalesreasonId, SalesorderheadersalesreasonRow> selectByIdsTracked(
    ...
    return selectByIds(compositeIds, c).stream()
        .collect(
            Collectors.toMap(
                (SalesorderheadersalesreasonRow row) -> row.compositeId(), Function.identity()));
  }
  ;
