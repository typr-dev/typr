...
public record SalesreasonRepoMock(
  ...
  public SalesreasonRepoMock(java.util.function.Function<SalesreasonRowUnsaved, SalesreasonRow> toRow) {
    this(toRow, new HashMap<SalesreasonId, SalesreasonRow>());
  };

  public SalesreasonRepoMock withToRow(java.util.function.Function<SalesreasonRowUnsaved, SalesreasonRow> toRow) {
