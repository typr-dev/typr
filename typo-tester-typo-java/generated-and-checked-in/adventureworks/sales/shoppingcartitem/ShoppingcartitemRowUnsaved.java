...
public record ShoppingcartitemRowUnsaved(
  ...
  public ShoppingcartitemRowUnsaved(
    ...
    this(shoppingcartid, productid, new UseDefault<>(), new UseDefault<>(), new UseDefault<>(), new UseDefault<>());
  };
  ...
  /** Default: nextval('sales.shoppingcartitem_shoppingcartitemid_seq'::regclass)
    * Primary key for ShoppingCartItem records.
    */
  public ShoppingcartitemRowUnsaved withShoppingcartitemid(Defaulted<ShoppingcartitemId> shoppingcartitemid) {
    return new ShoppingcartitemRowUnsaved(shoppingcartid, productid, shoppingcartitemid, quantity, datecreated, modifieddate);
  };
  ...
  static public PgText<ShoppingcartitemRowUnsaved> pgText =
