...
public record SalesorderheaderRowUnsaved(
  ...
  public SalesorderheaderRowUnsaved(
    ...
    this(duedate, Optional.empty(), Optional.empty(), Optional.empty(), customerid, Optional.empty(), Optional.empty(), billtoaddressid, shiptoaddressid, shipmethodid, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), new UseDefault<>(), new UseDefault<>(), new UseDefault<>(), new UseDefault<>(), new UseDefault<>(), new UseDefault<>(), new UseDefault<>(), new UseDefault<>(), new UseDefault<>(), new UseDefault<>());
  };
  ...
  /** Customer purchase order number reference. */
  public SalesorderheaderRowUnsaved withPurchaseordernumber(Optional<OrderNumber> purchaseordernumber) {
    return new SalesorderheaderRowUnsaved(duedate, shipdate, purchaseordernumber, accountnumber, customerid, salespersonid, territoryid, billtoaddressid, shiptoaddressid, shipmethodid, creditcardid, creditcardapprovalcode, currencyrateid, totaldue, comment, salesorderid, revisionnumber, orderdate, status, onlineorderflag, subtotal, taxamt, freight, rowguid, modifieddate);
  };
  ...
  /** Credit card identification number. Foreign key to CreditCard.CreditCardID.
    * Points to {@link adventureworks.sales.creditcard.CreditcardRow#creditcardid()}
    */
  public SalesorderheaderRowUnsaved withCreditcardid(Optional</* user-picked */ CustomCreditcardId> creditcardid) {
    return new SalesorderheaderRowUnsaved(duedate, shipdate, purchaseordernumber, accountnumber, customerid, salespersonid, territoryid, billtoaddressid, shiptoaddressid, shipmethodid, creditcardid, creditcardapprovalcode, currencyrateid, totaldue, comment, salesorderid, revisionnumber, orderdate, status, onlineorderflag, subtotal, taxamt, freight, rowguid, modifieddate);
  };

  /** Approval code provided by the credit card company. */
  public SalesorderheaderRowUnsaved withCreditcardapprovalcode(Optional</* max 15 chars */ String> creditcardapprovalcode) {
    return new SalesorderheaderRowUnsaved(duedate, shipdate, purchaseordernumber, accountnumber, customerid, salespersonid, territoryid, billtoaddressid, shiptoaddressid, shipmethodid, creditcardid, creditcardapprovalcode, currencyrateid, totaldue, comment, salesorderid, revisionnumber, orderdate, status, onlineorderflag, subtotal, taxamt, freight, rowguid, modifieddate);
  };
