...
public record SalesorderheaderRepoMock(
  ...
  public SalesorderheaderRepoMock(
      java.util.function.Function<SalesorderheaderRowUnsaved, SalesorderheaderRow> toRow) {
    this(toRow, new HashMap<SalesorderheaderId, SalesorderheaderRow>());
  }
  ;

  public SalesorderheaderRepoMock withToRow(
      java.util.function.Function<SalesorderheaderRowUnsaved, SalesorderheaderRow> toRow) {
  ...
  public Map<SalesorderheaderId, SalesorderheaderRow> selectByIdsTracked(
    ...
    return selectByIds(salesorderids, c).stream()
        .collect(
            Collectors.toMap((SalesorderheaderRow row) -> row.salesorderid(), Function.identity()));
  }
  ;
  ...
  public Boolean update(SalesorderheaderRow row, Connection c) {
    var shouldUpdate =
        Optional.ofNullable(map.get(row.salesorderid()))
