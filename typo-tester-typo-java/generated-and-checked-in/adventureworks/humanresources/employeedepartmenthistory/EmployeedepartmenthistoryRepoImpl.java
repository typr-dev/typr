...
public class EmployeedepartmenthistoryRepoImpl implements EmployeedepartmenthistoryRepo {
  ...
  public Integer deleteByIds(EmployeedepartmenthistoryId[] compositeIds, Connection c) {
    BusinessentityId[] businessentityid =
        arrayMap.map(
            compositeIds, EmployeedepartmenthistoryId::businessentityid, BusinessentityId.class);
    ;
    LocalDate[] startdate =
        arrayMap.map(compositeIds, EmployeedepartmenthistoryId::startdate, LocalDate.class);
    ;
    DepartmentId[] departmentid =
        arrayMap.map(compositeIds, EmployeedepartmenthistoryId::departmentid, DepartmentId.class);
    ;
    ShiftId[] shiftid =
        arrayMap.map(compositeIds, EmployeedepartmenthistoryId::shiftid, ShiftId.class);
    ;
    return interpolate(
            Fragment.lit(
                "delete\n"
  ...
  public EmployeedepartmenthistoryRow insert(EmployeedepartmenthistoryRow unsaved, Connection c) {
    return interpolate(
            ...
            Fragment.lit("::date, "),
            Fragment.encode(PgTypes.date.opt(), unsaved.enddate()),
            Fragment.lit("::date, "),
  ...
  public EmployeedepartmenthistoryRow insert(
      EmployeedepartmenthistoryRowUnsaved unsaved, Connection c) {
    ...
    values.add(
        interpolate(
            Fragment.encode(PgTypes.date.opt(), unsaved.enddate()), Fragment.lit("::date")));
    unsaved
        .modifieddate()
        .visit(
            () -> {},
    ...
    Fragment q =
        interpolate(
            Fragment.lit("insert into \"humanresources\".\"employeedepartmenthistory\"("),
  ...
  public Long insertStreaming(
      Iterator<EmployeedepartmenthistoryRow> unsaved, Integer batchSize, Connection c) {
    return streamingInsert.insertUnchecked(
        "COPY \"humanresources\".\"employeedepartmenthistory\"(\"businessentityid\","
            + " \"departmentid\", \"shiftid\", \"startdate\", \"enddate\", \"modifieddate\") FROM"
            + " STDIN",
        batchSize,
        unsaved,
        c,
  ...
  public Long insertUnsavedStreaming(
      Iterator<EmployeedepartmenthistoryRowUnsaved> unsaved, Integer batchSize, Connection c) {
    return streamingInsert.insertUnchecked(
        "COPY \"humanresources\".\"employeedepartmenthistory\"(\"businessentityid\","
            + " \"departmentid\", \"shiftid\", \"startdate\", \"enddate\", \"modifieddate\") FROM"
  ...
  public Optional<EmployeedepartmenthistoryRow> selectById(
      EmployeedepartmenthistoryId compositeId, Connection c) {
    return interpolate(
            Fragment.lit(
                "select \"businessentityid\", \"departmentid\", \"shiftid\", \"startdate\","
                    + " \"enddate\", \"modifieddate\"\n"
  ...
  public List<EmployeedepartmenthistoryRow> selectByIds(
      EmployeedepartmenthistoryId[] compositeIds, Connection c) {
    BusinessentityId[] businessentityid =
        arrayMap.map(
            compositeIds, EmployeedepartmenthistoryId::businessentityid, BusinessentityId.class);
    ;
  ...
  public Map<EmployeedepartmenthistoryId, EmployeedepartmenthistoryRow> selectByIdsTracked(
      EmployeedepartmenthistoryId[] compositeIds, Connection c) {
    HashMap<EmployeedepartmenthistoryId, EmployeedepartmenthistoryRow> ret =
        new HashMap<EmployeedepartmenthistoryId, EmployeedepartmenthistoryRow>();
  ...
  public Boolean update(EmployeedepartmenthistoryRow row, Connection c) {
    ...
    return interpolate(
                ...
                Fragment.encode(PgTypes.date.opt(), row.enddate()),
                Fragment.lit("::date,\n\"modifieddate\" = "),
  ...
  public EmployeedepartmenthistoryRow upsert(EmployeedepartmenthistoryRow unsaved, Connection c) {
    return interpolate(
            ...
            Fragment.lit(
                "::timestamp)\n"
                    + "on conflict (\"businessentityid\", \"startdate\", \"departmentid\","
                    + " \"shiftid\")\n"
                    + "do update set\n"
  ...
  public List<EmployeedepartmenthistoryRow> upsertBatch(
      Iterator<EmployeedepartmenthistoryRow> unsaved, Connection c) {
    return interpolate(
            Fragment.lit(
                "insert into \"humanresources\".\"employeedepartmenthistory\"(\"businessentityid\","
                    + " \"departmentid\", \"shiftid\", \"startdate\", \"enddate\","
  ...
  public Integer upsertStreaming(
    ...
    interpolate(
            Fragment.lit(
                "create temporary table employeedepartmenthistory_TEMP (like"
                    + " \"humanresources\".\"employeedepartmenthistory\") on commit drop"))
        .update()
        .runUnchecked(c);
    streamingInsert.insertUnchecked(
        "copy employeedepartmenthistory_TEMP(\"businessentityid\", \"departmentid\", \"shiftid\","
            + " \"startdate\", \"enddate\", \"modifieddate\") from stdin",
        batchSize,
        unsaved,
        c,
        EmployeedepartmenthistoryRow.pgText);
    return interpolate(
            Fragment.lit(
                "insert into \"humanresources\".\"employeedepartmenthistory\"(\"businessentityid\","
                    ...
                    + "\"modifieddate\" = EXCLUDED.\"modifieddate\"\n"
                    + ";\n"
                    + "drop table employeedepartmenthistory_TEMP;"))
        .update()
        .runUnchecked(c);
  }
  ;
