...
public record EmployeedepartmenthistoryRepoMock(
    java.util.function.Function<EmployeedepartmenthistoryRowUnsaved, EmployeedepartmenthistoryRow>
        toRow,
    HashMap<EmployeedepartmenthistoryId, EmployeedepartmenthistoryRow> map)
    implements EmployeedepartmenthistoryRepo {
  public EmployeedepartmenthistoryRepoMock(
      java.util.function.Function<EmployeedepartmenthistoryRowUnsaved, EmployeedepartmenthistoryRow>
          toRow) {
  ...
  public EmployeedepartmenthistoryRepoMock withToRow(
      java.util.function.Function<EmployeedepartmenthistoryRowUnsaved, EmployeedepartmenthistoryRow>
          toRow) {
  ...
  public EmployeedepartmenthistoryRepoMock withMap(
      HashMap<EmployeedepartmenthistoryId, EmployeedepartmenthistoryRow> map) {
    return new EmployeedepartmenthistoryRepoMock(toRow, map);
  }
  ;
  ...
  public Map<EmployeedepartmenthistoryId, EmployeedepartmenthistoryRow> selectByIdsTracked(
    ...
    return selectByIds(compositeIds, c).stream()
        .collect(
            Collectors.toMap(
                (EmployeedepartmenthistoryRow row) -> row.compositeId(), Function.identity()));
  }
  ;
