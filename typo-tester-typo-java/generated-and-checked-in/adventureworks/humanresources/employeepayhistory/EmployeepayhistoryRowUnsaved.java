...
/**
 * This class corresponds to a row in table `humanresources.employeepayhistory` which has not been
 * persisted yet
 */
public record EmployeepayhistoryRowUnsaved(
  ...
  public static PgText<EmployeepayhistoryRowUnsaved> pgText =
      PgText.instance(
          (row, sb) -> {
  ...
  public EmployeepayhistoryRow toRow(
