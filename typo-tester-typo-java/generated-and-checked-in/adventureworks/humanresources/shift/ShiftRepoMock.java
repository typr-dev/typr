...
public record ShiftRepoMock(
    java.util.function.Function<ShiftRowUnsaved, ShiftRow> toRow, HashMap<ShiftId, ShiftRow> map)
  ...
  public Map<ShiftId, ShiftRow> selectByIdsTracked(ShiftId[] shiftids, Connection c) {
    return selectByIds(shiftids, c).stream()
        .collect(Collectors.toMap((ShiftRow row) -> row.shiftid(), Function.identity()));
  }
  ;
  ...
  public Boolean update(ShiftRow row, Connection c) {
    var shouldUpdate =
        Optional.ofNullable(map.get(row.shiftid()))
