...
public record ProductlistpricehistoryRepoMock(
  java.util.function.Function<ProductlistpricehistoryRowUnsaved, ProductlistpricehistoryRow> toRow,
  HashMap<ProductlistpricehistoryId, ProductlistpricehistoryRow> map
) implements ProductlistpricehistoryRepo {
  public ProductlistpricehistoryRepoMock(java.util.function.Function<ProductlistpricehistoryRowUnsaved, ProductlistpricehistoryRow> toRow) {
    this(toRow, new HashMap<ProductlistpricehistoryId, ProductlistpricehistoryRow>());
  };

  public ProductlistpricehistoryRepoMock withToRow(java.util.function.Function<ProductlistpricehistoryRowUnsaved, ProductlistpricehistoryRow> toRow) {
    return new ProductlistpricehistoryRepoMock(toRow, map);
  };

  public ProductlistpricehistoryRepoMock withMap(HashMap<ProductlistpricehistoryId, ProductlistpricehistoryRow> map) {
    return new ProductlistpricehistoryRepoMock(toRow, map);
  };
