...
public class TransactionhistoryarchiveRepoImpl implements TransactionhistoryarchiveRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"production\".\"transactionhistoryarchive\" where \"transactionid\" = "), Fragment.encode(TransactionhistoryarchiveId.pgType, transactionid), Fragment.lit("")).update().runUnchecked(c) > 0;
  };
  ...
  public TransactionhistoryarchiveRow insert(
    ...
    values.add(interpolate(Fragment.encode(TransactionhistoryarchiveId.pgType, unsaved.transactionid()), Fragment.lit("::int4")));
    ...
    Fragment q = interpolate(Fragment.lit("insert into \"production\".\"transactionhistoryarchive\"("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nreturning \"transactionid\", \"productid\", \"referenceorderid\", \"referenceorderlineid\", \"transactiondate\", \"transactiontype\", \"quantity\", \"actualcost\", \"modifieddate\"\n"));;
  ...
  public Long insertStreaming(
    ...
    return streamingInsert.insertUnchecked("COPY \"production\".\"transactionhistoryarchive\"(\"transactionid\", \"productid\", \"referenceorderid\", \"referenceorderlineid\", \"transactiondate\", \"transactiontype\", \"quantity\", \"actualcost\", \"modifieddate\") FROM STDIN", batchSize, unsaved, c, TransactionhistoryarchiveRow.pgText);
  };
  ...
  public UpdateBuilder<TransactionhistoryarchiveFields, TransactionhistoryarchiveRow> update() {
    return UpdateBuilder.of("\"production\".\"transactionhistoryarchive\"", TransactionhistoryarchiveFields.structure(), TransactionhistoryarchiveRow._rowParser, Dialect.POSTGRESQL);
  };
  ...
  public Integer upsertStreaming(
    ...
    interpolate(Fragment.lit("create temporary table transactionhistoryarchive_TEMP (like \"production\".\"transactionhistoryarchive\") on commit drop")).update().runUnchecked(c);
