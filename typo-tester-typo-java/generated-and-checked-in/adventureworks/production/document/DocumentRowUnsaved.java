...
public record DocumentRowUnsaved(
    ...
    /** Default: false 0 = This is a folder, 1 = This is a document. */
    Defaulted<Flag> folderflag,
    /** Default: 0 Engineering change approval number. */
    Defaulted<Integer> changenumber,
    /**
     * Default: uuid_generate_v1() ROWGUIDCOL number uniquely identifying the record. Required for
     * FileStream.
     */
    Defaulted<UUID> rowguid,
    /** Default: now() */
    Defaulted<LocalDateTime> modifieddate,
    /** Default: '/'::character varying Primary key for Document records. */
    Defaulted<DocumentId> documentnode) {
  public DocumentRowUnsaved(
      /** Title of the document. */
      String title,
      /**
       * Employee who controls the document. Foreign key to Employee.BusinessEntityID Points to
  ...
  public static PgText<DocumentRowUnsaved> pgText =
      PgText.instance(
          (row, sb) -> {
  ...
  public DocumentRow toRow(
    ...
    return new DocumentRow(
        title,
        owner,
        folderflag.getOrElse(folderflagDefault),
        filename,
        fileextension,
        revision,
        changenumber.getOrElse(changenumberDefault),
        status,
        documentsummary,
        document,
