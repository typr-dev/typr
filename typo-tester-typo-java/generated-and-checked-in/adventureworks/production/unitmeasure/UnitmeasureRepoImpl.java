...
public class UnitmeasureRepoImpl implements UnitmeasureRepo {
  ...
  public UnitmeasureRow insert(UnitmeasureRowUnsaved unsaved, Connection c) {
    ...
    Fragment q =
        interpolate(
            Fragment.lit("insert into \"production\".\"unitmeasure\"("),
  ...
  public Long insertStreaming(Iterator<UnitmeasureRow> unsaved, Integer batchSize, Connection c) {
    return streamingInsert.insertUnchecked(
        "COPY \"production\".\"unitmeasure\"(\"unitmeasurecode\", \"name\", \"modifieddate\") FROM"
            + " STDIN",
        batchSize,
        unsaved,
        c,
  ...
  public Integer upsertStreaming(
    ...
    interpolate(
            Fragment.lit(
                "create temporary table unitmeasure_TEMP (like \"production\".\"unitmeasure\") on"
                    + " commit drop"))
        .update()
        .runUnchecked(c);
