...
public interface TransactionhistoryFields extends FieldsExpr<TransactionhistoryRow> {
  record Impl(List<Path> _path) implements TransactionhistoryFields, RelationStructure<TransactionhistoryFields, TransactionhistoryRow> {
    @Override
    ...
    public Field<LocalDateTime, TransactionhistoryRow> transactiondate() {
      return new Field<LocalDateTime, TransactionhistoryRow>(_path, "transactiondate", TransactionhistoryRow::transactiondate, Optional.empty(), Optional.of("timestamp"), (row, value) -> row.withTransactiondate(value), PgTypes.timestamp);
    };

    @Override
    public Field<String, TransactionhistoryRow> transactiontype() {
      return new Field<String, TransactionhistoryRow>(_path, "transactiontype", TransactionhistoryRow::transactiontype, Optional.empty(), Optional.of("bpchar"), (row, value) -> row.withTransactiontype(value), PgTypes.bpchar);
    };
    ...
    public Field<LocalDateTime, TransactionhistoryRow> modifieddate() {
      return new Field<LocalDateTime, TransactionhistoryRow>(_path, "modifieddate", TransactionhistoryRow::modifieddate, Optional.empty(), Optional.of("timestamp"), (row, value) -> row.withModifieddate(value), PgTypes.timestamp);
    };
    ...
    @Override
    public RelationStructure<TransactionhistoryFields, TransactionhistoryRow> withPaths(List<Path> _path) {
  ...
  default ForeignKey<ProductFields, ProductRow> fkProduct() {
    return ForeignKey.<ProductFields, ProductRow>of("production.FK_TransactionHistory_Product_ProductID").<ProductId>withColumnPair(productid(), ProductFields::productid);
  };
