...
/**
 * This class corresponds to a row in table `production.transactionhistory` which has not been
 * persisted yet
 */
public record TransactionhistoryRowUnsaved(
    ...
    /**
     * Default: nextval('production.transactionhistory_transactionid_seq'::regclass) Primary key for
   ...
   * TransactionHistory records.
   */
  public TransactionhistoryRowUnsaved withTransactionid(
      Defaulted<TransactionhistoryId> transactionid) {
    return new TransactionhistoryRowUnsaved(
        productid,
        referenceorderid,
  ...
  /** Default: 0 Line number associated with the purchase order, sales order, or work order. */
  public TransactionhistoryRowUnsaved withReferenceorderlineid(
      Defaulted<Integer> referenceorderlineid) {
    return new TransactionhistoryRowUnsaved(
        productid,
        referenceorderid,
  ...
  /** Default: now() Date and time of the transaction. */
  public TransactionhistoryRowUnsaved withTransactiondate(
      Defaulted<LocalDateTime> transactiondate) {
    return new TransactionhistoryRowUnsaved(
        productid,
        referenceorderid,
  ...
  public static PgText<TransactionhistoryRowUnsaved> pgText =
      PgText.instance(
          (row, sb) -> {
            ...
            sb.append(PgText.DELIMETER);
            Defaulted.pgText(TransactionhistoryId.pgType.pgText())
