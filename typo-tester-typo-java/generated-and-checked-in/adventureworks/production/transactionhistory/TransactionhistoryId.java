...
public record TransactionhistoryId(@JsonValue Integer value) {
  ...
  static public PgType<TransactionhistoryId> pgType =
    PgTypes.int4.bimap(TransactionhistoryId::new, TransactionhistoryId::value);

  static public PgType<TransactionhistoryId[]> pgTypeArray =
    PgTypes.int4Array.bimap(xs -> arrayMap.map(xs, TransactionhistoryId::new, TransactionhistoryId.class), xs -> arrayMap.map(xs, TransactionhistoryId::value, Integer.class));
}