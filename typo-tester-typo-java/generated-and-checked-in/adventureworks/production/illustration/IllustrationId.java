...
public record IllustrationId(@JsonValue Integer value) {
  ...
  static public PgType<IllustrationId> pgType =
    PgTypes.int4.bimap(IllustrationId::new, IllustrationId::value);

  static public PgType<IllustrationId[]> pgTypeArray =
    PgTypes.int4Array.bimap(xs -> arrayMap.map(xs, IllustrationId::new, IllustrationId.class), xs -> arrayMap.map(xs, IllustrationId::value, Integer.class));
}