...
public record ProductmodelillustrationRepoMock(
  java.util.function.Function<ProductmodelillustrationRowUnsaved, ProductmodelillustrationRow> toRow,
  HashMap<ProductmodelillustrationId, ProductmodelillustrationRow> map
) implements ProductmodelillustrationRepo {
  public ProductmodelillustrationRepoMock(java.util.function.Function<ProductmodelillustrationRowUnsaved, ProductmodelillustrationRow> toRow) {
    this(toRow, new HashMap<ProductmodelillustrationId, ProductmodelillustrationRow>());
  };

  public ProductmodelillustrationRepoMock withToRow(java.util.function.Function<ProductmodelillustrationRowUnsaved, ProductmodelillustrationRow> toRow) {
    return new ProductmodelillustrationRepoMock(toRow, map);
  };

  public ProductmodelillustrationRepoMock withMap(HashMap<ProductmodelillustrationId, ProductmodelillustrationRow> map) {
    return new ProductmodelillustrationRepoMock(toRow, map);
  };

  @Override
  public DeleteBuilder<ProductmodelillustrationFields, ProductmodelillustrationRow> delete() {
    return new DeleteBuilderMock<>(ProductmodelillustrationFields.structure(), () -> new ArrayList<>(map.values()), DeleteParams.empty(), row -> row.compositeId(), id -> map.remove(id));
  };
  ...
  public SelectBuilder<ProductmodelillustrationFields, ProductmodelillustrationRow> select() {
    return new SelectBuilderMock<>(ProductmodelillustrationFields.structure(), () -> new ArrayList<>(map.values()), SelectParams.empty());
  };
  ...
  public Map<ProductmodelillustrationId, ProductmodelillustrationRow> selectByIdsTracked(
    ...
    return selectByIds(compositeIds, c).stream().collect(Collectors.toMap((ProductmodelillustrationRow row) -> row.compositeId(), Function.identity()));
  };

  @Override
  public UpdateBuilder<ProductmodelillustrationFields, ProductmodelillustrationRow> update() {
    return new UpdateBuilderMock<>(ProductmodelillustrationFields.structure(), () -> new ArrayList<>(map.values()), UpdateParams.empty(), row -> row);
  };
