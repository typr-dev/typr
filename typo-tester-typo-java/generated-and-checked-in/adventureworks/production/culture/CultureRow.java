...
/**
 * Table: production.culture Lookup table containing the languages in which some AdventureWorks data
 * is stored. Primary key: cultureid
 */
public record CultureRow(
  ...
  public static PgText<CultureRow> pgText = PgText.from(_rowParser);
