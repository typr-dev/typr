...
public class ProductmodelproductdescriptioncultureRepoImpl implements ProductmodelproductdescriptioncultureRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"production\".\"productmodelproductdescriptionculture\" where \"productmodelid\" = "), Fragment.encode(ProductmodelId.pgType, compositeId.productmodelid()), Fragment.lit(" AND \"productdescriptionid\" = "), Fragment.encode(ProductdescriptionId.pgType, compositeId.productdescriptionid()), Fragment.lit(" AND \"cultureid\" = "), Fragment.encode(CultureId.pgType, compositeId.cultureid()), Fragment.lit("")).update().runUnchecked(c) > 0;
  };
  ...
  public ProductmodelproductdescriptioncultureRow insert(
    ...
    values.add(interpolate(Fragment.encode(ProductdescriptionId.pgType, unsaved.productdescriptionid()), Fragment.lit("::int4")));
    ...
    Fragment q = interpolate(Fragment.lit("insert into \"production\".\"productmodelproductdescriptionculture\"("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nreturning \"productmodelid\", \"productdescriptionid\", \"cultureid\", \"modifieddate\"\n"));;
  ...
  public Long insertStreaming(
    ...
    return streamingInsert.insertUnchecked("COPY \"production\".\"productmodelproductdescriptionculture\"(\"productmodelid\", \"productdescriptionid\", \"cultureid\", \"modifieddate\") FROM STDIN", batchSize, unsaved, c, ProductmodelproductdescriptioncultureRow.pgText);
  };
  ...
  public Long insertUnsavedStreaming(
    ...
    return streamingInsert.insertUnchecked("COPY \"production\".\"productmodelproductdescriptionculture\"(\"productmodelid\", \"productdescriptionid\", \"cultureid\", \"modifieddate\") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')", batchSize, unsaved, c, ProductmodelproductdescriptioncultureRowUnsaved.pgText);
  };
  ...
  public UpdateBuilder<ProductmodelproductdescriptioncultureFields, ProductmodelproductdescriptioncultureRow> update() {
    return UpdateBuilder.of("\"production\".\"productmodelproductdescriptionculture\"", ProductmodelproductdescriptioncultureFields.structure(), ProductmodelproductdescriptioncultureRow._rowParser, Dialect.POSTGRESQL);
  };
  ...
  public Integer upsertStreaming(
    ...
    interpolate(Fragment.lit("create temporary table productmodelproductdescriptionculture_TEMP (like \"production\".\"productmodelproductdescriptionculture\") on commit drop")).update().runUnchecked(c);
