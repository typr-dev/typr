...
public record WorkorderroutingRowUnsaved(
  ...
  public WorkorderroutingRowUnsaved(
    ...
    this(workorderid, productid, operationsequence, locationid, scheduledstartdate, scheduledenddate, Optional.empty(), Optional.empty(), Optional.empty(), plannedcost, Optional.empty(), new UseDefault<>());
  };
  ...
  static public PgText<WorkorderroutingRowUnsaved> pgText =
