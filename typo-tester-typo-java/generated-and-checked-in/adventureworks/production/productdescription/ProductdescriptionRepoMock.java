...
public record ProductdescriptionRepoMock(
  ...
  public ProductdescriptionRepoMock(java.util.function.Function<ProductdescriptionRowUnsaved, ProductdescriptionRow> toRow) {
    this(toRow, new HashMap<ProductdescriptionId, ProductdescriptionRow>());
  };

  public ProductdescriptionRepoMock withToRow(java.util.function.Function<ProductdescriptionRowUnsaved, ProductdescriptionRow> toRow) {
    return new ProductdescriptionRepoMock(toRow, map);
  };

  public ProductdescriptionRepoMock withMap(HashMap<ProductdescriptionId, ProductdescriptionRow> map) {
    return new ProductdescriptionRepoMock(toRow, map);
  };
