...
public record ProductphotoRepoMock(
  ...
  public ProductphotoRepoMock(java.util.function.Function<ProductphotoRowUnsaved, ProductphotoRow> toRow) {
    this(toRow, new HashMap<ProductphotoId, ProductphotoRow>());
  };

  public ProductphotoRepoMock withToRow(java.util.function.Function<ProductphotoRowUnsaved, ProductphotoRow> toRow) {
