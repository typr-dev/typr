...
public interface SohViewFields extends FieldsExpr<SohViewRow> {
  record Impl(List<Path> _path) implements SohViewFields, Relation<SohViewFields, SohViewRow> {
    @Override
