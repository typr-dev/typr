...
public sealed interface Issue142Id permits Issue142Id.Unknown, Issue142Id.Known {
    ...
    static public PgType<Issue142Id[]> pgTypeArray =
      PgTypes.textArray
        .bimap(xs -> arrayMap.map(xs, Issue142Id::apply, Issue142Id.class), xs -> arrayMap.map(xs, Issue142Id::value, String.class));
