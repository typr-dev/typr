...
public class IdentityTestRepoImpl implements IdentityTestRepo {
  ...
  public IdentityTestRow insert(IdentityTestRowUnsaved unsaved, Connection c) {
    ...
    Fragment q =
        interpolate(
            Fragment.lit("insert into \"public\".\"identity-test\"("),
  ...
  public Long insertUnsavedStreaming(
    ...
    return streamingInsert.insertUnchecked(
        "COPY \"public\".\"identity-test\"(\"name\", \"default_generated\") FROM STDIN (DEFAULT"
            + " '__DEFAULT_VALUE__')",
        batchSize,
        unsaved,
        c,
  ...
  public Integer upsertStreaming(
    ...
    interpolate(
            Fragment.lit(
                "create temporary table identity-test_TEMP (like \"public\".\"identity-test\") on"
                    + " commit drop"))
        .update()
        .runUnchecked(c);
