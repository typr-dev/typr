...
public record TestSakSoknadsalternativRow(
  ...
  /** Points to {@link adventureworks.public_.test_utdanningstilbud.TestUtdanningstilbudRow#organisasjonskode()} */
  public TestSakSoknadsalternativRow withOrganisasjonskodeTilbyder(TestOrganisasjonId organisasjonskodeTilbyder) {
    return new TestSakSoknadsalternativRow(organisasjonskodeSaksbehandler, utdanningsmulighetKode, organisasjonskodeTilbyder);
  };

  static RowParser<TestSakSoknadsalternativRow> _rowParser = RowParsers.of(PgTypes.text, PgTypes.text, TestOrganisasjonId.pgType, TestSakSoknadsalternativRow::new, row -> new Object[]{row.organisasjonskodeSaksbehandler(), row.utdanningsmulighetKode(), row.organisasjonskodeTilbyder()});;

  static public TestSakSoknadsalternativRow apply(
    TestSakSoknadsalternativId compositeId,
    TestOrganisasjonId organisasjonskodeTilbyder
  ) {
    return new TestSakSoknadsalternativRow(compositeId.organisasjonskodeSaksbehandler(), compositeId.utdanningsmulighetKode(), organisasjonskodeTilbyder);
  };

  static public PgText<TestSakSoknadsalternativRow> pgText =
