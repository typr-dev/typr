...
public class TestOrganisasjonRepoImpl implements TestOrganisasjonRepo {
  ...
  public DeleteBuilder<TestOrganisasjonFields, TestOrganisasjonRow> delete() {
    return DeleteBuilder.of(
        "\"public\".\"test_organisasjon\"", TestOrganisasjonFields.structure(), Dialect.POSTGRESQL);
  }
  ;
  ...
  public Boolean deleteById(TestOrganisasjonId organisasjonskode, Connection c) {
    return interpolate(
                ...
                Fragment.encode(TestOrganisasjonId.pgType, organisasjonskode),
                Fragment.lit(""))
            .update()
            .runUnchecked(c)
        > 0;
  ...
  public Integer deleteByIds(TestOrganisasjonId[] organisasjonskodes, Connection c) {
    return interpolate(
            ...
            Fragment.encode(TestOrganisasjonId.pgTypeArray, organisasjonskodes),
            Fragment.lit(")"))
        .update()
        .runUnchecked(c);
  }
  ...
  public SelectBuilder<TestOrganisasjonFields, TestOrganisasjonRow> select() {
    return SelectBuilder.of(
        "\"public\".\"test_organisasjon\"",
        TestOrganisasjonFields.structure(),
        TestOrganisasjonRow._rowParser,
        Dialect.POSTGRESQL);
  }
  ;
  ...
  public List<TestOrganisasjonRow> selectAll(Connection c) {
    return interpolate(
            Fragment.lit("select \"organisasjonskode\"\nfrom \"public\".\"test_organisasjon\"\n"))
        .query(TestOrganisasjonRow._rowParser.all())
        .runUnchecked(c);
  }
  ;
  ...
  public Optional<TestOrganisasjonRow> selectById(
    ...
    return interpolate(
            ...
            Fragment.encode(TestOrganisasjonId.pgType, organisasjonskode),
            Fragment.lit(""))
        .query(TestOrganisasjonRow._rowParser.first())
        .runUnchecked(c);
  }
  ;
  ...
  public Map<TestOrganisasjonId, TestOrganisasjonRow> selectByIdsTracked(
      TestOrganisasjonId[] organisasjonskodes, Connection c) {
    HashMap<TestOrganisasjonId, TestOrganisasjonRow> ret =
        new HashMap<TestOrganisasjonId, TestOrganisasjonRow>();
  ...
  public Integer upsertStreaming(
    ...
    interpolate(
            Fragment.lit(
                "create temporary table test_organisasjon_TEMP (like"
                    + " \"public\".\"test_organisasjon\") on commit drop"))
        .update()
        .runUnchecked(c);
    ...
    return interpolate(
            Fragment.lit(
                "insert into \"public\".\"test_organisasjon\"(\"organisasjonskode\")\n"
                    ...
                    + "do nothing\n"
                    + ";\n"
                    + "drop table test_organisasjon_TEMP;"))
        .update()
        .runUnchecked(c);
  }
  ;
