...
public record PurchaseorderheaderRowUnsaved(
  ...
  public PurchaseorderheaderRowUnsaved(
    ...
    this(employeeid, vendorid, shipmethodid, Optional.empty(), new UseDefault<>(), new UseDefault<>(), new UseDefault<>(), new UseDefault<>(), new UseDefault<>(), new UseDefault<>(), new UseDefault<>(), new UseDefault<>());
  };
  ...
  /** Default: nextval('purchasing.purchaseorderheader_purchaseorderid_seq'::regclass)
    * Primary key.
    */
  public PurchaseorderheaderRowUnsaved withPurchaseorderid(Defaulted<PurchaseorderheaderId> purchaseorderid) {
    return new PurchaseorderheaderRowUnsaved(employeeid, vendorid, shipmethodid, shipdate, purchaseorderid, revisionnumber, status, orderdate, subtotal, taxamt, freight, modifieddate);
  };
  ...
  static public PgText<PurchaseorderheaderRowUnsaved> pgText =
