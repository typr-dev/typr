...
public interface PurchaseorderheaderFields extends FieldsExpr<PurchaseorderheaderRow> {
  record Impl(List<Path> _path) implements PurchaseorderheaderFields, RelationStructure<PurchaseorderheaderFields, PurchaseorderheaderRow> {
    @Override
    ...
    public Field<Short, PurchaseorderheaderRow> revisionnumber() {
      return new Field<Short, PurchaseorderheaderRow>(_path, "revisionnumber", PurchaseorderheaderRow::revisionnumber, Optional.empty(), Optional.of("int2"), (row, value) -> row.withRevisionnumber(value), PgTypes.int2);
    };

    @Override
    public Field<Short, PurchaseorderheaderRow> status() {
      return new Field<Short, PurchaseorderheaderRow>(_path, "status", PurchaseorderheaderRow::status, Optional.empty(), Optional.of("int2"), (row, value) -> row.withStatus(value), PgTypes.int2);
    };
    ...
    public Field<LocalDateTime, PurchaseorderheaderRow> orderdate() {
      return new Field<LocalDateTime, PurchaseorderheaderRow>(_path, "orderdate", PurchaseorderheaderRow::orderdate, Optional.empty(), Optional.of("timestamp"), (row, value) -> row.withOrderdate(value), PgTypes.timestamp);
    };

    @Override
    public OptField<LocalDateTime, PurchaseorderheaderRow> shipdate() {
      return new OptField<LocalDateTime, PurchaseorderheaderRow>(_path, "shipdate", PurchaseorderheaderRow::shipdate, Optional.empty(), Optional.of("timestamp"), (row, value) -> row.withShipdate(value), PgTypes.timestamp);
    };
    ...
    public Field<LocalDateTime, PurchaseorderheaderRow> modifieddate() {
      return new Field<LocalDateTime, PurchaseorderheaderRow>(_path, "modifieddate", PurchaseorderheaderRow::modifieddate, Optional.empty(), Optional.of("timestamp"), (row, value) -> row.withModifieddate(value), PgTypes.timestamp);
    };

    @Override
    public List<FieldLike<?, PurchaseorderheaderRow>> columns() {
      return java.util.List.of(this.purchaseorderid(), this.revisionnumber(), this.status(), this.employeeid(), this.vendorid(), this.shipmethodid(), this.orderdate(), this.shipdate(), this.subtotal(), this.taxamt(), this.freight(), this.modifieddate());
    };

    @Override
    public RelationStructure<PurchaseorderheaderFields, PurchaseorderheaderRow> withPaths(List<Path> _path) {
  ...
  default ForeignKey<EmployeeFields, EmployeeRow> fkHumanresourcesEmployee() {
    return ForeignKey.<EmployeeFields, EmployeeRow>of("purchasing.FK_PurchaseOrderHeader_Employee_EmployeeID").<BusinessentityId>withColumnPair(employeeid(), EmployeeFields::businessentityid);
  };

  default ForeignKey<ShipmethodFields, ShipmethodRow> fkShipmethod() {
    return ForeignKey.<ShipmethodFields, ShipmethodRow>of("purchasing.FK_PurchaseOrderHeader_ShipMethod_ShipMethodID").<ShipmethodId>withColumnPair(shipmethodid(), ShipmethodFields::shipmethodid);
  };

  default ForeignKey<VendorFields, VendorRow> fkVendor() {
    return ForeignKey.<VendorFields, VendorRow>of("purchasing.FK_PurchaseOrderHeader_Vendor_VendorID").<BusinessentityId>withColumnPair(vendorid(), VendorFields::businessentityid);
  };
