...
public record PurchaseorderheaderRepoMock(
  ...
  public PurchaseorderheaderRepoMock(java.util.function.Function<PurchaseorderheaderRowUnsaved, PurchaseorderheaderRow> toRow) {
    this(toRow, new HashMap<PurchaseorderheaderId, PurchaseorderheaderRow>());
  };

  public PurchaseorderheaderRepoMock withToRow(java.util.function.Function<PurchaseorderheaderRowUnsaved, PurchaseorderheaderRow> toRow) {
    return new PurchaseorderheaderRepoMock(toRow, map);
  };

  public PurchaseorderheaderRepoMock withMap(HashMap<PurchaseorderheaderId, PurchaseorderheaderRow> map) {
    return new PurchaseorderheaderRepoMock(toRow, map);
  };
