...
public record VendorRowUnsaved(
  ...
  /** Vendor URL. */
  public VendorRowUnsaved withPurchasingwebserviceurl(Optional</* max 1024 chars */ String> purchasingwebserviceurl) {
    return new VendorRowUnsaved(businessentityid, accountnumber, name, creditrating, purchasingwebserviceurl, preferredvendorstatus, activeflag, modifieddate);
  };
  ...
  static public PgText<VendorRowUnsaved> pgText =
