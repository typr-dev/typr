...
public record PurchaseorderdetailRowUnsaved(
  ...
  public PurchaseorderdetailRowUnsaved(
    ...
    this(purchaseorderid, duedate, orderqty, productid, unitprice, receivedqty, rejectedqty, new UseDefault<>(), new UseDefault<>());
  };
  ...
  /** Default: nextval('purchasing.purchaseorderdetail_purchaseorderdetailid_seq'::regclass)
    * Primary key. One line number per purchased product.
    */
  public PurchaseorderdetailRowUnsaved withPurchaseorderdetailid(Defaulted<Integer> purchaseorderdetailid) {
    return new PurchaseorderdetailRowUnsaved(purchaseorderid, duedate, orderqty, productid, unitprice, receivedqty, rejectedqty, purchaseorderdetailid, modifieddate);
  };
  ...
  static public PgText<PurchaseorderdetailRowUnsaved> pgText =
