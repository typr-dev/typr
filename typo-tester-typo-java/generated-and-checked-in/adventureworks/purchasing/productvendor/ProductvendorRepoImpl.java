...
public class ProductvendorRepoImpl implements ProductvendorRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"purchasing\".\"productvendor\" where \"productid\" = "), Fragment.encode(ProductId.pgType, compositeId.productid()), Fragment.lit(" AND \"businessentityid\" = "), Fragment.encode(BusinessentityId.pgType, compositeId.businessentityid()), Fragment.lit("")).update().runUnchecked(c) > 0;
  };
  ...
  public ProductvendorRow insert(
    ...
    values.add(interpolate(Fragment.encode(PgTypes.int4, unsaved.averageleadtime()), Fragment.lit("::int4")));
    ...
    values.add(interpolate(Fragment.encode(PgTypes.numeric.opt(), unsaved.lastreceiptcost()), Fragment.lit("::numeric")));
    columns.add(Fragment.lit("\"lastreceiptdate\""));
    values.add(interpolate(Fragment.encode(PgTypes.timestamp.opt(), unsaved.lastreceiptdate()), Fragment.lit("::timestamp")));
    columns.add(Fragment.lit("\"minorderqty\""));
    values.add(interpolate(Fragment.encode(PgTypes.int4, unsaved.minorderqty()), Fragment.lit("::int4")));
    columns.add(Fragment.lit("\"maxorderqty\""));
    values.add(interpolate(Fragment.encode(PgTypes.int4, unsaved.maxorderqty()), Fragment.lit("::int4")));
    columns.add(Fragment.lit("\"onorderqty\""));
    values.add(interpolate(Fragment.encode(PgTypes.int4.opt(), unsaved.onorderqty()), Fragment.lit("::int4")));
    ...
    Fragment q = interpolate(Fragment.lit("insert into \"purchasing\".\"productvendor\"("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nreturning \"productid\", \"businessentityid\", \"averageleadtime\", \"standardprice\", \"lastreceiptcost\", \"lastreceiptdate\", \"minorderqty\", \"maxorderqty\", \"onorderqty\", \"unitmeasurecode\", \"modifieddate\"\n"));;
  ...
  public Long insertStreaming(
    ...
    return streamingInsert.insertUnchecked("COPY \"purchasing\".\"productvendor\"(\"productid\", \"businessentityid\", \"averageleadtime\", \"standardprice\", \"lastreceiptcost\", \"lastreceiptdate\", \"minorderqty\", \"maxorderqty\", \"onorderqty\", \"unitmeasurecode\", \"modifieddate\") FROM STDIN", batchSize, unsaved, c, ProductvendorRow.pgText);
  };
  ...
  public Long insertUnsavedStreaming(
    ...
    return streamingInsert.insertUnchecked("COPY \"purchasing\".\"productvendor\"(\"productid\", \"businessentityid\", \"averageleadtime\", \"standardprice\", \"lastreceiptcost\", \"lastreceiptdate\", \"minorderqty\", \"maxorderqty\", \"onorderqty\", \"unitmeasurecode\", \"modifieddate\") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')", batchSize, unsaved, c, ProductvendorRowUnsaved.pgText);
  };
  ...
  public UpdateBuilder<ProductvendorFields, ProductvendorRow> update() {
    return UpdateBuilder.of("\"purchasing\".\"productvendor\"", ProductvendorFields.structure(), ProductvendorRow._rowParser, Dialect.POSTGRESQL);
  };
