...
public record ProductvendorRepoMock(
  ...
  public ProductvendorRepoMock(java.util.function.Function<ProductvendorRowUnsaved, ProductvendorRow> toRow) {
    this(toRow, new HashMap<ProductvendorId, ProductvendorRow>());
  };

  public ProductvendorRepoMock withToRow(java.util.function.Function<ProductvendorRowUnsaved, ProductvendorRow> toRow) {
  ...
  public DeleteBuilder<ProductvendorFields, ProductvendorRow> delete() {
    return new DeleteBuilderMock<>(ProductvendorFields.structure(), () -> new ArrayList<>(map.values()), DeleteParams.empty(), row -> row.compositeId(), id -> map.remove(id));
  };
  ...
  public SelectBuilder<ProductvendorFields, ProductvendorRow> select() {
    return new SelectBuilderMock<>(ProductvendorFields.structure(), () -> new ArrayList<>(map.values()), SelectParams.empty());
  };
  ...
  public Map<ProductvendorId, ProductvendorRow> selectByIdsTracked(
    ...
    return selectByIds(compositeIds, c).stream().collect(Collectors.toMap((ProductvendorRow row) -> row.compositeId(), Function.identity()));
  };

  @Override
  public UpdateBuilder<ProductvendorFields, ProductvendorRow> update() {
    return new UpdateBuilderMock<>(ProductvendorFields.structure(), () -> new ArrayList<>(map.values()), UpdateParams.empty(), row -> row);
  };
