...
public record ProductvendorRowUnsaved(
  ...
  public ProductvendorRowUnsaved(
    ...
    this(productid, businessentityid, averageleadtime, standardprice, Optional.empty(), Optional.empty(), minorderqty, maxorderqty, Optional.empty(), unitmeasurecode, new UseDefault<>());
  };
  ...
  static public PgText<ProductvendorRowUnsaved> pgText =
