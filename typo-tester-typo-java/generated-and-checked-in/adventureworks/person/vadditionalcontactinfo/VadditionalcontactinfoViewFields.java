...
public interface VadditionalcontactinfoViewFields extends FieldsExpr<VadditionalcontactinfoViewRow> {
  record Impl(List<Path> _path) implements VadditionalcontactinfoViewFields, Relation<VadditionalcontactinfoViewFields, VadditionalcontactinfoViewRow> {
    @Override
