...
public record StateprovinceRepoMock(
  ...
  public StateprovinceRepoMock(
      java.util.function.Function<StateprovinceRowUnsaved, StateprovinceRow> toRow) {
    this(toRow, new HashMap<StateprovinceId, StateprovinceRow>());
  }
  ;

  public StateprovinceRepoMock withToRow(
      java.util.function.Function<StateprovinceRowUnsaved, StateprovinceRow> toRow) {
  ...
  public Map<StateprovinceId, StateprovinceRow> selectByIdsTracked(
    ...
    return selectByIds(stateprovinceids, c).stream()
        .collect(
            Collectors.toMap((StateprovinceRow row) -> row.stateprovinceid(), Function.identity()));
  }
  ;
  ...
  public Boolean update(StateprovinceRow row, Connection c) {
    var shouldUpdate =
        Optional.ofNullable(map.get(row.stateprovinceid()))
  ...
  public Integer upsertStreaming(
      Iterator<StateprovinceRow> unsaved, Integer batchSize, Connection c) {
    var count = 0;
    while (unsaved.hasNext()) {
      var row = unsaved.next();
      map.put(row.stateprovinceid(), row);
