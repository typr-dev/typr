...
public class BusinessentityaddressRepoImpl implements BusinessentityaddressRepo {
  ...
  public Integer deleteByIds(BusinessentityaddressId[] compositeIds, Connection c) {
    BusinessentityId[] businessentityid =
        arrayMap.map(
            compositeIds, BusinessentityaddressId::businessentityid, BusinessentityId.class);
    ;
    AddressId[] addressid =
        arrayMap.map(compositeIds, BusinessentityaddressId::addressid, AddressId.class);
    ;
    AddresstypeId[] addresstypeid =
        arrayMap.map(compositeIds, BusinessentityaddressId::addresstypeid, AddresstypeId.class);
    ;
    return interpolate(
            Fragment.lit(
                "delete\n"
  ...
  public BusinessentityaddressRow insert(BusinessentityaddressRowUnsaved unsaved, Connection c) {
    ...
    Fragment q =
        interpolate(
            Fragment.lit("insert into \"person\".\"businessentityaddress\"("),
  ...
  public Long insertStreaming(
    ...
    return streamingInsert.insertUnchecked(
        "COPY \"person\".\"businessentityaddress\"(\"businessentityid\", \"addressid\","
            + " \"addresstypeid\", \"rowguid\", \"modifieddate\") FROM STDIN",
        batchSize,
        unsaved,
        c,
  ...
  public Long insertUnsavedStreaming(
    ...
    return streamingInsert.insertUnchecked(
        "COPY \"person\".\"businessentityaddress\"(\"businessentityid\", \"addressid\","
            + " \"addresstypeid\", \"rowguid\", \"modifieddate\") FROM STDIN (DEFAULT"
            + " '__DEFAULT_VALUE__')",
        batchSize,
        unsaved,
        c,
  ...
  public List<BusinessentityaddressRow> selectAll(Connection c) {
    return interpolate(
            Fragment.lit(
                "select \"businessentityid\", \"addressid\", \"addresstypeid\", \"rowguid\","
                    + " \"modifieddate\"\n"
                    + "from \"person\".\"businessentityaddress\"\n"))
  ...
  public Optional<BusinessentityaddressRow> selectById(
      BusinessentityaddressId compositeId, Connection c) {
    return interpolate(
            Fragment.lit(
                "select \"businessentityid\", \"addressid\", \"addresstypeid\", \"rowguid\","
                    + " \"modifieddate\"\n"
  ...
  public Map<BusinessentityaddressId, BusinessentityaddressRow> selectByIdsTracked(
      BusinessentityaddressId[] compositeIds, Connection c) {
    HashMap<BusinessentityaddressId, BusinessentityaddressRow> ret =
        new HashMap<BusinessentityaddressId, BusinessentityaddressRow>();
  ...
  public Boolean update(BusinessentityaddressRow row, Connection c) {
    ...
    ;
    return interpolate(
                Fragment.lit("update \"person\".\"businessentityaddress\"\nset \"rowguid\" = "),
  ...
  public Integer upsertStreaming(
    ...
    interpolate(
            Fragment.lit(
                "create temporary table businessentityaddress_TEMP (like"
                    + " \"person\".\"businessentityaddress\") on commit drop"))
        .update()
        .runUnchecked(c);
    streamingInsert.insertUnchecked(
        "copy businessentityaddress_TEMP(\"businessentityid\", \"addressid\", \"addresstypeid\","
    ...
    return interpolate(
            Fragment.lit(
                "insert into \"person\".\"businessentityaddress\"(\"businessentityid\","
                    ...
                    + "\"modifieddate\" = EXCLUDED.\"modifieddate\"\n"
                    + ";\n"
                    + "drop table businessentityaddress_TEMP;"))
        .update()
        .runUnchecked(c);
  }
  ;
