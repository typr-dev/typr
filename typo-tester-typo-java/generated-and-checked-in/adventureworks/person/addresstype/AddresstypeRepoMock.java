...
public record AddresstypeRepoMock(
  ...
  public AddresstypeRepoMock(
      java.util.function.Function<AddresstypeRowUnsaved, AddresstypeRow> toRow) {
    this(toRow, new HashMap<AddresstypeId, AddresstypeRow>());
  }
  ;

  public AddresstypeRepoMock withToRow(
      java.util.function.Function<AddresstypeRowUnsaved, AddresstypeRow> toRow) {
  ...
  public Map<AddresstypeId, AddresstypeRow> selectByIdsTracked(
    ...
    return selectByIds(addresstypeids, c).stream()
        .collect(
            Collectors.toMap((AddresstypeRow row) -> row.addresstypeid(), Function.identity()));
  }
  ;
  ...
  public Boolean update(AddresstypeRow row, Connection c) {
    var shouldUpdate =
        Optional.ofNullable(map.get(row.addresstypeid()))
