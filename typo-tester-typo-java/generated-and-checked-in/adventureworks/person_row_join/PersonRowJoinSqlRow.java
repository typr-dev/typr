...
public record PersonRowJoinSqlRow(
  ...
  static RowParser<PersonRowJoinSqlRow> _rowParser = RowParsers.of(BusinessentityId.pgType, PgTypes.recordArray.opt(), PgTypes.recordArray.opt(), PersonRowJoinSqlRow::new, row -> new Object[]{row.businessentityid(), row.email(), row.emails()});;
}