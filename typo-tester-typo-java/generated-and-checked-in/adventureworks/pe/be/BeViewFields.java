...
public interface BeViewFields extends FieldsExpr<BeViewRow> {
  record Impl(List<Path> _path) implements BeViewFields, RelationStructure<BeViewFields, BeViewRow> {
    @Override
    ...
    public Field<UUID, BeViewRow> rowguid() {
      return new Field<UUID, BeViewRow>(_path, "rowguid", BeViewRow::rowguid, Optional.empty(), Optional.empty(), (row, value) -> row.withRowguid(value), PgTypes.uuid);
    };

    @Override
    public Field<LocalDateTime, BeViewRow> modifieddate() {
      return new Field<LocalDateTime, BeViewRow>(_path, "modifieddate", BeViewRow::modifieddate, Optional.empty(), Optional.empty(), (row, value) -> row.withModifieddate(value), PgTypes.timestamp);
    };

    @Override
    public List<FieldLike<?, BeViewRow>> columns() {
      return java.util.List.of(this.id(), this.businessentityid(), this.rowguid(), this.modifieddate());
    };
