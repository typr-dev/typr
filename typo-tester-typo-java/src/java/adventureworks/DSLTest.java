...
public class DSLTest extends SnapshotTest {
    ...
    public void mapProjectsColumns() {
        WithConnection.run(c -> {
            ...
            var projected = personRepoImpl.select()
    ...
    public void mapAfterJoin() {
        WithConnection.run(c -> {
            ...
            var nestedProjected = personRepoImpl.select()
                    .where(p -> p.businessentityid().isEqual(personRow.businessentityid()))
                    .join(emailaddressRepoImpl.select())
                    .on(pe -> pe._1().businessentityid().isEqual(pe._2().businessentityid()))
                    .map(
    ...
    public void multisetOnAggregatesChildRows() {
        WithConnection.run(c -> {
            ...
            var multiset = personRepoImpl.select()
                    .where(p -> p.businessentityid().isEqual(personRow.businessentityid()))
                    .multisetOn(
    ...
    /**
     * Test combining multisetOn with nested tuple projections.
     * Projects parent as nested tuple (firstname, lastname) and aggregates child emails.
     */
    @Test
    public void multisetOnWithNestedTupleProjection() {
        WithConnection.run(c -> {
            ...
            var projectedPerson = personRepoImpl.select()
                    .where(p -> p.businessentityid().isEqual(personRow.businessentityid()))
            ...
            var multiset = projectedPerson.multisetOn(
                    emailaddressRepoImpl.select(),
                    pe -> pe._1()._2().isEqual(pe._2().businessentityid())  // _1()._2() is the businessentityid from parent tuple
            );
            ...
            var parentTuple = results.get(0)._1();  // Tuple2<Tuple2<FirstName, Name>, BusinessentityId>
    ...
    public void inSubqueryFindsMatchingRows() {
        WithConnection.run(c -> {
            ...
            var be1 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(),
                    c
            );
            var person1 = testInsert.personPerson(
            ...
            var be2 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(),
                    c
            );
            var person2 = testInsert.personPerson(
            ...
            var subquery = emailaddressRepoImpl.select()
                    .map(e -> e.businessentityid());

            var query = personRepoImpl.select()
                    .where(p -> p.businessentityid().isEqual(person1.businessentityid())
                            .or(p.businessentityid().isEqual(person2.businessentityid()), typo.dsl.Bijection.asBool()))
    ...
    public void existsFindsRowsWithCorrelatedSubquery() {
        WithConnection.run(c -> {
            ...
            // Find persons where EXISTS (select from email where email.businessentityid = person.businessentityid)
            // Note: EXISTS with a correlated subquery requires the subquery to reference the outer query.
            // In SQL this would be: WHERE EXISTS (SELECT 1 FROM email WHERE email.businessentityid = person.businessentityid)
            // Our simple EXISTS doesn't support correlation, so we'll test the non-correlated form for now.

            // Test non-correlated EXISTS - just checks if email table has any rows
            var subqueryWithRows = emailaddressRepoImpl.select()
    ...
    public void notExistsFiltersOutRowsWithMatches() {
        WithConnection.run(c -> {
            ...
            var subqueryForPerson2 = emailaddressRepoImpl.select()
    ...
    public void existsWithWhereClause() {
        WithConnection.run(c -> {
            ...
            var be1 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var person1 = testInsert.personPerson(
                    be1.businessentityid(), "EM", new FirstName("WorkEmail"), Optional.empty(),
                    Optional.empty(), new Name("User"), Optional.empty(), Optional.empty(), Optional.empty(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), c);
            testInsert.personEmailaddress(person1.businessentityid(), Optional.of("work@company.com"),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            ...
            var be2 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var person2 = testInsert.personPerson(
                    be2.businessentityid(), "EM", new FirstName("PersonalEmail"), Optional.empty(),
                    Optional.empty(), new Name("User"), Optional.empty(), Optional.empty(), Optional.empty(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), c);
            testInsert.personEmailaddress(person2.businessentityid(), Optional.of("me@gmail.com"),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);

            // Find person1 who has a work email (containing "company")
            // Uses a filtered subquery to demonstrate EXISTS with WHERE
            var workEmailSubquery = emailaddressRepoImpl.select()
                    .where(e -> e.businessentityid().isEqual(person1.businessentityid()));
    ...
    public void leftJoinReturnsAllLeftRowsWithOptionalRight() {
        WithConnection.run(c -> {
            ...
            var be1 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var employee = testInsert.personPerson(
                    be1.businessentityid(), "EM", new FirstName("Employee"), Optional.empty(),
                    Optional.empty(), new Name("Worker"), Optional.empty(), Optional.empty(), Optional.empty(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), c);
            testInsert.humanresourcesEmployee(
                    employee.businessentityid(),
                    new TypoLocalDate(java.time.LocalDate.of(1990, 1, 1)), "S", "M",
                    new TypoLocalDate(java.time.LocalDate.of(2020, 1, 1)),
                    "111111", "adventure-works\\emp1", "Developer",
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), c);
            ...
            var be2 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var nonEmployee = testInsert.personPerson(
                    be2.businessentityid(), "SC", new FirstName("Customer"), Optional.empty(),
                    Optional.empty(), new Name("Only"), Optional.empty(), Optional.empty(), Optional.empty(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), c);

            // Left join person with employee - should return both persons
            var query = personRepoImpl.select()
                    .where(p -> p.businessentityid().isEqual(employee.businessentityid())
                            .or(p.businessentityid().isEqual(nonEmployee.businessentityid()), Bijection.asBool()))
                    .leftJoinOn(employeeRepoImpl.select(),
                            pe -> pe._1().businessentityid().isEqual(pe._2().businessentityid()))
    ...
    public void comparisonOperatorsWithLiterals() {
        WithConnection.run(c -> {
            ...
            var be1 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var person1 = testInsert.personPerson(
                    be1.businessentityid(), "EM", new FirstName("Alice"), Optional.empty(),
                    Optional.empty(), new Name("Anderson"), Optional.empty(), Optional.empty(), Optional.empty(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), c);
            ...
            var be2 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var person2 = testInsert.personPerson(
                    be2.businessentityid(), "EM", new FirstName("Bob"), Optional.empty(),
                    Optional.empty(), new Name("Brown"), Optional.empty(), Optional.empty(), Optional.empty(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), c);

            var be3 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var person3 = testInsert.personPerson(
                    be3.businessentityid(), "EM", new FirstName("Charlie"), Optional.empty(),
                    Optional.empty(), new Name("Clark"), Optional.empty(), Optional.empty(), Optional.empty(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), c);

            // Test greaterThan - find persons with id > person1's id
            var gtQuery = personRepoImpl.select()
            ...
            var ltQuery = personRepoImpl.select()
            ...
            // Test isNotEqual
            var neqQuery = personRepoImpl.select()
    ...
    public void inArrayFindsMatchingRows() {
        WithConnection.run(c -> {
            ...
            var be1 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var person1 = testInsert.personPerson(
                    be1.businessentityid(), "EM", new FirstName("InTest1"), Optional.empty(),
                    Optional.empty(), new Name("Person"), Optional.empty(), Optional.empty(), Optional.empty(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), c);
            ...
            var be2 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var person2 = testInsert.personPerson(
                    be2.businessentityid(), "EM", new FirstName("InTest2"), Optional.empty(),
                    Optional.empty(), new Name("Person"), Optional.empty(), Optional.empty(), Optional.empty(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), c);
            ...
            var be3 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var person3 = testInsert.personPerson(
                    be3.businessentityid(), "EM", new FirstName("InTest3"), Optional.empty(),
                    Optional.empty(), new Name("Person"), Optional.empty(), Optional.empty(), Optional.empty(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), c);
            ...
            var query = personRepoImpl.select()
                    .where(p -> p.businessentityid().in(person1.businessentityid(), person3.businessentityid()))
                    .orderBy(p -> p.businessentityid().asc());
    ...
    public void coalesceReturnsFirstNonNull() {
        WithConnection.run(c -> {
            ...
            var be1 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var personWithMiddle = testInsert.personPerson(
                    be1.businessentityid(), "EM", new FirstName("WithMiddle"), Optional.empty(),
                    Optional.of(new Name("MiddleName")), new Name("Last"), Optional.empty(), Optional.empty(),
                    Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);

            // Create person without middle name
            var be2 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var personWithoutMiddle = testInsert.personPerson(
                    be2.businessentityid(), "EM", new FirstName("NoMiddle"), Optional.empty(),
                    Optional.empty(), new Name("Last"), Optional.empty(), Optional.empty(),
                    Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);

            // Query and verify persons were created correctly
            var query = personRepoImpl.select()
                    .where(p -> p.businessentityid().isEqual(personWithMiddle.businessentityid())
                            .or(p.businessentityid().isEqual(personWithoutMiddle.businessentityid()), Bijection.asBool()))
    ...
    public void isNullFindsRowsWithNullValues() {
        WithConnection.run(c -> {
            ...
            var be1 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var personWithTitle = testInsert.personPerson(
                    be1.businessentityid(), "EM", new FirstName("HasTitle"), Optional.of("Mr."),
                    Optional.empty(), new Name("Person"), Optional.empty(), Optional.empty(),
                    Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            ...
            var be2 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var personWithoutTitle = testInsert.personPerson(
                    be2.businessentityid(), "EM", new FirstName("NoTitle"), Optional.empty(),
                    Optional.empty(), new Name("Person"), Optional.empty(), Optional.empty(),
                    Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);

            // Find persons with NULL title
            var nullQuery = personRepoImpl.select()
                    .where(p -> p.businessentityid().isEqual(personWithTitle.businessentityid())
                            .or(p.businessentityid().isEqual(personWithoutTitle.businessentityid()), Bijection.asBool()))
            ...
            var notNullQuery = personRepoImpl.select()
                    .where(p -> p.businessentityid().isEqual(personWithTitle.businessentityid())
                            .or(p.businessentityid().isEqual(personWithoutTitle.businessentityid()), Bijection.asBool()))
    ...
    public void allAndAnyCombineBooleanExpressions() {
        WithConnection.run(c -> {
            ...
            var person1 = testInsert.personPerson(
                    be1.businessentityid(), "EM", new FirstName("Alice"), Optional.empty(),
                    Optional.empty(), new Name("Anderson"), Optional.empty(), Optional.empty(),
                    Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            ...
            var be2 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var person2 = testInsert.personPerson(
                    be2.businessentityid(), "SC", new FirstName("Bob"), Optional.empty(),
                    Optional.empty(), new Name("Brown"), Optional.empty(), Optional.empty(),
                    Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);

            // Test SqlExpr.all() - all conditions must be true
            var allQuery = personRepoImpl.select()
                    .where(p -> SqlExpr.all(
            ...
            var anyQuery = personRepoImpl.select()
                    .where(p -> p.businessentityid().isEqual(person1.businessentityid())
                            .or(p.businessentityid().isEqual(person2.businessentityid()), Bijection.asBool()))
                    .where(p -> SqlExpr.any(
                            p.firstname().isEqual(new FirstName("Alice")),
    ...
    public void orderByMultipleColumns() {
        WithConnection.run(c -> {
            ...
            var be1 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var person1 = testInsert.personPerson(
                    be1.businessentityid(), "EM", new FirstName("Zoe"), Optional.empty(),
                    Optional.empty(), new Name("Smith"), Optional.empty(), Optional.empty(),
                    Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            ...
            var be2 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var person2 = testInsert.personPerson(
                    be2.businessentityid(), "EM", new FirstName("Alice"), Optional.empty(),
                    Optional.empty(), new Name("Smith"), Optional.empty(), Optional.empty(),
                    Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            ...
            var be3 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var person3 = testInsert.personPerson(
                    be3.businessentityid(), "EM", new FirstName("Bob"), Optional.empty(),
                    Optional.empty(), new Name("Jones"), Optional.empty(), Optional.empty(),
                    Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            ...
            var query = personRepoImpl.select()
                    .where(p -> p.businessentityid().isEqual(person1.businessentityid())
                            .or(p.businessentityid().isEqual(person2.businessentityid()), Bijection.asBool())
                            .or(p.businessentityid().isEqual(person3.businessentityid()), Bijection.asBool()))
    ...
    public void limitAndOffsetPaginateResults() {
        WithConnection.run(c -> {
            ...
            for (int i = 0; i < 5; i++) {
                var be = testInsert.personBusinessentity(
                        new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
                var person = testInsert.personPerson(
                        be.businessentityid(), "EM", new FirstName("Person" + i), Optional.empty(),
                        Optional.empty(), new Name("Test"), Optional.empty(), Optional.empty(),
                        Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                        new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
                persons.add(person);
            }
            ...
            var page1Query = personRepoImpl.select()
            ...
            var page2Query = personRepoImpl.select()
                    .where(p -> p.lastname().isEqual(new Name("Test")))
                    .orderBy(p -> p.businessentityid().asc())
                    .offset(2)
                    .limit(2);
            ...
            var page3Query = personRepoImpl.select()
                    .where(p -> p.lastname().isEqual(new Name("Test")))
                    .orderBy(p -> p.businessentityid().asc())
                    .offset(4)
                    .limit(2);
        ...
        WithConnection.run(c -> {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                testInsert.personPerson(
                        be.businessentityid(), "EM", new FirstName("Count" + i), Optional.empty(),
                        Optional.empty(), new Name("TestCount"), Optional.empty(), Optional.empty(),
                        Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                        new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            }
            ...
            var filteredQuery = personRepoImpl.select()
                    .where(p -> p.lastname().isEqual(new Name("TestCount")))
    ...
    public void includeIfReturnsOptionalBasedOnPredicate() {
        WithConnection.run(c -> {
            ...
            var employee = testInsert.personPerson(
                    be1.businessentityid(), "EM", new FirstName("Employee"), Optional.empty(),
                    Optional.empty(), new Name("Worker"), Optional.empty(), Optional.empty(),
                    Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            ...
            var be2 = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var customer = testInsert.personPerson(
                    be2.businessentityid(), "SC", new FirstName("Customer"), Optional.empty(),
                    Optional.empty(), new Name("Only"), Optional.empty(), Optional.empty(),
                    Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            ...
            var query = personRepoImpl.select()
                    .where(p -> p.businessentityid().isEqual(employee.businessentityid())
                            .or(p.businessentityid().isEqual(customer.businessentityid()), Bijection.asBool()))
                    .orderBy(p -> p.firstname().asc())
                    .map(
                            p -> p.firstname(),
    ...
    public void includeIfWithTruePredicateIncludesValue() {
        WithConnection.run(c -> {
            ...
            var be = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var person = testInsert.personPerson(
                    be.businessentityid(), "EM", new FirstName("Test"), Optional.empty(),
                    Optional.empty(), new Name("Person"), Optional.empty(), Optional.empty(),
                    Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            ...
            var query = personRepoImpl.select()
                    ...
                    .map(
                            p -> p.firstname(),
                            p -> p.lastname().includeIf(new SqlExpr.ConstReq<>(true, typo.runtime.PgTypes.bool))
                    );

            var results = query.toList(c);
            assertEquals(1, results.size());
            assertTrue("Lastname should be present with true predicate", results.get(0)._2().isPresent());
    ...
    public void includeIfWithFalsePredicateExcludesValue() {
        WithConnection.run(c -> {
            ...
            var query = personRepoImpl.select()
                    ...
                    .map(
                            p -> p.firstname(),
                            p -> p.lastname().includeIf(new SqlExpr.ConstReq<>(false, typo.runtime.PgTypes.bool))
                    );

            var results = query.toList(c);
            assertEquals(1, results.size());
            assertTrue("Lastname should be empty with false predicate", results.get(0)._2().isEmpty());
        });
    }
        ...
        WithConnection.run(c -> {
            ...
            for (int i = 0; i < 3; i++) {
                var be = testInsert.personBusinessentity(
                        new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
                testInsert.personPerson(
                        be.businessentityid(), "EM", new FirstName("Employee" + i), Optional.empty(),
                        Optional.empty(), new Name("GroupTest"), Optional.empty(), Optional.empty(),
                        Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                        new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            }
            for (int i = 0; i < 2; i++) {
                var be = testInsert.personBusinessentity(
                        new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
                testInsert.personPerson(
                        be.businessentityid(), "SC", new FirstName("Customer" + i), Optional.empty(),
                        Optional.empty(), new Name("GroupTest"), Optional.empty(), Optional.empty(),
                        Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                        new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            }
            ...
            var emResult = results.stream()
                    .filter(r -> "EM".equals(r._1()))
                    .findFirst()
                    .orElseThrow();
            var scResult = results.stream()
                    .filter(r -> "SC".equals(r._1()))
                    .findFirst()
                    .orElseThrow();
    ...
    public void groupByWithHavingFiltersGroups() {
        WithConnection.run(c -> {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                testInsert.personPerson(
                        be.businessentityid(), "EM", new FirstName("Employee" + i), Optional.empty(),
                        Optional.empty(), new Name("HavingTest"), Optional.empty(), Optional.empty(),
                        Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                        new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            }
            var be = testInsert.personBusinessentity(
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            testInsert.personPerson(
                    be.businessentityid(), "SC", new FirstName("Customer"), Optional.empty(),
                    Optional.empty(), new Name("HavingTest"), Optional.empty(), Optional.empty(),
                    Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            ...
            var query = personRepoImpl.select()
                    ...
                    .groupBy(p -> p.persontype())
                    .having(p -> SqlExpr.count().greaterThan(new SqlExpr.ConstReq<>(1L, typo.runtime.PgTypes.int8)))
                    .select(p -> Tuples.of(
                            p.persontype(),
                            SqlExpr.count()
                    ));
    ...
    /**
     * Test join on grouped results (mock implementation).
     * Groups by persontype, counts per type, then joins with another table.
     */
    @Test
    public void groupByThenJoinOnMock() {
        // Use counters for unique IDs
        java.util.concurrent.atomic.AtomicInteger beIdCounter = new java.util.concurrent.atomic.AtomicInteger(1);

        // Use mock repos for in-memory testing
        var personRepoMock = new adventureworks.person.person.PersonRepoMock(
                unsaved -> unsaved.toRow(
                        () -> new adventureworks.public_.NameStyle(false),
                        () -> 0,
                        () -> adventureworks.customtypes.TypoUUID.randomUUID(),
                        () -> adventureworks.customtypes.TypoLocalDateTime.now()
                )
        );
        var businessentityRepoMock = new adventureworks.person.businessentity.BusinessentityRepoMock(
                unsaved -> unsaved.toRow(
                        () -> new adventureworks.person.businessentity.BusinessentityId(beIdCounter.getAndIncrement()),
                        () -> adventureworks.customtypes.TypoUUID.randomUUID(),
                        () -> adventureworks.customtypes.TypoLocalDateTime.now()
                )
        );
        ...
        for (int i = 1; i <= 3; i++) {
            int id = i;
            var be = businessentityRepoMock.insert(
        ...
        var grouped = personRepoMock.select()
                .where(p -> p.lastname().isEqual(new Name("Test")))
                .groupBy(p -> p.persontype())
                .select(p -> Tuples.of(
                        p.persontype(),
        ...
        var joinedWithBe = grouped.joinOn(
                ...
                tuple -> {
                    ...
                    return new SqlExpr.ConstReq<>(true, typo.runtime.PgTypes.bool);
                }
        );
        ...
        WithConnection.run(c -> {
            ...
            for (String name : emNames) {
                var be = testInsert.personBusinessentity(
                        new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
                testInsert.personPerson(
                        be.businessentityid(), "EM", new FirstName(name), Optional.empty(),
                        Optional.empty(), new Name("MinMaxTest"), Optional.empty(), Optional.empty(),
                        Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                        new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            }
            ...
            for (String name : scNames) {
                var be = testInsert.personBusinessentity(
                        new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
                testInsert.personPerson(
                        be.businessentityid(), "SC", new FirstName(name), Optional.empty(),
                        Optional.empty(), new Name("MinMaxTest"), Optional.empty(), Optional.empty(),
                        Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                        new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            }
    ...
    /**
     * Test GROUP BY then JOIN with SQL-backed repositories.
     * This verifies that grouped results can be joined with other tables.
     */
    @Test
    public void groupByThenJoinOnSql() {
        WithConnection.run(c -> {
            ...
            var dept1 = testInsert.humanresourcesDepartment(
                    new Name("Engineering"), new Name("Research and Development"),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            var dept2 = testInsert.humanresourcesDepartment(
                    new Name("Sales"), new Name("Sales and Marketing"),
                    new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            ...
            for (int i = 0; i < 3; i++) {
                var be = testInsert.personBusinessentity(
                        new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
                testInsert.personPerson(
                        be.businessentityid(), "EM", new FirstName("Emp" + i), Optional.empty(),
                        Optional.empty(), new Name("JoinTest"), Optional.empty(), Optional.empty(),
                        Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                        new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            }
            for (int i = 0; i < 2; i++) {
                var be = testInsert.personBusinessentity(
                        new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
                testInsert.personPerson(
                        be.businessentityid(), "SC", new FirstName("Cust" + i), Optional.empty(),
                        Optional.empty(), new Name("JoinTest"), Optional.empty(), Optional.empty(),
                        Optional.empty(), new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(),
                        new Defaulted.UseDefault<>(), new Defaulted.UseDefault<>(), c);
            }
            ...
            var grouped = personRepoImpl.select()
            ...
            var joined = grouped.joinOn(
                    deptRepo.select().where(d -> d.name().isEqual(new Name("Engineering")).or(d.name().isEqual(new Name("Sales")), Bijection.asBool())),
                    tuple -> new SqlExpr.ConstReq<>(true, typo.runtime.PgTypes.bool)
            );
            ...
            var emResult = results.stream()
                    .filter(r -> "EM".equals(r._1()._1()))
                    .findFirst()
                    .orElseThrow();
            assertEquals(Long.valueOf(3), emResult._1()._2());

            var scResult = results.stream()
                    .filter(r -> "SC".equals(r._1()._1()))
                    .findFirst()
                    .orElseThrow();
