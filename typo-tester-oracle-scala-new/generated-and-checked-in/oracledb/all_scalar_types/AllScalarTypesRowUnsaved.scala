...
case class AllScalarTypesRowUnsaved(
  @JsonProperty("COL_VARCHAR2") colVarchar2: Option[String] = None,
  @JsonProperty("COL_NUMBER") colNumber: Option[BigDecimal] = None,
  @JsonProperty("COL_DATE") colDate: Option[LocalDateTime] = None,
  @JsonProperty("COL_TIMESTAMP") colTimestamp: Option[LocalDateTime] = None,
  @JsonProperty("COL_CLOB") colClob: Option[String] = None,
