...
You can clone the [repo](https://github.com/oyvindberg/typr) and run `bleep compile-benchmarks` to reproduce the results.
The benchmark code can be found in [CompileBenchmark.scala](https://github.com/oyvindberg/typr/blob/main/typr-scripts/src/scala/scripts/CompileBenchmark.scala)
