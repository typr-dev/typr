...
If you're not happy with the types PostgreSQL and Typr has ended up with for a given column, you can override it.

This is referred to within Typr as a [user-selected type](../type-safety/user-selected-types.md).
