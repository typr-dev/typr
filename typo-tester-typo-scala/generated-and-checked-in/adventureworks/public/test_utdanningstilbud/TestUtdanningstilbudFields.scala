...
trait TestUtdanningstilbudFields extends FieldsExpr[TestUtdanningstilbudRow] {
  ...
  def fkTestOrganisasjon: ForeignKey[TestOrganisasjonFields, TestOrganisasjonRow] = ForeignKey.of[TestOrganisasjonFields, TestOrganisasjonRow]("public.test_utdanningstilbud_organisasjonskode_fkey").withColumnPair(organisasjonskode, _.organisasjonskode)
