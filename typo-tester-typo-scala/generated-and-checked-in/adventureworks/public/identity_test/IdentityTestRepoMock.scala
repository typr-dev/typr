...
case class IdentityTestRepoMock(
  ...
  override def select: SelectBuilder[IdentityTestFields, IdentityTestRow] = new SelectBuilderMock(IdentityTestFields.structure, () => new ArrayList(map.values()), SelectParams.empty())
