...
object DepartmentRow {
  val `_rowParser`: RowParser[DepartmentRow] = RowParsers.of(DepartmentId.pgType, Name.pgType, Name.pgType, TypoLocalDateTime.pgType, DepartmentRow.apply, row => Array[Object](row.departmentid.asInstanceOf[Object], row.name.asInstanceOf[Object], row.groupname.asInstanceOf[Object], row.modifieddate.asInstanceOf[Object]))
