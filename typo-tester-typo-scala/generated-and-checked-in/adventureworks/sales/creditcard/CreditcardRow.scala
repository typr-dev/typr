...
object CreditcardRow {
  val `_rowParser`: RowParser[CreditcardRow] = RowParsers.of(CustomCreditcardId.pgType, PgTypes.text, PgTypes.text, TypoShort.pgType, TypoShort.pgType, TypoLocalDateTime.pgType, CreditcardRow.apply, row => Array[Object](row.creditcardid.asInstanceOf[Object], row.cardtype.asInstanceOf[Object], row.cardnumber.asInstanceOf[Object], row.expmonth.asInstanceOf[Object], row.expyear.asInstanceOf[Object], row.modifieddate.asInstanceOf[Object]))
