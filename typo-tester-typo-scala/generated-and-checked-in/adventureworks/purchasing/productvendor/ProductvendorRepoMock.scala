...
case class ProductvendorRepoMock(
  ...
  override def select: SelectBuilder[ProductvendorFields, ProductvendorRow] = new SelectBuilderMock(ProductvendorFields.structure, () => new ArrayList(map.values()), SelectParams.empty())
