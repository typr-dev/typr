...
case class ProductmodelillustrationRepoMock(
  ...
  override def select: SelectBuilder[ProductmodelillustrationFields, ProductmodelillustrationRow] = new SelectBuilderMock(ProductmodelillustrationFields.structure, () => new ArrayList(map.values()), SelectParams.empty())
