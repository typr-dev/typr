...
case class TestInsert(
  ...
  def publicPgtestnull(
    ...
    int2: Optional[TypoShort] = if (random.nextBoolean()) Optional.empty() else Optional.of(TypoShort(random.nextInt(Short.MaxValue).toShort)),
    ...
    int2es: Optional[Array[TypoShort]] = if (random.nextBoolean()) Optional.empty() else Optional.of(Array.fill(random.nextInt(3))(TypoShort(random.nextInt(Short.MaxValue).toShort))),
