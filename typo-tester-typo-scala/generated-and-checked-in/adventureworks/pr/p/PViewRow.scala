...
object PViewRow {
  val `_rowParser`: RowParser[PViewRow] = RowParsers.of(ProductId.pgType, ProductId.pgType, Name.pgType, PgTypes.text, Flag.pgType, Flag.pgType, PgTypes.text.opt(), TypoShort.pgType, TypoShort.pgType, PgTypes.numeric, PgTypes.numeric, PgTypes.text.opt(), UnitmeasureId.pgType.opt(), UnitmeasureId.pgType.opt(), PgTypes.numeric.opt(), PgTypes.int4, PgTypes.bpchar.opt(), PgTypes.bpchar.opt(), PgTypes.bpchar.opt(), ProductsubcategoryId.pgType.opt(), ProductmodelId.pgType.opt(), TypoLocalDateTime.pgType, TypoLocalDateTime.pgType.opt(), TypoLocalDateTime.pgType.opt(), TypoUUID.pgType, TypoLocalDateTime.pgType, PViewRow.apply, row => Array[Object](row.id.asInstanceOf[Object], row.productid.asInstanceOf[Object], row.name.asInstanceOf[Object], row.productnumber.asInstanceOf[Object], row.makeflag.asInstanceOf[Object], row.finishedgoodsflag.asInstanceOf[Object], row.color.asInstanceOf[Object], row.safetystocklevel.asInstanceOf[Object], row.reorderpoint.asInstanceOf[Object], row.standardcost.asInstanceOf[Object], row.listprice.asInstanceOf[Object], row.size.asInstanceOf[Object], row.sizeunitmeasurecode.asInstanceOf[Object], row.weightunitmeasurecode.asInstanceOf[Object], row.weight.asInstanceOf[Object], row.daystomanufacture.asInstanceOf[Object], row.productline.asInstanceOf[Object], row.`class`.asInstanceOf[Object], row.style.asInstanceOf[Object], row.productsubcategoryid.asInstanceOf[Object], row.productmodelid.asInstanceOf[Object], row.sellstartdate.asInstanceOf[Object], row.sellenddate.asInstanceOf[Object], row.discontinueddate.asInstanceOf[Object], row.rowguid.asInstanceOf[Object], row.modifieddate.asInstanceOf[Object]))
}