...
object VstateprovincecountryregionMVRow {
  val `_rowParser`: RowParser[VstateprovincecountryregionMVRow] = RowParsers.of(StateprovinceId.pgType, PgTypes.bpchar, Flag.pgType, Name.pgType, SalesterritoryId.pgType, CountryregionId.pgType, Name.pgType, VstateprovincecountryregionMVRow.apply, row => Array[Object](row.stateprovinceid.asInstanceOf[Object], row.stateprovincecode.asInstanceOf[Object], row.isonlystateprovinceflag.asInstanceOf[Object], row.stateprovincename.asInstanceOf[Object], row.territoryid.asInstanceOf[Object], row.countryregioncode.asInstanceOf[Object], row.countryregionname.asInstanceOf[Object]))
}