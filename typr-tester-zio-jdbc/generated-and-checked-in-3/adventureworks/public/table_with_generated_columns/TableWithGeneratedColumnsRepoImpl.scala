...
class TableWithGeneratedColumnsRepoImpl extends TableWithGeneratedColumnsRepo {
  ...
  override def deleteById(name: TableWithGeneratedColumnsId): ZIO[ZConnection, Throwable, Boolean] = sql"""delete from "public"."table-with-generated-columns" where "name" = ${Segment.paramSegment(name)(using TableWithGeneratedColumnsId.setter)}""".delete.map(_ > 0)

  override def deleteByIds(names: Array[TableWithGeneratedColumnsId]): ZIO[ZConnection, Throwable, Long] = sql"""delete from "public"."table-with-generated-columns" where "name" = ANY(${Segment.paramSegment(names)(using TableWithGeneratedColumnsId.arraySetter)})""".delete
  ...
  override def selectAll: ZStream[ZConnection, Throwable, TableWithGeneratedColumnsRow] = sql"""select "name", "name-type-always" from "public"."table-with-generated-columns"""".query(using TableWithGeneratedColumnsRow.jdbcDecoder).selectStream()
