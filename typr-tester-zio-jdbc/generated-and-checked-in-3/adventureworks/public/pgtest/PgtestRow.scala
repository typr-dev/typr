...
object PgtestRow {
  given jdbcDecoder: JdbcDecoder[PgtestRow] = {
  ...
  given jsonDecoder: JsonDecoder[PgtestRow] = {
    JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
      val bool = jsonObj.get("bool").toRight("Missing field 'bool'").flatMap(_.as(using JsonDecoder.boolean))
      val box = jsonObj.get("box").toRight("Missing field 'box'").flatMap(_.as(using TypoBox.jsonDecoder))
      val bpchar = jsonObj.get("bpchar").toRight("Missing field 'bpchar'").flatMap(_.as(using JsonDecoder.string))
      val bytea = jsonObj.get("bytea").toRight("Missing field 'bytea'").flatMap(_.as(using TypoBytea.jsonDecoder))
      val char = jsonObj.get("char").toRight("Missing field 'char'").flatMap(_.as(using JsonDecoder.string))
      val circle = jsonObj.get("circle").toRight("Missing field 'circle'").flatMap(_.as(using TypoCircle.jsonDecoder))
      val date = jsonObj.get("date").toRight("Missing field 'date'").flatMap(_.as(using TypoLocalDate.jsonDecoder))
      val float4 = jsonObj.get("float4").toRight("Missing field 'float4'").flatMap(_.as(using JsonDecoder.float))
      val float8 = jsonObj.get("float8").toRight("Missing field 'float8'").flatMap(_.as(using JsonDecoder.double))
      val hstore = jsonObj.get("hstore").toRight("Missing field 'hstore'").flatMap(_.as(using TypoHStore.jsonDecoder))
      val inet = jsonObj.get("inet").toRight("Missing field 'inet'").flatMap(_.as(using TypoInet.jsonDecoder))
      val int2 = jsonObj.get("int2").toRight("Missing field 'int2'").flatMap(_.as(using TypoShort.jsonDecoder))
      val int2vector = jsonObj.get("int2vector").toRight("Missing field 'int2vector'").flatMap(_.as(using TypoInt2Vector.jsonDecoder))
      val int4 = jsonObj.get("int4").toRight("Missing field 'int4'").flatMap(_.as(using JsonDecoder.int))
      val int8 = jsonObj.get("int8").toRight("Missing field 'int8'").flatMap(_.as(using JsonDecoder.long))
      val interval = jsonObj.get("interval").toRight("Missing field 'interval'").flatMap(_.as(using TypoInterval.jsonDecoder))
      val json = jsonObj.get("json").toRight("Missing field 'json'").flatMap(_.as(using TypoJson.jsonDecoder))
      val jsonb = jsonObj.get("jsonb").toRight("Missing field 'jsonb'").flatMap(_.as(using TypoJsonb.jsonDecoder))
      val line = jsonObj.get("line").toRight("Missing field 'line'").flatMap(_.as(using TypoLine.jsonDecoder))
      val lseg = jsonObj.get("lseg").toRight("Missing field 'lseg'").flatMap(_.as(using TypoLineSegment.jsonDecoder))
      val money = jsonObj.get("money").toRight("Missing field 'money'").flatMap(_.as(using TypoMoney.jsonDecoder))
      val mydomain = jsonObj.get("mydomain").toRight("Missing field 'mydomain'").flatMap(_.as(using Mydomain.jsonDecoder))
      val myenum = jsonObj.get("myenum").toRight("Missing field 'myenum'").flatMap(_.as(using Myenum.jsonDecoder))
      val name = jsonObj.get("name").toRight("Missing field 'name'").flatMap(_.as(using JsonDecoder.string))
      val numeric = jsonObj.get("numeric").toRight("Missing field 'numeric'").flatMap(_.as(using JsonDecoder.scalaBigDecimal))
      val path = jsonObj.get("path").toRight("Missing field 'path'").flatMap(_.as(using TypoPath.jsonDecoder))
      val point = jsonObj.get("point").toRight("Missing field 'point'").flatMap(_.as(using TypoPoint.jsonDecoder))
      val polygon = jsonObj.get("polygon").toRight("Missing field 'polygon'").flatMap(_.as(using TypoPolygon.jsonDecoder))
      val text = jsonObj.get("text").toRight("Missing field 'text'").flatMap(_.as(using JsonDecoder.string))
      val time = jsonObj.get("time").toRight("Missing field 'time'").flatMap(_.as(using TypoLocalTime.jsonDecoder))
      val timestamp = jsonObj.get("timestamp").toRight("Missing field 'timestamp'").flatMap(_.as(using TypoLocalDateTime.jsonDecoder))
      val timestampz = jsonObj.get("timestampz").toRight("Missing field 'timestampz'").flatMap(_.as(using TypoInstant.jsonDecoder))
      val timez = jsonObj.get("timez").toRight("Missing field 'timez'").flatMap(_.as(using TypoOffsetTime.jsonDecoder))
      val uuid = jsonObj.get("uuid").toRight("Missing field 'uuid'").flatMap(_.as(using TypoUUID.jsonDecoder))
      val varchar = jsonObj.get("varchar").toRight("Missing field 'varchar'").flatMap(_.as(using JsonDecoder.string))
      val vector = jsonObj.get("vector").toRight("Missing field 'vector'").flatMap(_.as(using TypoVector.jsonDecoder))
      val xml = jsonObj.get("xml").toRight("Missing field 'xml'").flatMap(_.as(using TypoXml.jsonDecoder))
      val boxes = jsonObj.get("boxes").toRight("Missing field 'boxes'").flatMap(_.as(using JsonDecoder.array[TypoBox](using TypoBox.jsonDecoder, implicitly)))
      val bpchares = jsonObj.get("bpchares").toRight("Missing field 'bpchares'").flatMap(_.as(using JsonDecoder.array[String](using JsonDecoder.string, implicitly)))
      val chares = jsonObj.get("chares").toRight("Missing field 'chares'").flatMap(_.as(using JsonDecoder.array[String](using JsonDecoder.string, implicitly)))
      val circlees = jsonObj.get("circlees").toRight("Missing field 'circlees'").flatMap(_.as(using JsonDecoder.array[TypoCircle](using TypoCircle.jsonDecoder, implicitly)))
      val datees = jsonObj.get("datees").toRight("Missing field 'datees'").flatMap(_.as(using JsonDecoder.array[TypoLocalDate](using TypoLocalDate.jsonDecoder, implicitly)))
      val float4es = jsonObj.get("float4es").toRight("Missing field 'float4es'").flatMap(_.as(using JsonDecoder.array[Float](using JsonDecoder.float, implicitly)))
      val float8es = jsonObj.get("float8es").toRight("Missing field 'float8es'").flatMap(_.as(using JsonDecoder.array[Double](using JsonDecoder.double, implicitly)))
      val inetes = jsonObj.get("inetes").toRight("Missing field 'inetes'").flatMap(_.as(using JsonDecoder.array[TypoInet](using TypoInet.jsonDecoder, implicitly)))
      val int2es = jsonObj.get("int2es").toRight("Missing field 'int2es'").flatMap(_.as(using JsonDecoder.array[TypoShort](using TypoShort.jsonDecoder, implicitly)))
      val int2vectores = jsonObj.get("int2vectores").toRight("Missing field 'int2vectores'").flatMap(_.as(using JsonDecoder.array[TypoInt2Vector](using TypoInt2Vector.jsonDecoder, implicitly)))
      val int4es = jsonObj.get("int4es").toRight("Missing field 'int4es'").flatMap(_.as(using JsonDecoder.array[Int](using JsonDecoder.int, implicitly)))
      val int8es = jsonObj.get("int8es").toRight("Missing field 'int8es'").flatMap(_.as(using JsonDecoder.array[Long](using JsonDecoder.long, implicitly)))
      val intervales = jsonObj.get("intervales").toRight("Missing field 'intervales'").flatMap(_.as(using JsonDecoder.array[TypoInterval](using TypoInterval.jsonDecoder, implicitly)))
      val jsones = jsonObj.get("jsones").toRight("Missing field 'jsones'").flatMap(_.as(using JsonDecoder.array[TypoJson](using TypoJson.jsonDecoder, implicitly)))
      val jsonbes = jsonObj.get("jsonbes").toRight("Missing field 'jsonbes'").flatMap(_.as(using JsonDecoder.array[TypoJsonb](using TypoJsonb.jsonDecoder, implicitly)))
      val linees = jsonObj.get("linees").toRight("Missing field 'linees'").flatMap(_.as(using JsonDecoder.array[TypoLine](using TypoLine.jsonDecoder, implicitly)))
      val lseges = jsonObj.get("lseges").toRight("Missing field 'lseges'").flatMap(_.as(using JsonDecoder.array[TypoLineSegment](using TypoLineSegment.jsonDecoder, implicitly)))
      val moneyes = jsonObj.get("moneyes").toRight("Missing field 'moneyes'").flatMap(_.as(using JsonDecoder.array[TypoMoney](using TypoMoney.jsonDecoder, implicitly)))
      val mydomaines = jsonObj.get("mydomaines").toRight("Missing field 'mydomaines'").flatMap(_.as(using JsonDecoder.array[Mydomain](using Mydomain.jsonDecoder, implicitly)))
      val myenumes = jsonObj.get("myenumes").toRight("Missing field 'myenumes'").flatMap(_.as(using JsonDecoder.array[Myenum](using Myenum.jsonDecoder, implicitly)))
      val namees = jsonObj.get("namees").toRight("Missing field 'namees'").flatMap(_.as(using JsonDecoder.array[String](using JsonDecoder.string, implicitly)))
      val numerices = jsonObj.get("numerices").toRight("Missing field 'numerices'").flatMap(_.as(using JsonDecoder.array[BigDecimal](using JsonDecoder.scalaBigDecimal, implicitly)))
      val pathes = jsonObj.get("pathes").toRight("Missing field 'pathes'").flatMap(_.as(using JsonDecoder.array[TypoPath](using TypoPath.jsonDecoder, implicitly)))
      val pointes = jsonObj.get("pointes").toRight("Missing field 'pointes'").flatMap(_.as(using JsonDecoder.array[TypoPoint](using TypoPoint.jsonDecoder, implicitly)))
      val polygones = jsonObj.get("polygones").toRight("Missing field 'polygones'").flatMap(_.as(using JsonDecoder.array[TypoPolygon](using TypoPolygon.jsonDecoder, implicitly)))
      val textes = jsonObj.get("textes").toRight("Missing field 'textes'").flatMap(_.as(using JsonDecoder.array[String](using JsonDecoder.string, implicitly)))
      val timees = jsonObj.get("timees").toRight("Missing field 'timees'").flatMap(_.as(using JsonDecoder.array[TypoLocalTime](using TypoLocalTime.jsonDecoder, implicitly)))
      val timestampes = jsonObj.get("timestampes").toRight("Missing field 'timestampes'").flatMap(_.as(using JsonDecoder.array[TypoLocalDateTime](using TypoLocalDateTime.jsonDecoder, implicitly)))
      val timestampzes = jsonObj.get("timestampzes").toRight("Missing field 'timestampzes'").flatMap(_.as(using JsonDecoder.array[TypoInstant](using TypoInstant.jsonDecoder, implicitly)))
      val timezes = jsonObj.get("timezes").toRight("Missing field 'timezes'").flatMap(_.as(using JsonDecoder.array[TypoOffsetTime](using TypoOffsetTime.jsonDecoder, implicitly)))
      val uuides = jsonObj.get("uuides").toRight("Missing field 'uuides'").flatMap(_.as(using JsonDecoder.array[TypoUUID](using TypoUUID.jsonDecoder, implicitly)))
      val varchares = jsonObj.get("varchares").toRight("Missing field 'varchares'").flatMap(_.as(using JsonDecoder.array[String](using JsonDecoder.string, implicitly)))
      val xmles = jsonObj.get("xmles").toRight("Missing field 'xmles'").flatMap(_.as(using JsonDecoder.array[TypoXml](using TypoXml.jsonDecoder, implicitly)))
  ...
  given jsonEncoder: JsonEncoder[PgtestRow] = {
