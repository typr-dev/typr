...
class TestOrganisasjonRepoImpl extends TestOrganisasjonRepo {
  ...
  override def deleteById(organisasjonskode: TestOrganisasjonId): ZIO[ZConnection, Throwable, Boolean] = sql"""delete from "public"."test_organisasjon" where "organisasjonskode" = ${Segment.paramSegment(organisasjonskode)(using TestOrganisasjonId.setter)}""".delete.map(_ > 0)

  override def deleteByIds(organisasjonskodes: Array[TestOrganisasjonId]): ZIO[ZConnection, Throwable, Long] = sql"""delete from "public"."test_organisasjon" where "organisasjonskode" = ANY(${Segment.paramSegment(organisasjonskodes)(using TestOrganisasjonId.arraySetter)})""".delete
  ...
  override def insert(unsaved: TestOrganisasjonRow): ZIO[ZConnection, Throwable, TestOrganisasjonRow] = {
    ...
    values (${Segment.paramSegment(unsaved.organisasjonskode)(using TestOrganisasjonId.setter)})
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  ): ZIO[ZConnection, Throwable, Long] = streamingInsert(s"""COPY "public"."test_organisasjon"("organisasjonskode") FROM STDIN""", batchSize, unsaved)(using TestOrganisasjonRow.pgText)
  ...
  override def selectAll: ZStream[ZConnection, Throwable, TestOrganisasjonRow] = sql"""select "organisasjonskode" from "public"."test_organisasjon"""".query(using TestOrganisasjonRow.jdbcDecoder).selectStream()

  override def selectById(organisasjonskode: TestOrganisasjonId): ZIO[ZConnection, Throwable, Option[TestOrganisasjonRow]] = sql"""select "organisasjonskode" from "public"."test_organisasjon" where "organisasjonskode" = ${Segment.paramSegment(organisasjonskode)(using TestOrganisasjonId.setter)}""".query(using TestOrganisasjonRow.jdbcDecoder).selectOne

  override def selectByIds(organisasjonskodes: Array[TestOrganisasjonId]): ZStream[ZConnection, Throwable, TestOrganisasjonRow] = sql"""select "organisasjonskode" from "public"."test_organisasjon" where "organisasjonskode" = ANY(${Segment.paramSegment(organisasjonskodes)(using TestOrganisasjonId.arraySetter)})""".query(using TestOrganisasjonRow.jdbcDecoder).selectStream()
  ...
  override def upsertStreaming(
    ...
    val copied = streamingInsert(s"""copy test_organisasjon_TEMP("organisasjonskode") from stdin""", batchSize, unsaved)(using TestOrganisasjonRow.pgText)
