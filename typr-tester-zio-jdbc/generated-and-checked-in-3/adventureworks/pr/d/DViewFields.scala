...
trait DViewFields {
  ...
  def document: Field[TypoBytea, DViewRow]
...
object DViewFields {
  lazy val structure: RelationStructure[DViewFields, DViewRow] =
    new Impl(List())

  private final class Impl(val _path: List[Path])
    extends RelationStructure[DViewFields, DViewRow] {

    override lazy val fields: DViewFields = new DViewFields {
      override def title = Field[String, DViewRow](_path, "title", None, None, x => x.title, (row, value) => row.copy(title = value))
      ...
      override def filename = Field[String, DViewRow](_path, "filename", None, None, x => x.filename, (row, value) => row.copy(filename = value))
      override def fileextension = Field[String, DViewRow](_path, "fileextension", None, None, x => x.fileextension, (row, value) => row.copy(fileextension = value))
      override def revision = Field[String, DViewRow](_path, "revision", None, None, x => x.revision, (row, value) => row.copy(revision = value))
      ...
      override def documentsummary = Field[String, DViewRow](_path, "documentsummary", None, None, x => x.documentsummary, (row, value) => row.copy(documentsummary = value))
      override def document = Field[TypoBytea, DViewRow](_path, "document", None, None, x => x.document, (row, value) => row.copy(document = value))
