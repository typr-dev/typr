...
object VjobcandidateemploymentViewRow {
  ...
  given jsonDecoder: JsonDecoder[VjobcandidateemploymentViewRow] = {
    JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
      ...
      val empStartDate = jsonObj.get("Emp.StartDate").toRight("Missing field 'Emp.StartDate'").flatMap(_.as(using TypoLocalDate.jsonDecoder))
      val empEndDate = jsonObj.get("Emp.EndDate").toRight("Missing field 'Emp.EndDate'").flatMap(_.as(using TypoLocalDate.jsonDecoder))
      val empOrgName = jsonObj.get("Emp.OrgName").toRight("Missing field 'Emp.OrgName'").flatMap(_.as(using JsonDecoder.string))
      val empJobTitle = jsonObj.get("Emp.JobTitle").toRight("Missing field 'Emp.JobTitle'").flatMap(_.as(using JsonDecoder.string))
      val empResponsibility = jsonObj.get("Emp.Responsibility").toRight("Missing field 'Emp.Responsibility'").flatMap(_.as(using JsonDecoder.string))
      val empFunctionCategory = jsonObj.get("Emp.FunctionCategory").toRight("Missing field 'Emp.FunctionCategory'").flatMap(_.as(using JsonDecoder.string))
      val empIndustryCategory = jsonObj.get("Emp.IndustryCategory").toRight("Missing field 'Emp.IndustryCategory'").flatMap(_.as(using JsonDecoder.string))
      val empLocCountryRegion = jsonObj.get("Emp.Loc.CountryRegion").toRight("Missing field 'Emp.Loc.CountryRegion'").flatMap(_.as(using JsonDecoder.string))
      val empLocState = jsonObj.get("Emp.Loc.State").toRight("Missing field 'Emp.Loc.State'").flatMap(_.as(using JsonDecoder.string))
      val empLocCity = jsonObj.get("Emp.Loc.City").toRight("Missing field 'Emp.Loc.City'").flatMap(_.as(using JsonDecoder.string))
