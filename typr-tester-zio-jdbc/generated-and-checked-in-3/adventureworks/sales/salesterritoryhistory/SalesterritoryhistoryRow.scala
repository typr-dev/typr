...
object SalesterritoryhistoryRow {
  ...
  given jdbcDecoder: JdbcDecoder[SalesterritoryhistoryRow] = {
  ...
  given jsonDecoder: JsonDecoder[SalesterritoryhistoryRow] = {
  ...
  given jsonEncoder: JsonEncoder[SalesterritoryhistoryRow] = {
