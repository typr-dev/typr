...
object VstorewithaddressesViewRow {
  given jdbcDecoder: JdbcDecoder[VstorewithaddressesViewRow] = {
  ...
  given jsonDecoder: JsonDecoder[VstorewithaddressesViewRow] = {
  ...
  given jsonEncoder: JsonEncoder[VstorewithaddressesViewRow] = {
