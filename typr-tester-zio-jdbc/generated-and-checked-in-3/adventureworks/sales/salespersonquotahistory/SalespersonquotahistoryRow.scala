...
object SalespersonquotahistoryRow {
  ...
  given jdbcDecoder: JdbcDecoder[SalespersonquotahistoryRow] = {
  ...
  given jsonDecoder: JsonDecoder[SalespersonquotahistoryRow] = {
  ...
  given jsonEncoder: JsonEncoder[SalespersonquotahistoryRow] = {
