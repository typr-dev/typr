...
trait CountryregioncurrencyFields {
  ...
  def compositeIdIn(compositeIds: Array[CountryregioncurrencyId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[CountryregioncurrencyId](countryregioncode)(_.countryregioncode)(using as[Array[CountryregionId]](using CountryregionId.arrayJdbcEncoder, PGType.forArray(using CountryregionId.pgType)), implicitly), TuplePart[CountryregioncurrencyId](currencycode)(_.currencycode)(using as[Array[CurrencyId]](using CurrencyId.arrayJdbcEncoder, PGType.forArray(using CurrencyId.pgType)), implicitly))
