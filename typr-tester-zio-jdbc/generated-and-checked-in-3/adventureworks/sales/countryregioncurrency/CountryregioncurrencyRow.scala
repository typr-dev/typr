...
object CountryregioncurrencyRow {
  ...
  given jdbcDecoder: JdbcDecoder[CountryregioncurrencyRow] = {
  ...
  given jsonDecoder: JsonDecoder[CountryregioncurrencyRow] = {
  ...
  given jsonEncoder: JsonEncoder[CountryregioncurrencyRow] = {
