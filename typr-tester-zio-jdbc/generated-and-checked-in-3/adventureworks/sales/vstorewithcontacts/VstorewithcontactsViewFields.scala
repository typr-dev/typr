...
object VstorewithcontactsViewFields {
  lazy val structure: RelationStructure[VstorewithcontactsViewFields, VstorewithcontactsViewRow] =
    new Impl(List())

  private final class Impl(val _path: List[Path])
    extends RelationStructure[VstorewithcontactsViewFields, VstorewithcontactsViewRow] {
    ...
    override lazy val fields: VstorewithcontactsViewFields = new VstorewithcontactsViewFields {
      ...
      override def title = Field[String, VstorewithcontactsViewRow](_path, "title", None, None, x => x.title, (row, value) => row.copy(title = value))
      ...
      override def middlename = Field[Name, VstorewithcontactsViewRow](_path, "middlename", None, None, x => x.middlename, (row, value) => row.copy(middlename = value))
      ...
      override def suffix = Field[String, VstorewithcontactsViewRow](_path, "suffix", None, None, x => x.suffix, (row, value) => row.copy(suffix = value))
      override def phonenumber = Field[Phone, VstorewithcontactsViewRow](_path, "phonenumber", None, None, x => x.phonenumber, (row, value) => row.copy(phonenumber = value))
      override def phonenumbertype = Field[Name, VstorewithcontactsViewRow](_path, "phonenumbertype", None, None, x => x.phonenumbertype, (row, value) => row.copy(phonenumbertype = value))
      override def emailaddress = Field[String, VstorewithcontactsViewRow](_path, "emailaddress", None, None, x => x.emailaddress, (row, value) => row.copy(emailaddress = value))
