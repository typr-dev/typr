...
class ShoppingcartitemRepoImpl extends ShoppingcartitemRepo {
  ...
  override def upsertStreaming(
    ...
    val copied = streamingInsert(s"""copy shoppingcartitem_TEMP("shoppingcartitemid", "shoppingcartid", "quantity", "productid", "datecreated", "modifieddate") from stdin""", batchSize, unsaved)(using ShoppingcartitemRow.pgText)
