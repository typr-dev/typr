...
object SalesorderheadersalesreasonRow {
  ...
  given jdbcDecoder: JdbcDecoder[SalesorderheadersalesreasonRow] = {
  ...
  given jsonDecoder: JsonDecoder[SalesorderheadersalesreasonRow] = {
  ...
  given jsonEncoder: JsonEncoder[SalesorderheadersalesreasonRow] = {
