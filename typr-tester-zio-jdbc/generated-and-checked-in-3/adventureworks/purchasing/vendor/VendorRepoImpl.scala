...
class VendorRepoImpl extends VendorRepo {
  ...
  override def deleteById(businessentityid: BusinessentityId): ZIO[ZConnection, Throwable, Boolean] = sql"""delete from "purchasing"."vendor" where "businessentityid" = ${Segment.paramSegment(businessentityid)(using BusinessentityId.setter)}""".delete.map(_ > 0)

  override def deleteByIds(businessentityids: Array[BusinessentityId]): ZIO[ZConnection, Throwable, Long] = sql"""delete from "purchasing"."vendor" where "businessentityid" = ANY(${Segment.paramSegment(businessentityids)(using BusinessentityId.arraySetter)})""".delete
  ...
  override def insert(unsaved: VendorRow): ZIO[ZConnection, Throwable, VendorRow] = {
    ...
    values (${Segment.paramSegment(unsaved.businessentityid)(using BusinessentityId.setter)}::int4, ${Segment.paramSegment(unsaved.accountnumber)(using AccountNumber.setter)}::varchar, ${Segment.paramSegment(unsaved.name)(using Name.setter)}::varchar, ${Segment.paramSegment(unsaved.creditrating)(using TypoShort.setter)}::int2, ${Segment.paramSegment(unsaved.preferredvendorstatus)(using Flag.setter)}::bool, ${Segment.paramSegment(unsaved.activeflag)(using Flag.setter)}::bool, ${Segment.paramSegment(unsaved.purchasingwebserviceurl)(using Setter.optionParamSetter(using Setter.stringSetter))}, ${Segment.paramSegment(unsaved.modifieddate)(using TypoLocalDateTime.setter)}::timestamp)
  ...
  override def insert(unsaved: VendorRowUnsaved): ZIO[ZConnection, Throwable, VendorRow] = {
    val fs = List(
      ...
      Some((sql""""accountnumber"""", sql"${Segment.paramSegment(unsaved.accountnumber)(using AccountNumber.setter)}::varchar")),
      Some((sql""""name"""", sql"${Segment.paramSegment(unsaved.name)(using Name.setter)}::varchar")),
      Some((sql""""creditrating"""", sql"${Segment.paramSegment(unsaved.creditrating)(using TypoShort.setter)}::int2")),
      Some((sql""""purchasingwebserviceurl"""", sql"${Segment.paramSegment(unsaved.purchasingwebserviceurl)(using Setter.optionParamSetter(using Setter.stringSetter))}")),
      unsaved.preferredvendorstatus match {
        case Defaulted.UseDefault() => None
        case Defaulted.Provided(value) => Some((sql""""preferredvendorstatus"""", sql"${Segment.paramSegment(value: Flag)(using Flag.setter)}::bool"))
      },
      unsaved.activeflag match {
        case Defaulted.UseDefault() => None
        case Defaulted.Provided(value) => Some((sql""""activeflag"""", sql"${Segment.paramSegment(value: Flag)(using Flag.setter)}::bool"))
      },
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  ): ZIO[ZConnection, Throwable, Long] = streamingInsert(s"""COPY "purchasing"."vendor"("businessentityid", "accountnumber", "name", "creditrating", "preferredvendorstatus", "activeflag", "purchasingwebserviceurl", "modifieddate") FROM STDIN""", batchSize, unsaved)(using VendorRow.pgText)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: ZStream[ZConnection, Throwable, VendorRowUnsaved],
    batchSize: Int = 10000
  ): ZIO[ZConnection, Throwable, Long] = streamingInsert(s"""COPY "purchasing"."vendor"("businessentityid", "accountnumber", "name", "creditrating", "purchasingwebserviceurl", "preferredvendorstatus", "activeflag", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using VendorRowUnsaved.pgText)
  ...
  override def update(row: VendorRow): ZIO[ZConnection, Throwable, Option[VendorRow]] = {
    ...
    set "accountnumber" = ${Segment.paramSegment(row.accountnumber)(using AccountNumber.setter)}::varchar,
    "name" = ${Segment.paramSegment(row.name)(using Name.setter)}::varchar,
    "creditrating" = ${Segment.paramSegment(row.creditrating)(using TypoShort.setter)}::int2,
    "preferredvendorstatus" = ${Segment.paramSegment(row.preferredvendorstatus)(using Flag.setter)}::bool,
    "activeflag" = ${Segment.paramSegment(row.activeflag)(using Flag.setter)}::bool,
    "purchasingwebserviceurl" = ${Segment.paramSegment(row.purchasingwebserviceurl)(using Setter.optionParamSetter(using Setter.stringSetter))},
    ...
    returning "businessentityid", "accountnumber", "name", "creditrating", "preferredvendorstatus", "activeflag", "purchasingwebserviceurl", "modifieddate"::text"""
      .query(using VendorRow.jdbcDecoder)
      .selectOne
  }
  ...
  override def upsert(unsaved: VendorRow): ZIO[ZConnection, Throwable, UpdateResult[VendorRow]] = {
    ...
    ${Segment.paramSegment(unsaved.accountnumber)(using AccountNumber.setter)}::varchar,
    ${Segment.paramSegment(unsaved.name)(using Name.setter)}::varchar,
    ${Segment.paramSegment(unsaved.creditrating)(using TypoShort.setter)}::int2,
    ${Segment.paramSegment(unsaved.preferredvendorstatus)(using Flag.setter)}::bool,
    ${Segment.paramSegment(unsaved.activeflag)(using Flag.setter)}::bool,
    ${Segment.paramSegment(unsaved.purchasingwebserviceurl)(using Setter.optionParamSetter(using Setter.stringSetter))},
  ...
  override def upsertStreaming(
    ...
    val copied = streamingInsert(s"""copy vendor_TEMP("businessentityid", "accountnumber", "name", "creditrating", "preferredvendorstatus", "activeflag", "purchasingwebserviceurl", "modifieddate") from stdin""", batchSize, unsaved)(using VendorRow.pgText)
