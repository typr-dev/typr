...
class ShipmethodRepoImpl extends ShipmethodRepo {
  ...
  override def upsertStreaming(
    ...
    val copied = streamingInsert(s"""copy shipmethod_TEMP("shipmethodid", "name", "shipbase", "shiprate", "rowguid", "modifieddate") from stdin""", batchSize, unsaved)(using ShipmethodRow.pgText)
