...
trait ProductvendorFields {
  ...
  def compositeIdIn(compositeIds: Array[ProductvendorId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[ProductvendorId](productid)(_.productid)(using as[Array[ProductId]](using ProductId.arrayJdbcEncoder, PGType.forArray(using ProductId.pgType)), implicitly), TuplePart[ProductvendorId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId]](using BusinessentityId.arrayJdbcEncoder, PGType.forArray(using BusinessentityId.pgType)), implicitly))
