...
object PurchaseorderheaderRowUnsaved {
  given jsonDecoder: JsonDecoder[PurchaseorderheaderRowUnsaved] = {
    JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
      val employeeid = jsonObj.get("employeeid").toRight("Missing field 'employeeid'").flatMap(_.as(using BusinessentityId.jsonDecoder))
      ...
      val purchaseorderid = jsonObj.get("purchaseorderid").toRight("Missing field 'purchaseorderid'").flatMap(_.as(using Defaulted.jsonDecoder(using PurchaseorderheaderId.jsonDecoder)))
  ...
  given jsonEncoder: JsonEncoder[PurchaseorderheaderRowUnsaved] = {
    new JsonEncoder[PurchaseorderheaderRowUnsaved] {
      override def unsafeEncode(a: PurchaseorderheaderRowUnsaved, indent: Option[Int], out: Write): Unit = {
        ...
        Defaulted.jsonEncoder(using PurchaseorderheaderId.jsonEncoder).unsafeEncode(a.purchaseorderid, indent, out)
        out.write(",")
