...
class CountryregionRepoImpl extends CountryregionRepo {
  ...
  override def deleteById(countryregioncode: CountryregionId): ZIO[ZConnection, Throwable, Boolean] = sql"""delete from "person"."countryregion" where "countryregioncode" = ${Segment.paramSegment(countryregioncode)(using CountryregionId.setter)}""".delete.map(_ > 0)

  override def deleteByIds(countryregioncodes: Array[CountryregionId]): ZIO[ZConnection, Throwable, Long] = sql"""delete from "person"."countryregion" where "countryregioncode" = ANY(${Segment.paramSegment(countryregioncodes)(using CountryregionId.arraySetter)})""".delete
  ...
  override def insert(unsaved: CountryregionRow): ZIO[ZConnection, Throwable, CountryregionRow] = {
    ...
    values (${Segment.paramSegment(unsaved.countryregioncode)(using CountryregionId.setter)}, ${Segment.paramSegment(unsaved.name)(using Name.setter)}::varchar, ${Segment.paramSegment(unsaved.modifieddate)(using TypoLocalDateTime.setter)}::timestamp)
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  ): ZIO[ZConnection, Throwable, Long] = streamingInsert(s"""COPY "person"."countryregion"("countryregioncode", "name", "modifieddate") FROM STDIN""", batchSize, unsaved)(using CountryregionRow.pgText)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: ZStream[ZConnection, Throwable, CountryregionRowUnsaved],
    batchSize: Int = 10000
  ): ZIO[ZConnection, Throwable, Long] = streamingInsert(s"""COPY "person"."countryregion"("countryregioncode", "name", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using CountryregionRowUnsaved.pgText)
  ...
  override def selectAll: ZStream[ZConnection, Throwable, CountryregionRow] = sql"""select "countryregioncode", "name", "modifieddate"::text from "person"."countryregion"""".query(using CountryregionRow.jdbcDecoder).selectStream()

  override def selectById(countryregioncode: CountryregionId): ZIO[ZConnection, Throwable, Option[CountryregionRow]] = sql"""select "countryregioncode", "name", "modifieddate"::text from "person"."countryregion" where "countryregioncode" = ${Segment.paramSegment(countryregioncode)(using CountryregionId.setter)}""".query(using CountryregionRow.jdbcDecoder).selectOne

  override def selectByIds(countryregioncodes: Array[CountryregionId]): ZStream[ZConnection, Throwable, CountryregionRow] = sql"""select "countryregioncode", "name", "modifieddate"::text from "person"."countryregion" where "countryregioncode" = ANY(${Segment.paramSegment(countryregioncodes)(using CountryregionId.arraySetter)})""".query(using CountryregionRow.jdbcDecoder).selectStream()
  ...
  override def update(row: CountryregionRow): ZIO[ZConnection, Throwable, Option[CountryregionRow]] = {
    ...
    where "countryregioncode" = ${Segment.paramSegment(countryregioncode)(using CountryregionId.setter)}
    returning "countryregioncode", "name", "modifieddate"::text"""
      .query(using CountryregionRow.jdbcDecoder)
      .selectOne
  }
  ...
  override def upsertStreaming(
    ...
    val copied = streamingInsert(s"""copy countryregion_TEMP("countryregioncode", "name", "modifieddate") from stdin""", batchSize, unsaved)(using CountryregionRow.pgText)
