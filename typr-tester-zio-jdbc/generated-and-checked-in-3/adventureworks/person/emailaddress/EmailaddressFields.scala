...
trait EmailaddressFields {
  ...
  def compositeIdIn(compositeIds: Array[EmailaddressId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[EmailaddressId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId]](using BusinessentityId.arrayJdbcEncoder, PGType.forArray(using BusinessentityId.pgType)), implicitly), TuplePart[EmailaddressId](emailaddressid)(_.emailaddressid)(using as[Array[Int]](using adventureworks.IntArrayEncoder, PGType.forArray(using PGType.PGTypeInt)), implicitly))
