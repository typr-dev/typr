...
trait BusinessentityaddressFields {
  ...
  def compositeIdIn(compositeIds: Array[BusinessentityaddressId]): SqlExpr[Boolean] =
    new CompositeIn(compositeIds)(TuplePart[BusinessentityaddressId](businessentityid)(_.businessentityid)(using as[Array[BusinessentityId]](using BusinessentityId.arrayJdbcEncoder, PGType.forArray(using BusinessentityId.pgType)), implicitly), TuplePart[BusinessentityaddressId](addressid)(_.addressid)(using as[Array[AddressId]](using AddressId.arrayJdbcEncoder, PGType.forArray(using AddressId.pgType)), implicitly), TuplePart[BusinessentityaddressId](addresstypeid)(_.addresstypeid)(using as[Array[AddresstypeId]](using AddresstypeId.arrayJdbcEncoder, PGType.forArray(using AddresstypeId.pgType)), implicitly))
