...
object BusinessentitycontactRow {
  ...
  given jdbcDecoder: JdbcDecoder[BusinessentitycontactRow] = {
  ...
  given jsonDecoder: JsonDecoder[BusinessentitycontactRow] = {
  ...
  given jsonEncoder: JsonEncoder[BusinessentitycontactRow] = {
