...
object TransactionhistoryarchiveRow {
  given jdbcDecoder: JdbcDecoder[TransactionhistoryarchiveRow] = {
  ...
  given jsonDecoder: JsonDecoder[TransactionhistoryarchiveRow] = {
    JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
      val transactionid = jsonObj.get("transactionid").toRight("Missing field 'transactionid'").flatMap(_.as(using TransactionhistoryarchiveId.jsonDecoder))
      ...
      val referenceorderlineid = jsonObj.get("referenceorderlineid").toRight("Missing field 'referenceorderlineid'").flatMap(_.as(using JsonDecoder.int))
      val transactiondate = jsonObj.get("transactiondate").toRight("Missing field 'transactiondate'").flatMap(_.as(using TypoLocalDateTime.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[TransactionhistoryarchiveRow] = {
