...
class ProductmodelillustrationRepoImpl extends ProductmodelillustrationRepo {
  ...
  override def deleteById(compositeId: ProductmodelillustrationId): ZIO[ZConnection, Throwable, Boolean] = sql"""delete from "production"."productmodelillustration" where "productmodelid" = ${Segment.paramSegment(compositeId.productmodelid)(using ProductmodelId.setter)} AND "illustrationid" = ${Segment.paramSegment(compositeId.illustrationid)(using IllustrationId.setter)}""".delete.map(_ > 0)
  ...
  override def deleteByIds(compositeIds: Array[ProductmodelillustrationId]): ZIO[ZConnection, Throwable, Long] = {
    ...
    in (select unnest(${Segment.paramSegment(productmodelid)(using ProductmodelId.arraySetter)}), unnest(${Segment.paramSegment(illustrationid)(using IllustrationId.arraySetter)}))
    """.delete
  }
  ...
  override def insert(unsaved: ProductmodelillustrationRow): ZIO[ZConnection, Throwable, ProductmodelillustrationRow] = {
    ...
    values (${Segment.paramSegment(unsaved.productmodelid)(using ProductmodelId.setter)}::int4, ${Segment.paramSegment(unsaved.illustrationid)(using IllustrationId.setter)}::int4, ${Segment.paramSegment(unsaved.modifieddate)(using TypoLocalDateTime.setter)}::timestamp)
  ...
  override def insert(unsaved: ProductmodelillustrationRowUnsaved): ZIO[ZConnection, Throwable, ProductmodelillustrationRow] = {
    val fs = List(
      ...
      Some((sql""""illustrationid"""", sql"${Segment.paramSegment(unsaved.illustrationid)(using IllustrationId.setter)}::int4")),
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  ): ZIO[ZConnection, Throwable, Long] = streamingInsert(s"""COPY "production"."productmodelillustration"("productmodelid", "illustrationid", "modifieddate") FROM STDIN""", batchSize, unsaved)(using ProductmodelillustrationRow.pgText)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: ZStream[ZConnection, Throwable, ProductmodelillustrationRowUnsaved],
    batchSize: Int = 10000
  ): ZIO[ZConnection, Throwable, Long] = streamingInsert(s"""COPY "production"."productmodelillustration"("productmodelid", "illustrationid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using ProductmodelillustrationRowUnsaved.pgText)
  ...
  override def selectAll: ZStream[ZConnection, Throwable, ProductmodelillustrationRow] = sql"""select "productmodelid", "illustrationid", "modifieddate"::text from "production"."productmodelillustration"""".query(using ProductmodelillustrationRow.jdbcDecoder).selectStream()

  override def selectById(compositeId: ProductmodelillustrationId): ZIO[ZConnection, Throwable, Option[ProductmodelillustrationRow]] = sql"""select "productmodelid", "illustrationid", "modifieddate"::text from "production"."productmodelillustration" where "productmodelid" = ${Segment.paramSegment(compositeId.productmodelid)(using ProductmodelId.setter)} AND "illustrationid" = ${Segment.paramSegment(compositeId.illustrationid)(using IllustrationId.setter)}""".query(using ProductmodelillustrationRow.jdbcDecoder).selectOne
  ...
  override def update(row: ProductmodelillustrationRow): ZIO[ZConnection, Throwable, Option[ProductmodelillustrationRow]] = {
    ...
    where "productmodelid" = ${Segment.paramSegment(compositeId.productmodelid)(using ProductmodelId.setter)} AND "illustrationid" = ${Segment.paramSegment(compositeId.illustrationid)(using IllustrationId.setter)}
    returning "productmodelid", "illustrationid", "modifieddate"::text"""
      .query(using ProductmodelillustrationRow.jdbcDecoder)
      .selectOne
  }
  ...
  override def upsertStreaming(
    ...
    val copied = streamingInsert(s"""copy productmodelillustration_TEMP("productmodelid", "illustrationid", "modifieddate") from stdin""", batchSize, unsaved)(using ProductmodelillustrationRow.pgText)
