...
object ProductmodelillustrationRow {
  ...
  given jdbcDecoder: JdbcDecoder[ProductmodelillustrationRow] = {
  ...
  given jsonDecoder: JsonDecoder[ProductmodelillustrationRow] = {
  ...
  given jsonEncoder: JsonEncoder[ProductmodelillustrationRow] = {
