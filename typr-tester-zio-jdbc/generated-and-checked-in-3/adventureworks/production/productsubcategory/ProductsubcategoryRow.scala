...
object ProductsubcategoryRow {
  given jdbcDecoder: JdbcDecoder[ProductsubcategoryRow] = {
  ...
  given jsonDecoder: JsonDecoder[ProductsubcategoryRow] = {
  ...
  given jsonEncoder: JsonEncoder[ProductsubcategoryRow] = {
