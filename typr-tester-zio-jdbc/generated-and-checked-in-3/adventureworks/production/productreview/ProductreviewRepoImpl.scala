...
class ProductreviewRepoImpl extends ProductreviewRepo {
  ...
  override def upsertStreaming(
    ...
    val copied = streamingInsert(s"""copy productreview_TEMP("productreviewid", "productid", "reviewername", "reviewdate", "emailaddress", "rating", "comments", "modifieddate") from stdin""", batchSize, unsaved)(using ProductreviewRow.pgText)
