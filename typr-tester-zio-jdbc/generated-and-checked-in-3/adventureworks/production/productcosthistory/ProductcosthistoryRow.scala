...
object ProductcosthistoryRow {
  ...
  given jdbcDecoder: JdbcDecoder[ProductcosthistoryRow] = {
  ...
  given jsonDecoder: JsonDecoder[ProductcosthistoryRow] = {
  ...
  given jsonEncoder: JsonEncoder[ProductcosthistoryRow] = {
