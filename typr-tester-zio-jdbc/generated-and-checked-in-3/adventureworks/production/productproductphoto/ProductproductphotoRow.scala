...
object ProductproductphotoRow {
  ...
  given jdbcDecoder: JdbcDecoder[ProductproductphotoRow] = {
  ...
  given jsonDecoder: JsonDecoder[ProductproductphotoRow] = {
  ...
  given jsonEncoder: JsonEncoder[ProductproductphotoRow] = {
