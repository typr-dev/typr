...
object TransactionhistoryRow {
  given jdbcDecoder: JdbcDecoder[TransactionhistoryRow] = {
  ...
  given jsonDecoder: JsonDecoder[TransactionhistoryRow] = {
    JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
      val transactionid = jsonObj.get("transactionid").toRight("Missing field 'transactionid'").flatMap(_.as(using TransactionhistoryId.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[TransactionhistoryRow] = {
