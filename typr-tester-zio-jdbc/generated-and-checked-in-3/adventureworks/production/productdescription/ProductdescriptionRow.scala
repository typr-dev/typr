...
object ProductdescriptionRow {
  given jdbcDecoder: JdbcDecoder[ProductdescriptionRow] = {
  ...
  given jsonDecoder: JsonDecoder[ProductdescriptionRow] = {
  ...
  given jsonEncoder: JsonEncoder[ProductdescriptionRow] = {
