...
object PvViewRow {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PvViewRow] = {
    JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
      ...
      val lastreceiptcost = jsonObj.get("lastreceiptcost").toRight("Missing field 'lastreceiptcost'").flatMap(_.as(JsonDecoder.scalaBigDecimal))
      val lastreceiptdate = jsonObj.get("lastreceiptdate").toRight("Missing field 'lastreceiptdate'").flatMap(_.as(TypoLocalDateTime.jsonDecoder))
      ...
      val onorderqty = jsonObj.get("onorderqty").toRight("Missing field 'onorderqty'").flatMap(_.as(JsonDecoder.int))
