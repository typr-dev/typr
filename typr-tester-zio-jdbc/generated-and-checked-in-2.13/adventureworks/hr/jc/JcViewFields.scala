...
trait JcViewFields {
  ...
  def resume: Field[TypoXml, JcViewRow]
  def modifieddate: Field[TypoLocalDateTime, JcViewRow]
}

object JcViewFields {
  lazy val structure: RelationStructure[JcViewFields, JcViewRow] =
    new Impl(List())

  private final class Impl(val _path: List[Path])
    extends RelationStructure[JcViewFields, JcViewRow] {
    ...
    override lazy val fields: JcViewFields = new JcViewFields {
      ...
      override def businessentityid = Field[BusinessentityId, JcViewRow](_path, "businessentityid", None, None, x => x.businessentityid, (row, value) => row.copy(businessentityid = value))
      override def resume = Field[TypoXml, JcViewRow](_path, "resume", None, None, x => x.resume, (row, value) => row.copy(resume = value))
