...
class BusinessentityaddressRepoImpl extends BusinessentityaddressRepo {
  ...
  override def upsertStreaming(
    ...
    val copied = streamingInsert(s"""copy businessentityaddress_TEMP("businessentityid", "addressid", "addresstypeid", "rowguid", "modifieddate") from stdin""", batchSize, unsaved)(BusinessentityaddressRow.pgText)
