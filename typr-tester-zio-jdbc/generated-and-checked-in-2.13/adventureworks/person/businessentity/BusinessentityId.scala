...
object BusinessentityId {
  ...
  implicit lazy val bijection: Bijection[BusinessentityId, Int] = Bijection.apply[BusinessentityId, Int](_.value)(BusinessentityId.apply)
  ...
  implicit lazy val pgText: Text[BusinessentityId] = {
