...
class DocumentRepoImpl extends DocumentRepo {
  ...
  override def upsertStreaming(
    ...
    val copied = streamingInsert(s"""copy document_TEMP("title", "owner", "folderflag", "filename", "fileextension", "revision", "changenumber", "status", "documentsummary", "document", "rowguid", "modifieddate", "documentnode") from stdin""", batchSize, unsaved)(DocumentRow.pgText)
