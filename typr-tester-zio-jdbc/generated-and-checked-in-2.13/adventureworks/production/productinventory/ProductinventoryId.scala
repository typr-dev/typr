...
object ProductinventoryId {
  implicit lazy val jdbcDecoder: JdbcDecoder[ProductinventoryId] = {
    new JdbcDecoder[ProductinventoryId] {
      override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, ProductinventoryId) =
        columIndex + 1 ->
          ProductinventoryId(
