...
class ProductmodelillustrationRepoImpl extends ProductmodelillustrationRepo {
  ...
  override def upsertStreaming(
    ...
    val copied = streamingInsert(s"""copy productmodelillustration_TEMP("productmodelid", "illustrationid", "modifieddate") from stdin""", batchSize, unsaved)(ProductmodelillustrationRow.pgText)
