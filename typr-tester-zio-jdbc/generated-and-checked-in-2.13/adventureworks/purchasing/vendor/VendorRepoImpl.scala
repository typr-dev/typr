...
class VendorRepoImpl extends VendorRepo {
  ...
  override def upsertStreaming(
    ...
    val copied = streamingInsert(s"""copy vendor_TEMP("businessentityid", "accountnumber", "name", "creditrating", "preferredvendorstatus", "activeflag", "purchasingwebserviceurl", "modifieddate") from stdin""", batchSize, unsaved)(VendorRow.pgText)
