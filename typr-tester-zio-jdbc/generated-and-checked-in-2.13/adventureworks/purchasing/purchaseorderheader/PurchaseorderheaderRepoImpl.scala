...
class PurchaseorderheaderRepoImpl extends PurchaseorderheaderRepo {
  ...
  override def upsertStreaming(
    ...
    val copied = streamingInsert(s"""copy purchaseorderheader_TEMP("purchaseorderid", "revisionnumber", "status", "employeeid", "vendorid", "shipmethodid", "orderdate", "shipdate", "subtotal", "taxamt", "freight", "modifieddate") from stdin""", batchSize, unsaved)(PurchaseorderheaderRow.pgText)
