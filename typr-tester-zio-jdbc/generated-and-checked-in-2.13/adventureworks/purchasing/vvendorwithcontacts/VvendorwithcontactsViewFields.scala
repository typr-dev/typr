...
object VvendorwithcontactsViewFields {
  lazy val structure: RelationStructure[VvendorwithcontactsViewFields, VvendorwithcontactsViewRow] =
    new Impl(List())

  private final class Impl(val _path: List[Path])
    extends RelationStructure[VvendorwithcontactsViewFields, VvendorwithcontactsViewRow] {
    ...
    override lazy val fields: VvendorwithcontactsViewFields = new VvendorwithcontactsViewFields {
      ...
      override def title = Field[String, VvendorwithcontactsViewRow](_path, "title", None, None, x => x.title, (row, value) => row.copy(title = value))
      ...
      override def middlename = Field[Name, VvendorwithcontactsViewRow](_path, "middlename", None, None, x => x.middlename, (row, value) => row.copy(middlename = value))
      ...
      override def suffix = Field[String, VvendorwithcontactsViewRow](_path, "suffix", None, None, x => x.suffix, (row, value) => row.copy(suffix = value))
      override def phonenumber = Field[Phone, VvendorwithcontactsViewRow](_path, "phonenumber", None, None, x => x.phonenumber, (row, value) => row.copy(phonenumber = value))
      override def phonenumbertype = Field[Name, VvendorwithcontactsViewRow](_path, "phonenumbertype", None, None, x => x.phonenumbertype, (row, value) => row.copy(phonenumbertype = value))
      override def emailaddress = Field[String, VvendorwithcontactsViewRow](_path, "emailaddress", None, None, x => x.emailaddress, (row, value) => row.copy(emailaddress = value))
