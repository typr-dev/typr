...
class CountryregioncurrencyRepoImpl extends CountryregioncurrencyRepo {
  ...
  override def upsertStreaming(
    ...
    val copied = streamingInsert(s"""copy countryregioncurrency_TEMP("countryregioncode", "currencycode", "modifieddate") from stdin""", batchSize, unsaved)(CountryregioncurrencyRow.pgText)
