...
class UsersRepoImpl extends UsersRepo {
  ...
  override def upsertStreaming(
    ...
    val copied = streamingInsert(s"""copy users_TEMP("user_id", "name", "last_name", "email", "password", "created_at", "verified_on") from stdin""", batchSize, unsaved)(UsersRow.pgText)
