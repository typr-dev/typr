...
object OnlyPkColumnsRow {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[OnlyPkColumnsRow] = {
    new JdbcDecoder[OnlyPkColumnsRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[OnlyPkColumnsRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[OnlyPkColumnsRow] = {
