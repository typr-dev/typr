...
object PgtestnullRow {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PgtestnullRow] = {
    JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
      ...
      val mydomaines = jsonObj.get("mydomaines").fold[Either[String, Option[Array[Mydomain]]]](Right(None))(_.as(JsonDecoder.option(JsonDecoder.array[Mydomain](Mydomain.jsonDecoder, implicitly))))
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PgtestnullRow] = {
    new JsonEncoder[PgtestnullRow] {
      override def unsafeEncode(a: PgtestnullRow, indent: Option[Int], out: Write): Unit = {
        ...
        JsonEncoder.option(JsonEncoder.array[Mydomain](Mydomain.jsonEncoder, implicitly)).unsafeEncode(a.mydomaines, indent, out)
        out.write(",")
        out.write(""""myenumes":""")
  ...
  implicit lazy val pgText: Text[PgtestnullRow] = {
    Text.instance[PgtestnullRow]{ (row, sb) =>
      Text.option(Text.booleanInstance).unsafeEncode(row.bool, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoBox.pgText).unsafeEncode(row.box, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.stringInstance).unsafeEncode(row.bpchar, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoBytea.pgText).unsafeEncode(row.bytea, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.stringInstance).unsafeEncode(row.char, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoCircle.pgText).unsafeEncode(row.circle, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoLocalDate.pgText).unsafeEncode(row.date, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.floatInstance).unsafeEncode(row.float4, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.doubleInstance).unsafeEncode(row.float8, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoHStore.pgText).unsafeEncode(row.hstore, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoInet.pgText).unsafeEncode(row.inet, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoShort.pgText).unsafeEncode(row.int2, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoInt2Vector.pgText).unsafeEncode(row.int2vector, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.intInstance).unsafeEncode(row.int4, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.longInstance).unsafeEncode(row.int8, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoInterval.pgText).unsafeEncode(row.interval, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoJson.pgText).unsafeEncode(row.json, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoJsonb.pgText).unsafeEncode(row.jsonb, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoLine.pgText).unsafeEncode(row.line, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoLineSegment.pgText).unsafeEncode(row.lseg, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoMoney.pgText).unsafeEncode(row.money, sb)
      sb.append(Text.DELIMETER)
      Text.option(Mydomain.pgText).unsafeEncode(row.mydomain, sb)
      sb.append(Text.DELIMETER)
      Text.option(Myenum.pgText).unsafeEncode(row.myenum, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.stringInstance).unsafeEncode(row.name, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.bigDecimalInstance).unsafeEncode(row.numeric, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoPath.pgText).unsafeEncode(row.path, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoPoint.pgText).unsafeEncode(row.point, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoPolygon.pgText).unsafeEncode(row.polygon, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.stringInstance).unsafeEncode(row.text, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoLocalTime.pgText).unsafeEncode(row.time, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoLocalDateTime.pgText).unsafeEncode(row.timestamp, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoInstant.pgText).unsafeEncode(row.timestampz, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoOffsetTime.pgText).unsafeEncode(row.timez, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoUUID.pgText).unsafeEncode(row.uuid, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.stringInstance).unsafeEncode(row.varchar, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoVector.pgText).unsafeEncode(row.vector, sb)
      sb.append(Text.DELIMETER)
      Text.option(TypoXml.pgText).unsafeEncode(row.xml, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoBox](TypoBox.pgText, implicitly)).unsafeEncode(row.boxes, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text[Array[String]]).unsafeEncode(row.bpchares, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text[Array[String]]).unsafeEncode(row.chares, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoCircle](TypoCircle.pgText, implicitly)).unsafeEncode(row.circlees, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoLocalDate](TypoLocalDate.pgText, implicitly)).unsafeEncode(row.datees, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text[Array[Float]]).unsafeEncode(row.float4es, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text[Array[Double]]).unsafeEncode(row.float8es, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoInet](TypoInet.pgText, implicitly)).unsafeEncode(row.inetes, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoShort](TypoShort.pgText, implicitly)).unsafeEncode(row.int2es, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoInt2Vector](TypoInt2Vector.pgText, implicitly)).unsafeEncode(row.int2vectores, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text[Array[Int]]).unsafeEncode(row.int4es, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text[Array[Long]]).unsafeEncode(row.int8es, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoInterval](TypoInterval.pgText, implicitly)).unsafeEncode(row.intervales, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoJson](TypoJson.pgText, implicitly)).unsafeEncode(row.jsones, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoJsonb](TypoJsonb.pgText, implicitly)).unsafeEncode(row.jsonbes, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoLine](TypoLine.pgText, implicitly)).unsafeEncode(row.linees, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoLineSegment](TypoLineSegment.pgText, implicitly)).unsafeEncode(row.lseges, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoMoney](TypoMoney.pgText, implicitly)).unsafeEncode(row.moneyes, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, Mydomain](Mydomain.pgText, implicitly)).unsafeEncode(row.mydomaines, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, Myenum](Myenum.pgText, implicitly)).unsafeEncode(row.myenumes, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text[Array[String]]).unsafeEncode(row.namees, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text[Array[BigDecimal]]).unsafeEncode(row.numerices, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoPath](TypoPath.pgText, implicitly)).unsafeEncode(row.pathes, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoPoint](TypoPoint.pgText, implicitly)).unsafeEncode(row.pointes, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoPolygon](TypoPolygon.pgText, implicitly)).unsafeEncode(row.polygones, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text[Array[String]]).unsafeEncode(row.textes, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoLocalTime](TypoLocalTime.pgText, implicitly)).unsafeEncode(row.timees, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoLocalDateTime](TypoLocalDateTime.pgText, implicitly)).unsafeEncode(row.timestampes, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoInstant](TypoInstant.pgText, implicitly)).unsafeEncode(row.timestampzes, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoOffsetTime](TypoOffsetTime.pgText, implicitly)).unsafeEncode(row.timezes, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoUUID](TypoUUID.pgText, implicitly)).unsafeEncode(row.uuides, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text[Array[String]]).unsafeEncode(row.varchares, sb)
      sb.append(Text.DELIMETER)
      Text.option(Text.iterableInstance[Array, TypoXml](TypoXml.pgText, implicitly)).unsafeEncode(row.xmles, sb)
    }
  }
}