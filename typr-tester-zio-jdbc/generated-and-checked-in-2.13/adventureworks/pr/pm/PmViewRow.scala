...
object PmViewRow {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PmViewRow] = {
    JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
      ...
      val catalogdescription = jsonObj.get("catalogdescription").toRight("Missing field 'catalogdescription'").flatMap(_.as(TypoXml.jsonDecoder))
      val instructions = jsonObj.get("instructions").toRight("Missing field 'instructions'").flatMap(_.as(TypoXml.jsonDecoder))
