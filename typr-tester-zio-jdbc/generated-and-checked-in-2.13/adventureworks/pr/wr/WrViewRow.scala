...
object WrViewRow {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[WrViewRow] = {
    JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
      ...
      val actualstartdate = jsonObj.get("actualstartdate").toRight("Missing field 'actualstartdate'").flatMap(_.as(TypoLocalDateTime.jsonDecoder))
      val actualenddate = jsonObj.get("actualenddate").toRight("Missing field 'actualenddate'").flatMap(_.as(TypoLocalDateTime.jsonDecoder))
      val actualresourcehrs = jsonObj.get("actualresourcehrs").toRight("Missing field 'actualresourcehrs'").flatMap(_.as(JsonDecoder.scalaBigDecimal))
