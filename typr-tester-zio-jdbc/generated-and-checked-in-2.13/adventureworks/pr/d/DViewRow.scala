...
object DViewRow {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[DViewRow] = {
    JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
      ...
      val fileextension = jsonObj.get("fileextension").toRight("Missing field 'fileextension'").flatMap(_.as(JsonDecoder.string))
      ...
      val documentsummary = jsonObj.get("documentsummary").toRight("Missing field 'documentsummary'").flatMap(_.as(JsonDecoder.string))
      val document = jsonObj.get("document").toRight("Missing field 'document'").flatMap(_.as(TypoBytea.jsonDecoder))
