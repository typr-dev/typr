...
object Int18 {
  ...
  given oracleType: OracleType[Int18] = OracleTypes.number.to(Bijection.of(bd => new Int18(BigInt(bd.bigDecimal.toBigIntegerExact())), v => BigDecimal(new java.math.BigDecimal(v.value.bigInteger))))
