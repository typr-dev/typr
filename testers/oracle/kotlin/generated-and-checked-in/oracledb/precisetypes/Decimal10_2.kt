...
data class Decimal10_2 private constructor(@field:JsonValue val value: BigDecimal) : DecimalN {
  ...
  companion object {
    ...
    val oracleType: OracleType<Decimal10_2> =
      OracleTypes.number.to(Bijection.of(::Decimal10_2, Decimal10_2::value))

    val rowCodec: RowCodec<Decimal10_2> =
      RowCodecs.of(OracleTypes.number.to(Bijection.of(::Decimal10_2, Decimal10_2::value)), { x -> x }, { id -> arrayOf<Any?>(id) })
  }
}