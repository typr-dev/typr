...
public record CustomersRow(
  ...
  public static RowCodec<CustomersRow> rowCodec = RowCodecs.of(CustomersId.oracleType, OracleTypes.varchar2, AddressT.oracleType, MoneyT.oracleType.opt(), OracleTypes.timestamp, CustomersRow::new, row -> new Object[]{row.customerId(), row.name(), row.billingAddress(), row.creditLimit(), row.createdAt()});
