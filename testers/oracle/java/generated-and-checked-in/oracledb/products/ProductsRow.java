...
public record ProductsRow(
  ...
  public static RowCodec<ProductsRow> rowCodec = RowCodecs.of(ProductsId.oracleType, OracleTypes.varchar2, OracleTypes.varchar2, MoneyT.oracleType, TagVarrayT.oracleType.opt(), ProductsRow::new, row -> new Object[]{row.productId(), row.sku(), row.name(), row.price(), row.tags()});
