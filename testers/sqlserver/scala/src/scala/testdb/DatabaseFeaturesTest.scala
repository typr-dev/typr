...
class DatabaseFeaturesTest {
  private val testInsert = TestInsert(Random(1911710963))
  ...
  @Test
  def testMoneyType(): Unit = withConnection {
  ...
  @Test
  def testSmallmoneyType(): Unit = withConnection {
  ...
  @Test
  def testMoneyPrecision(): Unit = withConnection {
  ...
  @Test
  def testRowversionUniquePerRow(): Unit = withConnection {
  ...
  @Test
  def testRowversionChangesOnUpdate(): Unit = withConnection {
  ...
  @Test
  def testXmlNestedStructure(): Unit = withConnection {
  ...
  @Test
  def testUniqueidentifierType(): Unit = withConnection {
  ...
  @Test
  def testUniqueidentifierUniqueness(): Unit = withConnection {
  ...
  @Test
  def testDatetimeoffsetType(): Unit = withConnection {
  ...
  @Test
  def testDatetimeoffsetDifferentTimezones(): Unit = withConnection {
  ...
  @Test
  def testHierarchyidType(): Unit = withConnection {
  ...
  @Test
  def testHierarchyidRootLevel(): Unit = withConnection {
  ...
  @Test
  def testViewDSLFilter(): Unit = withConnection {
  ...
  @Test
  def testSmalldatetimeType(): Unit = withConnection {
  ...
  @Test
  def testDefaultValueApplied(): Unit = withConnection {
    val row = testInsert.AllScalarTypes()
