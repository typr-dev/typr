...
public record FindCustomersByEmailSqlRow(
  ...
  public static RowCodec<FindCustomersByEmailSqlRow> rowCodec = RowCodecs.of(CustomersId.sqlServerType, SqlServerTypes.nvarchar, Email.sqlServerType, SqlServerTypes.datetime2.opt(), FindCustomersByEmailSqlRow::new, row -> new Object[]{row.customerId(), row.customerName(), row.customerEmail(), row.createdAt()});
