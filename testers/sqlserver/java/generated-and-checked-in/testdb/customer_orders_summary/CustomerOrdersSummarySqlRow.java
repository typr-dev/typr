...
public record CustomerOrdersSummarySqlRow(
...
) implements Tuple7<CustomersId, String, /* user-picked */ Email, Optional<OrdersId>, Optional<BigDecimal>, Optional<BigDecimal>, Optional<LocalDateTime>> {
  /** Points to {@link testdb.customers.CustomersRow#customerId()} */
  public CustomerOrdersSummarySqlRow withCustomerId(CustomersId customerId) {
    return new CustomerOrdersSummarySqlRow(customerId, customerName, customerEmail, orderCount, totalSpent, avgOrderAmount, lastOrderDate);
  }
  ...
  public static RowCodec<CustomerOrdersSummarySqlRow> rowCodec = RowCodecs.of(CustomersId.sqlServerType, SqlServerTypes.nvarchar, Email.sqlServerType, OrdersId.sqlServerType.opt(), SqlServerTypes.money.opt(), SqlServerTypes.money.opt(), SqlServerTypes.datetime2.opt(), CustomerOrdersSummarySqlRow::new, row -> new Object[]{row.customerId(), row.customerName(), row.customerEmail(), row.orderCount(), row.totalSpent(), row.avgOrderAmount(), row.lastOrderDate()});
