...
/** Table: public.flaff
  ...
  */
data class FlaffRow(
  /** Points to [combined.postgres.public.flaff.FlaffRow.code] */
  val code: ShortText,
  /** Points to [combined.postgres.public.flaff.FlaffRow.anotherCode] */
  @field:JsonProperty("another_code") val anotherCode: kotlin.String,
  /** Points to [combined.postgres.public.flaff.FlaffRow.someNumber] */
  @field:JsonProperty("some_number") val someNumber: Int,
  val specifier: ShortText,
  /** Points to [combined.postgres.public.flaff.FlaffRow.specifier] */
