...
data class VCustomerSummaryViewRow(
  ...
  /** 
    * Default: 'bronze'
    * Points to [combined.mariadb.customers.CustomersRow.tier]
    */
  val tier: kotlin.String,
  /** 
    * Default: 'pending'
    * Points to [combined.mariadb.customers.CustomersRow.status]
    */
  val status: CustomerStatusId,
  /** 
    * Default: current_timestamp(6)
    * Points to [combined.mariadb.customers.CustomersRow.createdAt]
    */
  @field:JsonProperty("created_at") val createdAt: LocalDateTime,
  /** 
    * Default: NULL
    * Points to [combined.mariadb.customers.CustomersRow.lastLoginAt]
    */
