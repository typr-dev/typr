...
class PaymentChargedSerde() : Serde<PaymentCharged>, Serializer<PaymentCharged>, Deserializer<PaymentCharged> {
  override fun close() {
  ...
  override fun deserializer(): Deserializer<PaymentCharged> = this
  ...
  override fun serializer(): Serializer<PaymentCharged> = this
}