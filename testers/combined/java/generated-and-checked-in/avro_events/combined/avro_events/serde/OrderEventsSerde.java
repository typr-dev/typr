...
public class OrderEventsSerde implements Serde<OrderEvents>, Serializer<OrderEvents>, Deserializer<OrderEvents> {
  ...
  public byte[] serialize(
    ...
    return switch (data) {
      ...
      case PaymentCallback e -> new PaymentCallbackSerde().serialize(topic, e);
      case PaymentCharged e -> new PaymentChargedSerde().serialize(topic, e);
    };
  }

  @Override
  public OrderEvents deserialize(
    String topic,
    byte[] data
  ) {
    if (data == null) {
