...
public class LinkedListNodeSerde implements Serde<LinkedListNode>, Serializer<LinkedListNode>, Deserializer<LinkedListNode> {
  ...
  @Override
  public LinkedListNode deserialize(
    String topic,
    byte[] data
  ) {
    if (data == null) {
