...
public class OrderCancelledSerde implements Serde<OrderCancelled>, Serializer<OrderCancelled>, Deserializer<OrderCancelled> {
  ...
  @Override
  public OrderCancelled deserialize(
    String topic,
    byte[] data
  ) {
    if (data == null) {
