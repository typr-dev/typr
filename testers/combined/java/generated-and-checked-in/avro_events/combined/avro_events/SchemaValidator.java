...
public class SchemaValidator {
  ...
  /** Get detailed compatibility information between two schemas.
    ...
    */
  public SchemaPairCompatibility checkCompatibility(
    Schema newSchema,
    Schema oldSchema
  ) {
