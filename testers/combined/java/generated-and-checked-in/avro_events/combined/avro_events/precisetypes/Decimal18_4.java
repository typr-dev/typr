package combined.avro_events.precisetypes;
...
public record Decimal18_4(BigDecimal value) implements DecimalN {
  ...
  static public Optional<Decimal18_4> of(BigDecimal value) {
  ...
  static public Decimal18_4 unsafeForce(BigDecimal value) {
    BigDecimal scaled = value.setScale(4, RoundingMode.HALF_UP);
    if (scaled.precision() > 18) { throw new IllegalArgumentException("Value exceeds precision(18, 4)"); };
    return new Decimal18_4(scaled);
  }

  static public Decimal18_4 of(Integer value) {
    return new Decimal18_4(BigDecimal.valueOf((long) (value)));
  }

  static public Optional<Decimal18_4> of(Long value) {
    return Decimal18_4.of(BigDecimal.valueOf(value));
  }

  static public Optional<Decimal18_4> of(Double value) {
    return Decimal18_4.of(BigDecimal.valueOf(value));
  }
