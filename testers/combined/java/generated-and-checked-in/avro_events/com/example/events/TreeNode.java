...
public record TreeNode(
  ...
  static public TreeNode fromGenericRecord(GenericRecord record) {
    return new TreeNode(record.get("value").toString(), Optional.ofNullable((record.get("left") == null
      ? null
      : TreeNode.fromGenericRecord(((GenericRecord) record.get("left"))))), Optional.ofNullable((record.get("right") == null
      ? null
  ...
  public GenericRecord toGenericRecord() {
    ...
    record.put("left", (this.left().isEmpty()
      ? null
      : this.left().get().toGenericRecord()));
    record.put("right", (this.right().isEmpty()
      ? null
      : this.right().get().toGenericRecord()));
    return record;
  }
}