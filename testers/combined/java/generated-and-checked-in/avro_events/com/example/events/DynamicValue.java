...
import combined.avro_events.StringOrIntOrBoolean;
import combined.avro_events.StringOrLong;
...
public record DynamicValue(
  ...
  static public DynamicValue fromGenericRecord(GenericRecord record) {
    return new DynamicValue(record.get("id").toString(), Objects.requireNonNull((record.get("value") instanceof CharSequence
      ...
      : (record.get("value") instanceof Integer
          ...
          : (record.get("value") instanceof Boolean
              ...
              : null))), "Unknown union type"), Optional.ofNullable((record.get("optionalValue") == null
      ? null
  ...
  public GenericRecord toGenericRecord() {
    ...
    record.put("value", (this.value().isString()
      ? this.value().asString()
      : (this.value().isInt()
          ? this.value().asInt()
          : (this.value().isBoolean()
              ...
              : null))));
    record.put("optionalValue", (this.optionalValue().isEmpty()
      ? null
