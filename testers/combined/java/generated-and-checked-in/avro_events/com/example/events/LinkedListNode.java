...
public record LinkedListNode(
  ...
  static public LinkedListNode fromGenericRecord(GenericRecord record) {
    return new LinkedListNode(((Integer) record.get("value")), Optional.ofNullable((record.get("next") == null
      ? null
  ...
  public GenericRecord toGenericRecord() {
    ...
    record.put("next", (this.next().isEmpty()
      ? null
      : this.next().get().toGenericRecord()));
    return record;
  }
}