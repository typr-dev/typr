...
public record Address(
  ...
  static public Address fromGenericRecord(GenericRecord record) {
    return new Address(record.get("street").toString(), record.get("city").toString(), record.get("postalCode").toString(), record.get("country").toString());
  }
