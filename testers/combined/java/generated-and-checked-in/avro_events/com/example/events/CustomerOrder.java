...
public record CustomerOrder(
  ...
  static public CustomerOrder fromGenericRecord(GenericRecord record) {
    return new CustomerOrder(OrderId.valueOf(record.get("orderId").toString()), CustomerId.valueOf(((Long) record.get("customerId"))), (record.get("email") == null
      ? Optional.empty()
      : Optional.of(Email.valueOf(record.get("email").toString()))), ((Long) record.get("amount")));
  }
  ...
  public GenericRecord toGenericRecord() {
    ...
    record.put("email", (this.email().isEmpty()
      ? null
      : this.email().get().unwrap()));
