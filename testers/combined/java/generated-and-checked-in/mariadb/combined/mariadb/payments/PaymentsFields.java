...
public class PaymentsFields extends TupleExpr12<PaymentsId, OrdersId, PaymentMethodsId, String, BigDecimal, String, String, Json, String, Inet6, LocalDateTime, LocalDateTime> implements RelationStructure<PaymentsFields, PaymentsRow>, FieldsBase<PaymentsRow> {
  List<Path> _path;
  ...
  public IdField<PaymentsId, PaymentsRow> paymentId() {
    return new IdField<PaymentsId, PaymentsRow>(_path, "payment_id", PaymentsRow::paymentId, Optional.empty(), Optional.empty(), (row, value) -> row.withPaymentId(value), PaymentsId.mariaType);
  }

  public Field<OrdersId, PaymentsRow> orderId() {
    return new Field<OrdersId, PaymentsRow>(_path, "order_id", PaymentsRow::orderId, Optional.empty(), Optional.empty(), (row, value) -> row.withOrderId(value), OrdersId.mariaType);
  }

  public Field<PaymentMethodsId, PaymentsRow> methodId() {
    return new Field<PaymentMethodsId, PaymentsRow>(_path, "method_id", PaymentsRow::methodId, Optional.empty(), Optional.empty(), (row, value) -> row.withMethodId(value), PaymentMethodsId.mariaType);
  }
  ...
  public OptField<Json, PaymentsRow> processorResponse() {
    return new OptField<Json, PaymentsRow>(_path, "processor_response", PaymentsRow::processorResponse, Optional.empty(), Optional.empty(), (row, value) -> row.withProcessorResponse(value), MariaTypes.json);
  }
  ...
  @Override
  public RowCodec<PaymentsRow> rowCodec() {
    return PaymentsRow.rowCodec;
  }
