...
import dev.typr.dsl.TupleExpr.TupleExpr16;
...
public class PromotionsFields extends TupleExpr16<PromotionsId, String, String, String, String, BigDecimal, BigDecimal, Uint4, Uint4, Uint1, AllBrandsCategoriesCSet, Json, LocalDateTime, LocalDateTime, /* user-picked */ IsActive, LocalDateTime> implements RelationStructure<PromotionsFields, PromotionsRow>, FieldsBase<PromotionsRow> {
  List<Path> _path;
  ...
  public static PromotionsFields structure = new PromotionsFields(java.util.Collections.emptyList());

  public IdField<PromotionsId, PromotionsRow> promotionId() {
    return new IdField<PromotionsId, PromotionsRow>(_path, "promotion_id", PromotionsRow::promotionId, Optional.empty(), Optional.empty(), (row, value) -> row.withPromotionId(value), PromotionsId.mariaType);
  }
  ...
  public OptField<Uint4, PromotionsRow> maxUses() {
    return new OptField<Uint4, PromotionsRow>(_path, "max_uses", PromotionsRow::maxUses, Optional.empty(), Optional.empty(), (row, value) -> row.withMaxUses(value), MariaTypes.intUnsigned);
  }

  public Field<Uint4, PromotionsRow> usesCount() {
    return new Field<Uint4, PromotionsRow>(_path, "uses_count", PromotionsRow::usesCount, Optional.empty(), Optional.empty(), (row, value) -> row.withUsesCount(value), MariaTypes.intUnsigned);
  }

  public OptField<Uint1, PromotionsRow> maxUsesPerCustomer() {
    return new OptField<Uint1, PromotionsRow>(_path, "max_uses_per_customer", PromotionsRow::maxUsesPerCustomer, Optional.empty(), Optional.empty(), (row, value) -> row.withMaxUsesPerCustomer(value), MariaTypes.tinyintUnsigned);
  }

  public OptField<AllBrandsCategoriesCSet, PromotionsRow> applicableTo() {
    return new OptField<AllBrandsCategoriesCSet, PromotionsRow>(_path, "applicable_to", PromotionsRow::applicableTo, Optional.empty(), Optional.empty(), (row, value) -> row.withApplicableTo(value), AllBrandsCategoriesCSet.mariaType);
  }

  public OptField<Json, PromotionsRow> rulesJson() {
    return new OptField<Json, PromotionsRow>(_path, "rules_json", PromotionsRow::rulesJson, Optional.empty(), Optional.empty(), (row, value) -> row.withRulesJson(value), MariaTypes.json);
  }
  ...
  public Field</* user-picked */ IsActive, PromotionsRow> isActive() {
    return new Field</* user-picked */ IsActive, PromotionsRow>(_path, "is_active", PromotionsRow::isActive, Optional.empty(), Optional.empty(), (row, value) -> row.withIsActive(value), IsActive.mariaType);
  }
  ...
  @Override
  public RowCodec<PromotionsRow> rowCodec() {
    return PromotionsRow.rowCodec;
  }
