...
import dev.typr.dsl.TupleExpr.TupleExpr22;
...
public class OrdersFields extends TupleExpr22<OrdersId, String, CustomersId, String, String, CustomerAddressesId, CustomerAddressesId, BigDecimal, BigDecimal, BigDecimal, BigDecimal, BigDecimal, String, PromotionsId, String, String, Inet6, String, LocalDateTime, LocalDateTime, LocalDateTime, LocalDateTime> implements RelationStructure<OrdersFields, OrdersRow>, FieldsBase<OrdersRow> {
  List<Path> _path;
  ...
  public IdField<OrdersId, OrdersRow> orderId() {
    return new IdField<OrdersId, OrdersRow>(_path, "order_id", OrdersRow::orderId, Optional.empty(), Optional.empty(), (row, value) -> row.withOrderId(value), OrdersId.mariaType);
  }
  ...
  public Field<CustomersId, OrdersRow> customerId() {
    return new Field<CustomersId, OrdersRow>(_path, "customer_id", OrdersRow::customerId, Optional.empty(), Optional.empty(), (row, value) -> row.withCustomerId(value), CustomersId.mariaType);
  }
  ...
  public OptField<CustomerAddressesId, OrdersRow> shippingAddressId() {
    return new OptField<CustomerAddressesId, OrdersRow>(_path, "shipping_address_id", OrdersRow::shippingAddressId, Optional.empty(), Optional.empty(), (row, value) -> row.withShippingAddressId(value), CustomerAddressesId.mariaType);
  }

  public OptField<CustomerAddressesId, OrdersRow> billingAddressId() {
    return new OptField<CustomerAddressesId, OrdersRow>(_path, "billing_address_id", OrdersRow::billingAddressId, Optional.empty(), Optional.empty(), (row, value) -> row.withBillingAddressId(value), CustomerAddressesId.mariaType);
  }
  ...
  public OptField<PromotionsId, OrdersRow> promotionId() {
    return new OptField<PromotionsId, OrdersRow>(_path, "promotion_id", OrdersRow::promotionId, Optional.empty(), Optional.empty(), (row, value) -> row.withPromotionId(value), PromotionsId.mariaType);
  }
  ...
  public ForeignKey<CustomerAddressesFields, CustomerAddressesRow> fkCustomerAddressesBillingAddressId() {
  ...
  public ForeignKey<CustomerAddressesFields, CustomerAddressesRow> fkCustomerAddressesShippingAddressId() {
