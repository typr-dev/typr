...
public class OrdersRepoImpl implements OrdersRepo {
  ...
  public Boolean deleteById(
    ...
    return concat(Fragment.of("delete from `orders` where `order_id` = "), Fragment.encode(OrdersId.mariaType, orderId), Fragment.of("")).update().run(c) > 0;
  }
  ...
  public Integer deleteByIds(
    ...
    for (var id : orderIds) { fragments.add(Fragment.encode(OrdersId.mariaType, id)); };
  ...
  public OrdersRow insert(
    ...
    values.add(concat(Fragment.encode(MariaTypes.varchar, unsaved.orderNumber()), Fragment.of("")));
    ...
    values.add(concat(Fragment.encode(MariaTypes.numeric, unsaved.subtotal()), Fragment.of("")));
    columns.add(Fragment.of("`total_amount`"));
    values.add(concat(Fragment.encode(MariaTypes.numeric, unsaved.totalAmount()), Fragment.of("")));
    unsaved.orderStatus().visit(
      () -> {
  
      },
      value -> {
        columns.add(Fragment.of("`order_status`"));
    ...
    unsaved.paymentStatus().visit(
      ...
      value -> {
        columns.add(Fragment.of("`payment_status`"));
        values.add(concat(Fragment.encode(MariaTypes.text, value), Fragment.of("")));
      }
    );;
    unsaved.shippingAddressId().visit(
      ...
      value -> {
        columns.add(Fragment.of("`shipping_address_id`"));
        values.add(concat(Fragment.encode(CustomerAddressesId.mariaType.opt(), value), Fragment.of("")));
      }
    );;
    unsaved.billingAddressId().visit(
      ...
      value -> {
        columns.add(Fragment.of("`billing_address_id`"));
        values.add(concat(Fragment.encode(CustomerAddressesId.mariaType.opt(), value), Fragment.of("")));
      }
    );;
    ...
    unsaved.promotionId().visit(
      ...
      value -> {
        columns.add(Fragment.of("`promotion_id`"));
        values.add(concat(Fragment.encode(PromotionsId.mariaType.opt(), value), Fragment.of("")));
      }
    );;
    unsaved.notes().visit(
      () -> {
    ...
    unsaved.internalNotes().visit(
      ...
      value -> {
        columns.add(Fragment.of("`internal_notes`"));
    ...
    unsaved.userAgent().visit(
      ...
      value -> {
        columns.add(Fragment.of("`user_agent`"));
    ...
    unsaved.orderedAt().visit(
      ...
      value -> {
        columns.add(Fragment.of("`ordered_at`"));
    ...
    unsaved.confirmedAt().visit(
      ...
      value -> {
        columns.add(Fragment.of("`confirmed_at`"));
    ...
    unsaved.deliveredAt().visit(
      ...
      value -> {
        columns.add(Fragment.of("`delivered_at`"));
        values.add(concat(Fragment.encode(MariaTypes.datetime.opt(), value), Fragment.of("")));
      }
    );;
  ...
  public SelectBuilder<OrdersFields, OrdersRow> select() {
    return SelectBuilder.of("`orders`", OrdersFields.structure, OrdersRow.rowCodec, Dialect.MARIADB);
  }

  @Override
  public List<OrdersRow> selectAll(ConnectionRead c) {
    return concat(Fragment.of("select `order_id`, `order_number`, `customer_id`, `order_status`, `payment_status`, `shipping_address_id`, `billing_address_id`, `subtotal`, `shipping_cost`, `tax_amount`, `discount_amount`, `total_amount`, `currency_code`, `promotion_id`, `notes`, `internal_notes`, `ip_address`, `user_agent`, `ordered_at`, `confirmed_at`, `shipped_at`, `delivered_at`\nfrom `orders`\n")).query(OrdersRow.rowCodec.all()).run(c);
  }
  ...
  public UpdateBuilder<OrdersFields, OrdersRow> update() {
    return UpdateBuilder.of("`orders`", OrdersFields.structure, OrdersRow.rowCodec, Dialect.MARIADB);
  }
