...
public class ProductsFields extends TupleExpr18<ProductsId, String, BrandsId, String, String, String, BigDecimal, BigDecimal, BigDecimal, Json, String, String, BestsellerClearanceFSet, Json, Json, LocalDateTime, LocalDateTime, LocalDateTime> implements RelationStructure<ProductsFields, ProductsRow>, FieldsBase<ProductsRow> {
  List<Path> _path;
  ...
  public IdField<ProductsId, ProductsRow> productId() {
    return new IdField<ProductsId, ProductsRow>(_path, "product_id", ProductsRow::productId, Optional.empty(), Optional.empty(), (row, value) -> row.withProductId(value), ProductsId.mariaType);
  }
  ...
  public OptField<BrandsId, ProductsRow> brandId() {
    return new OptField<BrandsId, ProductsRow>(_path, "brand_id", ProductsRow::brandId, Optional.empty(), Optional.empty(), (row, value) -> row.withBrandId(value), BrandsId.mariaType);
  }
  ...
  public OptField<Json, ProductsRow> dimensionsJson() {
    return new OptField<Json, ProductsRow>(_path, "dimensions_json", ProductsRow::dimensionsJson, Optional.empty(), Optional.empty(), (row, value) -> row.withDimensionsJson(value), MariaTypes.json);
  }
  ...
  public OptField<BestsellerClearanceFSet, ProductsRow> tags() {
    return new OptField<BestsellerClearanceFSet, ProductsRow>(_path, "tags", ProductsRow::tags, Optional.empty(), Optional.empty(), (row, value) -> row.withTags(value), BestsellerClearanceFSet.mariaType);
  }

  public OptField<Json, ProductsRow> attributes() {
    return new OptField<Json, ProductsRow>(_path, "attributes", ProductsRow::attributes, Optional.empty(), Optional.empty(), (row, value) -> row.withAttributes(value), MariaTypes.json);
  }

  public OptField<Json, ProductsRow> seoMetadata() {
    return new OptField<Json, ProductsRow>(_path, "seo_metadata", ProductsRow::seoMetadata, Optional.empty(), Optional.empty(), (row, value) -> row.withSeoMetadata(value), MariaTypes.json);
  }
