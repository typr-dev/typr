...
public class VProductCatalogViewFields extends TupleExpr11<ProductsId, String, String, String, BigDecimal, String, BestsellerClearanceFSet, String, BigDecimal, BigDecimal, Long> implements RelationStructure<VProductCatalogViewFields, VProductCatalogViewRow>, FieldsBase<VProductCatalogViewRow> {
  List<Path> _path;
  ...
  public static VProductCatalogViewFields structure = new VProductCatalogViewFields(java.util.Collections.emptyList());

  public Field<ProductsId, VProductCatalogViewRow> productId() {
    return new Field<ProductsId, VProductCatalogViewRow>(_path, "product_id", VProductCatalogViewRow::productId, Optional.empty(), Optional.empty(), (row, value) -> row.withProductId(value), ProductsId.mariaType);
  }
  ...
  public OptField<BestsellerClearanceFSet, VProductCatalogViewRow> tags() {
    return new OptField<BestsellerClearanceFSet, VProductCatalogViewRow>(_path, "tags", VProductCatalogViewRow::tags, Optional.empty(), Optional.empty(), (row, value) -> row.withTags(value), BestsellerClearanceFSet.mariaType);
  }
  ...
  @Override
  public RowCodec<VProductCatalogViewRow> rowCodec() {
    return VProductCatalogViewRow.rowCodec;
  }
