...
public class ShipmentsFields extends TupleExpr17<ShipmentsId, OrdersId, ShippingCarriersId, String, String, BigDecimal, Json, byte[], String, LocalDate, LocalDateTime, BigDecimal, BigDecimal, WarehousesId, LocalDateTime, LocalDateTime, LocalDateTime> implements RelationStructure<ShipmentsFields, ShipmentsRow>, FieldsBase<ShipmentsRow> {
  List<Path> _path;
  ...
  public IdField<ShipmentsId, ShipmentsRow> shipmentId() {
    return new IdField<ShipmentsId, ShipmentsRow>(_path, "shipment_id", ShipmentsRow::shipmentId, Optional.empty(), Optional.empty(), (row, value) -> row.withShipmentId(value), ShipmentsId.mariaType);
  }

  public Field<OrdersId, ShipmentsRow> orderId() {
    return new Field<OrdersId, ShipmentsRow>(_path, "order_id", ShipmentsRow::orderId, Optional.empty(), Optional.empty(), (row, value) -> row.withOrderId(value), OrdersId.mariaType);
  }

  public Field<ShippingCarriersId, ShipmentsRow> carrierId() {
    return new Field<ShippingCarriersId, ShipmentsRow>(_path, "carrier_id", ShipmentsRow::carrierId, Optional.empty(), Optional.empty(), (row, value) -> row.withCarrierId(value), ShippingCarriersId.mariaType);
  }
  ...
  public OptField<Json, ShipmentsRow> dimensionsJson() {
    return new OptField<Json, ShipmentsRow>(_path, "dimensions_json", ShipmentsRow::dimensionsJson, Optional.empty(), Optional.empty(), (row, value) -> row.withDimensionsJson(value), MariaTypes.json);
  }
  ...
  public OptField<WarehousesId, ShipmentsRow> originWarehouseId() {
    return new OptField<WarehousesId, ShipmentsRow>(_path, "origin_warehouse_id", ShipmentsRow::originWarehouseId, Optional.empty(), Optional.empty(), (row, value) -> row.withOriginWarehouseId(value), WarehousesId.mariaType);
  }
  ...
  @Override
  public RowCodec<ShipmentsRow> rowCodec() {
    return ShipmentsRow.rowCodec;
  }
