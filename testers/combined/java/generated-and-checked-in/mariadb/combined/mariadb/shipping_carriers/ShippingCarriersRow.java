...
public record ShippingCarriersRow(
...
) implements Tuple6<ShippingCarriersId, String, String, Optional<String>, Optional<Json>, /* user-picked */ IsActive> {
  /** 
    * AUTO_INCREMENT
    */
  ...
  public static RowCodec<ShippingCarriersRow> rowCodec = RowCodecs.of(ShippingCarriersId.mariaType, MariaTypes.varchar, MariaTypes.varchar, MariaTypes.varchar.opt(), MariaTypes.json.opt(), IsActive.mariaType, ShippingCarriersRow::new, row -> new Object[]{row.carrierId(), row.code(), row.name(), row.trackingUrlTemplate(), row.apiConfig(), row.isActive()});
