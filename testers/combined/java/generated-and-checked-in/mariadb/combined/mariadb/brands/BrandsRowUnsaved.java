...
public record BrandsRowUnsaved(
  ...
  public BrandsRowUnsaved(
      ...
      String slug) {
    this(
        name, slug, new UseDefault<>(), new UseDefault<>(), new UseDefault<>(), new UseDefault<>());
  }
  ;
  ...
  public BrandsRow toRow(
    ...
    return new BrandsRow(
        ...
        name,
        slug,
        logoBlob.getOrElse(logoBlobDefault),
        websiteUrl.getOrElse(websiteUrlDefault),
        countryOfOrigin.getOrElse(countryOfOriginDefault),
