...
) implements Tuple7<BrandsId, String, String, Optional<byte[]>, Optional<String>, Optional<String>, /* user-picked */ IsActive> {
  /** 
    * AUTO_INCREMENT
    */
