...
public class VInventoryStatusViewFields extends TupleExpr14<ProductsId, String, String, WarehousesId, String, String, Integer, Integer, Integer, Long, Integer, String, String, LocalDateTime> implements RelationStructure<VInventoryStatusViewFields, VInventoryStatusViewRow>, FieldsBase<VInventoryStatusViewRow> {
  List<Path> _path;
  ...
  public static VInventoryStatusViewFields structure = new VInventoryStatusViewFields(java.util.Collections.emptyList());

  public Field<ProductsId, VInventoryStatusViewRow> productId() {
    return new Field<ProductsId, VInventoryStatusViewRow>(_path, "product_id", VInventoryStatusViewRow::productId, Optional.empty(), Optional.empty(), (row, value) -> row.withProductId(value), ProductsId.mariaType);
  }
  ...
  public Field<WarehousesId, VInventoryStatusViewRow> warehouseId() {
    return new Field<WarehousesId, VInventoryStatusViewRow>(_path, "warehouse_id", VInventoryStatusViewRow::warehouseId, Optional.empty(), Optional.empty(), (row, value) -> row.withWarehouseId(value), WarehousesId.mariaType);
  }
  ...
  @Override
  public RowCodec<VInventoryStatusViewRow> rowCodec() {
    return VInventoryStatusViewRow.rowCodec;
  }
