 ...
 */
package combined.postgres.public_.pgtest;
...
public class PgtestFields extends TupleExpr70<Boolean, PGbox, String, byte[], String, PGcircle, LocalDate, Float, Double, Map<String, String>, Inet, Short, Int2Vector, Integer, Long, PGInterval, Json, Jsonb, PGline, PGlseg, Money, Mydomain, Myenum, String, BigDecimal, PGpath, PGpoint, PGpolygon, String, LocalTime, LocalDateTime, Instant, OffsetTime, UUID, String, Vector, Xml, List<PGbox>, List</* bpchar */ String>, List</* bpchar */ String>, List<PGcircle>, List<LocalDate>, List<Float>, List<Double>, List<Inet>, List<Short>, List<Int2Vector>, List<Integer>, List<Long>, List<PGInterval>, List<Json>, List<Jsonb>, List<PGline>, List<PGlseg>, List<Money>, List<Mydomain>, List<Myenum>, List<String>, List<BigDecimal>, List<PGpath>, List<PGpoint>, List<PGpolygon>, List<String>, List<LocalTime>, List<LocalDateTime>, List<Instant>, List<OffsetTime>, List<UUID>, List<String>, List<Xml>> implements RelationStructure<PgtestFields, PgtestRow>, FieldsBase<PgtestRow> {
  ...
  public Field<List<PGbox>, PgtestRow> boxes() {
    return new Field<List<PGbox>, PgtestRow>(_path, "boxes", PgtestRow::boxes, Optional.empty(), Optional.of("box[]"), (row, value) -> row.withBoxes(value), PgTypes.box.array());
  }

  public Field<List</* bpchar */ String>, PgtestRow> bpchares() {
    return new Field<List</* bpchar */ String>, PgtestRow>(_path, "bpchares", PgtestRow::bpchares, Optional.empty(), Optional.of("bpchar[]"), (row, value) -> row.withBpchares(value), PgTypes.bpchar.array());
  }

  public Field<List</* bpchar */ String>, PgtestRow> chares() {
    return new Field<List</* bpchar */ String>, PgtestRow>(_path, "chares", PgtestRow::chares, Optional.empty(), Optional.of("bpchar[]"), (row, value) -> row.withChares(value), PgTypes.bpchar.array());
  }

  public Field<List<PGcircle>, PgtestRow> circlees() {
    return new Field<List<PGcircle>, PgtestRow>(_path, "circlees", PgtestRow::circlees, Optional.empty(), Optional.of("circle[]"), (row, value) -> row.withCirclees(value), PgTypes.circle.array());
  }

  public Field<List<LocalDate>, PgtestRow> datees() {
    return new Field<List<LocalDate>, PgtestRow>(_path, "datees", PgtestRow::datees, Optional.empty(), Optional.of("date[]"), (row, value) -> row.withDatees(value), PgTypes.date.array());
  }

  public Field<List<Float>, PgtestRow> float4es() {
    return new Field<List<Float>, PgtestRow>(_path, "float4es", PgtestRow::float4es, Optional.empty(), Optional.of("float4[]"), (row, value) -> row.withFloat4es(value), PgTypes.float4.array());
  }

  public Field<List<Double>, PgtestRow> float8es() {
    return new Field<List<Double>, PgtestRow>(_path, "float8es", PgtestRow::float8es, Optional.empty(), Optional.of("float8[]"), (row, value) -> row.withFloat8es(value), PgTypes.float8.array());
  }

  public Field<List<Inet>, PgtestRow> inetes() {
    return new Field<List<Inet>, PgtestRow>(_path, "inetes", PgtestRow::inetes, Optional.empty(), Optional.of("inet[]"), (row, value) -> row.withInetes(value), PgTypes.inet.array());
  }

  public Field<List<Short>, PgtestRow> int2es() {
    return new Field<List<Short>, PgtestRow>(_path, "int2es", PgtestRow::int2es, Optional.empty(), Optional.of("int2[]"), (row, value) -> row.withInt2es(value), PgTypes.int2.array());
  }

  public Field<List<Int2Vector>, PgtestRow> int2vectores() {
    return new Field<List<Int2Vector>, PgtestRow>(_path, "int2vectores", PgtestRow::int2vectores, Optional.empty(), Optional.of("int2vector[]"), (row, value) -> row.withInt2vectores(value), PgTypes.int2vector.array());
  }

  public Field<List<Integer>, PgtestRow> int4es() {
    return new Field<List<Integer>, PgtestRow>(_path, "int4es", PgtestRow::int4es, Optional.empty(), Optional.of("int4[]"), (row, value) -> row.withInt4es(value), PgTypes.int4.array());
  }

  public Field<List<Long>, PgtestRow> int8es() {
    return new Field<List<Long>, PgtestRow>(_path, "int8es", PgtestRow::int8es, Optional.empty(), Optional.of("int8[]"), (row, value) -> row.withInt8es(value), PgTypes.int8.array());
  }

  public Field<List<PGInterval>, PgtestRow> intervales() {
    return new Field<List<PGInterval>, PgtestRow>(_path, "intervales", PgtestRow::intervales, Optional.empty(), Optional.of("interval[]"), (row, value) -> row.withIntervales(value), PgTypes.interval.array());
  }

  public Field<List<Json>, PgtestRow> jsones() {
    return new Field<List<Json>, PgtestRow>(_path, "jsones", PgtestRow::jsones, Optional.empty(), Optional.of("json[]"), (row, value) -> row.withJsones(value), PgTypes.json.array());
  }

  public Field<List<Jsonb>, PgtestRow> jsonbes() {
    return new Field<List<Jsonb>, PgtestRow>(_path, "jsonbes", PgtestRow::jsonbes, Optional.empty(), Optional.of("jsonb[]"), (row, value) -> row.withJsonbes(value), PgTypes.jsonb.array());
  }

  public Field<List<PGline>, PgtestRow> linees() {
    return new Field<List<PGline>, PgtestRow>(_path, "linees", PgtestRow::linees, Optional.empty(), Optional.of("line[]"), (row, value) -> row.withLinees(value), PgTypes.line.array());
  }

  public Field<List<PGlseg>, PgtestRow> lseges() {
    return new Field<List<PGlseg>, PgtestRow>(_path, "lseges", PgtestRow::lseges, Optional.empty(), Optional.of("lseg[]"), (row, value) -> row.withLseges(value), PgTypes.lseg.array());
  }

  public Field<List<Money>, PgtestRow> moneyes() {
    return new Field<List<Money>, PgtestRow>(_path, "moneyes", PgtestRow::moneyes, Optional.of("numeric[]"), Optional.of("money[]"), (row, value) -> row.withMoneyes(value), PgTypes.money.array());
  }

  public Field<List<Mydomain>, PgtestRow> mydomaines() {
    return new Field<List<Mydomain>, PgtestRow>(_path, "mydomaines", PgtestRow::mydomaines, Optional.of("text[]"), Optional.of("mydomain[]"), (row, value) -> row.withMydomaines(value), Mydomain.pgType.array());
  }

  public Field<List<Myenum>, PgtestRow> myenumes() {
    return new Field<List<Myenum>, PgtestRow>(_path, "myenumes", PgtestRow::myenumes, Optional.empty(), Optional.of("myenum[]"), (row, value) -> row.withMyenumes(value), Myenum.pgType.array());
  }

  public Field<List<String>, PgtestRow> namees() {
    return new Field<List<String>, PgtestRow>(_path, "namees", PgtestRow::namees, Optional.empty(), Optional.of("name[]"), (row, value) -> row.withNamees(value), PgTypes.name.array());
  }

  public Field<List<BigDecimal>, PgtestRow> numerices() {
    return new Field<List<BigDecimal>, PgtestRow>(_path, "numerices", PgtestRow::numerices, Optional.empty(), Optional.of("numeric[]"), (row, value) -> row.withNumerices(value), PgTypes.numeric.array());
  }

  public Field<List<PGpath>, PgtestRow> pathes() {
    return new Field<List<PGpath>, PgtestRow>(_path, "pathes", PgtestRow::pathes, Optional.empty(), Optional.of("path[]"), (row, value) -> row.withPathes(value), PgTypes.path.array());
  }

  public Field<List<PGpoint>, PgtestRow> pointes() {
    return new Field<List<PGpoint>, PgtestRow>(_path, "pointes", PgtestRow::pointes, Optional.empty(), Optional.of("point[]"), (row, value) -> row.withPointes(value), PgTypes.point.array());
  }

  public Field<List<PGpolygon>, PgtestRow> polygones() {
    return new Field<List<PGpolygon>, PgtestRow>(_path, "polygones", PgtestRow::polygones, Optional.empty(), Optional.of("polygon[]"), (row, value) -> row.withPolygones(value), PgTypes.polygon.array());
  }

  public Field<List<String>, PgtestRow> textes() {
    return new Field<List<String>, PgtestRow>(_path, "textes", PgtestRow::textes, Optional.empty(), Optional.of("text[]"), (row, value) -> row.withTextes(value), PgTypes.text.array());
  }

  public Field<List<LocalTime>, PgtestRow> timees() {
    return new Field<List<LocalTime>, PgtestRow>(_path, "timees", PgtestRow::timees, Optional.empty(), Optional.of("time[]"), (row, value) -> row.withTimees(value), PgTypes.time.array());
  }

  public Field<List<LocalDateTime>, PgtestRow> timestampes() {
    return new Field<List<LocalDateTime>, PgtestRow>(_path, "timestampes", PgtestRow::timestampes, Optional.empty(), Optional.of("timestamp[]"), (row, value) -> row.withTimestampes(value), PgTypes.timestamp.array());
  }

  public Field<List<Instant>, PgtestRow> timestampzes() {
    return new Field<List<Instant>, PgtestRow>(_path, "timestampzes", PgtestRow::timestampzes, Optional.empty(), Optional.of("timestamptz[]"), (row, value) -> row.withTimestampzes(value), PgTypes.timestamptz.array());
  }

  public Field<List<OffsetTime>, PgtestRow> timezes() {
    return new Field<List<OffsetTime>, PgtestRow>(_path, "timezes", PgtestRow::timezes, Optional.empty(), Optional.of("timetz[]"), (row, value) -> row.withTimezes(value), PgTypes.timetz.array());
  }

  public Field<List<UUID>, PgtestRow> uuides() {
    return new Field<List<UUID>, PgtestRow>(_path, "uuides", PgtestRow::uuides, Optional.empty(), Optional.of("uuid[]"), (row, value) -> row.withUuides(value), PgTypes.uuid.array());
  }

  public Field<List<String>, PgtestRow> varchares() {
    return new Field<List<String>, PgtestRow>(_path, "varchares", PgtestRow::varchares, Optional.empty(), Optional.of("varchar[]"), (row, value) -> row.withVarchares(value), PgTypes.text.array());
  }

  public Field<List<Xml>, PgtestRow> xmles() {
    return new Field<List<Xml>, PgtestRow>(_path, "xmles", PgtestRow::xmles, Optional.empty(), Optional.of("xml[]"), (row, value) -> row.withXmles(value), PgTypes.xml.array());
  }
  ...
  @Override
  public RowCodec<PgtestRow> rowCodec() {
    return PgtestRow.rowCodec;
  }

  @Override
  public RelationStructure<PgtestFields, PgtestRow> withPaths(List<Path> _path) {
    return new PgtestFields(_path);
  }
