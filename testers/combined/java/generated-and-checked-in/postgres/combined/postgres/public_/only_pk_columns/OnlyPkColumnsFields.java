...
public class OnlyPkColumnsFields extends TupleExpr2<String, Integer> implements RelationStructure<OnlyPkColumnsFields, OnlyPkColumnsRow>, FieldsBase<OnlyPkColumnsRow> {
  List<Path> _path;
  ...
  public static OnlyPkColumnsFields structure = new OnlyPkColumnsFields(java.util.Collections.emptyList());
  ...
  @Override
  public RowCodec<OnlyPkColumnsRow> rowCodec() {
    return OnlyPkColumnsRow.rowCodec;
  }
