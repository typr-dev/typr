...
public record IdentityTestRow(
  ...
  public static RowCodec<IdentityTestRow> rowCodec = RowCodecs.of(PgTypes.int4, PgTypes.int4, IdentityTestId.pgType, IdentityTestRow::new, row -> new Object[]{row.alwaysGenerated(), row.defaultGenerated(), row.name()});
