...
public record OnlyPkColumnsRow(
  ...
  public static RowCodec<OnlyPkColumnsRow> rowCodec = RowCodecs.of(PgTypes.text, PgTypes.int4, OnlyPkColumnsRow::new, row -> new Object[]{row.keyColumn1(), row.keyColumn2()});
