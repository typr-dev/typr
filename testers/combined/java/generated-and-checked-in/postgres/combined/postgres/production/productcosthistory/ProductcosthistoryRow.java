...
public record ProductcosthistoryRow(
  /** Product identification number. Foreign key to Product.ProductID
    * Points to {@link combined.postgres.production.product.ProductRow#productid()}
    */
  ProductId productid,
...
) implements Tuple5<ProductId, LocalDateTime, Optional<LocalDateTime>, BigDecimal, LocalDateTime> {
  /** Product identification number. Foreign key to Product.ProductID
    * Points to {@link combined.postgres.production.product.ProductRow#productid()}
    */
  ...
  public static RowCodec<ProductcosthistoryRow> rowCodec = RowCodecs.of(ProductId.pgType, PgTypes.timestamp, PgTypes.timestamp.opt(), PgTypes.numeric, PgTypes.timestamp, ProductcosthistoryRow::new, row -> new Object[]{row.productid(), row.startdate(), row.enddate(), row.standardcost(), row.modifieddate()});
