...
public record ProductmodelRow(
  ...
  public static RowCodec<ProductmodelRow> rowCodec = RowCodecs.of(ProductmodelId.pgType, Name.pgType, PgTypes.xml.opt(), PgTypes.xml.opt(), PgTypes.uuid, PgTypes.timestamp, ProductmodelRow::new, row -> new Object[]{row.productmodelid(), row.name(), row.catalogdescription(), row.instructions(), row.rowguid(), row.modifieddate()});
