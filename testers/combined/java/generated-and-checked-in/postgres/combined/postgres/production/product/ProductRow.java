...
) implements Tuple25<ProductId, Name, String, Flag, Flag, Optional</* max 15 chars */ String>, Short, Short, BigDecimal, BigDecimal, Optional</* max 5 chars */ String>, Optional<UnitmeasureId>, Optional<UnitmeasureId>, Optional<BigDecimal>, Integer, Optional</* bpchar, max 2 chars */ String>, Optional</* bpchar, max 2 chars */ String>, Optional</* bpchar, max 2 chars */ String>, Optional<ProductsubcategoryId>, Optional<ProductmodelId>, LocalDateTime, Optional<LocalDateTime>, Optional<LocalDateTime>, UUID, LocalDateTime> {
  /** Primary key for Product records.
    * Default: nextval('production.product_productid_seq'::regclass)
    */
