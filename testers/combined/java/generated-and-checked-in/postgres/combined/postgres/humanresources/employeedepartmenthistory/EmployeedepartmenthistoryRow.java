...
public record EmployeedepartmenthistoryRow(
  ...
  /** Department in which the employee worked including currently. Foreign key to Department.DepartmentID.
    * Points to {@link combined.postgres.humanresources.department.DepartmentRow#departmentid()}
    */
  DepartmentId departmentid,
  /** Identifies which 8-hour shift the employee works. Foreign key to Shift.Shift.ID.
    * Points to {@link combined.postgres.humanresources.shift.ShiftRow#shiftid()}
    */
  ShiftId shiftid,
...
) implements Tuple6<BusinessentityId, DepartmentId, ShiftId, LocalDate, Optional<LocalDate>, LocalDateTime> {
  /** Employee identification number. Foreign key to Employee.BusinessEntityID.
    * Points to {@link combined.postgres.humanresources.employee.EmployeeRow#businessentityid()}
    */
  ...
  public static RowCodec<EmployeedepartmenthistoryRow> rowCodec = RowCodecs.of(BusinessentityId.pgType, DepartmentId.pgType, ShiftId.pgType, PgTypes.date, PgTypes.date.opt(), PgTypes.timestamp, EmployeedepartmenthistoryRow::new, row -> new Object[]{row.businessentityid(), row.departmentid(), row.shiftid(), row.startdate(), row.enddate(), row.modifieddate()});
