...
public class EmployeeRepoImpl implements EmployeeRepo {
  ...
  public EmployeeRow insert(EmployeeRow unsaved, Connection c) {
    return interpolate(
            ...
            Fragment.lit(", "),
            Fragment.encode(PgTypes.text, unsaved.loginid()),
            Fragment.lit(", "),
            Fragment.encode(PgTypes.text, unsaved.jobtitle()),
            Fragment.lit(", "),
            Fragment.encode(PgTypes.date, unsaved.birthdate()),
            Fragment.lit("::date, "),
            Fragment.encode(PgTypes.bpchar, unsaved.maritalstatus()),
            Fragment.lit("::bpchar, "),
            Fragment.encode(PgTypes.bpchar, unsaved.gender()),
            Fragment.lit("::bpchar, "),
            Fragment.encode(PgTypes.date, unsaved.hiredate()),
            Fragment.lit("::date, "),
            Fragment.encode(IsSalaried.pgType, unsaved.salariedflag()),
            Fragment.lit("::bool, "),
            Fragment.encode(PgTypes.int2, unsaved.vacationhours()),
            Fragment.lit("::int2, "),
            Fragment.encode(PgTypes.int2, unsaved.sickleavehours()),
            Fragment.lit("::int2, "),
            Fragment.encode(IsActive.pgType, unsaved.currentflag()),
            Fragment.lit("::bool, "),
  ...
  public EmployeeRow insert(EmployeeRowUnsaved unsaved, Connection c) {
    ...
    values.add(
        interpolate(Fragment.encode(PgTypes.text, unsaved.nationalidnumber()), Fragment.lit("")));
    ...
    values.add(
        interpolate(Fragment.encode(PgTypes.date, unsaved.birthdate()), Fragment.lit("::date")));
    columns.add(Fragment.lit("\"maritalstatus\""));
    values.add(
        interpolate(
            Fragment.encode(PgTypes.bpchar, unsaved.maritalstatus()), Fragment.lit("::bpchar")));
    columns.add(Fragment.lit("\"gender\""));
    values.add(
        interpolate(Fragment.encode(PgTypes.bpchar, unsaved.gender()), Fragment.lit("::bpchar")));
    columns.add(Fragment.lit("\"hiredate\""));
    values.add(
        interpolate(Fragment.encode(PgTypes.date, unsaved.hiredate()), Fragment.lit("::date")));
    unsaved
        .salariedflag()
        .visit(
            () -> {},
            value -> {
              ...
              values.add(
                  interpolate(Fragment.encode(IsSalaried.pgType, value), Fragment.lit("::bool")));
            });
    ;
    unsaved
        .vacationhours()
    ...
    unsaved
        ...
        .visit(
            ...
            value -> {
              ...
              values.add(
                  interpolate(Fragment.encode(IsActive.pgType, value), Fragment.lit("::bool")));
            });
    ;
    unsaved
        .rowguid()
    ...
    Fragment q =
        interpolate(
            Fragment.lit("insert into \"humanresources\".\"employee\"("),
  ...
  public Long insertStreaming(Iterator<EmployeeRow> unsaved, Integer batchSize, Connection c) {
    return streamingInsert.insertUnchecked(
        "COPY \"humanresources\".\"employee\"(\"businessentityid\", \"nationalidnumber\","
            + " \"loginid\", \"jobtitle\", \"birthdate\", \"maritalstatus\", \"gender\","
            + " \"hiredate\", \"salariedflag\", \"vacationhours\", \"sickleavehours\","
            + " \"currentflag\", \"rowguid\", \"modifieddate\", \"organizationnode\") FROM STDIN",
        batchSize,
        unsaved,
        c,
        EmployeeRow.pgText);
  ...
  public Boolean update(EmployeeRow row, Connection c) {
    ...
    ;
    return interpolate(
                Fragment.lit("update \"humanresources\".\"employee\"\nset \"nationalidnumber\" = "),
                Fragment.encode(PgTypes.text, row.nationalidnumber()),
                Fragment.lit(",\n\"loginid\" = "),
                Fragment.encode(PgTypes.text, row.loginid()),
                Fragment.lit(",\n\"jobtitle\" = "),
                Fragment.encode(PgTypes.text, row.jobtitle()),
                Fragment.lit(",\n\"birthdate\" = "),
                Fragment.encode(PgTypes.date, row.birthdate()),
                Fragment.lit("::date,\n\"maritalstatus\" = "),
                Fragment.encode(PgTypes.bpchar, row.maritalstatus()),
                Fragment.lit("::bpchar,\n\"gender\" = "),
                Fragment.encode(PgTypes.bpchar, row.gender()),
                Fragment.lit("::bpchar,\n\"hiredate\" = "),
                Fragment.encode(PgTypes.date, row.hiredate()),
                Fragment.lit("::date,\n\"salariedflag\" = "),
                Fragment.encode(IsSalaried.pgType, row.salariedflag()),
                Fragment.lit("::bool,\n\"vacationhours\" = "),
                Fragment.encode(PgTypes.int2, row.vacationhours()),
                Fragment.lit("::int2,\n\"sickleavehours\" = "),
                Fragment.encode(PgTypes.int2, row.sickleavehours()),
                Fragment.lit("::int2,\n\"currentflag\" = "),
                Fragment.encode(IsActive.pgType, row.currentflag()),
                Fragment.lit("::bool,\n\"rowguid\" = "),
    ...
    return interpolate(
            Fragment.lit(
                "insert into \"humanresources\".\"employee\"(\"businessentityid\","
                    ...
                    + " \"vacationhours\", \"sickleavehours\", \"currentflag\", \"rowguid\","
                    + " \"modifieddate\", \"organizationnode\")\n"
                    + "values (?::int4, ?, ?, ?, ?::date, ?::bpchar, ?::bpchar, ?::date, ?::bool,"
                    + " ?::int2, ?::int2, ?::bool, ?::uuid, ?::timestamp, ?)\n"
                    + "on conflict (\"businessentityid\")\n"
                    + "do update set\n"
                    + "  \"nationalidnumber\" = EXCLUDED.\"nationalidnumber\",\n"
                    + "\"loginid\" = EXCLUDED.\"loginid\",\n"
  ...
  public Integer upsertStreaming(Iterator<EmployeeRow> unsaved, Integer batchSize, Connection c) {
    interpolate(
            Fragment.lit(
                "create temporary table employee_TEMP (like \"humanresources\".\"employee\") on"
                    + " commit drop"))
        .update()
        .runUnchecked(c);
    streamingInsert.insertUnchecked(
        "copy employee_TEMP(\"businessentityid\", \"nationalidnumber\", \"loginid\", \"jobtitle\","
            + " \"birthdate\", \"maritalstatus\", \"gender\", \"hiredate\", \"salariedflag\","
            + " \"vacationhours\", \"sickleavehours\", \"currentflag\", \"rowguid\","
            + " \"modifieddate\", \"organizationnode\") from stdin",
        batchSize,
        unsaved,
        c,
        EmployeeRow.pgText);
