...
public record ShiftRow(
  ...
  public static RowCodec<ShiftRow> rowCodec = RowCodecs.of(ShiftId.pgType, Name.pgType, PgTypes.time, PgTypes.time, PgTypes.timestamp, ShiftRow::new, row -> new Object[]{row.shiftid(), row.name(), row.starttime(), row.endtime(), row.modifieddate()});
