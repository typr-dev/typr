...
public record EmployeeRow(
     ...
     */
    /* user-picked */ IsSalaried salariedflag,
    /**
    ...
    /* user-picked */ IsActive currentflag,
   ...
   * from collective bargaining. Default: true
   */
  public EmployeeRow withSalariedflag(/* user-picked */ IsSalaried salariedflag) {
    return new EmployeeRow(
        businessentityid,
        nationalidnumber,
        loginid,
  ...
  /** 0 = Inactive, 1 = Active Default: true */
  public EmployeeRow withCurrentflag(/* user-picked */ IsActive currentflag) {
    return new EmployeeRow(
        businessentityid,
        nationalidnumber,
        loginid,
  ...
  @Override
  public /* user-picked */ IsActive _12() {
    return currentflag;
  }
  ;
  ...
  @Override
  public /* user-picked */ IsSalaried _9() {
    return salariedflag;
  }
  ;
