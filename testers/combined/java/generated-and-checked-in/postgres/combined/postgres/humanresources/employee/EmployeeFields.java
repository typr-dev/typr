...
public class EmployeeFields extends TupleExpr15<BusinessentityId, String, String, String, LocalDate, String, String, LocalDate, /* user-picked */ SalariedFlag, Short, Short, /* user-picked */ CurrentFlag, UUID, LocalDateTime, String> implements RelationStructure<EmployeeFields, EmployeeRow>, FieldsBase<EmployeeRow> {
  List<Path> _path;
  ...
  public Field</* user-picked */ SalariedFlag, EmployeeRow> salariedflag() {
    return new Field</* user-picked */ SalariedFlag, EmployeeRow>(_path, "salariedflag", EmployeeRow::salariedflag, Optional.empty(), Optional.of("bool"), (row, value) -> row.withSalariedflag(value), SalariedFlag.pgType);
  }
  ...
  public Field</* user-picked */ CurrentFlag, EmployeeRow> currentflag() {
    return new Field</* user-picked */ CurrentFlag, EmployeeRow>(_path, "currentflag", EmployeeRow::currentflag, Optional.empty(), Optional.of("bool"), (row, value) -> row.withCurrentflag(value), CurrentFlag.pgType);
  }
  ...
  @Override
  public RowCodec<EmployeeRow> rowCodec() {
    return EmployeeRow.rowCodec;
  }
