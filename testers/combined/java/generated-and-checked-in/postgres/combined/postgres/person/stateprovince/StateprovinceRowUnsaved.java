...
public record StateprovinceRowUnsaved(
  ...
  public StateprovinceRowUnsaved(
    ...
    this(stateprovincecode, countryregioncode, name, territoryid, new UseDefault<>(), new UseDefault<>(), new UseDefault<>(), new UseDefault<>());
  }
  ...
  /** Default: true
    * 0 = StateProvinceCode exists. 1 = StateProvinceCode unavailable, using CountryRegionCode.
    */
  public StateprovinceRowUnsaved withIsonlystateprovinceflag(Defaulted<Flag> isonlystateprovinceflag) {
    return new StateprovinceRowUnsaved(stateprovincecode, countryregioncode, name, territoryid, stateprovinceid, isonlystateprovinceflag, rowguid, modifieddate);
  }
