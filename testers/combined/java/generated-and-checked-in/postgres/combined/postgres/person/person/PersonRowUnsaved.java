...
public record PersonRowUnsaved(
    ...
    /**
     * Default: false 0 = The data in FirstName and LastName are stored in western style (first
     * name, last name) order. 1 = Eastern style (last name, first name) order.
     */
    Defaulted<NameStyle> namestyle,
    /**
     * Default: 0 0 = Contact does not wish to receive e-mail promotions, 1 = Contact does wish to
     * receive e-mail promotions from AdventureWorks, 2 = Contact does wish to receive e-mail
     * promotions from AdventureWorks and selected partners. Constraint CK_Person_EmailPromotion
  ...
  /**
   * Default: false 0 = The data in FirstName and LastName are stored in western style (first name,
   * last name) order. 1 = Eastern style (last name, first name) order.
   */
  ...
  public PersonRow toRow(
    ...
    return new PersonRow(
        businessentityid,
        persontype,
        namestyle.getOrElse(namestyleDefault),
        title,
        firstname,
        middlename,
        lastname,
        suffix,
        emailpromotion.getOrElse(emailpromotionDefault),
        additionalcontactinfo,
        demographics,
