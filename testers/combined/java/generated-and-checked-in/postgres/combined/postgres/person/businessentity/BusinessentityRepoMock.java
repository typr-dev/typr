...
public record BusinessentityRepoMock(
  ...
  public BusinessentityRepoMock(
      java.util.function.Function<BusinessentityRowUnsaved, BusinessentityRow> toRow) {
    this(toRow, new HashMap<BusinessentityId, BusinessentityRow>());
  }
  ;

  public BusinessentityRepoMock withToRow(
      java.util.function.Function<BusinessentityRowUnsaved, BusinessentityRow> toRow) {
  ...
  public Long insertStreaming(
      Iterator<BusinessentityRow> unsaved, Integer batchSize, Connection c) {
    var count = 0L;
  ...
  public SelectBuilder<BusinessentityFields, BusinessentityRow> select() {
    return new SelectBuilderMock<>(
        BusinessentityFields.structure, () -> new ArrayList<>(map.values()), SelectParams.empty());
  }
  ;
  ...
  public Map<BusinessentityId, BusinessentityRow> selectByIdsTracked(
    ...
    return selectByIds(businessentityids, c).stream()
        .collect(
            Collectors.toMap(
                (BusinessentityRow row) -> row.businessentityid(), Function.identity()));
  }
  ;
