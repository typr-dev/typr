...
public class BusinessentityRepoImpl implements BusinessentityRepo {
  ...
  public Long insertStreaming(
    ...
    return streamingInsert.insertUnchecked(
        "COPY \"person\".\"businessentity\"(\"businessentityid\", \"rowguid\", \"modifieddate\")"
            + " FROM STDIN",
        batchSize,
        unsaved,
        c,
  ...
  public Map<BusinessentityId, BusinessentityRow> selectByIdsTracked(
    ...
    HashMap<BusinessentityId, BusinessentityRow> ret =
        new HashMap<BusinessentityId, BusinessentityRow>();
  ...
  public Boolean update(BusinessentityRow row, Connection c) {
    ...
    ;
    return interpolate(
                Fragment.lit("update \"person\".\"businessentity\"\nset \"rowguid\" = "),
  ...
  public Integer upsertStreaming(
    ...
    interpolate(
            Fragment.lit(
                "create temporary table businessentity_TEMP (like \"person\".\"businessentity\") on"
                    + " commit drop"))
        .update()
        .runUnchecked(c);
    ...
    return interpolate(
            Fragment.lit(
                "insert into \"person\".\"businessentity\"(\"businessentityid\", \"rowguid\","
                    ...
                    + "\"modifieddate\" = EXCLUDED.\"modifieddate\"\n"
                    + ";\n"
                    + "drop table businessentity_TEMP;"))
        .update()
        .runUnchecked(c);
  }
}
