...
public record PersonRow(
  /** Primary key for Person records.
    * Points to {@link combined.postgres.person.businessentity.BusinessentityRow#businessentityid()}
    */
...
) implements Tuple13<BusinessentityId, String, NameStyle, Optional</* max 8 chars */ String>, /* user-picked */ FirstName, Optional</* user-picked */ MiddleName>, /* user-picked */ LastName, Optional</* max 10 chars */ String>, Integer, Optional<Xml>, Optional<Xml>, UUID, LocalDateTime> {
  /** Primary key for Person records.
    * Points to {@link combined.postgres.person.businessentity.BusinessentityRow#businessentityid()}
    */
