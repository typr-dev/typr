...
public record BusinessentityRow(
  ...
  public static RowCodec<BusinessentityRow> rowCodec = RowCodecs.of(BusinessentityId.pgType, PgTypes.uuid, PgTypes.timestamp, BusinessentityRow::new, row -> new Object[]{row.businessentityid(), row.rowguid(), row.modifieddate()});
