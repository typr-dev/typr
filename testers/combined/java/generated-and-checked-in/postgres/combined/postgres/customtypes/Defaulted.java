 ...
 */
package combined.postgres.customtypes;

import com.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.fasterxml.jackson.databind.annotation.JsonSerialize;
import combined.postgres.DefaultedDeserializer;
import combined.postgres.DefaultedSerializer;
...
public sealed interface Defaulted<T> permits Defaulted.Provided, Defaulted.UseDefault {
  ...
  static <T> PgText<Defaulted<T>> pgText(DbText<T> t) {
  ...
  void visit(java.lang.Runnable onDefault, java.util.function.Consumer<T> onProvided);
}
