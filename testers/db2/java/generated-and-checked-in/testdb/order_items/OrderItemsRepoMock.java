...
public record OrderItemsRepoMock(HashMap<OrderItemsId, OrderItemsRow> map) implements OrderItemsRepo {
  public OrderItemsRepoMock() {
    this(new HashMap<OrderItemsId, OrderItemsRow>());
  }

  public OrderItemsRepoMock withMap(HashMap<OrderItemsId, OrderItemsRow> map) {
    return new OrderItemsRepoMock(map);
  }
