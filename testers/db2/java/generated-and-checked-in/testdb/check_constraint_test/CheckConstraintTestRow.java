...
public record CheckConstraintTestRow(
  ...
  public static RowCodec<CheckConstraintTestRow> rowCodec = RowCodecs.of(CheckConstraintTestId.db2Type, Db2Types.integer, Db2Types.varchar, Db2Types.decimal.opt(), CheckConstraintTestRow::new, row -> new Object[]{row.id(), row.age(), row.status(), row.price()});
