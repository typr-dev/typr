...
public record CustomersRow(
  ...
  public static RowCodec<CustomersRow> rowCodec = RowCodecs.of(CustomersId.db2Type, Db2Types.varchar, Db2Types.varchar, Db2Types.timestamp.opt(), CustomersRow::new, row -> new Object[]{row.customerId(), row.name(), row.email(), row.createdAt()});
