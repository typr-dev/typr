...
class OrderUpdatedSerde extends Serde[OrderUpdated] with Serializer[OrderUpdated]  with Deserializer[OrderUpdated] {
  ...
  override def serializer: Serializer[OrderUpdated] = this

  override def deserializer: Deserializer[OrderUpdated] = this
}