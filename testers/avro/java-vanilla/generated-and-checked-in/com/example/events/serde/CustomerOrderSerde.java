...
public class CustomerOrderSerde
  ...
  DatumWriter<GenericRecord> writer = new GenericDatumWriter(CustomerOrder.SCHEMA);

  DatumReader<GenericRecord> reader = new GenericDatumReader(CustomerOrder.SCHEMA);
