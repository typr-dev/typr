...
public class DynamicValueSerde
  ...
  DatumWriter<GenericRecord> writer = new GenericDatumWriter(DynamicValue.SCHEMA);

  DatumReader<GenericRecord> reader = new GenericDatumReader(DynamicValue.SCHEMA);
