...
public record CustomerOrderProducer(Producer<String, CustomerOrder> producer, String topic)
  ...
  public Future<RecordMetadata> send(String key, CustomerOrder value) {
    return producer.send(new ProducerRecord<String, CustomerOrder>(topic, key, value));
  }

  /** Send a message with headers to the topic */
  public Future<RecordMetadata> send(String key, CustomerOrder value, StandardHeaders headers) {
    return producer.send(
        new ProducerRecord<String, CustomerOrder>(topic, null, key, value, headers.toHeaders()));
  }
}
