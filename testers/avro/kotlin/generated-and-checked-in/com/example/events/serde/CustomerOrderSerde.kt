...
class CustomerOrderSerde() : Serde<CustomerOrder>, Serializer<CustomerOrder>, Deserializer<CustomerOrder> {
  override fun close() {
  ...
  override fun deserializer(): Deserializer<CustomerOrder> = this
  ...
  override fun serializer(): Serializer<CustomerOrder> = this
}