...
/** Serde for TreeNode */
class TreeNodeSerde() : Serde<TreeNode>, Serializer<TreeNode>, Deserializer<TreeNode> {
  override fun close() {
  ...
  override fun deserializer(): Deserializer<TreeNode> = this
  ...
  override fun serializer(): Serializer<TreeNode> = this
}