...
/** Serde for Money */
class MoneySerde() : Serde<Money>, Serializer<Money>, Deserializer<Money> {
  override fun close() {
  ...
  override fun deserializer(): Deserializer<Money> = this
  ...
  override fun serializer(): Serializer<Money> = this
}