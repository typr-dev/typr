...
class LinkedListNodeSerde() : Serde<LinkedListNode>, Serializer<LinkedListNode>, Deserializer<LinkedListNode> {
  override fun close() {
  ...
  override fun deserializer(): Deserializer<LinkedListNode> = this
  ...
  override fun serializer(): Serializer<LinkedListNode> = this
}