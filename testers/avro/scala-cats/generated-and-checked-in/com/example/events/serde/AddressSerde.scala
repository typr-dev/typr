...
/** Serde for Address */
class AddressSerde extends Serde[Address] with Serializer[Address]  with Deserializer[Address] {
  ...
  override def serializer: Serializer[Address] = this

  override def deserializer: Deserializer[Address] = this
}