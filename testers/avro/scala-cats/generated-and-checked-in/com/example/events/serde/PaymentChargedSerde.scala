...
class PaymentChargedSerde extends Serde[PaymentCharged] with Serializer[PaymentCharged]  with Deserializer[PaymentCharged] {
  ...
  override def serializer: Serializer[PaymentCharged] = this

  override def deserializer: Deserializer[PaymentCharged] = this
}