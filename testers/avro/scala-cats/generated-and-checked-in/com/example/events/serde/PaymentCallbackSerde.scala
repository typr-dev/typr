...
class PaymentCallbackSerde extends Serde[PaymentCallback] with Serializer[PaymentCallback]  with Deserializer[PaymentCallback] {
  ...
  override def serializer: Serializer[PaymentCallback] = this

  override def deserializer: Deserializer[PaymentCallback] = this
}