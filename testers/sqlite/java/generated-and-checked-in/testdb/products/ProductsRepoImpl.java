...
public class ProductsRepoImpl implements ProductsRepo {
  ...
  public DeleteBuilder<ProductsFields, ProductsRow> delete() {
    return DeleteBuilder.of("\"products\"", ProductsFields.structure, Dialect.SQLITE);
  }
  ...
  public Boolean deleteById(
    ...
    return concat(Fragment.of("delete from \"products\" where \"product_id\" = "), Fragment.encode(ProductsId.sqliteType, productId), Fragment.of("")).update().run(c) > 0;
  }
  ...
  public Integer deleteByIds(
    ...
    for (var id : productIds) { fragments.add(Fragment.encode(ProductsId.sqliteType, id)); };
  ...
  public SelectBuilder<ProductsFields, ProductsRow> select() {
    return SelectBuilder.of("\"products\"", ProductsFields.structure, ProductsRow.rowCodec, Dialect.SQLITE);
  }
  ...
  public List<ProductsRow> selectByIds(
    ...
    ArrayList<Fragment> fragments = new ArrayList<>();
    for (var id : productIds) { fragments.add(Fragment.encode(ProductsId.sqliteType, id)); };
    return Fragment.concat(Fragment.of("select \"product_id\", \"sku\", \"name\", \"price\", \"metadata\" from \"products\" where \"product_id\" in ("), Fragment.comma(fragments), Fragment.of(")")).query(ProductsRow.rowCodec.all()).run(c);
  }
  ...
  public UpdateBuilder<ProductsFields, ProductsRow> update() {
    return UpdateBuilder.of("\"products\"", ProductsFields.structure, ProductsRow.rowCodec, Dialect.SQLITE);
  }
