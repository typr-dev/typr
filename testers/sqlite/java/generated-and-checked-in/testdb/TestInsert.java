...
public record TestInsert(Random random) {
  ...
  public Inserter<OrderItemsRowUnsaved, OrderItemsRow> OrderItems(
    ...
    return Inserter.of(new OrderItemsRowUnsaved(orderId, productId, BigDecimal.valueOf(random.nextDouble()), new UseDefault()), (OrderItemsRowUnsaved row, Connection c) -> (new OrderItemsRepoImpl()).insert(row, c));
  }

  public Inserter<OrdersRowUnsaved, OrdersRow> Orders(CustomersId customerId) {
    return Inserter.of(new OrdersRowUnsaved(new OrdersId(random.nextLong()), customerId, LocalDate.ofEpochDay((long) (random.nextInt(30000))), (random.nextBoolean() ? Optional.empty() : Optional.of(BigDecimal.valueOf(random.nextDouble()))), new UseDefault()), (OrdersRowUnsaved row, Connection c) -> (new OrdersRepoImpl()).insert(row, c));
  }

  public Inserter<PrecisionTypesRow, PrecisionTypesRow> PrecisionTypes() {
    return Inserter.of(new PrecisionTypesRow(new PrecisionTypesId(random.nextLong()), String10.truncate(RandomHelper.alphanumeric(random, 10)), String20.truncate(RandomHelper.alphanumeric(random, 20)), String50.truncate(RandomHelper.alphanumeric(random, 20)), String100.truncate(RandomHelper.alphanumeric(random, 20)), String255.truncate(RandomHelper.alphanumeric(random, 20)), Decimal5_2.unsafeForce(BigDecimal.valueOf((long) (Math.abs(random.nextInt()) % 1000)).add(BigDecimal.valueOf((long) (Math.abs(random.nextInt()) % 100)).movePointLeft(2))), Decimal10_2.unsafeForce(BigDecimal.valueOf((long) (Math.abs(random.nextInt()) % 1000000)).add(BigDecimal.valueOf((long) (Math.abs(random.nextInt()) % 100)).movePointLeft(2))), Decimal18_4.unsafeForce(BigDecimal.valueOf((long) (Math.abs(random.nextInt()) % 1000000)).add(BigDecimal.valueOf((long) (Math.abs(random.nextInt()) % 10000)).movePointLeft(4))), Int5.unsafeForce(BigInteger.valueOf((long) (Math.abs(random.nextInt()) % 100000))), Int10.unsafeForce(BigInteger.valueOf((long) (Math.abs(random.nextInt()) % 1000000000))), Int18.unsafeForce(BigInteger.valueOf((long) (Math.abs(random.nextInt()) % 1000000000)))), (PrecisionTypesRow row, Connection c) -> (new PrecisionTypesRepoImpl()).insert(row, c));
  }

  public Inserter<PrecisionTypesNullRow, PrecisionTypesNullRow> PrecisionTypesNull() {
    return Inserter.of(new PrecisionTypesNullRow(new PrecisionTypesNullId(random.nextLong()), (random.nextBoolean() ? Optional.empty() : Optional.of(String10.truncate(RandomHelper.alphanumeric(random, 10)))), (random.nextBoolean() ? Optional.empty() : Optional.of(String20.truncate(RandomHelper.alphanumeric(random, 20)))), (random.nextBoolean() ? Optional.empty() : Optional.of(String50.truncate(RandomHelper.alphanumeric(random, 20)))), (random.nextBoolean() ? Optional.empty() : Optional.of(String100.truncate(RandomHelper.alphanumeric(random, 20)))), (random.nextBoolean() ? Optional.empty() : Optional.of(String255.truncate(RandomHelper.alphanumeric(random, 20)))), (random.nextBoolean() ? Optional.empty() : Optional.of(Decimal5_2.unsafeForce(BigDecimal.valueOf((long) (Math.abs(random.nextInt()) % 1000)).add(BigDecimal.valueOf((long) (Math.abs(random.nextInt()) % 100)).movePointLeft(2))))), (random.nextBoolean() ? Optional.empty() : Optional.of(Decimal10_2.unsafeForce(BigDecimal.valueOf((long) (Math.abs(random.nextInt()) % 1000000)).add(BigDecimal.valueOf((long) (Math.abs(random.nextInt()) % 100)).movePointLeft(2))))), (random.nextBoolean() ? Optional.empty() : Optional.of(Decimal18_4.unsafeForce(BigDecimal.valueOf((long) (Math.abs(random.nextInt()) % 1000000)).add(BigDecimal.valueOf((long) (Math.abs(random.nextInt()) % 10000)).movePointLeft(4))))), (random.nextBoolean() ? Optional.empty() : Optional.of(Int5.unsafeForce(BigInteger.valueOf((long) (Math.abs(random.nextInt()) % 100000))))), (random.nextBoolean() ? Optional.empty() : Optional.of(Int10.unsafeForce(BigInteger.valueOf((long) (Math.abs(random.nextInt()) % 1000000000))))), (random.nextBoolean() ? Optional.empty() : Optional.of(Int18.unsafeForce(BigInteger.valueOf((long) (Math.abs(random.nextInt()) % 1000000000)))))), (PrecisionTypesNullRow row, Connection c) -> (new PrecisionTypesNullRepoImpl()).insert(row, c));
  }

  public Inserter<ProductsRow, ProductsRow> Products() {
    return Inserter.of(new ProductsRow(new ProductsId(random.nextLong()), RandomHelper.alphanumeric(random, 20), RandomHelper.alphanumeric(random, 20), BigDecimal.valueOf(random.nextDouble()), (random.nextBoolean() ? Optional.empty() : Optional.of(new Json("{}")))), (ProductsRow row, Connection c) -> (new ProductsRepoImpl()).insert(row, c));
  }

  public Inserter<UsersRow, UsersRow> Users() {
    return Inserter.of(new UsersRow(new UsersId(random.nextLong()), RandomHelper.alphanumeric(random, 20), new Email(RandomHelper.alphanumeric(random, 20))), (UsersRow row, Connection c) -> (new UsersRepoImpl()).insert(row, c));
  }
}