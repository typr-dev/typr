...
public class CustomersFields extends TupleExpr4<CustomersId, String, /* user-picked */ Email, LocalDateTime> implements RelationStructure<CustomersFields, CustomersRow>, FieldsBase<CustomersRow> {
  ...
  public IdField<CustomersId, CustomersRow> customerId() {
    return new IdField<CustomersId, CustomersRow>(_path, "customer_id", CustomersRow::customerId, Optional.empty(), Optional.empty(), (row, value) -> row.withCustomerId(value), CustomersId.sqliteType);
  }

  public Field<String, CustomersRow> name() {
    return new Field<String, CustomersRow>(_path, "name", CustomersRow::name, Optional.empty(), Optional.empty(), (row, value) -> row.withName(value), SqliteTypes.text);
  }

  public OptField</* user-picked */ Email, CustomersRow> email() {
    return new OptField</* user-picked */ Email, CustomersRow>(_path, "email", CustomersRow::email, Optional.empty(), Optional.empty(), (row, value) -> row.withEmail(value), Email.sqliteType);
  }

  public Field<LocalDateTime, CustomersRow> createdAt() {
    return new Field<LocalDateTime, CustomersRow>(_path, "created_at", CustomersRow::createdAt, Optional.empty(), Optional.empty(), (row, value) -> row.withCreatedAt(value), SqliteTypes.timestamp);
  }
