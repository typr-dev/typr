...
public class EmployeesRepoImpl implements EmployeesRepo {
  ...
  public DeleteBuilder<EmployeesFields, EmployeesRow> delete() {
    return DeleteBuilder.of("\"employees\"", EmployeesFields.structure, Dialect.SQLITE);
  }
  ...
  public Boolean deleteById(
    ...
    return concat(Fragment.of("delete from \"employees\" where \"emp_number\" = "), Fragment.encode(SqliteTypes.integer, compositeId.empNumber()), Fragment.of(" AND \"emp_suffix\" = "), Fragment.encode(SqliteTypes.varchar, compositeId.empSuffix()), Fragment.of("")).update().run(c) > 0;
  }
  ...
  public Integer deleteByIds(
    ...
    for (var id : compositeIds) { fragments.add(Fragment.concat(Fragment.of("("), Fragment.encode(SqliteTypes.integer, id.empNumber()), Fragment.of(", "), Fragment.encode(SqliteTypes.varchar, id.empSuffix()), Fragment.of(")"))); };
  ...
  public EmployeesRow insert(
    ...
    values.add(concat(Fragment.encode(SqliteTypes.integer, unsaved.empNumber()), Fragment.of("")));
    columns.add(Fragment.of("\"emp_suffix\""));
    values.add(concat(Fragment.encode(SqliteTypes.varchar, unsaved.empSuffix()), Fragment.of("")));
    columns.add(Fragment.of("\"dept_code\""));
    values.add(concat(Fragment.encode(SqliteTypes.varchar, unsaved.deptCode()), Fragment.of("")));
    columns.add(Fragment.of("\"dept_region\""));
    values.add(concat(Fragment.encode(SqliteTypes.varchar, unsaved.deptRegion()), Fragment.of("")));
    columns.add(Fragment.of("\"emp_name\""));
    values.add(concat(Fragment.encode(SqliteTypes.text, unsaved.empName()), Fragment.of("")));
    columns.add(Fragment.of("\"salary\""));
    values.add(concat(Fragment.encode(SqliteTypes.numeric.opt(), unsaved.salary()), Fragment.of("")));
    unsaved.hireDate().visit(
      ...
      value -> {
        ...
        values.add(concat(Fragment.encode(SqliteTypes.date, value), Fragment.of("")));
      }
    );;
  ...
  public SelectBuilder<EmployeesFields, EmployeesRow> select() {
    return SelectBuilder.of("\"employees\"", EmployeesFields.structure, EmployeesRow.rowCodec, Dialect.SQLITE);
  }
  ...
  public UpdateBuilder<EmployeesFields, EmployeesRow> update() {
    return UpdateBuilder.of("\"employees\"", EmployeesFields.structure, EmployeesRow.rowCodec, Dialect.SQLITE);
  }
