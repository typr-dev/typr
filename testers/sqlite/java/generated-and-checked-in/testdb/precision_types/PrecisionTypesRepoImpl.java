...
public class PrecisionTypesRepoImpl implements PrecisionTypesRepo {
  ...
  public DeleteBuilder<PrecisionTypesFields, PrecisionTypesRow> delete() {
    return DeleteBuilder.of("\"precision_types\"", PrecisionTypesFields.structure, Dialect.SQLITE);
  }
  ...
  public Boolean deleteById(
    ...
    return concat(Fragment.of("delete from \"precision_types\" where \"id\" = "), Fragment.encode(PrecisionTypesId.sqliteType, id), Fragment.of("")).update().run(c) > 0;
  }
  ...
  public Integer deleteByIds(
    ...
    for (var id : ids) { fragments.add(Fragment.encode(PrecisionTypesId.sqliteType, id)); };
  ...
  public SelectBuilder<PrecisionTypesFields, PrecisionTypesRow> select() {
    return SelectBuilder.of("\"precision_types\"", PrecisionTypesFields.structure, PrecisionTypesRow.rowCodec, Dialect.SQLITE);
  }
  ...
  public List<PrecisionTypesRow> selectByIds(
    ...
    ArrayList<Fragment> fragments = new ArrayList<>();
    for (var id : ids) { fragments.add(Fragment.encode(PrecisionTypesId.sqliteType, id)); };
    return Fragment.concat(Fragment.of("select \"id\", \"string10\", \"string20\", \"string50\", \"string100\", \"string255\", \"decimal5_2\", \"decimal10_2\", \"decimal18_4\", \"decimal5_0\", \"decimal10_0\", \"decimal18_0\" from \"precision_types\" where \"id\" in ("), Fragment.comma(fragments), Fragment.of(")")).query(PrecisionTypesRow.rowCodec.all()).run(c);
  }
  ...
  public UpdateBuilder<PrecisionTypesFields, PrecisionTypesRow> update() {
    return UpdateBuilder.of("\"precision_types\"", PrecisionTypesFields.structure, PrecisionTypesRow.rowCodec, Dialect.SQLITE);
  }
