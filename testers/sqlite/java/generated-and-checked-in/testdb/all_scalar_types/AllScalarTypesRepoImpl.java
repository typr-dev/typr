...
public class AllScalarTypesRepoImpl implements AllScalarTypesRepo {
  ...
  public DeleteBuilder<AllScalarTypesFields, AllScalarTypesRow> delete() {
    return DeleteBuilder.of("\"all_scalar_types\"", AllScalarTypesFields.structure, Dialect.SQLITE);
  }
  ...
  public Boolean deleteById(
    ...
    return concat(Fragment.of("delete from \"all_scalar_types\" where \"id\" = "), Fragment.encode(AllScalarTypesId.sqliteType, id), Fragment.of("")).update().run(c) > 0;
  }
  ...
  public Integer deleteByIds(
    ...
    for (var id : ids) { fragments.add(Fragment.encode(AllScalarTypesId.sqliteType, id)); };
  ...
  public SelectBuilder<AllScalarTypesFields, AllScalarTypesRow> select() {
    return SelectBuilder.of("\"all_scalar_types\"", AllScalarTypesFields.structure, AllScalarTypesRow.rowCodec, Dialect.SQLITE);
  }

  @Override
  public List<AllScalarTypesRow> selectAll(ConnectionRead c) {
    return concat(Fragment.of("select \"id\", \"col_tinyint\", \"col_smallint\", \"col_int\", \"col_integer\", \"col_bigint\", \"col_boolean\", \"col_real\", \"col_double\", \"col_float\", \"col_decimal\", \"col_numeric\", \"col_text\", \"col_varchar\", \"col_char\", \"col_clob\", \"col_blob\", \"col_binary\", \"col_date\", \"col_time\", \"col_datetime\", \"col_timestamp\", \"col_uuid\", \"col_json\", \"col_not_null\"\nfrom \"all_scalar_types\"\n")).query(AllScalarTypesRow.rowCodec.all()).run(c);
  }
  ...
  public List<AllScalarTypesRow> selectByIds(
    ...
    ArrayList<Fragment> fragments = new ArrayList<>();
    for (var id : ids) { fragments.add(Fragment.encode(AllScalarTypesId.sqliteType, id)); };
    return Fragment.concat(Fragment.of("select \"id\", \"col_tinyint\", \"col_smallint\", \"col_int\", \"col_integer\", \"col_bigint\", \"col_boolean\", \"col_real\", \"col_double\", \"col_float\", \"col_decimal\", \"col_numeric\", \"col_text\", \"col_varchar\", \"col_char\", \"col_clob\", \"col_blob\", \"col_binary\", \"col_date\", \"col_time\", \"col_datetime\", \"col_timestamp\", \"col_uuid\", \"col_json\", \"col_not_null\" from \"all_scalar_types\" where \"id\" in ("), Fragment.comma(fragments), Fragment.of(")")).query(AllScalarTypesRow.rowCodec.all()).run(c);
  }
  ...
  public UpdateBuilder<AllScalarTypesFields, AllScalarTypesRow> update() {
    return UpdateBuilder.of("\"all_scalar_types\"", AllScalarTypesFields.structure, AllScalarTypesRow.rowCodec, Dialect.SQLITE);
  }
