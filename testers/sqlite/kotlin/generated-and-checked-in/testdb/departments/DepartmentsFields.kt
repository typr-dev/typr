...
data class DepartmentsFields(val _path: List<Path>) : TupleExpr4<kotlin.String, kotlin.String, kotlin.String, BigDecimal>, RelationStructure<DepartmentsFields, DepartmentsRow>, FieldsBase<DepartmentsRow> {
  ...
  fun budget(): OptField<BigDecimal, DepartmentsRow> = OptField<BigDecimal, DepartmentsRow>(_path, "budget", DepartmentsRow::budget, null, null, { row, value -> row.copy(budget = value) }, SqliteTypes.numeric.underlying)
  ...
  fun deptCode(): IdField<kotlin.String, DepartmentsRow> = IdField<kotlin.String, DepartmentsRow>(_path, "dept_code", DepartmentsRow::deptCode, null, null, { row, value -> row.copy(deptCode = value) }, SqliteTypes.varchar.underlying)

  fun deptName(): Field<kotlin.String, DepartmentsRow> = Field<kotlin.String, DepartmentsRow>(_path, "dept_name", DepartmentsRow::deptName, null, null, { row, value -> row.copy(deptName = value) }, SqliteTypes.text.underlying)

  fun deptRegion(): IdField<kotlin.String, DepartmentsRow> = IdField<kotlin.String, DepartmentsRow>(_path, "dept_region", DepartmentsRow::deptRegion, null, null, { row, value -> row.copy(deptRegion = value) }, SqliteTypes.varchar.underlying)
