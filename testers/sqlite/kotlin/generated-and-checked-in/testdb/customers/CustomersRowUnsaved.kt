...
data class CustomersRowUnsaved(
  ...
  fun toRow(createdAtDefault: () -> LocalDateTime): CustomersRow = CustomersRow(customerId = customerId, name = name, email = email, createdAt = createdAt.getOrElse(createdAtDefault))
}