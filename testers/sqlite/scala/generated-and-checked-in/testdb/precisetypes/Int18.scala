...
object Int18 {
  ...
  given sqliteType: SqliteType[Int18] = SqliteTypes.numeric.to(Bijection.of(bd => new Int18(BigInt(bd.bigDecimal.toBigIntegerExact())), v => BigDecimal(new java.math.BigDecimal(v.value.bigInteger))))
