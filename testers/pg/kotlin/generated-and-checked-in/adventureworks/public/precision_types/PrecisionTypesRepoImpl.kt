...
class PrecisionTypesRepoImpl() : PrecisionTypesRepo {
  ...
  override fun deleteById(
    id: PrecisionTypesId,
    c: Connection
  ): Boolean = Fragment.interpolate(Fragment.lit("delete from \"public\".\"precision_types\" where \"id\" = "), Fragment.encode(PrecisionTypesId.pgType, id), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun insert(
    ...
    values.add(Fragment.interpolate(Fragment.encode(String10.pgType, unsaved.string10), Fragment.lit("")))
    columns.add(Fragment.lit("\"string20\""))
    values.add(Fragment.interpolate(Fragment.encode(String20.pgType, unsaved.string20), Fragment.lit("")))
    columns.add(Fragment.lit("\"string50\""))
    values.add(Fragment.interpolate(Fragment.encode(String50.pgType, unsaved.string50), Fragment.lit("")))
    columns.add(Fragment.lit("\"string100\""))
    values.add(Fragment.interpolate(Fragment.encode(String100.pgType, unsaved.string100), Fragment.lit("")))
    columns.add(Fragment.lit("\"string255\""))
    values.add(Fragment.interpolate(Fragment.encode(String255.pgType, unsaved.string255), Fragment.lit("")))
    columns.add(Fragment.lit("\"bpchar3\""))
    values.add(Fragment.interpolate(Fragment.encode(PaddedString3.pgType, unsaved.bpchar3), Fragment.lit("::bpchar")))
    columns.add(Fragment.lit("\"bpchar10\""))
    values.add(Fragment.interpolate(Fragment.encode(PaddedString10.pgType, unsaved.bpchar10), Fragment.lit("::bpchar")))
    ...
    unsaved.id.visit(
      ...
      values.add(Fragment.interpolate(Fragment.encode(PrecisionTypesId.pgType, value), Fragment.lit("::int4"))) }
    );
