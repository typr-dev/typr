...
public class StateprovinceFields extends TupleExpr8<StateprovinceId, String, CountryregionId, Flag, Name, SalesterritoryId, UUID, LocalDateTime> implements RelationStructure<StateprovinceFields, StateprovinceRow>, FieldsBase<StateprovinceRow> {
  ...
  public IdField<StateprovinceId, StateprovinceRow> stateprovinceid() {
    return new IdField<StateprovinceId, StateprovinceRow>(_path, "stateprovinceid", StateprovinceRow::stateprovinceid, Optional.empty(), Optional.of("int4"), (row, value) -> row.withStateprovinceid(value), StateprovinceId.dbType);
  }
  ...
  public Field<CountryregionId, StateprovinceRow> countryregioncode() {
    return new Field<CountryregionId, StateprovinceRow>(_path, "countryregioncode", StateprovinceRow::countryregioncode, Optional.empty(), Optional.empty(), (row, value) -> row.withCountryregioncode(value), CountryregionId.dbType);
  }

  public Field<Flag, StateprovinceRow> isonlystateprovinceflag() {
    return new Field<Flag, StateprovinceRow>(_path, "isonlystateprovinceflag", StateprovinceRow::isonlystateprovinceflag, Optional.empty(), Optional.of("bool"), (row, value) -> row.withIsonlystateprovinceflag(value), Flag.dbType);
  }

  public Field<Name, StateprovinceRow> name() {
    return new Field<Name, StateprovinceRow>(_path, "name", StateprovinceRow::name, Optional.empty(), Optional.of("varchar"), (row, value) -> row.withName(value), Name.dbType);
  }

  public Field<SalesterritoryId, StateprovinceRow> territoryid() {
    return new Field<SalesterritoryId, StateprovinceRow>(_path, "territoryid", StateprovinceRow::territoryid, Optional.empty(), Optional.of("int4"), (row, value) -> row.withTerritoryid(value), SalesterritoryId.dbType);
  }
