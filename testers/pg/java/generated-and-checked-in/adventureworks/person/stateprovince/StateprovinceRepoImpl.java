...
public class StateprovinceRepoImpl implements StateprovinceRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"person\".\"stateprovince\" where \"stateprovinceid\" = "), Fragment.encode(StateprovinceId.dbType, stateprovinceid), Fragment.lit("")).update().runUnchecked(c) > 0;
  }
  ...
  public StateprovinceRow insert(
    ...
    values.add(interpolate(Fragment.encode(SalesterritoryId.dbType, unsaved.territoryid()), Fragment.lit("::int4")));
    unsaved.stateprovinceid().visit(
      ...
      value -> {
        ...
        values.add(interpolate(Fragment.encode(StateprovinceId.dbType, value), Fragment.lit("::int4")));
      }
    );;
