...
public class PersonFields extends TupleExpr13<BusinessentityId, String, NameStyle, /* max 8 chars */ String, /* user-picked */ FirstName, Name, Name, /* max 10 chars */ String, Integer, Xml, Xml, UUID, LocalDateTime> implements RelationStructure<PersonFields, PersonRow>, FieldsBase<PersonRow> {
  List<Path> _path;
  ...
  public IdField<BusinessentityId, PersonRow> businessentityid() {
    return new IdField<BusinessentityId, PersonRow>(_path, "businessentityid", PersonRow::businessentityid, Optional.empty(), Optional.of("int4"), (row, value) -> row.withBusinessentityid(value), BusinessentityId.dbType);
  }
  ...
  public Field<NameStyle, PersonRow> namestyle() {
    return new Field<NameStyle, PersonRow>(_path, "namestyle", PersonRow::namestyle, Optional.empty(), Optional.of("bool"), (row, value) -> row.withNamestyle(value), NameStyle.dbType);
  }
  ...
  public Field</* user-picked */ FirstName, PersonRow> firstname() {
    return new Field</* user-picked */ FirstName, PersonRow>(_path, "firstname", PersonRow::firstname, Optional.empty(), Optional.of("varchar"), (row, value) -> row.withFirstname(value), FirstName.dbType);
  }

  public OptField<Name, PersonRow> middlename() {
    return new OptField<Name, PersonRow>(_path, "middlename", PersonRow::middlename, Optional.empty(), Optional.of("varchar"), (row, value) -> row.withMiddlename(value), Name.dbType);
  }

  public Field<Name, PersonRow> lastname() {
    return new Field<Name, PersonRow>(_path, "lastname", PersonRow::lastname, Optional.empty(), Optional.of("varchar"), (row, value) -> row.withLastname(value), Name.dbType);
  }
