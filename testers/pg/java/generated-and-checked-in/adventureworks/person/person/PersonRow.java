...
) implements Tuple13<BusinessentityId, String, NameStyle, Optional</* max 8 chars */ String>, /* user-picked */ FirstName, Optional<Name>, Name, Optional</* max 10 chars */ String>, Integer, Optional<Xml>, Optional<Xml>, UUID, LocalDateTime> {
  /** Primary key for Person records.
    * Points to {@link adventureworks.person.businessentity.BusinessentityRow#businessentityid()}
    */
