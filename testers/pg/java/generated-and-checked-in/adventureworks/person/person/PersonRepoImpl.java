...
public class PersonRepoImpl implements PersonRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"person\".\"person\" where \"businessentityid\" = "), Fragment.encode(BusinessentityId.dbType, businessentityid), Fragment.lit("")).update().runUnchecked(c) > 0;
  }
  ...
  public PersonRow insert(
    ...
    values.add(interpolate(Fragment.encode(FirstName.dbType, unsaved.firstname()), Fragment.lit("::varchar")));
    columns.add(Fragment.lit("\"middlename\""));
    values.add(interpolate(Fragment.encode(Name.dbType.opt(), unsaved.middlename()), Fragment.lit("::varchar")));
    columns.add(Fragment.lit("\"lastname\""));
    values.add(interpolate(Fragment.encode(Name.dbType, unsaved.lastname()), Fragment.lit("::varchar")));
    ...
    unsaved.namestyle().visit(
      ...
      value -> {
        ...
        values.add(interpolate(Fragment.encode(NameStyle.dbType, value), Fragment.lit("::bool")));
      }
    );;
