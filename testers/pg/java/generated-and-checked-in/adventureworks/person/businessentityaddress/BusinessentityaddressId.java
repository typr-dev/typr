...
public record BusinessentityaddressId(
  ...
  public static RowParser<BusinessentityaddressId> _rowParser = RowParsers.of(BusinessentityId.pgType, AddressId.pgType, AddresstypeId.pgType, BusinessentityaddressId::new, row -> new Object[]{row.businessentityid(), row.addressid(), row.addresstypeid()});;
}