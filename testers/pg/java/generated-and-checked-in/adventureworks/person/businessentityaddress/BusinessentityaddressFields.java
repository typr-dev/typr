...
public class BusinessentityaddressFields extends TupleExpr5<BusinessentityId, AddressId, AddresstypeId, UUID, LocalDateTime> implements RelationStructure<BusinessentityaddressFields, BusinessentityaddressRow>, FieldsBase<BusinessentityaddressRow> {
  ...
  public IdField<BusinessentityId, BusinessentityaddressRow> businessentityid() {
    return new IdField<BusinessentityId, BusinessentityaddressRow>(_path, "businessentityid", BusinessentityaddressRow::businessentityid, Optional.empty(), Optional.of("int4"), (row, value) -> row.withBusinessentityid(value), BusinessentityId.dbType);
  }

  public IdField<AddressId, BusinessentityaddressRow> addressid() {
    return new IdField<AddressId, BusinessentityaddressRow>(_path, "addressid", BusinessentityaddressRow::addressid, Optional.empty(), Optional.of("int4"), (row, value) -> row.withAddressid(value), AddressId.dbType);
  }

  public IdField<AddresstypeId, BusinessentityaddressRow> addresstypeid() {
    return new IdField<AddresstypeId, BusinessentityaddressRow>(_path, "addresstypeid", BusinessentityaddressRow::addresstypeid, Optional.empty(), Optional.of("int4"), (row, value) -> row.withAddresstypeid(value), AddresstypeId.dbType);
  }
