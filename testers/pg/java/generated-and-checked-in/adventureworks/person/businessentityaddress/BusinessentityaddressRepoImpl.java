...
public class BusinessentityaddressRepoImpl implements BusinessentityaddressRepo {
  ...
  public BusinessentityaddressRow insert(
    ...
    values.add(interpolate(Fragment.encode(AddressId.dbType, unsaved.addressid()), Fragment.lit("::int4")));
    columns.add(Fragment.lit("\"addresstypeid\""));
    values.add(interpolate(Fragment.encode(AddresstypeId.dbType, unsaved.addresstypeid()), Fragment.lit("::int4")));
