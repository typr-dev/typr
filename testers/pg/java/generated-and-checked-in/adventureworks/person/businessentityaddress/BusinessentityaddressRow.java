...
public record BusinessentityaddressRow(
  ...
  public static RowParser<BusinessentityaddressRow> _rowParser = RowParsers.of(BusinessentityId.dbType, AddressId.dbType, AddresstypeId.dbType, PgTypes.uuid, PgTypes.timestamp, BusinessentityaddressRow::new, row -> new Object[]{row.businessentityid(), row.addressid(), row.addresstypeid(), row.rowguid(), row.modifieddate()});;
