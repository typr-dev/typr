...
public record BusinessentityaddressRow(
  ...
  public static RowParser<BusinessentityaddressRow> _rowParser = RowParsers.of(BusinessentityId.pgType, AddressId.pgType, AddresstypeId.pgType, PgTypes.uuid, PgTypes.timestamp, BusinessentityaddressRow::new, row -> new Object[]{row.businessentityid(), row.addressid(), row.addresstypeid(), row.rowguid(), row.modifieddate()});;
