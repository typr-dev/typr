...
public record BusinessentityaddressRepoMock(
  ...
  public BusinessentityaddressRepoMock(
      java.util.function.Function<BusinessentityaddressRowUnsaved, BusinessentityaddressRow>
          toRow) {
    this(toRow, new HashMap<BusinessentityaddressId, BusinessentityaddressRow>());
  }
  ;

  public BusinessentityaddressRepoMock withToRow(
      java.util.function.Function<BusinessentityaddressRowUnsaved, BusinessentityaddressRow>
          toRow) {
  ...
  public BusinessentityaddressRepoMock withMap(
      HashMap<BusinessentityaddressId, BusinessentityaddressRow> map) {
    return new BusinessentityaddressRepoMock(toRow, map);
  }
  ;
  ...
  public Map<BusinessentityaddressId, BusinessentityaddressRow> selectByIdsTracked(
    ...
    return selectByIds(compositeIds, c).stream()
        .collect(
            Collectors.toMap(
                (BusinessentityaddressRow row) -> row.compositeId(), Function.identity()));
  }
  ;
