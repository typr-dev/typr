...
public class AddressRepoImpl implements AddressRepo {
  ...
  public DeleteBuilder<AddressFields, AddressRow> delete() {
    return DeleteBuilder.of(
        "\"person\".\"address\"", AddressFields.structure(), Dialect.POSTGRESQL);
  }
  ;
  ...
  @Override
  public AddressRow insert(AddressRow unsaved, Connection c) {
    return interpolate(
            Fragment.lit(
                "insert into \"person\".\"address\"(\"addressid\", \"addressline1\","
            ...
            Fragment.lit(", "),
            Fragment.encode(PgTypes.text.opt(), unsaved.addressline2()),
            Fragment.lit(", "),
            ...
            Fragment.lit(", "),
            Fragment.encode(PgTypes.bytea.opt(), unsaved.spatiallocation()),
            Fragment.lit("::bytea, "),
  ...
  @Override
  public AddressRow insert(AddressRowUnsaved unsaved, Connection c) {
    ...
    values.add(
        interpolate(Fragment.encode(PgTypes.text, unsaved.addressline1()), Fragment.lit("")));
    columns.add(Fragment.lit("\"addressline2\""));
    values.add(
        interpolate(Fragment.encode(PgTypes.text.opt(), unsaved.addressline2()), Fragment.lit("")));
    ...
    Fragment q =
        interpolate(
            Fragment.lit("insert into \"person\".\"address\"("),
  ...
  @Override
  public Long insertStreaming(Iterator<AddressRow> unsaved, Integer batchSize, Connection c) {
    return streamingInsert.insertUnchecked(
        "COPY \"person\".\"address\"(\"addressid\", \"addressline1\", \"addressline2\", \"city\","
            + " \"stateprovinceid\", \"postalcode\", \"spatiallocation\", \"rowguid\","
  ...
  public Long insertUnsavedStreaming(
      Iterator<AddressRowUnsaved> unsaved, Integer batchSize, Connection c) {
    return streamingInsert.insertUnchecked(
        "COPY \"person\".\"address\"(\"addressline1\", \"addressline2\", \"city\","
            + " \"stateprovinceid\", \"postalcode\", \"spatiallocation\", \"addressid\","
            + " \"rowguid\", \"modifieddate\") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')",
        batchSize,
        unsaved,
        c,
        AddressRowUnsaved.pgText);
  }
  ;
  ...
  @Override
  public Optional<AddressRow> selectById(AddressId addressid, Connection c) {
    return interpolate(
            Fragment.lit(
                "select \"addressid\", \"addressline1\", \"addressline2\", \"city\","
                    + " \"stateprovinceid\", \"postalcode\", \"spatiallocation\", \"rowguid\","
  ...
  @Override
  public List<AddressRow> selectByIds(AddressId[] addressids, Connection c) {
    return interpolate(
            Fragment.lit(
                "select \"addressid\", \"addressline1\", \"addressline2\", \"city\","
                    + " \"stateprovinceid\", \"postalcode\", \"spatiallocation\", \"rowguid\","
  ...
  @Override
  public Map<AddressId, AddressRow> selectByIdsTracked(AddressId[] addressids, Connection c) {
  ...
  @Override
  public Boolean update(AddressRow row, Connection c) {
    AddressId addressid = row.addressid();
    ;
    return interpolate(
                Fragment.lit("update \"person\".\"address\"\nset \"addressline1\" = "),
                Fragment.encode(PgTypes.text, row.addressline1()),
                Fragment.lit(",\n\"addressline2\" = "),
                Fragment.encode(PgTypes.text.opt(), row.addressline2()),
                Fragment.lit(",\n\"city\" = "),
                ...
                Fragment.lit(",\n\"spatiallocation\" = "),
                Fragment.encode(PgTypes.bytea.opt(), row.spatiallocation()),
                Fragment.lit("::bytea,\n\"rowguid\" = "),
  ...
  @Override
  public AddressRow upsert(AddressRow unsaved, Connection c) {
    return interpolate(
            Fragment.lit(
                "insert into \"person\".\"address\"(\"addressid\", \"addressline1\","
                    + " \"addressline2\", \"city\", \"stateprovinceid\", \"postalcode\","
  ...
  @Override
  public List<AddressRow> upsertBatch(Iterator<AddressRow> unsaved, Connection c) {
    return interpolate(
            Fragment.lit(
                "insert into \"person\".\"address\"(\"addressid\", \"addressline1\","
                    + " \"addressline2\", \"city\", \"stateprovinceid\", \"postalcode\","
  ...
  @Override
  public Integer upsertStreaming(Iterator<AddressRow> unsaved, Integer batchSize, Connection c) {
    interpolate(
            Fragment.lit(
    ...
    streamingInsert.insertUnchecked(
        "copy address_TEMP(\"addressid\", \"addressline1\", \"addressline2\", \"city\","
            + " \"stateprovinceid\", \"postalcode\", \"spatiallocation\", \"rowguid\","
            + " \"modifieddate\") from stdin",
        batchSize,
        unsaved,
