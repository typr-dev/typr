...
public class AddressRepoImpl implements AddressRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"person\".\"address\" where \"addressid\" = "), Fragment.encode(AddressId.dbType, addressid), Fragment.lit("")).update().runUnchecked(c) > 0;
  }
  ...
  public AddressRow insert(
    ...
    values.add(interpolate(Fragment.encode(StateprovinceId.dbType, unsaved.stateprovinceid()), Fragment.lit("::int4")));
    ...
    unsaved.addressid().visit(
      ...
      value -> {
        ...
        values.add(interpolate(Fragment.encode(AddressId.dbType, value), Fragment.lit("::int4")));
      }
    );;
