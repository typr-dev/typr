...
public record BusinessentityRow(
  ...
  public static RowParser<BusinessentityRow> _rowParser = RowParsers.of(BusinessentityId.dbType, PgTypes.uuid, PgTypes.timestamp, BusinessentityRow::new, row -> new Object[]{row.businessentityid(), row.rowguid(), row.modifieddate()});;
