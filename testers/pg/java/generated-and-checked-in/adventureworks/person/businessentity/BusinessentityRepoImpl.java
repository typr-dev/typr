...
public class BusinessentityRepoImpl implements BusinessentityRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"person\".\"businessentity\" where \"businessentityid\" = "), Fragment.encode(BusinessentityId.dbType, businessentityid), Fragment.lit("")).update().runUnchecked(c) > 0;
  }
  ...
  public BusinessentityRow insert(
    ...
    unsaved.businessentityid().visit(
      ...
      value -> {
        ...
        values.add(interpolate(Fragment.encode(BusinessentityId.dbType, value), Fragment.lit("::int4")));
      }
    );;
