...
public record AddresstypeRow(
  ...
  public static RowParser<AddresstypeRow> _rowParser = RowParsers.of(AddresstypeId.pgType, Name.pgType, PgTypes.uuid, PgTypes.timestamp, AddresstypeRow::new, row -> new Object[]{row.addresstypeid(), row.name(), row.rowguid(), row.modifieddate()});;
