...
public class EmailaddressFields extends TupleExpr5<BusinessentityId, Integer, /* max 50 chars */ String, UUID, LocalDateTime> implements RelationStructure<EmailaddressFields, EmailaddressRow>, FieldsBase<EmailaddressRow> {
  List<Path> _path;
  ...
  public static EmailaddressFields structure = new EmailaddressFields(java.util.Collections.emptyList());

  public IdField<BusinessentityId, EmailaddressRow> businessentityid() {
    return new IdField<BusinessentityId, EmailaddressRow>(_path, "businessentityid", EmailaddressRow::businessentityid, Optional.empty(), Optional.of("int4"), (row, value) -> row.withBusinessentityid(value), BusinessentityId.dbType);
  }
