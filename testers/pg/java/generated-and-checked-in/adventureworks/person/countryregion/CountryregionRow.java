...
public record CountryregionRow(
  ...
  public static RowParser<CountryregionRow> _rowParser = RowParsers.of(CountryregionId.dbType, Name.dbType, PgTypes.timestamp, CountryregionRow::new, row -> new Object[]{row.countryregioncode(), row.name(), row.modifieddate()});;
