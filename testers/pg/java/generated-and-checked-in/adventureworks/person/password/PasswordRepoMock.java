...
public record PasswordRepoMock(
    java.util.function.Function<PasswordRowUnsaved, PasswordRow> toRow,
    HashMap<BusinessentityId, PasswordRow> map)
    implements PasswordRepo {
  public PasswordRepoMock(java.util.function.Function<PasswordRowUnsaved, PasswordRow> toRow) {
    this(toRow, new HashMap<BusinessentityId, PasswordRow>());
  }
  ;

  public PasswordRepoMock withToRow(
      java.util.function.Function<PasswordRowUnsaved, PasswordRow> toRow) {
    return new PasswordRepoMock(toRow, map);
  }
  ;

  public PasswordRepoMock withMap(HashMap<BusinessentityId, PasswordRow> map) {
    return new PasswordRepoMock(toRow, map);
  }
  ;
  ...
  public Map<BusinessentityId, PasswordRow> selectByIdsTracked(
    ...
    return selectByIds(businessentityids, c).stream()
        .collect(
            Collectors.toMap((PasswordRow row) -> row.businessentityid(), Function.identity()));
  }
  ;
