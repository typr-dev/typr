...
public record PasswordRow(
  ...
  public static RowParser<PasswordRow> _rowParser = RowParsers.of(BusinessentityId.dbType, PgTypes.text, PgTypes.text, PgTypes.uuid, PgTypes.timestamp, PasswordRow::new, row -> new Object[]{row.businessentityid(), row.passwordhash(), row.passwordsalt(), row.rowguid(), row.modifieddate()});;
