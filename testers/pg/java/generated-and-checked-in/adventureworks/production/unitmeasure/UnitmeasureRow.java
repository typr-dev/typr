...
public record UnitmeasureRow(
  ...
  public static RowParser<UnitmeasureRow> _rowParser = RowParsers.of(UnitmeasureId.dbType, Name.dbType, PgTypes.timestamp, UnitmeasureRow::new, row -> new Object[]{row.unitmeasurecode(), row.name(), row.modifieddate()});;
