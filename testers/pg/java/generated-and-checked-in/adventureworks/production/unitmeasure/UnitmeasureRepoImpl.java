...
public class UnitmeasureRepoImpl implements UnitmeasureRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"production\".\"unitmeasure\" where \"unitmeasurecode\" = "), Fragment.encode(UnitmeasureId.dbType, unitmeasurecode), Fragment.lit("")).update().runUnchecked(c) > 0;
  }
  ...
  public UnitmeasureRow insert(
    ...
    values.add(interpolate(Fragment.encode(UnitmeasureId.dbType, unsaved.unitmeasurecode()), Fragment.lit("::bpchar")));
