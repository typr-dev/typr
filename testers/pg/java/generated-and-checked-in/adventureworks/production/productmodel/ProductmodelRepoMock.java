...
public record ProductmodelRepoMock(
  ...
  public ProductmodelRepoMock(
      java.util.function.Function<ProductmodelRowUnsaved, ProductmodelRow> toRow) {
    this(toRow, new HashMap<ProductmodelId, ProductmodelRow>());
  }
  ;

  public ProductmodelRepoMock withToRow(
      java.util.function.Function<ProductmodelRowUnsaved, ProductmodelRow> toRow) {
  ...
  public SelectBuilder<ProductmodelFields, ProductmodelRow> select() {
    return new SelectBuilderMock<>(
        ProductmodelFields.structure(), () -> new ArrayList<>(map.values()), SelectParams.empty());
  }
  ;
  ...
  public Map<ProductmodelId, ProductmodelRow> selectByIdsTracked(
    ...
    return selectByIds(productmodelids, c).stream()
        .collect(
            Collectors.toMap((ProductmodelRow row) -> row.productmodelid(), Function.identity()));
  }
  ;
  ...
  public Boolean update(ProductmodelRow row, Connection c) {
    var shouldUpdate =
        Optional.ofNullable(map.get(row.productmodelid()))
