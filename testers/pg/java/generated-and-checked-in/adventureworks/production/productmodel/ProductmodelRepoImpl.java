...
public class ProductmodelRepoImpl implements ProductmodelRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"production\".\"productmodel\" where \"productmodelid\" = "), Fragment.encode(ProductmodelId.pgType, productmodelid), Fragment.lit("")).update().runUnchecked(c) > 0;
  };
  ...
  public ProductmodelRow insert(
    ...
    unsaved.productmodelid().visit(
      ...
      value -> {
        ...
        values.add(interpolate(Fragment.encode(ProductmodelId.pgType, value), Fragment.lit("::int4")));
      }
    );;
