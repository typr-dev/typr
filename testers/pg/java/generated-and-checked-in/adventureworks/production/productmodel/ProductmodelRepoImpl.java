...
public class ProductmodelRepoImpl implements ProductmodelRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"production\".\"productmodel\" where \"productmodelid\" = "), Fragment.encode(ProductmodelId.dbType, productmodelid), Fragment.lit("")).update().runUnchecked(c) > 0;
  }
  ...
  public ProductmodelRow insert(
    ...
    values.add(interpolate(Fragment.encode(PgTypes.xml.opt(), unsaved.catalogdescription()), Fragment.lit("::xml")));
    columns.add(Fragment.lit("\"instructions\""));
    values.add(interpolate(Fragment.encode(PgTypes.xml.opt(), unsaved.instructions()), Fragment.lit("::xml")));
    unsaved.productmodelid().visit(
      ...
      value -> {
        ...
        values.add(interpolate(Fragment.encode(ProductmodelId.dbType, value), Fragment.lit("::int4")));
      }
    );;
    ...
    Fragment q = interpolate(Fragment.lit("insert into \"production\".\"productmodel\"("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nRETURNING \"productmodelid\", \"name\", \"catalogdescription\", \"instructions\", \"rowguid\", \"modifieddate\"\n"));;
  ...
  public Long insertStreaming(
    ...
    return streamingInsert.insertUnchecked("COPY \"production\".\"productmodel\"(\"productmodelid\", \"name\", \"catalogdescription\", \"instructions\", \"rowguid\", \"modifieddate\") FROM STDIN", batchSize, unsaved, c, ProductmodelRow.pgText);
  }
  ...
  public Long insertUnsavedStreaming(
    ...
    return streamingInsert.insertUnchecked("COPY \"production\".\"productmodel\"(\"name\", \"catalogdescription\", \"instructions\", \"productmodelid\", \"rowguid\", \"modifieddate\") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')", batchSize, unsaved, c, ProductmodelRowUnsaved.pgText);
  }
  ...
  public List<ProductmodelRow> selectAll(Connection c) {
    return interpolate(Fragment.lit("select \"productmodelid\", \"name\", \"catalogdescription\", \"instructions\", \"rowguid\", \"modifieddate\"\nfrom \"production\".\"productmodel\"\n")).query(ProductmodelRow._rowParser.all()).runUnchecked(c);
  }
  ...
  public UpdateBuilder<ProductmodelFields, ProductmodelRow> update() {
    return UpdateBuilder.of("\"production\".\"productmodel\"", ProductmodelFields.structure, ProductmodelRow._rowParser, Dialect.POSTGRESQL);
  }
  ...
  public Integer upsertStreaming(
    ...
    interpolate(Fragment.lit("create temporary table productmodel_TEMP (like \"production\".\"productmodel\") on commit drop")).update().runUnchecked(c);
