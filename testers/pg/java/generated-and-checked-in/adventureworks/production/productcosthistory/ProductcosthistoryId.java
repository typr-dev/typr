...
public record ProductcosthistoryId(
  ...
  public static RowParser<ProductcosthistoryId> _rowParser = RowParsers.of(ProductId.dbType, PgTypes.timestamp, ProductcosthistoryId::new, row -> new Object[]{row.productid(), row.startdate()});;
