...
public class ProductcosthistoryFields extends TupleExpr5<ProductId, LocalDateTime, LocalDateTime, BigDecimal, LocalDateTime> implements RelationStructure<ProductcosthistoryFields, ProductcosthistoryRow>, FieldsBase<ProductcosthistoryRow> {
  ...
  public IdField<ProductId, ProductcosthistoryRow> productid() {
    return new IdField<ProductId, ProductcosthistoryRow>(_path, "productid", ProductcosthistoryRow::productid, Optional.empty(), Optional.of("int4"), (row, value) -> row.withProductid(value), ProductId.dbType);
  }
