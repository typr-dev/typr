...
public record ProductcategoryRow(
  ...
  public static RowParser<ProductcategoryRow> _rowParser = RowParsers.of(ProductcategoryId.dbType, Name.dbType, PgTypes.uuid, PgTypes.timestamp, ProductcategoryRow::new, row -> new Object[]{row.productcategoryid(), row.name(), row.rowguid(), row.modifieddate()});;
