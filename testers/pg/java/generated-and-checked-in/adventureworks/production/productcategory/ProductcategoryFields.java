...
public class ProductcategoryFields extends TupleExpr4<ProductcategoryId, Name, UUID, LocalDateTime> implements RelationStructure<ProductcategoryFields, ProductcategoryRow>, FieldsBase<ProductcategoryRow> {
  List<Path> _path;
  ...
  public static ProductcategoryFields structure = new ProductcategoryFields(java.util.Collections.emptyList());

  public IdField<ProductcategoryId, ProductcategoryRow> productcategoryid() {
    return new IdField<ProductcategoryId, ProductcategoryRow>(_path, "productcategoryid", ProductcategoryRow::productcategoryid, Optional.empty(), Optional.of("int4"), (row, value) -> row.withProductcategoryid(value), ProductcategoryId.dbType);
  }

  public Field<Name, ProductcategoryRow> name() {
    return new Field<Name, ProductcategoryRow>(_path, "name", ProductcategoryRow::name, Optional.empty(), Optional.of("varchar"), (row, value) -> row.withName(value), Name.dbType);
  }
