...
public class ProductsubcategoryRepoImpl implements ProductsubcategoryRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"production\".\"productsubcategory\" where \"productsubcategoryid\" = "), Fragment.encode(ProductsubcategoryId.dbType, productsubcategoryid), Fragment.lit("")).update().runUnchecked(c) > 0;
  }
  ...
  public Integer deleteByIds(
    ...
    return interpolate(Fragment.lit("delete\nfrom \"production\".\"productsubcategory\"\nwhere \"productsubcategoryid\" = ANY("), Fragment.encode(ProductsubcategoryId.dbTypeArray, productsubcategoryids), Fragment.lit(")"))
      .update()
      .runUnchecked(c);
  }
  ...
  public ProductsubcategoryRow insert(
    ...
    values.add(interpolate(Fragment.encode(ProductcategoryId.dbType, unsaved.productcategoryid()), Fragment.lit("::int4")));
    ...
    unsaved.productsubcategoryid().visit(
      ...
      value -> {
        ...
        values.add(interpolate(Fragment.encode(ProductsubcategoryId.dbType, value), Fragment.lit("::int4")));
      }
    );;
  ...
  public Optional<ProductsubcategoryRow> selectById(
    ...
    return interpolate(Fragment.lit("select \"productsubcategoryid\", \"productcategoryid\", \"name\", \"rowguid\", \"modifieddate\"\nfrom \"production\".\"productsubcategory\"\nwhere \"productsubcategoryid\" = "), Fragment.encode(ProductsubcategoryId.dbType, productsubcategoryid), Fragment.lit("")).query(ProductsubcategoryRow._rowParser.first()).runUnchecked(c);
  }
  ...
  public List<ProductsubcategoryRow> selectByIds(
    ...
    return interpolate(Fragment.lit("select \"productsubcategoryid\", \"productcategoryid\", \"name\", \"rowguid\", \"modifieddate\"\nfrom \"production\".\"productsubcategory\"\nwhere \"productsubcategoryid\" = ANY("), Fragment.encode(ProductsubcategoryId.dbTypeArray, productsubcategoryids), Fragment.lit(")")).query(ProductsubcategoryRow._rowParser.all()).runUnchecked(c);
  }
