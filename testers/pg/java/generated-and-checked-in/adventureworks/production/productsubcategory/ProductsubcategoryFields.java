...
public class ProductsubcategoryFields extends TupleExpr5<ProductsubcategoryId, ProductcategoryId, Name, UUID, LocalDateTime> implements RelationStructure<ProductsubcategoryFields, ProductsubcategoryRow>, FieldsBase<ProductsubcategoryRow> {
  ...
  public IdField<ProductsubcategoryId, ProductsubcategoryRow> productsubcategoryid() {
    return new IdField<ProductsubcategoryId, ProductsubcategoryRow>(_path, "productsubcategoryid", ProductsubcategoryRow::productsubcategoryid, Optional.empty(), Optional.of("int4"), (row, value) -> row.withProductsubcategoryid(value), ProductsubcategoryId.dbType);
  }

  public Field<ProductcategoryId, ProductsubcategoryRow> productcategoryid() {
    return new Field<ProductcategoryId, ProductsubcategoryRow>(_path, "productcategoryid", ProductsubcategoryRow::productcategoryid, Optional.empty(), Optional.of("int4"), (row, value) -> row.withProductcategoryid(value), ProductcategoryId.dbType);
  }

  public Field<Name, ProductsubcategoryRow> name() {
    return new Field<Name, ProductsubcategoryRow>(_path, "name", ProductsubcategoryRow::name, Optional.empty(), Optional.of("varchar"), (row, value) -> row.withName(value), Name.dbType);
  }
