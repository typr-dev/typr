...
public record UpdatePersonReturningSqlRow(
  ...
  public static RowParser<UpdatePersonReturningSqlRow> _rowParser = RowParsers.of(FirstName.pgType, PgTypes.timestamp, UpdatePersonReturningSqlRow::new, row -> new Object[]{row.firstname(), row.modifieddate()});;
}