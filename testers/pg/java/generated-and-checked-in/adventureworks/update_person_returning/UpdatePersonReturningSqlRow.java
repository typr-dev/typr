...
public record UpdatePersonReturningSqlRow(
  ...
  public static RowCodec<UpdatePersonReturningSqlRow> rowCodec = RowCodecs.of(FirstName.pgType, PgTypes.timestamp, UpdatePersonReturningSqlRow::new, row -> new Object[]{row.firstname(), row.modifieddate()});
