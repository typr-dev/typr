...
public record UpdatePersonReturningSqlRow(
  ...
  public static RowParser<UpdatePersonReturningSqlRow> _rowParser = RowParsers.of(FirstName.dbType, PgTypes.timestamp, UpdatePersonReturningSqlRow::new, row -> new Object[]{row.firstname(), row.modifieddate()});;
