...
public record PersonDynamicSqlRow(
  ...
  public static RowParser<PersonDynamicSqlRow> _rowParser = RowParsers.of(PgTypes.text.opt(), FirstName.pgType, Name.pgType.opt(), Name.pgType, PersonDynamicSqlRow::new, row -> new Object[]{row.title(), row.firstname(), row.middlename(), row.lastname()});;
}