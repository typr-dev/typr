...
public record PersonDynamicSqlRow(
...
) implements Tuple4<Optional</* max 8 chars */ String>, /* user-picked */ FirstName, Optional</* user-picked */ MiddleName>, /* user-picked */ LastName> {
  /** Points to {@link adventureworks.person.person.PersonRow#title()} */
  ...
  public static RowCodec<PersonDynamicSqlRow> rowCodec = RowCodecs.of(PgTypes.text.opt(), FirstName.pgType, MiddleName.pgType.opt(), LastName.pgType, PersonDynamicSqlRow::new, row -> new Object[]{row.title(), row.firstname(), row.middlename(), row.lastname()});
