...
public class Issue142RepoImpl implements Issue142Repo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"public\".\"issue142\" where \"tabellkode\" = "), Fragment.encode(Issue142Id.dbType, tabellkode), Fragment.lit("")).update().runUnchecked(c) > 0;
  }
  ...
  public Long insertStreaming(
    ...
    return streamingInsert.insertUnchecked("COPY \"public\".\"issue142\"(\"tabellkode\") FROM STDIN", batchSize, unsaved, c, Issue142Row.pgText);
  }
  ...
  public Optional<Issue142Row> selectById(
    ...
    return interpolate(Fragment.lit("select \"tabellkode\"\nfrom \"public\".\"issue142\"\nwhere \"tabellkode\" = "), Fragment.encode(Issue142Id.dbType, tabellkode), Fragment.lit("")).query(Issue142Row._rowParser.first()).runUnchecked(c);
  }
  ...
  public List<Issue142Row> selectByIds(
    ...
    return interpolate(Fragment.lit("select \"tabellkode\"\nfrom \"public\".\"issue142\"\nwhere \"tabellkode\" = ANY("), Fragment.encode(Issue142Id.dbTypeArray, tabellkodes), Fragment.lit(")")).query(Issue142Row._rowParser.all()).runUnchecked(c);
  }
  ...
  public UpdateBuilder<Issue142Fields, Issue142Row> update() {
    return UpdateBuilder.of("\"public\".\"issue142\"", Issue142Fields.structure, Issue142Row._rowParser, Dialect.POSTGRESQL);
  }
