...
public class Issue1422Fields extends TupleExpr1<Issue142Id> implements RelationStructure<Issue1422Fields, Issue1422Row>, FieldsBase<Issue1422Row> {
  ...
  public IdField<Issue142Id, Issue1422Row> tabellkode() {
    return new IdField<Issue142Id, Issue1422Row>(_path, "tabellkode", Issue1422Row::tabellkode, Optional.empty(), Optional.empty(), (row, value) -> row.withTabellkode(value), Issue142Id.dbType);
  }
