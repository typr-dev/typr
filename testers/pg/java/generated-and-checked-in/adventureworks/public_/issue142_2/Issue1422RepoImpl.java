...
public class Issue1422RepoImpl implements Issue1422Repo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"public\".\"issue142_2\" where \"tabellkode\" = "), Fragment.encode(Issue142Id.dbType, tabellkode), Fragment.lit("")).update().runUnchecked(c) > 0;
  }
