...
public record OnlyPkColumnsId(
  ...
  public static RowParser<OnlyPkColumnsId> _rowParser = RowParsers.of(PgTypes.text, PgTypes.int4, OnlyPkColumnsId::new, row -> new Object[]{row.keyColumn1(), row.keyColumn2()});;
}