...
public class PrecisionTypesNullRepoImpl implements PrecisionTypesNullRepo {
  ...
  public PrecisionTypesNullRow insert(PrecisionTypesNullRow unsaved, Connection c) {
    return interpolate(
            Fragment.lit(
                "insert into \"public\".\"precision_types_null\"(\"id\", \"string10\","
                    + " \"string20\", \"string50\", \"string100\", \"string255\", \"bpchar3\","
                    + " \"bpchar10\", \"decimal5_2\", \"decimal10_2\", \"decimal18_4\","
                    + " \"numeric8_2\", \"numeric12_4\", \"timestamp0\", \"timestamp3\","
            ...
            Fragment.encode(PgTypes.numeric.opt(), unsaved.decimal102()),
            Fragment.lit("::numeric, "),
            Fragment.encode(PgTypes.numeric.opt(), unsaved.decimal184()),
            Fragment.lit("::numeric, "),
            Fragment.encode(PgTypes.numeric.opt(), unsaved.numeric82()),
            Fragment.lit("::numeric, "),
            Fragment.encode(PgTypes.numeric.opt(), unsaved.numeric124()),
            Fragment.lit("::numeric, "),
            Fragment.encode(PgTypes.timestamp.opt(), unsaved.timestamp0()),
            Fragment.lit("::timestamp, "),
            Fragment.encode(PgTypes.timestamp.opt(), unsaved.timestamp3()),
            Fragment.lit("::timestamp, "),
            Fragment.encode(PgTypes.timestamp.opt(), unsaved.timestamp6()),
            Fragment.lit("::timestamp, "),
            Fragment.encode(PgTypes.timestamptz.opt(), unsaved.timestamptz0()),
            Fragment.lit("::timestamptz, "),
            Fragment.encode(PgTypes.timestamptz.opt(), unsaved.timestamptz3()),
            Fragment.lit("::timestamptz, "),
            Fragment.encode(PgTypes.timestamptz.opt(), unsaved.timestamptz6()),
            Fragment.lit("::timestamptz, "),
            Fragment.encode(PgTypes.time.opt(), unsaved.time0()),
            Fragment.lit("::time, "),
            Fragment.encode(PgTypes.time.opt(), unsaved.time3()),
            Fragment.lit("::time, "),
            Fragment.encode(PgTypes.time.opt(), unsaved.time6()),
            Fragment.lit("::time, "),
            Fragment.encode(PgTypes.timetz.opt(), unsaved.timetz0()),
            Fragment.lit("::timetz, "),
            Fragment.encode(PgTypes.timetz.opt(), unsaved.timetz3()),
            Fragment.lit("::timetz, "),
            Fragment.encode(PgTypes.timetz.opt(), unsaved.timetz6()),
            Fragment.lit(
                "::timetz)\n"
  ...
  public PrecisionTypesNullRow insert(PrecisionTypesNullRowUnsaved unsaved, Connection c) {
    ...
    values.add(
        interpolate(Fragment.encode(PgTypes.time.opt(), unsaved.time0()), Fragment.lit("::time")));
    columns.add(Fragment.lit("\"time3\""));
    values.add(
        interpolate(Fragment.encode(PgTypes.time.opt(), unsaved.time3()), Fragment.lit("::time")));
    columns.add(Fragment.lit("\"time6\""));
    values.add(
        interpolate(Fragment.encode(PgTypes.time.opt(), unsaved.time6()), Fragment.lit("::time")));
    columns.add(Fragment.lit("\"timetz0\""));
    values.add(
        interpolate(
            Fragment.encode(PgTypes.timetz.opt(), unsaved.timetz0()), Fragment.lit("::timetz")));
    columns.add(Fragment.lit("\"timetz3\""));
    values.add(
        interpolate(
            Fragment.encode(PgTypes.timetz.opt(), unsaved.timetz3()), Fragment.lit("::timetz")));
    columns.add(Fragment.lit("\"timetz6\""));
    values.add(
        interpolate(
            Fragment.encode(PgTypes.timetz.opt(), unsaved.timetz6()), Fragment.lit("::timetz")));
    unsaved
        .id()
        .visit(
            () -> {},
    ...
    Fragment q =
        interpolate(
            Fragment.lit("insert into \"public\".\"precision_types_null\"("),
  ...
  public Long insertStreaming(
      Iterator<PrecisionTypesNullRow> unsaved, Integer batchSize, Connection c) {
    return streamingInsert.insertUnchecked(
        "COPY \"public\".\"precision_types_null\"(\"id\", \"string10\", \"string20\", \"string50\","
        ...
        unsaved,
        c,
        PrecisionTypesNullRow.pgText);
  }

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  @Override
  public Long insertUnsavedStreaming(
      Iterator<PrecisionTypesNullRowUnsaved> unsaved, Integer batchSize, Connection c) {
    return streamingInsert.insertUnchecked(
        "COPY \"public\".\"precision_types_null\"(\"string10\", \"string20\", \"string50\","
            + " \"string100\", \"string255\", \"bpchar3\", \"bpchar10\", \"decimal5_2\","
            + " \"decimal10_2\", \"decimal18_4\", \"numeric8_2\", \"numeric12_4\", \"timestamp0\","
            + " \"timestamp3\", \"timestamp6\", \"timestamptz0\", \"timestamptz3\","
            + " \"timestamptz6\", \"time0\", \"time3\", \"time6\", \"timetz0\", \"timetz3\","
        ...
        unsaved,
        c,
        PrecisionTypesNullRowUnsaved.pgText);
  }
  ...
  public Boolean update(PrecisionTypesNullRow row, Connection c) {
    ...
    return interpolate(
                ...
                Fragment.lit("::numeric,\n\"decimal10_2\" = "),
                Fragment.encode(PgTypes.numeric.opt(), row.decimal102()),
                Fragment.lit("::numeric,\n\"decimal18_4\" = "),
                Fragment.encode(PgTypes.numeric.opt(), row.decimal184()),
                Fragment.lit("::numeric,\n\"numeric8_2\" = "),
                Fragment.encode(PgTypes.numeric.opt(), row.numeric82()),
                Fragment.lit("::numeric,\n\"numeric12_4\" = "),
                Fragment.encode(PgTypes.numeric.opt(), row.numeric124()),
                Fragment.lit("::numeric,\n\"timestamp0\" = "),
                Fragment.encode(PgTypes.timestamp.opt(), row.timestamp0()),
                Fragment.lit("::timestamp,\n\"timestamp3\" = "),
                Fragment.encode(PgTypes.timestamp.opt(), row.timestamp3()),
                Fragment.lit("::timestamp,\n\"timestamp6\" = "),
                Fragment.encode(PgTypes.timestamp.opt(), row.timestamp6()),
                Fragment.lit("::timestamp,\n\"timestamptz0\" = "),
                Fragment.encode(PgTypes.timestamptz.opt(), row.timestamptz0()),
                Fragment.lit("::timestamptz,\n\"timestamptz3\" = "),
                Fragment.encode(PgTypes.timestamptz.opt(), row.timestamptz3()),
                Fragment.lit("::timestamptz,\n\"timestamptz6\" = "),
                Fragment.encode(PgTypes.timestamptz.opt(), row.timestamptz6()),
                Fragment.lit("::timestamptz,\n\"time0\" = "),
                Fragment.encode(PgTypes.time.opt(), row.time0()),
                Fragment.lit("::time,\n\"time3\" = "),
                Fragment.encode(PgTypes.time.opt(), row.time3()),
                Fragment.lit("::time,\n\"time6\" = "),
                Fragment.encode(PgTypes.time.opt(), row.time6()),
                Fragment.lit("::time,\n\"timetz0\" = "),
                Fragment.encode(PgTypes.timetz.opt(), row.timetz0()),
                Fragment.lit("::timetz,\n\"timetz3\" = "),
                Fragment.encode(PgTypes.timetz.opt(), row.timetz3()),
                Fragment.lit("::timetz,\n\"timetz6\" = "),
  ...
  public Integer upsertStreaming(
    ...
    interpolate(
            Fragment.lit(
                "create temporary table precision_types_null_TEMP (like"
                    + " \"public\".\"precision_types_null\") on commit drop"))
        .update()
        .runUnchecked(c);
    streamingInsert.insertUnchecked(
        "copy precision_types_null_TEMP(\"id\", \"string10\", \"string20\", \"string50\","
            + " \"string100\", \"string255\", \"bpchar3\", \"bpchar10\", \"decimal5_2\","
            + " \"decimal10_2\", \"decimal18_4\", \"numeric8_2\", \"numeric12_4\", \"timestamp0\","
            + " \"timestamp3\", \"timestamp6\", \"timestamptz0\", \"timestamptz3\","
            + " \"timestamptz6\", \"time0\", \"time3\", \"time6\", \"timetz0\", \"timetz3\","
    ...
    return interpolate(
            Fragment.lit(
                "insert into \"public\".\"precision_types_null\"(\"id\", \"string10\","
                    ...
                    + "\"timetz6\" = EXCLUDED.\"timetz6\"\n"
                    + ";\n"
                    + "drop table precision_types_null_TEMP;"))
        .update()
        .runUnchecked(c);
  }
}
