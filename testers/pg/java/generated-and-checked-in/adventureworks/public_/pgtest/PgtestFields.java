...
public class PgtestFields extends TupleExpr70<Boolean, PGbox, String, byte[], String, PGcircle, LocalDate, Float, Double, Map<String, String>, Inet, Short, Int2Vector, Integer, Long, PGInterval, Json, Jsonb, PGline, PGlseg, Money, Mydomain, Myenum, String, BigDecimal, PGpath, PGpoint, PGpolygon, String, LocalTime, LocalDateTime, Instant, OffsetTime, UUID, String, Vector, Xml, PGbox[], /* bpchar */ String[], /* bpchar */ String[], PGcircle[], LocalDate[], Float[], Double[], Inet[], Short[], Int2Vector[], Integer[], Long[], PGInterval[], Json[], Jsonb[], PGline[], PGlseg[], Money[], Mydomain[], Myenum[], String[], BigDecimal[], PGpath[], PGpoint[], PGpolygon[], String[], LocalTime[], LocalDateTime[], Instant[], OffsetTime[], UUID[], String[], Xml[]> implements RelationStructure<PgtestFields, PgtestRow>, FieldsBase<PgtestRow> {
  ...
  public Field<Mydomain, PgtestRow> mydomain() {
    return new Field<Mydomain, PgtestRow>(_path, "mydomain", PgtestRow::mydomain, Optional.empty(), Optional.of("text"), (row, value) -> row.withMydomain(value), Mydomain.dbType);
  }

  public Field<Myenum, PgtestRow> myenum() {
    return new Field<Myenum, PgtestRow>(_path, "myenum", PgtestRow::myenum, Optional.empty(), Optional.of("public.myenum"), (row, value) -> row.withMyenum(value), Myenum.dbType);
  }
  ...
  public Field<Mydomain[], PgtestRow> mydomaines() {
    return new Field<Mydomain[], PgtestRow>(_path, "mydomaines", PgtestRow::mydomaines, Optional.of("text[]"), Optional.of("mydomain[]"), (row, value) -> row.withMydomaines(value), Mydomain.dbTypeArray);
  }

  public Field<Myenum[], PgtestRow> myenumes() {
    return new Field<Myenum[], PgtestRow>(_path, "myenumes", PgtestRow::myenumes, Optional.empty(), Optional.of("myenum[]"), (row, value) -> row.withMyenumes(value), Myenum.dbTypeArray);
  }
