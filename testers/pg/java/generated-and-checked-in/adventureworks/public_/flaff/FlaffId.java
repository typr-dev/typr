...
public record FlaffId(
  ...
  public static RowParser<FlaffId> _rowParser = RowParsers.of(ShortText.dbType, PgTypes.text, PgTypes.int4, ShortText.dbType, FlaffId::new, row -> new Object[]{row.code(), row.anotherCode(), row.someNumber(), row.specifier()});;
