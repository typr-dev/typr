...
public record FlaffRow(
  ...
  public static RowParser<FlaffRow> _rowParser = RowParsers.of(ShortText.dbType, PgTypes.text, PgTypes.int4, ShortText.dbType, ShortText.dbType.opt(), FlaffRow::new, row -> new Object[]{row.code(), row.anotherCode(), row.someNumber(), row.specifier(), row.parentspecifier()});;
