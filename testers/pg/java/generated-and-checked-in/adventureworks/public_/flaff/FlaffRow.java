...
public record FlaffRow(
  ...
  public static RowParser<FlaffRow> _rowParser = RowParsers.of(ShortText.pgType, PgTypes.text, PgTypes.int4, ShortText.pgType, ShortText.pgType.opt(), FlaffRow::new, row -> new Object[]{row.code(), row.anotherCode(), row.someNumber(), row.specifier(), row.parentspecifier()});;
