...
public class FlaffFields extends TupleExpr5<ShortText, String, Integer, ShortText, ShortText> implements RelationStructure<FlaffFields, FlaffRow>, FieldsBase<FlaffRow> {
  ...
  public IdField<ShortText, FlaffRow> code() {
    return new IdField<ShortText, FlaffRow>(_path, "code", FlaffRow::code, Optional.empty(), Optional.of("text"), (row, value) -> row.withCode(value), ShortText.dbType);
  }
  ...
  public IdField<ShortText, FlaffRow> specifier() {
    return new IdField<ShortText, FlaffRow>(_path, "specifier", FlaffRow::specifier, Optional.empty(), Optional.of("text"), (row, value) -> row.withSpecifier(value), ShortText.dbType);
  }

  public OptField<ShortText, FlaffRow> parentspecifier() {
    return new OptField<ShortText, FlaffRow>(_path, "parentspecifier", FlaffRow::parentspecifier, Optional.empty(), Optional.of("text"), (row, value) -> row.withParentspecifier(value), ShortText.dbType);
  }
