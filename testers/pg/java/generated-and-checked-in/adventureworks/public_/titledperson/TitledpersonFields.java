...
public class TitledpersonFields extends TupleExpr3<TitleDomainId, TitleId, String> implements RelationStructure<TitledpersonFields, TitledpersonRow>, FieldsBase<TitledpersonRow> {
  ...
  public Field<TitleDomainId, TitledpersonRow> titleShort() {
    return new Field<TitleDomainId, TitledpersonRow>(_path, "title_short", TitledpersonRow::titleShort, Optional.empty(), Optional.of("text"), (row, value) -> row.withTitleShort(value), TitleDomainId.dbType);
  }

  public Field<TitleId, TitledpersonRow> title() {
    return new Field<TitleId, TitledpersonRow>(_path, "title", TitledpersonRow::title, Optional.empty(), Optional.empty(), (row, value) -> row.withTitle(value), TitleId.dbType);
  }
