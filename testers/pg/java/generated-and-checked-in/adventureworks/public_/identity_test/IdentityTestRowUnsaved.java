...
public record IdentityTestRowUnsaved(
    IdentityTestId name,
    /**
     * Identity BY DEFAULT, identityStart: 1, identityIncrement: 1, identityMaximum: 2147483647,
     * identityMinimum: 1
     */
  ...
  public IdentityTestRow toRow(
    ...
    return new IdentityTestRow(
        alwaysGeneratedDefault.get(), defaultGenerated.getOrElse(defaultGeneratedDefault), name);
  }
  ;
}
