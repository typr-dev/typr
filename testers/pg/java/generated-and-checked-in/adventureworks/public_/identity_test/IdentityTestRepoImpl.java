...
public class IdentityTestRepoImpl implements IdentityTestRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"public\".\"identity-test\" where \"name\" = "), Fragment.encode(IdentityTestId.dbType, name), Fragment.lit("")).update().runUnchecked(c) > 0;
  }
  ...
  public IdentityTestRow insert(
    ...
    values.add(interpolate(Fragment.encode(IdentityTestId.dbType, unsaved.name()), Fragment.lit("")));
