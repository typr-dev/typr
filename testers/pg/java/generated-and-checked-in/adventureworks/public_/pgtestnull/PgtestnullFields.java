...
public class PgtestnullFields extends TupleExpr70<Boolean, PGbox, /* bpchar, max 3 chars */ String, byte[], /* bpchar, max 1 chars */ String, PGcircle, LocalDate, Float, Double, Map<String, String>, Inet, Short, Int2Vector, Integer, Long, PGInterval, Json, Jsonb, PGline, PGlseg, Money, Mydomain, Myenum, String, BigDecimal, PGpath, PGpoint, PGpolygon, String, LocalTime, LocalDateTime, Instant, OffsetTime, UUID, String, Vector, Xml, PGbox[], /* bpchar */ String[], /* bpchar */ String[], PGcircle[], LocalDate[], Float[], Double[], Inet[], Short[], Int2Vector[], Integer[], Long[], PGInterval[], Json[], Jsonb[], PGline[], PGlseg[], Money[], Mydomain[], Myenum[], String[], BigDecimal[], PGpath[], PGpoint[], PGpolygon[], String[], LocalTime[], LocalDateTime[], Instant[], OffsetTime[], UUID[], String[], Xml[]> implements RelationStructure<PgtestnullFields, PgtestnullRow>, FieldsBase<PgtestnullRow> {
  ...
  public OptField<Mydomain, PgtestnullRow> mydomain() {
    return new OptField<Mydomain, PgtestnullRow>(_path, "mydomain", PgtestnullRow::mydomain, Optional.empty(), Optional.of("text"), (row, value) -> row.withMydomain(value), Mydomain.dbType);
  }

  public OptField<Myenum, PgtestnullRow> myenum() {
    return new OptField<Myenum, PgtestnullRow>(_path, "myenum", PgtestnullRow::myenum, Optional.empty(), Optional.of("public.myenum"), (row, value) -> row.withMyenum(value), Myenum.dbType);
  }
  ...
  public OptField<PGbox[], PgtestnullRow> boxes() {
    return new OptField<PGbox[], PgtestnullRow>(_path, "boxes", PgtestnullRow::boxes, Optional.empty(), Optional.of("box[]"), (row, value) -> row.withBoxes(value), PgTypes.boxArray);
  }
  ...
  public OptField<PGcircle[], PgtestnullRow> circlees() {
    return new OptField<PGcircle[], PgtestnullRow>(_path, "circlees", PgtestnullRow::circlees, Optional.empty(), Optional.of("circle[]"), (row, value) -> row.withCirclees(value), PgTypes.circleArray);
  }

  public OptField<LocalDate[], PgtestnullRow> datees() {
    return new OptField<LocalDate[], PgtestnullRow>(_path, "datees", PgtestnullRow::datees, Optional.empty(), Optional.of("date[]"), (row, value) -> row.withDatees(value), PgTypes.dateArray);
  }
  ...
  public OptField<Inet[], PgtestnullRow> inetes() {
    return new OptField<Inet[], PgtestnullRow>(_path, "inetes", PgtestnullRow::inetes, Optional.empty(), Optional.of("inet[]"), (row, value) -> row.withInetes(value), PgTypes.inetArray);
  }

  public OptField<Short[], PgtestnullRow> int2es() {
    return new OptField<Short[], PgtestnullRow>(_path, "int2es", PgtestnullRow::int2es, Optional.empty(), Optional.of("int2[]"), (row, value) -> row.withInt2es(value), PgTypes.int2Array);
  }

  public OptField<Int2Vector[], PgtestnullRow> int2vectores() {
    return new OptField<Int2Vector[], PgtestnullRow>(_path, "int2vectores", PgtestnullRow::int2vectores, Optional.empty(), Optional.of("int2vector[]"), (row, value) -> row.withInt2vectores(value), PgTypes.int2vectorArray);
  }
  ...
  public OptField<PGInterval[], PgtestnullRow> intervales() {
    return new OptField<PGInterval[], PgtestnullRow>(_path, "intervales", PgtestnullRow::intervales, Optional.empty(), Optional.of("interval[]"), (row, value) -> row.withIntervales(value), PgTypes.intervalArray);
  }

  public OptField<Json[], PgtestnullRow> jsones() {
    return new OptField<Json[], PgtestnullRow>(_path, "jsones", PgtestnullRow::jsones, Optional.empty(), Optional.of("json[]"), (row, value) -> row.withJsones(value), PgTypes.jsonArray);
  }

  public OptField<Jsonb[], PgtestnullRow> jsonbes() {
    return new OptField<Jsonb[], PgtestnullRow>(_path, "jsonbes", PgtestnullRow::jsonbes, Optional.empty(), Optional.of("jsonb[]"), (row, value) -> row.withJsonbes(value), PgTypes.jsonbArray);
  }

  public OptField<PGline[], PgtestnullRow> linees() {
    return new OptField<PGline[], PgtestnullRow>(_path, "linees", PgtestnullRow::linees, Optional.empty(), Optional.of("line[]"), (row, value) -> row.withLinees(value), PgTypes.lineArray);
  }

  public OptField<PGlseg[], PgtestnullRow> lseges() {
    return new OptField<PGlseg[], PgtestnullRow>(_path, "lseges", PgtestnullRow::lseges, Optional.empty(), Optional.of("lseg[]"), (row, value) -> row.withLseges(value), PgTypes.lsegArray);
  }

  public OptField<Money[], PgtestnullRow> moneyes() {
    return new OptField<Money[], PgtestnullRow>(_path, "moneyes", PgtestnullRow::moneyes, Optional.of("numeric[]"), Optional.of("money[]"), (row, value) -> row.withMoneyes(value), PgTypes.moneyArray);
  }

  public OptField<Mydomain[], PgtestnullRow> mydomaines() {
    return new OptField<Mydomain[], PgtestnullRow>(_path, "mydomaines", PgtestnullRow::mydomaines, Optional.of("text[]"), Optional.of("mydomain[]"), (row, value) -> row.withMydomaines(value), Mydomain.dbTypeArray);
  }

  public OptField<Myenum[], PgtestnullRow> myenumes() {
    return new OptField<Myenum[], PgtestnullRow>(_path, "myenumes", PgtestnullRow::myenumes, Optional.empty(), Optional.of("myenum[]"), (row, value) -> row.withMyenumes(value), Myenum.dbTypeArray);
  }
  ...
  public OptField<PGpath[], PgtestnullRow> pathes() {
    return new OptField<PGpath[], PgtestnullRow>(_path, "pathes", PgtestnullRow::pathes, Optional.empty(), Optional.of("path[]"), (row, value) -> row.withPathes(value), PgTypes.pathArray);
  }

  public OptField<PGpoint[], PgtestnullRow> pointes() {
    return new OptField<PGpoint[], PgtestnullRow>(_path, "pointes", PgtestnullRow::pointes, Optional.empty(), Optional.of("point[]"), (row, value) -> row.withPointes(value), PgTypes.pointArray);
  }

  public OptField<PGpolygon[], PgtestnullRow> polygones() {
    return new OptField<PGpolygon[], PgtestnullRow>(_path, "polygones", PgtestnullRow::polygones, Optional.empty(), Optional.of("polygon[]"), (row, value) -> row.withPolygones(value), PgTypes.polygonArray);
  }
  ...
  public OptField<LocalTime[], PgtestnullRow> timees() {
    return new OptField<LocalTime[], PgtestnullRow>(_path, "timees", PgtestnullRow::timees, Optional.empty(), Optional.of("time[]"), (row, value) -> row.withTimees(value), PgTypes.timeArray);
  }

  public OptField<LocalDateTime[], PgtestnullRow> timestampes() {
    return new OptField<LocalDateTime[], PgtestnullRow>(_path, "timestampes", PgtestnullRow::timestampes, Optional.empty(), Optional.of("timestamp[]"), (row, value) -> row.withTimestampes(value), PgTypes.timestampArray);
  }

  public OptField<Instant[], PgtestnullRow> timestampzes() {
    return new OptField<Instant[], PgtestnullRow>(_path, "timestampzes", PgtestnullRow::timestampzes, Optional.empty(), Optional.of("timestamptz[]"), (row, value) -> row.withTimestampzes(value), PgTypes.timestamptzArray);
  }

  public OptField<OffsetTime[], PgtestnullRow> timezes() {
    return new OptField<OffsetTime[], PgtestnullRow>(_path, "timezes", PgtestnullRow::timezes, Optional.empty(), Optional.of("timetz[]"), (row, value) -> row.withTimezes(value), PgTypes.timetzArray);
  }

  public OptField<UUID[], PgtestnullRow> uuides() {
    return new OptField<UUID[], PgtestnullRow>(_path, "uuides", PgtestnullRow::uuides, Optional.empty(), Optional.of("uuid[]"), (row, value) -> row.withUuides(value), PgTypes.uuidArray);
  }
  ...
  public OptField<Xml[], PgtestnullRow> xmles() {
    return new OptField<Xml[], PgtestnullRow>(_path, "xmles", PgtestnullRow::xmles, Optional.empty(), Optional.of("xml[]"), (row, value) -> row.withXmles(value), PgTypes.xmlArray);
  }
