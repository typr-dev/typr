...
public class UsersRepoImpl implements UsersRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"public\".\"users\" where \"user_id\" = "), Fragment.encode(UsersId.dbType, userId), Fragment.lit("")).update().runUnchecked(c) > 0;
  }
  ...
  public UsersRow insert(
    ...
    values.add(interpolate(Fragment.encode(UsersId.dbType, unsaved.userId()), Fragment.lit("::uuid")));
