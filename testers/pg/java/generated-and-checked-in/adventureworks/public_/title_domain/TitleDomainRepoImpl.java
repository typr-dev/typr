...
public class TitleDomainRepoImpl implements TitleDomainRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"public\".\"title_domain\" where \"code\" = "), Fragment.encode(TitleDomainId.dbType, code), Fragment.lit("")).update().runUnchecked(c) > 0;
  }
