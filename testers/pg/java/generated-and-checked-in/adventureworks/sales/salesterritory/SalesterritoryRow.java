...
public record SalesterritoryRow(
  ...
  public static RowParser<SalesterritoryRow> _rowParser = RowParsers.of(SalesterritoryId.dbType, Name.dbType, CountryregionId.dbType, PgTypes.text, PgTypes.numeric, PgTypes.numeric, PgTypes.numeric, PgTypes.numeric, PgTypes.uuid, PgTypes.timestamp, SalesterritoryRow::new, row -> new Object[]{row.territoryid(), row.name(), row.countryregioncode(), row.group(), row.salesytd(), row.saleslastyear(), row.costytd(), row.costlastyear(), row.rowguid(), row.modifieddate()});;
