...
public class SalesterritoryFields extends TupleExpr10<SalesterritoryId, Name, CountryregionId, String, BigDecimal, BigDecimal, BigDecimal, BigDecimal, UUID, LocalDateTime> implements RelationStructure<SalesterritoryFields, SalesterritoryRow>, FieldsBase<SalesterritoryRow> {
  List<Path> _path;
  ...
  public static SalesterritoryFields structure = new SalesterritoryFields(java.util.Collections.emptyList());

  public IdField<SalesterritoryId, SalesterritoryRow> territoryid() {
    return new IdField<SalesterritoryId, SalesterritoryRow>(_path, "territoryid", SalesterritoryRow::territoryid, Optional.empty(), Optional.of("int4"), (row, value) -> row.withTerritoryid(value), SalesterritoryId.dbType);
  }

  public Field<Name, SalesterritoryRow> name() {
    return new Field<Name, SalesterritoryRow>(_path, "name", SalesterritoryRow::name, Optional.empty(), Optional.of("varchar"), (row, value) -> row.withName(value), Name.dbType);
  }

  public Field<CountryregionId, SalesterritoryRow> countryregioncode() {
    return new Field<CountryregionId, SalesterritoryRow>(_path, "countryregioncode", SalesterritoryRow::countryregioncode, Optional.empty(), Optional.empty(), (row, value) -> row.withCountryregioncode(value), CountryregionId.dbType);
  }
