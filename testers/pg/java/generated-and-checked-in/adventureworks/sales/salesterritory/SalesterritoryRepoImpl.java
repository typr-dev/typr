...
public class SalesterritoryRepoImpl implements SalesterritoryRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"sales\".\"salesterritory\" where \"territoryid\" = "), Fragment.encode(SalesterritoryId.dbType, territoryid), Fragment.lit("")).update().runUnchecked(c) > 0;
  }
  ...
  public SalesterritoryRow insert(
    ...
    values.add(interpolate(Fragment.encode(CountryregionId.dbType, unsaved.countryregioncode()), Fragment.lit("")));
    ...
    unsaved.territoryid().visit(
      ...
      value -> {
        ...
        values.add(interpolate(Fragment.encode(SalesterritoryId.dbType, value), Fragment.lit("::int4")));
      }
    );;
