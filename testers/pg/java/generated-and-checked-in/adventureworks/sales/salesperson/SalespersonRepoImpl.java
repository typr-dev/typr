...
public class SalespersonRepoImpl implements SalespersonRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"sales\".\"salesperson\" where \"businessentityid\" = "), Fragment.encode(BusinessentityId.dbType, businessentityid), Fragment.lit("")).update().runUnchecked(c) > 0;
  }
  ...
  public SalespersonRow insert(
    ...
    values.add(interpolate(Fragment.encode(SalesterritoryId.dbType.opt(), unsaved.territoryid()), Fragment.lit("::int4")));
    columns.add(Fragment.lit("\"salesquota\""));
    values.add(interpolate(Fragment.encode(PgTypes.numeric.opt(), unsaved.salesquota()), Fragment.lit("::numeric")));
    unsaved.bonus().visit(
      () -> {
    ...
    Fragment q = interpolate(Fragment.lit("insert into \"sales\".\"salesperson\"("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nRETURNING \"businessentityid\", \"territoryid\", \"salesquota\", \"bonus\", \"commissionpct\", \"salesytd\", \"saleslastyear\", \"rowguid\", \"modifieddate\"\n"));;
  ...
  public Long insertStreaming(
    ...
    return streamingInsert.insertUnchecked("COPY \"sales\".\"salesperson\"(\"businessentityid\", \"territoryid\", \"salesquota\", \"bonus\", \"commissionpct\", \"salesytd\", \"saleslastyear\", \"rowguid\", \"modifieddate\") FROM STDIN", batchSize, unsaved, c, SalespersonRow.pgText);
  }
  ...
  public Long insertUnsavedStreaming(
    ...
    return streamingInsert.insertUnchecked("COPY \"sales\".\"salesperson\"(\"businessentityid\", \"territoryid\", \"salesquota\", \"bonus\", \"commissionpct\", \"salesytd\", \"saleslastyear\", \"rowguid\", \"modifieddate\") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')", batchSize, unsaved, c, SalespersonRowUnsaved.pgText);
  }
  ...
  public List<SalespersonRow> selectAll(Connection c) {
    return interpolate(Fragment.lit("select \"businessentityid\", \"territoryid\", \"salesquota\", \"bonus\", \"commissionpct\", \"salesytd\", \"saleslastyear\", \"rowguid\", \"modifieddate\"\nfrom \"sales\".\"salesperson\"\n")).query(SalespersonRow._rowParser.all()).runUnchecked(c);
  }
  ...
  public Optional<SalespersonRow> selectById(
    ...
    return interpolate(Fragment.lit("select \"businessentityid\", \"territoryid\", \"salesquota\", \"bonus\", \"commissionpct\", \"salesytd\", \"saleslastyear\", \"rowguid\", \"modifieddate\"\nfrom \"sales\".\"salesperson\"\nwhere \"businessentityid\" = "), Fragment.encode(BusinessentityId.dbType, businessentityid), Fragment.lit("")).query(SalespersonRow._rowParser.first()).runUnchecked(c);
  }
  ...
  public List<SalespersonRow> selectByIds(
    ...
    return interpolate(Fragment.lit("select \"businessentityid\", \"territoryid\", \"salesquota\", \"bonus\", \"commissionpct\", \"salesytd\", \"saleslastyear\", \"rowguid\", \"modifieddate\"\nfrom \"sales\".\"salesperson\"\nwhere \"businessentityid\" = ANY("), Fragment.encode(BusinessentityId.dbTypeArray, businessentityids), Fragment.lit(")")).query(SalespersonRow._rowParser.all()).runUnchecked(c);
  }
  ...
  public UpdateBuilder<SalespersonFields, SalespersonRow> update() {
    return UpdateBuilder.of("\"sales\".\"salesperson\"", SalespersonFields.structure, SalespersonRow._rowParser, Dialect.POSTGRESQL);
  }
