...
public class SalespersonFields extends TupleExpr9<BusinessentityId, SalesterritoryId, BigDecimal, BigDecimal, BigDecimal, BigDecimal, BigDecimal, UUID, LocalDateTime> implements RelationStructure<SalespersonFields, SalespersonRow>, FieldsBase<SalespersonRow> {
  ...
  public IdField<BusinessentityId, SalespersonRow> businessentityid() {
    return new IdField<BusinessentityId, SalespersonRow>(_path, "businessentityid", SalespersonRow::businessentityid, Optional.empty(), Optional.of("int4"), (row, value) -> row.withBusinessentityid(value), BusinessentityId.dbType);
  }

  public OptField<SalesterritoryId, SalespersonRow> territoryid() {
    return new OptField<SalesterritoryId, SalespersonRow>(_path, "territoryid", SalespersonRow::territoryid, Optional.empty(), Optional.of("int4"), (row, value) -> row.withTerritoryid(value), SalesterritoryId.dbType);
  }
