...
public class DepartmentRepoImpl implements DepartmentRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"humanresources\".\"department\" where \"departmentid\" = "), Fragment.encode(DepartmentId.dbType, departmentid), Fragment.lit("")).update().runUnchecked(c) > 0;
  }
  ...
  public DepartmentRow insert(
    ...
    values.add(interpolate(Fragment.encode(Name.dbType, unsaved.groupname()), Fragment.lit("::varchar")));
    unsaved.departmentid().visit(
      ...
      value -> {
        ...
        values.add(interpolate(Fragment.encode(DepartmentId.dbType, value), Fragment.lit("::int4")));
      }
    );;
