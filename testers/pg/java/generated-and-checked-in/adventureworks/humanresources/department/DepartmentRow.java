...
public record DepartmentRow(
  ...
  public static RowParser<DepartmentRow> _rowParser = RowParsers.of(DepartmentId.dbType, Name.dbType, Name.dbType, PgTypes.timestamp, DepartmentRow::new, row -> new Object[]{row.departmentid(), row.name(), row.groupname(), row.modifieddate()});;
