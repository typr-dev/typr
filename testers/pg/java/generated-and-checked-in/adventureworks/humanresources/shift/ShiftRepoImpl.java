...
public class ShiftRepoImpl implements ShiftRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from \"humanresources\".\"shift\" where \"shiftid\" = "), Fragment.encode(ShiftId.dbType, shiftid), Fragment.lit("")).update().runUnchecked(c) > 0;
  }
  ...
  public ShiftRow insert(
    ...
    unsaved.shiftid().visit(
      ...
      value -> {
        ...
        values.add(interpolate(Fragment.encode(ShiftId.dbType, value), Fragment.lit("::int4")));
      }
    );;
