...
public record EmployeedepartmenthistoryId(
  ...
  public static RowParser<EmployeedepartmenthistoryId> _rowParser = RowParsers.of(BusinessentityId.dbType, PgTypes.date, DepartmentId.dbType, ShiftId.dbType, EmployeedepartmenthistoryId::new, row -> new Object[]{row.businessentityid(), row.startdate(), row.departmentid(), row.shiftid()});;
