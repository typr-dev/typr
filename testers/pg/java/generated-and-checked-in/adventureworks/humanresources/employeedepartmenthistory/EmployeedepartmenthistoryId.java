...
public record EmployeedepartmenthistoryId(
  ...
  public static RowParser<EmployeedepartmenthistoryId> _rowParser = RowParsers.of(BusinessentityId.pgType, PgTypes.date, DepartmentId.pgType, ShiftId.pgType, EmployeedepartmenthistoryId::new, row -> new Object[]{row.businessentityid(), row.startdate(), row.departmentid(), row.shiftid()});;
}