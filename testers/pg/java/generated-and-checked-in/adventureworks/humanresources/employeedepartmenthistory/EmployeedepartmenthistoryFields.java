...
public class EmployeedepartmenthistoryFields extends TupleExpr6<BusinessentityId, DepartmentId, ShiftId, LocalDate, LocalDate, LocalDateTime> implements RelationStructure<EmployeedepartmenthistoryFields, EmployeedepartmenthistoryRow>, FieldsBase<EmployeedepartmenthistoryRow> {
  List<Path> _path;
  ...
  public static EmployeedepartmenthistoryFields structure = new EmployeedepartmenthistoryFields(java.util.Collections.emptyList());

  public IdField<BusinessentityId, EmployeedepartmenthistoryRow> businessentityid() {
    return new IdField<BusinessentityId, EmployeedepartmenthistoryRow>(_path, "businessentityid", EmployeedepartmenthistoryRow::businessentityid, Optional.empty(), Optional.of("int4"), (row, value) -> row.withBusinessentityid(value), BusinessentityId.dbType);
  }

  public IdField<DepartmentId, EmployeedepartmenthistoryRow> departmentid() {
    return new IdField<DepartmentId, EmployeedepartmenthistoryRow>(_path, "departmentid", EmployeedepartmenthistoryRow::departmentid, Optional.empty(), Optional.of("int2"), (row, value) -> row.withDepartmentid(value), DepartmentId.dbType);
  }

  public IdField<ShiftId, EmployeedepartmenthistoryRow> shiftid() {
    return new IdField<ShiftId, EmployeedepartmenthistoryRow>(_path, "shiftid", EmployeedepartmenthistoryRow::shiftid, Optional.empty(), Optional.of("int2"), (row, value) -> row.withShiftid(value), ShiftId.dbType);
  }
  ...
  public SqlExpr<Boolean> compositeIdIn(List<EmployeedepartmenthistoryId> compositeIds) {
    return TupleExpr.of(businessentityid(), startdate(), departmentid(), shiftid()).among(compositeIds);
  }
