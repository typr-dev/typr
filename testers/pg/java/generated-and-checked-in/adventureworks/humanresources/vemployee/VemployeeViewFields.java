...
public class VemployeeViewFields extends TupleExpr18<BusinessentityId, String, /* user-picked */ FirstName, Name, Name, String, String, Phone, Name, String, Integer, String, String, String, Name, String, Name, Xml> implements RelationStructure<VemployeeViewFields, VemployeeViewRow>, FieldsBase<VemployeeViewRow> {
  List<Path> _path;
  ...
  public static VemployeeViewFields structure = new VemployeeViewFields(java.util.Collections.emptyList());

  public Field<BusinessentityId, VemployeeViewRow> businessentityid() {
    return new Field<BusinessentityId, VemployeeViewRow>(_path, "businessentityid", VemployeeViewRow::businessentityid, Optional.empty(), Optional.empty(), (row, value) -> row.withBusinessentityid(value), BusinessentityId.dbType);
  }
  ...
  public Field</* user-picked */ FirstName, VemployeeViewRow> firstname() {
    return new Field</* user-picked */ FirstName, VemployeeViewRow>(_path, "firstname", VemployeeViewRow::firstname, Optional.empty(), Optional.empty(), (row, value) -> row.withFirstname(value), FirstName.dbType);
  }

  public Field<Name, VemployeeViewRow> middlename() {
    return new Field<Name, VemployeeViewRow>(_path, "middlename", VemployeeViewRow::middlename, Optional.empty(), Optional.empty(), (row, value) -> row.withMiddlename(value), Name.dbType);
  }

  public Field<Name, VemployeeViewRow> lastname() {
    return new Field<Name, VemployeeViewRow>(_path, "lastname", VemployeeViewRow::lastname, Optional.empty(), Optional.empty(), (row, value) -> row.withLastname(value), Name.dbType);
  }
  ...
  public Field<Phone, VemployeeViewRow> phonenumber() {
    return new Field<Phone, VemployeeViewRow>(_path, "phonenumber", VemployeeViewRow::phonenumber, Optional.empty(), Optional.empty(), (row, value) -> row.withPhonenumber(value), Phone.dbType);
  }

  public Field<Name, VemployeeViewRow> phonenumbertype() {
    return new Field<Name, VemployeeViewRow>(_path, "phonenumbertype", VemployeeViewRow::phonenumbertype, Optional.empty(), Optional.empty(), (row, value) -> row.withPhonenumbertype(value), Name.dbType);
  }
  ...
  public Field<Name, VemployeeViewRow> stateprovincename() {
    return new Field<Name, VemployeeViewRow>(_path, "stateprovincename", VemployeeViewRow::stateprovincename, Optional.empty(), Optional.empty(), (row, value) -> row.withStateprovincename(value), Name.dbType);
  }
  ...
  public Field<Name, VemployeeViewRow> countryregionname() {
    return new Field<Name, VemployeeViewRow>(_path, "countryregionname", VemployeeViewRow::countryregionname, Optional.empty(), Optional.empty(), (row, value) -> row.withCountryregionname(value), Name.dbType);
  }
