...
public class EmployeeFields extends TupleExpr15<BusinessentityId, String, String, String, LocalDate, String, String, LocalDate, Flag, Short, Short, Flag, UUID, LocalDateTime, String> implements RelationStructure<EmployeeFields, EmployeeRow>, FieldsBase<EmployeeRow> {
  List<Path> _path;
  ...
  public IdField<BusinessentityId, EmployeeRow> businessentityid() {
    return new IdField<BusinessentityId, EmployeeRow>(_path, "businessentityid", EmployeeRow::businessentityid, Optional.empty(), Optional.of("int4"), (row, value) -> row.withBusinessentityid(value), BusinessentityId.dbType);
  }
  ...
  public Field<Flag, EmployeeRow> salariedflag() {
    return new Field<Flag, EmployeeRow>(_path, "salariedflag", EmployeeRow::salariedflag, Optional.empty(), Optional.of("bool"), (row, value) -> row.withSalariedflag(value), Flag.dbType);
  }
  ...
  public Field<Flag, EmployeeRow> currentflag() {
    return new Field<Flag, EmployeeRow>(_path, "currentflag", EmployeeRow::currentflag, Optional.empty(), Optional.of("bool"), (row, value) -> row.withCurrentflag(value), Flag.dbType);
  }
