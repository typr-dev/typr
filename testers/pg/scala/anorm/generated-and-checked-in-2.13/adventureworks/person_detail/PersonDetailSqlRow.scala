    ...
    Reads[PersonDetailSqlRow](json => JsResult.fromTry(
        Try(
          PersonDetailSqlRow(
            ...
            middlename = json.\("middlename").toOption.map(_.as(MiddleName.reads)),
    ...
    RowParser[PersonDetailSqlRow] { row =>
      Success(
        PersonDetailSqlRow(
          ...
          middlename = row(idx + 3)(Column.columnToOption(MiddleName.column)),
          ...
          rowguid = row(idx + 9)(Column.columnToOption(TypoUUID.column))
        )
      )
    }
  }
  ...
  implicit lazy val writes: OWrites[PersonDetailSqlRow] = {
    OWrites[PersonDetailSqlRow](o =>
      new JsObject(ListMap[String, JsValue](
        ...
        "middlename" -> Writes.OptionWrites(MiddleName.writes).writes(o.middlename),
        ...
        "rowguid" -> Writes.OptionWrites(TypoUUID.writes).writes(o.rowguid)
      ))
    )
  }
}