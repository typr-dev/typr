...
class PrecisionTypesRepoImpl extends PrecisionTypesRepo {
  ...
  override def deleteById(id: PrecisionTypesId)(implicit c: Connection): Boolean = SQL"""delete from "public"."precision_types" where "id" = ${ParameterValue(id, null, PrecisionTypesId.toStatement)}""".executeUpdate() > 0

  override def deleteByIds(ids: Array[PrecisionTypesId])(implicit c: Connection): Int = {
    SQL"""delete
  ...
  override def insert(unsaved: PrecisionTypesRow)(implicit c: Connection): PrecisionTypesRow = {
  ...
  override def insert(unsaved: PrecisionTypesRowUnsaved)(implicit c: Connection): PrecisionTypesRow = {
  ...
  override def insertStreaming(
    ...
    batchSize: Int = 10000
  )(implicit c: Connection): Long = streamingInsert(s"""COPY "public"."precision_types"("id", "string10", "string20", "string50", "string100", "string255", "bpchar3", "bpchar10", "decimal5_2", "decimal10_2", "decimal18_4", "numeric8_2", "numeric12_4", "timestamp0", "timestamp3", "timestamp6", "timestamptz0", "timestamptz3", "timestamptz6", "time0", "time3", "time6", "timetz0", "timetz3", "timetz6") FROM STDIN""", batchSize, unsaved)(PrecisionTypesRow.pgText, c)

  /** NOTE: this functionality requires PostgreSQL 16 or later! */
  override def insertUnsavedStreaming(
    unsaved: Iterator[PrecisionTypesRowUnsaved],
    batchSize: Int = 10000
  )(implicit c: Connection): Long = streamingInsert(s"""COPY "public"."precision_types"("string10", "string20", "string50", "string100", "string255", "bpchar3", "bpchar10", "decimal5_2", "decimal10_2", "decimal18_4", "numeric8_2", "numeric12_4", "timestamp0", "timestamp3", "timestamp6", "timestamptz0", "timestamptz3", "timestamptz6", "time0", "time3", "time6", "timetz0", "timetz3", "timetz6", "id") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(PrecisionTypesRowUnsaved.pgText, c)
  ...
  override def selectAll(implicit c: Connection): List[PrecisionTypesRow] = {
  ...
  override def selectById(id: PrecisionTypesId)(implicit c: Connection): Option[PrecisionTypesRow] = {
    SQL"""select "id", "string10", "string20", "string50", "string100", "string255", "bpchar3", "bpchar10", "decimal5_2", "decimal10_2", "decimal18_4", "numeric8_2", "numeric12_4", "timestamp0"::text, "timestamp3"::text, "timestamp6"::text, "timestamptz0"::text, "timestamptz3"::text, "timestamptz6"::text, "time0"::text, "time3"::text, "time6"::text, "timetz0"::text, "timetz3"::text, "timetz6"::text
    from "public"."precision_types"
  ...
  override def selectByIds(ids: Array[PrecisionTypesId])(implicit c: Connection): List[PrecisionTypesRow] = {
    SQL"""select "id", "string10", "string20", "string50", "string100", "string255", "bpchar3", "bpchar10", "decimal5_2", "decimal10_2", "decimal18_4", "numeric8_2", "numeric12_4", "timestamp0"::text, "timestamp3"::text, "timestamp6"::text, "timestamptz0"::text, "timestamptz3"::text, "timestamptz6"::text, "time0"::text, "time3"::text, "time6"::text, "timetz0"::text, "timetz3"::text, "timetz6"::text
    from "public"."precision_types"
    where "id" = ANY(${ParameterValue(ids, null, PrecisionTypesId.arrayToStatement)})
    """.as(PrecisionTypesRow.rowParser(1).*)
  ...
  override def selectByIdsTracked(ids: Array[PrecisionTypesId])(implicit c: Connection): Map[PrecisionTypesId, PrecisionTypesRow] = {
  ...
  override def update(row: PrecisionTypesRow)(implicit c: Connection): Option[PrecisionTypesRow] = {
    val id = row.id
  ...
  override def upsert(unsaved: PrecisionTypesRow)(implicit c: Connection): PrecisionTypesRow = {
  SQL"""insert into "public"."precision_types"("id", "string10", "string20", "string50", "string100", "string255", "bpchar3", "bpchar10", "decimal5_2", "decimal10_2", "decimal18_4", "numeric8_2", "numeric12_4", "timestamp0", "timestamp3", "timestamp6", "timestamptz0", "timestamptz3", "timestamptz6", "time0", "time3", "time6", "timetz0", "timetz3", "timetz6")
    values (
  ...
  override def upsertBatch(unsaved: Iterable[PrecisionTypesRow])(implicit c: Connection): List[PrecisionTypesRow] = {
