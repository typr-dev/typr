...
trait PrecisionTypesRepo {
  ...
  def update(row: PrecisionTypesRow)(using c: Connection): Option[PrecisionTypesRow]

  def upsert(unsaved: PrecisionTypesRow)(using c: Connection): PrecisionTypesRow

  def upsertBatch(unsaved: Iterable[PrecisionTypesRow])(using c: Connection): List[PrecisionTypesRow]
