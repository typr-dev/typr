...
case class TestInsert(
  ...
  def publicIssue142(tabellkode: Issue142Id = Issue142Id.apply(random.alphanumeric.take(20).mkString))(using c: Connection): Issue142Row = (new Issue142RepoImpl).insert(new Issue142Row(tabellkode = tabellkode))
  ...
  )(using c: Connection): PrecisionTypesNullRow = (new PrecisionTypesNullRepoImpl).insert(new PrecisionTypesNullRowUnsaved(string10 = string10, string20 = string20, string50 = string50, string100 = string100, string255 = string255, bpchar3 = bpchar3, bpchar10 = bpchar10, decimal52 = decimal52, decimal102 = decimal102, decimal184 = decimal184, numeric82 = numeric82, numeric124 = numeric124, timestamp0 = timestamp0, timestamp3 = timestamp3, timestamp6 = timestamp6, timestamptz0 = timestamptz0, timestamptz3 = timestamptz3, timestamptz6 = timestamptz6, time0 = time0, time3 = time3, time6 = time6, timetz0 = timetz0, timetz3 = timetz3, timetz6 = timetz6, id = id))

  def publicTitle(code: TitleId = TitleId.apply(random.alphanumeric.take(20).mkString))(using c: Connection): TitleRow = (new TitleRepoImpl).insert(new TitleRow(code = code))

  def publicTitleDomain(code: TitleDomainId = TitleDomainId.apply(domainInsert.publicShortText(random)))(using c: Connection): TitleDomainRow = (new TitleDomainRepoImpl).insert(new TitleDomainRow(code = code))
