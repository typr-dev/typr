...
class PersonRepoImpl extends PersonRepo {
  ...
  override def insert(unsaved: PersonRowUnsaved)(using c: Connection): PersonRow = {
    val namedParameters = List(
      ...
      Some((NamedParameter("middlename", ParameterValue(unsaved.middlename, null, ToStatement.optionToStatement(using MiddleName.toStatement, MiddleName.parameterMetadata))), "::varchar")),
  ...
  override def update(row: PersonRow)(using c: Connection): Option[PersonRow] = {
    ...
    "middlename" = ${ParameterValue(row.middlename, null, ToStatement.optionToStatement(using MiddleName.toStatement, MiddleName.parameterMetadata))}::varchar,
  ...
  SQL"""insert into "person"."person"("businessentityid", "persontype", "namestyle", "title", "firstname", "middlename", "lastname", "suffix", "emailpromotion", "additionalcontactinfo", "demographics", "rowguid", "modifieddate")
    ...
    ${ParameterValue(unsaved.middlename, null, ToStatement.optionToStatement(using MiddleName.toStatement, MiddleName.parameterMetadata))}::varchar,
  ...
  override def upsertBatch(unsaved: Iterable[PersonRow])(using c: Connection): List[PersonRow] = {
    def toNamedParameter(row: PersonRow): List[NamedParameter] = List(
      ...
      NamedParameter("middlename", ParameterValue(row.middlename, null, ToStatement.optionToStatement(using MiddleName.toStatement, MiddleName.parameterMetadata))),
