...
object PersonDetailSqlRow {
  given jdbcDecoder: JdbcDecoder[PersonDetailSqlRow] = {
      ...
      override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, PersonDetailSqlRow) =
        columIndex + 9 ->
          PersonDetailSqlRow(
            ...
            middlename = JdbcDecoder.optionDecoder(using MiddleName.jdbcDecoder).unsafeDecode(columIndex + 3, rs)._2,
  ...
  given jsonDecoder: JsonDecoder[PersonDetailSqlRow] = {
  ...
  given jsonEncoder: JsonEncoder[PersonDetailSqlRow] = {
