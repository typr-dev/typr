...
object PersonDetailSqlRow {
      ...
      override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, PersonDetailSqlRow) =
        columIndex + 9 ->
          PersonDetailSqlRow(
            ...
            middlename = JdbcDecoder.optionDecoder(MiddleName.jdbcDecoder).unsafeDecode(columIndex + 3, rs)._2,
            ...
            rowguid = JdbcDecoder.optionDecoder(TypoUUID.jdbcDecoder).unsafeDecode(columIndex + 9, rs)._2
          )
    }
  }
  ...
  implicit lazy val jsonDecoder: JsonDecoder[PersonDetailSqlRow] = {
    JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
      ...
      val rowguid = jsonObj.get("rowguid").fold[Either[String, Option[TypoUUID]]](Right(None))(_.as(JsonDecoder.option(TypoUUID.jsonDecoder)))
  ...
  implicit lazy val jsonEncoder: JsonEncoder[PersonDetailSqlRow] = {
    new JsonEncoder[PersonDetailSqlRow] {
      override def unsafeEncode(a: PersonDetailSqlRow, indent: Option[Int], out: Write): Unit = {
        ...
        out.write(",")
        out.write(""""rowguid":""")
        JsonEncoder.option(TypoUUID.jsonEncoder).unsafeEncode(a.rowguid, indent, out)
        out.write("}")
      }
    }
  }
