...
case class TestInsert(
  ...
  def publicPgtestnull(
    ...
    boxes: Option[List[PGbox]] = None,
    bpchares: Option[List[/* bpchar */ String]] = None,
    chares: Option[List[/* bpchar */ String]] = None,
    circlees: Option[List[PGcircle]] = None,
    datees: Option[List[LocalDate]] = None,
    float4es: Option[List[Float]] = None,
    float8es: Option[List[Double]] = None,
    inetes: Option[List[Inet]] = None,
    int2es: Option[List[Short]] = None,
    int2vectores: Option[List[Int2Vector]] = None,
    int4es: Option[List[Int]] = None,
    int8es: Option[List[Long]] = None,
    intervales: Option[List[PGInterval]] = None,
    jsones: Option[List[Json]] = None,
    jsonbes: Option[List[Jsonb]] = None,
    linees: Option[List[PGline]] = None,
    lseges: Option[List[PGlseg]] = None,
    moneyes: Option[List[Money]] = None,
    mydomaines: Option[List[Mydomain]] = None,
    myenumes: Option[List[Myenum]] = None,
    namees: Option[List[String]] = None,
    numerices: Option[List[BigDecimal]] = None,
    pathes: Option[List[PGpath]] = None,
    pointes: Option[List[PGpoint]] = None,
    polygones: Option[List[PGpolygon]] = None,
    textes: Option[List[String]] = None,
    timees: Option[List[LocalTime]] = None,
    timestampes: Option[List[LocalDateTime]] = None,
    timestampzes: Option[List[Instant]] = None,
    timezes: Option[List[OffsetTime]] = None,
    uuides: Option[List[UUID]] = None,
    varchares: Option[List[String]] = None,
    xmles: Option[List[Xml]] = None
