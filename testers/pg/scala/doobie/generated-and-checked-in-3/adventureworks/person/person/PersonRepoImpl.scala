...
class PersonRepoImpl extends PersonRepo {
  ...
  override def insert(unsaved: PersonRowUnsaved): ConnectionIO[PersonRow] = {
    val fs = List(
      ...
      Some((Fragment.const0(s""""middlename""""), fr"${fromWrite(unsaved.middlename)(using new Write.SingleOpt(/* user-picked */ MiddleName.put))}::varchar")),
      Some((Fragment.const0(s""""lastname""""), fr"${fromWrite(unsaved.lastname)(using new Write.Single(/* user-picked */ LastName.put))}::varchar")),
  ...
  override def update(row: PersonRow): ConnectionIO[Option[PersonRow]] = {
    ...
    "middlename" = ${fromWrite(row.middlename)(using new Write.SingleOpt(/* user-picked */ MiddleName.put))}::varchar,
    "lastname" = ${fromWrite(row.lastname)(using new Write.Single(/* user-picked */ LastName.put))}::varchar,
  ...
  override def upsert(unsaved: PersonRow): ConnectionIO[PersonRow] = {
    ...
    ${fromWrite(unsaved.middlename)(using new Write.SingleOpt(/* user-picked */ MiddleName.put))}::varchar,
    ${fromWrite(unsaved.lastname)(using new Write.Single(/* user-picked */ LastName.put))}::varchar,
