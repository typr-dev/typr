...
object PersonFields {
  ...
  private final class Impl(val _path: List[Path])
    ...
    override lazy val fields: PersonFields = new PersonFields {
      ...
      override def middlename = OptField[/* user-picked */ MiddleName, PersonRow](_path, "middlename", None, Some("varchar"), x => x.middlename, (row, value) => row.copy(middlename = value))
      override def lastname = Field[/* user-picked */ LastName, PersonRow](_path, "lastname", None, Some("varchar"), x => x.lastname, (row, value) => row.copy(lastname = value))
