...
object PrecisionTypesRowUnsaved {
  given decoder: Decoder[PrecisionTypesRowUnsaved] = {
    Decoder.instanceTry[PrecisionTypesRowUnsaved]((c: HCursor) =>
      Try {
        ...
        PrecisionTypesRowUnsaved(
          string10 = orThrow(c.get("string10")(using Decoder.decodeString)),
          string20 = orThrow(c.get("string20")(using Decoder.decodeString)),
          string50 = orThrow(c.get("string50")(using Decoder.decodeString)),
          string100 = orThrow(c.get("string100")(using Decoder.decodeString)),
          string255 = orThrow(c.get("string255")(using Decoder.decodeString)),
          bpchar3 = orThrow(c.get("bpchar3")(using Decoder.decodeString)),
          bpchar10 = orThrow(c.get("bpchar10")(using Decoder.decodeString)),
          decimal52 = orThrow(c.get("decimal5_2")(using Decoder.decodeBigDecimal)),
          decimal102 = orThrow(c.get("decimal10_2")(using Decoder.decodeBigDecimal)),
          decimal184 = orThrow(c.get("decimal18_4")(using Decoder.decodeBigDecimal)),
          numeric82 = orThrow(c.get("numeric8_2")(using Decoder.decodeBigDecimal)),
          numeric124 = orThrow(c.get("numeric12_4")(using Decoder.decodeBigDecimal)),
          timestamp0 = orThrow(c.get("timestamp0")(using TypoLocalDateTime.decoder)),
          timestamp3 = orThrow(c.get("timestamp3")(using TypoLocalDateTime.decoder)),
          timestamp6 = orThrow(c.get("timestamp6")(using TypoLocalDateTime.decoder)),
          timestamptz0 = orThrow(c.get("timestamptz0")(using TypoInstant.decoder)),
          timestamptz3 = orThrow(c.get("timestamptz3")(using TypoInstant.decoder)),
          timestamptz6 = orThrow(c.get("timestamptz6")(using TypoInstant.decoder)),
          time0 = orThrow(c.get("time0")(using TypoLocalTime.decoder)),
          time3 = orThrow(c.get("time3")(using TypoLocalTime.decoder)),
          time6 = orThrow(c.get("time6")(using TypoLocalTime.decoder)),
          timetz0 = orThrow(c.get("timetz0")(using TypoOffsetTime.decoder)),
          timetz3 = orThrow(c.get("timetz3")(using TypoOffsetTime.decoder)),
          timetz6 = orThrow(c.get("timetz6")(using TypoOffsetTime.decoder)),
          id = orThrow(c.get("id")(using Defaulted.decoder(using PrecisionTypesId.decoder)))
        )
      }
    )
  }

  given encoder: Encoder[PrecisionTypesRowUnsaved] = {
    Encoder.instance[PrecisionTypesRowUnsaved](row =>
      Json.obj(
        ...
        "id" -> Defaulted.encoder(using PrecisionTypesId.encoder).apply(row.id)
      )
    )
  }
