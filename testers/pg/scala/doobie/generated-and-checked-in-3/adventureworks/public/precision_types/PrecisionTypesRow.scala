...
object PrecisionTypesRow {
  given decoder: Decoder[PrecisionTypesRow] = {
    Decoder.instanceTry[PrecisionTypesRow]((c: HCursor) =>
      Try {
        ...
        PrecisionTypesRow(
          id = orThrow(c.get("id")(using PrecisionTypesId.decoder)),
  ...
  given encoder: Encoder[PrecisionTypesRow] = {
  ...
  given read: Read[PrecisionTypesRow] = {
  ...
  given write: Write[PrecisionTypesRow] = {
