...
class EmployeeRepoImpl extends EmployeeRepo {
  ...
  override def deleteById(businessentityid: BusinessentityId): ConnectionIO[Boolean] = sql"""delete from "humanresources"."employee" where "businessentityid" = ${fromWrite(businessentityid)(new Write.Single(BusinessentityId.put))}""".update.run.map(_ > 0)

  override def deleteByIds(businessentityids: Array[BusinessentityId]): ConnectionIO[Int] = sql"""delete from "humanresources"."employee" where "businessentityid" = ANY(${fromWrite(businessentityids)(new Write.Single(BusinessentityId.arrayPut))})""".update.run
  ...
  override def insert(unsaved: EmployeeRowUnsaved): ConnectionIO[EmployeeRow] = {
    val fs = List(
      ...
      unsaved.salariedflag match {
        ...
        case Defaulted.Provided(value) => Some((Fragment.const0(s""""salariedflag""""), fr"${fromWrite(value: /* user-picked */ SalariedFlag)(new Write.Single(/* user-picked */ SalariedFlag.put))}::bool"))
      },
      ...
      unsaved.currentflag match {
        case Defaulted.UseDefault() => None
        case Defaulted.Provided(value) => Some((Fragment.const0(s""""currentflag""""), fr"${fromWrite(value: /* user-picked */ CurrentFlag)(new Write.Single(/* user-picked */ CurrentFlag.put))}::bool"))
      },
  ...
  override def update(row: EmployeeRow): ConnectionIO[Option[EmployeeRow]] = {
    ...
    "salariedflag" = ${fromWrite(row.salariedflag)(new Write.Single(/* user-picked */ SalariedFlag.put))}::bool,
    ...
    "currentflag" = ${fromWrite(row.currentflag)(new Write.Single(/* user-picked */ CurrentFlag.put))}::bool,
    ...
    returning "businessentityid", "nationalidnumber", "loginid", "jobtitle", "birthdate"::text, "maritalstatus", "gender", "hiredate"::text, "salariedflag", "vacationhours", "sickleavehours", "currentflag", "rowguid", "modifieddate"::text, "organizationnode"""".query(EmployeeRow.read).option
  }
  ...
  override def upsert(unsaved: EmployeeRow): ConnectionIO[EmployeeRow] = {
    ...
    ${fromWrite(unsaved.salariedflag)(new Write.Single(/* user-picked */ SalariedFlag.put))}::bool,
    ...
    ${fromWrite(unsaved.currentflag)(new Write.Single(/* user-picked */ CurrentFlag.put))}::bool,
  ...
  override def upsertBatch(unsaved: List[EmployeeRow]): Stream[ConnectionIO, EmployeeRow] = {
    ...
    .updateManyWithGeneratedKeys[EmployeeRow]("businessentityid", "nationalidnumber", "loginid", "jobtitle", "birthdate", "maritalstatus", "gender", "hiredate", "salariedflag", "vacationhours", "sickleavehours", "currentflag", "rowguid", "modifieddate", "organizationnode")(unsaved)(catsStdInstancesForList, EmployeeRow.read)
  }
  ...
  override def upsertStreaming(
    ...
    for {
      ...
      _ <- new FragmentOps(sql"""copy employee_TEMP("businessentityid", "nationalidnumber", "loginid", "jobtitle", "birthdate", "maritalstatus", "gender", "hiredate", "salariedflag", "vacationhours", "sickleavehours", "currentflag", "rowguid", "modifieddate", "organizationnode") from stdin""").copyIn(unsaved, batchSize)(EmployeeRow.pgText)
