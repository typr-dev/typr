...
case class OnlyPkColumnsRepoMock(map: HashMap[OnlyPkColumnsId, OnlyPkColumnsRow] = new HashMap[OnlyPkColumnsId, OnlyPkColumnsRow]()) extends OnlyPkColumnsRepo {
  override def delete: DeleteBuilder[OnlyPkColumnsFields, OnlyPkColumnsRow] = DeleteBuilderMock(OnlyPkColumnsFields.structure, () => new ArrayList(map.values()), DeleteParams.empty(), row => row.compositeId, id => map.remove(id): @scala.annotation.nowarn)
  ...
  override def select: SelectBuilder[OnlyPkColumnsFields, OnlyPkColumnsRow] = SelectBuilderMock(OnlyPkColumnsFields.structure, () => new ArrayList(map.values()), SelectParams.empty())

  override def selectAll(using c: ConnectionRead): java.util.List[OnlyPkColumnsRow] = new ArrayList(map.values())

  override def selectById(compositeId: OnlyPkColumnsId)(using c: ConnectionRead): Optional[OnlyPkColumnsRow] = Optional.ofNullable(map.get(compositeId))
  ...
  override def selectByIdsTracked(compositeIds: java.util.List[OnlyPkColumnsId])(using c: ConnectionRead): java.util.Map[OnlyPkColumnsId, OnlyPkColumnsRow] = selectByIds(compositeIds)(using c).stream().collect(Collectors.toMap((row: OnlyPkColumnsRow) => row.compositeId, Function.identity()))

  override def update: UpdateBuilder[OnlyPkColumnsFields, OnlyPkColumnsRow] = UpdateBuilderMock(OnlyPkColumnsFields.structure, () => new ArrayList(map.values()), UpdateParams.empty(), row => row)
