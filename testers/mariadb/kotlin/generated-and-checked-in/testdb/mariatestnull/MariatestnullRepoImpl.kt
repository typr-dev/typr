...
class MariatestnullRepoImpl() : MariatestnullRepo {
  ...
  override fun insert(
    ...
    unsaved.tinyintUCol.visit(
      ...
      values.add(Fragment.interpolate(Fragment.encode(MariaTypes.tinyintUnsigned.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.smallintUCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`smallint_u_col`"))
      values.add(Fragment.interpolate(Fragment.encode(MariaTypes.smallintUnsigned.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.mediumintUCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`mediumint_u_col`"))
      values.add(Fragment.interpolate(Fragment.encode(MariaTypes.mediumintUnsigned.nullable(), value), Fragment.lit(""))) }
    );
    unsaved.intUCol.visit(
      {  },
      { value -> columns.add(Fragment.lit("`int_u_col`"))
      values.add(Fragment.interpolate(Fragment.encode(MariaTypes.intUnsigned.nullable(), value), Fragment.lit(""))) }
    );
    ...
    unsaved.setCol.visit(
      ...
      values.add(Fragment.interpolate(Fragment.encode(XYZSet.mariaType.nullable(), value), Fragment.lit(""))) }
    );
