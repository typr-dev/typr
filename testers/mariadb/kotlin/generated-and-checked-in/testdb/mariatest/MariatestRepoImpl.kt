...
class MariatestRepoImpl() : MariatestRepo {
  ...
  override fun deleteById(
    intCol: MariatestId,
    c: Connection
  ): Boolean = Fragment.interpolate(Fragment.lit("delete from `mariatest` where `int_col` = "), Fragment.encode(MariatestId.mariaType, intCol), Fragment.lit("")).update().runUnchecked(c) > 0
  ...
  override fun insert(
    ...
    values.add(Fragment.interpolate(Fragment.encode(MariatestId.mariaType, unsaved.intCol), Fragment.lit("")))
    ...
    values.add(Fragment.interpolate(Fragment.encode(MariaTypes.tinyintUnsigned, unsaved.tinyintUCol), Fragment.lit("")))
    columns.add(Fragment.lit("`smallint_u_col`"))
    values.add(Fragment.interpolate(Fragment.encode(MariaTypes.smallintUnsigned, unsaved.smallintUCol), Fragment.lit("")))
    columns.add(Fragment.lit("`mediumint_u_col`"))
    values.add(Fragment.interpolate(Fragment.encode(MariaTypes.mediumintUnsigned, unsaved.mediumintUCol), Fragment.lit("")))
    columns.add(Fragment.lit("`int_u_col`"))
    values.add(Fragment.interpolate(Fragment.encode(MariaTypes.intUnsigned, unsaved.intUCol), Fragment.lit("")))
    ...
    values.add(Fragment.interpolate(Fragment.encode(XYZSet.mariaType, unsaved.setCol), Fragment.lit("")))
    columns.add(Fragment.lit("`json_col`"))
    values.add(Fragment.interpolate(Fragment.encode(MariaTypes.json, unsaved.jsonCol), Fragment.lit("")))
  ...
  override fun selectByIds(
    ...
    val fragments: ArrayList<Fragment> = ArrayList()
    for (id in intCols) { fragments.add(Fragment.encode(MariatestId.mariaType, id)) }
    return Fragment.interpolate(Fragment.lit("select `tinyint_col`, `smallint_col`, `mediumint_col`, `int_col`, `bigint_col`, `tinyint_u_col`, `smallint_u_col`, `mediumint_u_col`, `int_u_col`, `bigint_u_col`, `decimal_col`, `numeric_col`, `float_col`, `double_col`, `bool_col`, `bit_col`, `bit1_col`, `char_col`, `varchar_col`, `tinytext_col`, `text_col`, `mediumtext_col`, `longtext_col`, `binary_col`, `varbinary_col`, `tinyblob_col`, `blob_col`, `mediumblob_col`, `longblob_col`, `date_col`, `time_col`, `time_fsp_col`, `datetime_col`, `datetime_fsp_col`, `timestamp_col`, `timestamp_fsp_col`, `year_col`, `set_col`, `json_col`, `inet4_col`, `inet6_col` from `mariatest` where `int_col` in ("), Fragment.comma(fragments.toMutableList()), Fragment.lit(")")).query(MariatestRow._rowParser.all()).runUnchecked(c)
  }
