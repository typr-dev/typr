...
object XYZSet {
  ...
  given mariaType: MariaType[XYZSet] = MariaTypes.set.to(Bijection.of((ms: MariaSet) => XYZSet.fromString(ms.toCommaSeparated), (s: XYZSet) => MariaSet.fromString(s.toCommaSeparated)))
