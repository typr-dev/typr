...
class MariatestnullFields(val `_path`: java.util.List[Path]) extends TupleExpr41[Byte, Short, Int, Int, Long, Uint1, Uint2, Uint4, Uint4, Uint8, BigDecimal, BigDecimal, Float, Double, Boolean, Array[Byte], Array[Byte], String, String, String, String, String, String, Array[Byte], Array[Byte], Array[Byte], Array[Byte], Array[Byte], Array[Byte], LocalDate, LocalTime, LocalTime, LocalDateTime, LocalDateTime, LocalDateTime, LocalDateTime, Year, XYZSet, Json, Inet4, Inet6] with RelationStructure[MariatestnullFields, MariatestnullRow]  with FieldsBase[MariatestnullRow] {
  ...
  def tinyintUCol: OptField[Uint1, MariatestnullRow] = {
    new OptField[Uint1, MariatestnullRow](
      _path,
      "tinyint_u_col",
      _.tinyintUCol,
      None,
  ...
  def smallintUCol: OptField[Uint2, MariatestnullRow] = {
    new OptField[Uint2, MariatestnullRow](
      _path,
      "smallint_u_col",
      _.smallintUCol,
      None,
  ...
  def mediumintUCol: OptField[Uint4, MariatestnullRow] = {
    new OptField[Uint4, MariatestnullRow](
      _path,
      "mediumint_u_col",
      _.mediumintUCol,
      None,
  ...
  def intUCol: OptField[Uint4, MariatestnullRow] = {
    new OptField[Uint4, MariatestnullRow](
      _path,
      "int_u_col",
      _.intUCol,
  ...
  def bigintUCol: OptField[Uint8, MariatestnullRow] = {
    new OptField[Uint8, MariatestnullRow](
      _path,
      "bigint_u_col",
      _.bigintUCol,
      None,
  ...
  def setCol: OptField[XYZSet, MariatestnullRow] = {
    new OptField[XYZSet, MariatestnullRow](
      _path,
      "set_col",
      _.setCol,
      None,
  ...
  def jsonCol: OptField[Json, MariatestnullRow] = {
    new OptField[Json, MariatestnullRow](
      _path,
      "json_col",
      _.jsonCol,
      None,
  ...
  override def `_4`: SqlExpr[Int] = intCol
...
object MariatestnullFields {
  val structure: MariatestnullFields = new MariatestnullFields(java.util.Collections.emptyList())
}