...
public record ProductPricesRow(
  ...
  public static RowParser<ProductPricesRow> _rowParser = RowParsers.of(ProductPricesId.pgType, ProductsId.pgType, PriceTiersId.pgType.opt(), MariaTypes.numeric, MariaTypes.char_, MariaTypes.date, MariaTypes.date.opt(), ProductPricesRow::new, row -> new Object[]{row.priceId(), row.productId(), row.tierId(), row.price(), row.currencyCode(), row.validFrom(), row.validTo()});;
