...
public class PromotionsRepoImpl implements PromotionsRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from `promotions` where `promotion_id` = "), Fragment.encode(PromotionsId.pgType, promotionId), Fragment.lit("")).update().runUnchecked(c) > 0;
  };
  ...
  public Integer deleteByIds(
    ...
    for (var id : promotionIds) { fragments.add(Fragment.encode(PromotionsId.pgType, id)); };
  ...
  public PromotionsRow insert(
    ...
    values.add(interpolate(Fragment.encode(MariaTypes.datetime, unsaved.validFrom()), Fragment.lit("")));
    columns.add(Fragment.lit("`valid_to`"));
    values.add(interpolate(Fragment.encode(MariaTypes.datetime, unsaved.validTo()), Fragment.lit("")));
    ...
    Fragment q = interpolate(Fragment.lit("insert into `promotions`("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nRETURNING `promotion_id`, `code`, `name`, `description`, `discount_type`, `discount_value`, `min_order_amount`, `max_uses`, `uses_count`, `max_uses_per_customer`, `applicable_to`, `rules_json`, `valid_from`, `valid_to`, `is_active`, `created_at`\n"));;
  ...
  public List<PromotionsRow> selectAll(Connection c) {
    return interpolate(Fragment.lit("select `promotion_id`, `code`, `name`, `description`, `discount_type`, `discount_value`, `min_order_amount`, `max_uses`, `uses_count`, `max_uses_per_customer`, `applicable_to`, `rules_json`, `valid_from`, `valid_to`, `is_active`, `created_at`\nfrom `promotions`\n")).query(PromotionsRow._rowParser.all()).runUnchecked(c);
  };
  ...
  public UpdateBuilder<PromotionsFields, PromotionsRow> update() {
    return UpdateBuilder.of("`promotions`", PromotionsFields.structure(), PromotionsRow._rowParser, Dialect.MARIADB);
  };
  ...
  public List<PromotionsRow> upsertBatch(
    ...
    return interpolate(Fragment.lit("INSERT INTO `promotions`(`promotion_id`, `code`, `name`, `description`, `discount_type`, `discount_value`, `min_order_amount`, `max_uses`, `uses_count`, `max_uses_per_customer`, `applicable_to`, `rules_json`, `valid_from`, `valid_to`, `is_active`, `created_at`)\nVALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)\nON DUPLICATE KEY UPDATE `code` = VALUES(`code`),\n`name` = VALUES(`name`),\n`description` = VALUES(`description`),\n`discount_type` = VALUES(`discount_type`),\n`discount_value` = VALUES(`discount_value`),\n`min_order_amount` = VALUES(`min_order_amount`),\n`max_uses` = VALUES(`max_uses`),\n`uses_count` = VALUES(`uses_count`),\n`max_uses_per_customer` = VALUES(`max_uses_per_customer`),\n`applicable_to` = VALUES(`applicable_to`),\n`rules_json` = VALUES(`rules_json`),\n`valid_from` = VALUES(`valid_from`),\n`valid_to` = VALUES(`valid_to`),\n`is_active` = VALUES(`is_active`),\n`created_at` = VALUES(`created_at`)\nRETURNING `promotion_id`, `code`, `name`, `description`, `discount_type`, `discount_value`, `min_order_amount`, `max_uses`, `uses_count`, `max_uses_per_customer`, `applicable_to`, `rules_json`, `valid_from`, `valid_to`, `is_active`, `created_at`"))
