...
public class OrderItemsRepoImpl implements OrderItemsRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from `order_items` where `item_id` = "), Fragment.encode(OrderItemsId.pgType, itemId), Fragment.lit("")).update().runUnchecked(c) > 0;
  };
  ...
  public Integer deleteByIds(
    ...
    for (var id : itemIds) { fragments.add(Fragment.encode(OrderItemsId.pgType, id)); };
  ...
  public OrderItemsRow insert(
    ...
    return interpolate(Fragment.lit("insert into `order_items`(`order_id`, `product_id`, `sku`, `product_name`, `quantity`, `unit_price`, `discount_amount`, `tax_amount`, `line_total`, `fulfillment_status`, `warehouse_id`, `notes`)\nvalues ("), Fragment.encode(OrdersId.pgType, unsaved.orderId()), Fragment.lit(", "), Fragment.encode(ProductsId.pgType, unsaved.productId()), Fragment.lit(", "), Fragment.encode(MariaTypes.varchar, unsaved.sku()), Fragment.lit(", "), Fragment.encode(MariaTypes.varchar, unsaved.productName()), Fragment.lit(", "), Fragment.encode(MariaTypes.smallintUnsigned, unsaved.quantity()), Fragment.lit(", "), Fragment.encode(MariaTypes.numeric, unsaved.unitPrice()), Fragment.lit(", "), Fragment.encode(MariaTypes.numeric, unsaved.discountAmount()), Fragment.lit(", "), Fragment.encode(MariaTypes.numeric, unsaved.taxAmount()), Fragment.lit(", "), Fragment.encode(MariaTypes.numeric, unsaved.lineTotal()), Fragment.lit(", "), Fragment.encode(MariaTypes.text, unsaved.fulfillmentStatus()), Fragment.lit(", "), Fragment.encode(WarehousesId.pgType.opt(), unsaved.warehouseId()), Fragment.lit(", "), Fragment.encode(MariaTypes.tinytext.opt(), unsaved.notes()), Fragment.lit(")\nRETURNING `item_id`, `order_id`, `product_id`, `sku`, `product_name`, `quantity`, `unit_price`, `discount_amount`, `tax_amount`, `line_total`, `fulfillment_status`, `warehouse_id`, `notes`\n"))
  ...
  public OrderItemsRow insert(
    ...
    values.add(interpolate(Fragment.encode(MariaTypes.smallintUnsigned, unsaved.quantity()), Fragment.lit("")));
    columns.add(Fragment.lit("`unit_price`"));
    values.add(interpolate(Fragment.encode(MariaTypes.numeric, unsaved.unitPrice()), Fragment.lit("")));
    columns.add(Fragment.lit("`line_total`"));
    values.add(interpolate(Fragment.encode(MariaTypes.numeric, unsaved.lineTotal()), Fragment.lit("")));
    ...
    Fragment q = interpolate(Fragment.lit("insert into `order_items`("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nRETURNING `item_id`, `order_id`, `product_id`, `sku`, `product_name`, `quantity`, `unit_price`, `discount_amount`, `tax_amount`, `line_total`, `fulfillment_status`, `warehouse_id`, `notes`\n"));;
  ...
  public List<OrderItemsRow> selectAll(Connection c) {
    return interpolate(Fragment.lit("select `item_id`, `order_id`, `product_id`, `sku`, `product_name`, `quantity`, `unit_price`, `discount_amount`, `tax_amount`, `line_total`, `fulfillment_status`, `warehouse_id`, `notes`\nfrom `order_items`\n")).query(OrderItemsRow._rowParser.all()).runUnchecked(c);
  };
  ...
  public UpdateBuilder<OrderItemsFields, OrderItemsRow> update() {
    return UpdateBuilder.of("`order_items`", OrderItemsFields.structure(), OrderItemsRow._rowParser, Dialect.MARIADB);
  };
  ...
  public List<OrderItemsRow> upsertBatch(
    ...
    return interpolate(Fragment.lit("INSERT INTO `order_items`(`item_id`, `order_id`, `product_id`, `sku`, `product_name`, `quantity`, `unit_price`, `discount_amount`, `tax_amount`, `line_total`, `fulfillment_status`, `warehouse_id`, `notes`)\nVALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)\nON DUPLICATE KEY UPDATE `order_id` = VALUES(`order_id`),\n`product_id` = VALUES(`product_id`),\n`sku` = VALUES(`sku`),\n`product_name` = VALUES(`product_name`),\n`quantity` = VALUES(`quantity`),\n`unit_price` = VALUES(`unit_price`),\n`discount_amount` = VALUES(`discount_amount`),\n`tax_amount` = VALUES(`tax_amount`),\n`line_total` = VALUES(`line_total`),\n`fulfillment_status` = VALUES(`fulfillment_status`),\n`warehouse_id` = VALUES(`warehouse_id`),\n`notes` = VALUES(`notes`)\nRETURNING `item_id`, `order_id`, `product_id`, `sku`, `product_name`, `quantity`, `unit_price`, `discount_amount`, `tax_amount`, `line_total`, `fulfillment_status`, `warehouse_id`, `notes`"))
