...
public record CustomerStatusRow(
  ...
  public static RowParser<CustomerStatusRow> _rowParser = RowParsers.of(CustomerStatusId.pgType, MariaTypes.varchar, MariaTypes.bool, CustomerStatusRow::new, row -> new Object[]{row.statusCode(), row.description(), row.isActive()});;
