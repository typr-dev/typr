...
public record PriceTiersRow(
  ...
  public static RowParser<PriceTiersRow> _rowParser = RowParsers.of(PriceTiersId.pgType, MariaTypes.varchar, MariaTypes.intUnsigned, MariaTypes.text, MariaTypes.numeric, PriceTiersRow::new, row -> new Object[]{row.tierId(), row.name(), row.minQuantity(), row.discountType(), row.discountValue()});;
