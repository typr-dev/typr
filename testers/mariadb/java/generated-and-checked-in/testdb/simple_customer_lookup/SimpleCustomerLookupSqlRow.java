...
public record SimpleCustomerLookupSqlRow(
  ...
  public static RowParser<SimpleCustomerLookupSqlRow> _rowParser = RowParsers.of(CustomersId.pgType, MariaTypes.varchar, MariaTypes.varchar, MariaTypes.varchar, MariaTypes.text, CustomerStatusId.pgType, MariaTypes.datetime, SimpleCustomerLookupSqlRow::new, row -> new Object[]{row.customerId(), row.email(), row.firstName(), row.lastName(), row.tier(), row.status(), row.createdAt()});;
}