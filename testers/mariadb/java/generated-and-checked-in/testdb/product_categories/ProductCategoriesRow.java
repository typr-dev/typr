...
public record ProductCategoriesRow(
  ...
  public static RowParser<ProductCategoriesRow> _rowParser = RowParsers.of(ProductsId.pgType, CategoriesId.pgType, MariaTypes.bool, MariaTypes.smallint, ProductCategoriesRow::new, row -> new Object[]{row.productId(), row.categoryId(), row.isPrimary(), row.sortOrder()});;
