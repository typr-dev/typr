...
public record ProductCategoriesId(
  ...
  public static RowParser<ProductCategoriesId> _rowParser = RowParsers.of(ProductsId.pgType, CategoriesId.pgType, ProductCategoriesId::new, row -> new Object[]{row.productId(), row.categoryId()});;
}