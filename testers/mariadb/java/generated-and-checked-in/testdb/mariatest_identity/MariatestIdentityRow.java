...
public record MariatestIdentityRow(
  ...
  public static RowParser<MariatestIdentityRow> _rowParser = RowParsers.of(MariatestIdentityId.pgType, MariaTypes.varchar, MariatestIdentityRow::new, row -> new Object[]{row.id(), row.name()});;
