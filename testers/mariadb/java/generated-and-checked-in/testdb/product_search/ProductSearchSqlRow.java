...
) implements Tuple7<ProductsId, String, String, Optional<String>, BigDecimal, String, Optional<String>> {
  /** Points to {@link testdb.products.ProductsRow#productId()} */
