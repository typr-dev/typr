...
public class WarehousesRepoImpl implements WarehousesRepo {
  ...
  public Boolean deleteById(
    ...
    return interpolate(Fragment.lit("delete from `warehouses` where `warehouse_id` = "), Fragment.encode(WarehousesId.pgType, warehouseId), Fragment.lit("")).update().runUnchecked(c) > 0;
  };
  ...
  public Integer deleteByIds(
    ...
    for (var id : warehouseIds) { fragments.add(Fragment.encode(WarehousesId.pgType, id)); };
  ...
  public WarehousesRow insert(
    ...
    values.add(interpolate(Fragment.encode(MariaTypes.varchar, unsaved.address()), Fragment.lit("")));
    columns.add(Fragment.lit("`location`"));
    values.add(interpolate(Fragment.encode(MariaTypes.point, unsaved.location()), Fragment.lit("")));
    ...
    Fragment q = interpolate(Fragment.lit("insert into `warehouses`("), Fragment.comma(columns), Fragment.lit(")\nvalues ("), Fragment.comma(values), Fragment.lit(")\nRETURNING `warehouse_id`, `code`, `name`, `address`, `location`, `service_area`, `timezone`, `is_active`, `contact_email`, `contact_phone`\n"));;
  ...
  public List<WarehousesRow> selectAll(Connection c) {
    return interpolate(Fragment.lit("select `warehouse_id`, `code`, `name`, `address`, `location`, `service_area`, `timezone`, `is_active`, `contact_email`, `contact_phone`\nfrom `warehouses`\n")).query(WarehousesRow._rowParser.all()).runUnchecked(c);
  };
  ...
  public UpdateBuilder<WarehousesFields, WarehousesRow> update() {
    return UpdateBuilder.of("`warehouses`", WarehousesFields.structure(), WarehousesRow._rowParser, Dialect.MARIADB);
  };
  ...
  public List<WarehousesRow> upsertBatch(
    ...
    return interpolate(Fragment.lit("INSERT INTO `warehouses`(`warehouse_id`, `code`, `name`, `address`, `location`, `service_area`, `timezone`, `is_active`, `contact_email`, `contact_phone`)\nVALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)\nON DUPLICATE KEY UPDATE `code` = VALUES(`code`),\n`name` = VALUES(`name`),\n`address` = VALUES(`address`),\n`location` = VALUES(`location`),\n`service_area` = VALUES(`service_area`),\n`timezone` = VALUES(`timezone`),\n`is_active` = VALUES(`is_active`),\n`contact_email` = VALUES(`contact_email`),\n`contact_phone` = VALUES(`contact_phone`)\nRETURNING `warehouse_id`, `code`, `name`, `address`, `location`, `service_area`, `timezone`, `is_active`, `contact_email`, `contact_phone`"))
