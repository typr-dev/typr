...
public record MariatestUniqueRow(
  ...
  public static RowParser<MariatestUniqueRow> _rowParser = RowParsers.of(MariatestUniqueId.pgType, MariaTypes.varchar, MariaTypes.varchar, MariaTypes.varchar, MariatestUniqueRow::new, row -> new Object[]{row.id(), row.email(), row.code(), row.category()});;
