...
class TupleInTest {
    ...
    fun departmentsCompositeIdInCombinedWithOtherConditions(repos: Repos, c: Connection?) {
        val row1 = DepartmentsRow(
            ...
            Optional.of(BigDecimal("2000000")))
        val row2 = DepartmentsRow(
            "DEV", "EU", "Development EU",
            Optional.of(BigDecimal("100000")))
        val row3 = DepartmentsRow(
            "QA", "US", "QA US",
            Optional.of(BigDecimal("500000")))
    ...
    fun tupleInSubqueryBasic(repos: Repos, c: Connection?) {
        val row1 = DepartmentsRow(
            ...
            Optional.of(BigDecimal("10000")))
        val row2 = DepartmentsRow(
            "SMALL2", "REG2", "Small Dept 2",
            Optional.of(BigDecimal("20000")))
        val row3 = DepartmentsRow(
    ...
    fun tupleInSubqueryWithNoMatches(repos: Repos, c: Connection?) {
        val row = DepartmentsRow("TEST1", "REGION1", "Test Dept 1", Optional.of(BigDecimal("50000")))
        repos.departmentsRepo.insert(row, c)
    ...
    fun tupleInSubqueryCombinedWithOtherConditions(repos: Repos, c: Connection?) {
        val row1 = DepartmentsRow("A", "X", "Dept A", Optional.of(BigDecimal("1000")))
        val row2 = DepartmentsRow("B", "X", "Dept B", Optional.of(BigDecimal("2000")))
        val row3 = DepartmentsRow("C", "X", "Dept C", Optional.of(BigDecimal("3000")))
