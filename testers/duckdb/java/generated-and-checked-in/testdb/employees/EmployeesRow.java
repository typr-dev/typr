...
public record EmployeesRow(
  ...
  public static RowCodec<EmployeesRow> rowCodec = RowCodecs.of(DuckDbTypes.integer, DuckDbTypes.varchar, DuckDbTypes.varchar, DuckDbTypes.varchar, DuckDbTypes.varchar, DuckDbTypes.numeric.opt(), DuckDbTypes.date, EmployeesRow::new, row -> new Object[]{row.empNumber(), row.empSuffix(), row.deptCode(), row.deptRegion(), row.empName(), row.salary(), row.hireDate()});
