...
public record DepartmentsId(
  ...
  public static RowCodec<DepartmentsId> rowCodec = RowCodecs.of(DuckDbTypes.varchar, DuckDbTypes.varchar, DepartmentsId::new, row -> new Object[]{row.deptCode(), row.deptRegion()});
