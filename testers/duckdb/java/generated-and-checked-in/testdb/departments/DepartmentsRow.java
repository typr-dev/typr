...
public record DepartmentsRow(
  ...
  public static RowCodec<DepartmentsRow> rowCodec = RowCodecs.of(DuckDbTypes.varchar, DuckDbTypes.varchar, DuckDbTypes.varchar, DuckDbTypes.numeric.opt(), DepartmentsRow::new, row -> new Object[]{row.deptCode(), row.deptRegion(), row.deptName(), row.budget()});
