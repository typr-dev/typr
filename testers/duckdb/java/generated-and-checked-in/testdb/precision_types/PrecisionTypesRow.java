...
public record PrecisionTypesRow(
...
) implements Tuple12<PrecisionTypesId, String, String, String, String, String, Decimal5_2, Decimal10_2, Decimal18_4, Int5, Int10, Int18> {
  ...
  public static RowCodec<PrecisionTypesRow> rowCodec = RowCodecs.of(PrecisionTypesId.duckDbType, DuckDbTypes.varchar, DuckDbTypes.varchar, DuckDbTypes.varchar, DuckDbTypes.varchar, DuckDbTypes.varchar, Decimal5_2.duckDbType, Decimal10_2.duckDbType, Decimal18_4.duckDbType, Int5.duckDbType, Int10.duckDbType, Int18.duckDbType, PrecisionTypesRow::new, row -> new Object[]{row.id(), row.string10(), row.string20(), row.string50(), row.string100(), row.string255(), row.decimal52(), row.decimal102(), row.decimal184(), row.decimal50(), row.decimal100(), row.decimal180()});
