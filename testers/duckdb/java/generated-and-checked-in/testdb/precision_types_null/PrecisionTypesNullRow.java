...
public record PrecisionTypesNullRow(
...
) implements Tuple12<PrecisionTypesNullId, Optional<String>, Optional<String>, Optional<String>, Optional<String>, Optional<String>, Optional<Decimal5_2>, Optional<Decimal10_2>, Optional<Decimal18_4>, Optional<Int5>, Optional<Int10>, Optional<Int18>> {
  ...
  public static RowCodec<PrecisionTypesNullRow> rowCodec = RowCodecs.of(PrecisionTypesNullId.duckDbType, DuckDbTypes.varchar.opt(), DuckDbTypes.varchar.opt(), DuckDbTypes.varchar.opt(), DuckDbTypes.varchar.opt(), DuckDbTypes.varchar.opt(), Decimal5_2.duckDbType.opt(), Decimal10_2.duckDbType.opt(), Decimal18_4.duckDbType.opt(), Int5.duckDbType.opt(), Int10.duckDbType.opt(), Int18.duckDbType.opt(), PrecisionTypesNullRow::new, row -> new Object[]{row.id(), row.string10(), row.string20(), row.string50(), row.string100(), row.string255(), row.decimal52(), row.decimal102(), row.decimal184(), row.decimal50(), row.decimal100(), row.decimal180()});
