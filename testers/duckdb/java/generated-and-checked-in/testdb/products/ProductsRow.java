...
public record ProductsRow(
  ...
  public static RowCodec<ProductsRow> rowCodec = RowCodecs.of(ProductsId.duckDbType, DuckDbTypes.varchar, DuckDbTypes.varchar, DuckDbTypes.numeric, DuckDbTypes.json.opt(), ProductsRow::new, row -> new Object[]{row.productId(), row.sku(), row.name(), row.price(), row.metadata()});
