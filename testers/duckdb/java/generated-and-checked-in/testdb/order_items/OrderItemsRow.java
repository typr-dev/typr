...
public record OrderItemsRow(
  ...
  public static RowCodec<OrderItemsRow> rowCodec = RowCodecs.of(DuckDbTypes.integer, DuckDbTypes.integer, DuckDbTypes.integer, DuckDbTypes.numeric, OrderItemsRow::new, row -> new Object[]{row.orderId(), row.productId(), row.quantity(), row.unitPrice()});
