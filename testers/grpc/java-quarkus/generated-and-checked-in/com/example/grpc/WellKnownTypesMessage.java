...
public record WellKnownTypesMessage(
  ...
  static public WellKnownTypesMessage parseFrom(CodedInputStream input) throws IOException {
    ...
    while (!input.isAtEnd()) {
      ...
      if (WireFormat.getTagFieldNumber(tag) == 1) { var _length = input.readRawVarint32();
      ...
      input.popLimit(_oldLimit);; }
      else if (WireFormat.getTagFieldNumber(tag) == 5) { var _length = input.readRawVarint32();
      var _oldLimit = input.pushLimit(_length);
      input.readTag();
  ...
  static public Marshaller<WellKnownTypesMessage> MARSHALLER =
