...
public record Inventory(
  ...
  static public Inventory parseFrom(CodedInputStream input) throws IOException {
    String warehouseId = "";
    ...
    while (!input.isAtEnd()) {
      ...
      else if (WireFormat.getTagFieldNumber(tag) == 3) { var length = input.readRawVarint32();
  ...
  static public Marshaller<Inventory> MARSHALLER =
  ...
  public Integer getSerializedSize() {
    ...
    for (Entry<String, Integer> entry : this.stockCounts().entrySet()) {
      size = size + CodedOutputStream.computeTagSize(3) + CodedOutputStream.computeUInt32SizeNoTag(CodedOutputStream.computeStringSize(1, entry.getKey()) + CodedOutputStream.computeInt32Size(2, entry.getValue())) + CodedOutputStream.computeStringSize(1, entry.getKey()) + CodedOutputStream.computeInt32Size(2, entry.getValue());
    };
  ...
  public void writeTo(CodedOutputStream output) throws IOException {
    ...
    for (Entry<String, Integer> entry : this.stockCounts().entrySet()) {
      output.writeTag(3, 2);
      output.writeUInt32NoTag(CodedOutputStream.computeStringSize(1, entry.getKey()) + CodedOutputStream.computeInt32Size(2, entry.getValue()));
