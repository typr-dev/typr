...
public record InventoryRowUnsaved(
  ...
  public InventoryRow toRow(
    ...
    return new InventoryRow(
        inventoryIdDefault.get(),
        productId,
        warehouseId,
        quantityOnHand.getOrElse(quantityOnHandDefault),
        quantityReserved.getOrElse(quantityReservedDefault),
        quantityOnOrder.getOrElse(quantityOnOrderDefault),
        reorderPoint.getOrElse(reorderPointDefault),
        reorderQuantity.getOrElse(reorderQuantityDefault),
        binLocation.getOrElse(binLocationDefault),
        lastCountedAt.getOrElse(lastCountedAtDefault),
