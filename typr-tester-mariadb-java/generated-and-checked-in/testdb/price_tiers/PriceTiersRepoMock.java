...
public record PriceTiersRepoMock(
  ...
  public PriceTiersRepoMock(
      java.util.function.Function<PriceTiersRowUnsaved, PriceTiersRow> toRow) {
    this(toRow, new HashMap<PriceTiersId, PriceTiersRow>());
  }
  ;

  public PriceTiersRepoMock withToRow(
      java.util.function.Function<PriceTiersRowUnsaved, PriceTiersRow> toRow) {
  ...
  public Map<PriceTiersId, PriceTiersRow> selectByIdsTracked(PriceTiersId[] tierIds, Connection c) {
    return selectByIds(tierIds, c).stream()
        .collect(Collectors.toMap((PriceTiersRow row) -> row.tierId(), Function.identity()));
  }
  ;
  ...
  public Boolean update(PriceTiersRow row, Connection c) {
    var shouldUpdate =
        Optional.ofNullable(map.get(row.tierId()))
