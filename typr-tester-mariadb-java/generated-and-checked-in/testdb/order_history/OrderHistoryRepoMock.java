...
public record OrderHistoryRepoMock(
  ...
  public OrderHistoryRepoMock(
      java.util.function.Function<OrderHistoryRowUnsaved, OrderHistoryRow> toRow) {
    this(toRow, new HashMap<OrderHistoryId, OrderHistoryRow>());
  }
  ;

  public OrderHistoryRepoMock withToRow(
      java.util.function.Function<OrderHistoryRowUnsaved, OrderHistoryRow> toRow) {
  ...
  public SelectBuilder<OrderHistoryFields, OrderHistoryRow> select() {
    return new SelectBuilderMock<>(
        OrderHistoryFields.structure(), () -> new ArrayList<>(map.values()), SelectParams.empty());
  }
  ;
  ...
  public Map<OrderHistoryId, OrderHistoryRow> selectByIdsTracked(
    ...
    return selectByIds(historyIds, c).stream()
        .collect(Collectors.toMap((OrderHistoryRow row) -> row.historyId(), Function.identity()));
  }
  ;
  ...
  public Boolean update(OrderHistoryRow row, Connection c) {
    var shouldUpdate =
        Optional.ofNullable(map.get(row.historyId()))
