...
public record ProductPricesRepoMock(
  ...
  public ProductPricesRepoMock(
      java.util.function.Function<ProductPricesRowUnsaved, ProductPricesRow> toRow) {
    this(toRow, new HashMap<ProductPricesId, ProductPricesRow>());
  }
  ;

  public ProductPricesRepoMock withToRow(
      java.util.function.Function<ProductPricesRowUnsaved, ProductPricesRow> toRow) {
  ...
  public Map<ProductPricesId, ProductPricesRow> selectByIdsTracked(
    ...
    return selectByIds(priceIds, c).stream()
        .collect(Collectors.toMap((ProductPricesRow row) -> row.priceId(), Function.identity()));
  }
  ;
  ...
  public Boolean update(ProductPricesRow row, Connection c) {
    var shouldUpdate =
        Optional.ofNullable(map.get(row.priceId()))
