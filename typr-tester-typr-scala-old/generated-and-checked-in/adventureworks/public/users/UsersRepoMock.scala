...
case class UsersRepoMock(
  ...
  override def delete: DeleteBuilder[UsersFields, UsersRow] = DeleteBuilderMock(UsersFields.structure, () => new ArrayList(map.values()), DeleteParams.empty(), row => row.userId, id => map.remove(id): @scala.annotation.nowarn)
