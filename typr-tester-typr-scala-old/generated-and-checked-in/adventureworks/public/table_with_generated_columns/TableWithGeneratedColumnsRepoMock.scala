...
case class TableWithGeneratedColumnsRepoMock(
  ...
  override def delete: DeleteBuilder[TableWithGeneratedColumnsFields, TableWithGeneratedColumnsRow] = DeleteBuilderMock(TableWithGeneratedColumnsFields.structure, () => new ArrayList(map.values()), DeleteParams.empty(), row => row.name, id => map.remove(id): @scala.annotation.nowarn)
  ...
  override def select: SelectBuilder[TableWithGeneratedColumnsFields, TableWithGeneratedColumnsRow] = SelectBuilderMock(TableWithGeneratedColumnsFields.structure, () => new ArrayList(map.values()), SelectParams.empty())
  ...
  override def update: UpdateBuilder[TableWithGeneratedColumnsFields, TableWithGeneratedColumnsRow] = UpdateBuilderMock(TableWithGeneratedColumnsFields.structure, () => new ArrayList(map.values()), UpdateParams.empty(), row => row)
