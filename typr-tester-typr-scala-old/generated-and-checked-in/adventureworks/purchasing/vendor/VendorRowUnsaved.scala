...
case class VendorRowUnsaved(
  ...
  /** Vendor URL. */
  purchasingwebserviceurl: Optional[/* max 1024 chars */ String] = Optional.empty(),
  /** Default: true
