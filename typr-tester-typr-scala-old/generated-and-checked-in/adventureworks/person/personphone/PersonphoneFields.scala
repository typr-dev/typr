...
trait PersonphoneFields extends FieldsExpr0[PersonphoneRow] {
  ...
  def compositeIdIn(compositeIds: java.util.List[PersonphoneId]): SqlExpr[java.lang.Boolean] = CompositeIn(java.util.List.of(CompositeIn.Part[BusinessentityId, PersonphoneId, PersonphoneRow](businessentityid, _.businessentityid, BusinessentityId.pgType), CompositeIn.Part[Phone, PersonphoneId, PersonphoneRow](phonenumber, _.phonenumber, Phone.pgType), CompositeIn.Part[PhonenumbertypeId, PersonphoneId, PersonphoneRow](phonenumbertypeid, _.phonenumbertypeid, PhonenumbertypeId.pgType)), compositeIds)
