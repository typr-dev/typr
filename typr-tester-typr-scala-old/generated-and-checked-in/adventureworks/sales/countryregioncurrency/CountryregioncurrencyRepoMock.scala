...
case class CountryregioncurrencyRepoMock(
  ...
  override def delete: DeleteBuilder[CountryregioncurrencyFields, CountryregioncurrencyRow] = DeleteBuilderMock(CountryregioncurrencyFields.structure, () => new ArrayList(map.values()), DeleteParams.empty(), row => row.compositeId, id => map.remove(id): @scala.annotation.nowarn)
  ...
  override def select: SelectBuilder[CountryregioncurrencyFields, CountryregioncurrencyRow] = SelectBuilderMock(CountryregioncurrencyFields.structure, () => new ArrayList(map.values()), SelectParams.empty())
  ...
  override def update: UpdateBuilder[CountryregioncurrencyFields, CountryregioncurrencyRow] = UpdateBuilderMock(CountryregioncurrencyFields.structure, () => new ArrayList(map.values()), UpdateParams.empty(), row => row)
