...
case class SalesterritoryRowUnsaved(
  ...
  def toRow(
    ...
    salesytdDefault: => java.math.BigDecimal,
    saleslastyearDefault: => java.math.BigDecimal,
    costytdDefault: => java.math.BigDecimal,
    costlastyearDefault: => java.math.BigDecimal,
    rowguidDefault: => UUID,
