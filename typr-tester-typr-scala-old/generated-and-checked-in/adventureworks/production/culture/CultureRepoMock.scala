...
case class CultureRepoMock(
  ...
  override def delete: DeleteBuilder[CultureFields, CultureRow] = DeleteBuilderMock(CultureFields.structure, () => new ArrayList(map.values()), DeleteParams.empty(), row => row.cultureid, id => map.remove(id): @scala.annotation.nowarn)
  ...
  override def select: SelectBuilder[CultureFields, CultureRow] = SelectBuilderMock(CultureFields.structure, () => new ArrayList(map.values()), SelectParams.empty())
  ...
  override def update: UpdateBuilder[CultureFields, CultureRow] = UpdateBuilderMock(CultureFields.structure, () => new ArrayList(map.values()), UpdateParams.empty(), row => row)
