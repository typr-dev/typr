...
case class ProductinventoryRepoMock(
  ...
  override def delete: DeleteBuilder[ProductinventoryFields, ProductinventoryRow] = DeleteBuilderMock(ProductinventoryFields.structure, () => new ArrayList(map.values()), DeleteParams.empty(), row => row.compositeId, id => map.remove(id): @scala.annotation.nowarn)
  ...
  override def select: SelectBuilder[ProductinventoryFields, ProductinventoryRow] = SelectBuilderMock(ProductinventoryFields.structure, () => new ArrayList(map.values()), SelectParams.empty())
  ...
  override def update: UpdateBuilder[ProductinventoryFields, ProductinventoryRow] = UpdateBuilderMock(ProductinventoryFields.structure, () => new ArrayList(map.values()), UpdateParams.empty(), row => row)
