...
case class ScrapreasonRepoMock(
  ...
  override def delete: DeleteBuilder[ScrapreasonFields, ScrapreasonRow] = DeleteBuilderMock(ScrapreasonFields.structure, () => new ArrayList(map.values()), DeleteParams.empty(), row => row.scrapreasonid, id => map.remove(id): @scala.annotation.nowarn)
  ...
  override def select: SelectBuilder[ScrapreasonFields, ScrapreasonRow] = SelectBuilderMock(ScrapreasonFields.structure, () => new ArrayList(map.values()), SelectParams.empty())
  ...
  override def update: UpdateBuilder[ScrapreasonFields, ScrapreasonRow] = UpdateBuilderMock(ScrapreasonFields.structure, () => new ArrayList(map.values()), UpdateParams.empty(), row => row)
