...
case class TransactionhistoryRepoMock(
  ...
  override def delete: DeleteBuilder[TransactionhistoryFields, TransactionhistoryRow] = DeleteBuilderMock(TransactionhistoryFields.structure, () => new ArrayList(map.values()), DeleteParams.empty(), row => row.transactionid, id => map.remove(id): @scala.annotation.nowarn)
  ...
  override def select: SelectBuilder[TransactionhistoryFields, TransactionhistoryRow] = SelectBuilderMock(TransactionhistoryFields.structure, () => new ArrayList(map.values()), SelectParams.empty())
  ...
  override def update: UpdateBuilder[TransactionhistoryFields, TransactionhistoryRow] = UpdateBuilderMock(TransactionhistoryFields.structure, () => new ArrayList(map.values()), UpdateParams.empty(), row => row)
