...
case class DocumentRepoMock(
  ...
  override def delete: DeleteBuilder[DocumentFields, DocumentRow] = DeleteBuilderMock(DocumentFields.structure, () => new ArrayList(map.values()), DeleteParams.empty(), row => row.documentnode, id => map.remove(id): @scala.annotation.nowarn)
  ...
  override def select: SelectBuilder[DocumentFields, DocumentRow] = SelectBuilderMock(DocumentFields.structure, () => new ArrayList(map.values()), SelectParams.empty())
  ...
  override def selectByUniqueRowguid(rowguid: UUID)(using c: Connection): Optional[DocumentRow] = new ArrayList(map.values()).stream().filter(v => (rowguid == v.rowguid)).findFirst()

  override def update: UpdateBuilder[DocumentFields, DocumentRow] = UpdateBuilderMock(DocumentFields.structure, () => new ArrayList(map.values()), UpdateParams.empty(), row => row)
