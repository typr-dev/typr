...
case class WorkorderroutingRepoMock(
  ...
  override def delete: DeleteBuilder[WorkorderroutingFields, WorkorderroutingRow] = DeleteBuilderMock(WorkorderroutingFields.structure, () => new ArrayList(map.values()), DeleteParams.empty(), row => row.compositeId, id => map.remove(id): @scala.annotation.nowarn)
  ...
  override def select: SelectBuilder[WorkorderroutingFields, WorkorderroutingRow] = SelectBuilderMock(WorkorderroutingFields.structure, () => new ArrayList(map.values()), SelectParams.empty())
  ...
  override def update: UpdateBuilder[WorkorderroutingFields, WorkorderroutingRow] = UpdateBuilderMock(WorkorderroutingFields.structure, () => new ArrayList(map.values()), UpdateParams.empty(), row => row)
