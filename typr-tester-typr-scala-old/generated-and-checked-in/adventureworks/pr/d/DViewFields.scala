...
trait DViewFields extends FieldsExpr0[DViewRow] {
  ...
  def status: Field[java.lang.Short, DViewRow]

  def documentsummary: Field[String, DViewRow]

  def document: Field[Array[scala.Byte], DViewRow]
...
object DViewFields {
  case class Impl(val `_path`: java.util.List[Path]) extends DViewFields with RelationStructure[DViewFields, DViewRow] {
    ...
    override def status: Field[java.lang.Short, DViewRow] = {
      new Field[java.lang.Short, DViewRow](
        _path,
        "status",
        _.status,
        Optional.empty(),
    ...
    override def document: Field[Array[scala.Byte], DViewRow] = {
      new Field[Array[scala.Byte], DViewRow](
        _path,
        "document",
        _.document,
        Optional.empty(),
