...
/**
 * Unit tests for the OpenAPI generated Spring server code.
 *
 ...
 *
 * Note: Full HTTP integration tests are not included because Spring doesn't
 * automatically inherit @RequestMapping annotations from interfaces to implementing classes.
 * The primary goal is to verify the code generation produces correct, type-safe code.
 */
