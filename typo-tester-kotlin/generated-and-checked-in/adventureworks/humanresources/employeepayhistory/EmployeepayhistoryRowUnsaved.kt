...
data class EmployeepayhistoryRowUnsaved(
  ...
  constructor(businessentityid: BusinessentityId, ratechangedate: TypoLocalDateTime, rate: BigDecimal, payfrequency: TypoShort) : this(businessentityid, ratechangedate, rate, payfrequency, UseDefault())
