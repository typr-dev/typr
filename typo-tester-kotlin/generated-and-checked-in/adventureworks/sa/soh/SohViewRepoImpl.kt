...
data class SohViewRepoImpl() : SohViewRepo {
  fun selectAll(c: Connection): List<SohViewRow> = interpolate(typo.runtime.Fragment.lit("""
    ...
    from "sa"."soh"
  """.trimMargin())).as(SohViewRow._rowParser.all()).runUnchecked(c)
}