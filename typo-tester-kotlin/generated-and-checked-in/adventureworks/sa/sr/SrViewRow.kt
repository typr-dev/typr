...
data class SrViewRow(
  ...
  companion object {
    val _rowParser: RowParser<SrViewRow> = RowParsers.of(SalesreasonId.pgType, SalesreasonId.pgType, Name.pgType, Name.pgType, TypoLocalDateTime.pgType, ::SrViewRow, { row -> Tuple5(row.id, row.salesreasonid, row.name, row.reasontype, row.modifieddate) })
  }
}