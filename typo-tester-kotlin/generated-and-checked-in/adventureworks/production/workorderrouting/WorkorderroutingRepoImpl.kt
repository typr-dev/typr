...
data class WorkorderroutingRepoImpl() : WorkorderroutingRepo {
  fun deleteById(
  ...
  fun deleteByIds(
    ...
    val workorderid: Array<WorkorderId> = arrayMap.map(compositeIds, WorkorderroutingId::workorderid, WorkorderId::class.java)
      val productid: Array<Int> = arrayMap.map(compositeIds, WorkorderroutingId::productid, Int::class.java)
  ...
  fun selectAll(c: Connection): kotlin.collections.List<WorkorderroutingRow> = interpolate(typo.runtime.Fragment.lit("""
    ...
    from "production"."workorderrouting"
  """.trimMargin())).as(WorkorderroutingRow._rowParser.all()).runUnchecked(c)
  ...
  fun selectById(
    ...
    TypoShort.pgType.encode(compositeId.operationsequence),
    typo.runtime.Fragment.lit("")
  ).as(WorkorderroutingRow._rowParser.first()).runUnchecked(c)

  fun selectByIds(
    compositeIds: Array<WorkorderroutingId>,
    c: Connection
  ): kotlin.collections.List<WorkorderroutingRow> {
    val workorderid: Array<WorkorderId> = arrayMap.map(compositeIds, WorkorderroutingId::workorderid, WorkorderId::class.java)
      val productid: Array<Int> = arrayMap.map(compositeIds, WorkorderroutingId::productid, Int::class.java)
      val operationsequence: Array<TypoShort> = arrayMap.map(compositeIds, WorkorderroutingId::operationsequence, TypoShort::class.java)
    return interpolate(
  ...
  fun selectByIdsTracked(
    ...
    val ret: java.util.Map<WorkorderroutingId, WorkorderroutingRow> = HashMap()
  ...
  fun upsertBatch(
    unsaved: Iterator<WorkorderroutingRow>,
    c: Connection
  ): kotlin.collections.List<WorkorderroutingRow> = interpolate(typo.runtime.Fragment.lit("""
                                                      insert into "production"."workorderrouting"("workorderid", "productid", "operationsequence", "locationid", "scheduledstartdate", "scheduledenddate", "actualstartdate", "actualenddate", "actualresourcehrs", "plannedcost", "actualcost", "modifieddate")
