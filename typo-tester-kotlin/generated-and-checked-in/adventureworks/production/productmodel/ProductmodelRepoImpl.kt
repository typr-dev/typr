...
data class ProductmodelRepoImpl() : ProductmodelRepo {
  fun deleteById(
  ...
  fun selectAll(c: Connection): kotlin.collections.List<ProductmodelRow> = interpolate(typo.runtime.Fragment.lit("""
    select "productmodelid", "name", "catalogdescription", "instructions", "rowguid", "modifieddate"::text
    from "production"."productmodel"
  """.trimMargin())).as(ProductmodelRow._rowParser.all()).runUnchecked(c)
  ...
  fun selectById(
    ...
    ProductmodelId.pgType.encode(productmodelid),
    typo.runtime.Fragment.lit("")
  ).as(ProductmodelRow._rowParser.first()).runUnchecked(c)

  fun selectByIds(
    productmodelids: Array<ProductmodelId>,
    c: Connection
  ): kotlin.collections.List<ProductmodelRow> = interpolate(
    typo.runtime.Fragment.lit("""
      select "productmodelid", "name", "catalogdescription", "instructions", "rowguid", "modifieddate"::text
      from "production"."productmodel"
      where "productmodelid" = ANY(""".trimMargin()),
    ProductmodelId.pgTypeArray.encode(productmodelids),
    typo.runtime.Fragment.lit(")")
  ).as(ProductmodelRow._rowParser.all()).runUnchecked(c)

  fun selectByIdsTracked(
    productmodelids: Array<ProductmodelId>,
    c: Connection
  ): Map<ProductmodelId, ProductmodelRow> {
    val ret: java.util.Map<ProductmodelId, ProductmodelRow> = HashMap()
      for (var row : selectByIds(productmodelids, c)) {
          ret.put(row.id(), row);
      }
    return ret
  }
  ...
  fun upsertBatch(
    unsaved: Iterator<ProductmodelRow>,
    c: Connection
  ): kotlin.collections.List<ProductmodelRow> = interpolate(typo.runtime.Fragment.lit("""
                                                  insert into "production"."productmodel"("productmodelid", "name", "catalogdescription", "instructions", "rowguid", "modifieddate")
