...
data class ProductdocumentRow(
  ...
  companion object {
    val _rowParser: RowParser<ProductdocumentRow> = RowParsers.of(ProductId.pgType, TypoLocalDateTime.pgType, DocumentId.pgType, ::ProductdocumentRow, { row -> Tuple3(row.productid, row.modifieddate, row.documentnode) })
