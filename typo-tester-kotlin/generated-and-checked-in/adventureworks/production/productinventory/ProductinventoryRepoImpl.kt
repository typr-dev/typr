...
data class ProductinventoryRepoImpl() : ProductinventoryRepo {
  fun deleteById(
  ...
  fun selectAll(c: Connection): kotlin.collections.List<ProductinventoryRow> = interpolate(typo.runtime.Fragment.lit("""
    select "productid", "locationid", "shelf", "bin", "quantity", "rowguid", "modifieddate"::text
    from "production"."productinventory"
  """.trimMargin())).as(ProductinventoryRow._rowParser.all()).runUnchecked(c)
  ...
  fun selectById(
    ...
    LocationId.pgType.encode(compositeId.locationid),
    typo.runtime.Fragment.lit("")
  ).as(ProductinventoryRow._rowParser.first()).runUnchecked(c)

  fun selectByIds(
    compositeIds: Array<ProductinventoryId>,
    c: Connection
  ): kotlin.collections.List<ProductinventoryRow> {
    val productid: Array<ProductId> = arrayMap.map(compositeIds, ProductinventoryId::productid, ProductId::class.java)
      val locationid: Array<LocationId> = arrayMap.map(compositeIds, ProductinventoryId::locationid, LocationId::class.java)
    return interpolate(
             typo.runtime.Fragment.lit("""
  ...
  fun selectByIdsTracked(
    ...
    val ret: java.util.Map<ProductinventoryId, ProductinventoryRow> = HashMap()
  ...
  fun upsertBatch(
    unsaved: Iterator<ProductinventoryRow>,
    c: Connection
  ): kotlin.collections.List<ProductinventoryRow> = interpolate(typo.runtime.Fragment.lit("""
                                                      insert into "production"."productinventory"("productid", "locationid", "shelf", "bin", "quantity", "rowguid", "modifieddate")
