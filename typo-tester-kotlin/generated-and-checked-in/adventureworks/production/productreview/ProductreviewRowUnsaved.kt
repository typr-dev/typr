...
data class ProductreviewRowUnsaved(
  ...
  /** Default: nextval('production.productreview_productreviewid_seq'::regclass)
    ...
    */
  val productreviewid: Defaulted<ProductreviewId>,
  /** Default: now()
    * Date review was submitted.
    */
  val reviewdate: Defaulted<TypoLocalDateTime>,
  /** Default: now() */
  val modifieddate: Defaulted<TypoLocalDateTime>
) {
  constructor(productid: ProductId, reviewername: Name, emailaddress: /* max 50 chars */ java.lang.String, rating: Int) : this(productid, reviewername, emailaddress, rating, null, UseDefault(), UseDefault(), UseDefault())
