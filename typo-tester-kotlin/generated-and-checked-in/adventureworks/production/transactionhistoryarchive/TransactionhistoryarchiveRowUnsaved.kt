...
data class TransactionhistoryarchiveRowUnsaved(
  ...
  constructor(transactionid: TransactionhistoryarchiveId, productid: Int, referenceorderid: Int, transactiontype: /* bpchar, max 1 chars */ java.lang.String, quantity: Int, actualcost: BigDecimal) : this(transactionid, productid, referenceorderid, transactiontype, quantity, actualcost, UseDefault(), UseDefault(), UseDefault())
