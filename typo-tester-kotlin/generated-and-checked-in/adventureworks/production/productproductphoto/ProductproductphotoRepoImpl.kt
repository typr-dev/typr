...
data class ProductproductphotoRepoImpl() : ProductproductphotoRepo {
  fun deleteById(
  ...
  fun selectAll(c: Connection): kotlin.collections.List<ProductproductphotoRow> = interpolate(typo.runtime.Fragment.lit("""
    select "productid", "productphotoid", "primary", "modifieddate"::text
    from "production"."productproductphoto"
  """.trimMargin())).as(ProductproductphotoRow._rowParser.all()).runUnchecked(c)
  ...
  fun selectById(
    ...
    ProductphotoId.pgType.encode(compositeId.productphotoid),
    typo.runtime.Fragment.lit("")
  ).as(ProductproductphotoRow._rowParser.first()).runUnchecked(c)

  fun selectByIds(
    compositeIds: Array<ProductproductphotoId>,
    c: Connection
  ): kotlin.collections.List<ProductproductphotoRow> {
    val productid: Array<ProductId> = arrayMap.map(compositeIds, ProductproductphotoId::productid, ProductId::class.java)
      val productphotoid: Array<ProductphotoId> = arrayMap.map(compositeIds, ProductproductphotoId::productphotoid, ProductphotoId::class.java)
    return interpolate(
             typo.runtime.Fragment.lit("""
  ...
  fun selectByIdsTracked(
    ...
    val ret: java.util.Map<ProductproductphotoId, ProductproductphotoRow> = HashMap()
  ...
  fun upsertBatch(
    unsaved: Iterator<ProductproductphotoRow>,
    c: Connection
  ): kotlin.collections.List<ProductproductphotoRow> = interpolate(typo.runtime.Fragment.lit("""
                                                         insert into "production"."productproductphoto"("productid", "productphotoid", "primary", "modifieddate")
