...
data class ProductmodelproductdescriptioncultureRow(
  ...
  companion object {
    val _rowParser: RowParser<ProductmodelproductdescriptioncultureRow> = RowParsers.of(ProductmodelId.pgType, ProductdescriptionId.pgType, CultureId.pgType, TypoLocalDateTime.pgType, ::ProductmodelproductdescriptioncultureRow, { row -> Tuple4(row.productmodelid, row.productdescriptionid, row.cultureid, row.modifieddate) })
