...
data class WorkorderRepoImpl() : WorkorderRepo {
  fun deleteById(
  ...
  fun selectAll(c: Connection): kotlin.collections.List<WorkorderRow> = interpolate(typo.runtime.Fragment.lit("""
    ...
    from "production"."workorder"
  """.trimMargin())).as(WorkorderRow._rowParser.all()).runUnchecked(c)
  ...
  fun selectById(
    ...
    WorkorderId.pgType.encode(workorderid),
    typo.runtime.Fragment.lit("")
  ).as(WorkorderRow._rowParser.first()).runUnchecked(c)

  fun selectByIds(
    workorderids: Array<WorkorderId>,
    c: Connection
  ): kotlin.collections.List<WorkorderRow> = interpolate(
    typo.runtime.Fragment.lit("""
      select "workorderid", "productid", "orderqty", "scrappedqty", "startdate"::text, "enddate"::text, "duedate"::text, "scrapreasonid", "modifieddate"::text
      from "production"."workorder"
      where "workorderid" = ANY(""".trimMargin()),
  ...
  fun selectByIdsTracked(
    ...
    val ret: java.util.Map<WorkorderId, WorkorderRow> = HashMap()
      for (var row : selectByIds(workorderids, c)) {
          ret.put(row.id(), row);
      }
    return ret
  }
  ...
  fun upsertBatch(
    unsaved: Iterator<WorkorderRow>,
    c: Connection
  ): kotlin.collections.List<WorkorderRow> = interpolate(typo.runtime.Fragment.lit("""
                                               insert into "production"."workorder"("workorderid", "productid", "orderqty", "scrappedqty", "startdate", "enddate", "duedate", "scrapreasonid", "modifieddate")
