...
data class ScrapreasonRow(
  ...
  companion object {
    val _rowParser: RowParser<ScrapreasonRow> = RowParsers.of(ScrapreasonId.pgType, Name.pgType, TypoLocalDateTime.pgType, ::ScrapreasonRow, { row -> Tuple3(row.scrapreasonid, row.name, row.modifieddate) })
