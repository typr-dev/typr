...
data class DocumentRowUnsaved(
  ...
  /** Default: false
    ...
    */
  val folderflag: Defaulted<Flag>,
  /** Default: 0
    * Engineering change approval number.
    */
  val changenumber: Defaulted<Int>,
  ...
  constructor(title: /* max 50 chars */ java.lang.String, owner: BusinessentityId, filename: /* max 400 chars */ java.lang.String, revision: /* bpchar, max 5 chars */ java.lang.String, status: TypoShort) : this(title, owner, filename, null, revision, status, null, null, UseDefault(), UseDefault(), UseDefault(), UseDefault(), UseDefault())
