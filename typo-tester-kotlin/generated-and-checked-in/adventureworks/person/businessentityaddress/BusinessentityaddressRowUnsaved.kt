...
data class BusinessentityaddressRowUnsaved(
  ...
  constructor(businessentityid: BusinessentityId, addressid: AddressId, addresstypeid: AddresstypeId) : this(businessentityid, addressid, addresstypeid, UseDefault(), UseDefault())
