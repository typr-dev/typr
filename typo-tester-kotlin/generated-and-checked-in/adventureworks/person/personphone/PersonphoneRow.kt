...
data class PersonphoneRow(
  ...
  companion object {
    val _rowParser: RowParser<PersonphoneRow> = RowParsers.of(BusinessentityId.pgType, Phone.pgType, PhonenumbertypeId.pgType, TypoLocalDateTime.pgType, ::PersonphoneRow, { row -> Tuple4(row.businessentityid, row.phonenumber, row.phonenumbertypeid, row.modifieddate) })
