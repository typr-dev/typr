...
data class ContacttypeRepoImpl() : ContacttypeRepo {
  fun deleteById(
  ...
  fun selectAll(c: Connection): kotlin.collections.List<ContacttypeRow> = interpolate(typo.runtime.Fragment.lit("""
    select "contacttypeid", "name", "modifieddate"::text
    from "person"."contacttype"
  """.trimMargin())).as(ContacttypeRow._rowParser.all()).runUnchecked(c)
  ...
  fun selectByIds(
    contacttypeids: Array<ContacttypeId>,
    c: Connection
  ): kotlin.collections.List<ContacttypeRow> = interpolate(
    typo.runtime.Fragment.lit("""
      select "contacttypeid", "name", "modifieddate"::text
      from "person"."contacttype"
      where "contacttypeid" = ANY(""".trimMargin()),
  ...
  fun selectByIdsTracked(
    ...
    val ret: java.util.Map<ContacttypeId, ContacttypeRow> = HashMap()
      for (var row : selectByIds(contacttypeids, c)) {
          ret.put(row.id(), row);
      }
    return ret
  }
  ...
  fun upsertBatch(
    unsaved: Iterator<ContacttypeRow>,
    c: Connection
  ): kotlin.collections.List<ContacttypeRow> = interpolate(typo.runtime.Fragment.lit("""
                                                 insert into "person"."contacttype"("contacttypeid", "name", "modifieddate")
