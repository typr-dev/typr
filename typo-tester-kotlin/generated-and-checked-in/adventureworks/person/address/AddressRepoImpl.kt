...
data class AddressRepoImpl() : AddressRepo {
  fun deleteById(
    addressid: AddressId,
    c: Connection
  ): Boolean = interpolate(
  ...
  fun selectAll(c: Connection): kotlin.collections.List<AddressRow> = interpolate(typo.runtime.Fragment.lit("""
    select "addressid", "addressline1", "addressline2", "city", "stateprovinceid", "postalcode", "spatiallocation", "rowguid", "modifieddate"::text
    from "person"."address"
  """.trimMargin())).as(AddressRow._rowParser.all()).runUnchecked(c)
  ...
  fun selectByIds(
    addressids: Array<AddressId>,
    c: Connection
  ): kotlin.collections.List<AddressRow> = interpolate(
    typo.runtime.Fragment.lit("""
      select "addressid", "addressline1", "addressline2", "city", "stateprovinceid", "postalcode", "spatiallocation", "rowguid", "modifieddate"::text
      from "person"."address"
      where "addressid" = ANY(""".trimMargin()),
  ...
  fun selectByIdsTracked(
    ...
    val ret: java.util.Map<AddressId, AddressRow> = HashMap()
      for (var row : selectByIds(addressids, c)) {
          ret.put(row.id(), row);
      }
    return ret
  }
  ...
  fun upsertBatch(
    unsaved: Iterator<AddressRow>,
    c: Connection
  ): kotlin.collections.List<AddressRow> = interpolate(typo.runtime.Fragment.lit("""
                                             insert into "person"."address"("addressid", "addressline1", "addressline2", "city", "stateprovinceid", "postalcode", "spatiallocation", "rowguid", "modifieddate")
