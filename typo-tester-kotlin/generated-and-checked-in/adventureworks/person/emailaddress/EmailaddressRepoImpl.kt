...
data class EmailaddressRepoImpl() : EmailaddressRepo {
  fun deleteById(
  ...
  fun deleteByIds(
    ...
    val businessentityid: Array<BusinessentityId> = arrayMap.map(compositeIds, EmailaddressId::businessentityid, BusinessentityId::class.java)
      val emailaddressid: Array<Int> = arrayMap.map(compositeIds, EmailaddressId::emailaddressid, Int::class.java)
    return interpolate(
             typo.runtime.Fragment.lit("""
               delete
  ...
  fun selectAll(c: Connection): kotlin.collections.List<EmailaddressRow> = interpolate(typo.runtime.Fragment.lit("""
    select "businessentityid", "emailaddressid", "emailaddress", "rowguid", "modifieddate"::text
    from "person"."emailaddress"
  """.trimMargin())).as(EmailaddressRow._rowParser.all()).runUnchecked(c)
  ...
  fun selectByIds(
    compositeIds: Array<EmailaddressId>,
    c: Connection
  ): kotlin.collections.List<EmailaddressRow> {
    val businessentityid: Array<BusinessentityId> = arrayMap.map(compositeIds, EmailaddressId::businessentityid, BusinessentityId::class.java)
      val emailaddressid: Array<Int> = arrayMap.map(compositeIds, EmailaddressId::emailaddressid, Int::class.java)
    return interpolate(
             typo.runtime.Fragment.lit("""
  ...
  fun selectByIdsTracked(
    ...
    val ret: java.util.Map<EmailaddressId, EmailaddressRow> = HashMap()
  ...
  fun upsertBatch(
    unsaved: Iterator<EmailaddressRow>,
    c: Connection
  ): kotlin.collections.List<EmailaddressRow> = interpolate(typo.runtime.Fragment.lit("""
                                                  insert into "person"."emailaddress"("businessentityid", "emailaddressid", "emailaddress", "rowguid", "modifieddate")
