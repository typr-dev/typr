...
data class PersonRepoImpl() : PersonRepo {
  fun deleteById(
  ...
  fun selectAll(c: Connection): kotlin.collections.List<PersonRow> = interpolate(typo.runtime.Fragment.lit("""
    ...
    from "person"."person"
  """.trimMargin())).as(PersonRow._rowParser.all()).runUnchecked(c)
  ...
  fun selectByIds(
    businessentityids: Array<BusinessentityId>,
    c: Connection
  ): kotlin.collections.List<PersonRow> = interpolate(
    typo.runtime.Fragment.lit("""
      select "businessentityid", "persontype", "namestyle", "title", "firstname", "middlename", "lastname", "suffix", "emailpromotion", "additionalcontactinfo", "demographics", "rowguid", "modifieddate"::text
      from "person"."person"
      where "businessentityid" = ANY(""".trimMargin()),
  ...
  fun selectByIdsTracked(
    ...
    val ret: java.util.Map<BusinessentityId, PersonRow> = HashMap()
  ...
  fun upsertBatch(
    unsaved: Iterator<PersonRow>,
    c: Connection
  ): kotlin.collections.List<PersonRow> = interpolate(typo.runtime.Fragment.lit("""
                                            insert into "person"."person"("businessentityid", "persontype", "namestyle", "title", "firstname", "middlename", "lastname", "suffix", "emailpromotion", "additionalcontactinfo", "demographics", "rowguid", "modifieddate")
