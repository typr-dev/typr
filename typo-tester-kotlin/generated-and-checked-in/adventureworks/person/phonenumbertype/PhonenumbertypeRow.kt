...
data class PhonenumbertypeRow(
  ...
  companion object {
    val _rowParser: RowParser<PhonenumbertypeRow> = RowParsers.of(PhonenumbertypeId.pgType, Name.pgType, TypoLocalDateTime.pgType, ::PhonenumbertypeRow, { row -> Tuple3(row.phonenumbertypeid, row.name, row.modifieddate) })
