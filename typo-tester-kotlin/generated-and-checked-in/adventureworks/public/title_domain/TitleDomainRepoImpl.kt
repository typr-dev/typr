...
data class TitleDomainRepoImpl() : TitleDomainRepo {
  fun deleteById(
    code: TitleDomainId,
    c: Connection
  ): Boolean = interpolate(
  ...
  fun selectAll(c: Connection): List<TitleDomainRow> = interpolate(typo.runtime.Fragment.lit("""
    select "code"
    from "public"."title_domain"
  """.trimMargin())).as(TitleDomainRow._rowParser.all()).runUnchecked(c)
  ...
  fun selectByIdsTracked(
    ...
    val ret: java.util.Map<TitleDomainId, TitleDomainRow> = HashMap()
