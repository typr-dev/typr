...
data class PppViewRow(
  ...
  companion object {
    val _rowParser: RowParser<PppViewRow> = RowParsers.of(ProductId.pgType, ProductphotoId.pgType, Flag.pgType, TypoLocalDateTime.pgType, ::PppViewRow, { row -> Tuple4(row.productid, row.productphotoid, row.primary, row.modifieddate) })
  }
}