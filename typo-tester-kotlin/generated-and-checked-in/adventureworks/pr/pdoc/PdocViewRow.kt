...
data class PdocViewRow(
  ...
  companion object {
    val _rowParser: RowParser<PdocViewRow> = RowParsers.of(ProductId.pgType, ProductId.pgType, TypoLocalDateTime.pgType, DocumentId.pgType, ::PdocViewRow, { row -> Tuple4(row.id, row.productid, row.modifieddate, row.documentnode) })
  }
}