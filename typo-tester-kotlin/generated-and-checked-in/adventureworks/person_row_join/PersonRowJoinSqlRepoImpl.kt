...
data class PersonRowJoinSqlRepoImpl() : PersonRowJoinSqlRepo {
  fun apply(c: Connection): List<PersonRowJoinSqlRow> = interpolate(typo.runtime.Fragment.lit("""
  ...
  """.trimMargin())).as(PersonRowJoinSqlRow._rowParser.all()).runUnchecked(c)
}