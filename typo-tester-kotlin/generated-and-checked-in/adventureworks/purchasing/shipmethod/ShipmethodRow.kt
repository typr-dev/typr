...
data class ShipmethodRow(
  ...
  companion object {
    val _rowParser: RowParser<ShipmethodRow> = RowParsers.of(ShipmethodId.pgType, Name.pgType, PgTypes.numeric, PgTypes.numeric, TypoUUID.pgType, TypoLocalDateTime.pgType, ::ShipmethodRow, { row -> Tuple6(row.shipmethodid, row.name, row.shipbase, row.shiprate, row.rowguid, row.modifieddate) })
