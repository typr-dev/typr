...
data class VendorRepoImpl() : VendorRepo {
  fun deleteById(
  ...
  fun selectAll(c: Connection): kotlin.collections.List<VendorRow> = interpolate(typo.runtime.Fragment.lit("""
    ...
    from "purchasing"."vendor"
  """.trimMargin())).as(VendorRow._rowParser.all()).runUnchecked(c)
  ...
  fun selectByIds(
    businessentityids: Array<BusinessentityId>,
    c: Connection
  ): kotlin.collections.List<VendorRow> = interpolate(
    typo.runtime.Fragment.lit("""
      select "businessentityid", "accountnumber", "name", "creditrating", "preferredvendorstatus", "activeflag", "purchasingwebserviceurl", "modifieddate"::text
      from "purchasing"."vendor"
      where "businessentityid" = ANY(""".trimMargin()),
  ...
  fun selectByIdsTracked(
    ...
    val ret: java.util.Map<BusinessentityId, VendorRow> = HashMap()
  ...
  fun upsertBatch(
    unsaved: Iterator<VendorRow>,
    c: Connection
  ): kotlin.collections.List<VendorRow> = interpolate(typo.runtime.Fragment.lit("""
                                            insert into "purchasing"."vendor"("businessentityid", "accountnumber", "name", "creditrating", "preferredvendorstatus", "activeflag", "purchasingwebserviceurl", "modifieddate")
