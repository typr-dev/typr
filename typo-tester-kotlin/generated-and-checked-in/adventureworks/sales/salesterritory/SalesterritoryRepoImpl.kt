...
data class SalesterritoryRepoImpl() : SalesterritoryRepo {
  fun deleteById(
  ...
  fun selectAll(c: Connection): kotlin.collections.List<SalesterritoryRow> = interpolate(typo.runtime.Fragment.lit("""
    select "territoryid", "name", "countryregioncode", "group", "salesytd", "saleslastyear", "costytd", "costlastyear", "rowguid", "modifieddate"::text
    from "sales"."salesterritory"
  """.trimMargin())).as(SalesterritoryRow._rowParser.all()).runUnchecked(c)
  ...
  fun selectById(
    ...
    SalesterritoryId.pgType.encode(territoryid),
    typo.runtime.Fragment.lit("")
  ).as(SalesterritoryRow._rowParser.first()).runUnchecked(c)

  fun selectByIds(
    territoryids: Array<SalesterritoryId>,
    c: Connection
  ): kotlin.collections.List<SalesterritoryRow> = interpolate(
    typo.runtime.Fragment.lit("""
      select "territoryid", "name", "countryregioncode", "group", "salesytd", "saleslastyear", "costytd", "costlastyear", "rowguid", "modifieddate"::text
      from "sales"."salesterritory"
      where "territoryid" = ANY(""".trimMargin()),
  ...
  fun selectByIdsTracked(
    ...
    val ret: java.util.Map<SalesterritoryId, SalesterritoryRow> = HashMap()
      for (var row : selectByIds(territoryids, c)) {
          ret.put(row.id(), row);
      }
    return ret
  }
  ...
  fun upsertBatch(
    unsaved: Iterator<SalesterritoryRow>,
    c: Connection
  ): kotlin.collections.List<SalesterritoryRow> = interpolate(typo.runtime.Fragment.lit("""
                                                    insert into "sales"."salesterritory"("territoryid", "name", "countryregioncode", "group", "salesytd", "saleslastyear", "costytd", "costlastyear", "rowguid", "modifieddate")
