...
data class VsalespersonViewRepoImpl() : VsalespersonViewRepo {
  fun selectAll(c: Connection): List<VsalespersonViewRow> = interpolate(typo.runtime.Fragment.lit("""
  ...
  """.trimMargin())).as(VsalespersonViewRow._rowParser.all()).runUnchecked(c)
}