...
data class SpecialofferproductRepoImpl() : SpecialofferproductRepo {
  fun deleteById(
  ...
  fun selectAll(c: Connection): kotlin.collections.List<SpecialofferproductRow> = interpolate(typo.runtime.Fragment.lit("""
    select "specialofferid", "productid", "rowguid", "modifieddate"::text
    from "sales"."specialofferproduct"
  """.trimMargin())).as(SpecialofferproductRow._rowParser.all()).runUnchecked(c)
  ...
  fun selectByIds(
    compositeIds: Array<SpecialofferproductId>,
    c: Connection
  ): kotlin.collections.List<SpecialofferproductRow> {
    val specialofferid: Array<SpecialofferId> = arrayMap.map(compositeIds, SpecialofferproductId::specialofferid, SpecialofferId::class.java)
      val productid: Array<ProductId> = arrayMap.map(compositeIds, SpecialofferproductId::productid, ProductId::class.java)
    return interpolate(
             typo.runtime.Fragment.lit("""
  ...
  fun selectByIdsTracked(
    ...
    val ret: java.util.Map<SpecialofferproductId, SpecialofferproductRow> = HashMap()
  ...
  fun upsertBatch(
    unsaved: Iterator<SpecialofferproductRow>,
    c: Connection
  ): kotlin.collections.List<SpecialofferproductRow> = interpolate(typo.runtime.Fragment.lit("""
                                                         insert into "sales"."specialofferproduct"("specialofferid", "productid", "rowguid", "modifieddate")
