...
data class SpecialofferproductRow(
  ...
  companion object {
    val _rowParser: RowParser<SpecialofferproductRow> = RowParsers.of(SpecialofferId.pgType, ProductId.pgType, TypoUUID.pgType, TypoLocalDateTime.pgType, ::SpecialofferproductRow, { row -> Tuple4(row.specialofferid, row.productid, row.rowguid, row.modifieddate) })
