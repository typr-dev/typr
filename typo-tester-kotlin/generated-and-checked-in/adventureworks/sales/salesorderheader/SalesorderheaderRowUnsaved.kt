...
data class SalesorderheaderRowUnsaved(
  ...
  /** Default: nextval('sales.salesorderheader_salesorderid_seq'::regclass)
    * Primary key.
    */
  val salesorderid: Defaulted<SalesorderheaderId>,
  /** Default: 0
  ...
  /** Default: true
    ...
    */
  val onlineorderflag: Defaulted<Flag>,
  /** Default: 0.00
  ...
  constructor(duedate: TypoLocalDateTime, customerid: CustomerId, billtoaddressid: AddressId, shiptoaddressid: AddressId, shipmethodid: ShipmethodId) : this(duedate, null, null, null, customerid, null, null, billtoaddressid, shiptoaddressid, shipmethodid, null, null, null, null, null, UseDefault(), UseDefault(), UseDefault(), UseDefault(), UseDefault(), UseDefault(), UseDefault(), UseDefault(), UseDefault(), UseDefault())
