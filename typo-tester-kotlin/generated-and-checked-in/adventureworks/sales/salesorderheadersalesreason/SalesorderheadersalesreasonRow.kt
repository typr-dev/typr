...
data class SalesorderheadersalesreasonRow(
  ...
  companion object {
    val _rowParser: RowParser<SalesorderheadersalesreasonRow> = RowParsers.of(SalesorderheaderId.pgType, SalesreasonId.pgType, TypoLocalDateTime.pgType, ::SalesorderheadersalesreasonRow, { row -> Tuple3(row.salesorderid, row.salesreasonid, row.modifieddate) })
