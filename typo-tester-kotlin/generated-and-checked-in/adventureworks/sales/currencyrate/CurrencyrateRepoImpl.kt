...
data class CurrencyrateRepoImpl() : CurrencyrateRepo {
  fun deleteById(
  ...
  fun selectAll(c: Connection): kotlin.collections.List<CurrencyrateRow> = interpolate(typo.runtime.Fragment.lit("""
    select "currencyrateid", "currencyratedate"::text, "fromcurrencycode", "tocurrencycode", "averagerate", "endofdayrate", "modifieddate"::text
    from "sales"."currencyrate"
  """.trimMargin())).as(CurrencyrateRow._rowParser.all()).runUnchecked(c)
  ...
  fun selectByIds(
    currencyrateids: Array<CurrencyrateId>,
    c: Connection
  ): kotlin.collections.List<CurrencyrateRow> = interpolate(
    typo.runtime.Fragment.lit("""
      select "currencyrateid", "currencyratedate"::text, "fromcurrencycode", "tocurrencycode", "averagerate", "endofdayrate", "modifieddate"::text
      from "sales"."currencyrate"
      where "currencyrateid" = ANY(""".trimMargin()),
  ...
  fun selectByIdsTracked(
    ...
    val ret: java.util.Map<CurrencyrateId, CurrencyrateRow> = HashMap()
      for (var row : selectByIds(currencyrateids, c)) {
          ret.put(row.id(), row);
      }
    return ret
  }
  ...
  fun upsertBatch(
    unsaved: Iterator<CurrencyrateRow>,
    c: Connection
  ): kotlin.collections.List<CurrencyrateRow> = interpolate(typo.runtime.Fragment.lit("""
                                                  insert into "sales"."currencyrate"("currencyrateid", "currencyratedate", "fromcurrencycode", "tocurrencycode", "averagerate", "endofdayrate", "modifieddate")
