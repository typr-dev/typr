...
data class CurrencyrateRowUnsaved(
  ...
  /** Default: nextval('sales.currencyrate_currencyrateid_seq'::regclass)
    ...
    */
  val currencyrateid: Defaulted<CurrencyrateId>,
  /** Default: now() */
  val modifieddate: Defaulted<TypoLocalDateTime>
) {
  constructor(currencyratedate: TypoLocalDateTime, fromcurrencycode: CurrencyId, tocurrencycode: CurrencyId, averagerate: BigDecimal, endofdayrate: BigDecimal) : this(currencyratedate, fromcurrencycode, tocurrencycode, averagerate, endofdayrate, UseDefault(), UseDefault())
