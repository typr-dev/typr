...
data class SalespersonquotahistoryRepoImpl() : SalespersonquotahistoryRepo {
  fun deleteById(
  ...
  fun selectAll(c: Connection): kotlin.collections.List<SalespersonquotahistoryRow> = interpolate(typo.runtime.Fragment.lit("""
    select "businessentityid", "quotadate"::text, "salesquota", "rowguid", "modifieddate"::text
    from "sales"."salespersonquotahistory"
  """.trimMargin())).as(SalespersonquotahistoryRow._rowParser.all()).runUnchecked(c)
  ...
  fun selectByIds(
    compositeIds: Array<SalespersonquotahistoryId>,
    c: Connection
  ): kotlin.collections.List<SalespersonquotahistoryRow> {
    val businessentityid: Array<BusinessentityId> = arrayMap.map(compositeIds, SalespersonquotahistoryId::businessentityid, BusinessentityId::class.java)
      val quotadate: Array<TypoLocalDateTime> = arrayMap.map(compositeIds, SalespersonquotahistoryId::quotadate, TypoLocalDateTime::class.java)
    return interpolate(
             typo.runtime.Fragment.lit("""
  ...
  fun selectByIdsTracked(
    ...
    val ret: java.util.Map<SalespersonquotahistoryId, SalespersonquotahistoryRow> = HashMap()
  ...
  fun upsertBatch(
    unsaved: Iterator<SalespersonquotahistoryRow>,
    c: Connection
  ): kotlin.collections.List<SalespersonquotahistoryRow> = interpolate(typo.runtime.Fragment.lit("""
                                                             insert into "sales"."salespersonquotahistory"("businessentityid", "quotadate", "salesquota", "rowguid", "modifieddate")
