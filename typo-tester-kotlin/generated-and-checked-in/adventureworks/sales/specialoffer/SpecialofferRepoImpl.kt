...
data class SpecialofferRepoImpl() : SpecialofferRepo {
  fun deleteById(
  ...
  fun selectAll(c: Connection): kotlin.collections.List<SpecialofferRow> = interpolate(typo.runtime.Fragment.lit("""
    ...
    from "sales"."specialoffer"
  """.trimMargin())).as(SpecialofferRow._rowParser.all()).runUnchecked(c)
  ...
  fun selectById(
    ...
    SpecialofferId.pgType.encode(specialofferid),
    typo.runtime.Fragment.lit("")
  ).as(SpecialofferRow._rowParser.first()).runUnchecked(c)

  fun selectByIds(
    specialofferids: Array<SpecialofferId>,
    c: Connection
  ): kotlin.collections.List<SpecialofferRow> = interpolate(
    typo.runtime.Fragment.lit("""
      select "specialofferid", "description", "discountpct", "type", "category", "startdate"::text, "enddate"::text, "minqty", "maxqty", "rowguid", "modifieddate"::text
      from "sales"."specialoffer"
      where "specialofferid" = ANY(""".trimMargin()),
  ...
  fun selectByIdsTracked(
    ...
    val ret: java.util.Map<SpecialofferId, SpecialofferRow> = HashMap()
      for (var row : selectByIds(specialofferids, c)) {
          ret.put(row.id(), row);
      }
    return ret
  }
  ...
  fun upsertBatch(
    unsaved: Iterator<SpecialofferRow>,
    c: Connection
  ): kotlin.collections.List<SpecialofferRow> = interpolate(typo.runtime.Fragment.lit("""
                                                  insert into "sales"."specialoffer"("specialofferid", "description", "discountpct", "type", "category", "startdate", "enddate", "minqty", "maxqty", "rowguid", "modifieddate")
