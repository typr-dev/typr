...
data class CreditcardRowUnsaved(
  ...
  /** Default: nextval('sales.creditcard_creditcardid_seq'::regclass)
    ...
    */
  val creditcardid: Defaulted</* user-picked */ CustomCreditcardId>,
  /** Default: now() */
  val modifieddate: Defaulted<TypoLocalDateTime>
) {
  constructor(cardtype: /* max 50 chars */ java.lang.String, cardnumber: /* max 25 chars */ java.lang.String, expmonth: TypoShort, expyear: TypoShort) : this(cardtype, cardnumber, expmonth, expyear, UseDefault(), UseDefault())
