...
data class SalesorderdetailRowUnsaved(
  ...
  /** Default: nextval('sales.salesorderdetail_salesorderdetailid_seq'::regclass)
    ...
    */
  val salesorderdetailid: Defaulted<Int>,
  /** Default: 0.0
    * Discount amount.
    * Constraint CK_SalesOrderDetail_UnitPriceDiscount affecting columns unitpricediscount:  ((unitpricediscount >= 0.00))
    */
  val unitpricediscount: Defaulted<BigDecimal>,
  /** Default: uuid_generate_v1() */
  val rowguid: Defaulted<TypoUUID>,
  /** Default: now() */
  val modifieddate: Defaulted<TypoLocalDateTime>
) {
  constructor(salesorderid: SalesorderheaderId, orderqty: TypoShort, productid: ProductId, specialofferid: SpecialofferId, unitprice: BigDecimal) : this(salesorderid, null, orderqty, productid, specialofferid, unitprice, UseDefault(), UseDefault(), UseDefault(), UseDefault())
