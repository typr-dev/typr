...
data class SalesorderdetailRepoImpl() : SalesorderdetailRepo {
  fun deleteById(
  ...
  fun deleteByIds(
    ...
    val salesorderid: Array<SalesorderheaderId> = arrayMap.map(compositeIds, SalesorderdetailId::salesorderid, SalesorderheaderId::class.java)
      val salesorderdetailid: Array<Int> = arrayMap.map(compositeIds, SalesorderdetailId::salesorderdetailid, Int::class.java)
    return interpolate(
             typo.runtime.Fragment.lit("""
               delete
  ...
  fun selectAll(c: Connection): kotlin.collections.List<SalesorderdetailRow> = interpolate(typo.runtime.Fragment.lit("""
    ...
    from "sales"."salesorderdetail"
  """.trimMargin())).as(SalesorderdetailRow._rowParser.all()).runUnchecked(c)
  ...
  fun selectById(
    ...
    PgTypes.int4.encode(compositeId.salesorderdetailid),
    typo.runtime.Fragment.lit("")
  ).as(SalesorderdetailRow._rowParser.first()).runUnchecked(c)

  fun selectByIds(
    compositeIds: Array<SalesorderdetailId>,
    c: Connection
  ): kotlin.collections.List<SalesorderdetailRow> {
    val salesorderid: Array<SalesorderheaderId> = arrayMap.map(compositeIds, SalesorderdetailId::salesorderid, SalesorderheaderId::class.java)
      val salesorderdetailid: Array<Int> = arrayMap.map(compositeIds, SalesorderdetailId::salesorderdetailid, Int::class.java)
    return interpolate(
             typo.runtime.Fragment.lit("""
  ...
  fun selectByIdsTracked(
    ...
    val ret: java.util.Map<SalesorderdetailId, SalesorderdetailRow> = HashMap()
  ...
  fun upsertBatch(
    unsaved: Iterator<SalesorderdetailRow>,
    c: Connection
  ): kotlin.collections.List<SalesorderdetailRow> = interpolate(typo.runtime.Fragment.lit("""
                                                      insert into "sales"."salesorderdetail"("salesorderid", "salesorderdetailid", "carriertrackingnumber", "orderqty", "productid", "specialofferid", "unitprice", "unitpricediscount", "rowguid", "modifieddate")
