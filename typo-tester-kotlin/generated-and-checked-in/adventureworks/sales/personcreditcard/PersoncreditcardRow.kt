...
data class PersoncreditcardRow(
  ...
  companion object {
    val _rowParser: RowParser<PersoncreditcardRow> = RowParsers.of(BusinessentityId.pgType, /* user-picked */ CustomCreditcardId.pgType, TypoLocalDateTime.pgType, ::PersoncreditcardRow, { row -> Tuple3(row.businessentityid, row.creditcardid, row.modifieddate) })
