...
import dev.typr.foundations.{dsl => dsl}
...
/** Top-level type alias for RelationStructure interface.
  ...
  *   - columns(): java.util.List[dev.typr.foundations.dsl.SqlExpr.FieldLike[?, Row]] (from FieldsExpr)
  *   - _path(): java.util.List[dev.typr.foundations.dsl.Path] (from RelationStructure)
  *   - copy(_path: java.util.List[dev.typr.foundations.dsl.Path]): RelationStructure[Fields, Row] (from RelationStructure)
  *
