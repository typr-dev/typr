...
object BusinessentitycontactId {
  implicit lazy val jdbcDecoder: JdbcDecoder[BusinessentitycontactId] = {
    new JdbcDecoder[BusinessentitycontactId] {
      override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, BusinessentitycontactId) =
        columIndex + 2 ->
