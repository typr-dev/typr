...
object TestSakSoknadsalternativRow {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[TestSakSoknadsalternativRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[TestSakSoknadsalternativRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[TestSakSoknadsalternativRow] = {
