...
object TableWithGeneratedColumnsRow {
  implicit lazy val jdbcDecoder: JdbcDecoder[TableWithGeneratedColumnsRow] = {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[TableWithGeneratedColumnsRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[TableWithGeneratedColumnsRow] = {
