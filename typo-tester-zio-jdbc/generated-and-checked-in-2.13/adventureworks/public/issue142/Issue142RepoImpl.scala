...
class Issue142RepoImpl extends Issue142Repo {
  ...
  override def selectAll: ZStream[ZConnection, Throwable, Issue142Row] = {
    sql"""select "tabellkode" from "public"."issue142"""".query(Issue142Row.jdbcDecoder).selectStream()
  }
  override def selectById(tabellkode: Issue142Id): ZIO[ZConnection, Throwable, Option[Issue142Row]] = {
    sql"""select "tabellkode" from "public"."issue142" where "tabellkode" = ${Segment.paramSegment(tabellkode)(Issue142Id.setter)}""".query(Issue142Row.jdbcDecoder).selectOne
  }
  override def selectByIds(tabellkodes: Array[Issue142Id]): ZStream[ZConnection, Throwable, Issue142Row] = {
    sql"""select "tabellkode" from "public"."issue142" where "tabellkode" = ANY(${Segment.paramSegment(tabellkodes)(Issue142Id.arraySetter)})""".query(Issue142Row.jdbcDecoder).selectStream()
  }
