...
object FlaffRow {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[FlaffRow] = {
    JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
      ...
      val parentspecifier = jsonObj.get("parentspecifier").fold[Either[String, Option[ShortText]]](Right(None))(_.as(JsonDecoder.option(ShortText.jsonDecoder)))
  ...
  implicit lazy val jsonEncoder: JsonEncoder[FlaffRow] = {
    new JsonEncoder[FlaffRow] {
      override def unsafeEncode(a: FlaffRow, indent: Option[Int], out: Write): Unit = {
        ...
        JsonEncoder.option(ShortText.jsonEncoder).unsafeEncode(a.parentspecifier, indent, out)
        out.write("}")
      }
    }
  }
  ...
  implicit lazy val pgText: Text[FlaffRow] = {
    Text.instance[FlaffRow]{ (row, sb) =>
      ...
      sb.append(Text.DELIMETER)
      Text.option(ShortText.pgText).unsafeEncode(row.parentspecifier, sb)
    }
  }
}