...
object TestUtdanningstilbudRow {
  ...
  implicit lazy val jdbcDecoder: JdbcDecoder[TestUtdanningstilbudRow] = {
    new JdbcDecoder[TestUtdanningstilbudRow] {
  ...
  implicit lazy val jsonDecoder: JsonDecoder[TestUtdanningstilbudRow] = {
  ...
  implicit lazy val jsonEncoder: JsonEncoder[TestUtdanningstilbudRow] = {
    new JsonEncoder[TestUtdanningstilbudRow] {
