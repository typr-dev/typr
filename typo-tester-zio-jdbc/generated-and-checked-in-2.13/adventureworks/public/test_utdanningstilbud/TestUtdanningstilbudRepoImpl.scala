...
class TestUtdanningstilbudRepoImpl extends TestUtdanningstilbudRepo {
  ...
  override def selectAll: ZStream[ZConnection, Throwable, TestUtdanningstilbudRow] = {
    sql"""select "organisasjonskode", "utdanningsmulighet_kode" from "public"."test_utdanningstilbud"""".query(TestUtdanningstilbudRow.jdbcDecoder).selectStream()
  }
  override def selectById(compositeId: TestUtdanningstilbudId): ZIO[ZConnection, Throwable, Option[TestUtdanningstilbudRow]] = {
    sql"""select "organisasjonskode", "utdanningsmulighet_kode" from "public"."test_utdanningstilbud" where "organisasjonskode" = ${Segment.paramSegment(compositeId.organisasjonskode)(TestOrganisasjonId.setter)} AND "utdanningsmulighet_kode" = ${Segment.paramSegment(compositeId.utdanningsmulighetKode)(Setter.stringSetter)}""".query(TestUtdanningstilbudRow.jdbcDecoder).selectOne
  }
  ...
  override def upsert(unsaved: TestUtdanningstilbudRow): ZIO[ZConnection, Throwable, UpdateResult[TestUtdanningstilbudRow]] = {
    sql"""insert into "public"."test_utdanningstilbud"("organisasjonskode", "utdanningsmulighet_kode")
          ...
          returning "organisasjonskode", "utdanningsmulighet_kode"""".insertReturning(TestUtdanningstilbudRow.jdbcDecoder)
  }
