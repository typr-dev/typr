...
class Issue1422RepoImpl extends Issue1422Repo {
  ...
  override def selectAll: ZStream[ZConnection, Throwable, Issue1422Row] = {
    sql"""select "tabellkode" from "public"."issue142_2"""".query(Issue1422Row.jdbcDecoder).selectStream()
  }
  override def selectById(tabellkode: Issue142Id): ZIO[ZConnection, Throwable, Option[Issue1422Row]] = {
    sql"""select "tabellkode" from "public"."issue142_2" where "tabellkode" = ${Segment.paramSegment(tabellkode)(Issue142Id.setter)}""".query(Issue1422Row.jdbcDecoder).selectOne
  }
  override def selectByIds(tabellkodes: Array[Issue142Id]): ZStream[ZConnection, Throwable, Issue1422Row] = {
    sql"""select "tabellkode" from "public"."issue142_2" where "tabellkode" = ANY(${Segment.paramSegment(tabellkodes)(Issue142Id.arraySetter)})""".query(Issue1422Row.jdbcDecoder).selectStream()
  }
  ...
  override def upsert(unsaved: Issue1422Row): ZIO[ZConnection, Throwable, UpdateResult[Issue1422Row]] = {
    sql"""insert into "public"."issue142_2"("tabellkode")
          ...
          returning "tabellkode"""".insertReturning(Issue1422Row.jdbcDecoder)
  }
