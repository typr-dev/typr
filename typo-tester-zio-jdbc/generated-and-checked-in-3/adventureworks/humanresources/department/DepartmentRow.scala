...
object DepartmentRow {
  given jdbcDecoder: JdbcDecoder[DepartmentRow] = new JdbcDecoder[DepartmentRow] {
  ...
  given jsonDecoder: JsonDecoder[DepartmentRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[DepartmentRow] = new JsonEncoder[DepartmentRow] {
