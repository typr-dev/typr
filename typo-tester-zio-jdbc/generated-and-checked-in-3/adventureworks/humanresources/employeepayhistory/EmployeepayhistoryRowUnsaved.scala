...
object EmployeepayhistoryRowUnsaved {
  given jsonDecoder: JsonDecoder[EmployeepayhistoryRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[EmployeepayhistoryRowUnsaved] = new JsonEncoder[EmployeepayhistoryRowUnsaved] {
