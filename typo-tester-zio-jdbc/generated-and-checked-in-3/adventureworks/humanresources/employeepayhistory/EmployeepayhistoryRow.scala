...
object EmployeepayhistoryRow {
  ...
  given jdbcDecoder: JdbcDecoder[EmployeepayhistoryRow] = {
  ...
  given jsonDecoder: JsonDecoder[EmployeepayhistoryRow] = {
  ...
  given jsonEncoder: JsonEncoder[EmployeepayhistoryRow] = {
