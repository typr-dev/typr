...
object EmployeepayhistoryRow {
  ...
  given jdbcDecoder: JdbcDecoder[EmployeepayhistoryRow] = new JdbcDecoder[EmployeepayhistoryRow] {
  ...
  given jsonDecoder: JsonDecoder[EmployeepayhistoryRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val rate = jsonObj.get("rate").toRight("Missing field 'rate'").flatMap(_.as(using JsonDecoder.scalaBigDecimal))
    val payfrequency = jsonObj.get("payfrequency").toRight("Missing field 'payfrequency'").flatMap(_.as(using TypoShort.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[EmployeepayhistoryRow] = new JsonEncoder[EmployeepayhistoryRow] {
