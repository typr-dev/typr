...
object JobcandidateRowUnsaved {
  given jsonDecoder: JsonDecoder[JobcandidateRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[JobcandidateRowUnsaved] = new JsonEncoder[JobcandidateRowUnsaved] {
