...
object JobcandidateRow {
  given jdbcDecoder: JdbcDecoder[JobcandidateRow] = new JdbcDecoder[JobcandidateRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, JobcandidateRow) =
      columIndex + 3 ->
        JobcandidateRow(
          ...
          resume = JdbcDecoder.optionDecoder(using TypoXml.jdbcDecoder).unsafeDecode(columIndex + 2, rs)._2,
          modifieddate = TypoLocalDateTime.jdbcDecoder.unsafeDecode(columIndex + 3, rs)._2
        )
  }
  given jsonDecoder: JsonDecoder[JobcandidateRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[JobcandidateRow] = new JsonEncoder[JobcandidateRow] {
  ...
  given text: Text[JobcandidateRow] = Text.instance[JobcandidateRow]{ (row, sb) =>
