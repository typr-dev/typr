...
object EmployeedepartmenthistoryRow {
  ...
  given jdbcDecoder: JdbcDecoder[EmployeedepartmenthistoryRow] = new JdbcDecoder[EmployeedepartmenthistoryRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, EmployeedepartmenthistoryRow) =
      columIndex + 5 ->
        EmployeedepartmenthistoryRow(
          ...
          enddate = JdbcDecoder.optionDecoder(using TypoLocalDate.jdbcDecoder).unsafeDecode(columIndex + 4, rs)._2,
          modifieddate = TypoLocalDateTime.jdbcDecoder.unsafeDecode(columIndex + 5, rs)._2
        )
  }
  given jsonDecoder: JsonDecoder[EmployeedepartmenthistoryRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[EmployeedepartmenthistoryRow] = new JsonEncoder[EmployeedepartmenthistoryRow] {
