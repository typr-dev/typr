...
object EmployeedepartmenthistoryRow {
  ...
  given jdbcDecoder: JdbcDecoder[EmployeedepartmenthistoryRow] = {
  ...
  given jsonDecoder: JsonDecoder[EmployeedepartmenthistoryRow] = {
  ...
  given jsonEncoder: JsonEncoder[EmployeedepartmenthistoryRow] = {
