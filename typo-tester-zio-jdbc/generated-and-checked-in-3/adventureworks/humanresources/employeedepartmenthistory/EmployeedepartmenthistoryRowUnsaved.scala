...
object EmployeedepartmenthistoryRowUnsaved {
  given jsonDecoder: JsonDecoder[EmployeedepartmenthistoryRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[EmployeedepartmenthistoryRowUnsaved] = new JsonEncoder[EmployeedepartmenthistoryRowUnsaved] {
