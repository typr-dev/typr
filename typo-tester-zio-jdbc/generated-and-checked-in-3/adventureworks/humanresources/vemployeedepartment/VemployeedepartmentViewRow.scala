...
object VemployeedepartmentViewRow {
  given jdbcDecoder: JdbcDecoder[VemployeedepartmentViewRow] = new JdbcDecoder[VemployeedepartmentViewRow] {
  ...
  given jsonDecoder: JsonDecoder[VemployeedepartmentViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[VemployeedepartmentViewRow] = new JsonEncoder[VemployeedepartmentViewRow] {
