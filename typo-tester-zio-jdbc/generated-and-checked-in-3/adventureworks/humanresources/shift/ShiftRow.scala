...
object ShiftRow {
  given jdbcDecoder: JdbcDecoder[ShiftRow] = new JdbcDecoder[ShiftRow] {
  ...
  given jsonDecoder: JsonDecoder[ShiftRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ShiftRow] = new JsonEncoder[ShiftRow] {
