...
object EmployeeRow {
  given jdbcDecoder: JdbcDecoder[EmployeeRow] = new JdbcDecoder[EmployeeRow] {
  ...
  given jsonDecoder: JsonDecoder[EmployeeRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val salariedflag = jsonObj.get("salariedflag").toRight("Missing field 'salariedflag'").flatMap(_.as(using Flag.jsonDecoder))
    ...
    val currentflag = jsonObj.get("currentflag").toRight("Missing field 'currentflag'").flatMap(_.as(using Flag.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[EmployeeRow] = new JsonEncoder[EmployeeRow] {
  ...
  given text: Text[EmployeeRow] = Text.instance[EmployeeRow]{ (row, sb) =>
