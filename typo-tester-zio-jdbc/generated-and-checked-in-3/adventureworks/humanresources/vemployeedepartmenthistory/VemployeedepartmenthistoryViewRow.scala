...
object VemployeedepartmenthistoryViewRow {
  given jdbcDecoder: JdbcDecoder[VemployeedepartmenthistoryViewRow] = {
  ...
  given jsonDecoder: JsonDecoder[VemployeedepartmenthistoryViewRow] = {
  ...
  given jsonEncoder: JsonEncoder[VemployeedepartmenthistoryViewRow] = {
