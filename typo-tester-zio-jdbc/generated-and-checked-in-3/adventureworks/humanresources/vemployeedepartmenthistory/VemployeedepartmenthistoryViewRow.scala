...
object VemployeedepartmenthistoryViewRow {
  given jdbcDecoder: JdbcDecoder[VemployeedepartmenthistoryViewRow] = new JdbcDecoder[VemployeedepartmenthistoryViewRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, VemployeedepartmenthistoryViewRow) =
      columIndex + 10 ->
        VemployeedepartmenthistoryViewRow(
          ...
          enddate = JdbcDecoder.optionDecoder(using TypoLocalDate.jdbcDecoder).unsafeDecode(columIndex + 10, rs)._2
        )
  }
  given jsonDecoder: JsonDecoder[VemployeedepartmenthistoryViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val shift = jsonObj.get("shift").toRight("Missing field 'shift'").flatMap(_.as(using Name.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[VemployeedepartmenthistoryViewRow] = new JsonEncoder[VemployeedepartmenthistoryViewRow] {
