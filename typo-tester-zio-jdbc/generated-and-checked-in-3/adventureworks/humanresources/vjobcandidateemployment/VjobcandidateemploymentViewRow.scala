...
object VjobcandidateemploymentViewRow {
  given jdbcDecoder: JdbcDecoder[VjobcandidateemploymentViewRow] = {
  ...
  given jsonDecoder: JsonDecoder[VjobcandidateemploymentViewRow] = {
  ...
  given jsonEncoder: JsonEncoder[VjobcandidateemploymentViewRow] = {
