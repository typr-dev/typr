...
object UpdatePersonReturningSqlRow {
  given jdbcDecoder: JdbcDecoder[UpdatePersonReturningSqlRow] = {
  ...
  given jsonDecoder: JsonDecoder[UpdatePersonReturningSqlRow] = {
  ...
  given jsonEncoder: JsonEncoder[UpdatePersonReturningSqlRow] = {
