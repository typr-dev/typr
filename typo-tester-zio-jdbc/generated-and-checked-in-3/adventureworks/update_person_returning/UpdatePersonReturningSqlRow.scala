...
object UpdatePersonReturningSqlRow {
  given jdbcDecoder: JdbcDecoder[UpdatePersonReturningSqlRow] = new JdbcDecoder[UpdatePersonReturningSqlRow] {
  ...
  given jsonDecoder: JsonDecoder[UpdatePersonReturningSqlRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[UpdatePersonReturningSqlRow] = new JsonEncoder[UpdatePersonReturningSqlRow] {
