...
object SmViewRow {
  given jdbcDecoder: JdbcDecoder[SmViewRow] = new JdbcDecoder[SmViewRow] {
  ...
  given jsonDecoder: JsonDecoder[SmViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    val id = jsonObj.get("id").toRight("Missing field 'id'").flatMap(_.as(using ShipmethodId.jsonDecoder))
    ...
    val shipbase = jsonObj.get("shipbase").toRight("Missing field 'shipbase'").flatMap(_.as(using JsonDecoder.scalaBigDecimal))
    val shiprate = jsonObj.get("shiprate").toRight("Missing field 'shiprate'").flatMap(_.as(using JsonDecoder.scalaBigDecimal))
  ...
  given jsonEncoder: JsonEncoder[SmViewRow] = new JsonEncoder[SmViewRow] {
