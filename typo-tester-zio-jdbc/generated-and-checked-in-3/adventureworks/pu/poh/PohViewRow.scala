...
object PohViewRow {
  given jdbcDecoder: JdbcDecoder[PohViewRow] = new JdbcDecoder[PohViewRow] {
  ...
  given jsonDecoder: JsonDecoder[PohViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    val id = jsonObj.get("id").toRight("Missing field 'id'").flatMap(_.as(using PurchaseorderheaderId.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[PohViewRow] = new JsonEncoder[PohViewRow] {
