...
object PodViewRow {
  given jdbcDecoder: JdbcDecoder[PodViewRow] = new JdbcDecoder[PodViewRow] {
  ...
  given jsonDecoder: JsonDecoder[PodViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[PodViewRow] = new JsonEncoder[PodViewRow] {
