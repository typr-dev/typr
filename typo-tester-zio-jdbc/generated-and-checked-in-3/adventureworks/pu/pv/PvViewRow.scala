...
object PvViewRow {
  given jdbcDecoder: JdbcDecoder[PvViewRow] = new JdbcDecoder[PvViewRow] {
  ...
  given jsonDecoder: JsonDecoder[PvViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[PvViewRow] = new JsonEncoder[PvViewRow] {
