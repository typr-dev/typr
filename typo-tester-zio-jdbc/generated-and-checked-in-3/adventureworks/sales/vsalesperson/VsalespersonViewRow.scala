...
object VsalespersonViewRow {
  given jdbcDecoder: JdbcDecoder[VsalespersonViewRow] = new JdbcDecoder[VsalespersonViewRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, VsalespersonViewRow) =
      columIndex + 21 ->
        VsalespersonViewRow(
          ...
          territoryname = JdbcDecoder.optionDecoder(using Name.jdbcDecoder).unsafeDecode(columIndex + 17, rs)._2,
          territorygroup = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 18, rs)._2,
          salesquota = JdbcDecoder.optionDecoder(using JdbcDecoder.bigDecimalDecoderScala).unsafeDecode(columIndex + 19, rs)._2,
  ...
  given jsonDecoder: JsonDecoder[VsalespersonViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val territoryname = jsonObj.get("territoryname").fold[Either[String, Option[Name]]](Right(None))(_.as(using JsonDecoder.option(using Name.jsonDecoder)))
    val territorygroup = jsonObj.get("territorygroup").fold[Either[String, Option[String]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.string)))
  ...
  given jsonEncoder: JsonEncoder[VsalespersonViewRow] = new JsonEncoder[VsalespersonViewRow] {
