...
object CreditcardRow {
  given jdbcDecoder: JdbcDecoder[CreditcardRow] = new JdbcDecoder[CreditcardRow] {
  ...
  given jsonDecoder: JsonDecoder[CreditcardRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[CreditcardRow] = new JsonEncoder[CreditcardRow] {
  ...
  given text: Text[CreditcardRow] = Text.instance[CreditcardRow]{ (row, sb) =>
