...
trait CreditcardRepo {
  ...
  def deleteByIds(creditcardids: Array[/* user-picked */ CustomCreditcardId])(using encoder0: JdbcEncoder[Array[/* user-picked */ CustomCreditcardId]]): ZIO[ZConnection, Throwable, Long]
  ...
  def selectByIds(creditcardids: Array[/* user-picked */ CustomCreditcardId])(using encoder0: JdbcEncoder[Array[/* user-picked */ CustomCreditcardId]]): ZStream[ZConnection, Throwable, CreditcardRow]
  def selectByIdsTracked(creditcardids: Array[/* user-picked */ CustomCreditcardId])(using encoder0: JdbcEncoder[Array[/* user-picked */ CustomCreditcardId]]): ZIO[ZConnection, Throwable, Map[/* user-picked */ CustomCreditcardId, CreditcardRow]]
