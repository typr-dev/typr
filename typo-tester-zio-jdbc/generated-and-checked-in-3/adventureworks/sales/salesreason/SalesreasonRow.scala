...
object SalesreasonRow {
  given jdbcDecoder: JdbcDecoder[SalesreasonRow] = new JdbcDecoder[SalesreasonRow] {
  ...
  given jsonDecoder: JsonDecoder[SalesreasonRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[SalesreasonRow] = new JsonEncoder[SalesreasonRow] {
