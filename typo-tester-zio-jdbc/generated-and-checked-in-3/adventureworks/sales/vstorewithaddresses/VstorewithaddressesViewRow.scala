...
object VstorewithaddressesViewRow {
  given jdbcDecoder: JdbcDecoder[VstorewithaddressesViewRow] = new JdbcDecoder[VstorewithaddressesViewRow] {
  ...
  given jsonDecoder: JsonDecoder[VstorewithaddressesViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[VstorewithaddressesViewRow] = new JsonEncoder[VstorewithaddressesViewRow] {
