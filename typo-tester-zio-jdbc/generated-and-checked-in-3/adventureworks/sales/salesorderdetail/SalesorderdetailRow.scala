...
object SalesorderdetailRow {
  ...
  given jdbcDecoder: JdbcDecoder[SalesorderdetailRow] = new JdbcDecoder[SalesorderdetailRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, SalesorderdetailRow) =
      columIndex + 9 ->
        SalesorderdetailRow(
          ...
          carriertrackingnumber = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 2, rs)._2,
  ...
  given jsonDecoder: JsonDecoder[SalesorderdetailRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val unitpricediscount = jsonObj.get("unitpricediscount").toRight("Missing field 'unitpricediscount'").flatMap(_.as(using JsonDecoder.scalaBigDecimal))
  ...
  given jsonEncoder: JsonEncoder[SalesorderdetailRow] = new JsonEncoder[SalesorderdetailRow] {
