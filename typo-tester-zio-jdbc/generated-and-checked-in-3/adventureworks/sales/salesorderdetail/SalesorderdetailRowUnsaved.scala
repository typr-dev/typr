...
object SalesorderdetailRowUnsaved {
  given jsonDecoder: JsonDecoder[SalesorderdetailRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val salesorderdetailid = jsonObj.get("salesorderdetailid").toRight("Missing field 'salesorderdetailid'").flatMap(_.as(using Defaulted.jsonDecoder(using JsonDecoder.int)))
    val unitpricediscount = jsonObj.get("unitpricediscount").toRight("Missing field 'unitpricediscount'").flatMap(_.as(using Defaulted.jsonDecoder(using JsonDecoder.scalaBigDecimal)))
  ...
  given jsonEncoder: JsonEncoder[SalesorderdetailRowUnsaved] = new JsonEncoder[SalesorderdetailRowUnsaved] {
    override def unsafeEncode(a: SalesorderdetailRowUnsaved, indent: Option[Int], out: Write): Unit = {
      ...
      Defaulted.jsonEncoder(using JsonEncoder.int).unsafeEncode(a.salesorderdetailid, indent, out)
      out.write(",")
      out.write(""""unitpricediscount":""")
      Defaulted.jsonEncoder(using JsonEncoder.scalaBigDecimal).unsafeEncode(a.unitpricediscount, indent, out)
      out.write(",")
      out.write(""""rowguid":""")
