...
object CurrencyRowUnsaved {
  given jsonDecoder: JsonDecoder[CurrencyRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[CurrencyRowUnsaved] = new JsonEncoder[CurrencyRowUnsaved] {
