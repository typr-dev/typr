...
object CurrencyRow {
  given jdbcDecoder: JdbcDecoder[CurrencyRow] = new JdbcDecoder[CurrencyRow] {
  ...
  given jsonDecoder: JsonDecoder[CurrencyRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[CurrencyRow] = new JsonEncoder[CurrencyRow] {
