...
object VpersondemographicsViewRow {
  given jdbcDecoder: JdbcDecoder[VpersondemographicsViewRow] = new JdbcDecoder[VpersondemographicsViewRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, VpersondemographicsViewRow) =
      columIndex + 12 ->
        VpersondemographicsViewRow(
          ...
          totalpurchaseytd = JdbcDecoder.optionDecoder(using TypoMoney.jdbcDecoder).unsafeDecode(columIndex + 1, rs)._2,
          datefirstpurchase = JdbcDecoder.optionDecoder(using TypoLocalDate.jdbcDecoder).unsafeDecode(columIndex + 2, rs)._2,
          birthdate = JdbcDecoder.optionDecoder(using TypoLocalDate.jdbcDecoder).unsafeDecode(columIndex + 3, rs)._2,
          maritalstatus = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 4, rs)._2,
          yearlyincome = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 5, rs)._2,
          gender = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 6, rs)._2,
          totalchildren = JdbcDecoder.optionDecoder(using JdbcDecoder.intDecoder).unsafeDecode(columIndex + 7, rs)._2,
          numberchildrenathome = JdbcDecoder.optionDecoder(using JdbcDecoder.intDecoder).unsafeDecode(columIndex + 8, rs)._2,
          education = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 9, rs)._2,
          occupation = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 10, rs)._2,
          homeownerflag = JdbcDecoder.optionDecoder(using JdbcDecoder.booleanDecoder).unsafeDecode(columIndex + 11, rs)._2,
          numbercarsowned = JdbcDecoder.optionDecoder(using JdbcDecoder.intDecoder).unsafeDecode(columIndex + 12, rs)._2
        )
  }
  given jsonDecoder: JsonDecoder[VpersondemographicsViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val totalpurchaseytd = jsonObj.get("totalpurchaseytd").fold[Either[String, Option[TypoMoney]]](Right(None))(_.as(using JsonDecoder.option(using TypoMoney.jsonDecoder)))
    val datefirstpurchase = jsonObj.get("datefirstpurchase").fold[Either[String, Option[TypoLocalDate]]](Right(None))(_.as(using JsonDecoder.option(using TypoLocalDate.jsonDecoder)))
    val birthdate = jsonObj.get("birthdate").fold[Either[String, Option[TypoLocalDate]]](Right(None))(_.as(using JsonDecoder.option(using TypoLocalDate.jsonDecoder)))
    val maritalstatus = jsonObj.get("maritalstatus").fold[Either[String, Option[String]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.string)))
    val yearlyincome = jsonObj.get("yearlyincome").fold[Either[String, Option[String]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.string)))
    val gender = jsonObj.get("gender").fold[Either[String, Option[String]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.string)))
    val totalchildren = jsonObj.get("totalchildren").fold[Either[String, Option[Int]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.int)))
    val numberchildrenathome = jsonObj.get("numberchildrenathome").fold[Either[String, Option[Int]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.int)))
    val education = jsonObj.get("education").fold[Either[String, Option[String]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.string)))
    val occupation = jsonObj.get("occupation").fold[Either[String, Option[String]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.string)))
    val homeownerflag = jsonObj.get("homeownerflag").fold[Either[String, Option[Boolean]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.boolean)))
    val numbercarsowned = jsonObj.get("numbercarsowned").fold[Either[String, Option[Int]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.int)))
  ...
  given jsonEncoder: JsonEncoder[VpersondemographicsViewRow] = new JsonEncoder[VpersondemographicsViewRow] {
