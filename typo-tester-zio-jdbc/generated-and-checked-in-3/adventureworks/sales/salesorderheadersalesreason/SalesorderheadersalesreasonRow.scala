...
object SalesorderheadersalesreasonRow {
  ...
  given jdbcDecoder: JdbcDecoder[SalesorderheadersalesreasonRow] = new JdbcDecoder[SalesorderheadersalesreasonRow] {
  ...
  given jsonDecoder: JsonDecoder[SalesorderheadersalesreasonRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[SalesorderheadersalesreasonRow] = new JsonEncoder[SalesorderheadersalesreasonRow] {
