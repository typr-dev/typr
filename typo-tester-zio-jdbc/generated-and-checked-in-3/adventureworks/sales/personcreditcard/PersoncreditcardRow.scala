...
object PersoncreditcardRow {
  ...
  given jdbcDecoder: JdbcDecoder[PersoncreditcardRow] = new JdbcDecoder[PersoncreditcardRow] {
  ...
  given jsonDecoder: JsonDecoder[PersoncreditcardRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[PersoncreditcardRow] = new JsonEncoder[PersoncreditcardRow] {
