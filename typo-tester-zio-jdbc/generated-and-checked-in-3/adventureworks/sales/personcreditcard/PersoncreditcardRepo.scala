...
trait PersoncreditcardRepo {
  ...
  def deleteByIds(compositeIds: Array[PersoncreditcardId])(using encoder0: JdbcEncoder[Array[/* user-picked */ CustomCreditcardId]]): ZIO[ZConnection, Throwable, Long]
  ...
  def selectByIds(compositeIds: Array[PersoncreditcardId])(using encoder0: JdbcEncoder[Array[/* user-picked */ CustomCreditcardId]]): ZStream[ZConnection, Throwable, PersoncreditcardRow]
  def selectByIdsTracked(compositeIds: Array[PersoncreditcardId])(using encoder0: JdbcEncoder[Array[/* user-picked */ CustomCreditcardId]]): ZIO[ZConnection, Throwable, Map[PersoncreditcardId, PersoncreditcardRow]]
