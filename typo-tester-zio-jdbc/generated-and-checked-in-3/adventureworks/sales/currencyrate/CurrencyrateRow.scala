...
object CurrencyrateRow {
  given jdbcDecoder: JdbcDecoder[CurrencyrateRow] = new JdbcDecoder[CurrencyrateRow] {
  ...
  given jsonDecoder: JsonDecoder[CurrencyrateRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[CurrencyrateRow] = new JsonEncoder[CurrencyrateRow] {
  ...
  given text: Text[CurrencyrateRow] = Text.instance[CurrencyrateRow]{ (row, sb) =>
