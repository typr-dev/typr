...
object CountryregioncurrencyRow {
  ...
  given jdbcDecoder: JdbcDecoder[CountryregioncurrencyRow] = new JdbcDecoder[CountryregioncurrencyRow] {
  ...
  given jsonDecoder: JsonDecoder[CountryregioncurrencyRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[CountryregioncurrencyRow] = new JsonEncoder[CountryregioncurrencyRow] {
