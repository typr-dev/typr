...
object CountryregioncurrencyRowUnsaved {
  given jsonDecoder: JsonDecoder[CountryregioncurrencyRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[CountryregioncurrencyRowUnsaved] = new JsonEncoder[CountryregioncurrencyRowUnsaved] {
