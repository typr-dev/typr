...
object VindividualcustomerViewRow {
  given jdbcDecoder: JdbcDecoder[VindividualcustomerViewRow] = new JdbcDecoder[VindividualcustomerViewRow] {
  ...
  given jsonDecoder: JsonDecoder[VindividualcustomerViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[VindividualcustomerViewRow] = new JsonEncoder[VindividualcustomerViewRow] {
