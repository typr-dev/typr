...
object SalesterritoryRow {
  given jdbcDecoder: JdbcDecoder[SalesterritoryRow] = new JdbcDecoder[SalesterritoryRow] {
  ...
  given jsonDecoder: JsonDecoder[SalesterritoryRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val costytd = jsonObj.get("costytd").toRight("Missing field 'costytd'").flatMap(_.as(using JsonDecoder.scalaBigDecimal))
    val costlastyear = jsonObj.get("costlastyear").toRight("Missing field 'costlastyear'").flatMap(_.as(using JsonDecoder.scalaBigDecimal))
  ...
  given jsonEncoder: JsonEncoder[SalesterritoryRow] = new JsonEncoder[SalesterritoryRow] {
