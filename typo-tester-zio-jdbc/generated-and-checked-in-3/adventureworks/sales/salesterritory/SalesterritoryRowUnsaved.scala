...
object SalesterritoryRowUnsaved {
  given jsonDecoder: JsonDecoder[SalesterritoryRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[SalesterritoryRowUnsaved] = new JsonEncoder[SalesterritoryRowUnsaved] {
