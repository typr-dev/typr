...
object SpecialofferRow {
  given jdbcDecoder: JdbcDecoder[SpecialofferRow] = {
      ...
      override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, SpecialofferRow) =
        columIndex + 10 ->
          SpecialofferRow(
            ...
            maxqty = JdbcDecoder.optionDecoder(using JdbcDecoder.intDecoder).unsafeDecode(columIndex + 8, rs)._2,
  ...
  given jsonDecoder: JsonDecoder[SpecialofferRow] = {
    JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
      ...
      val discountpct = jsonObj.get("discountpct").toRight("Missing field 'discountpct'").flatMap(_.as(using JsonDecoder.scalaBigDecimal))
      ...
      val minqty = jsonObj.get("minqty").toRight("Missing field 'minqty'").flatMap(_.as(using JsonDecoder.int))
  ...
  given jsonEncoder: JsonEncoder[SpecialofferRow] = {
