...
object SpecialofferRow {
  given jdbcDecoder: JdbcDecoder[SpecialofferRow] = new JdbcDecoder[SpecialofferRow] {
  ...
  given jsonDecoder: JsonDecoder[SpecialofferRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[SpecialofferRow] = new JsonEncoder[SpecialofferRow] {
