...
object SalespersonquotahistoryRowUnsaved {
  given jsonDecoder: JsonDecoder[SalespersonquotahistoryRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[SalespersonquotahistoryRowUnsaved] = new JsonEncoder[SalespersonquotahistoryRowUnsaved] {
