...
object SalespersonquotahistoryRow {
  ...
  given jdbcDecoder: JdbcDecoder[SalespersonquotahistoryRow] = new JdbcDecoder[SalespersonquotahistoryRow] {
  ...
  given jsonDecoder: JsonDecoder[SalespersonquotahistoryRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[SalespersonquotahistoryRow] = new JsonEncoder[SalespersonquotahistoryRow] {
