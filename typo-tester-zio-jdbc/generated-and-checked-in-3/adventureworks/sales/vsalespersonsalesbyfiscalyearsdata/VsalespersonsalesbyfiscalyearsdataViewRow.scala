...
object VsalespersonsalesbyfiscalyearsdataViewRow {
  given jdbcDecoder: JdbcDecoder[VsalespersonsalesbyfiscalyearsdataViewRow] = new JdbcDecoder[VsalespersonsalesbyfiscalyearsdataViewRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, VsalespersonsalesbyfiscalyearsdataViewRow) =
      columIndex + 5 ->
        VsalespersonsalesbyfiscalyearsdataViewRow(
          ...
          salestotal = JdbcDecoder.optionDecoder(using JdbcDecoder.bigDecimalDecoderScala).unsafeDecode(columIndex + 4, rs)._2,
          fiscalyear = JdbcDecoder.optionDecoder(using JdbcDecoder.bigDecimalDecoderScala).unsafeDecode(columIndex + 5, rs)._2
        )
  }
  given jsonDecoder: JsonDecoder[VsalespersonsalesbyfiscalyearsdataViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val salestotal = jsonObj.get("salestotal").fold[Either[String, Option[BigDecimal]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.scalaBigDecimal)))
    val fiscalyear = jsonObj.get("fiscalyear").fold[Either[String, Option[BigDecimal]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.scalaBigDecimal)))
  ...
  given jsonEncoder: JsonEncoder[VsalespersonsalesbyfiscalyearsdataViewRow] = new JsonEncoder[VsalespersonsalesbyfiscalyearsdataViewRow] {
