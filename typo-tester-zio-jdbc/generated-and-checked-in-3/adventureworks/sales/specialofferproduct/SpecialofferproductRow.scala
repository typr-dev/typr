...
object SpecialofferproductRow {
  ...
  given jdbcDecoder: JdbcDecoder[SpecialofferproductRow] = {
  ...
  given jsonDecoder: JsonDecoder[SpecialofferproductRow] = {
  ...
  given jsonEncoder: JsonEncoder[SpecialofferproductRow] = {
