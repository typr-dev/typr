...
object SpecialofferproductRow {
  ...
  given jdbcDecoder: JdbcDecoder[SpecialofferproductRow] = new JdbcDecoder[SpecialofferproductRow] {
  ...
  given jsonDecoder: JsonDecoder[SpecialofferproductRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[SpecialofferproductRow] = new JsonEncoder[SpecialofferproductRow] {
