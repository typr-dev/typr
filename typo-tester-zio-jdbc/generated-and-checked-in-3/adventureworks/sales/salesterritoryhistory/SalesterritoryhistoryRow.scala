...
object SalesterritoryhistoryRow {
  ...
  given jdbcDecoder: JdbcDecoder[SalesterritoryhistoryRow] = new JdbcDecoder[SalesterritoryhistoryRow] {
  ...
  given jsonDecoder: JsonDecoder[SalesterritoryhistoryRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[SalesterritoryhistoryRow] = new JsonEncoder[SalesterritoryhistoryRow] {
