...
object SalesterritoryhistoryRowUnsaved {
  given jsonDecoder: JsonDecoder[SalesterritoryhistoryRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[SalesterritoryhistoryRowUnsaved] = new JsonEncoder[SalesterritoryhistoryRowUnsaved] {
