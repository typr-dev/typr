...
object SalestaxrateRow {
  given jdbcDecoder: JdbcDecoder[SalestaxrateRow] = new JdbcDecoder[SalestaxrateRow] {
  ...
  given jsonDecoder: JsonDecoder[SalestaxrateRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[SalestaxrateRow] = new JsonEncoder[SalestaxrateRow] {
