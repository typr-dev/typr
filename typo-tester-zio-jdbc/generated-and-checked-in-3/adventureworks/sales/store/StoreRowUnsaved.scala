...
object StoreRowUnsaved {
  given jsonDecoder: JsonDecoder[StoreRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[StoreRowUnsaved] = new JsonEncoder[StoreRowUnsaved] {
