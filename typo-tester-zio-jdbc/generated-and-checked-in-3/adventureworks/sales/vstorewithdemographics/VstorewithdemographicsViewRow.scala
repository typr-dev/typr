...
object VstorewithdemographicsViewRow {
  given jdbcDecoder: JdbcDecoder[VstorewithdemographicsViewRow] = {
  ...
  given jsonDecoder: JsonDecoder[VstorewithdemographicsViewRow] = {
  ...
  given jsonEncoder: JsonEncoder[VstorewithdemographicsViewRow] = {
