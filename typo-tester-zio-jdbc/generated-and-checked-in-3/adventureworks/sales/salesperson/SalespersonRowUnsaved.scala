...
object SalespersonRowUnsaved {
  given jsonDecoder: JsonDecoder[SalespersonRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val salesquota = jsonObj.get("salesquota").fold[Either[String, Option[BigDecimal]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.scalaBigDecimal)))
    val bonus = jsonObj.get("bonus").toRight("Missing field 'bonus'").flatMap(_.as(using Defaulted.jsonDecoder(using JsonDecoder.scalaBigDecimal)))
    val commissionpct = jsonObj.get("commissionpct").toRight("Missing field 'commissionpct'").flatMap(_.as(using Defaulted.jsonDecoder(using JsonDecoder.scalaBigDecimal)))
  ...
  given jsonEncoder: JsonEncoder[SalespersonRowUnsaved] = new JsonEncoder[SalespersonRowUnsaved] {
    override def unsafeEncode(a: SalespersonRowUnsaved, indent: Option[Int], out: Write): Unit = {
      ...
      out.write(",")
      out.write(""""bonus":""")
      Defaulted.jsonEncoder(using JsonEncoder.scalaBigDecimal).unsafeEncode(a.bonus, indent, out)
      out.write(",")
      out.write(""""commissionpct":""")
      Defaulted.jsonEncoder(using JsonEncoder.scalaBigDecimal).unsafeEncode(a.commissionpct, indent, out)
      out.write(",")
      out.write(""""salesytd":""")
