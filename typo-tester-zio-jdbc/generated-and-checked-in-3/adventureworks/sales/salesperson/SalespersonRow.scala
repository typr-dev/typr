...
object SalespersonRow {
  given jdbcDecoder: JdbcDecoder[SalespersonRow] = new JdbcDecoder[SalespersonRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, SalespersonRow) =
      columIndex + 8 ->
        SalespersonRow(
          ...
          territoryid = JdbcDecoder.optionDecoder(using SalesterritoryId.jdbcDecoder).unsafeDecode(columIndex + 1, rs)._2,
          salesquota = JdbcDecoder.optionDecoder(using JdbcDecoder.bigDecimalDecoderScala).unsafeDecode(columIndex + 2, rs)._2,
  ...
  given jsonDecoder: JsonDecoder[SalespersonRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val bonus = jsonObj.get("bonus").toRight("Missing field 'bonus'").flatMap(_.as(using JsonDecoder.scalaBigDecimal))
    val commissionpct = jsonObj.get("commissionpct").toRight("Missing field 'commissionpct'").flatMap(_.as(using JsonDecoder.scalaBigDecimal))
  ...
  given jsonEncoder: JsonEncoder[SalespersonRow] = new JsonEncoder[SalespersonRow] {
