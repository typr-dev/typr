...
object SalesorderheaderRow {
  given jdbcDecoder: JdbcDecoder[SalesorderheaderRow] = new JdbcDecoder[SalesorderheaderRow] {
  ...
  given jsonDecoder: JsonDecoder[SalesorderheaderRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[SalesorderheaderRow] = new JsonEncoder[SalesorderheaderRow] {
  ...
  given text: Text[SalesorderheaderRow] = Text.instance[SalesorderheaderRow]{ (row, sb) =>
