...
object SalesorderheaderRow {
  given jdbcDecoder: JdbcDecoder[SalesorderheaderRow] = {
      ...
      override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, SalesorderheaderRow) =
        columIndex + 24 ->
          SalesorderheaderRow(
            ...
            shipdate = JdbcDecoder.optionDecoder(using TypoLocalDateTime.jdbcDecoder).unsafeDecode(columIndex + 4, rs)._2,
            ...
            purchaseordernumber = JdbcDecoder.optionDecoder(using OrderNumber.jdbcDecoder).unsafeDecode(columIndex + 7, rs)._2,
            accountnumber = JdbcDecoder.optionDecoder(using AccountNumber.jdbcDecoder).unsafeDecode(columIndex + 8, rs)._2,
            customerid = CustomerId.jdbcDecoder.unsafeDecode(columIndex + 9, rs)._2,
            salespersonid = JdbcDecoder.optionDecoder(using BusinessentityId.jdbcDecoder).unsafeDecode(columIndex + 10, rs)._2,
            territoryid = JdbcDecoder.optionDecoder(using SalesterritoryId.jdbcDecoder).unsafeDecode(columIndex + 11, rs)._2,
            ...
            creditcardid = JdbcDecoder.optionDecoder(using CustomCreditcardId.jdbcDecoder).unsafeDecode(columIndex + 15, rs)._2,
            creditcardapprovalcode = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 16, rs)._2,
            currencyrateid = JdbcDecoder.optionDecoder(using CurrencyrateId.jdbcDecoder).unsafeDecode(columIndex + 17, rs)._2,
            ...
            totaldue = JdbcDecoder.optionDecoder(using JdbcDecoder.bigDecimalDecoderScala).unsafeDecode(columIndex + 21, rs)._2,
            comment = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 22, rs)._2,
  ...
  given jsonDecoder: JsonDecoder[SalesorderheaderRow] = {
  ...
  given jsonEncoder: JsonEncoder[SalesorderheaderRow] = {
