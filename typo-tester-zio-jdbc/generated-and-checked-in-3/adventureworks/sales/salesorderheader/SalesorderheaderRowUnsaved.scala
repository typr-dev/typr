...
object SalesorderheaderRowUnsaved {
  given jsonDecoder: JsonDecoder[SalesorderheaderRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[SalesorderheaderRowUnsaved] = new JsonEncoder[SalesorderheaderRowUnsaved] {
