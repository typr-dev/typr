...
object VstorewithcontactsViewRow {
  given jdbcDecoder: JdbcDecoder[VstorewithcontactsViewRow] = new JdbcDecoder[VstorewithcontactsViewRow] {
  ...
  given jsonDecoder: JsonDecoder[VstorewithcontactsViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[VstorewithcontactsViewRow] = new JsonEncoder[VstorewithcontactsViewRow] {
