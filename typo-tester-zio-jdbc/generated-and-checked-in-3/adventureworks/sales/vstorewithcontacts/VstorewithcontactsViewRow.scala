...
object VstorewithcontactsViewRow {
  given jdbcDecoder: JdbcDecoder[VstorewithcontactsViewRow] = {
  ...
  given jsonDecoder: JsonDecoder[VstorewithcontactsViewRow] = {
  ...
  given jsonEncoder: JsonEncoder[VstorewithcontactsViewRow] = {
