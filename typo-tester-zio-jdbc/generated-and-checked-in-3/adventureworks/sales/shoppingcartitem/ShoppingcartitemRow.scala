...
object ShoppingcartitemRow {
  given jdbcDecoder: JdbcDecoder[ShoppingcartitemRow] = new JdbcDecoder[ShoppingcartitemRow] {
  ...
  given jsonDecoder: JsonDecoder[ShoppingcartitemRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ShoppingcartitemRow] = new JsonEncoder[ShoppingcartitemRow] {
