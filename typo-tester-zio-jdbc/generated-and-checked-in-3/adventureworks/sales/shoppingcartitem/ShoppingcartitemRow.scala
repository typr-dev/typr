...
object ShoppingcartitemRow {
  given jdbcDecoder: JdbcDecoder[ShoppingcartitemRow] = {
  ...
  given jsonDecoder: JsonDecoder[ShoppingcartitemRow] = {
    JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
      val shoppingcartitemid = jsonObj.get("shoppingcartitemid").toRight("Missing field 'shoppingcartitemid'").flatMap(_.as(using ShoppingcartitemId.jsonDecoder))
      ...
      val datecreated = jsonObj.get("datecreated").toRight("Missing field 'datecreated'").flatMap(_.as(using TypoLocalDateTime.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[ShoppingcartitemRow] = {
