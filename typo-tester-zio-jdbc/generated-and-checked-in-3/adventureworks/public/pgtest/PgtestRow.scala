...
object PgtestRow {
  given jdbcDecoder: JdbcDecoder[PgtestRow] = new JdbcDecoder[PgtestRow] {
  ...
  given jsonDecoder: JsonDecoder[PgtestRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[PgtestRow] = new JsonEncoder[PgtestRow] {
