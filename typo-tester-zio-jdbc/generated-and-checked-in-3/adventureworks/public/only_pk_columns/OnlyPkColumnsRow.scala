...
object OnlyPkColumnsRow {
  ...
  given jdbcDecoder: JdbcDecoder[OnlyPkColumnsRow] = new JdbcDecoder[OnlyPkColumnsRow] {
  ...
  given jsonDecoder: JsonDecoder[OnlyPkColumnsRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[OnlyPkColumnsRow] = new JsonEncoder[OnlyPkColumnsRow] {
