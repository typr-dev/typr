...
object IdentityTestRow {
  given jdbcDecoder: JdbcDecoder[IdentityTestRow] = new JdbcDecoder[IdentityTestRow] {
  ...
  given jsonDecoder: JsonDecoder[IdentityTestRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    val alwaysGenerated = jsonObj.get("always_generated").toRight("Missing field 'always_generated'").flatMap(_.as(using JsonDecoder.int))
    val defaultGenerated = jsonObj.get("default_generated").toRight("Missing field 'default_generated'").flatMap(_.as(using JsonDecoder.int))
  ...
  given jsonEncoder: JsonEncoder[IdentityTestRow] = new JsonEncoder[IdentityTestRow] {
