...
object IdentityTestRowUnsaved {
  given jsonDecoder: JsonDecoder[IdentityTestRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[IdentityTestRowUnsaved] = new JsonEncoder[IdentityTestRowUnsaved] {
