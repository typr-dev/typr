...
object TestSakSoknadsalternativRow {
  ...
  given jdbcDecoder: JdbcDecoder[TestSakSoknadsalternativRow] = new JdbcDecoder[TestSakSoknadsalternativRow] {
  ...
  given jsonDecoder: JsonDecoder[TestSakSoknadsalternativRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[TestSakSoknadsalternativRow] = new JsonEncoder[TestSakSoknadsalternativRow] {
