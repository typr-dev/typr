...
object TestSakSoknadsalternativRow {
  ...
  given jdbcDecoder: JdbcDecoder[TestSakSoknadsalternativRow] = {
  ...
  given jsonDecoder: JsonDecoder[TestSakSoknadsalternativRow] = {
    JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
      val organisasjonskodeSaksbehandler = jsonObj.get("organisasjonskode_saksbehandler").toRight("Missing field 'organisasjonskode_saksbehandler'").flatMap(_.as(using JsonDecoder.string))
      ...
      val organisasjonskodeTilbyder = jsonObj.get("organisasjonskode_tilbyder").toRight("Missing field 'organisasjonskode_tilbyder'").flatMap(_.as(using TestOrganisasjonId.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[TestSakSoknadsalternativRow] = {
