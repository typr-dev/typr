...
object Issue1422Row {
  ...
  given jsonDecoder: JsonDecoder[Issue1422Row] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[Issue1422Row] = new JsonEncoder[Issue1422Row] {
