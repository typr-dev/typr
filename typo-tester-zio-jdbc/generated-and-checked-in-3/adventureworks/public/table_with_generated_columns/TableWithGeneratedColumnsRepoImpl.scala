...
class TableWithGeneratedColumnsRepoImpl extends TableWithGeneratedColumnsRepo {
  ...
  override def insertStreaming(unsaved: ZStream[ZConnection, Throwable, TableWithGeneratedColumnsRow], batchSize: Int = 10000): ZIO[ZConnection, Throwable, Long] = {
    streamingInsert(s"""COPY "public"."table-with-generated-columns"("name") FROM STDIN""", batchSize, unsaved)(using TableWithGeneratedColumnsRow.text)
  }
  ...
  override def insertUnsavedStreaming(unsaved: ZStream[ZConnection, Throwable, TableWithGeneratedColumnsRowUnsaved], batchSize: Int = 10000): ZIO[ZConnection, Throwable, Long] = {
    streamingInsert(s"""COPY "public"."table-with-generated-columns"("name") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using TableWithGeneratedColumnsRowUnsaved.text)
  }
  ...
  override def selectById(name: TableWithGeneratedColumnsId): ZIO[ZConnection, Throwable, Option[TableWithGeneratedColumnsRow]] = {
    sql"""select "name", "name-type-always" from "public"."table-with-generated-columns" where "name" = ${Segment.paramSegment(name)(using TableWithGeneratedColumnsId.setter)}""".query(using TableWithGeneratedColumnsRow.jdbcDecoder).selectOne
  }
  override def selectByIds(names: Array[TableWithGeneratedColumnsId]): ZStream[ZConnection, Throwable, TableWithGeneratedColumnsRow] = {
    sql"""select "name", "name-type-always" from "public"."table-with-generated-columns" where "name" = ANY(${Segment.paramSegment(names)(using TableWithGeneratedColumnsId.arraySetter)})""".query(using TableWithGeneratedColumnsRow.jdbcDecoder).selectStream()
  }
  ...
  override def upsertStreaming(unsaved: ZStream[ZConnection, Throwable, TableWithGeneratedColumnsRow], batchSize: Int = 10000): ZIO[ZConnection, Throwable, Long] = {
    ...
    val copied = streamingInsert(s"""copy table-with-generated-columns_TEMP("name") from stdin""", batchSize, unsaved)(using TableWithGeneratedColumnsRow.text)
