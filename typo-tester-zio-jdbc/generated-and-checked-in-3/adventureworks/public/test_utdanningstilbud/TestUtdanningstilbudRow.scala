...
object TestUtdanningstilbudRow {
  ...
  given jdbcDecoder: JdbcDecoder[TestUtdanningstilbudRow] = {
  ...
  given jsonDecoder: JsonDecoder[TestUtdanningstilbudRow] = {
  ...
  given jsonEncoder: JsonEncoder[TestUtdanningstilbudRow] = {
