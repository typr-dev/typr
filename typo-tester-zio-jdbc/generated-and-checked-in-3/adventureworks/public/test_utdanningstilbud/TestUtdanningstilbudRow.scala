...
object TestUtdanningstilbudRow {
  ...
  given jdbcDecoder: JdbcDecoder[TestUtdanningstilbudRow] = new JdbcDecoder[TestUtdanningstilbudRow] {
  ...
  given jsonDecoder: JsonDecoder[TestUtdanningstilbudRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[TestUtdanningstilbudRow] = new JsonEncoder[TestUtdanningstilbudRow] {
