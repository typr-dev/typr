...
object PersonRowJoinSqlRow {
  given jdbcDecoder: JdbcDecoder[PersonRowJoinSqlRow] = {
      ...
      override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, PersonRowJoinSqlRow) =
        columIndex + 2 ->
          PersonRowJoinSqlRow(
            ...
            email = JdbcDecoder.optionDecoder(using TypoRecord.arrayJdbcDecoder).unsafeDecode(columIndex + 1, rs)._2,
            emails = JdbcDecoder.optionDecoder(using TypoRecord.arrayJdbcDecoder).unsafeDecode(columIndex + 2, rs)._2
          )
    }
  }

  given jsonDecoder: JsonDecoder[PersonRowJoinSqlRow] = {
  ...
  given jsonEncoder: JsonEncoder[PersonRowJoinSqlRow] = {
