...
object CrViewRow {
  given jdbcDecoder: JdbcDecoder[CrViewRow] = new JdbcDecoder[CrViewRow] {
  ...
  given jsonDecoder: JsonDecoder[CrViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[CrViewRow] = new JsonEncoder[CrViewRow] {
