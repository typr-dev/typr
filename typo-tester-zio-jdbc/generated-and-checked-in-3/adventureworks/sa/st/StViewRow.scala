...
object StViewRow {
  given jdbcDecoder: JdbcDecoder[StViewRow] = new JdbcDecoder[StViewRow] {
  ...
  given jsonDecoder: JsonDecoder[StViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[StViewRow] = new JsonEncoder[StViewRow] {
