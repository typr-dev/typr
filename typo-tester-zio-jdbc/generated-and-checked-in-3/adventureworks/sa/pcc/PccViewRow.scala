...
object PccViewRow {
  given jdbcDecoder: JdbcDecoder[PccViewRow] = new JdbcDecoder[PccViewRow] {
  ...
  given jsonDecoder: JsonDecoder[PccViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[PccViewRow] = new JsonEncoder[PccViewRow] {
