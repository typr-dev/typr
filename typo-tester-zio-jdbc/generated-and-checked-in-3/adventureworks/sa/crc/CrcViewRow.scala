...
object CrcViewRow {
  given jdbcDecoder: JdbcDecoder[CrcViewRow] = new JdbcDecoder[CrcViewRow] {
  ...
  given jsonDecoder: JsonDecoder[CrcViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[CrcViewRow] = new JsonEncoder[CrcViewRow] {
