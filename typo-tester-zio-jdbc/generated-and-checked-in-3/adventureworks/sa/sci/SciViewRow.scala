...
object SciViewRow {
  given jdbcDecoder: JdbcDecoder[SciViewRow] = new JdbcDecoder[SciViewRow] {
  ...
  given jsonDecoder: JsonDecoder[SciViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    val id = jsonObj.get("id").toRight("Missing field 'id'").flatMap(_.as(using ShoppingcartitemId.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[SciViewRow] = new JsonEncoder[SciViewRow] {
