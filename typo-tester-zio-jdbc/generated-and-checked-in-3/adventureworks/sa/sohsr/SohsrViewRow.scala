...
object SohsrViewRow {
  given jdbcDecoder: JdbcDecoder[SohsrViewRow] = new JdbcDecoder[SohsrViewRow] {
  ...
  given jsonDecoder: JsonDecoder[SohsrViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[SohsrViewRow] = new JsonEncoder[SohsrViewRow] {
