...
object CcViewRow {
  given jdbcDecoder: JdbcDecoder[CcViewRow] = new JdbcDecoder[CcViewRow] {
  ...
  given jsonDecoder: JsonDecoder[CcViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    val id = jsonObj.get("id").toRight("Missing field 'id'").flatMap(_.as(using CustomCreditcardId.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[CcViewRow] = new JsonEncoder[CcViewRow] {
