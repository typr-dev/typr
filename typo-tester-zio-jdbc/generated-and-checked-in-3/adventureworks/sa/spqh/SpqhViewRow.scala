...
object SpqhViewRow {
  given jdbcDecoder: JdbcDecoder[SpqhViewRow] = new JdbcDecoder[SpqhViewRow] {
  ...
  given jsonDecoder: JsonDecoder[SpqhViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[SpqhViewRow] = new JsonEncoder[SpqhViewRow] {
