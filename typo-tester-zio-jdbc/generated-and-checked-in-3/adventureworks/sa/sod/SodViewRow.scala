...
object SodViewRow {
  given jdbcDecoder: JdbcDecoder[SodViewRow] = new JdbcDecoder[SodViewRow] {
  ...
  given jsonDecoder: JsonDecoder[SodViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[SodViewRow] = new JsonEncoder[SodViewRow] {
