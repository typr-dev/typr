...
object SopViewRow {
  given jdbcDecoder: JdbcDecoder[SopViewRow] = new JdbcDecoder[SopViewRow] {
  ...
  given jsonDecoder: JsonDecoder[SopViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[SopViewRow] = new JsonEncoder[SopViewRow] {
