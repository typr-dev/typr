...
object TrViewRow {
  given jdbcDecoder: JdbcDecoder[TrViewRow] = new JdbcDecoder[TrViewRow] {
  ...
  given jsonDecoder: JsonDecoder[TrViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    val id = jsonObj.get("id").toRight("Missing field 'id'").flatMap(_.as(using SalestaxrateId.jsonDecoder))
    val salestaxrateid = jsonObj.get("salestaxrateid").toRight("Missing field 'salestaxrateid'").flatMap(_.as(using SalestaxrateId.jsonDecoder))
    ...
    val taxrate = jsonObj.get("taxrate").toRight("Missing field 'taxrate'").flatMap(_.as(using JsonDecoder.scalaBigDecimal))
  ...
  given jsonEncoder: JsonEncoder[TrViewRow] = new JsonEncoder[TrViewRow] {
