...
object SpViewRow {
  given jdbcDecoder: JdbcDecoder[SpViewRow] = new JdbcDecoder[SpViewRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, SpViewRow) =
      columIndex + 9 ->
        SpViewRow(
          ...
          territoryid = JdbcDecoder.optionDecoder(using SalesterritoryId.jdbcDecoder).unsafeDecode(columIndex + 2, rs)._2,
          salesquota = JdbcDecoder.optionDecoder(using JdbcDecoder.bigDecimalDecoderScala).unsafeDecode(columIndex + 3, rs)._2,
  ...
  given jsonDecoder: JsonDecoder[SpViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[SpViewRow] = new JsonEncoder[SpViewRow] {
