...
object ShipmethodRowUnsaved {
  given jsonDecoder: JsonDecoder[ShipmethodRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ShipmethodRowUnsaved] = new JsonEncoder[ShipmethodRowUnsaved] {
