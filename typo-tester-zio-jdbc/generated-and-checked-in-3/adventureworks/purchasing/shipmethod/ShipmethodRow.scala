...
object ShipmethodRow {
  given jdbcDecoder: JdbcDecoder[ShipmethodRow] = new JdbcDecoder[ShipmethodRow] {
  ...
  given jsonDecoder: JsonDecoder[ShipmethodRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ShipmethodRow] = new JsonEncoder[ShipmethodRow] {
