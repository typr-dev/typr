...
class ShipmethodRepoImpl extends ShipmethodRepo {
  ...
  override def deleteById(shipmethodid: ShipmethodId): ZIO[ZConnection, Throwable, Boolean] = {
    sql"""delete from "purchasing"."shipmethod" where "shipmethodid" = ${Segment.paramSegment(shipmethodid)(using ShipmethodId.setter)}""".delete.map(_ > 0)
  }
  ...
  override def insert(unsaved: ShipmethodRowUnsaved): ZIO[ZConnection, Throwable, ShipmethodRow] = {
    val fs = List(
      ...
      unsaved.shipmethodid match {
        ...
        case Defaulted.Provided(value) => Some((sql""""shipmethodid"""", sql"${Segment.paramSegment(value: ShipmethodId)(using ShipmethodId.setter)}::int4"))
      },
      unsaved.shipbase match {
        case Defaulted.UseDefault => None
        case Defaulted.Provided(value) => Some((sql""""shipbase"""", sql"${Segment.paramSegment(value: BigDecimal)(using Setter.bigDecimalScalaSetter)}::numeric"))
      },
      unsaved.shiprate match {
        case Defaulted.UseDefault => None
        case Defaulted.Provided(value) => Some((sql""""shiprate"""", sql"${Segment.paramSegment(value: BigDecimal)(using Setter.bigDecimalScalaSetter)}::numeric"))
      },
  ...
  override def insertStreaming(unsaved: ZStream[ZConnection, Throwable, ShipmethodRow], batchSize: Int = 10000): ZIO[ZConnection, Throwable, Long] = {
    streamingInsert(s"""COPY "purchasing"."shipmethod"("shipmethodid", "name", "shipbase", "shiprate", "rowguid", "modifieddate") FROM STDIN""", batchSize, unsaved)(using ShipmethodRow.text)
  }
  ...
  override def insertUnsavedStreaming(unsaved: ZStream[ZConnection, Throwable, ShipmethodRowUnsaved], batchSize: Int = 10000): ZIO[ZConnection, Throwable, Long] = {
    streamingInsert(s"""COPY "purchasing"."shipmethod"("name", "shipmethodid", "shipbase", "shiprate", "rowguid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using ShipmethodRowUnsaved.text)
  }
  ...
  override def selectById(shipmethodid: ShipmethodId): ZIO[ZConnection, Throwable, Option[ShipmethodRow]] = {
    sql"""select "shipmethodid", "name", "shipbase", "shiprate", "rowguid", "modifieddate"::text from "purchasing"."shipmethod" where "shipmethodid" = ${Segment.paramSegment(shipmethodid)(using ShipmethodId.setter)}""".query(using ShipmethodRow.jdbcDecoder).selectOne
  }
  override def selectByIds(shipmethodids: Array[ShipmethodId]): ZStream[ZConnection, Throwable, ShipmethodRow] = {
    sql"""select "shipmethodid", "name", "shipbase", "shiprate", "rowguid", "modifieddate"::text from "purchasing"."shipmethod" where "shipmethodid" = ANY(${Segment.paramSegment(shipmethodids)(using ShipmethodId.arraySetter)})""".query(using ShipmethodRow.jdbcDecoder).selectStream()
  }
  ...
  override def update(row: ShipmethodRow): ZIO[ZConnection, Throwable, Option[ShipmethodRow]] = {
    ...
    sql"""update "purchasing"."shipmethod"
          set "name" = ${Segment.paramSegment(row.name)(using Name.setter)}::varchar,
              "shipbase" = ${Segment.paramSegment(row.shipbase)(using Setter.bigDecimalScalaSetter)}::numeric,
              "shiprate" = ${Segment.paramSegment(row.shiprate)(using Setter.bigDecimalScalaSetter)}::numeric,
          ...
          where "shipmethodid" = ${Segment.paramSegment(shipmethodid)(using ShipmethodId.setter)}
          returning "shipmethodid", "name", "shipbase", "shiprate", "rowguid", "modifieddate"::text"""
      .query(using ShipmethodRow.jdbcDecoder)
      .selectOne
  }
  override def upsert(unsaved: ShipmethodRow): ZIO[ZConnection, Throwable, UpdateResult[ShipmethodRow]] = {
    sql"""insert into "purchasing"."shipmethod"("shipmethodid", "name", "shipbase", "shiprate", "rowguid", "modifieddate")
          values (
            ...
            ${Segment.paramSegment(unsaved.shipbase)(using Setter.bigDecimalScalaSetter)}::numeric,
            ${Segment.paramSegment(unsaved.shiprate)(using Setter.bigDecimalScalaSetter)}::numeric,
  ...
  override def upsertStreaming(unsaved: ZStream[ZConnection, Throwable, ShipmethodRow], batchSize: Int = 10000): ZIO[ZConnection, Throwable, Long] = {
    ...
    val copied = streamingInsert(s"""copy shipmethod_TEMP("shipmethodid", "name", "shipbase", "shiprate", "rowguid", "modifieddate") from stdin""", batchSize, unsaved)(using ShipmethodRow.text)
