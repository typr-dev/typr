...
object VvendorwithcontactsViewRow {
  given jdbcDecoder: JdbcDecoder[VvendorwithcontactsViewRow] = new JdbcDecoder[VvendorwithcontactsViewRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, VvendorwithcontactsViewRow) =
      columIndex + 11 ->
        VvendorwithcontactsViewRow(
          ...
          middlename = JdbcDecoder.optionDecoder(using Name.jdbcDecoder).unsafeDecode(columIndex + 5, rs)._2,
          ...
          phonenumber = JdbcDecoder.optionDecoder(using Phone.jdbcDecoder).unsafeDecode(columIndex + 8, rs)._2,
          phonenumbertype = JdbcDecoder.optionDecoder(using Name.jdbcDecoder).unsafeDecode(columIndex + 9, rs)._2,
          emailaddress = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 10, rs)._2,
          emailpromotion = JdbcDecoder.intDecoder.unsafeDecode(columIndex + 11, rs)._2
        )
  }
  given jsonDecoder: JsonDecoder[VvendorwithcontactsViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[VvendorwithcontactsViewRow] = new JsonEncoder[VvendorwithcontactsViewRow] {
