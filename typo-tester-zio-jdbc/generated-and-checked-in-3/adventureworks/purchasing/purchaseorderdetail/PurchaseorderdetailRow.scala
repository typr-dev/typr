...
object PurchaseorderdetailRow {
  ...
  given jdbcDecoder: JdbcDecoder[PurchaseorderdetailRow] = new JdbcDecoder[PurchaseorderdetailRow] {
  ...
  given jsonDecoder: JsonDecoder[PurchaseorderdetailRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[PurchaseorderdetailRow] = new JsonEncoder[PurchaseorderdetailRow] {
