...
object PurchaseorderdetailRow {
  ...
  given jdbcDecoder: JdbcDecoder[PurchaseorderdetailRow] = {
  ...
  given jsonDecoder: JsonDecoder[PurchaseorderdetailRow] = {
  ...
  given jsonEncoder: JsonEncoder[PurchaseorderdetailRow] = {
