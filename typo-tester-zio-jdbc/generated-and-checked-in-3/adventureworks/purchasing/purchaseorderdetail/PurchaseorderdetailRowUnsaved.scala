...
object PurchaseorderdetailRowUnsaved {
  given jsonDecoder: JsonDecoder[PurchaseorderdetailRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[PurchaseorderdetailRowUnsaved] = new JsonEncoder[PurchaseorderdetailRowUnsaved] {
  ...
  given text: Text[PurchaseorderdetailRowUnsaved] = Text.instance[PurchaseorderdetailRowUnsaved]{ (row, sb) =>
    ...
    sb.append(Text.DELIMETER)
    Defaulted.text(using Text.intInstance).unsafeEncode(row.purchaseorderdetailid, sb)
    sb.append(Text.DELIMETER)
