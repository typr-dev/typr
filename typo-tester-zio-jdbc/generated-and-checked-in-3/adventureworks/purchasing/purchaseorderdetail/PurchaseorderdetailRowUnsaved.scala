...
object PurchaseorderdetailRowUnsaved {
  given jsonDecoder: JsonDecoder[PurchaseorderdetailRowUnsaved] = {
    JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
      ...
      val unitprice = jsonObj.get("unitprice").toRight("Missing field 'unitprice'").flatMap(_.as(using JsonDecoder.scalaBigDecimal))
      val receivedqty = jsonObj.get("receivedqty").toRight("Missing field 'receivedqty'").flatMap(_.as(using JsonDecoder.scalaBigDecimal))
      val rejectedqty = jsonObj.get("rejectedqty").toRight("Missing field 'rejectedqty'").flatMap(_.as(using JsonDecoder.scalaBigDecimal))
      val purchaseorderdetailid = jsonObj.get("purchaseorderdetailid").toRight("Missing field 'purchaseorderdetailid'").flatMap(_.as(using Defaulted.jsonDecoder(using JsonDecoder.int)))
  ...
  given jsonEncoder: JsonEncoder[PurchaseorderdetailRowUnsaved] = {
    new JsonEncoder[PurchaseorderdetailRowUnsaved] {
      override def unsafeEncode(a: PurchaseorderdetailRowUnsaved, indent: Option[Int], out: Write): Unit = {
        ...
        Defaulted.jsonEncoder(using JsonEncoder.int).unsafeEncode(a.purchaseorderdetailid, indent, out)
        out.write(",")
