...
object VvendorwithaddressesViewRow {
  given jdbcDecoder: JdbcDecoder[VvendorwithaddressesViewRow] = new JdbcDecoder[VvendorwithaddressesViewRow] {
  ...
  given jsonDecoder: JsonDecoder[VvendorwithaddressesViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[VvendorwithaddressesViewRow] = new JsonEncoder[VvendorwithaddressesViewRow] {
