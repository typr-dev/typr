...
object VvendorwithaddressesViewRow {
  given jdbcDecoder: JdbcDecoder[VvendorwithaddressesViewRow] = {
  ...
  given jsonDecoder: JsonDecoder[VvendorwithaddressesViewRow] = {
  ...
  given jsonEncoder: JsonEncoder[VvendorwithaddressesViewRow] = {
