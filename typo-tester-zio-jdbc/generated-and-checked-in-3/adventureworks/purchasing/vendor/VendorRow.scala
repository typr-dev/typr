...
object VendorRow {
  given jdbcDecoder: JdbcDecoder[VendorRow] = new JdbcDecoder[VendorRow] {
  ...
  given jsonDecoder: JsonDecoder[VendorRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[VendorRow] = new JsonEncoder[VendorRow] {
  ...
  given text: Text[VendorRow] = Text.instance[VendorRow]{ (row, sb) =>
