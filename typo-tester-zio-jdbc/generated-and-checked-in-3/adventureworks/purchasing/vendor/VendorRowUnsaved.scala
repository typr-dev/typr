...
object VendorRowUnsaved {
  given jsonDecoder: JsonDecoder[VendorRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[VendorRowUnsaved] = new JsonEncoder[VendorRowUnsaved] {
