...
object PurchaseorderheaderRowUnsaved {
  given jsonDecoder: JsonDecoder[PurchaseorderheaderRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[PurchaseorderheaderRowUnsaved] = new JsonEncoder[PurchaseorderheaderRowUnsaved] {
  ...
  given text: Text[PurchaseorderheaderRowUnsaved] = Text.instance[PurchaseorderheaderRowUnsaved]{ (row, sb) =>
    ...
    sb.append(Text.DELIMETER)
    Defaulted.text(using PurchaseorderheaderId.text).unsafeEncode(row.purchaseorderid, sb)
    sb.append(Text.DELIMETER)
