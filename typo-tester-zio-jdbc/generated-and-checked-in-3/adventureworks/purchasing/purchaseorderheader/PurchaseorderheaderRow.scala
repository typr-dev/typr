...
object PurchaseorderheaderRow {
  given jdbcDecoder: JdbcDecoder[PurchaseorderheaderRow] = {
      ...
      override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, PurchaseorderheaderRow) =
        columIndex + 11 ->
          PurchaseorderheaderRow(
            ...
            shipdate = JdbcDecoder.optionDecoder(using TypoLocalDateTime.jdbcDecoder).unsafeDecode(columIndex + 7, rs)._2,
  ...
  given jsonDecoder: JsonDecoder[PurchaseorderheaderRow] = {
  ...
  given jsonEncoder: JsonEncoder[PurchaseorderheaderRow] = {
