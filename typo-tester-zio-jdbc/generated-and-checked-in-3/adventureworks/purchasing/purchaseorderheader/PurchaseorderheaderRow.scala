...
object PurchaseorderheaderRow {
  given jdbcDecoder: JdbcDecoder[PurchaseorderheaderRow] = new JdbcDecoder[PurchaseorderheaderRow] {
  ...
  given jsonDecoder: JsonDecoder[PurchaseorderheaderRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[PurchaseorderheaderRow] = new JsonEncoder[PurchaseorderheaderRow] {
