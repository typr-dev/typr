...
object ProductvendorRowUnsaved {
  given jsonDecoder: JsonDecoder[ProductvendorRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductvendorRowUnsaved] = new JsonEncoder[ProductvendorRowUnsaved] {
