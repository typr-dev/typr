...
object ProductvendorRow {
  ...
  given jdbcDecoder: JdbcDecoder[ProductvendorRow] = {
      ...
      override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, ProductvendorRow) =
        columIndex + 10 ->
          ProductvendorRow(
            ...
            lastreceiptcost = JdbcDecoder.optionDecoder(using JdbcDecoder.bigDecimalDecoderScala).unsafeDecode(columIndex + 4, rs)._2,
            lastreceiptdate = JdbcDecoder.optionDecoder(using TypoLocalDateTime.jdbcDecoder).unsafeDecode(columIndex + 5, rs)._2,
            ...
            onorderqty = JdbcDecoder.optionDecoder(using JdbcDecoder.intDecoder).unsafeDecode(columIndex + 8, rs)._2,
  ...
  given jsonDecoder: JsonDecoder[ProductvendorRow] = {
  ...
  given jsonEncoder: JsonEncoder[ProductvendorRow] = {
