...
object ProductvendorRow {
  ...
  given jdbcDecoder: JdbcDecoder[ProductvendorRow] = new JdbcDecoder[ProductvendorRow] {
  ...
  given jsonDecoder: JsonDecoder[ProductvendorRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductvendorRow] = new JsonEncoder[ProductvendorRow] {
