...
object PersonDynamicSqlRow {
  given jdbcDecoder: JdbcDecoder[PersonDynamicSqlRow] = new JdbcDecoder[PersonDynamicSqlRow] {
  ...
  given jsonDecoder: JsonDecoder[PersonDynamicSqlRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[PersonDynamicSqlRow] = new JsonEncoder[PersonDynamicSqlRow] {
