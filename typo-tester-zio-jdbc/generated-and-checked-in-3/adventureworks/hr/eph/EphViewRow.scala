...
object EphViewRow {
  given jdbcDecoder: JdbcDecoder[EphViewRow] = new JdbcDecoder[EphViewRow] {
  ...
  given jsonDecoder: JsonDecoder[EphViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[EphViewRow] = new JsonEncoder[EphViewRow] {
