...
object TypoInterval {
  given arrayJdbcDecoder: JdbcDecoder[Array[TypoInterval]] = JdbcDecoder[Array[TypoInterval]]((rs: ResultSet) => (i: Int) =>
    rs.getArray(i) match {
      case null => null
  ...
  given arraySetter: Setter[Array[TypoInterval]] = Setter.forSqlType((ps, i, v) =>
    ps.setArray(
      i,
  ...
  given jdbcDecoder: JdbcDecoder[TypoInterval] = JdbcDecoder[TypoInterval](
    (rs: ResultSet) => (i: Int) => {
  ...
  given jsonDecoder: JsonDecoder[TypoInterval] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[TypoInterval] = new JsonEncoder[TypoInterval] {
