...
object TypoCircle {
  given arrayJdbcDecoder: JdbcDecoder[Array[TypoCircle]] = JdbcDecoder[Array[TypoCircle]]((rs: ResultSet) => (i: Int) =>
    rs.getArray(i) match {
      case null => null
  ...
  given arraySetter: Setter[Array[TypoCircle]] = Setter.forSqlType((ps, i, v) =>
    ps.setArray(
      i,
  ...
  given jdbcDecoder: JdbcDecoder[TypoCircle] = JdbcDecoder[TypoCircle](
    (rs: ResultSet) => (i: Int) => {
  ...
  given jsonDecoder: JsonDecoder[TypoCircle] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[TypoCircle] = new JsonEncoder[TypoCircle] {
