...
object TypoLocalTime {
  ...
  given arrayJdbcDecoder: JdbcDecoder[Array[TypoLocalTime]] = JdbcDecoder[Array[TypoLocalTime]]((rs: ResultSet) => (i: Int) =>
    rs.getArray(i) match {
      case null => null
  ...
  given arrayJdbcEncoder: JdbcEncoder[Array[TypoLocalTime]] = JdbcEncoder.singleParamEncoder(using arraySetter)
  given arraySetter: Setter[Array[TypoLocalTime]] = Setter.forSqlType((ps, i, v) =>
    ps.setArray(
      i,
  ...
  given jdbcDecoder: JdbcDecoder[TypoLocalTime] = JdbcDecoder[TypoLocalTime](
    (rs: ResultSet) => (i: Int) => {
