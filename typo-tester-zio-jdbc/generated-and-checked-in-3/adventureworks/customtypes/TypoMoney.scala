...
object TypoMoney {
  given arrayJdbcDecoder: JdbcDecoder[Array[TypoMoney]] = JdbcDecoder[Array[TypoMoney]]((rs: ResultSet) => (i: Int) =>
    rs.getArray(i) match {
      case null => null
  ...
  given arraySetter: Setter[Array[TypoMoney]] = Setter.forSqlType((ps, i, v) =>
    ps.setArray(
      i,
  ...
  given jdbcDecoder: JdbcDecoder[TypoMoney] = JdbcDecoder[TypoMoney](
    (rs: ResultSet) => (i: Int) => {
