...
object TypoLineSegment {
  given arrayJdbcDecoder: JdbcDecoder[Array[TypoLineSegment]] = JdbcDecoder[Array[TypoLineSegment]]((rs: ResultSet) => (i: Int) =>
    rs.getArray(i) match {
      case null => null
  ...
  given arraySetter: Setter[Array[TypoLineSegment]] = Setter.forSqlType((ps, i, v) =>
    ps.setArray(
      i,
  ...
  given jdbcDecoder: JdbcDecoder[TypoLineSegment] = JdbcDecoder[TypoLineSegment](
    (rs: ResultSet) => (i: Int) => {
  ...
  given jsonDecoder: JsonDecoder[TypoLineSegment] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[TypoLineSegment] = new JsonEncoder[TypoLineSegment] {
