...
object TypoBox {
  given arrayJdbcDecoder: JdbcDecoder[Array[TypoBox]] = JdbcDecoder[Array[TypoBox]]((rs: ResultSet) => (i: Int) =>
    rs.getArray(i) match {
      case null => null
  ...
  given arraySetter: Setter[Array[TypoBox]] = Setter.forSqlType((ps, i, v) =>
    ps.setArray(
      i,
  ...
  given jdbcDecoder: JdbcDecoder[TypoBox] = JdbcDecoder[TypoBox](
    (rs: ResultSet) => (i: Int) => {
  ...
  given jsonDecoder: JsonDecoder[TypoBox] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[TypoBox] = new JsonEncoder[TypoBox] {
