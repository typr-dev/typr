...
object TypoJsonb {
  given arrayJdbcDecoder: JdbcDecoder[Array[TypoJsonb]] = JdbcDecoder[Array[TypoJsonb]]((rs: ResultSet) => (i: Int) =>
    rs.getArray(i) match {
      case null => null
  ...
  given arraySetter: Setter[Array[TypoJsonb]] = Setter.forSqlType((ps, i, v) =>
    ps.setArray(
      i,
  ...
  given jdbcDecoder: JdbcDecoder[TypoJsonb] = JdbcDecoder[TypoJsonb](
    (rs: ResultSet) => (i: Int) => {
