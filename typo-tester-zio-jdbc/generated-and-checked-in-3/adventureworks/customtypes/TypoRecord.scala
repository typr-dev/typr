...
object TypoRecord {
  given arrayJdbcDecoder: JdbcDecoder[Array[TypoRecord]] = JdbcDecoder[Array[TypoRecord]]((rs: ResultSet) => (i: Int) =>
    rs.getArray(i) match {
      case null => null
  ...
  given arraySetter: Setter[Array[TypoRecord]] = Setter.forSqlType((ps, i, v) =>
    ps.setArray(
      i,
  ...
  given jdbcDecoder: JdbcDecoder[TypoRecord] = JdbcDecoder[TypoRecord](
    (rs: ResultSet) => (i: Int) => {
