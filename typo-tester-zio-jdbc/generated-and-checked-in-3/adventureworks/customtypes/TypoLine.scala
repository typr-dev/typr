...
object TypoLine {
  given arrayJdbcDecoder: JdbcDecoder[Array[TypoLine]] = JdbcDecoder[Array[TypoLine]]((rs: ResultSet) => (i: Int) =>
    rs.getArray(i) match {
      case null => null
  ...
  given arraySetter: Setter[Array[TypoLine]] = Setter.forSqlType((ps, i, v) =>
    ps.setArray(
      i,
  ...
  given jdbcDecoder: JdbcDecoder[TypoLine] = JdbcDecoder[TypoLine](
    (rs: ResultSet) => (i: Int) => {
  ...
  given jsonDecoder: JsonDecoder[TypoLine] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[TypoLine] = new JsonEncoder[TypoLine] {
  ...
  given text: Text[TypoLine] = new Text[TypoLine] {
