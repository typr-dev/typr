...
object PersonDetailSqlRow {
  given jdbcDecoder: JdbcDecoder[PersonDetailSqlRow] = new JdbcDecoder[PersonDetailSqlRow] {
  ...
  given jsonDecoder: JsonDecoder[PersonDetailSqlRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[PersonDetailSqlRow] = new JsonEncoder[PersonDetailSqlRow] {
