...
object BecViewRow {
  given jdbcDecoder: JdbcDecoder[BecViewRow] = new JdbcDecoder[BecViewRow] {
  ...
  given jsonDecoder: JsonDecoder[BecViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[BecViewRow] = new JsonEncoder[BecViewRow] {
