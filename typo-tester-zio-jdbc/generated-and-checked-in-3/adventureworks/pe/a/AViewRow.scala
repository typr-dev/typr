...
object AViewRow {
  given jdbcDecoder: JdbcDecoder[AViewRow] = new JdbcDecoder[AViewRow] {
  ...
  given jsonDecoder: JsonDecoder[AViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[AViewRow] = new JsonEncoder[AViewRow] {
