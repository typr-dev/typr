...
object PntViewRow {
  given jdbcDecoder: JdbcDecoder[PntViewRow] = new JdbcDecoder[PntViewRow] {
  ...
  given jsonDecoder: JsonDecoder[PntViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    val id = jsonObj.get("id").toRight("Missing field 'id'").flatMap(_.as(using PhonenumbertypeId.jsonDecoder))
    val phonenumbertypeid = jsonObj.get("phonenumbertypeid").toRight("Missing field 'phonenumbertypeid'").flatMap(_.as(using PhonenumbertypeId.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[PntViewRow] = new JsonEncoder[PntViewRow] {
