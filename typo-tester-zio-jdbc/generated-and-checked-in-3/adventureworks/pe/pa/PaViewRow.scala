...
object PaViewRow {
  given jdbcDecoder: JdbcDecoder[PaViewRow] = new JdbcDecoder[PaViewRow] {
  ...
  given jsonDecoder: JsonDecoder[PaViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[PaViewRow] = new JsonEncoder[PaViewRow] {
