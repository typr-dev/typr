...
object PersonphoneRow {
  ...
  given jdbcDecoder: JdbcDecoder[PersonphoneRow] = new JdbcDecoder[PersonphoneRow] {
  ...
  given jsonDecoder: JsonDecoder[PersonphoneRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[PersonphoneRow] = new JsonEncoder[PersonphoneRow] {
