...
object BusinessentityaddressRow {
  ...
  given jdbcDecoder: JdbcDecoder[BusinessentityaddressRow] = {
  ...
  given jsonDecoder: JsonDecoder[BusinessentityaddressRow] = {
  ...
  given jsonEncoder: JsonEncoder[BusinessentityaddressRow] = {
