...
object BusinessentityaddressRow {
  ...
  given jdbcDecoder: JdbcDecoder[BusinessentityaddressRow] = new JdbcDecoder[BusinessentityaddressRow] {
  ...
  given jsonDecoder: JsonDecoder[BusinessentityaddressRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[BusinessentityaddressRow] = new JsonEncoder[BusinessentityaddressRow] {
