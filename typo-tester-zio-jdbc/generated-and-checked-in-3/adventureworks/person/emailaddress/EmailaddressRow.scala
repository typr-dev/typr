...
object EmailaddressRow {
  ...
  given jdbcDecoder: JdbcDecoder[EmailaddressRow] = new JdbcDecoder[EmailaddressRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, EmailaddressRow) =
      columIndex + 4 ->
        EmailaddressRow(
          ...
          emailaddress = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 2, rs)._2,
  ...
  given jsonDecoder: JsonDecoder[EmailaddressRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[EmailaddressRow] = new JsonEncoder[EmailaddressRow] {
