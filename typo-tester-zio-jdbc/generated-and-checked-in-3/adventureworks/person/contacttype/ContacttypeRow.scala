...
object ContacttypeRow {
  given jdbcDecoder: JdbcDecoder[ContacttypeRow] = new JdbcDecoder[ContacttypeRow] {
  ...
  given jsonDecoder: JsonDecoder[ContacttypeRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ContacttypeRow] = new JsonEncoder[ContacttypeRow] {
