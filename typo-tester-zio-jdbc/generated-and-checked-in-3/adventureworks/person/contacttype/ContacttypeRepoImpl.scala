...
class ContacttypeRepoImpl extends ContacttypeRepo {
  ...
  override def deleteById(contacttypeid: ContacttypeId): ZIO[ZConnection, Throwable, Boolean] = {
    sql"""delete from "person"."contacttype" where "contacttypeid" = ${Segment.paramSegment(contacttypeid)(using ContacttypeId.setter)}""".delete.map(_ > 0)
  }
  ...
  override def insert(unsaved: ContacttypeRowUnsaved): ZIO[ZConnection, Throwable, ContacttypeRow] = {
    val fs = List(
      ...
      unsaved.contacttypeid match {
        ...
        case Defaulted.Provided(value) => Some((sql""""contacttypeid"""", sql"${Segment.paramSegment(value: ContacttypeId)(using ContacttypeId.setter)}::int4"))
      },
  ...
  override def insertStreaming(unsaved: ZStream[ZConnection, Throwable, ContacttypeRow], batchSize: Int = 10000): ZIO[ZConnection, Throwable, Long] = {
    streamingInsert(s"""COPY "person"."contacttype"("contacttypeid", "name", "modifieddate") FROM STDIN""", batchSize, unsaved)(using ContacttypeRow.text)
  }
  ...
  override def insertUnsavedStreaming(unsaved: ZStream[ZConnection, Throwable, ContacttypeRowUnsaved], batchSize: Int = 10000): ZIO[ZConnection, Throwable, Long] = {
    streamingInsert(s"""COPY "person"."contacttype"("name", "contacttypeid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using ContacttypeRowUnsaved.text)
  }
  ...
  override def selectById(contacttypeid: ContacttypeId): ZIO[ZConnection, Throwable, Option[ContacttypeRow]] = {
    sql"""select "contacttypeid", "name", "modifieddate"::text from "person"."contacttype" where "contacttypeid" = ${Segment.paramSegment(contacttypeid)(using ContacttypeId.setter)}""".query(using ContacttypeRow.jdbcDecoder).selectOne
  }
  override def selectByIds(contacttypeids: Array[ContacttypeId]): ZStream[ZConnection, Throwable, ContacttypeRow] = {
    sql"""select "contacttypeid", "name", "modifieddate"::text from "person"."contacttype" where "contacttypeid" = ANY(${Segment.paramSegment(contacttypeids)(using ContacttypeId.arraySetter)})""".query(using ContacttypeRow.jdbcDecoder).selectStream()
  }
  ...
  override def update(row: ContacttypeRow): ZIO[ZConnection, Throwable, Option[ContacttypeRow]] = {
    ...
    sql"""update "person"."contacttype"
          ...
          where "contacttypeid" = ${Segment.paramSegment(contacttypeid)(using ContacttypeId.setter)}
          returning "contacttypeid", "name", "modifieddate"::text"""
      .query(using ContacttypeRow.jdbcDecoder)
      .selectOne
  }
  ...
  override def upsertStreaming(unsaved: ZStream[ZConnection, Throwable, ContacttypeRow], batchSize: Int = 10000): ZIO[ZConnection, Throwable, Long] = {
    ...
    val copied = streamingInsert(s"""copy contacttype_TEMP("contacttypeid", "name", "modifieddate") from stdin""", batchSize, unsaved)(using ContacttypeRow.text)
