...
object BusinessentitycontactRowUnsaved {
  given jsonDecoder: JsonDecoder[BusinessentitycontactRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[BusinessentitycontactRowUnsaved] = new JsonEncoder[BusinessentitycontactRowUnsaved] {
