...
object BusinessentitycontactRow {
  ...
  given jdbcDecoder: JdbcDecoder[BusinessentitycontactRow] = new JdbcDecoder[BusinessentitycontactRow] {
  ...
  given jsonDecoder: JsonDecoder[BusinessentitycontactRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[BusinessentitycontactRow] = new JsonEncoder[BusinessentitycontactRow] {
