...
object BusinessentityRow {
  given jdbcDecoder: JdbcDecoder[BusinessentityRow] = new JdbcDecoder[BusinessentityRow] {
  ...
  given jsonDecoder: JsonDecoder[BusinessentityRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[BusinessentityRow] = new JsonEncoder[BusinessentityRow] {
