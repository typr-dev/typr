...
object BusinessentityRowUnsaved {
  given jsonDecoder: JsonDecoder[BusinessentityRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    val businessentityid = jsonObj.get("businessentityid").toRight("Missing field 'businessentityid'").flatMap(_.as(using Defaulted.jsonDecoder(using BusinessentityId.jsonDecoder)))
  ...
  given jsonEncoder: JsonEncoder[BusinessentityRowUnsaved] = new JsonEncoder[BusinessentityRowUnsaved] {
    override def unsafeEncode(a: BusinessentityRowUnsaved, indent: Option[Int], out: Write): Unit = {
      out.write("{")
      out.write(""""businessentityid":""")
      Defaulted.jsonEncoder(using BusinessentityId.jsonEncoder).unsafeEncode(a.businessentityid, indent, out)
      out.write(",")
      out.write(""""rowguid":""")
