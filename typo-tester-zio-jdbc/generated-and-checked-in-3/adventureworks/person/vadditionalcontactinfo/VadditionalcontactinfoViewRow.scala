...
object VadditionalcontactinfoViewRow {
  given jdbcDecoder: JdbcDecoder[VadditionalcontactinfoViewRow] = new JdbcDecoder[VadditionalcontactinfoViewRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, VadditionalcontactinfoViewRow) =
      columIndex + 16 ->
        VadditionalcontactinfoViewRow(
          ...
          middlename = JdbcDecoder.optionDecoder(using Name.jdbcDecoder).unsafeDecode(columIndex + 2, rs)._2,
          lastname = Name.jdbcDecoder.unsafeDecode(columIndex + 3, rs)._2,
          telephonenumber = JdbcDecoder.optionDecoder(using TypoXml.jdbcDecoder).unsafeDecode(columIndex + 4, rs)._2,
          telephonespecialinstructions = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 5, rs)._2,
          street = JdbcDecoder.optionDecoder(using TypoXml.jdbcDecoder).unsafeDecode(columIndex + 6, rs)._2,
          city = JdbcDecoder.optionDecoder(using TypoXml.jdbcDecoder).unsafeDecode(columIndex + 7, rs)._2,
          stateprovince = JdbcDecoder.optionDecoder(using TypoXml.jdbcDecoder).unsafeDecode(columIndex + 8, rs)._2,
          postalcode = JdbcDecoder.optionDecoder(using TypoXml.jdbcDecoder).unsafeDecode(columIndex + 9, rs)._2,
          countryregion = JdbcDecoder.optionDecoder(using TypoXml.jdbcDecoder).unsafeDecode(columIndex + 10, rs)._2,
          homeaddressspecialinstructions = JdbcDecoder.optionDecoder(using TypoXml.jdbcDecoder).unsafeDecode(columIndex + 11, rs)._2,
          emailaddress = JdbcDecoder.optionDecoder(using TypoXml.jdbcDecoder).unsafeDecode(columIndex + 12, rs)._2,
          emailspecialinstructions = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 13, rs)._2,
          emailtelephonenumber = JdbcDecoder.optionDecoder(using TypoXml.jdbcDecoder).unsafeDecode(columIndex + 14, rs)._2,
  ...
  given jsonDecoder: JsonDecoder[VadditionalcontactinfoViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val telephonenumber = jsonObj.get("telephonenumber").fold[Either[String, Option[TypoXml]]](Right(None))(_.as(using JsonDecoder.option(using TypoXml.jsonDecoder)))
    val telephonespecialinstructions = jsonObj.get("telephonespecialinstructions").fold[Either[String, Option[String]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.string)))
    val street = jsonObj.get("street").fold[Either[String, Option[TypoXml]]](Right(None))(_.as(using JsonDecoder.option(using TypoXml.jsonDecoder)))
    val city = jsonObj.get("city").fold[Either[String, Option[TypoXml]]](Right(None))(_.as(using JsonDecoder.option(using TypoXml.jsonDecoder)))
    val stateprovince = jsonObj.get("stateprovince").fold[Either[String, Option[TypoXml]]](Right(None))(_.as(using JsonDecoder.option(using TypoXml.jsonDecoder)))
    val postalcode = jsonObj.get("postalcode").fold[Either[String, Option[TypoXml]]](Right(None))(_.as(using JsonDecoder.option(using TypoXml.jsonDecoder)))
    val countryregion = jsonObj.get("countryregion").fold[Either[String, Option[TypoXml]]](Right(None))(_.as(using JsonDecoder.option(using TypoXml.jsonDecoder)))
    val homeaddressspecialinstructions = jsonObj.get("homeaddressspecialinstructions").fold[Either[String, Option[TypoXml]]](Right(None))(_.as(using JsonDecoder.option(using TypoXml.jsonDecoder)))
    val emailaddress = jsonObj.get("emailaddress").fold[Either[String, Option[TypoXml]]](Right(None))(_.as(using JsonDecoder.option(using TypoXml.jsonDecoder)))
    val emailspecialinstructions = jsonObj.get("emailspecialinstructions").fold[Either[String, Option[String]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.string)))
    val emailtelephonenumber = jsonObj.get("emailtelephonenumber").fold[Either[String, Option[TypoXml]]](Right(None))(_.as(using JsonDecoder.option(using TypoXml.jsonDecoder)))
  ...
  given jsonEncoder: JsonEncoder[VadditionalcontactinfoViewRow] = new JsonEncoder[VadditionalcontactinfoViewRow] {
