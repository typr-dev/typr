...
object VadditionalcontactinfoViewRow {
  given jdbcDecoder: JdbcDecoder[VadditionalcontactinfoViewRow] = {
  ...
  given jsonDecoder: JsonDecoder[VadditionalcontactinfoViewRow] = {
  ...
  given jsonEncoder: JsonEncoder[VadditionalcontactinfoViewRow] = {
