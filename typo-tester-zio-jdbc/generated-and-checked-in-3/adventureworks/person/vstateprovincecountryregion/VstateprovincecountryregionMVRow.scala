...
object VstateprovincecountryregionMVRow {
  given jdbcDecoder: JdbcDecoder[VstateprovincecountryregionMVRow] = new JdbcDecoder[VstateprovincecountryregionMVRow] {
  ...
  given jsonDecoder: JsonDecoder[VstateprovincecountryregionMVRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val isonlystateprovinceflag = jsonObj.get("isonlystateprovinceflag").toRight("Missing field 'isonlystateprovinceflag'").flatMap(_.as(using Flag.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[VstateprovincecountryregionMVRow] = new JsonEncoder[VstateprovincecountryregionMVRow] {
