...
object VstateprovincecountryregionMVRow {
  given jdbcDecoder: JdbcDecoder[VstateprovincecountryregionMVRow] = {
  ...
  given jsonDecoder: JsonDecoder[VstateprovincecountryregionMVRow] = {
  ...
  given jsonEncoder: JsonEncoder[VstateprovincecountryregionMVRow] = {
