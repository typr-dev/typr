...
object PasswordRow {
  given jdbcDecoder: JdbcDecoder[PasswordRow] = new JdbcDecoder[PasswordRow] {
  ...
  given jsonDecoder: JsonDecoder[PasswordRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val passwordhash = jsonObj.get("passwordhash").toRight("Missing field 'passwordhash'").flatMap(_.as(using JsonDecoder.string))
    val passwordsalt = jsonObj.get("passwordsalt").toRight("Missing field 'passwordsalt'").flatMap(_.as(using JsonDecoder.string))
  ...
  given jsonEncoder: JsonEncoder[PasswordRow] = new JsonEncoder[PasswordRow] {
  ...
  given text: Text[PasswordRow] = Text.instance[PasswordRow]{ (row, sb) =>
