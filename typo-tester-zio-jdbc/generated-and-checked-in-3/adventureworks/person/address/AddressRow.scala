...
object AddressRow {
  given jdbcDecoder: JdbcDecoder[AddressRow] = new JdbcDecoder[AddressRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, AddressRow) =
      columIndex + 8 ->
        AddressRow(
          ...
          addressline2 = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 2, rs)._2,
          ...
          spatiallocation = JdbcDecoder.optionDecoder(using TypoBytea.jdbcDecoder).unsafeDecode(columIndex + 6, rs)._2,
  ...
  given jsonDecoder: JsonDecoder[AddressRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[AddressRow] = new JsonEncoder[AddressRow] {
