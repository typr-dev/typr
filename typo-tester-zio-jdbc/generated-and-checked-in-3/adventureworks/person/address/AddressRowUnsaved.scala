...
object AddressRowUnsaved {
  given jsonDecoder: JsonDecoder[AddressRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val addressid = jsonObj.get("addressid").toRight("Missing field 'addressid'").flatMap(_.as(using Defaulted.jsonDecoder(using AddressId.jsonDecoder)))
  ...
  given jsonEncoder: JsonEncoder[AddressRowUnsaved] = new JsonEncoder[AddressRowUnsaved] {
    override def unsafeEncode(a: AddressRowUnsaved, indent: Option[Int], out: Write): Unit = {
      ...
      out.write(",")
      out.write(""""addressid":""")
      Defaulted.jsonEncoder(using AddressId.jsonEncoder).unsafeEncode(a.addressid, indent, out)
      out.write(",")
      out.write(""""rowguid":""")
