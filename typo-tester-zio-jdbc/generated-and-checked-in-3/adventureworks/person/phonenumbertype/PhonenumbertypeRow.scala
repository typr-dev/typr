...
object PhonenumbertypeRow {
  given jdbcDecoder: JdbcDecoder[PhonenumbertypeRow] = new JdbcDecoder[PhonenumbertypeRow] {
  ...
  given jsonDecoder: JsonDecoder[PhonenumbertypeRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[PhonenumbertypeRow] = new JsonEncoder[PhonenumbertypeRow] {
