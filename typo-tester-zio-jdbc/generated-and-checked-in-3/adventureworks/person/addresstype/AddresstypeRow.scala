...
object AddresstypeRow {
  given jdbcDecoder: JdbcDecoder[AddresstypeRow] = new JdbcDecoder[AddresstypeRow] {
  ...
  given jsonDecoder: JsonDecoder[AddresstypeRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[AddresstypeRow] = new JsonEncoder[AddresstypeRow] {
