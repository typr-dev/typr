...
object StateprovinceRow {
  given jdbcDecoder: JdbcDecoder[StateprovinceRow] = new JdbcDecoder[StateprovinceRow] {
  ...
  given jsonDecoder: JsonDecoder[StateprovinceRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[StateprovinceRow] = new JsonEncoder[StateprovinceRow] {
  ...
  given text: Text[StateprovinceRow] = Text.instance[StateprovinceRow]{ (row, sb) =>
