...
object ThaViewRow {
  given jdbcDecoder: JdbcDecoder[ThaViewRow] = new JdbcDecoder[ThaViewRow] {
  ...
  given jsonDecoder: JsonDecoder[ThaViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    val id = jsonObj.get("id").toRight("Missing field 'id'").flatMap(_.as(using TransactionhistoryarchiveId.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[ThaViewRow] = new JsonEncoder[ThaViewRow] {
