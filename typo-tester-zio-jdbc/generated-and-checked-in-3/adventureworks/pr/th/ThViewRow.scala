...
object ThViewRow {
  given jdbcDecoder: JdbcDecoder[ThViewRow] = new JdbcDecoder[ThViewRow] {
  ...
  given jsonDecoder: JsonDecoder[ThViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    val id = jsonObj.get("id").toRight("Missing field 'id'").flatMap(_.as(using TransactionhistoryId.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[ThViewRow] = new JsonEncoder[ThViewRow] {
