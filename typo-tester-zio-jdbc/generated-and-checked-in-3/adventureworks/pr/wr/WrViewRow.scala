...
object WrViewRow {
  given jdbcDecoder: JdbcDecoder[WrViewRow] = new JdbcDecoder[WrViewRow] {
  ...
  given jsonDecoder: JsonDecoder[WrViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    val id = jsonObj.get("id").toRight("Missing field 'id'").flatMap(_.as(using WorkorderId.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[WrViewRow] = new JsonEncoder[WrViewRow] {
