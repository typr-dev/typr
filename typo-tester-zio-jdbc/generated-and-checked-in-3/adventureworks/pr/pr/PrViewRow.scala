...
object PrViewRow {
  given jdbcDecoder: JdbcDecoder[PrViewRow] = new JdbcDecoder[PrViewRow] {
  ...
  given jsonDecoder: JsonDecoder[PrViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    val id = jsonObj.get("id").toRight("Missing field 'id'").flatMap(_.as(using ProductreviewId.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[PrViewRow] = new JsonEncoder[PrViewRow] {
