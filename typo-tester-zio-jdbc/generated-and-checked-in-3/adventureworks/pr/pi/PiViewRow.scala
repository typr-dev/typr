...
object PiViewRow {
  given jdbcDecoder: JdbcDecoder[PiViewRow] = new JdbcDecoder[PiViewRow] {
  ...
  given jsonDecoder: JsonDecoder[PiViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[PiViewRow] = new JsonEncoder[PiViewRow] {
