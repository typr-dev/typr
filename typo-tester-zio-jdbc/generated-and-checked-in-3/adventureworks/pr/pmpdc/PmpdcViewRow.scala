...
object PmpdcViewRow {
  given jdbcDecoder: JdbcDecoder[PmpdcViewRow] = new JdbcDecoder[PmpdcViewRow] {
  ...
  given jsonDecoder: JsonDecoder[PmpdcViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[PmpdcViewRow] = new JsonEncoder[PmpdcViewRow] {
