...
object PcViewRow {
  given jdbcDecoder: JdbcDecoder[PcViewRow] = new JdbcDecoder[PcViewRow] {
  ...
  given jsonDecoder: JsonDecoder[PcViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    val id = jsonObj.get("id").toRight("Missing field 'id'").flatMap(_.as(using ProductcategoryId.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[PcViewRow] = new JsonEncoder[PcViewRow] {
