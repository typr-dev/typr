...
object BomViewRow {
  given jdbcDecoder: JdbcDecoder[BomViewRow] = new JdbcDecoder[BomViewRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, BomViewRow) =
      columIndex + 9 ->
        BomViewRow(
          ...
          productassemblyid = JdbcDecoder.optionDecoder(using ProductId.jdbcDecoder).unsafeDecode(columIndex + 2, rs)._2,
          ...
          enddate = JdbcDecoder.optionDecoder(using TypoLocalDateTime.jdbcDecoder).unsafeDecode(columIndex + 5, rs)._2,
  ...
  given jsonDecoder: JsonDecoder[BomViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[BomViewRow] = new JsonEncoder[BomViewRow] {
