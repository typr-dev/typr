...
object LViewRow {
  given jdbcDecoder: JdbcDecoder[LViewRow] = new JdbcDecoder[LViewRow] {
  ...
  given jsonDecoder: JsonDecoder[LViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    val id = jsonObj.get("id").toRight("Missing field 'id'").flatMap(_.as(using LocationId.jsonDecoder))
    ...
    val costrate = jsonObj.get("costrate").toRight("Missing field 'costrate'").flatMap(_.as(using JsonDecoder.scalaBigDecimal))
    val availability = jsonObj.get("availability").toRight("Missing field 'availability'").flatMap(_.as(using JsonDecoder.scalaBigDecimal))
  ...
  given jsonEncoder: JsonEncoder[LViewRow] = new JsonEncoder[LViewRow] {
