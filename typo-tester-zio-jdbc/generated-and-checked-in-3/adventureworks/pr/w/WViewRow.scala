...
object WViewRow {
  given jdbcDecoder: JdbcDecoder[WViewRow] = new JdbcDecoder[WViewRow] {
  ...
  given jsonDecoder: JsonDecoder[WViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[WViewRow] = new JsonEncoder[WViewRow] {
