...
object PlphViewRow {
  given jdbcDecoder: JdbcDecoder[PlphViewRow] = new JdbcDecoder[PlphViewRow] {
  ...
  given jsonDecoder: JsonDecoder[PlphViewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[PlphViewRow] = new JsonEncoder[PlphViewRow] {
