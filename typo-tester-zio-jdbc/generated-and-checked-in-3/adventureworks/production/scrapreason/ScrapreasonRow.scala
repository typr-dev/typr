...
object ScrapreasonRow {
  given jdbcDecoder: JdbcDecoder[ScrapreasonRow] = new JdbcDecoder[ScrapreasonRow] {
  ...
  given jsonDecoder: JsonDecoder[ScrapreasonRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ScrapreasonRow] = new JsonEncoder[ScrapreasonRow] {
