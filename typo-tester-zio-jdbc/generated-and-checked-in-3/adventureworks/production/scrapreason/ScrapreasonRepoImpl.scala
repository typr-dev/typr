...
class ScrapreasonRepoImpl extends ScrapreasonRepo {
  ...
  override def deleteById(scrapreasonid: ScrapreasonId): ZIO[ZConnection, Throwable, Boolean] = {
    sql"""delete from "production"."scrapreason" where "scrapreasonid" = ${Segment.paramSegment(scrapreasonid)(using ScrapreasonId.setter)}""".delete.map(_ > 0)
  }
  ...
  override def insert(unsaved: ScrapreasonRowUnsaved): ZIO[ZConnection, Throwable, ScrapreasonRow] = {
    val fs = List(
      ...
      unsaved.scrapreasonid match {
        ...
        case Defaulted.Provided(value) => Some((sql""""scrapreasonid"""", sql"${Segment.paramSegment(value: ScrapreasonId)(using ScrapreasonId.setter)}::int4"))
      },
  ...
  override def insertStreaming(unsaved: ZStream[ZConnection, Throwable, ScrapreasonRow], batchSize: Int = 10000): ZIO[ZConnection, Throwable, Long] = {
    streamingInsert(s"""COPY "production"."scrapreason"("scrapreasonid", "name", "modifieddate") FROM STDIN""", batchSize, unsaved)(using ScrapreasonRow.text)
  }
  ...
  override def insertUnsavedStreaming(unsaved: ZStream[ZConnection, Throwable, ScrapreasonRowUnsaved], batchSize: Int = 10000): ZIO[ZConnection, Throwable, Long] = {
    streamingInsert(s"""COPY "production"."scrapreason"("name", "scrapreasonid", "modifieddate") FROM STDIN (DEFAULT '__DEFAULT_VALUE__')""", batchSize, unsaved)(using ScrapreasonRowUnsaved.text)
  }
  ...
  override def selectById(scrapreasonid: ScrapreasonId): ZIO[ZConnection, Throwable, Option[ScrapreasonRow]] = {
    sql"""select "scrapreasonid", "name", "modifieddate"::text from "production"."scrapreason" where "scrapreasonid" = ${Segment.paramSegment(scrapreasonid)(using ScrapreasonId.setter)}""".query(using ScrapreasonRow.jdbcDecoder).selectOne
  }
  override def selectByIds(scrapreasonids: Array[ScrapreasonId]): ZStream[ZConnection, Throwable, ScrapreasonRow] = {
    sql"""select "scrapreasonid", "name", "modifieddate"::text from "production"."scrapreason" where "scrapreasonid" = ANY(${Segment.paramSegment(scrapreasonids)(using ScrapreasonId.arraySetter)})""".query(using ScrapreasonRow.jdbcDecoder).selectStream()
  }
  ...
  override def update(row: ScrapreasonRow): ZIO[ZConnection, Throwable, Option[ScrapreasonRow]] = {
    ...
    sql"""update "production"."scrapreason"
          ...
          where "scrapreasonid" = ${Segment.paramSegment(scrapreasonid)(using ScrapreasonId.setter)}
          returning "scrapreasonid", "name", "modifieddate"::text"""
      .query(using ScrapreasonRow.jdbcDecoder)
      .selectOne
  }
  ...
  override def upsertStreaming(unsaved: ZStream[ZConnection, Throwable, ScrapreasonRow], batchSize: Int = 10000): ZIO[ZConnection, Throwable, Long] = {
    ...
    val copied = streamingInsert(s"""copy scrapreason_TEMP("scrapreasonid", "name", "modifieddate") from stdin""", batchSize, unsaved)(using ScrapreasonRow.text)
