...
object IllustrationRowUnsaved {
  given jsonDecoder: JsonDecoder[IllustrationRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[IllustrationRowUnsaved] = new JsonEncoder[IllustrationRowUnsaved] {
