...
object UnitmeasureRow {
  given jdbcDecoder: JdbcDecoder[UnitmeasureRow] = new JdbcDecoder[UnitmeasureRow] {
  ...
  given jsonDecoder: JsonDecoder[UnitmeasureRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[UnitmeasureRow] = new JsonEncoder[UnitmeasureRow] {
