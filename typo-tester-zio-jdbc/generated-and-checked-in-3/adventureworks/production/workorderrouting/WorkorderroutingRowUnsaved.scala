...
object WorkorderroutingRowUnsaved {
  given jsonDecoder: JsonDecoder[WorkorderroutingRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[WorkorderroutingRowUnsaved] = new JsonEncoder[WorkorderroutingRowUnsaved] {
