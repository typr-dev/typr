...
object VproductmodelcatalogdescriptionViewRow {
  given jdbcDecoder: JdbcDecoder[VproductmodelcatalogdescriptionViewRow] = {
  ...
  given jsonDecoder: JsonDecoder[VproductmodelcatalogdescriptionViewRow] = {
  ...
  given jsonEncoder: JsonEncoder[VproductmodelcatalogdescriptionViewRow] = {
