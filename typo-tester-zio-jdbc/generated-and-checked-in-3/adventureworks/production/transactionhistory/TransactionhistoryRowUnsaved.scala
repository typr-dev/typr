...
object TransactionhistoryRowUnsaved {
  given jsonDecoder: JsonDecoder[TransactionhistoryRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[TransactionhistoryRowUnsaved] = new JsonEncoder[TransactionhistoryRowUnsaved] {
