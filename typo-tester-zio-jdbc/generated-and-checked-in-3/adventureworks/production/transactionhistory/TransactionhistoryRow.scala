...
object TransactionhistoryRow {
  given jdbcDecoder: JdbcDecoder[TransactionhistoryRow] = new JdbcDecoder[TransactionhistoryRow] {
  ...
  given jsonDecoder: JsonDecoder[TransactionhistoryRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[TransactionhistoryRow] = new JsonEncoder[TransactionhistoryRow] {
