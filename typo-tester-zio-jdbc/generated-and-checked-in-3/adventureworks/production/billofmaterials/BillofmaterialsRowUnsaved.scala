...
object BillofmaterialsRowUnsaved {
  given jsonDecoder: JsonDecoder[BillofmaterialsRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[BillofmaterialsRowUnsaved] = new JsonEncoder[BillofmaterialsRowUnsaved] {
