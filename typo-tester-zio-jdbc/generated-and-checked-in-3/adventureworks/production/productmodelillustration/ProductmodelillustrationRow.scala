...
object ProductmodelillustrationRow {
  ...
  given jdbcDecoder: JdbcDecoder[ProductmodelillustrationRow] = new JdbcDecoder[ProductmodelillustrationRow] {
  ...
  given jsonDecoder: JsonDecoder[ProductmodelillustrationRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductmodelillustrationRow] = new JsonEncoder[ProductmodelillustrationRow] {
