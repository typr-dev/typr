...
object ProductmodelillustrationRowUnsaved {
  given jsonDecoder: JsonDecoder[ProductmodelillustrationRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductmodelillustrationRowUnsaved] = new JsonEncoder[ProductmodelillustrationRowUnsaved] {
