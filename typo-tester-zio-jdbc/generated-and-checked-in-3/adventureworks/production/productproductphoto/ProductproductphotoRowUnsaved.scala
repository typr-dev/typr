...
object ProductproductphotoRowUnsaved {
  given jsonDecoder: JsonDecoder[ProductproductphotoRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductproductphotoRowUnsaved] = new JsonEncoder[ProductproductphotoRowUnsaved] {
