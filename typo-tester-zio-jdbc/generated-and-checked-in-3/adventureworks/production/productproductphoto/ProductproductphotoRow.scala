...
object ProductproductphotoRow {
  ...
  given jdbcDecoder: JdbcDecoder[ProductproductphotoRow] = new JdbcDecoder[ProductproductphotoRow] {
  ...
  given jsonDecoder: JsonDecoder[ProductproductphotoRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val primary = jsonObj.get("primary").toRight("Missing field 'primary'").flatMap(_.as(using Flag.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[ProductproductphotoRow] = new JsonEncoder[ProductproductphotoRow] {
