...
object ProductcosthistoryRowUnsaved {
  given jsonDecoder: JsonDecoder[ProductcosthistoryRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductcosthistoryRowUnsaved] = new JsonEncoder[ProductcosthistoryRowUnsaved] {
