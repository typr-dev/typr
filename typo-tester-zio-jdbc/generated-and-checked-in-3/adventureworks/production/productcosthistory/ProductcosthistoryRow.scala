...
object ProductcosthistoryRow {
  ...
  given jdbcDecoder: JdbcDecoder[ProductcosthistoryRow] = new JdbcDecoder[ProductcosthistoryRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, ProductcosthistoryRow) =
      columIndex + 4 ->
        ProductcosthistoryRow(
          ...
          enddate = JdbcDecoder.optionDecoder(using TypoLocalDateTime.jdbcDecoder).unsafeDecode(columIndex + 2, rs)._2,
  ...
  given jsonDecoder: JsonDecoder[ProductcosthistoryRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductcosthistoryRow] = new JsonEncoder[ProductcosthistoryRow] {
