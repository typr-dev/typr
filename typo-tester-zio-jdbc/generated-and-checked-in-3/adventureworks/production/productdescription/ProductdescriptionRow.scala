...
object ProductdescriptionRow {
  given jdbcDecoder: JdbcDecoder[ProductdescriptionRow] = new JdbcDecoder[ProductdescriptionRow] {
  ...
  given jsonDecoder: JsonDecoder[ProductdescriptionRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductdescriptionRow] = new JsonEncoder[ProductdescriptionRow] {
