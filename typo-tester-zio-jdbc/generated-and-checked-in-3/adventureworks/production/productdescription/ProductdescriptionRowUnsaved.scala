...
object ProductdescriptionRowUnsaved {
  given jsonDecoder: JsonDecoder[ProductdescriptionRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductdescriptionRowUnsaved] = new JsonEncoder[ProductdescriptionRowUnsaved] {
