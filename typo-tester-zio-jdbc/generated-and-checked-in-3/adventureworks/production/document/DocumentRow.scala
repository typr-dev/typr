...
object DocumentRow {
  given jdbcDecoder: JdbcDecoder[DocumentRow] = new JdbcDecoder[DocumentRow] {
  ...
  given jsonDecoder: JsonDecoder[DocumentRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[DocumentRow] = new JsonEncoder[DocumentRow] {
  ...
  given text: Text[DocumentRow] = Text.instance[DocumentRow]{ (row, sb) =>
