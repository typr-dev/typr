...
object ProductdocumentRow {
  ...
  given jdbcDecoder: JdbcDecoder[ProductdocumentRow] = new JdbcDecoder[ProductdocumentRow] {
  ...
  given jsonDecoder: JsonDecoder[ProductdocumentRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductdocumentRow] = new JsonEncoder[ProductdocumentRow] {
