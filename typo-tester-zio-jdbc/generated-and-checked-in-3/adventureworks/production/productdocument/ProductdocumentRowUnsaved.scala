...
object ProductdocumentRowUnsaved {
  given jsonDecoder: JsonDecoder[ProductdocumentRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductdocumentRowUnsaved] = new JsonEncoder[ProductdocumentRowUnsaved] {
