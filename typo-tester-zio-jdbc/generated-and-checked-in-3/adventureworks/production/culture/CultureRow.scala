...
object CultureRow {
  given jdbcDecoder: JdbcDecoder[CultureRow] = new JdbcDecoder[CultureRow] {
  ...
  given jsonDecoder: JsonDecoder[CultureRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[CultureRow] = new JsonEncoder[CultureRow] {
