...
object ProductlistpricehistoryRow {
  ...
  given jdbcDecoder: JdbcDecoder[ProductlistpricehistoryRow] = new JdbcDecoder[ProductlistpricehistoryRow] {
  ...
  given jsonDecoder: JsonDecoder[ProductlistpricehistoryRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductlistpricehistoryRow] = new JsonEncoder[ProductlistpricehistoryRow] {
