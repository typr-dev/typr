...
object ProductlistpricehistoryRow {
  ...
  given jdbcDecoder: JdbcDecoder[ProductlistpricehistoryRow] = {
  ...
  given jsonDecoder: JsonDecoder[ProductlistpricehistoryRow] = {
  ...
  given jsonEncoder: JsonEncoder[ProductlistpricehistoryRow] = {
