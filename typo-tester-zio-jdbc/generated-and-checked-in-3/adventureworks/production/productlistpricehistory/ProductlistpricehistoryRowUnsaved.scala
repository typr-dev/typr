...
object ProductlistpricehistoryRowUnsaved {
  given jsonDecoder: JsonDecoder[ProductlistpricehistoryRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductlistpricehistoryRowUnsaved] = new JsonEncoder[ProductlistpricehistoryRowUnsaved] {
