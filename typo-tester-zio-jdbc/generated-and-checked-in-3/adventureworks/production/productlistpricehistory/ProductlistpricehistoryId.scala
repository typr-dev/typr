...
object ProductlistpricehistoryId {
  given jsonDecoder: JsonDecoder[ProductlistpricehistoryId] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductlistpricehistoryId] = new JsonEncoder[ProductlistpricehistoryId] {
