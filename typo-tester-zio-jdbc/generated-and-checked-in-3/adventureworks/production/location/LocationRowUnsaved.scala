...
object LocationRowUnsaved {
  given jsonDecoder: JsonDecoder[LocationRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[LocationRowUnsaved] = new JsonEncoder[LocationRowUnsaved] {
