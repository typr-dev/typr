...
object LocationRow {
  given jdbcDecoder: JdbcDecoder[LocationRow] = new JdbcDecoder[LocationRow] {
  ...
  given jsonDecoder: JsonDecoder[LocationRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[LocationRow] = new JsonEncoder[LocationRow] {
