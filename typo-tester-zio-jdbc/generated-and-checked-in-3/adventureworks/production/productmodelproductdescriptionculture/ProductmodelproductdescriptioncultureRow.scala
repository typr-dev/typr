...
object ProductmodelproductdescriptioncultureRow {
  ...
  given jdbcDecoder: JdbcDecoder[ProductmodelproductdescriptioncultureRow] = new JdbcDecoder[ProductmodelproductdescriptioncultureRow] {
  ...
  given jsonDecoder: JsonDecoder[ProductmodelproductdescriptioncultureRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val productdescriptionid = jsonObj.get("productdescriptionid").toRight("Missing field 'productdescriptionid'").flatMap(_.as(using ProductdescriptionId.jsonDecoder))
    val cultureid = jsonObj.get("cultureid").toRight("Missing field 'cultureid'").flatMap(_.as(using CultureId.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[ProductmodelproductdescriptioncultureRow] = new JsonEncoder[ProductmodelproductdescriptioncultureRow] {
