...
object ProductreviewRow {
  given jdbcDecoder: JdbcDecoder[ProductreviewRow] = new JdbcDecoder[ProductreviewRow] {
  ...
  given jsonDecoder: JsonDecoder[ProductreviewRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductreviewRow] = new JsonEncoder[ProductreviewRow] {
