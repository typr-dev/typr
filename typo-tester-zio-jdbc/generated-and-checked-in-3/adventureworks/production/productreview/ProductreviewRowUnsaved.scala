...
object ProductreviewRowUnsaved {
  given jsonDecoder: JsonDecoder[ProductreviewRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductreviewRowUnsaved] = new JsonEncoder[ProductreviewRowUnsaved] {
