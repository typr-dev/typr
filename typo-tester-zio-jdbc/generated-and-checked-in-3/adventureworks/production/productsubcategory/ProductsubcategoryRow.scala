...
object ProductsubcategoryRow {
  given jdbcDecoder: JdbcDecoder[ProductsubcategoryRow] = new JdbcDecoder[ProductsubcategoryRow] {
  ...
  given jsonDecoder: JsonDecoder[ProductsubcategoryRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductsubcategoryRow] = new JsonEncoder[ProductsubcategoryRow] {
