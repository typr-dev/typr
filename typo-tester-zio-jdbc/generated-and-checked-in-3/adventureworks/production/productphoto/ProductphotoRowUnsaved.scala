...
object ProductphotoRowUnsaved {
  given jsonDecoder: JsonDecoder[ProductphotoRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val productphotoid = jsonObj.get("productphotoid").toRight("Missing field 'productphotoid'").flatMap(_.as(using Defaulted.jsonDecoder(using ProductphotoId.jsonDecoder)))
  ...
  given jsonEncoder: JsonEncoder[ProductphotoRowUnsaved] = new JsonEncoder[ProductphotoRowUnsaved] {
    override def unsafeEncode(a: ProductphotoRowUnsaved, indent: Option[Int], out: Write): Unit = {
      ...
      Defaulted.jsonEncoder(using ProductphotoId.jsonEncoder).unsafeEncode(a.productphotoid, indent, out)
      out.write(",")
