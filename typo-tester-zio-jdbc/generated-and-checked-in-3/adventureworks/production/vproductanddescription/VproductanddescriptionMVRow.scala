...
object VproductanddescriptionMVRow {
  given jdbcDecoder: JdbcDecoder[VproductanddescriptionMVRow] = new JdbcDecoder[VproductanddescriptionMVRow] {
  ...
  given jsonDecoder: JsonDecoder[VproductanddescriptionMVRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val productmodel = jsonObj.get("productmodel").toRight("Missing field 'productmodel'").flatMap(_.as(using Name.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[VproductanddescriptionMVRow] = new JsonEncoder[VproductanddescriptionMVRow] {
