...
object VproductanddescriptionMVRow {
  given jdbcDecoder: JdbcDecoder[VproductanddescriptionMVRow] = {
  ...
  given jsonDecoder: JsonDecoder[VproductanddescriptionMVRow] = {
  ...
  given jsonEncoder: JsonEncoder[VproductanddescriptionMVRow] = {
