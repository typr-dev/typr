...
object ProductcategoryRow {
  given jdbcDecoder: JdbcDecoder[ProductcategoryRow] = new JdbcDecoder[ProductcategoryRow] {
  ...
  given jsonDecoder: JsonDecoder[ProductcategoryRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductcategoryRow] = new JsonEncoder[ProductcategoryRow] {
