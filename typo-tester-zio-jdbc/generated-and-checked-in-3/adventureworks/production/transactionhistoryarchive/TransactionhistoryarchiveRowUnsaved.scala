...
object TransactionhistoryarchiveRowUnsaved {
  given jsonDecoder: JsonDecoder[TransactionhistoryarchiveRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[TransactionhistoryarchiveRowUnsaved] = new JsonEncoder[TransactionhistoryarchiveRowUnsaved] {
