...
object TransactionhistoryarchiveRow {
  given jdbcDecoder: JdbcDecoder[TransactionhistoryarchiveRow] = new JdbcDecoder[TransactionhistoryarchiveRow] {
  ...
  given jsonDecoder: JsonDecoder[TransactionhistoryarchiveRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[TransactionhistoryarchiveRow] = new JsonEncoder[TransactionhistoryarchiveRow] {
  ...
  given text: Text[TransactionhistoryarchiveRow] = Text.instance[TransactionhistoryarchiveRow]{ (row, sb) =>
