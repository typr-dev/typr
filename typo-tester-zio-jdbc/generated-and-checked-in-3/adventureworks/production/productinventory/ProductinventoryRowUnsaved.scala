...
object ProductinventoryRowUnsaved {
  given jsonDecoder: JsonDecoder[ProductinventoryRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val quantity = jsonObj.get("quantity").toRight("Missing field 'quantity'").flatMap(_.as(using Defaulted.jsonDecoder(using TypoShort.jsonDecoder)))
  ...
  given jsonEncoder: JsonEncoder[ProductinventoryRowUnsaved] = new JsonEncoder[ProductinventoryRowUnsaved] {
    override def unsafeEncode(a: ProductinventoryRowUnsaved, indent: Option[Int], out: Write): Unit = {
      ...
      out.write(",")
      out.write(""""quantity":""")
      Defaulted.jsonEncoder(using TypoShort.jsonEncoder).unsafeEncode(a.quantity, indent, out)
      out.write(",")
      out.write(""""rowguid":""")
