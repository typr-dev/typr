...
object ProductinventoryRow {
  ...
  given jdbcDecoder: JdbcDecoder[ProductinventoryRow] = new JdbcDecoder[ProductinventoryRow] {
  ...
  given jsonDecoder: JsonDecoder[ProductinventoryRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val shelf = jsonObj.get("shelf").toRight("Missing field 'shelf'").flatMap(_.as(using JsonDecoder.string))
    val bin = jsonObj.get("bin").toRight("Missing field 'bin'").flatMap(_.as(using TypoShort.jsonDecoder))
    val quantity = jsonObj.get("quantity").toRight("Missing field 'quantity'").flatMap(_.as(using TypoShort.jsonDecoder))
  ...
  given jsonEncoder: JsonEncoder[ProductinventoryRow] = new JsonEncoder[ProductinventoryRow] {
  ...
  given text: Text[ProductinventoryRow] = Text.instance[ProductinventoryRow]{ (row, sb) =>
