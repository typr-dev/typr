...
object ProductRow {
  given jdbcDecoder: JdbcDecoder[ProductRow] = {
  ...
  given jsonDecoder: JsonDecoder[ProductRow] = {
  ...
  given jsonEncoder: JsonEncoder[ProductRow] = {
  ...
  given pgText: Text[ProductRow] = {
    Text.instance[ProductRow]{ (row, sb) =>
      ...
      sb.append(Text.DELIMETER)
      Flag.pgText.unsafeEncode(row.makeflag, sb)
      sb.append(Text.DELIMETER)
      Flag.pgText.unsafeEncode(row.finishedgoodsflag, sb)
      sb.append(Text.DELIMETER)
