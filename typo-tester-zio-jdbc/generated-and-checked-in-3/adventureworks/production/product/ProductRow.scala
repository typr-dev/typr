...
object ProductRow {
  given jdbcDecoder: JdbcDecoder[ProductRow] = new JdbcDecoder[ProductRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, ProductRow) =
      columIndex + 24 ->
        ProductRow(
          ...
          color = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 5, rs)._2,
          ...
          size = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 10, rs)._2,
          sizeunitmeasurecode = JdbcDecoder.optionDecoder(using UnitmeasureId.jdbcDecoder).unsafeDecode(columIndex + 11, rs)._2,
          weightunitmeasurecode = JdbcDecoder.optionDecoder(using UnitmeasureId.jdbcDecoder).unsafeDecode(columIndex + 12, rs)._2,
          weight = JdbcDecoder.optionDecoder(using JdbcDecoder.bigDecimalDecoderScala).unsafeDecode(columIndex + 13, rs)._2,
          daystomanufacture = JdbcDecoder.intDecoder.unsafeDecode(columIndex + 14, rs)._2,
          productline = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 15, rs)._2,
          `class` = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 16, rs)._2,
          style = JdbcDecoder.optionDecoder(using JdbcDecoder.stringDecoder).unsafeDecode(columIndex + 17, rs)._2,
          productsubcategoryid = JdbcDecoder.optionDecoder(using ProductsubcategoryId.jdbcDecoder).unsafeDecode(columIndex + 18, rs)._2,
          productmodelid = JdbcDecoder.optionDecoder(using ProductmodelId.jdbcDecoder).unsafeDecode(columIndex + 19, rs)._2,
          sellstartdate = TypoLocalDateTime.jdbcDecoder.unsafeDecode(columIndex + 20, rs)._2,
          sellenddate = JdbcDecoder.optionDecoder(using TypoLocalDateTime.jdbcDecoder).unsafeDecode(columIndex + 21, rs)._2,
          discontinueddate = JdbcDecoder.optionDecoder(using TypoLocalDateTime.jdbcDecoder).unsafeDecode(columIndex + 22, rs)._2,
  ...
  given jsonDecoder: JsonDecoder[ProductRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val size = jsonObj.get("size").fold[Either[String, Option[String]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.string)))
    val sizeunitmeasurecode = jsonObj.get("sizeunitmeasurecode").fold[Either[String, Option[UnitmeasureId]]](Right(None))(_.as(using JsonDecoder.option(using UnitmeasureId.jsonDecoder)))
    val weightunitmeasurecode = jsonObj.get("weightunitmeasurecode").fold[Either[String, Option[UnitmeasureId]]](Right(None))(_.as(using JsonDecoder.option(using UnitmeasureId.jsonDecoder)))
    val weight = jsonObj.get("weight").fold[Either[String, Option[BigDecimal]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.scalaBigDecimal)))
    ...
    val `class` = jsonObj.get("class").fold[Either[String, Option[String]]](Right(None))(_.as(using JsonDecoder.option(using JsonDecoder.string)))
    ...
    val productsubcategoryid = jsonObj.get("productsubcategoryid").fold[Either[String, Option[ProductsubcategoryId]]](Right(None))(_.as(using JsonDecoder.option(using ProductsubcategoryId.jsonDecoder)))
    val productmodelid = jsonObj.get("productmodelid").fold[Either[String, Option[ProductmodelId]]](Right(None))(_.as(using JsonDecoder.option(using ProductmodelId.jsonDecoder)))
    ...
    val sellenddate = jsonObj.get("sellenddate").fold[Either[String, Option[TypoLocalDateTime]]](Right(None))(_.as(using JsonDecoder.option(using TypoLocalDateTime.jsonDecoder)))
    val discontinueddate = jsonObj.get("discontinueddate").fold[Either[String, Option[TypoLocalDateTime]]](Right(None))(_.as(using JsonDecoder.option(using TypoLocalDateTime.jsonDecoder)))
  ...
  given jsonEncoder: JsonEncoder[ProductRow] = new JsonEncoder[ProductRow] {
  ...
  given text: Text[ProductRow] = Text.instance[ProductRow]{ (row, sb) =>
