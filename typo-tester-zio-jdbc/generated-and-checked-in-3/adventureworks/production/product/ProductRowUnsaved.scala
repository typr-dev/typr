...
object ProductRowUnsaved {
  given jsonDecoder: JsonDecoder[ProductRowUnsaved] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
    ...
    val productid = jsonObj.get("productid").toRight("Missing field 'productid'").flatMap(_.as(using Defaulted.jsonDecoder(using ProductId.jsonDecoder)))
    val makeflag = jsonObj.get("makeflag").toRight("Missing field 'makeflag'").flatMap(_.as(using Defaulted.jsonDecoder(using Flag.jsonDecoder)))
    val finishedgoodsflag = jsonObj.get("finishedgoodsflag").toRight("Missing field 'finishedgoodsflag'").flatMap(_.as(using Defaulted.jsonDecoder(using Flag.jsonDecoder)))
  ...
  given jsonEncoder: JsonEncoder[ProductRowUnsaved] = new JsonEncoder[ProductRowUnsaved] {
    override def unsafeEncode(a: ProductRowUnsaved, indent: Option[Int], out: Write): Unit = {
      ...
      out.write(",")
      out.write(""""productid":""")
      Defaulted.jsonEncoder(using ProductId.jsonEncoder).unsafeEncode(a.productid, indent, out)
      out.write(",")
      out.write(""""makeflag":""")
      Defaulted.jsonEncoder(using Flag.jsonEncoder).unsafeEncode(a.makeflag, indent, out)
      out.write(",")
      out.write(""""finishedgoodsflag":""")
      Defaulted.jsonEncoder(using Flag.jsonEncoder).unsafeEncode(a.finishedgoodsflag, indent, out)
      out.write(",")
      out.write(""""rowguid":""")
