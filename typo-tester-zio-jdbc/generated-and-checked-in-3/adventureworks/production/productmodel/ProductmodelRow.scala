...
object ProductmodelRow {
  given jdbcDecoder: JdbcDecoder[ProductmodelRow] = new JdbcDecoder[ProductmodelRow] {
    override def unsafeDecode(columIndex: Int, rs: ResultSet): (Int, ProductmodelRow) =
      columIndex + 5 ->
        ProductmodelRow(
          ...
          catalogdescription = JdbcDecoder.optionDecoder(using TypoXml.jdbcDecoder).unsafeDecode(columIndex + 2, rs)._2,
          instructions = JdbcDecoder.optionDecoder(using TypoXml.jdbcDecoder).unsafeDecode(columIndex + 3, rs)._2,
  ...
  given jsonDecoder: JsonDecoder[ProductmodelRow] = JsonDecoder[Json.Obj].mapOrFail { jsonObj =>
  ...
  given jsonEncoder: JsonEncoder[ProductmodelRow] = new JsonEncoder[ProductmodelRow] {
