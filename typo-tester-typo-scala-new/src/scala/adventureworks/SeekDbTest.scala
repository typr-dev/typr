...
class SeekDbTest {
  ...
  private def testUniformSeek(businessentityRepo: BusinessentityRepo): Unit = {
    ...
    WithConnection {
      ...
      val rows1 = businessentityRepo.select
        .maybeSeek(f => f.modifieddate.asc, Option.empty[LocalDateTime], (v: LocalDateTime) => new typo.dsl.SqlExpr.ConstReq(v, timestampPgType))
        .maybeSeek(f => f.businessentityid.asc, Option.empty[BusinessentityId], (v: BusinessentityId) => new typo.dsl.SqlExpr.ConstReq(v, BusinessentityId.pgType))
        .maybeSeek(f => f.rowguid.asc, Option.empty[UUID], (v: UUID) => new typo.dsl.SqlExpr.ConstReq(v, PgTypes.uuid))
        .limit(limit)
        .toList
      ...
      val rows2 = businessentityRepo.select
        .maybeSeek(f => f.modifieddate.asc, Some(lastRow.modifieddate), (v: LocalDateTime) => new typo.dsl.SqlExpr.ConstReq(v, timestampPgType))
        .maybeSeek(f => f.businessentityid.asc, Some(lastRow.businessentityid), (v: BusinessentityId) => new typo.dsl.SqlExpr.ConstReq(v, BusinessentityId.pgType))
        .maybeSeek(f => f.rowguid.asc, Some(lastRow.rowguid), (v: UUID) => new typo.dsl.SqlExpr.ConstReq(v, PgTypes.uuid))
        .limit(limit)
        .toList
  ...
  private def testNonUniformSeek(businessentityRepo: BusinessentityRepo): Unit = {
    ...
    WithConnection {
      ...
      val rows1 = businessentityRepo.select
        .maybeSeek(f => f.modifieddate.desc, Option.empty[LocalDateTime], (v: LocalDateTime) => new typo.dsl.SqlExpr.ConstReq(v, timestampPgType))
        .maybeSeek(f => f.businessentityid.asc, Option.empty[BusinessentityId], (v: BusinessentityId) => new typo.dsl.SqlExpr.ConstReq(v, BusinessentityId.pgType))
        .maybeSeek(f => f.rowguid.asc, Option.empty[UUID], (v: UUID) => new typo.dsl.SqlExpr.ConstReq(v, PgTypes.uuid))
        .limit(limit)
        .toList
      ...
      val lastRow = rows1.last
      val rows2 = businessentityRepo.select
        .maybeSeek(f => f.modifieddate.desc, Some(lastRow.modifieddate), (v: LocalDateTime) => new typo.dsl.SqlExpr.ConstReq(v, timestampPgType))
        .maybeSeek(f => f.businessentityid.asc, Some(lastRow.businessentityid), (v: BusinessentityId) => new typo.dsl.SqlExpr.ConstReq(v, BusinessentityId.pgType))
        .maybeSeek(f => f.rowguid.asc, Some(lastRow.rowguid), (v: UUID) => new typo.dsl.SqlExpr.ConstReq(v, PgTypes.uuid))
        .limit(limit)
        .toList
