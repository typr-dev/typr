...
object PiViewRow {
  val `_rowParser`: RowParser[PiViewRow] = {
    RowParsers.of(ProductId.pgType, ProductId.pgType, LocationId.pgType, PgTypes.text, ScalaDbTypes.PgTypes.int2, ScalaDbTypes.PgTypes.int2, PgTypes.uuid, PgTypes.timestamp)((t0, t1, t2, t3, t4, t5, t6, t7) => new PiViewRow(
      t0,
      t1,
      t2,
      t3,
