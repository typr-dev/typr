...
object PrViewRow {
  val `_rowParser`: RowParser[PrViewRow] = {
    RowParsers.of(ProductreviewId.pgType, ProductreviewId.pgType, ProductId.pgType, Name.pgType, PgTypes.timestamp, PgTypes.text, ScalaDbTypes.PgTypes.int4, PgTypes.text, PgTypes.timestamp)((t0, t1, t2, t3, t4, t5, t6, t7, t8) => new PrViewRow(
      t0,
      t1,
      t2,
      t3,
