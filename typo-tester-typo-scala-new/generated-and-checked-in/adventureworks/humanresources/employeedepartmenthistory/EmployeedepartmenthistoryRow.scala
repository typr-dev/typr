...
object EmployeedepartmenthistoryRow {
  val `_rowParser`: RowParser[EmployeedepartmenthistoryRow] = {
    RowParsers.of(BusinessentityId.pgType, DepartmentId.pgType, ShiftId.pgType, PgTypes.date, PgTypes.date.nullable, PgTypes.timestamp)((t0, t1, t2, t3, t4, t5) => new EmployeedepartmenthistoryRow(
      t0,
      t1,
      t2,
      t3,
  ...
  given pgText: PgText[EmployeedepartmenthistoryRow] = PgText.from(`_rowParser`.underlying)
}