...
object SalesterritoryRow {
  val `_rowParser`: RowParser[SalesterritoryRow] = {
    RowParsers.of(SalesterritoryId.pgType, Name.pgType, CountryregionId.pgType, PgTypes.text, ScalaDbTypes.PgTypes.numeric, ScalaDbTypes.PgTypes.numeric, ScalaDbTypes.PgTypes.numeric, ScalaDbTypes.PgTypes.numeric, PgTypes.uuid, PgTypes.timestamp)((t0, t1, t2, t3, t4, t5, t6, t7, t8, t9) => new SalesterritoryRow(
      t0,
      t1,
      t2,
      t3,
