...
object CustomerRow {
  val `_rowParser`: RowParser[CustomerRow] = {
    RowParsers.of(CustomerId.pgType, BusinessentityId.pgType.nullable, BusinessentityId.pgType.nullable, SalesterritoryId.pgType.nullable, PgTypes.uuid, PgTypes.timestamp)((t0, t1, t2, t3, t4, t5) => new CustomerRow(
      t0,
      t1,
      t2,
      t3,
