...
object IdentityTestRow {
  val `_rowParser`: RowParser[IdentityTestRow] = RowParsers.of(ScalaDbTypes.PgTypes.int4, ScalaDbTypes.PgTypes.int4, IdentityTestId.pgType)((t0, t1, t2) => new IdentityTestRow(t0, t1, t2))(row => Array[Any](row.alwaysGenerated, row.defaultGenerated, row.name))
