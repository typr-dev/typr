...
object PersonRow {
  val `_rowParser`: RowParser[PersonRow] = {
    RowParsers.of(BusinessentityId.pgType, PgTypes.bpchar, NameStyle.pgType, PgTypes.text.nullable, FirstName.pgType, Name.pgType.nullable, Name.pgType, PgTypes.text.nullable, ScalaDbTypes.PgTypes.int4, PgTypes.xml.nullable, PgTypes.xml.nullable, PgTypes.uuid, PgTypes.timestamp)((t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12) => new PersonRow(
      t0,
      t1,
      t2,
      t3,
