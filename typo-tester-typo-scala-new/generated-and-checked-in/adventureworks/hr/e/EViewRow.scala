...
object EViewRow {
  val `_rowParser`: RowParser[EViewRow] = {
    RowParsers.of(BusinessentityId.pgType, BusinessentityId.pgType, PgTypes.text, PgTypes.text, PgTypes.text, PgTypes.date, PgTypes.bpchar, PgTypes.bpchar, PgTypes.date, Flag.pgType, ScalaDbTypes.PgTypes.int2, ScalaDbTypes.PgTypes.int2, Flag.pgType, PgTypes.uuid, PgTypes.timestamp, PgTypes.text)((t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15) => new EViewRow(
      t0,
      t1,
      t2,
      t3,
